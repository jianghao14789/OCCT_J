...
Handle(Adaptor3d_Surface) BRepAdaptor_Surface::UTrim(const Standard_Real First, const Standard_Real Last,
...
Handle(Adaptor3d_Surface) BRepAdaptor_Surface::VTrim(const Standard_Real First, const Standard_Real Last,
                                                     const Standard_Real Tol) const {
    Handle(GeomAdaptor_Surface) HS = new GeomAdaptor_Surface();
    HS->Load(Handle(Geom_Surface)::DownCast(mySurf.Surface()->Transformed(myTrsf)));
...
void BRepAdaptor_Surface::D1(const Standard_Real U, const Standard_Real V, gp_Pnt& P, gp_Vec& D1U, gp_Vec& D1V) const {
...
void BRepAdaptor_Surface::D2(const Standard_Real U, const Standard_Real V, gp_Pnt& P, gp_Vec& D1U, gp_Vec& D1V,
...
void BRepAdaptor_Surface::D3(const Standard_Real U, const Standard_Real V, gp_Pnt& P, gp_Vec& D1U, gp_Vec& D1V,
...
gp_Vec BRepAdaptor_Surface::DN(const Standard_Real U, const Standard_Real V, const Standard_Integer Nu,
