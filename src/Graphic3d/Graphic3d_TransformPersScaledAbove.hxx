...
public:
    ...
    Standard_EXPORT Graphic3d_TransformPersScaledAbove(const Standard_Real theScale, const gp_Pnt& thePnt);
    //! Destructor
    ...
    persistentScale(const Handle(Graphic3d_Camera) & theCamera, const Standard_Integer theViewportWidth,
