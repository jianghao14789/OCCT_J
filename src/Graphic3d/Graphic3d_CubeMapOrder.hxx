...
public:
    ...
    Standard_EXPORT Graphic3d_CubeMapOrder(unsigned char thePosXLocation, unsigned char theNegXLocation,
...
public:
    ...
    //! Copy constructor.
    Graphic3d_ValidatedCubeMapOrder(const Graphic3d_ValidatedCubeMapOrder& theOther) : Order(theOther.Order) {}
...
private:
    ...
    Graphic3d_ValidatedCubeMapOrder(const Graphic3d_CubeMapOrder theOrder) : Order(theOrder) {}
