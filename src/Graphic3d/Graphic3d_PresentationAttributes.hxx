...
public:
    ...
    Graphic3d_PresentationAttributes()
        : myBasicColor(Quantity_NOC_WHITE), myHiMethod(Aspect_TOHM_COLOR), myZLayer(Graphic3d_ZLayerId_Default),
          myDispMode(0) {
        //
    }
    ...
    Standard_ShortReal Transparency() const {
        return 1.0f - myBasicColor.Alpha();
    }
