...
//! Therefore, this collection allows defining a Clipping Volume through the limited set of Boolean operations between
//! clipping Planes.
//!
//! The Clipping Volume can be assigned either to entire View or to a specific Object;
//! in the latter case property ToOverrideGlobal() will specify if Object planes should override (suppress) globally
//! defined ones or extend their definition through logical OR (disjunction) operation.
//!
//! Note that defining (many) planes will lead to performance degradation, and Graphics Driver may limit
//! the overall number of simultaneously active clipping planes - but at least 6 planes should be supported on all
//! configurations.
