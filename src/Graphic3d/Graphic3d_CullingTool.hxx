...
public:
    ...
    struct Plane {
        ...
        Plane(const Graphic3d_Vec3d& theOrigin, const Graphic3d_Vec3d& theNormal)
            : Origin(theOrigin), Normal(theNormal) {}
...
public:
    ...
    Standard_EXPORT void SetViewportSize(Standard_Integer theViewportWidth, Standard_Integer theViewportHeight,
    ...
    bool IsCulled(const CullingContext& theCtx, const Graphic3d_Vec3d& theMinPnt, const Graphic3d_Vec3d& theMaxPnt,
                  Standard_Boolean* theIsInside = NULL) const {
        return IsOutFrustum(theMinPnt, theMaxPnt, theIsInside) ||
               IsTooDistant(theCtx, theMinPnt, theMaxPnt, theIsInside) || IsTooSmall(theCtx, theMinPnt, theMaxPnt);
    }
...
public:
    ...
    bool IsOutFrustum(const Graphic3d_Vec3d& theMinPnt, const Graphic3d_Vec3d& theMaxPnt,
                      Standard_Boolean* theIsInside = NULL) const {
        //     E1
        //    |_ E0
        //   /
        ...
        for (Standard_Integer aPlaneIter = 0; aPlaneIter < PlanesNB - 1; aPlaneIter += anIncFactor) {
            ...
            if (aBoxProjMin > myMaxClipProjectionPts[aPlaneIter] || aBoxProjMax < myMinClipProjectionPts[aPlaneIter]) {
                return true;
            }
    ...
    //!         FALSE in case of partial or complete overlap (use theIsInside to distinguish)
    bool IsTooDistant(const CullingContext& theCtx, const Graphic3d_Vec3d& theMinPnt, const Graphic3d_Vec3d& theMaxPnt,
                      Standard_Boolean* theIsInside = NULL) const {
    ...
    bool IsTooSmall(const CullingContext& theCtx, const Graphic3d_Vec3d& theMinPnt,
...
protected:
    ...
    enum { Plane_Left, Plane_Right, Plane_Bottom, Plane_Top, Plane_Near, Plane_Far, PlanesNB };
...
protected:
    ...
    // ORDER: E0, E1, E2
    Standard_Real
        myMaxOrthoProjectionPts[3]; //!< Max view volume's vertices projections onto normalized dimensions of AABB
    Standard_Real
        myMinOrthoProjectionPts[3]; //!< Min view volume's vertices projections onto normalized dimensions of AABB
