...
public:
    ...
    Graphic3d_ArrayOfTriangleStrips(Standard_Integer theMaxVertexs, Standard_Integer theMaxStrips,
    ...
    //!                       vertex normals should be specified coherent to triangle orientation (defined by order of
    //!                       vertexes within triangle) for proper rendering
    //! @param theHasVColors  when TRUE, AddVertex(Point,Color) or AddVertex(Point,Normal,Color) should be used to
    //! specify vertex color
    //! @param theHasBColors  when TRUE, AddBound(number,Color) should be used to specify sub-group color
    //! @param theHasVTexels  when TRUE, AddVertex(Point,Texel) or AddVertex(Point,Normal,Texel) should be used to
    //! specify vertex UV coordinates
    Graphic3d_ArrayOfTriangleStrips(Standard_Integer theMaxVertexs, Standard_Integer theMaxStrips = 0,
        ...
        : Graphic3d_ArrayOfPrimitives(
              Graphic3d_TOPA_TRIANGLESTRIPS, theMaxVertexs, theMaxStrips, 0,
