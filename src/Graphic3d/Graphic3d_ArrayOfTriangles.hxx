...
public:
    ...
    Graphic3d_ArrayOfTriangles(Standard_Integer theMaxVertexs, Standard_Integer theMaxEdges,
    ...
    Graphic3d_ArrayOfTriangles(Standard_Integer theMaxVertexs, Standard_Integer theMaxEdges = 0,
        ...
        : Graphic3d_ArrayOfPrimitives(
              Graphic3d_TOPA_TRIANGLES, theMaxVertexs, 0, theMaxEdges,
