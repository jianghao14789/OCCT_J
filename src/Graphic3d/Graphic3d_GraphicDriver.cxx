...
Graphic3d_GraphicDriver::Graphic3d_GraphicDriver(const Handle(Aspect_DisplayConnection) & theDisp)
    ...
    // default layers are always presented in display layer sequence and cannot be removed
    {
        ...
        Handle(Graphic3d_Layer) aLayer =
            new Graphic3d_Layer(Graphic3d_ZLayerId_BotOSD, 1, Handle(Select3D_BVHBuilder3d)());
...

    {
        ...
        aSettings.SetPolygonOffset(Graphic3d_PolygonOffset());
        Handle(Graphic3d_Layer) aLayer =
            new Graphic3d_Layer(Graphic3d_ZLayerId_Default, 1, Handle(Select3D_BVHBuilder3d)());
        aLayer->SetLayerSettings(aSettings);
        myLayers.Append(aLayer);
        myLayerIds.Bind(aLayer->LayerId(), aLayer);
    }

    {
        ...
        aSettings.SetPolygonOffset(Graphic3d_PolygonOffset());
        Handle(Graphic3d_Layer) aLayer =
            new Graphic3d_Layer(Graphic3d_ZLayerId_Top, 1, Handle(Select3D_BVHBuilder3d)());
        aLayer->SetLayerSettings(aSettings);
        myLayers.Append(aLayer);
        myLayerIds.Bind(aLayer->LayerId(), aLayer);
    }

    {
        ...
        aSettings.SetPolygonOffset(Graphic3d_PolygonOffset());
        Handle(Graphic3d_Layer) aLayer =
            new Graphic3d_Layer(Graphic3d_ZLayerId_Topmost, 1, Handle(Select3D_BVHBuilder3d)());
        aLayer->SetLayerSettings(aSettings);
        myLayers.Append(aLayer);
        myLayerIds.Bind(aLayer->LayerId(), aLayer);
    }

    {
        ...
        aSettings.SetPolygonOffset(Graphic3d_PolygonOffset());
        Handle(Graphic3d_Layer) aLayer =
            new Graphic3d_Layer(Graphic3d_ZLayerId_TopOSD, 1, Handle(Select3D_BVHBuilder3d)());
        aLayer->SetLayerSettings(aSettings);
        myLayers.Append(aLayer);
        myLayerIds.Bind(aLayer->LayerId(), aLayer);
    }
