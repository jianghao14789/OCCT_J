...
public:
    ...
    Standard_EXPORT bool Init(const Standard_Integer theNbElems, const Graphic3d_Attribute* theAttribs,
    ...
    virtual Standard_Boolean IsMutable() const Standard_OVERRIDE {
        return myIsMutable;
    }
    ...
    virtual Standard_Boolean IsInterleaved() const Standard_OVERRIDE {
        return myIsInterleaved;
    }
    ...
    virtual void Validate() Standard_OVERRIDE {
        myInvalidatedRange.Clear();
    }
    ...
    Standard_EXPORT void Invalidate(Standard_Integer theAttributeIndex, Standard_Integer theVertexLower,
