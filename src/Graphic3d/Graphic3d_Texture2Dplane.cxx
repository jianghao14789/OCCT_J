...
Graphic3d_Texture2Dplane::Graphic3d_Texture2Dplane(const TCollection_AsciiString& theFileName)
    ...
    myParams->SetGenMode(Graphic3d_TOTM_OBJECT, Graphic3d_Vec4(1.0f, 0.0f, 0.0f, 0.0f),
...
// purpose  :
// =======================================================================
void Graphic3d_Texture2Dplane::SetPlaneS(const Standard_ShortReal theA, const Standard_ShortReal theB,
                                         const Standard_ShortReal theC, const Standard_ShortReal theD) {
...
// purpose  :
// =======================================================================
void Graphic3d_Texture2Dplane::SetPlaneT(const Standard_ShortReal theA, const Standard_ShortReal theB,
                                         const Standard_ShortReal theC, const Standard_ShortReal theD) {
...
void Graphic3d_Texture2Dplane::SetPlane(const Graphic3d_NameOfTexturePlane thePlane) {
    switch (thePlane) {
        ...
        case Graphic3d_NOTP_YZ: {
            myParams->SetGenMode(Graphic3d_TOTM_OBJECT, Graphic3d_Vec4(0.0f, 1.0f, 0.0f, 0.0f),
...
// purpose  :
// =======================================================================
void Graphic3d_Texture2Dplane::PlaneS(Standard_ShortReal& theA, Standard_ShortReal& theB, Standard_ShortReal& theC,
...
// purpose  :
// =======================================================================
void Graphic3d_Texture2Dplane::PlaneT(Standard_ShortReal& theA, Standard_ShortReal& theB, Standard_ShortReal& theC,
                                      Standard_ShortReal& theD) const {
    const Graphic3d_Vec4& aPlaneT = myParams->GenPlaneT();
    theA = aPlaneT.x();
    theB = aPlaneT.y();
