...
enum Graphic3d_TextureUnit {
    ...
    //! Graphic3d_TextureUnit_BaseColor, while other texture maps (normal map and others) are unexpected and unsupported
    //! for points. Note that it can be overridden to Graphic3d_TextureUnit_0 for FFP fallback on hardware without
    //! multi-texturing.
