...
static const RawMaterial THE_MATERIALS[] = {RawMaterial(Graphic3d_NameOfMaterial_Brass, "Brass"),
...
RawMaterial::RawMaterial(Graphic3d_NameOfMaterial theName, const char* theStringName)
    : StringName(theStringName), BSDF(Graphic3d_BSDF::CreateDiffuse(Graphic3d_Vec3(0.0f))), TransparencyCoef(0.0f),
      RefractionIndex(1.0f), Shininess(0.039f), AmbientCoef(0.25f), DiffuseCoef(1.0f),
      MaterialType(Graphic3d_MATERIAL_ASPECT), MaterialName(theName) {
    switch (theName) {
        ...
        case Graphic3d_NameOfMaterial_Steel:
            ...
            BSDF =
                Graphic3d_BSDF::CreateMetallic(Graphic3d_Vec3(0.985f, 0.985f, 0.985f),
        ...
        case Graphic3d_NameOfMaterial_Water:
            ...
            BSDF = Graphic3d_BSDF::CreateGlass(Graphic3d_Vec3(1.f), Graphic3d_Vec3(0.7f, 0.75f, 0.85f), 0.05f,
                                               RefractionIndex);
        ...
        case Graphic3d_NameOfMaterial_Glass:
            ...
            BSDF = Graphic3d_BSDF::CreateGlass(Graphic3d_Vec3(1.f), Graphic3d_Vec3(0.75f, 0.95f, 0.9f), 0.05f,
                                               RefractionIndex);
            TransparencyCoef = 0.80f;
        ...
        case Graphic3d_NameOfMaterial_Diamond:
            ...
            BSDF = Graphic3d_BSDF::CreateGlass(Graphic3d_Vec3(1.f), Graphic3d_Vec3(0.95f, 0.95f, 0.95f), 0.05f,
                                               RefractionIndex);
            TransparencyCoef = 0.80f;
...
// purpose  :
// =======================================================================
Graphic3d_MaterialAspect::Graphic3d_MaterialAspect() : myRequestedMaterialName(Graphic3d_NameOfMaterial_DEFAULT) {
...
void Graphic3d_MaterialAspect::SetColor(const Quantity_Color& theColor) {
    ...
    if (myMaterialName != Graphic3d_NameOfMaterial_UserDefined &&
        (!myColors[Graphic3d_TOR_AMBIENT].IsEqual(anAmbient) || !myColors[Graphic3d_TOR_DIFFUSE].IsEqual(aDiffuse))) {
        setUserMaterial();
    }
...
void Graphic3d_MaterialAspect::SetAmbientColor(const Quantity_Color& theColor) {
    if (myMaterialType == Graphic3d_MATERIAL_PHYSIC && myMaterialName != Graphic3d_NameOfMaterial_UserDefined &&
