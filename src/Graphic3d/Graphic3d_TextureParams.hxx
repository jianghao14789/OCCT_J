...
public:
    ...
    Standard_EXPORT void SetGenMode(const Graphic3d_TypeOfTextureMode theMode, const Graphic3d_Vec4 thePlaneS,
    ...
    unsigned int SamplerRevision() const {
        return mySamplerRevision;
    }

private:
    //! Increment revision.
    void updateSamplerRevision() {
        ++mySamplerRevision;
    }
...
private:
    ...
    Graphic3d_TextureUnit
        myTextureUnit; //!< default texture unit to bind texture; Graphic3d_TextureUnit_BaseColor by default
