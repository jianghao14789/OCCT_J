...
//! Transform Persistence Mode defining whether to lock in object position, rotation and / or zooming relative to camera
//! position.
enum Graphic3d_TransModeFlags {
    ...
    Graphic3d_TMF_TriedronPers = 0x0020, //!< object behaves like trihedron - it is fixed at the corner of view and does
                                         //!< not resizing (but rotating)
    Graphic3d_TMF_2d =
        0x0040, //!< object is defined in 2D screen coordinates (pixels) and does not resize, pan and rotate
