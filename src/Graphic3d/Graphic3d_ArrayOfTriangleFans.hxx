...
public:
    ...
    Graphic3d_ArrayOfTriangleFans(Standard_Integer theMaxVertexs, Standard_Integer theMaxFans,
    ...
    //! @param theMaxVertexs defines the maximum allowed vertex number in the array
    //! @param theMaxFans    defines the maximum allowed fan    number in the array
    Graphic3d_ArrayOfTriangleFans(Standard_Integer theMaxVertexs, Standard_Integer theMaxFans = 0,
        ...
        : Graphic3d_ArrayOfPrimitives(
              Graphic3d_TOPA_TRIANGLEFANS, theMaxVertexs, theMaxFans, 0,
