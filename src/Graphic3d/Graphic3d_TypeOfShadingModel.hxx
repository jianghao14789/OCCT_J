...
enum Graphic3d_TypeOfShadingModel {
    ...
    //! Lighting is calculated per-fragment basing on nodal normal (normal is interpolated across fragments of
    //! triangle). This shading model requires normals to be defined within vertex attributes.
