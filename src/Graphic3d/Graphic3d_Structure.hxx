...
public:
    ...
    //! Marks the structure <me> representing wired structure needed for highlight only so it won't be added to BVH
    //! tree.
    ...
    Standard_EXPORT void Connect(Graphic3d_Structure* theStructure, Graphic3d_TypeOfConnection theType,
                                 Standard_Boolean theWithCheck = Standard_False);

    Standard_DEPRECATED("Deprecated short-cut") void Connect(const Handle(Graphic3d_Structure) & thePrs) {
    ...
    Standard_DEPRECATED("Deprecated alias for Disconnect()") void Remove(const Handle(Graphic3d_Structure) & thePrs) {
        Disconnect(thePrs.get());
    }
    ...
    Standard_DEPRECATED("Deprecated alias for DisconnectAll()") void RemoveAll() {
    ...
    Standard_EXPORT static void Network(Graphic3d_Structure* theStructure, const Graphic3d_TypeOfConnection theType,
    ...
    Standard_Boolean IsMutable() const {
        return !myCStructure.IsNull() && myCStructure->IsMutable;
    }
    ...
    Standard_EXPORT void Remove(Graphic3d_Structure* thePtr, const Graphic3d_TypeOfConnection theType);
    ...
    void SetComputeVisual(const Graphic3d_TypeOfStructure theVisual) {
        ...
        // This declaration permits to calculate proper representation of the structure calculated by Compute instead of
        // passage to TOS_COMPUTED.
    ...
    Standard_EXPORT static void Transforms(const gp_Trsf& theTrsf, const Standard_Real theX, const Standard_Real theY,
...
protected:
    ...
    Standard_EXPORT static void TransformBoundaries(const gp_Trsf& theTrsf, Standard_Real& theXMin,
                                                    Standard_Real& theYMin, Standard_Real& theZMin,
                                                    Standard_Real& theXMax, Standard_Real& theYMax,
