...
enum Graphic3d_FrameStatsCounter {
    ...
    Graphic3d_FrameStatsCounter_NbPointsNotCulled,     //!< number of not culled (as structure) points
                                                   // Graphic3d_FrameStatsCounter_NbGlyphsNotCulled,    //!< number
                                                   // glyphs, to be considered in future
    ...
    Graphic3d_FrameStatsCounter_NbElemsFillImmediate,  //!< number of OpenGl_PrimitiveArray drawing triangles in
                                                       //!< immediate layer
    Graphic3d_FrameStatsCounter_NbElemsLineImmediate,  //!< number of OpenGl_PrimitiveArray drawing lines in immediate
                                                       //!< layer
    Graphic3d_FrameStatsCounter_NbElemsPointImmediate, //!< number of OpenGl_PrimitiveArray drawing points in immediate
                                                       //!< layer
