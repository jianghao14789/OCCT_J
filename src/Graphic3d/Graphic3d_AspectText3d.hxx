...
public:
    ...
    Standard_EXPORT Graphic3d_AspectText3d(const Quantity_Color& theColor, Standard_CString theFont,
                                           Standard_Real theExpansionFactor, Standard_Real theSpace,
    ...
    Standard_ShortReal GetTextAngle() const {
        return myTextAngle;
    }
