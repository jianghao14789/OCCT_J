...
public:
    ...
    //! Note that this flag is designed for usage with - custom shader program may discard fragment regardless this
    //! flag.
    void SetAlphaTest(Standard_Boolean theAlphaTest) {
        myHasAlphaTest = theAlphaTest;
    }

    //! Return TRUE if standard program header should define default texture sampler occSampler0; TRUE by default for
    //! compatibility.
    Standard_Boolean HasDefaultSampler() const {
        return myHasDefSampler;
    }
    ...
    template <class T> Standard_Boolean PushVariable(const TCollection_AsciiString& theName, const T& theValue);
...
// =======================================================================
template <class T>
inline Standard_Boolean Graphic3d_ShaderProgram::PushVariable(const TCollection_AsciiString& theName,
                                                              const T& theValue) {
