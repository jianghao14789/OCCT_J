...
public:
    ...
    Standard_EXPORT static Handle(Graphic3d_MarkerImage)
        StandardMarker(const Aspect_TypeOfMarker theMarkerType, const Standard_ShortReal theScale,
...
public:
    ...
    //! If an instance of the class has been initialized with image, it will be converted to bitmap based on the
    //! parameter theAlphaValue.
    ...
    Standard_EXPORT Handle(TColStd_HArray1OfByte)
        GetBitMapArray(const Standard_Real theAlphaValue = 0.5, const Standard_Boolean theIsTopDown = false) const;
