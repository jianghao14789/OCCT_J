...
void HeaderSection_FileDescription::Init(const Handle(Interface_HArray1OfHAsciiString) & aDescription,
...
void HeaderSection_FileDescription::SetImplementationLevel(const Handle(TCollection_HAsciiString) &
