...
XmlTObjDrivers_ObjectDriver::XmlTObjDrivers_ObjectDriver(const Handle(Message_Messenger) & theMessageDriver)
...
Standard_Boolean XmlTObjDrivers_ObjectDriver::Paste(const XmlObjMgt_Persistent& Source,
    ...
    if (XmlObjMgt::GetExtendedString(Source, aString)) {
        ...
        Handle(TObj_Object) anObject = TObj_Persistence::CreateNewObject(anAscii.ToCString(), Target->Label());
...
void XmlTObjDrivers_ObjectDriver::Paste(const Handle(TDF_Attribute) & Source, XmlObjMgt_Persistent& Target,
