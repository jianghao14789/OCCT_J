...
XmlTObjDrivers_ReferenceDriver::XmlTObjDrivers_ReferenceDriver(const Handle(Message_Messenger) & theMessageDriver)
...
Standard_Boolean XmlTObjDrivers_ReferenceDriver::Paste(const XmlObjMgt_Persistent& Source,
...
void XmlTObjDrivers_ReferenceDriver::Paste(const Handle(TDF_Attribute) & Source, XmlObjMgt_Persistent& Target,
