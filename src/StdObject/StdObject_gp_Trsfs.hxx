...
inline StdObjMgt_ReadData& operator>>(StdObjMgt_ReadData& theReadData, gp_Mat& theMat) {
    StdObjMgt_ReadData::ObjectSentry aSentry(theReadData);
    theReadData >> theMat(1, 1) >> theMat(1, 2) >> theMat(1, 3) >> theMat(2, 1) >> theMat(2, 2) >> theMat(2, 3) >>
...
inline StdObjMgt_WriteData& operator<<(StdObjMgt_WriteData& theWriteData, const gp_Mat& theMat) {
    ...
    theWriteData << theMat(1, 1) << theMat(1, 2) << theMat(1, 3) << theMat(2, 1) << theMat(2, 2) << theMat(2, 3)
                 << theMat(3, 1) << theMat(3, 2) << theMat(3, 3);
    return theWriteData;
}
...
inline StdObjMgt_ReadData& operator>>(StdObjMgt_ReadData& theReadData, gp_Trsf2d& theTrsf) {
    ...
    theTrsf.SetValues(aScale * aMat(1, 1), aScale * aMat(1, 2), aLoc.X(), aScale * aMat(2, 1), aScale * aMat(2, 2),
                      aLoc.Y());
...
inline StdObjMgt_ReadData& operator>>(StdObjMgt_ReadData& theReadData, gp_Trsf& theTrsf) {
    ...
    theTrsf.SetValues(aScale * aMat(1, 1), aScale * aMat(1, 2), aScale * aMat(1, 3), aLoc.X(), aScale * aMat(2, 1),
                      aScale * aMat(2, 2), aScale * aMat(2, 3), aLoc.Y(), aScale * aMat(3, 1), aScale * aMat(3, 2),
                      aScale * aMat(3, 3), aLoc.Z());
