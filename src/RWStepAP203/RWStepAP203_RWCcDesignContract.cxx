...
void RWStepAP203_RWCcDesignContract::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
    ...
    data->ReadEntity(num, 1, "contract_assignment.assigned_contract", ach, STANDARD_TYPE(StepBasic_Contract),
