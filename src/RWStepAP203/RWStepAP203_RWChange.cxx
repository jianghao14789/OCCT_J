...
void RWStepAP203_RWChange::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                    Handle(Interface_Check) & ach, const Handle(StepAP203_Change) & ent) const {
...
void RWStepAP203_RWChange::WriteStep(StepData_StepWriter& SW, const Handle(StepAP203_Change) & ent) const {
...
void RWStepAP203_RWChange::Share(const Handle(StepAP203_Change) & ent, Interface_EntityIterator& iter) const {
