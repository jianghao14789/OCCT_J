...
void RWStepAP203_RWStartWork::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                       Handle(Interface_Check) & ach, const Handle(StepAP203_StartWork) & ent) const {
    ...
    data->ReadEntity(num, 1, "action_assignment.assigned_action", ach, STANDARD_TYPE(StepBasic_Action),
...
void RWStepAP203_RWStartWork::WriteStep(StepData_StepWriter& SW, const Handle(StepAP203_StartWork) & ent) const {
...
void RWStepAP203_RWStartWork::Share(const Handle(StepAP203_StartWork) & ent, Interface_EntityIterator& iter) const {
