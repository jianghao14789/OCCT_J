...
void RWStepAP203_RWCcDesignDateAndTimeAssignment::ReadStep(const Handle(StepData_StepReaderData) & data,
    ...
    data->ReadEntity(num, 1, "date_and_time_assignment.assigned_date_and_time", ach,
                     STANDARD_TYPE(StepBasic_DateAndTime), aDateAndTimeAssignment_AssignedDateAndTime);

    Handle(StepBasic_DateTimeRole) aDateAndTimeAssignment_Role;
    data->ReadEntity(num, 2, "date_and_time_assignment.role", ach, STANDARD_TYPE(StepBasic_DateTimeRole),
