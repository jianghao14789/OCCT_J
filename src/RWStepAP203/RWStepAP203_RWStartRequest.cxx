...
void RWStepAP203_RWStartRequest::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
    ...
    data->ReadEntity(num, 1, "action_request_assignment.assigned_action_request", ach,
                     STANDARD_TYPE(StepBasic_VersionedActionRequest), aActionRequestAssignment_AssignedActionRequest);
...
void RWStepAP203_RWStartRequest::WriteStep(StepData_StepWriter& SW, const Handle(StepAP203_StartRequest) & ent) const {
