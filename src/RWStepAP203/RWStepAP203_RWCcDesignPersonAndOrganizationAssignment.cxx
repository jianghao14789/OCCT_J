...
void RWStepAP203_RWCcDesignPersonAndOrganizationAssignment::ReadStep(
    ...
    data->ReadEntity(num, 1, "person_and_organization_assignment.assigned_person_and_organization", ach,
    ...
    data->ReadEntity(num, 2, "person_and_organization_assignment.role", ach,
                     STANDARD_TYPE(StepBasic_PersonAndOrganizationRole), aPersonAndOrganizationAssignment_Role);
    ...
    // Initialize entity
    ent->Init(aPersonAndOrganizationAssignment_AssignedPersonAndOrganization, aPersonAndOrganizationAssignment_Role,
              aItems);
}
...
void RWStepAP203_RWCcDesignPersonAndOrganizationAssignment::WriteStep(
    StepData_StepWriter& SW, const Handle(StepAP203_CcDesignPersonAndOrganizationAssignment) & ent) const {
...
void RWStepAP203_RWCcDesignPersonAndOrganizationAssignment::Share(
    const Handle(StepAP203_CcDesignPersonAndOrganizationAssignment) & ent, Interface_EntityIterator& iter) const {
