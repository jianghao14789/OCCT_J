...
public:
    ...
    Standard_EXPORT static Standard_Boolean Lin(const TopoDS_Edge& e, gp_Lin& l, Standard_Boolean& infinite,
                                                Standard_Real& first, Standard_Real& last);

    //! false if <e> is not a circular edge
    Standard_EXPORT static Standard_Boolean Circ(const TopoDS_Edge& e, gp_Circ& l, Standard_Real& first,
                                                 Standard_Real& last);
