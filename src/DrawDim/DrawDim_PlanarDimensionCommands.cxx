...
static Standard_Integer DrawDim_DISTANCE(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 1) {
...
void DrawDim::PlanarDimensionCommands(Draw_Interpretor& theCommands) {
    ...
    theCommands.Add("center", "to extract center of a circle : center ,name, circle", __FILE__, DrawDim_CENTER);
