...
// purpose  : Constructor
//=======================================================================
BinMDataXtd_PositionDriver::BinMDataXtd_PositionDriver(const Handle(Message_Messenger) & theMsgDriver)
...
void BinMDataXtd_PositionDriver::Paste(const Handle(TDF_Attribute) & theSource, BinObjMgt_Persistent& theTarget,
