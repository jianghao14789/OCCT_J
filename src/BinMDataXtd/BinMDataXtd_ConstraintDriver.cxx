...
// purpose  : Constructor
//=======================================================================
BinMDataXtd_ConstraintDriver::BinMDataXtd_ConstraintDriver(const Handle(Message_Messenger) & theMsgDriver)
...
Standard_Boolean BinMDataXtd_ConstraintDriver::Paste(const BinObjMgt_Persistent& theSource,
    ...
    if (!(theSource >> NbGeom)) return Standard_False;
    ...
    if (!(theSource >> aType)) return Standard_False;
    aC->SetType((TDataXtd_ConstraintEnum)aType);

    // flags
    Standard_Integer flags;
    if (!(theSource >> flags)) return Standard_False;
...
//=======================================================================
void BinMDataXtd_ConstraintDriver::Paste(const Handle(TDF_Attribute) & theSource, BinObjMgt_Persistent& theTarget,
