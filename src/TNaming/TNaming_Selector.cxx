                        ...
                        if (!shapesOfContext.Contains(it.Key())) {
                            ...
                            for (; itC.More(); itC.Next())
                                std::cout << " ShapeType = " << itC.Key().ShapeType()
                                          << " TShape = " << itC.Key().TShape() << " OR = " << itC.Key().Orientation()
                                          << std::endl;
...
static void FindGenerated(const Handle(TNaming_NamedShape) & NS, const TopoDS_Shape& S, TopTools_ListOfShape& theList)
...
// purpose  :
//=======================================================================
Standard_Boolean TNaming_Selector::IsIdentified(const TDF_Label& L, const TopoDS_Shape& Selection,
                                                Handle(TNaming_NamedShape) & NS, const Standard_Boolean Geometry) {
...
// purpose  :
//=======================================================================
Standard_Boolean TNaming_Selector::Select(const TopoDS_Shape& Selection, const TopoDS_Shape& Context,
    ...
    */
...
#ifdef OCCT_DEBUG_SEL
    std::cout << "SELECTION ORIENTATION = " << Selection.Orientation() << ", TShape = " << Selection.TShape()
              << std::endl;
    // std::cout << "SELECTION ORIENTATION = " << selection.Orientation() <<", TShape = " << selection.TShape()
    // <<std::endl;
    ...
    if (!Selection.IsSame(aSelection) && Selection.ShapeType() != TopAbs_COMPOUND) {
        ...
        std::cout << "Selection is Not Same (NSLabel = " << entry << "): TShape1 = " << Selection.TShape()->This()
...
// purpose  :
//=======================================================================
Standard_Boolean TNaming_Selector::Select(const TopoDS_Shape& Selection, const Standard_Boolean Geometry,
                                          const Standard_Boolean KeepOrientation) const {
