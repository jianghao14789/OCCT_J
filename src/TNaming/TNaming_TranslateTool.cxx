...
void TNaming_TranslateTool::UpdateVertex(const TopoDS_Shape& S1, TopoDS_Shape& S2,
    ...
    while (itpr.More()) {
        ...
        if (PR1->IsPointOnCurve()) {                                               // pointOnCurve (1)
            Handle(BRep_PointOnCurve) OC = new BRep_PointOnCurve(PR1->Parameter(), // the same geometry
            ...
            Handle(BRep_PointOnCurveOnSurface) OCS = new BRep_PointOnCurveOnSurface(
                PR1->Parameter(), PR1->PCurve(), PR1->Surface(), TNaming_CopyShape::Translate(PR1->Location(), aMap));
            PR2 = OCS;
        }
            ...
            Handle(BRep_PointOnSurface) OS =
                new BRep_PointOnSurface(PR1->Parameter(), PR1->Parameter2(), PR1->Surface(),
                                        TNaming_CopyShape::Translate(PR1->Location(), aMap));
            PR2 = OS;
        }
...
void TNaming_TranslateTool::UpdateEdge(const TopoDS_Shape& S1, TopoDS_Shape& S2,
                                       TColStd_IndexedDataMapOfTransientTransient& aMap) const {
...
void TNaming_TranslateTool::UpdateFace(const TopoDS_Shape& S1, TopoDS_Shape& S2,
                                       TColStd_IndexedDataMapOfTransientTransient& aMap) const {
