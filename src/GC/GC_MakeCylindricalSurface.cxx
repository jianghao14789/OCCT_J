...
GC_MakeCylindricalSurface::GC_MakeCylindricalSurface(const gp_Pnt& P1, const gp_Pnt& P2, const gp_Pnt& P3) {
...
GC_MakeCylindricalSurface::GC_MakeCylindricalSurface(const gp_Cylinder& Cyl, const Standard_Real Dist) {
    TheError = gce_Done;
