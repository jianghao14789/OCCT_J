...
// purpose  :
//=======================================================================
void StdPrs_HLRShape::ComputeHLR(const Handle(Prs3d_Presentation) & thePresentation, const TopoDS_Shape& theShape,
    ...
    for (anI = 1; anI <= aNbEdges; ++anI) {
        for (aTool.InitVisible(anI); aTool.MoreVisible(); aTool.NextVisible()) {
            ...
            StdPrs_DeflectionCurve::Add(thePresentation, aCurve, anU1, anU2, aDeviation, aPoints, anAngle);
        }
    }
