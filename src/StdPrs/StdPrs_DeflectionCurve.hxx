...
public:
    ...
    Standard_EXPORT static void Add(const Handle(Prs3d_Presentation) & aPresentation, Adaptor3d_Curve& aCurve,
    ...
    Standard_EXPORT static void Add(const Handle(Prs3d_Presentation) & aPresentation, Adaptor3d_Curve& aCurve,
                                    ...
                                    TColgp_SequenceOfPnt& Points, const Standard_Boolean drawCurve = Standard_True);
    ...
    Standard_EXPORT static void Add(const Handle(Prs3d_Presentation) & aPresentation, Adaptor3d_Curve& aCurve,
                                    ...
                                    TColgp_SequenceOfPnt& Points, const Standard_Real anAngle = 0.2,
                                    const Standard_Boolean drawCurve = Standard_True);
    ...
    Standard_EXPORT static Standard_Boolean Match(const Standard_Real X, const Standard_Real Y, const Standard_Real Z,
    ...
    Standard_EXPORT static Standard_Boolean Match(const Standard_Real theX, const Standard_Real theY,
                                                  const Standard_Real theZ, const Standard_Real theDistance,
                                                  const Adaptor3d_Curve& theCurve, const Standard_Real theDeflection,
                                                  const Standard_Real theLimit, const Standard_Real theAngle);
    ...
    Standard_EXPORT static Standard_Boolean Match(const Standard_Real theX, const Standard_Real theY,
                                                  const Standard_Real theZ, const Standard_Real theDistance,
                                                  const Adaptor3d_Curve& theCurve, const Standard_Real theU1,
                                                  const Standard_Real theU2, const Standard_Real theDeflection,
