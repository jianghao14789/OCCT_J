...
public:
    ...
    Standard_EXPORT TopoDS_Shape Perform(StdPrs_BRepFont& theFont, const Handle(Font_TextFormatter) & theFormatter,
    ...
    //! @return result shape with pen transformation applied as shape location
    Standard_EXPORT TopoDS_Shape Perform(StdPrs_BRepFont& theFont, const NCollection_String& theString,
                                         const gp_Ax3& thePenLoc = gp_Ax3(),
