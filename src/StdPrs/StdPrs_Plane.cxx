...
void StdPrs_Plane::Add(const Handle(Prs3d_Presentation) & aPresentation, const Adaptor3d_Surface& aPlane,
...
Standard_Boolean StdPrs_Plane::Match(const Standard_Real X, const Standard_Real Y, const Standard_Real Z,
