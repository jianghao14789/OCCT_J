...
Standard_Boolean StdPrs_ToolTriangulatedShape::IsClosed(const TopoDS_Shape& theShape) {
    ...
    switch (theShape.ShapeType()) {
        ...
        case TopAbs_SOLID: {
            ...
            // inside the shape
            if (!BRep_Tool::IsClosed(theShape)) return Standard_False;
...
// purpose  :
//=======================================================================
void StdPrs_ToolTriangulatedShape::Normal(const TopoDS_Face& theFace, Poly_Connect& thePolyConnect,
...
Standard_Real StdPrs_ToolTriangulatedShape::GetDeflection(const TopoDS_Shape& theShape,
    ...
    // store computed relative deflection of shape as absolute deviation coefficient in case relative type to use it
    // later on for sub-shapes
    const Standard_Real aDeflection =
        Prs3d::GetDeflection(aBndBox, theDrawer->DeviationCoefficient(), theDrawer->MaximalChordialDeviation());
