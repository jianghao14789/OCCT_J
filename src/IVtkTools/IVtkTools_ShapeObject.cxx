...
//          information object by key.
//============================================================================
vtkSmartPointer<IVtkTools_ShapeDataSource> IVtkTools_ShapeObject ::GetShapeSource(vtkActor* theActor) {
    ...
    if (anInfo.GetPointer() != NULL) {
        KeyPtr aKey = getKey();
        if (aKey->Has(anInfo)) {
            vtkSmartPointer<IVtkTools_ShapeObject> aShapeObj = IVtkTools_ShapeObject::SafeDownCast(aKey->Get(anInfo));
...
//          object with key.
//============================================================================
void IVtkTools_ShapeObject::SetShapeSource(IVtkTools_ShapeDataSource* theDataSource, vtkDataSet* theDataSet) {
...
//          object with key.
//============================================================================
void IVtkTools_ShapeObject::SetShapeSource(IVtkTools_ShapeDataSource* theDataSource, vtkActor* theActor) {
