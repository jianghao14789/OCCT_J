...
vtkStandardNewMacro(IVtkTools_DisplayModeFilter)
    ...
    : myDisplayMode(DM_Wireframe), myDoDisplaySharedVertices(false), myDrawFaceBoundaries(false),
...
//          parts types.
//============================================================================
int IVtkTools_DisplayModeFilter::RequestData(vtkInformation* theRequest, vtkInformationVector** theInputVector,
