...
public: //! @name Constructor
    //! Constructor
    BVH_PairDistance()
        : BVH_PairTraverse<NumType, Dimension, BVHSetType, NumType>(), myDistance(std::numeric_limits<NumType>::max()),
...
public: //! @name Definition of the rules for tree descend
    ...
    virtual Standard_Boolean IsMetricBetter(const NumType& theLeft, const NumType& theRight) const Standard_OVERRIDE {
    ...
    virtual Standard_Boolean RejectNode(const BVH_VecNt& theCornerMin1, const BVH_VecNt& theCornerMax1,
        ...
        theMetric = BVH_Tools<NumType, Dimension>::BoxBoxSquareDistance(theCornerMin1, theCornerMax1, theCornerMin2,
                                                                        theCornerMax2);
