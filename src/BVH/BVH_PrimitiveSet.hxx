...
template <class T, int N> class BVH_PrimitiveSet : public BVH_Object<T, N>, public BVH_Set<T, N> {
protected:
...
public:
    ...
    BVH_PrimitiveSet()
        : myBVH(new BVH_Tree<T, N>()),
          ...
          myBuilder(new BVH_BinnedBuilder<T, N, BVH_Constants_NbBinsBest>(BVH_Constants_LeafNodeSizeDefault,
    ...
    BVH_PrimitiveSet(const opencascade::handle<BVH_Builder<T, N>>& theBuilder)
        : myBVH(new BVH_Tree<T, N>()), myBuilder(theBuilder) {
        //
    }
