...
template <class T, int N> class BVH_TreeBase : public BVH_TreeBaseTransient {
...
public: //! @name methods for accessing serialized tree data
    ...
    virtual void DumpNode(const int theNodeIndex, Standard_OStream& theOStream,
...
template <class T, int N, class Arity = BVH_BinaryTree> class BVH_Tree {
    // Invalid type
};
