...
//!     Standard_Real aDist = BVH_Tools<Standard_Real, 3>::PointTriangleSquareDistance (myObject, aTri.Node1,
//!     aTri.Node2, aTri.Node3); if (aDist < myDistance)
//!     {
//!       myDistance = aDist;
...
template <class MetricType> class BVH_BaseTraverse {
...
public: //! @name Constructor
    //! Constructor
    BVH_Traverse() : BVH_BaseTraverse<MetricType>(), myBVHSet(NULL) {}
...
public: //! @name Rules for Accept/Reject
    ...
    virtual Standard_Boolean RejectNode(const BVH_VecNt& theCornerMin, const BVH_VecNt& theCornerMax,
...
public: //! @name Constructor
    //! Constructor
    BVH_PairTraverse() : BVH_BaseTraverse<MetricType>(), myBVHSet1(NULL), myBVHSet2(NULL) {}
...
public: //! @name Rules for Accept/Reject
    ...
    virtual Standard_Boolean RejectNode(const BVH_VecNt& theCornerMin1, const BVH_VecNt& theCornerMax1,
                                        const BVH_VecNt& theCornerMin2, const BVH_VecNt& theCornerMax2,
                                        MetricType& theMetric) const = 0;
