...
protected:
    ...
    BVH_BuilderTransient(const Standard_Integer theLeafNodeSize, const Standard_Integer theMaxTreeDepth)
        : myMaxTreeDepth(theMaxTreeDepth), myLeafNodeSize(theLeafNodeSize), myIsParallel(Standard_False) {}
...
template <class T, int N> class BVH_Builder : public BVH_BuilderTransient {
public:
