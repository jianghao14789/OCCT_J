...
// purpose  :
//======================================================================
BiTgte_CurveOnVertex::BiTgte_CurveOnVertex() : myFirst(0.0), myLast(0.0) {}
...
BiTgte_CurveOnVertex::BiTgte_CurveOnVertex(const TopoDS_Edge& theEonF, const TopoDS_Vertex& theVertex)
...
Handle(Adaptor3d_Curve) BiTgte_CurveOnVertex::Trim(const Standard_Real, const Standard_Real,
