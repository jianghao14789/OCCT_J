...
private:
    ...
    void addVertex(const TopoDS_Vertex& theVertex, const IVtk_IdType theShapeId, const IVtk_MeshType theMeshType);
    ...
    void addEdge(const TopoDS_Edge& theEdge, const IVtk_IdType theShapeId, const IVtk_MeshType theMeshType);
    ...
    void addWFFace(const TopoDS_Face& theFace, const IVtk_IdType theShapeId, const Standard_Real theDeflection);
