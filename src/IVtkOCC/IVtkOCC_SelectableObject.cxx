...
IVtkOCC_SelectableObject::IVtkOCC_SelectableObject(const IVtkOCC_Shape::Handle& theShape)
    : SelectMgr_SelectableObject(PrsMgr_TOP_AllView), myShape(theShape) {
    if (!myShape.IsNull()) {
...
// Purpose:
//============================================================================
IVtkOCC_SelectableObject::IVtkOCC_SelectableObject() : SelectMgr_SelectableObject(PrsMgr_TOP_AllView) {
    //
}
...
void IVtkOCC_SelectableObject::ComputeSelection(const Handle(SelectMgr_Selection) & theSelection,
    ...
    try {
        OCC_CATCH_SIGNALS
        StdSelect_BRepSelectionTool::Load(theSelection, this, anOcctShape, aTypeOfSel, aDeflection,
                                          aDrawer->DeviationAngle(), aDrawer->IsAutoTriangulation());
    } catch (const Standard_Failure& anException) {
        Message::SendFail(TCollection_AsciiString("Error: IVtkOCC_SelectableObject::ComputeSelection(") + theMode +
