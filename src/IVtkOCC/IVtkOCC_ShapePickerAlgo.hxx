...
public: //! @name Set selectable shapes and selection modes
    ...
    Standard_EXPORT virtual void SetSelectionMode(const IVtk_IShape::Handle& theShape, const IVtk_SelectionMode theMode,
    ...
    //! @param [in] theMode Selection mode to be activated
    //! @param [in] theIsTurnOn Flag to turn on/off the selection mode
    Standard_EXPORT virtual void SetSelectionMode(const IVtk_ShapePtrList& theShapes, const IVtk_SelectionMode theMode,
                                                  const bool theIsTurnOn = true) Standard_OVERRIDE;

public: //! @name Picking methods
    Standard_EXPORT virtual bool Pick(const double theX, const double theY) Standard_OVERRIDE;

    Standard_EXPORT virtual bool Pick(const double theXMin, const double theYMin, const double theXMax,
...
public: //! @name Obtain picking results
    ...
    Standard_EXPORT virtual void SubShapesPicked(const IVtk_IdType theId,
                                                 IVtk_ShapeIdList& theShapeList) const Standard_OVERRIDE;
    ...
    const gp_Pnt& TopPickedPoint() const {
        return myTopPickedPoint;
    }
