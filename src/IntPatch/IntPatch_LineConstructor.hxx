...
public:
    ...
    Standard_EXPORT void Perform(const IntPatch_SequenceOfLine& SL, const Handle(IntPatch_Line) & L,
                                 const Handle(Adaptor3d_Surface) & S1, const Handle(Adaptor3d_TopolTool) & D1,
