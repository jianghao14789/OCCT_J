...
public:
    ...
    Standard_EXPORT IntPatch_Polyhedron(const Handle(Adaptor3d_Surface) & Surface, const Standard_Integer nbdU,
    ...
    Standard_EXPORT void Perform(const Handle(Adaptor3d_Surface) & Surface, const Standard_Integer nbdU,
                                 const Standard_Integer nbdV);
