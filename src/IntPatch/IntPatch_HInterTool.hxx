...
public:
    ...
    Standard_EXPORT static Standard_Integer NbSamplesV(const Handle(Adaptor3d_Surface) & S, const Standard_Real v1,
                                                       const Standard_Real v2);

    Standard_EXPORT Standard_Integer NbSamplePoints(const Handle(Adaptor3d_Surface) & S);

    Standard_EXPORT void SamplePoint(const Handle(Adaptor3d_Surface) & S, const Standard_Integer Index,
    ...
    Standard_EXPORT static void Bounds(const Handle(Adaptor2d_Curve2d) & C, Standard_Real& Ufirst,
                                       Standard_Real& Ulast);
    ...
    //! are not significant.
    Standard_EXPORT static Standard_Boolean Project(const Handle(Adaptor2d_Curve2d) & C, const gp_Pnt2d& P,
    ...
    Standard_EXPORT static void Value(const Handle(Adaptor2d_Curve2d) & C, const Standard_Integer Index, gp_Pnt& Pt,
                                      Standard_Real& Tol, Standard_Real& U);
    ...
    //! vertex on the arc A.
    Standard_EXPORT static void Vertex(const Handle(Adaptor2d_Curve2d) & C, const Standard_Integer Index,
    ...
    Standard_EXPORT static Standard_Boolean HasFirstPoint(const Handle(Adaptor2d_Curve2d) & C,
                                                          const Standard_Integer Index, Standard_Integer& IndFirst);
    ...
    Standard_EXPORT static Standard_Boolean HasLastPoint(const Handle(Adaptor2d_Curve2d) & C,
                                                         const Standard_Integer Index, Standard_Integer& IndLast);
