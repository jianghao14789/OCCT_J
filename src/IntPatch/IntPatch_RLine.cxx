...
IntPatch_RLine::IntPatch_RLine(const Standard_Boolean Tang, const IntSurf_TypeTrans Trans1,
                               const IntSurf_TypeTrans Trans2)
    : IntPatch_PointLine(Tang, Trans1, Trans2), ParamInf1(0.0), ParamSup1(0.0), ParamInf2(0.0), ParamSup2(0.0),
...
IntPatch_RLine::IntPatch_RLine(const Standard_Boolean Tang, const IntSurf_Situation Situ1,
                               const IntSurf_Situation Situ2)
    : IntPatch_PointLine(Tang, Situ1, Situ2), ParamInf1(0.0), ParamSup1(0.0), ParamInf2(0.0), ParamSup2(0.0),
      fipt(Standard_False), lapt(Standard_False), indf(0), indl(0) {
    typ = IntPatch_Restriction;
    onS2 = Standard_False;
    onS1 = Standard_False;
...
IntPatch_RLine::IntPatch_RLine(const Standard_Boolean Tang)
    : IntPatch_PointLine(Tang), ParamInf1(0.0), ParamSup1(0.0), ParamInf2(0.0), ParamSup2(0.0), fipt(Standard_False),
