...
public:
    ...
    Standard_EXPORT static Standard_Real CurvatureRadiusOfIntersLine(const Handle(Adaptor3d_Surface) & theS1,
...
protected:
    ...
    //! are In or Out.
    Standard_EXPORT IntPatch_PointLine(const Standard_Boolean Tang, const IntSurf_TypeTrans Trans1,
                                       const IntSurf_TypeTrans Trans2);

    //! To initialize the fields, when the transitions
    //! are Touch.
    Standard_EXPORT IntPatch_PointLine(const Standard_Boolean Tang, const IntSurf_Situation Situ1,
