...
public:
    ...
    Standard_EXPORT static Handle(IntPatch_WLine)
        ComputePurgedWLine(const Handle(IntPatch_WLine) & theWLine, const Handle(Adaptor3d_Surface) & theS1,
    ...
    Standard_EXPORT static void JoinWLines(IntPatch_SequenceOfLine& theSlin, IntPatch_SequenceOfPoint& theSPnt,
    ...
    Standard_EXPORT static void ExtendTwoWLines(IntPatch_SequenceOfLine& theSlin,
