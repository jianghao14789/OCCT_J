...
public:
    ...
    Standard_EXPORT IntPatch_TheIWalking(const Standard_Real Epsilon, const Standard_Real Deflection,
    ...
    Standard_EXPORT void Perform(const IntSurf_SequenceOfPathPoint& Pnts1, const IntSurf_SequenceOfInteriorPoint& Pnts2,
                                 IntPatch_TheSurfFunction& Func, const Handle(Adaptor3d_Surface) & S,
                                 const Standard_Boolean Reversed = Standard_False);

    //! Searches a set of polylines starting on a point of Pnts1.
    //! Each point on a resulting polyline verifies F(u,v)=0
    Standard_EXPORT void Perform(const IntSurf_SequenceOfPathPoint& Pnts1, IntPatch_TheSurfFunction& Func,
...
protected:
    ...
    Standard_EXPORT Standard_Boolean TestArretPassage(const TColStd_SequenceOfReal& Umult,
                                                      ...
                                                      IntPatch_TheSurfFunction& Section, math_Vector& UV,
    ...
    Standard_EXPORT Standard_Boolean TestArretAjout(IntPatch_TheSurfFunction& Section, math_Vector& UV,
                                                    Standard_Integer& Irang, IntSurf_PntOn2S& PSol);

    Standard_EXPORT void FillPntsInHoles(IntPatch_TheSurfFunction& Section, TColStd_SequenceOfInteger& CopySeqAlone,
    ...
    Standard_EXPORT void TestArretCadre(const TColStd_SequenceOfReal& Umult, const TColStd_SequenceOfReal& Vmult,
                                        ...
                                        IntPatch_TheSurfFunction& Section, math_Vector& UV, Standard_Integer& Irang);
    ...
    Standard_EXPORT void ComputeOpenLine(const TColStd_SequenceOfReal& Umult, const TColStd_SequenceOfReal& Vmult,
                                         const IntSurf_SequenceOfPathPoint& Pnts1, IntPatch_TheSurfFunction& Section,
    ...
    Standard_EXPORT void ComputeCloseLine(const TColStd_SequenceOfReal& Umult, const TColStd_SequenceOfReal& Vmult,
                                          ...
                                          IntPatch_TheSurfFunction& Section, Standard_Boolean& Rajout);
    ...
    Standard_EXPORT void MakeWalkingPoint(const Standard_Integer Case, const Standard_Real U, const Standard_Real V,
                                          IntPatch_TheSurfFunction& Section, IntSurf_PntOn2S& Psol);
