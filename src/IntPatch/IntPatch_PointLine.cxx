...
IntPatch_PointLine::IntPatch_PointLine(const Standard_Boolean Tang, const IntSurf_TypeTrans Trans1,
                                       const IntSurf_TypeTrans Trans2)
    : IntPatch_Line(Tang, Trans1, Trans2) {}

IntPatch_PointLine::IntPatch_PointLine(const Standard_Boolean Tang, const IntSurf_Situation Situ1,
                                       const IntSurf_Situation Situ2)
    : IntPatch_Line(Tang, Situ1, Situ2) {}

IntPatch_PointLine::IntPatch_PointLine(const Standard_Boolean Tang) : IntPatch_Line(Tang) {}
...
//=======================================================================
Standard_Real IntPatch_PointLine::CurvatureRadiusOfIntersLine(const Handle(Adaptor3d_Surface) & theS1,
  ...
  default:
    ...
    const Standard_Real aF1 =
        aDuS1 * aDuS1 * aDUU1.Dot(aN1) + 2.0 * aDuS1 * aDvS1 * aDUV1.Dot(aN1) + aDvS1 * aDvS1 * aDVV1.Dot(aN1);
    const Standard_Real aF2 =
        aDuS2 * aDuS2 * aDUU2.Dot(aN2) + 2.0 * aDuS2 * aDvS2 * aDUV2.Dot(aN2) + aDvS2 * aDvS2 * aDVV2.Dot(aN2);
    ...
    if (aSqMagnSDer < aSqSmallValue) { // Intersection curve has null curvature in observed point
