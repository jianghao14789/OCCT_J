...
static short int Lhint[2098] = {
    /*18,*/ 19, 19,  19,  19,  20,  20,  20,  21,  21,  21,  22,  22,  22,  23,  23,  23,  23,  24,  24,  24,
    25,         25,  25,  26,  26,  26,  26,  27,  27,  27,  28,  28,  28,  29,  29,  29,  29,  30,  30,  30,
    31,         31,  31,  32,  32,  32,  32,  33,  33,  33,  34,  34,  34,  35,  35,  35,  35,  36,  36,  36,
    37,         37,  37,  38,  38,  38,  38,  39,  39,  39,  40,  40,  40,  41,  41,  41,  41,  42,  42,  42,
    43,         43,  43,  44,  44,  44,  44,  45,  45,  45,  46,  46,  46,  47,  47,  47,  47,  48,  48,  48,
    49,         49,  49,  50,  50,  50,  51,  51,  51,  51,  52,  52,  52,  53,  53,  53,  54,  54,  54,  54,
    55,         55,  55,  56,  56,  56,  57,  57,  57,  57,  58,  58,  58,  59,  59,  59,  60,  60,  60,  60,
    61,         61,  61,  62,  62,  62,  63,  63,  63,  63,  64,  64,  64,  65,  65,  65,  66,  66,  66,  66,
    67,         67,  67,  68,  68,  68,  69,  69,  69,  69,  70,  70,  70,  71,  71,  71,  72,  72,  72,  72,
    73,         73,  73,  74,  74,  74,  75,  75,  75,  75,  76,  76,  76,  77,  77,  77,  78,  78,  78,  78,
    79,         79,  79,  80,  80,  80,  81,  81,  81,  82,  82,  82,  82,  83,  83,  83,  84,  84,  84,  85,
    85,         85,  85,  86,  86,  86,  87,  87,  87,  88,  88,  88,  88,  89,  89,  89,  90,  90,  90,  91,
    91,         91,  91,  92,  92,  92,  93,  93,  93,  94,  94,  94,  94,  95,  95,  95,  96,  96,  96,  97,
    97,         97,  97,  98,  98,  98,  99,  99,  99,  100, 100, 100, 100, 101, 101, 101, 102, 102, 102, 103,
    103,        103, 103, 104, 104, 104, 105, 105, 105, 106, 106, 106, 106, 107, 107, 107, 108, 108, 108, 109,
    109,        109, 110, 110, 110, 110, 111, 111, 111, 112, 112, 112, 113, 113, 113, 113, 114, 114, 114, 115,
    115,        115, 116, 116, 116, 116, 117, 117, 117, 118, 118, 118, 119, 119, 119, 119, 120, 120, 120, 121,
    121,        121, 122, 122, 122, 122, 123, 123, 123, 124, 124, 124, 125, 125, 125, 125, 126, 126, 126, 127,
    127,        127, 128, 128, 128, 128, 129, 129, 129, 130, 130, 130, 131, 131, 131, 131, 132, 132, 132, 133,
    133,        133, 134, 134, 134, 134, 135, 135, 135, 136, 136, 136, 137, 137, 137, 137, 138, 138, 138, 139,
    139,        139, 140, 140, 140, 141, 141, 141, 141, 142, 142, 142, 143, 143, 143, 144, 144, 144, 144, 145,
    145,        145, 146, 146, 146, 147, 147, 147, 147, 148, 148, 148, 149, 149, 149, 150, 150, 150, 150, 151,
    151,        151, 152, 152, 152, 153, 153, 153, 153, 154, 154, 154, 155, 155, 155, 156, 156, 156, 156, 157,
    157,        157, 158, 158, 158, 159, 159, 159, 159, 160, 160, 160, 161, 161, 161, 162, 162, 162, 162, 163,
    163,        163, 164, 164, 164, 165, 165, 165, 165, 166, 166, 166, 167, 167, 167, 168, 168, 168, 169, 169,
    169,        169, 170, 170, 170, 171, 171, 171, 172, 172, 172, 172, 173, 173, 173, 174, 174, 174, 175, 175,
    175,        175, 176, 176, 176, 177, 177, 177, 178, 178, 178, 178, 179, 179, 179, 180, 180, 180, 181, 181,
    181,        181, 182, 182, 182, 183, 183, 183, 184, 184, 184, 184, 185, 185, 185, 186, 186, 186, 187, 187,
    187,        187, 188, 188, 188, 189, 189, 189, 190, 190, 190, 190, 191, 191, 191, 192, 192, 192, 193, 193,
    193,        193, 194, 194, 194, 195, 195, 195, 196, 196, 196, 197, 197, 197, 197, 198, 198, 198, 199, 199,
    199,        200, 200, 200, 200, 201, 201, 201, 202, 202, 202, 203, 203, 203, 203, 204, 204, 204, 205, 205,
    205,        206, 206, 206, 206, 207, 207, 207, 208, 208, 208, 209, 209, 209, 209, 210, 210, 210, 211, 211,
    211,        212, 212, 212, 212, 213, 213, 213, 214, 214, 214, 215, 215, 215, 215, 216, 216, 216, 217, 217,
    217,        218, 218, 218, 218, 219, 219, 219, 220, 220, 220, 221, 221, 221, 221, 222, 222, 222, 223, 223,
    223,        224, 224, 224, 224, 225, 225, 225, 226, 226, 226, 227, 227, 227, 228, 228, 228, 228, 229, 229,
    229,        230, 230, 230, 231, 231, 231, 231, 232, 232, 232, 233, 233, 233, 234, 234, 234, 234, 235, 235,
    235,        236, 236, 236, 237, 237, 237, 237, 238, 238, 238, 239, 239, 239, 240, 240, 240, 240, 241, 241,
    241,        242, 242, 242, 243, 243, 243, 243, 244, 244, 244, 245, 245, 245, 246, 246, 246, 246, 247, 247,
    247,        248, 248, 248, 249, 249, 249, 249, 250, 250, 250, 251, 251, 251, 252, 252, 252, 252, 253, 253,
    253,        254, 254, 254, 255, 255, 255, 256, 256, 256, 256, 257, 257, 257, 258, 258, 258, 259, 259, 259,
    259,        260, 260, 260, 261, 261, 261, 262, 262, 262, 262, 263, 263, 263, 264, 264, 264, 265, 265, 265,
    265,        266, 266, 266, 267, 267, 267, 268, 268, 268, 268, 269, 269, 269, 270, 270, 270, 271, 271, 271,
    271,        272, 272, 272, 273, 273, 273, 274, 274, 274, 274, 275, 275, 275, 276, 276, 276, 277, 277, 277,
    277,        278, 278, 278, 279, 279, 279, 280, 280, 280, 280, 281, 281, 281, 282, 282, 282, 283, 283, 283,
    283,        284, 284, 284, 285, 285, 285, 286, 286, 286, 287, 287, 287, 287, 288, 288, 288, 289, 289, 289,
    290,        290, 290, 290, 291, 291, 291, 292, 292, 292, 293, 293, 293, 293, 294, 294, 294, 295, 295, 295,
    296,        296, 296, 296, 297, 297, 297, 298, 298, 298, 299, 299, 299, 299, 300, 300, 300, 301, 301, 301,
    302,        302, 302, 302, 303, 303, 303, 304, 304, 304, 305, 305, 305, 305, 306, 306, 306, 307, 307, 307,
    308,        308, 308, 308, 309, 309, 309, 310, 310, 310, 311, 311, 311, 311, 312, 312, 312, 313, 313, 313,
    314,        314, 314, 315, 315, 315, 315, 316, 316, 316, 317, 317, 317, 318, 318, 318, 318, 319, 319, 319,
    320,        320, 320, 321, 321, 321, 321, 322, 322, 322, 323, 323, 323, 324, 324, 324, 324, 325, 325, 325,
    326,        326, 326, 327, 327, 327, 327, 328, 328, 328, 329, 329, 329, 330, 330, 330, 330, 331, 331, 331,
    332,        332, 332, 333, 333, 333, 333, 334, 334, 334, 335, 335, 335, 336, 336, 336, 336, 337, 337, 337,
    338,        338, 338, 339, 339, 339, 339, 340, 340, 340, 341, 341, 341, 342, 342, 342, 342, 343, 343, 343,
    344,        344, 344, 345, 345, 345, 346, 346, 346, 346, 347, 347, 347, 348, 348, 348, 349, 349, 349, 349,
    350,        350, 350, 351, 351, 351, 352, 352, 352, 352, 353, 353, 353, 354, 354, 354, 355, 355, 355, 355,
    356,        356, 356, 357, 357, 357, 358, 358, 358, 358, 359, 359, 359, 360, 360, 360, 361, 361, 361, 361,
    362,        362, 362, 363, 363, 363, 364, 364, 364, 364, 365, 365, 365, 366, 366, 366, 367, 367, 367, 367,
    368,        368, 368, 369, 369, 369, 370, 370, 370, 370, 371, 371, 371, 372, 372, 372, 373, 373, 373, 374,
    374,        374, 374, 375, 375, 375, 376, 376, 376, 377, 377, 377, 377, 378, 378, 378, 379, 379, 379, 380,
    380,        380, 380, 381, 381, 381, 382, 382, 382, 383, 383, 383, 383, 384, 384, 384, 385, 385, 385, 386,
    386,        386, 386, 387, 387, 387, 388, 388, 388, 389, 389, 389, 389, 390, 390, 390, 391, 391, 391, 392,
    392,        392, 392, 393, 393, 393, 394, 394, 394, 395, 395, 395, 395, 396, 396, 396, 397, 397, 397, 398,
    398,        398, 398, 399, 399, 399, 400, 400, 400, 401, 401, 401, 402, 402, 402, 402, 403, 403, 403, 404,
    404,        404, 405, 405, 405, 405, 406, 406, 406, 407, 407, 407, 408, 408, 408, 408, 409, 409, 409, 410,
    410,        410, 411, 411, 411, 411, 412, 412, 412, 413, 413, 413, 414, 414, 414, 414, 415, 415, 415, 416,
    416,        416, 417, 417, 417, 417, 418, 418, 418, 419, 419, 419, 420, 420, 420, 420, 421, 421, 421, 422,
    422,        422, 423, 423, 423, 423, 424, 424, 424, 425, 425, 425, 426, 426, 426, 426, 427, 427, 427, 428,
    428,        428, 429, 429, 429, 429, 430, 430, 430, 431, 431, 431, 432, 432, 432, 433, 433, 433, 433, 434,
    434,        434, 435, 435, 435, 436, 436, 436, 436, 437, 437, 437, 438, 438, 438, 439, 439, 439, 439, 440,
    440,        440, 441, 441, 441, 442, 442, 442, 442, 443, 443, 443, 444, 444, 444, 445, 445, 445, 445, 446,
    446,        446, 447, 447, 447, 448, 448, 448, 448, 449, 449, 449, 450, 450, 450, 451, 451, 451, 451, 452,
    452,        452, 453, 453, 453, 454, 454, 454, 454, 455, 455, 455, 456, 456, 456, 457, 457, 457, 457, 458,
    458,        458, 459, 459, 459, 460, 460, 460, 461, 461, 461, 461, 462, 462, 462, 463, 463, 463, 464, 464,
    464,        464, 465, 465, 465, 466, 466, 466, 467, 467, 467, 467, 468, 468, 468, 469, 469, 469, 470, 470,
    470,        470, 471, 471, 471, 472, 472, 472, 473, 473, 473, 473, 474, 474, 474, 475, 475, 475, 476, 476,
    476,        476, 477, 477, 477, 478, 478, 478, 479, 479, 479, 479, 480, 480, 480, 481, 481, 481, 482, 482,
    482,        482, 483, 483, 483, 484, 484, 484, 485, 485, 485, 485, 486, 486, 486, 487, 487, 487, 488, 488,
    488,        488, 489, 489, 489, 490, 490, 490, 491, 491, 491, 492, 492, 492, 492, 493, 493, 493, 494, 494,
    494,        495, 495, 495, 495, 496, 496, 496, 497, 497, 497, 498, 498, 498, 498, 499, 499, 499, 500, 500,
    500,        501, 501, 501, 501, 502, 502, 502, 503, 503, 503, 504, 504, 504, 504, 505, 505, 505, 506, 506,
    506,        507, 507, 507, 507, 508, 508, 508, 509, 509, 509, 510, 510, 510, 510, 511, 511, 511, 512, 512,
    512,        513, 513, 513, 513, 514, 514, 514, 515, 515, 515, 516, 516, 516, 516, 517, 517, 517, 518, 518,
    518,        519, 519, 519, 520, 520, 520, 520, 521, 521, 521, 522, 522, 522, 523, 523, 523, 523, 524, 524,
    524,        525, 525, 525, 526, 526, 526, 526, 527, 527, 527, 528, 528, 528, 529, 529, 529, 529, 530, 530,
    530,        531, 531, 531, 532, 532, 532, 532, 533, 533, 533, 534, 534, 534, 535, 535, 535, 535, 536, 536,
    536,        537, 537, 537, 538, 538, 538, 538, 539, 539, 539, 540, 540, 540, 541, 541, 541, 541, 542, 542,
    542,        543, 543, 543, 544, 544, 544, 544, 545, 545, 545, 546, 546, 546, 547, 547, 547, 548, 548, 548,
    548,        549, 549, 549, 550, 550, 550, 551, 551, 551, 551, 552, 552, 552, 553, 553, 553, 554, 554, 554,
    554,        555, 555, 555, 556, 556, 556, 557, 557, 557, 557, 558, 558, 558, 559, 559, 559, 560, 560, 560,
    560,        561, 561, 561, 562, 562, 562, 563, 563, 563, 563, 564, 564, 564, 565, 565, 565, 566, 566, 566,
    566,        567, 567, 567, 568, 568, 568, 569, 569, 569, 569, 570, 570, 570, 571, 571, 571, 572, 572, 572,
    572,        573, 573, 573, 574, 574, 574, 575, 575, 575, 575, 576, 576, 576, 577, 577, 577, 578, 578, 578,
    579,        579, 579, 579, 580, 580, 580, 581, 581, 581, 582, 582, 582, 582, 583, 583, 583, 584, 584, 584,
    585,        585, 585, 585, 586, 586, 586, 587, 587, 587, 588, 588, 588, 588, 589, 589, 589, 590, 590, 590,
    591,        591, 591, 591, 592, 592, 592, 593, 593, 593, 594, 594, 594, 594, 595, 595, 595, 596, 596, 596,
    597,        597, 597, 597, 598, 598, 598, 599, 599, 599, 600, 600, 600, 600, 601, 601, 601, 602, 602, 602,
    603,        603, 603, 603, 604, 604, 604, 605, 605, 605, 606, 606, 606, 607, 607, 607, 607, 608, 608, 608,
    609,        609, 609, 610, 610, 610, 610, 611, 611, 611, 612, 612, 612, 613, 613, 613, 613, 614, 614, 614,
    615,        615, 615, 616, 616, 616, 616, 617, 617, 617, 618, 618, 618, 619, 619, 619, 619, 620, 620, 620,
    621,        621, 621, 622, 622, 622, 622, 623, 623, 623, 624, 624, 624, 625, 625, 625, 625, 626, 626, 626,
    627,        627, 627, 628, 628, 628, 628, 629, 629, 629, 630, 630, 630, 631, 631, 631, 631, 632, 632, 632,
    633,        633, 633, 634, 634, 634, 634, 635, 635, 635, 636, 636, 636, 637, 637, 637, 638, 638, 638, 638,
    639,        639, 639, 640, 640, 640, 641, 641, 641, 641, 642, 642, 642, 643, 643, 643, 644, 644, 644, 644,
    645,        645, 645, 646, 646, 646, 647, 647, 647, 647, 648, 648, 648, 649, 649, 649, 650, 650};
    ...
    if (n > maxthreads) {
        ...
        if (TI1) {
            ...
            if (TI0_used) {
                ...
                if (n > 1) memset(TI1 + 1, 0, L - sizeof(ThInfo));
...
static ThInfo* get_TI(void) {
    ...
    if (thno < maxthreads) return TI1 + thno;
    if (thno == 0) TI0_used = 1;
    return &TI0;
}
...
static Bigint* Balloc(int k MTd) {
    ...
    if (!(TI = *PTI)) *PTI = TI = get_TI();
    if (TI == &TI0) ACQUIRE_DTOA_LOCK(0);
#endif
...
static Bigint* pow5mult(Bigint* b, int k MTd) {
    ...
    if ((i = k & 3)) b = multadd(b, p05[i - 1], 0 MTa);
...
#ifdef MULTIPLE_THREADS
        if (!(TI = *PTI)) *PTI = TI = get_TI();
        if (TI == &TI0) ACQUIRE_DTOA_LOCK(1);
        if (!(p5 = p5s)) {
            p5 = p5s = i2b(625 MTa);
            p5->next = 0;
        }
        if (TI == &TI0) FREE_DTOA_LOCK(1);
#else
        p5 = p5s = i2b(625 MTa);
        p5->next = 0;
#endif
...
void gethex(const char** sp, U* rvp, int rounding, int sign MTd) {
    ...
    if (hexdig[*s])
        ...
        for (i = 0; decimalpoint[i]; ++i) {
            if (s[i] != decimalpoint[i]) goto pcheck;
        }
        decpt = s += i;
#else
        if (*s != '.') goto pcheck;
    ...
    *x++ = L;
    ...
    if (e < emin) {
        ...
        if (n >= nbits) {
            ...
            switch (rounding) {
                case Round_near:
                    if (n == nbits && (n < 2 || lostbits || any_on(b, n - 1))) goto ret_tinyf;
                    break;
                case Round_up:
                    if (!sign) goto ret_tinyf;
                    break;
                case Round_down:
                    if (sign) goto ret_tinyf;
            }
    ...
    if ((j = e & 3)) {
        ...
        if (k) {
            switch (rounding) {
                ...
                case Round_near:
                    j = 1 << (j - 1);
                    if (k & j && ((k & (j - 1)) | lostbits)) increment(b);
            }
        }
    }
    e >>= 2;
...
#ifdef Honor_FLT_ROUNDS
    if (bc->rounding != 1) {
        if (i > 0) b = lshift(b, i MTa);
        if (dsign) b = increment(b MTa);
    } else
#endif
    {
        b = lshift(b, ++i MTa);
...
have_i:
    ...
    i = dshift(d, d2);
    if ((b2 += i) > 0) b = lshift(b, b2 MTa);
    if ((d2 += i) > 0) d = lshift(d, d2 MTa);
...
ret:
    ...
    if (bc->rounding != 1) {
        if (dd < 0) {
            if (bc->rounding == 0) {
                if (!dsign) goto retlow1;
            } else if (dsign)
                goto rethi1;
        } else if (dd > 0) {
            if (bc->rounding == 0) {
                if (dsign) goto rethi1;
                goto ret1;
            }
            if (!dsign) goto rethi1;
...
dig_done:
    ...
    if (erv <= 0 && nd > 19) goto many_digits; /* denormal: may need to look at all digits */
    bhi = brv >> 32;
    ...
    if (t00 & 0x8000000000000000ull) {
        if ((t00 & 0x3ff) && (~t00 & 0x3fe)) { /* unambiguous result? */
            if (nd > 19 && ((t00 + (1 << i) + 2) & 0x400) ^ (t00 & 0x400)) goto many_digits;
            if (erv <= 0) goto denormal;
#ifdef Honor_FLT_ROUNDS
            switch (bc.rounding) {
                case 0:
                    goto noround;
...
#endif
            if (t00 & 0x400 && t00 & 0xbff) goto roundup;
            goto noround;
        }
    } else {
        if ((t00 & 0x1ff) && (~t00 & 0x1fe)) { /* unambiguous result? */
            if (nd > 19 && ((t00 + (1 << i) + 2) & 0x200) ^ (t00 & 0x200)) goto many_digits;
            if (erv <= 1) goto denormal1;
#ifdef Honor_FLT_ROUNDS
            switch (bc.rounding) {
                case 0:
                    goto noround1;
    ...
    bexact = 1;
    if (e1 < 0 || e1 > 41 || (t10 | t11) & 0xffffffffull || nd > 19) bexact = 0;
    tlo = (t10 & 0xffffffffull) + (t02 >> 32) + (t11 >> 32);
    if (!bexact && (tlo + 0x10) >> 32 > tlo >> 32) goto many_digits;
    t00 += tlo >> 32;
    if (t00 & 0x8000000000000000ull) {
        if (erv <= 0) { /* denormal result */
            if (nd >= 20 || !((tlo & 0xfffffff0) | (t00 & 0x3ff))) goto many_digits;
        denormal:
            if (erv <= -52) {
#ifdef Honor_FLT_ROUNDS
                switch (bc.rounding) {
...
#endif
                if (erv < -52 || !(t00 & 0x7fffffffffffffffull)) goto undfl;
                goto tiniest;
            }
            tg = 1ull << (11 - erv);
        ...
        if (bexact) {
            ...
            switch (bc.rounding) {
                case 2:
                    if (t00 & 0x7ff) goto roundup;
                case 0:
                    goto noround;
            }
#endif
            if (t00 & 0x400 && (tlo & 0xffffffff) | (t00 & 0xbff)) goto roundup;
            goto noround;
        }
        ...
        if (erv <= 1) { /* denormal result */
            if (nd >= 20 || !((tlo & 0xfffffff0) | (t00 & 0x1ff))) goto many_digits;
        denormal1:
            if (erv <= -51) {
#ifdef Honor_FLT_ROUNDS
                switch (bc.rounding) {
...
#endif
                if (erv < -51 || !(t00 & 0x3fffffffffffffffull)) goto undfl;
            tiniest:
                LLval(&rv) = 1;
                Set_errno(ERANGE);
                goto ret;
        ...
        if (bexact) {
            ...
            switch (bc.rounding) {
                case 2:
                    if (t00 & 0x3ff) goto roundup1;
                case 0:
                    goto noround1;
            }
#endif
            if (t00 & 0x200 && (t00 & 0x5ff || tlo)) goto roundup1;
            goto noround1;
        }
...
if (nd > strtod_diglim) {
    ...
    if (i > nd0) j += bc.dplen;
    for (;;) {
        if (--j < bc.dp1 && j >= bc.dp0) j = bc.dp0 - 1;
        if (s0[j] != '0') break;
        --i;
    }
    e += nd - i;
...
for (;;) {
    ...
    if (bb2 > 0) bb = lshift(bb, bb2 MTb);
    if (bd5 > 0) bd = pow5mult(bd, bd5 MTb);
    if (bd2 > 0) bd = lshift(bd, bd2 MTb);
    if (bs2 > 0) bs = lshift(bs, bs2 MTb);
    ...
    if (bc.rounding != 1) {
        ...
        if (adj.d <= 0x7ffffffe) {
            ...
            y = adj.d;
            if (y != adj.d) {
                if (!((bc.rounding >> 1) ^ bc.dsign)) y++;
                adj.d = y;
            }
        }
#ifdef Avoid_Underflow /*{*/
        if (bc.scale && (y = word0(&rv) & Exp_mask) <= 2 * P * Exp_msk1) word0(&adj) += (2 * P + 1) * Exp_msk1 - y;
#else
#ifdef Sudden_Underflow
        if ((word0(&rv) & Exp_mask) <= P * Exp_msk1) {
            word0(&rv) += P * Exp_msk1;
        ...
        adj.d *= ulp(&rv);
        if (bc.dsign) {
            if (word0(&rv) == Big0 && word1(&rv) == Big1) goto ovfl;
            dval(&rv) += adj.d;
        } else
            dval(&rv) -= adj.d;
        goto cont;
...
#ifdef SET_INEXACT
            if (!delta->x[0] && delta->wds <= 1) bc.inexact = 0;
#endif
            break;
        }
        if (!delta->x[0] && delta->wds <= 1) {
...
if (req_bigcomp) {
    ...
    y = word0(&rv) & Exp_mask;
    if (y == Exp_mask) goto ovfl;
    if (y == 0 && rv.d == 0.) goto undfl;
}
#endif
#ifdef Avoid_Underflow
if (bc.scale) {
...
void freedtoa(char* s) {
    ...
    Bfree(b MTb);
#ifndef MULTIPLE_THREADS
    if (s == dtoa_result) dtoa_result = 0;
#endif
}
...
char* dtoa_r(double dd, int mode, int ndigits, int* decpt, int* sign, char** rve, char* buf, size_t blen) {
...
#ifdef USE_BF96 /*{{*/
    BF96* p10;
    ULLong dbhi, dbits, dblo, den, hb, rb, rblo, res, res0, res3, reslo, sres, sulp, tv0, tv1, tv2, tv3, ulp, ulplo,
        ulpmask, ures, ureslo, zb;
...
#endif
    {
        ...
        *decpt = 9999;
#ifdef IEEE_Arith
        if (!word1(&u) && !(word0(&u) & 0xfffff)) return nrv_alloc("Infinity", buf, blen, rve, 8 MTb);
#endif
    ...
    i = be - 0x3fe;
    if (i < p10->e || (i == p10->e && (dbhi < p10->b0 || (dbhi == p10->b0 && dblo < p10->b1)))) --j;
    k = j - 342;
...
if (k >= 0) {
    ...
    if (k < 0) {
        ...
        if (n2 > 61) {
            ulpshift = n2 - 61;
            if (res & (ulpmask = (1ull << ulpshift) - 1)) goto toobig;
            j -= ulpshift;
            res >>= ulpshift;
        }
        /* Yes. */
    ...
    if (ilim == 0 && j + k >= 0) {
        S = mhi = 0;
        if ((dbits >> 11) > (pfive[k - 1] << j)) goto one_digit;
        goto no_digits;
    }
    ...
    use_exact:
        ...
        for (;;) {
            ...
            *s++ = '0' + dig;
            ...
            if (ilim < 0) {
                ures = den - res;
                if (2 * res <= ulp && (spec_case ? 4 * res <= ulp : (2 * res < ulp || dig & 1))) goto ulp_reached;
                if (2 * ures < ulp) goto Roundup;
            } else if (i == ilim) {
                switch (Rounding) {
                    case 0:
                        goto retc;
                ...
                ures = 2 * res;
                if (ures > den || (ures == den && dig & 1) || (spec_case && res <= ulp && 2 * res >= ulp)) goto Roundup;
                goto retc;
            }
            if (j1 < ++i) {
                res *= 10;
        ...
        for (;;) {
            ...
            *s++ = '0' + dig;
            ...
            if (ilim < 0) {
                ...
                ulp_reached:
                    if (ures < res || (ures == res && dig & 1)) goto Roundup;
                    goto retc;
                }
                if (2 * ures < ulp) goto Roundup;
            }
...
#endif
                hb = 1ull << j;
                if (res & hb && (dig & 1 || res & (hb - 1))) goto Roundup;
...
toobig:
    ...
    if (ilim == 0) {
        if (!(res & 0x7fffffffffffffeull) || !((~res) & 0x7fffffffffffffeull)) goto Fast_failed1;
        S = mhi = 0;
        if (res >= 0x5000000000000000ull) goto one_digit;
        goto no_digits;
    }
        ...
        *s++ = '0' + dig;
        ...
        if (ilim < 0) {
            ...
            if (eulp > 0) {
                ...
                sulp = ulp << (eulp - 1);
                if (res <= ures) {
                    if (res + rb > ures - rb) goto Fast_failed;
                    if (res < sulp) goto retc;
                } else {
                    if (res - rb <= ures + rb) goto Fast_failed;
                    if (ures < sulp) goto Roundup;
                }
            } else {
                zb = -(1ull << (eulp + 63));
                if (!(zb & res)) {
                    ...
                    if (sres < ulp && (!spec_case || 2 * sres < ulp)) {
                        if ((res + rb) << (1 - eulp) >= ulp) goto Fast_failed;
                        if (ures < res) {
                            if (ures + rb >= res - rb) goto Fast_failed;
                            goto Roundup;
                        }
                        if (ures - rb < res + rb) goto Fast_failed;
                        goto retc;
                ...
                if (!(zb & ures) && ures << -eulp < ulp) {
                    if (ures << (1 - eulp) < ulp) goto Roundup;
                    goto Fast_failed;
                }
            }
        } else if (i == ilim) {
            ...
            if (ures < res) {
                if (ures <= rb || res - rb <= ures + rb) {
                    if (j + k >= 0 && k >= 0 && k <= 27) goto use_exact1;
                    goto Fast_failed;
                }
#ifdef Honor_FLT_ROUNDS
                if (Rounding == 0) goto retc;
#endif
                goto Roundup;
            }
...
#ifdef Honor_FLT_ROUNDS
            if (Rounding == 2) goto Roundup;
#endif
            goto retc;
        }
        rb *= 10;
        if (rb >= 0x1000000000000000ull) goto Fast_failed;
        res *= 10;
        ulp *= 5;
...
Fast_failed:
    ...
    if (i) reslo = (res0 << (64 - i)) >> 32 | (reslo >> i);
    rb = 0;
        ...
        *s++ = '0' + dig;
        ...
        if (ilim < 0) {
            ...
            if (eulp > 0) {
                ...
                if (res <= ures) {
                    if (res < sulp) {
                        if (res + rb < ures - rb) goto retc;
                    }
                } else if (ures < sulp) {
                    if (res - rb > ures + rb) goto Roundup;
                }
                goto Fast_failed1;
            } else {
                zb = -(1ull << (eulp + 60));
                if (!(zb & (res + rb))) {
                    ...
                    if (sres < ulp && (!spec_case || 2 * sres < ulp)) {
                        ...
                        if ((j = eulp + 31) > 0)
                            ...
                            sres += (rblo + reslo) << -j;
                        if (sres + (rb << (1 - eulp)) >= ulp) goto Fast_failed1;
                        if (sres >= ulp) goto more96;
                        if (ures < res || (ures == res && ureslo < reslo)) {
                            if (ures + rb >= res - rb) goto Fast_failed1;
                            goto Roundup;
                        }
                        if (ures - rb <= res + rb) goto Fast_failed1;
                        goto retc;
                ...
                if (!(zb & ures) && (ures - rb) << (1 - eulp) < ulp) {
                    if ((ures + rb) << (1 - eulp) < ulp) goto Roundup;
                    goto Fast_failed1;
                }
            }
        } else if (i == ilim) {
            ...
            sres += 2 * rb;
            if (ures <= res) {
                if (ures <= sres || res - ures <= sres) goto Fast_failed1;
#ifdef Honor_FLT_ROUNDS
                if (Rounding == 0) goto retc;
#endif
                goto Roundup;
            }
            if (res <= sres || ures - res <= sres) goto Fast_failed1;
#ifdef Honor_FLT_ROUNDS
            if (Rounding == 2) goto Roundup;
#endif
            goto retc;
    ...
    more96:
        ...
        rb = 10 * rb + (rblo >> 32);
        rblo &= 0xffffffffull;
        if (rb >= 0x1000000000000000ull) goto Fast_failed1;
        reslo *= 10;
        res = 10 * res + (reslo >> 32);
        reslo &= 0xffffffffull;
        ulp *= 5;
...
Fast_failed1:
    ...
    if (b5 > 0) {
        if (leftright) {
            ...
            if ((j = b5 - m5)) b = pow5mult(b, j MTb);
        } else
            b = pow5mult(b, b5 MTb);
    }
    S = i2b(1 MTb);
    if (s5 > 0) S = pow5mult(S, s5 MTb);
    ...
    m2 += i;
    s2 += i;
    if (b2 > 0) b = lshift(b, b2 MTb);
    if (s2 > 0) S = lshift(S, s2 MTb);
#ifndef USE_BF96
    if (k_check) {
        if (cmp(b, S) < 0) {
            k--;
            b = multadd(b, 10, 0 MTb); /* we botched the k estimate */
            if (leftright) mhi = multadd(mhi, 10, 0 MTb);
            ilim = ilim1;
        }
    }
#endif
    ...
    if (leftright) {
        ...
        for (i = 1;; i++) {
            ...
            if (j1 > 0) {
#ifdef Honor_FLT_ROUNDS
                if (!Rounding && mode > 1) goto accept_dig;
#endif
...
char* dtoa(double dd, int mode, int ndigits, int* decpt, int* sign, char** rve) {
    ...
    */
#ifndef MULTIPLE_THREADS
    if (dtoa_result) freedtoa(dtoa_result);
#endif
