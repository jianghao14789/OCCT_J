...
public:
    ...
    //! @param theSize      the size of the block that was requested by application (this value is correct only if
    //! theIsAlloc is true)
    typedef void (*TPCallBackFunc)(const Standard_Boolean theIsAlloc, const Standard_Address theStorage,
