...
Standard_Boolean XmlMFunction_GraphNodeDriver::Paste(const XmlObjMgt_Persistent& theSource,
    ...
    if (!anElement.getAttribute(::ExecutionStatus()).GetInteger(exec)) {
        TCollection_ExtendedString aMessageString = TCollection_ExtendedString("Cannot retrieve the execution status"
...
//=======================================================================
void XmlMFunction_GraphNodeDriver::Paste(const Handle(TDF_Attribute) & theSource, XmlObjMgt_Persistent& theTarget,
