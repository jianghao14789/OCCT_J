...
public:
    ...
    Standard_EXPORT void PerformBySimple(const TopoDS_Shape& theS, const Standard_Real theOffsetValue);
    ...
    Standard_EXPORT void PerformByJoin(const TopoDS_Shape& S, const Standard_Real Offset, const Standard_Real Tol,
