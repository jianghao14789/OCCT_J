...
public:
    ...
    Standard_EXPORT void MakeThickSolidBySimple(const TopoDS_Shape& theS, const Standard_Real theOffsetValue);
    ...
    //! MakeOffsetShape.
    Standard_EXPORT void MakeThickSolidByJoin(const TopoDS_Shape& S, const TopTools_ListOfShape& ClosingFaces,
