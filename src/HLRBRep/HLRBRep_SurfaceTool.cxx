...
Standard_Integer HLRBRep_SurfaceTool::NbSamplesU(const Standard_Address S, const Standard_Real u1,
...
Standard_Integer HLRBRep_SurfaceTool::NbSamplesV(const Standard_Address S, const Standard_Real v1,
