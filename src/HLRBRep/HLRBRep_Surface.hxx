...
public:
    ...
    Standard_EXPORT Standard_Boolean IsAbove(const Standard_Boolean back, const HLRBRep_Curve* A,
    ...
    //! Raised  if   the   continuity   of the current
    //! intervals is not C2.
    void D2(const Standard_Real U, const Standard_Real V, gp_Pnt& P, gp_Vec& D1U, gp_Vec& D1V, gp_Vec& D2U, gp_Vec& D2V,
            gp_Vec& D2UV) const;
    ...
    //! Raised  if   the   continuity   of the current
    //! intervals is not C3.
    void D3(const Standard_Real U, const Standard_Real V, gp_Pnt& P, gp_Vec& D1U, gp_Vec& D1V, gp_Vec& D2U, gp_Vec& D2V,
            gp_Vec& D2UV, gp_Vec& D3U, gp_Vec& D3V, gp_Vec& D3UUV, gp_Vec& D3UVV) const;
...
private:
    //! returns true if it is a side face
    Standard_EXPORT Standard_Boolean SideRowsOfPoles(const Standard_Real tol, const Standard_Integer nbuPoles,
                                                     const Standard_Integer nbvPoles, TColgp_Array2OfPnt& Pnt) const;
