...
// purpose  :
//=======================================================================
TopoDS_Edge HLRBRep::MakeEdge(const HLRBRep_Curve& ec, const Standard_Real U1, const Standard_Real U2) {
    TopoDS_Edge Edg;
        ...
        case GeomAbs_BSplineCurve: {
            ...
            if (theCurve->IsPeriodic() && !GAcurve.IsClosed()) {
                ...
                if (theCurve->IsRational()) {
                    ...
                    ec2d = new Geom2d_BSplineCurve(Poles, Weights, knots, mults, theCurve->Degree(),
                                                   theCurve->IsPeriodic());
                } else {
                    ec.Poles(theCurve, Poles);
                    ec2d = new Geom2d_BSplineCurve(Poles, knots, mults, theCurve->Degree(), theCurve->IsPeriodic());
                }
            } else {
                TColgp_Array1OfPnt2d Poles(1, ec.NbPoles());
...
TopoDS_Edge HLRBRep::MakeEdge3d(const HLRBRep_Curve& ec, const Standard_Real U1, const Standard_Real U2) {
    TopoDS_Edge Edg;
    // const Standard_Real sta = ec.Parameter2d(U1);
    // const Standard_Real end = ec.Parameter2d(U2);
...
void HLRBRep::PolyHLRAngleAndDeflection(const Standard_Real InAngl, Standard_Real& OutAngl, Standard_Real& OutDefl) {
    ...
    OutAngl = HAngLim + sqrt((OutAngl - HAngMin) * (HAngMax - HAngLim) * (HAngMax - HAngLim) / (HAngMax - HAngMin));
