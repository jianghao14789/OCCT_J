...
// purpose  :
//=======================================================================
HLRBRep_Surface::HLRBRep_Surface() : myType(GeomAbs_OtherSurface), myProj(NULL) {}
...
Standard_Boolean HLRBRep_Surface::SideRowsOfPoles(const Standard_Real tol, const Standard_Integer nbuPoles,
    ...
    if (Pl.IsPlanar()) result = Abs(Pl.Plane().Axis().Direction().Z()) < 0.0001;
...
Standard_Boolean HLRBRep_Surface::IsAbove(const Standard_Boolean back, const HLRBRep_Curve* A,
