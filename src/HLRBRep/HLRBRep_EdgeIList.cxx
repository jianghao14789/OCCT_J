...
//=======================================================================
void HLRBRep_EdgeIList::AddInterference(HLRAlgo_InterferenceList& IL, const HLRAlgo_Interference& I,
...
//=======================================================================
#ifdef OCCT_DEBUG_SI
static Standard_Boolean SimilarInterference(const HLRAlgo_Interference& I1, const HLRAlgo_Interference& I2) {
    Standard_Real p1, p2;
...
#endif
void HLRBRep_EdgeIList::ProcessComplex(HLRAlgo_InterferenceList& IL, const HLRBRep_EdgeInterferenceTool& T) {
    ...
    while (It1.More()) {
        ...
        if (It2.More()) {
            if (T.SameInterferences(It1.Value(), It2.Value())
                ...
                transTool.AddInterference(TolAng, TgtI, NormI, CurvI, It1.Value().Orientation(),
                                          It1.Value().Transition(), It1.Value().BoundaryTransition());
                ...
                while (It2.More()) {
                    ...
                    transTool.AddInterference(TolAng, TgtI, NormI, CurvI, It2.Value().Orientation(),
                                              It2.Value().Transition(), It2.Value().BoundaryTransition());
                    IL.Remove(It2);
                }
