...
public:
    ...
    Standard_EXPORT static void PolesAndWeights(const BRepAdaptor_Curve& C, TColgp_Array1OfPnt& T,
                                                TColStd_Array1OfReal& W);

    Standard_EXPORT static Standard_Integer NbSamples(const BRepAdaptor_Curve& C, const Standard_Real U0,
