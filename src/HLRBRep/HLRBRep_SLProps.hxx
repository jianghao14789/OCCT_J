...
public:
    ...
    //! if a vector is null).
    Standard_EXPORT HLRBRep_SLProps(const Standard_Address& S, const Standard_Real U, const Standard_Real V,
                                    const Standard_Integer N, const Standard_Real Resolution);

    //! idem as previous constructor but without setting the value
    //! of parameters <U> and <V>.
    Standard_EXPORT HLRBRep_SLProps(const Standard_Address& S, const Standard_Integer N,
