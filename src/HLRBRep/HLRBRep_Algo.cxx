...
HLRBRep_Algo::HLRBRep_Algo(const Handle(HLRBRep_Algo) & A) : HLRBRep_InternalAlgo(A) {}
...
void HLRBRep_Algo::Add(const TopoDS_Shape& S, const Handle(Standard_Transient) & SData, const Standard_Integer nbIso) {
