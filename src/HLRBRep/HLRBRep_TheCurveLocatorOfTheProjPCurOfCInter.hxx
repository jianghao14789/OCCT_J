...
public:
    ...
    Standard_EXPORT static void Locate(const gp_Pnt2d& P, const Standard_Address& C, const Standard_Integer NbU,
    ...
    Standard_EXPORT static void Locate(const Standard_Address& C1, const Standard_Address& C2,
