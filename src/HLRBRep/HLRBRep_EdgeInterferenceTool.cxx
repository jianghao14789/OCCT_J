...
// purpose  :
//=======================================================================
HLRBRep_EdgeInterferenceTool::HLRBRep_EdgeInterferenceTool(const Handle(HLRBRep_Data) & DS) : myDS(DS) {}
...
void HLRBRep_EdgeInterferenceTool::EdgeGeometry(const Standard_Real Param, gp_Dir& Tgt, gp_Dir& Nrm,
...
Standard_Boolean HLRBRep_EdgeInterferenceTool::SameVertexAndInterference(const HLRAlgo_Interference& I) const {
    if (I.Intersection().Index() == inter[cur].Index()) return Standard_True;
...
void HLRBRep_EdgeInterferenceTool::InterferenceBoundaryGeometry(const HLRAlgo_Interference& I, gp_Dir& Tang,
                                                                gp_Dir& Norm, Standard_Real& CrFE) const {
    Standard_Integer FE;
    Standard_Real Param;
    gp_Dir2d TgFE, NmFE;
