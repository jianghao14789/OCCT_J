...
HLRBRep_Intersector::HLRBRep_Intersector() : myPolyhedron(NULL) {
#ifdef PERF
    if (NbInters) {
        printf("\n--------------------------------------");
    ...
    NbIntersSimulate = NbIntersAuto = NbIntersCS = NbInters = NbIntersVides = NbInters1Segment = NbInters1Point =
        NbIntersNPoints = NbIntersNSegments = NbIntersPointEtSegment = NbIntersCSVides = 0;
#endif
...
void HLRBRep_Intersector::Perform(const Standard_Address A1, const Standard_Real da1, const Standard_Real db1) {
#ifdef PERF
    NbIntersAuto++;
#endif
...
void HLRBRep_Intersector::Perform(const Standard_Integer /*nA*/, const Standard_Address A1, const Standard_Real da1,
                                  const Standard_Real db1, const Standard_Integer /*nB*/, const Standard_Address A2,
                                  const Standard_Real da2, const Standard_Real db2, const Standard_Boolean EnBout) {
...
void HLRBRep_Intersector::SimulateOnePoint(const Standard_Address A1, const Standard_Real u, const Standard_Address A2,
...
void HLRBRep_Intersector::Perform(const gp_Lin& L, const Standard_Real P) {
    ...
    switch (typ) {
      ...
      break;
            ...
            HLRBRep_ThePolygonOfInterCSurf Polygon(L, pmin, pmax, 3);
            myCSIntersector.Perform(L, Polygon, mySurface, *((HLRBRep_ThePolyhedronOfInterCSurf*)myPolyhedron));
...
void HLRBRep_Intersector::Destroy() {
    if (myPolyhedron != NULL) delete myPolyhedron;
}
