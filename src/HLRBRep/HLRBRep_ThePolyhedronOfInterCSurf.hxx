...
public:
    ...
    Standard_EXPORT HLRBRep_ThePolyhedronOfInterCSurf(const Standard_Address& Surface, const Standard_Integer nbdU,
                                                      const Standard_Integer nbdV, const Standard_Real U1,
                                                      const Standard_Real V1, const Standard_Real U2,
    ...
    Standard_EXPORT void Triangle(const Standard_Integer Index, Standard_Integer& P1, Standard_Integer& P2,
    ...
    Standard_EXPORT Standard_Integer TriConnex(const Standard_Integer Triang, const Standard_Integer Pivot,
    ...
    //! points.
    Standard_EXPORT void Point(const gp_Pnt& thePnt, const Standard_Integer lig, const Standard_Integer col,
    ...
    Standard_EXPORT void PlaneEquation(const Standard_Integer Triang, gp_XYZ& NormalVector,
...
protected:
    Standard_EXPORT void Init(const Standard_Address& Surface, const Standard_Real U1, const Standard_Real V1,
                              const Standard_Real U2, const Standard_Real V2);

    Standard_EXPORT void Init(const Standard_Address& Surface, const TColStd_Array1OfReal& Upars,
                              const TColStd_Array1OfReal& Vpars);
...
private:
    ...
    Standard_EXPORT Standard_Real ComputeBorderDeflection(const Standard_Address& Surface,
                                                          const Standard_Real Parameter, const Standard_Real PMin,
