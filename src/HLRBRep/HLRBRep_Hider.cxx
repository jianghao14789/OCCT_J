...
// purpose  :
//=======================================================================
HLRBRep_Hider::HLRBRep_Hider(const Handle(HLRBRep_Data) & DS) : myDS(DS) {}
                                    ...
                                    switch (staft) {
                                        ...
                                        case TopAbs_ON:
                                            ...
                                            HLRBRep_EdgeIList::AddInterference // REVERSED in ILHidden
                                                (ILHidden,
                                                 HLRAlgo_Interference(Int.Intersection(), Int.Boundary(),
                                                                      Int.Orientation(), TopAbs_REVERSED,
                                    ...
                                    switch (staft) {
                                        case TopAbs_IN:
                                            ...
                                            HLRBRep_EdgeIList::AddInterference // REVERSED in ILHidden
                                                (ILHidden,
                                                 HLRAlgo_Interference(Int.Intersection(), Int.Boundary(),
                                                                      Int.Orientation(), TopAbs_FORWARD,
                                                                      Int.BoundaryTransition()),
                                                 EIT);
                                            break;
                                        case TopAbs_ON:
