...
enum { NMsk_Vert = 1, NMsk_OutL = 2, NMsk_Norm = 4, NMsk_Fuck = 8, NMsk_Edge = 16, NMsk_Move = 32 };
...
// purpose  :
//=======================================================================
HLRBRep_PolyAlgo::HLRBRep_PolyAlgo() : myDebug(Standard_False), myTolSta(0.1), myTolEnd(0.9), myTolAngular(0.001) {
...
HLRBRep_PolyAlgo::HLRBRep_PolyAlgo(const TopoDS_Shape& theShape)
    : myDebug(Standard_False), myTolSta(0.1), myTolEnd(0.9), myTolAngular(0.001) {
...
void HLRBRep_PolyAlgo::Update() {
    ...
    for (TopExp_Explorer aShellIter(aShape, TopAbs_SHELL); aShellIter.More(); aShellIter.Next()) {
        StoreShell(aShellIter.Current(), iShell, aShell, Standard_False, Standard_False, anES, aPD, aPID, aShapeMap1,
                   aShapeMap2);
    }
    if (isIsoledF) {
        StoreShell(aShape, iShell, aShell, isIsoledF, Standard_False, anES, aPD, aPID, aShapeMap1, aShapeMap2);
    }
    if (isIsoledE) {
        StoreShell(aShape, iShell, aShell, Standard_False, isIsoledE, anES, aPD, aPID, aShapeMap1, aShapeMap2);
    }
    myAlgo->Update();
}
...
// purpose  :
//=======================================================================
Standard_Integer HLRBRep_PolyAlgo::InitShape(const TopoDS_Shape& theShape, Standard_Boolean& theIsoledF,
    ...
    for (TopExp_Explorer anEdgeIter(theShape, TopAbs_EDGE, TopAbs_FACE); anEdgeIter.More() && !theIsoledE;
         anEdgeIter.Next()) {
...
// purpose  :
//=======================================================================
void HLRBRep_PolyAlgo::StoreShell(const TopoDS_Shape& theShape, Standard_Integer& theIShell,
                                  NCollection_Array1<Handle(HLRAlgo_PolyShellData)>& theShell,
                                  const Standard_Boolean theIsoledF, const Standard_Boolean theIsoledE,
                                  TColStd_Array1OfInteger& theES, NCollection_Array1<Handle(HLRAlgo_PolyData)>& thePD,
                                  NCollection_Array1<Handle(HLRAlgo_PolyInternalData)>& thePID,
                                  TopTools_MapOfShape& theShapeMap1, TopTools_MapOfShape& theShapeMap2) {
    TopLoc_Location aLoc;
            ...
            if (!aTr.IsNull()) {
                if (theShapeMap2.Add(aFace)) {
                    ...
                    for (Standard_Integer aTriIter = 1; aTriIter <= aNbTris; ++aTriIter) {
                        ...
                        OrientTriangle(aTriIter, aTriData, aPN1->Indices(), aPN1->Data(), aPN2->Indices(), aPN2->Data(),
...
Standard_Boolean HLRBRep_PolyAlgo::Normal(const Standard_Integer theNodeIndex,
                                          ...
                                          HLRAlgo_Array1OfTData& theTriData, HLRAlgo_Array1OfPISeg& thePISeg,
                                          HLRAlgo_Array1OfPINod& thePINod, const Standard_Boolean theToOrient) const {
    ...
    if (AverageNormal(theNodeIndex, theNodIndices, theTriData, thePISeg, thePINod, anAverNorm)) {
        ...
        if (myProj.Perspective()) {
            anEyeDir.SetCoord(theNod1RValues.Point.X(), theNod1RValues.Point.Y(),
...
Standard_Boolean HLRBRep_PolyAlgo::AverageNormal(const Standard_Integer iNode,
                                                 ...
                                                 HLRAlgo_Array1OfTData& theTData, HLRAlgo_Array1OfPISeg& thePISeg,
                                                 HLRAlgo_Array1OfPINod& thePINod, Standard_Real& theX,
                                                 Standard_Real& theY, Standard_Real& theZ) const {
...
// purpose  :
//=======================================================================
void HLRBRep_PolyAlgo::AddNormalOnTriangle(const Standard_Integer theITri, const Standard_Integer theINode,
                                           Standard_Integer& theJNode, HLRAlgo_Array1OfTData& theTData,
                                           HLRAlgo_Array1OfPINod& thePINod, Standard_Real& theX, Standard_Real& theY,
                                           Standard_Real& theZ, Standard_Boolean& theIsOK) const {
...
// purpose  :
//=======================================================================
void HLRBRep_PolyAlgo::InitBiPointsWithConnexity(const Standard_Integer theIEdge, TopoDS_Edge& theEdge,
                                                 HLRAlgo_ListOfBPoint& theList,
                                                 NCollection_Array1<Handle(HLRAlgo_PolyInternalData)>& thePID,
                                                 TopTools_ListOfShape& theLS, const Standard_Boolean theIsConnex) {
            ...
            if (!aHPol[0].IsNull()) {
                ...
                if (aNbPol == 2 && BRep_Tool::Degenerated(theEdge)) {
                    ...
                    for (Standard_Integer iPol = 2; iPol <= aNbPol; iPol++) {
                        ...
                        aNode12Indices->Flag |= NMsk_Edge;
                        TIMultiply(XTI2, YTI2, ZTI2);
                        Interpolation(theList, X1, Y1, Z1, X2, Y2, Z2, XTI1, YTI1, ZTI1, XTI2, YTI2, ZTI2, theIEdge, U1,
                                      U2, *aNode11Indices, *aNod11RValues, *aNode12Indices, *aNod12RValues, i1p1, i1p2,
                                      i1, pid1, aTData1, aPISeg1, aPINod1);
                    }
                }
            }
#ifdef OCCT_DEBUG
            ...
            if (!aHPol[0].IsNull() && !aHPol[1].IsNull()) {
                ...
                if (aNbPol1 == 2 && BRep_Tool::Degenerated(theEdge)) {
                    ...
                    for (Standard_Integer iPol = 2; iPol <= aNbPol1; iPol++) {
                        ...
                        TIMultiply(XTI2, YTI2, ZTI2);
                        Interpolation(theList, X1, Y1, Z1, X2, Y2, Z2, XTI1, YTI1, ZTI1, XTI2, YTI2, ZTI2, theIEdge, U1,
                                      U2, rg, *aNode11Indices, *aNod11RValues, *aNode12Indices, *aNod12RValues, i1p1,
                                      i1p2, i1, pid1, aTData1, aPISeg1, aPINod1, *aNod21Indices, *aNod21RValues,
                                      *aNod22Indices, *aNod22RValues, i2p1, i2p2, i2, pid2, aTData2, aPISeg2, aPINod2);
                    }
                }
            }
#ifdef OCCT_DEBUG
...
// purpose  :
//=======================================================================
void HLRBRep_PolyAlgo::Interpolation(
    HLRAlgo_ListOfBPoint& theList, Standard_Real& theX1, Standard_Real& theY1, Standard_Real& theZ1,
    Standard_Real& theX2, Standard_Real& theY2, Standard_Real& theZ2, Standard_Real& theXTI1, Standard_Real& theYTI1,
    Standard_Real& theZTI1, Standard_Real& theXTI2, Standard_Real& theYTI2, Standard_Real& theZTI2,
    const Standard_Integer theIEdge, Standard_Real& theU1, Standard_Real& theU2,
    HLRAlgo_PolyInternalNode::NodeIndices& theNod11Indices, HLRAlgo_PolyInternalNode::NodeData& theNod11RValues,
    HLRAlgo_PolyInternalNode::NodeIndices& theNod12Indices, HLRAlgo_PolyInternalNode::NodeData& theNod12RValues,
    const Standard_Integer theI1p1, const Standard_Integer theI1p2, const Standard_Integer theI1,
    const Handle(HLRAlgo_PolyInternalData) & thePid1, HLRAlgo_Array1OfTData*& theTData1,
    HLRAlgo_Array1OfPISeg*& thePISeg1, HLRAlgo_Array1OfPINod*& thePINod1) const {
    Standard_Boolean mP3P1 = false;
    Standard_Real X3 = 0.0, Y3 = 0.0, Z3 = 0.0, XTI3 = 0.0, YTI3 = 0.0, ZTI3 = 0.0, coef3 = 0.0, U3 = 0.0;
    //  gp_Pnt P3, PT3;
    Standard_Boolean insP3 =
        Interpolation(theU1, theU2, theNod11RValues, theNod12RValues, X3, Y3, Z3, XTI3, YTI3, ZTI3, coef3, U3, mP3P1);
    MoveOrInsertPoint(theList, theX1, theY1, theZ1, theX2, theY2, theZ2, theXTI1, theYTI1, theZTI1, theXTI2, theYTI2,
                      theZTI2, theIEdge, theU1, theU2, theNod11Indices, theNod11RValues, theNod12Indices,
                      theNod12RValues, theI1p1, theI1p2, theI1, thePid1, theTData1, thePISeg1, thePINod1, X3, Y3, Z3,
                      XTI3, YTI3, ZTI3, coef3, U3, insP3, mP3P1, 0);
}
...
void HLRBRep_PolyAlgo::Interpolation(
    ...
    Standard_Real& theX2, Standard_Real& theY2, Standard_Real& theZ2, Standard_Real& theXTI1, Standard_Real& theYTI1,
    Standard_Real& theZTI1, Standard_Real& theXTI2, Standard_Real& theYTI2, Standard_Real& theZTI2,
    const Standard_Integer theIEdge, Standard_Real& theU1, Standard_Real& theU2, const GeomAbs_Shape theRg,
    HLRAlgo_PolyInternalNode::NodeIndices& theNod11Indices, HLRAlgo_PolyInternalNode::NodeData& theNod11RValues,
    HLRAlgo_PolyInternalNode::NodeIndices& theNod12Indices, HLRAlgo_PolyInternalNode::NodeData& theNod12RValues,
    const Standard_Integer theI1p1, const Standard_Integer theI1p2, const Standard_Integer theI1,
    const Handle(HLRAlgo_PolyInternalData) & thePid1, HLRAlgo_Array1OfTData*& theTData1,
    HLRAlgo_Array1OfPISeg*& thePISeg1, HLRAlgo_Array1OfPINod*& thePINod1,
    HLRAlgo_PolyInternalNode::NodeIndices& theNod21Indices, HLRAlgo_PolyInternalNode::NodeData& theNod21RValues,
    HLRAlgo_PolyInternalNode::NodeIndices& theNod22Indices, HLRAlgo_PolyInternalNode::NodeData& theNod22RValues,
    const Standard_Integer theI2p1, const Standard_Integer theI2p2, const Standard_Integer theI2,
    const Handle(HLRAlgo_PolyInternalData) & thePid2, HLRAlgo_Array1OfTData*& theTData2,
    HLRAlgo_Array1OfPISeg*& thePISeg2, HLRAlgo_Array1OfPINod*& thePINod2) const {
    ...
    const bool insP3 =
        Interpolation(theU1, theU2, theNod11RValues, theNod12RValues, X3, Y3, Z3, XTI3, YTI3, ZTI3, coef3, U3, mP3P1);
    const bool insP4 =
        Interpolation(theU1, theU2, theNod21RValues, theNod22RValues, X4, Y4, Z4, XTI4, YTI4, ZTI4, coef4, U4, mP4P1);
    const bool isOK = insP3 || insP4;
    if (isOK) {
        if (!insP4) // p1 i1p3 p2
        {
            MoveOrInsertPoint(theList, theX1, theY1, theZ1, theX2, theY2, theZ2, theXTI1, theYTI1, theZTI1, theXTI2,
                              theYTI2, theZTI2, theIEdge, theU1, theU2, theNod11Indices, theNod11RValues,
                              theNod12Indices, theNod12RValues, theI1p1, theI1p2, theI1, thePid1, theTData1, thePISeg1,
                              thePINod1, theNod21Indices, theNod21RValues, theNod22Indices, theNod22RValues, theI2p1,
                              theI2p2, theI2, thePid2, theTData2, thePISeg2, thePINod2, X3, Y3, Z3, XTI3, YTI3, ZTI3,
                              coef3, U3, insP3, mP3P1, flag);
        } else if (!insP3) // p1 i2p4 p2
        {
            MoveOrInsertPoint(theList, theX1, theY1, theZ1, theX2, theY2, theZ2, theXTI1, theYTI1, theZTI1, theXTI2,
                              theYTI2, theZTI2, theIEdge, theU1, theU2, theNod21Indices, theNod21RValues,
                              theNod22Indices, theNod22RValues, theI2p1, theI2p2, theI2, thePid2, theTData2, thePISeg2,
                              thePINod2, theNod11Indices, theNod11RValues, theNod12Indices, theNod12RValues, theI1p1,
                              theI1p2, theI1, thePid1, theTData1, thePISeg1, thePINod1, X4, Y4, Z4, XTI4, YTI4, ZTI4,
                              coef4, U4, insP4, mP4P1, flag);
        ...
        } else if (coef4 < coef3) // p1 i2p4 i1p3 p2
        {
            MoveOrInsertPoint(theList, theX1, theY1, theZ1, theX2, theY2, theZ2, theXTI1, theYTI1, theZTI1, theXTI2,
                              ...
                              thePINod2, theNod11Indices, theNod11RValues, theNod12Indices, theNod12RValues, theI1p1,
                              theI1p2, theI1, thePid1, theTData1, thePISeg1, thePINod1, X4, Y4, Z4, XTI4, YTI4, ZTI4,
                              coef4, U4, insP4, mP4P1, X3, Y3, Z3, XTI3, YTI3, ZTI3, coef3, U3, insP3, mP3P1, flag);
        } else // p1 i1p3 i2p4 p2
        {
            MoveOrInsertPoint(theList, theX1, theY1, theZ1, theX2, theY2, theZ2, theXTI1, theYTI1, theZTI1, theXTI2,
                              ...
                              thePINod1, theNod21Indices, theNod21RValues, theNod22Indices, theNod22RValues, theI2p1,
                              theI2p2, theI2, thePid2, theTData2, thePISeg2, thePINod2, X3, Y3, Z3, XTI3, YTI3, ZTI3,
                              coef3, U3, insP3, mP3P1, X4, Y4, Z4, XTI4, YTI4, ZTI4, coef4, U4, insP4, mP4P1, flag);
        }
    } else // p1 p2
    {
        theList.Prepend(HLRAlgo_BiPoint(theXTI1, theYTI1, theZTI1, theXTI2, theYTI2, theZTI2, theX1, theY1, theZ1,
                                        theX2, theY2, theZ2, theIEdge, theI1, theI1p1, theI1p2, theI2, theI2p1, theI2p2,
                                        flag));
    }
}
...
// purpose  :
//=======================================================================
Standard_Boolean HLRBRep_PolyAlgo::Interpolation(const Standard_Real theU1, const Standard_Real theU2,
                                                 HLRAlgo_PolyInternalNode::NodeData& theNod1RValues,
                                                 HLRAlgo_PolyInternalNode::NodeData& theNod2RValues,
                                                 Standard_Real& theX3, Standard_Real& theY3, Standard_Real& theZ3,
                                                 Standard_Real& theXTI3, Standard_Real& theYTI3, Standard_Real& theZTI3,
                                                 Standard_Real& theCoef3, Standard_Real& theU3,
...
// purpose  :
//=======================================================================
void HLRBRep_PolyAlgo::MoveOrInsertPoint(
    HLRAlgo_ListOfBPoint& theList, Standard_Real& theX1, Standard_Real& theY1, Standard_Real& theZ1,
    Standard_Real& theX2, Standard_Real& theY2, Standard_Real& theZ2, Standard_Real& theXTI1, Standard_Real& theYTI1,
    Standard_Real& theZTI1, Standard_Real& theXTI2, Standard_Real& theYTI2, Standard_Real& theZTI2,
    const Standard_Integer theIEdge, Standard_Real& theU1, Standard_Real& theU2,
    ...
    const Standard_Integer theI1p1, const Standard_Integer theI1p2, const Standard_Integer theI1,
    const Handle(HLRAlgo_PolyInternalData) & thePid1, HLRAlgo_Array1OfTData*& theTData1,
    HLRAlgo_Array1OfPISeg*& thePISeg1, HLRAlgo_Array1OfPINod*& thePINod1, const Standard_Real theX3,
    const Standard_Real theY3, const Standard_Real theZ3, const Standard_Real theXTI3, const Standard_Real theYTI3,
    const Standard_Real theZTI3, const Standard_Real theCoef3, const Standard_Real theU3,
    const Standard_Boolean theInsP3, const Standard_Boolean themP3P1, const Standard_Integer theFlag) const {
    ...
    if (anIns3 && themP3P1) // P1 ---> P3
    {
        if (!(theNod11Indices.Flag & NMsk_Vert) && theCoef3 < myTolSta) {
            ...
            ChangeNode(theI1p1, theI1p2, theNod11Indices, theNod11RValues, theNod12Indices, theNod12RValues, theCoef3,
                       theX3, theY3, theZ3, Standard_True, *theTData1, *thePISeg1, *thePINod1);
            theX1 = theX3;
            theY1 = theY3;
            theZ1 = theZ3;
            theXTI1 = theXTI3;
    ...
    if (anIns3 && !themP3P1) // P2 ---> P3
    {
        if (!(theNod12Indices.Flag & NMsk_Vert) && theCoef3 > myTolEnd) {
            anIns3 = Standard_False;
            ChangeNode(theI1p1, theI1p2, theNod11Indices, theNod11RValues, theNod12Indices, theNod12RValues, theCoef3,
                       theX3, theY3, theZ3, Standard_False, *theTData1, *thePISeg1, *thePINod1);
            theX2 = theX3;
            theY2 = theY3;
            theZ2 = theZ3;
            theXTI2 = theXTI3;
    ...
    {
        Standard_Integer anI1p3 =
            thePid1->AddNode(theNod11RValues, theNod12RValues, thePINod1, aPINod2, theCoef3, theX3, theY3, theZ3);
        ...
        thePid1->UpdateLinks(theI1p1, theI1p2, anI1p3, theTData1, aTData2, thePISeg1, aPISeg2, thePINod1, aPINod2);
        UpdateAroundNode(anI1p3, aNod13Indices, *theTData1, *thePISeg1, *thePINod1);
        theList.Prepend(HLRAlgo_BiPoint(theXTI1, theYTI1, theZTI1, theXTI3, theYTI3, theZTI3, theX1, theY1, theZ1,
                                        theX3, theY3, theZ3, theIEdge, theI1, theI1p1, anI1p3, theFlag));
        theList.Prepend(HLRAlgo_BiPoint(theXTI3, theYTI3, theZTI3, theXTI2, theYTI2, theZTI2, theX3, theY3, theZ3,
                                        theX2, theY2, theZ2, theIEdge, theI1, anI1p3, theI1p2, theFlag));
    } else // p1 p2
    {
        theList.Prepend(HLRAlgo_BiPoint(theXTI1, theYTI1, theZTI1, theXTI2, theYTI2, theZTI2, theX1, theY1, theZ1,
                                        theX2, theY2, theZ2, theIEdge, theI1, theI1p1, theI1p2, theFlag));
    }
}
...
void HLRBRep_PolyAlgo::MoveOrInsertPoint(
    ...
    const Standard_Integer theI2p1, const Standard_Integer theI2p2, const Standard_Integer theI2,
    const Handle(HLRAlgo_PolyInternalData) & thePid2, HLRAlgo_Array1OfTData*& theTData2,
    HLRAlgo_Array1OfPISeg*& thePISeg2, HLRAlgo_Array1OfPINod*& thePINod2, const Standard_Real theX3,
    const Standard_Real theY3, const Standard_Real theZ3, const Standard_Real theXTI3, const Standard_Real theYTI3,
    const Standard_Real theZTI3, const Standard_Real theCoef3, const Standard_Real theU3,
    const Standard_Boolean theInsP3, const Standard_Boolean themP3P1, const Standard_Integer theFlag) const {
    Standard_Boolean anIns3 = theInsP3;
    if (anIns3 && themP3P1) // P1 ---> P3
    {
        if (!(theNod11Indices.Flag & NMsk_Vert) && theCoef3 < myTolSta) {
            ...
            ChangeNode(theI1p1, theI1p2, theNod11Indices, theNod11RValues, theNod12Indices, theNod12RValues, theCoef3,
                       theX3, theY3, theZ3, Standard_True, *theTData1, *thePISeg1, *thePINod1);
            ChangeNode(theI2p1, theI2p2, theNod21Indices, theNod21RValues, theNod22Indices, theNod22RValues, theCoef3,
                       theX3, theY3, theZ3, Standard_True, *theTData2, *thePISeg2, *thePINod2);
            theX1 = theX3;
            theY1 = theY3;
            theZ1 = theZ3;
            theXTI1 = theXTI3;
    ...
    if (anIns3 && !themP3P1) // P2 ---> P3
    {
        if (!(theNod12Indices.Flag & NMsk_Vert) && theCoef3 > myTolEnd) {
            ...
            ChangeNode(theI1p1, theI1p2, theNod11Indices, theNod11RValues, theNod12Indices, theNod12RValues, theCoef3,
                       theX3, theY3, theZ3, Standard_False, *theTData1, *thePISeg1, *thePINod1);
            ChangeNode(theI2p1, theI2p2, theNod21Indices, theNod21RValues, theNod22Indices, theNod22RValues, theCoef3,
                       theX3, theY3, theZ3, Standard_False, *theTData2, *thePISeg2, *thePINod2);
            theX2 = theX3;
            theY2 = theY3;
            theZ2 = theZ3;
            theXTI2 = theXTI3;
    ...
    {
        Standard_Integer anI1p3 =
            thePid1->AddNode(theNod11RValues, theNod12RValues, thePINod1, thePINod2, theCoef3, theX3, theY3, theZ3);
        Standard_Integer anI2p3 =
            thePid2->AddNode(theNod21RValues, theNod22RValues, thePINod2, thePINod1, theCoef3, theX3, theY3, theZ3);
        const Handle(HLRAlgo_PolyInternalNode) & aPi1p3 = thePINod1->ChangeValue(anI1p3);
        HLRAlgo_PolyInternalNode::NodeIndices& aNod13Indices = aPi1p3->Indices();
        HLRAlgo_PolyInternalNode::NodeData& aNod13RValues = aPi1p3->Data();
        ...
        thePid1->UpdateLinks(theI1p1, theI1p2, anI1p3, theTData1, theTData2, thePISeg1, thePISeg2, thePINod1,
                             thePINod2);
        thePid2->UpdateLinks(theI2p1, theI2p2, anI2p3, theTData2, theTData1, thePISeg2, thePISeg1, thePINod2,
                             thePINod1);
        UpdateAroundNode(anI1p3, aNod13Indices, *theTData1, *thePISeg1, *thePINod1);
        UpdateAroundNode(anI2p3, aNod23Indices, *theTData2, *thePISeg2, *thePINod2);
        theList.Prepend(HLRAlgo_BiPoint(theXTI1, theYTI1, theZTI1, theXTI3, theYTI3, theZTI3, theX1, theY1, theZ1,
                                        theX3, theY3, theZ3, theIEdge, theI1, theI1p1, anI1p3, theI2, theI2p1, anI2p3,
                                        theFlag));
        theList.Prepend(HLRAlgo_BiPoint(theXTI3, theYTI3, theZTI3, theXTI2, theYTI2, theZTI2, theX3, theY3, theZ3,
                                        theX2, theY2, theZ2, theIEdge, theI1, anI1p3, theI1p2, theI2, anI2p3, theI2p2,
                                        theFlag));
    } else // p1 p2
    {
        theList.Prepend(HLRAlgo_BiPoint(theXTI1, theYTI1, theZTI1, theXTI2, theYTI2, theZTI2, theX1, theY1, theZ1,
...
void HLRBRep_PolyAlgo::MoveOrInsertPoint(
    ...
    const Standard_Real theY3, const Standard_Real theZ3, const Standard_Real theXTI3, const Standard_Real theYTI3,
    const Standard_Real theZTI3, const Standard_Real theCoef3, const Standard_Real theU3,
    const Standard_Boolean theInsP3, const Standard_Boolean themP3P1, const Standard_Real theX4,
    const Standard_Real theY4, const Standard_Real theZ4, const Standard_Real theXTI4, const Standard_Real theYTI4,
    const Standard_Real theZTI4, const Standard_Real theCoef4, const Standard_Real theU4,
    const Standard_Boolean theInsP4, const Standard_Boolean themP4P1, const Standard_Integer theFlag) const {
    Standard_Boolean anIns3 = theInsP3;
    ...
    if (anIns4 && !themP4P1) // P2 ---> P4
    {
        if (!(theNod12Indices.Flag & NMsk_Vert) && theCoef4 > myTolEnd) {
            ...
            ChangeNode(theI2p1, theI2p2, theNod21Indices, theNod21RValues, theNod22Indices, theNod22RValues, theCoef4,
                       theX4, theY4, theZ4, Standard_False, *theTData2, *thePISeg2, *thePINod2);
            ChangeNode(theI1p1, theI1p2, theNod11Indices, theNod11RValues, theNod12Indices, theNod12RValues, theCoef4,
                       theX4, theY4, theZ4, Standard_False, *theTData1, *thePISeg1, *thePINod1);
            theX2 = theX4;
            theY2 = theY4;
            theZ2 = theZ4;
            theXTI2 = theXTI4;
    ...
    if (anIns3 || anIns4) {
        if (!anIns4) // p1 i1p3 p2
        {
            MoveOrInsertPoint(theList, theX1, theY1, theZ1, theX2, theY2, theZ2, theXTI1, theYTI1, theZTI1, theXTI2,
                              ...
                              theNod12Indices, theNod12RValues, theI1p1, theI1p2, theI1, thePid1, theTData1, thePISeg1,
                              thePINod1, theNod21Indices, theNod21RValues, theNod22Indices, theNod22RValues, theI2p1,
                              theI2p2, theI2, thePid2, theTData2, thePISeg2, thePINod2, theX3, theY3, theZ3, theXTI3,
                              theYTI3, theZTI3, theCoef3, theU3, theInsP3, themP3P1, theFlag);
        } else if (!anIns3) // p1 i2p4 p2
        {
            MoveOrInsertPoint(theList, theX1, theY1, theZ1, theX2, theY2, theZ2, theXTI1, theYTI1, theZTI1, theXTI2,
                              ...
                              theNod22Indices, theNod22RValues, theI2p1, theI2p2, theI2, thePid2, theTData2, thePISeg2,
                              thePINod2, theNod11Indices, theNod11RValues, theNod12Indices, theNod12RValues, theI1p1,
                              theI1p2, theI1, thePid1, theTData1, thePISeg1, thePINod1, theX4, theY4, theZ4, theXTI4,
                              theYTI4, theZTI4, theCoef4, theU4, theInsP4, themP4P1, theFlag);
        } else // p1 i1p3 i2p4 p2
        {
            Standard_Integer anI1p3 =
                thePid1->AddNode(theNod11RValues, theNod12RValues, thePINod1, thePINod2, theCoef3, theX3, theY3, theZ3);
            Standard_Integer anI2p3 =
                thePid2->AddNode(theNod21RValues, theNod22RValues, thePINod2, thePINod1, theCoef3, theX3, theY3, theZ3);
            Standard_Integer anI1p4 =
                thePid1->AddNode(theNod11RValues, theNod12RValues, thePINod1, thePINod2, theCoef4, theX4, theY4, theZ4);
            Standard_Integer anI2p4 =
                thePid2->AddNode(theNod21RValues, theNod22RValues, thePINod2, thePINod1, theCoef4, theX4, theY4, theZ4);
            const Handle(HLRAlgo_PolyInternalNode) & aPi1p3 = thePINod1->ChangeValue(anI1p3);
            HLRAlgo_PolyInternalNode::NodeIndices& aNod13Indices = aPi1p3->Indices();
            HLRAlgo_PolyInternalNode::NodeData& aNod13RValues = aPi1p3->Data();
            ...
            thePid2->UpdateLinks(theI2p1, theI2p2, anI2p3, theTData2, theTData1, thePISeg2, thePISeg1, thePINod2,
                                 thePINod1);
            thePid2->UpdateLinks(anI2p3, theI2p2, anI2p4, theTData2, theTData1, thePISeg2, thePISeg1, thePINod2,
                                 thePINod1);
            thePid1->UpdateLinks(anI1p3, theI1p2, anI1p4, theTData1, theTData2, thePISeg1, thePISeg2, thePINod1,
                                 thePINod2);
            UpdateAroundNode(anI1p3, aNod13Indices, *theTData1, *thePISeg1, *thePINod1);
            UpdateAroundNode(anI2p3, aNod23Indices, *theTData2, *thePISeg2, *thePINod2);
            ...
            theList.Prepend(HLRAlgo_BiPoint(theXTI1, theYTI1, theZTI1, theXTI3, theYTI3, theZTI3, theX1, theY1, theZ1,
                                            theX3, theY3, theZ3, theIEdge, theI1, theI1p1, anI1p3, theI2, theI2p1,
                                            anI2p3, theFlag));
            theList.Prepend(HLRAlgo_BiPoint(theXTI3, theYTI3, theZTI3, theXTI4, theYTI4, theZTI4, theX3, theY3, theZ3,
                                            theX4, theY4, theZ4, theIEdge, theI1, anI1p3, anI1p4, theI2, anI2p3, anI2p4,
                                            theFlag));
            theList.Prepend(HLRAlgo_BiPoint(theXTI4, theYTI4, theZTI4, theXTI2, theYTI2, theZTI2, theX4, theY4, theZ4,
                                            theX2, theY2, theZ2, theIEdge, theI1, anI1p4, theI1p2, theI2, anI2p4,
                                            theI2p2, theFlag));
        }
    } else // p1 p2
    {
                ...
                if (aNod1Indices.Flag & NMsk_OutL && aNod2Indices.Flag & NMsk_OutL) {
                    ...
                    if (isInsP3 && mP3P1) // P1 ---> P3
                    {
                        if ((aNod1Indices.Flag & NMsk_Edge) == 0 && aCoef3 < myTolSta) {
                            ...
                            ChangeNode(ip1, ip2, aNod1Indices, aNod1RValues, aNod2Indices, aNod2RValues, aCoef3, X3, Y3,
                                       Z3, Standard_True, *aTData1, *aPISeg1, *aPINod1);
                            aNod1RValues.Scal = 0;
                    ...
                    if (isInsP3 && !mP3P1) // P2 ---> P3
                    {
                        if ((aNod2Indices.Flag & NMsk_Edge) == 0 && aCoef3 > myTolEnd) {
                            isInsP3 = Standard_False;
                            ChangeNode(ip1, ip2, aNod1Indices, aNod1RValues, aNod2Indices, aNod2RValues, aCoef3, X3, Y3,
                                       Z3, Standard_False, *aTData1, *aPISeg1, *aPINod1);
                            aNod2RValues.Scal = 0;
    ...
    while (isModif && iLoop < 4) {
        ...
        for (Standard_Integer aFaceIter = 1; aFaceIter <= aNbFaces; ++aFaceIter) {
            ...
            for (Standard_Integer aTriIter = 1; aTriIter <= aNbTris; ++aTriIter) {
                ...
                if ((tdata->Flags & HLRAlgo_PolyMask_FMskSide) == 0 && (tdata->Flags & HLRAlgo_PolyMask_FMskFrBack)) {
#ifdef OCCT_DEBUG
                    if (DoTrace) {
...
// purpose  :
//=======================================================================
void HLRBRep_PolyAlgo::FindEdgeOnTriangle(const HLRAlgo_TriangleData& theTriangle, const Standard_Integer theIp1,
                                          const Standard_Integer theIp2, Standard_Integer& theJtrouv,
...
// purpose  :
//=======================================================================
void HLRBRep_PolyAlgo::ChangeNode(const Standard_Integer theIp1, const Standard_Integer theIp2,
                                  HLRAlgo_PolyInternalNode::NodeIndices& theNod1Indices,
                                  HLRAlgo_PolyInternalNode::NodeData& theNod1RValues,
                                  HLRAlgo_PolyInternalNode::NodeIndices& theNod2Indices,
                                  HLRAlgo_PolyInternalNode::NodeData& theNod2RValues, const Standard_Real theCoef1,
                                  const Standard_Real theX3, const Standard_Real theY3, const Standard_Real theZ3,
                                  const Standard_Boolean theIsFirst, HLRAlgo_Array1OfTData& theTData,
                                  HLRAlgo_Array1OfPISeg& thePISeg, HLRAlgo_Array1OfPINod& thePINod) const {
...
void HLRBRep_PolyAlgo::UpdateAroundNode(const Standard_Integer theINode,
    ...
    while (iiii != 0) {
        ...
        if (iTri1 != 0) {
            ...
            OrientTriangle(iTri1, aTriangle, aNod1Indices, aNod1RValues, aNod2Indices, aNod2RValues, aNod3Indices,
                           aNod3RValues);
        }
        if (iTri2 != 0) {
            ...
            HLRAlgo_PolyInternalNode::NodeData& aNod2RValues = aPN2->Data();
            HLRAlgo_PolyInternalNode::NodeData& aNod3RValues = aPN3->Data();
            OrientTriangle(iTri2, aTriangle2, aNod1Indices, aNod1RValues, aNod2Indices, aNod2RValues, aNod3Indices,
                           aNod3RValues);
        }
...
// purpose  :
//=======================================================================
void HLRBRep_PolyAlgo::OrientTriangle(const Standard_Integer theITri, HLRAlgo_TriangleData& theTriangle,
                                      HLRAlgo_PolyInternalNode::NodeIndices& theNod1Indices,
                                      HLRAlgo_PolyInternalNode::NodeData& theNod1RValues,
                                      HLRAlgo_PolyInternalNode::NodeIndices& theNod2Indices,
                                      HLRAlgo_PolyInternalNode::NodeData& theNod2RValues,
...
// purpose  :
//=======================================================================
Standard_Boolean HLRBRep_PolyAlgo::Triangles(const Standard_Integer theIp1, const Standard_Integer theIp2,
                                             HLRAlgo_PolyInternalNode::NodeIndices& theNod1Indices,
                                             HLRAlgo_Array1OfPISeg*& thePISeg, Standard_Integer& theITri1,
...
Standard_Boolean HLRBRep_PolyAlgo::NewNode(HLRAlgo_PolyInternalNode::NodeData& theNod1RValues,
                                           HLRAlgo_PolyInternalNode::NodeData& theNod2RValues, Standard_Real& theCoef1,
...
void HLRBRep_PolyAlgo::UVNode(HLRAlgo_PolyInternalNode::NodeData& theNod1RValues,
                              HLRAlgo_PolyInternalNode::NodeData& theNod2RValues, const Standard_Real theCoef1,
                              Standard_Real& theU3, Standard_Real& theV3) const {
    const Standard_Real aCoef2 = 1.0 - theCoef1;
        ...
        for (Standard_Integer aSegIter = 1; aSegIter <= aNbSegs; ++aSegIter) {
            ...
            if (it1 != 0 && it2 != 0 && it1 != it2) // debile but sure !
            {
                ...
                if (!(aTriangle.Flags & HLRAlgo_PolyMask_FMskSide) && !(aTriangle2.Flags & HLRAlgo_PolyMask_FMskSide)) {
                    isOutl =
                        (aTriangle.Flags & HLRAlgo_PolyMask_FMskBack) != (aTriangle2.Flags & HLRAlgo_PolyMask_FMskBack);
                ...
                if (isOutl) {
                    ...
                    TIMultiply(XTI2, YTI2, ZTI2);
                    theList.Append(HLRAlgo_BiPoint(XTI1, YTI1, ZTI1, XTI2, YTI2, ZTI2, X1, Y1, Z1, X2, Y2, Z2,
...
// purpose  :
//=======================================================================
void HLRBRep_PolyAlgo::TMultiply(Standard_Real& theX, Standard_Real& theY, Standard_Real& theZ,
...
// purpose  :
//=======================================================================
void HLRBRep_PolyAlgo::TTMultiply(Standard_Real& theX, Standard_Real& theY, Standard_Real& theZ,
                                  const Standard_Boolean theVPO) const {
...
// purpose  :
//=======================================================================
void HLRBRep_PolyAlgo::TIMultiply(Standard_Real& theX, Standard_Real& theY, Standard_Real& theZ,
                                  const Standard_Boolean theVPO) const {
...
// purpose  :
//=======================================================================
HLRAlgo_BiPoint::PointsT& HLRBRep_PolyAlgo::Hide(HLRAlgo_EdgeStatus& theStatus, TopoDS_Shape& theShape,
                                                 Standard_Boolean& theReg1, Standard_Boolean& theRegn,
                                                 Standard_Boolean& theOutl, Standard_Boolean& theIntl) {
...
// purpose  :
//=======================================================================
HLRAlgo_BiPoint::PointsT& HLRBRep_PolyAlgo::Show(TopoDS_Shape& theShape, Standard_Boolean& theReg1,
                                                 Standard_Boolean& theRegn, Standard_Boolean& theOutl,
