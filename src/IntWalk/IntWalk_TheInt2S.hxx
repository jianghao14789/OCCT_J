...
public:
    ...
    Standard_EXPORT IntWalk_TheInt2S(const TColStd_Array1OfReal& Param, const Handle(Adaptor3d_Surface) & S1,
                                     const Handle(Adaptor3d_Surface) & S2, const Standard_Real TolTangency);
    ...
    //! }
    Standard_EXPORT IntWalk_TheInt2S(const Handle(Adaptor3d_Surface) & S1, const Handle(Adaptor3d_Surface) & S2,
