...
public:
    ...
    Standard_EXPORT IntWalk_PWalking(const Handle(Adaptor3d_Surface) & Caro1, const Handle(Adaptor3d_Surface) & Caro2,
    ...
    Standard_EXPORT void Perform(const TColStd_Array1OfReal& ParDep, const Standard_Real u1min,
                                 const Standard_Real v1min, const Standard_Real u2min, const Standard_Real v2min,
                                 const Standard_Real u1max, const Standard_Real v1max, const Standard_Real u2max,
    ...
    Standard_EXPORT Standard_Boolean TestArret(const Standard_Boolean DejaReparti, TColStd_Array1OfReal& Param,
                                               IntImp_ConstIsoparametric& ChoixIso);

    Standard_EXPORT void RepartirOuDiviser(Standard_Boolean& DejaReparti, IntImp_ConstIsoparametric& ChoixIso,
    ...
    void RemoveAPoint(const Standard_Integer theIndex) {
        ...
        if (anIdx <= myTangentIdx) {
            ...
            if (myTangentIdx < 1) myTangentIdx = 1;
        }
...
protected:
    Standard_EXPORT void ComputePasInit(const Standard_Real theDeltaU1, const Standard_Real theDeltaV1,
    ...
    Standard_EXPORT Standard_Boolean DistanceMinimizeByExtrema(const Handle(Adaptor3d_Surface) & theASurf,
                                                               ...
                                                               Standard_Real& theV0, const Standard_Real* theStep0 = 0);
