...
void IGESGraph_TextFontDef::Init(const Standard_Integer aFontCode, const Handle(TCollection_HAsciiString) & aFontName,
                                 const Standard_Integer aSupersededFont,
                                 const Handle(IGESGraph_TextFontDef) & aSupersededEntity, const Standard_Integer aScale,
...
void IGESGraph_TextFontDef::NextCharOrigin(const Standard_Integer Chnum, Standard_Integer& NX,
...
void IGESGraph_TextFontDef::NextPenPosition(const Standard_Integer Chnum, const Standard_Integer Motionnum,
