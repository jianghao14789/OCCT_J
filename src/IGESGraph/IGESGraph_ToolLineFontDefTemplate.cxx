...
void IGESGraph_ToolLineFontDefTemplate::ReadOwnParams(const Handle(IGESGraph_LineFontDefTemplate) & ent,
    ...
    PR.ReadEntity(IR, PR.Current(), "Subfigure Definition Entity for Template Display",
...
void IGESGraph_ToolLineFontDefTemplate::WriteOwnParams(const Handle(IGESGraph_LineFontDefTemplate) & ent,
...
void IGESGraph_ToolLineFontDefTemplate::OwnCopy(const Handle(IGESGraph_LineFontDefTemplate) & another,
                                                const Handle(IGESGraph_LineFontDefTemplate) & ent,
                                                Interface_CopyTool& TC) const {
    Standard_Integer tempOrientation = another->Orientation();
    DeclareAndCast(IGESBasic_SubfigureDef, tempTemplateSubfigure, TC.Transferred(another->TemplateEntity()));
...
IGESData_DirChecker
IGESGraph_ToolLineFontDefTemplate::DirChecker(const Handle(IGESGraph_LineFontDefTemplate) & /*ent*/) const {
