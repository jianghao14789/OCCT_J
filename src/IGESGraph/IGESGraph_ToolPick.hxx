...
public:
    ...
    Standard_EXPORT void ReadOwnParams(const Handle(IGESGraph_Pick) & ent, const Handle(IGESData_IGESReaderData) & IR,
    ...
    Standard_EXPORT void OwnCheck(const Handle(IGESGraph_Pick) & ent, const Interface_ShareTool& shares,
                                  Handle(Interface_Check) & ach) const;

    //! Copies Specific Parameters
    Standard_EXPORT void OwnCopy(const Handle(IGESGraph_Pick) & entfrom, const Handle(IGESGraph_Pick) & entto,
                                 Interface_CopyTool& TC) const;

    //! Dump of Specific Parameters
    Standard_EXPORT void OwnDump(const Handle(IGESGraph_Pick) & ent, const IGESData_IGESDumper& dumper,
