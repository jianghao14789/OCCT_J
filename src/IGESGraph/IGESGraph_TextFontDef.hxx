...
public:
    ...
    //! are not same.
    Standard_EXPORT void Init(const Standard_Integer aFontCode, const Handle(TCollection_HAsciiString) & aFontName,
    ...
    Standard_EXPORT void NextPenPosition(const Standard_Integer Chnum, const Standard_Integer Motionnum,
