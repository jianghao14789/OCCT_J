...
void IGESGraph_GeneralModule::OwnSharedCase(const Standard_Integer CN, const Handle(IGESData_IGESEntity) & ent,
...
IGESData_DirChecker IGESGraph_GeneralModule::DirChecker(const Standard_Integer CN,
...
void IGESGraph_GeneralModule::OwnCheckCase(const Standard_Integer CN, const Handle(IGESData_IGESEntity) & ent,
...
Standard_Boolean IGESGraph_GeneralModule::NewVoid(const Standard_Integer CN, Handle(Standard_Transient) & ent) const {
    switch (CN) {
        case 1:
...
void IGESGraph_GeneralModule::OwnCopyCase(const Standard_Integer CN, const Handle(IGESData_IGESEntity) & entfrom,
