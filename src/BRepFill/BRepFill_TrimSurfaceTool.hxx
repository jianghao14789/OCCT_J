...
public:
    ...
    Standard_EXPORT BRepFill_TrimSurfaceTool(const Handle(Geom2d_Curve) & Bis, const TopoDS_Face& Face1,
    ...
    Standard_EXPORT void IntersectWith(const TopoDS_Edge& EdgeOnF1, const TopoDS_Edge& EdgeOnF2,
    ...
    Standard_EXPORT void Project(const Standard_Real U1, const Standard_Real U2, Handle(Geom_Curve) & Curve,
