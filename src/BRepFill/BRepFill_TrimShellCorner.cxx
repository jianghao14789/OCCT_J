...
static TopoDS_Edge FindEdgeCloseToBisectorPlane(const TopoDS_Vertex& theVertex, TopoDS_Compound& theComp,
                                                const gp_Ax1& theAxis);

static Standard_Boolean FindMiddleEdges(const TopoDS_Vertex& theVertex1, const TopoDS_Vertex& theVertex2,
                                        const gp_Ax1& theAxis, TopoDS_Compound& theComp,
                                        TopTools_ListOfShape& theElist);

static Standard_Boolean FindCommonVertex(const TopoDS_Edge& theFirstEdge, const TopoDS_Edge& theLastEdge,
                                         const TopoDS_Vertex& theFirstVertex, const TopoDS_Vertex& theLastVertex,
                                         TopoDS_Vertex& theCommonVertex);

static Standard_Boolean FindCommonVertex(const BOPDS_PDS& theDS, const Standard_Integer theEIndex1,
                                         const Standard_Integer theEIndex2, TopoDS_Vertex& theCommonVertex,
                                         Standard_Real& theParamOnE1, Standard_Real& theParamOnE2);

static Standard_Boolean SplitUEdges(const Handle(TopTools_HArray2OfShape) & theUEdges, const BOPDS_PDS& theDS,
                                    TopTools_DataMapOfShapeListOfShape& theHistMap);

static void StoreVedgeInHistMap(const Handle(TopTools_HArray1OfShape) & theVEdges, const Standard_Integer theIndex,
                                const TopoDS_Shape& theNewVedge, TopTools_DataMapOfShapeListOfShape& theHistMap);

static void FindFreeVertices(const TopoDS_Shape& theShape, const TopTools_MapOfShape& theVerticesToAvoid,
                             TopTools_ListOfShape& theListOfVertex);

static Standard_Boolean CheckAndOrientEdges(const TopTools_ListOfShape& theOrderedList, const gp_Pnt2d& theFirstPoint,
                                            const gp_Pnt2d& theLastPoint, const TopoDS_Face& theFace,
                                            TopTools_ListOfShape& theOrientedList);

static Standard_Boolean FillGap(const TopoDS_Vertex& theFirstVertex, const TopoDS_Vertex& theLastVertex,
                                const gp_Pnt2d& theFirstPoint, const gp_Pnt2d& theLastPoint, const TopoDS_Face& theFace,
                                const TopoDS_Compound& theSectionEdges, TopTools_ListOfShape& theOrderedList);

static Standard_Boolean FindNextEdge(const TopoDS_Vertex& theFirstVertex, const TopoDS_Vertex& theLastVertex,
                                     const TopTools_IndexedDataMapOfShapeListOfShape& theMapVE,
                                     const TopTools_MapOfShape& theMapToAvoid, TopTools_ListOfShape& theOrderedList);

static Standard_Boolean FindVertex(const TopoDS_Edge& theEdge, const Standard_Integer theRank, const BOPDS_PDS& theDS,
                                   const TopTools_DataMapOfShapeListOfShape& theHistMap, TopoDS_Vertex& theVertex,
                                   BOPDS_Pave& thePave);

static Standard_Boolean FindNextVertex(const Standard_Integer theEdgeIndex, const BOPDS_Pave& thePrevPave,
                                       const BOPDS_PDS& theDS, TopoDS_Vertex& theNextVertex, BOPDS_Pave& thePave);
...
static Standard_Boolean FindFromUEdge(const TopoDS_Edge& theUE1Old, const TopoDS_Edge& theUE2Old,
                                      const TopoDS_Edge& theUE1New, const TopoDS_Edge& theUE2New,
                                      const TopoDS_Face& theFace, const TopoDS_Compound& theSecEdges,
                                      const Standard_Integer theRank, const TopoDS_Edge& theBoundEdge,
                                      const Standard_Integer theBoundEdgeIndex, const BOPDS_PDS& theDS,
                                      const TopTools_DataMapOfShapeListOfShape& theHistMap,
                                      TopoDS_Compound& theSecEdgesNew, TopTools_ListOfShape& theListOfWireEdges,
                                      BOPDS_Pave& theFoundPave, Standard_Boolean& isOnUEdge);

static Standard_Boolean FindFromVEdge(const BOPDS_Pave& thePrevPave, const Standard_Boolean& isOnUEdge,
                                      const TopoDS_Edge& theUE1Old, const TopoDS_Edge& theUE2Old,
                                      const TopoDS_Face& theFace, const TopoDS_Compound& theSecEdges,
                                      const Standard_Integer theRank, const TopoDS_Edge& theBoundEdge,
                                      const Standard_Integer theBoundEdgeIndex, const BOPDS_PDS& theDS,
                                      const TopTools_DataMapOfShapeListOfShape& theHistMap,
                                      TopTools_ListOfShape& theListOfWireEdges, Standard_Boolean& isSectionFound);

static void RemoveEdges(const TopoDS_Compound& theSourceComp, const TopTools_ListOfShape& theListToRemove,
                        TopoDS_Compound& theResultComp);

static Standard_Boolean FilterSectionEdges(const BOPDS_VectorOfCurve& theBCurves, const TopoDS_Face& theSecPlane,
                                           const BOPDS_PDS& theDS, TopoDS_Compound& theResult);

static Standard_Boolean GetUEdges(const Standard_Integer theIndex, const Standard_Integer theRank,
                                  const Handle(TopTools_HArray2OfShape) & theUEdges, const TopoDS_Edge& theBoundEdge,
                                  const TopoDS_Face& theFace, TopoDS_Edge& theFirstUEdge, TopoDS_Edge& theSecondUEdge);

static Standard_Real ComputeAveragePlaneAndMaxDeviation(const TopoDS_Shape& aWire, gp_Pln& thePlane,
                                                        Standard_Boolean& IsSingular);

static void UpdateSectionEdge(TopoDS_Edge& theEdge, const TopoDS_Vertex& theConstVertex, TopoDS_Vertex& theVertex,
...
BRepFill_TrimShellCorner::BRepFill_TrimShellCorner(const Handle(TopTools_HArray2OfShape) & theFaces,
    ...
    : myTransition(theTransition), myAxeOfBisPlane(theAxeOfBisPlane), myDone(Standard_False),
      myHasSection(Standard_False) {
    myFaces = new TopTools_HArray2OfShape(theFaces->LowerRow(), theFaces->UpperRow(), theFaces->LowerCol(),
                                          theFaces->UpperCol());
...
void BRepFill_TrimShellCorner::AddBounds(const Handle(TopTools_HArray2OfShape) & theBounds) {
    myBounds = new TopTools_HArray2OfShape(theBounds->LowerRow(), theBounds->UpperRow(), theBounds->LowerCol(),
                                           theBounds->UpperCol());
...
void BRepFill_TrimShellCorner::AddUEdges(const Handle(TopTools_HArray2OfShape) & theUEdges) {
    myUEdges = new TopTools_HArray2OfShape(theUEdges->LowerRow(), theUEdges->UpperRow(), theUEdges->LowerCol(),
                                           theUEdges->UpperCol());
...
void BRepFill_TrimShellCorner::Perform() {
    ...
    for (ii = myFaces->LowerRow(); ii <= myFaces->UpperRow(); ii++) {
        ...
        if ((anIndex1 == -1) || (anIndex2 == -1)) continue;
...
// purpose:
// ===========================================================================================
void BRepFill_TrimShellCorner::Modified(const TopoDS_Shape& theShape, TopTools_ListOfShape& theModified) {
    theModified.Clear();
...
// ----------------------------------------------------------------------------------------------------
Standard_Boolean BRepFill_TrimShellCorner::MakeFacesNonSec(const Standard_Integer theIndex, const BOPDS_PDS& theDS,
    ...
    Standard_Boolean bvertexfound = FindCommonVertex(theDS, anIndex1, anIndex2, aCommonVertex, apar1, apar2);
    ...
    for (ueit = 1, eindex = theIndex; ueit <= 2; ueit++, eindex++) {
        ...
        if (myHistMap.IsBound(aShape1)) {
            ...
            if (!lst.IsEmpty()) aUE1 = TopoDS::Edge(lst.First());
        }

        if (myHistMap.IsBound(aShape2)) {
            const TopTools_ListOfShape& lst = myHistMap.Find(aShape2);

            if (!lst.IsEmpty()) aUE2 = TopoDS::Edge(lst.First());
        }
    ...
    if (bvertexfound) {
        if (aCommonVertices.Extent() != 1) return Standard_False;
    ...
    if (aCommonVertices.Extent() == 2) {
        aNewEdge = BRepLib_MakeEdge(TopoDS::Vertex(aCommonVertices.First()), TopoDS::Vertex(aCommonVertices.Last()));
        bHasNewEdge = Standard_True;
    }
    ...
    for (fit = 1; fit <= 2; fit++) {
        ...
        for (ueit = 1, eindex = theIndex; ueit <= 2; ueit++, eindex++) {
            ...
            if (myHistMap.IsBound(aShape)) {
                ...
                if (!lst.IsEmpty()) aUE = TopoDS::Edge(lst.First());
            }
        ...
        if (!alonevertices.IsEmpty() && (alonevertices.Extent() != 2)) return Standard_False;
            ...
            if (bfound1 && bfound2) {
                ...
                if (bHasNewEdge) {
                    ...
                    for (; !bfoundv && anExpV.More(); anExpV.Next()) {
                        if (aV2.IsSame(anExpV.Current())) bfoundv = Standard_True;
                    }
        ...
        for (; anExpE.More(); anExpE.Next()) {
            ...
            if (aNewValue.IsNull() || aNewValue.IsSame(anExpE.Current())) continue;

            if (myHistMap.IsBound(anExpE.Current())) continue;
...
// ----------------------------------------------------------------------------------------------------
Standard_Boolean BRepFill_TrimShellCorner::MakeFacesSec(const Standard_Integer theIndex, const BOPDS_PDS& theDS,
                                                        const Standard_Integer theFaceIndex1,
                                                        const Standard_Integer theFaceIndex2,
    ...
    if (!FilterSectionEdges(aBCurves, aSecPlane, theDS, aSecEdges)) return Standard_False;
    ...
    FindCommonVertex(theDS, IndexOfLeftE1, IndexOfLeftE2, FirstVertex, ParamOnLeftE1, ParamOnLeftE2);
    FindCommonVertex(theDS, IndexOfRightE1, IndexOfRightE2, LastVertex, ParamOnRightE1, ParamOnRightE2);

    TopoDS_Shape SecWire;
    gp_Pln SecPlane;
    Standard_Boolean IsSingular;
    Standard_Boolean WireFound = ChooseSection(aSecEdges, FirstVertex, LastVertex, SecWire, SecPlane, IsSingular);
    ...
    for (fit = 0; fit < 2; fit++) {
        ...
        if (!GetUEdges(theIndex, fit, myUEdges, aBoundEdge, aFaceF, aUE1, aUE2)) return Standard_False;
        ...
        if (FindFromUEdge(aUE1old, aUE2old, aUE1, aUE2, aFace, aSecEdges, fit, aBoundEdge, aBoundEdgeIndex, theDS,
                          myHistMap, aCompOfSecEdges, aListOfWireEdges, aPave1, isPave1OnUEdge)) {
        ...
        if (!aListOfWireEdges.IsEmpty()) {
            ...
            for (; aEIt.More(); aEIt.Next()) {
                if (!aBoundEdge.IsSame(aEIt.Value())) aBB.Add(aW, aEIt.Value());
            }
...
// purpose  :
//=======================================================================
Standard_Boolean BRepFill_TrimShellCorner::ChooseSection(const TopoDS_Shape& Comp, const TopoDS_Vertex& theFirstVertex,
                                                         const TopoDS_Vertex& theLastVertex, TopoDS_Shape& resWire,
                                                         gp_Pln& resPlane, Standard_Boolean& IsSingular) {
    ...
    // its known first vertex to its known last vertex
    {
        ...
        TopoDS_Edge FirstEdge = FindEdgeCloseToBisectorPlane(theFirstVertex, OldComp, myAxeOfBisPlane.Axis());
        if (FirstEdge.IsNull()) return Standard_False;
        ...
        TopoDS_Edge LastEdge = FindEdgeCloseToBisectorPlane(theLastVertex, OldComp, myAxeOfBisPlane.Axis());
        if (LastEdge.IsNull()) return Standard_False;
                ...
                if (FindMiddleEdges(Vertex1, Vertex2, myAxeOfBisPlane.Axis(), OldComp, MiddleEdges)) {
                    ...
                    if (Extrema.IsDone() && Extrema.NbExt() > 0) {
                        ...
                        for (i = 2; i <= Extrema.NbExt(); i++)
                            if (Extrema.SquareDistance(i) < Extrema.SquareDistance(imin)) imin = i;
    ...
    for (;;) {
        ...
        for (;;) {
            ...
            for (j = 0; j < 2; j++)
                if (VEmap.Contains(Extremity[j])) Vedges[j] = VEmap.FindFromKey(Extremity[j]);
...
// purpose:
// ------------------------------------------------------------------------------------------
Standard_Boolean SplitUEdges(const Handle(TopTools_HArray2OfShape) & theUEdges, const BOPDS_PDS& theDS,
                             TopTools_DataMapOfShapeListOfShape& theHistMap) {
    ...
    for (ueit = theUEdges->LowerRow(); ueit <= upRow; ueit++) {
        ...
        if (theHistMap.IsBound(aE1) || theHistMap.IsBound(aE2)) continue;
        ...
        TopoDS_Vertex aCommonVertex;
        Standard_Real apar1 = 0., apar2 = 0.;
        Standard_Boolean bvertexfound = FindCommonVertex(theDS, anEIndex1, anEIndex2, aCommonVertex, apar1, apar2);
        //
        if (!bvertexfound) {
...
// purpose:
// ------------------------------------------------------------------------------------------
void StoreVedgeInHistMap(const Handle(TopTools_HArray1OfShape) & theVEdges, const Standard_Integer theIndex,
                         const TopoDS_Shape& theNewVshape, TopTools_DataMapOfShapeListOfShape& theHistMap) {
...
// purpose:
// ------------------------------------------------------------------------------------------
void FindFreeVertices(const TopoDS_Shape& theShape, const TopTools_MapOfShape& theVerticesToAvoid,
                      TopTools_ListOfShape& theListOfVertex) {
    ...
    for (i = 1; i <= aMap.Extent(); i++) {
        ...
        if (theVerticesToAvoid.Contains(aKey)) continue;
...
// purpose:
// ------------------------------------------------------------------------------------------
Standard_Boolean FindCommonVertex(const BOPDS_PDS& theDS, const Standard_Integer theEIndex1,
                                  const Standard_Integer theEIndex2, TopoDS_Vertex& theCommonVertex,
                                  Standard_Real& theParamOnE1, Standard_Real& theParamOnE2) {
...
// purpose:
// ----------------------------------------------------------------------------------------------------
Standard_Boolean GetUEdges(const Standard_Integer theIndex, const Standard_Integer theRank,
                           const Handle(TopTools_HArray2OfShape) & theUEdges, const TopoDS_Edge& theBoundEdge,
                           const TopoDS_Face& theFace, TopoDS_Edge& theFirstUEdge, TopoDS_Edge& theSecondUEdge) {
...
// purpose:
// ----------------------------------------------------------------------------------------------------
Standard_Boolean FillGap(const TopoDS_Vertex& theFirstVertex, const TopoDS_Vertex& theLastVertex,
                         const gp_Pnt2d& theFirstPoint, const gp_Pnt2d& theLastPoint, const TopoDS_Face& theFace,
                         const TopoDS_Compound& theSectionEdges, TopTools_ListOfShape& theOrderedList) {
...
// purpose:
// ----------------------------------------------------------------------------------------------------
Standard_Boolean FindNextEdge(const TopoDS_Vertex& theFirstVertex, const TopoDS_Vertex& theLastVertex,
                              const TopTools_IndexedDataMapOfShapeListOfShape& theMapVE,
                              const TopTools_MapOfShape& theMapToAvoid, TopTools_ListOfShape& theOrderedList) {
    TopoDS_Vertex aCurVertex = theFirstVertex;
    TopTools_MapOfShape aMapToAvoid;
    ...
    for (i = 1; i <= theMapVE.Extent(); i++) {
        if (!theMapVE.Contains(aCurVertex)) break;
        ...
        if (aCurVertex.IsSame(theLastVertex)) break;
...
// purpose:
// ----------------------------------------------------------------------------------------------------
Standard_Boolean CheckAndOrientEdges(const TopTools_ListOfShape& theOrderedList, const gp_Pnt2d& theFirstPoint,
                                     const gp_Pnt2d& theLastPoint, const TopoDS_Face& theFace,
                                     TopTools_ListOfShape& theOrientedList) {
    TopTools_ListIteratorOfListOfShape anIt(theOrderedList);

    if (!anIt.More()) return Standard_True;
    ...
    if (ap.Distance(theFirstPoint) < aTolerance1) {
        if (theOrientedList.IsEmpty()) theOrientedList.Append(aEPrev.Oriented(TopAbs_FORWARD));
        bFirstFound = Standard_True;
    } else if (ap.Distance(theLastPoint) < aTolerance1) {
        if (theOrientedList.IsEmpty()) theOrientedList.Append(aEPrev.Oriented(TopAbs_REVERSED));
    ...
    if (!theOrientedList.IsEmpty()) aEPrev = TopoDS::Edge(theOrientedList.Last());
    ...
    for (; anIt.More(); anIt.Next()) {
        ...
        TopAbs_Orientation anOri = (aV12.IsSame(aV21) || aV11.IsSame(aV22)) ? TopAbs_FORWARD : TopAbs_REVERSED;
...
// purpose:
// ----------------------------------------------------------------------------------------------------
Standard_Boolean FindVertex(const TopoDS_Edge& theEdge, const Standard_Integer theRank, const BOPDS_PDS& theDS,
                            const TopTools_DataMapOfShapeListOfShape& theHistMap, TopoDS_Vertex& theVertex,
                            BOPDS_Pave& thePave) {

    if (!theHistMap.IsBound(theEdge)) return Standard_False;

    const TopTools_ListOfShape& lst = theHistMap.Find(theEdge);

    if (lst.IsEmpty()) return Standard_False;
...
// purpose:
// ----------------------------------------------------------------------------------------------------
Standard_Boolean FindNextVertex(const Standard_Integer theEdgeIndex, const BOPDS_Pave& thePrevPave,
                                const BOPDS_PDS& theDS, TopoDS_Vertex& theNextVertex, BOPDS_Pave& thePave) {
...
// purpose:
// ----------------------------------------------------------------------------------------------------
Standard_Boolean GetPave(const Standard_Integer theEdgeIndex, const Standard_Boolean isFirst, const BOPDS_PDS& theDS,
                         BOPDS_Pave& thePave) {
...
// purpose:
// ----------------------------------------------------------------------------------------------------
Standard_Boolean FindFromUEdge(const TopoDS_Edge& theUE1Old, const TopoDS_Edge& theUE2Old, const TopoDS_Edge& theUE1New,
                               const TopoDS_Edge& theUE2New, const TopoDS_Face& theFace,
                               const TopoDS_Compound& theSecEdges, const Standard_Integer theRank,
                               const TopoDS_Edge& theBoundEdge, const Standard_Integer theBoundEdgeIndex,
                               const BOPDS_PDS& theDS, const TopTools_DataMapOfShapeListOfShape& theHistMap,
                               TopoDS_Compound& theSecEdgesNew, TopTools_ListOfShape& theListOfWireEdges,
                               BOPDS_Pave& theFoundPave, Standard_Boolean& isOnUEdge) {
...
// purpose:
// ----------------------------------------------------------------------------------------------------
Standard_Boolean FindFromVEdge(const BOPDS_Pave& thePrevPave, const Standard_Boolean& isOnUEdge,
                               const TopoDS_Edge& theUE1Old, const TopoDS_Edge& theUE2Old, const TopoDS_Face& theFace,
                               const TopoDS_Compound& theSecEdges, const Standard_Integer theRank,
                               const TopoDS_Edge& theBoundEdge, const Standard_Integer theBoundEdgeIndex,
                               const BOPDS_PDS& theDS, const TopTools_DataMapOfShapeListOfShape& theHistMap,
                               TopTools_ListOfShape& theListOfWireEdges, Standard_Boolean& isSectionFound) {
    ...
    if (isOnUEdge) {
        ...
        if (FindVertex(theUE2Old, theRank, theDS, theHistMap, atmpVertex, aPaveOfE2)) {
            if (thePrevPave.IsEqual(aPaveOfE2)) return Standard_True;
        }
    }
    ...
    while (FindNextVertex(theBoundEdgeIndex, aPave1, theDS, aNextVertex, aPave2) && (pit < nbpave)) {
        ...
        for (aPIt1.Initialize(aFirstPaves), aPIt2.Initialize(aLastPaves), aFlagIt.Initialize(aListOfFlags);
             aPIt1.More() && aPIt2.More() && aFlagIt.More(); aPIt1.Next(), aPIt2.Next(), aFlagIt.Next(), apbcounter++) {
            ...
            if (aFlagIt.Value()) {
                ...
                if ((aPave2.Index() == aPIt2.Value().Index()) && (aPave2.Index() > 0)) {
                    ...
                    if (p2.Distance(p3) < aTolerance) blin = Standard_True;
                }
            }
    ...
    if (FindVertex(theUE2Old, theRank, theDS, theHistMap, aNextVertex, aPave2)) {
        ...
        if (!bisinside) {
            ...
            if (FillGap(aFirstV, aLastV, p1, p2, aFaceF, aCompOfSecEdges, aOrderedList)) {
                ...
                TopoDS_Edge aESplit;
                // get split
                if (!GetPave(theBoundEdgeIndex, Standard_False, theDS, aPave2)) return Standard_False;
                //
                aPBIt.Initialize(theDS->PaveBlocks(theBoundEdgeIndex));
                for (; aPBIt.More(); aPBIt.Next()) {
                    const Handle(BOPDS_PaveBlock) & aPB1 = aPBIt.Value();
...
// purpose:
// ----------------------------------------------------------------------------------------------------
void RemoveEdges(const TopoDS_Compound& theSourceComp, const TopTools_ListOfShape& theListToRemove,
                 TopoDS_Compound& theResultComp) {
    BRep_Builder aBB;
    TopoDS_Compound aComp;
    aBB.MakeCompound(aComp);
...
// purpose:
// ----------------------------------------------------------------------------------------------------
Standard_Boolean FilterSectionEdges(const BOPDS_VectorOfCurve& theBCurves, const TopoDS_Face& theSecPlane,
                                    const BOPDS_PDS& theDS, TopoDS_Compound& theResult) {
...
static TopoDS_Edge FindEdgeCloseToBisectorPlane(const TopoDS_Vertex& theVertex, TopoDS_Compound& theComp,
    ...
    TopoDS_Edge MinEdge;
    if (!VEmap.Contains(theVertex)) return MinEdge;
    ...
    if (Edges.Extent() == 1)
        ...
        for (; itl.More(); itl.Next()) {
            ...
            if (issing) // edge is a segment of line
            {
                ...
                if (anAngle > M_PI / 2) anAngle = M_PI - anAngle;
...
static Standard_Boolean FindMiddleEdges(const TopoDS_Vertex& theVertex1, const TopoDS_Vertex& theVertex2,
    ...
    TopTools_IndexedDataMapOfShapeListOfShape VEmap;
    TopExp::MapShapesAndAncestors(theComp, TopAbs_VERTEX, TopAbs_EDGE, VEmap);
    if (VEmap.IsEmpty()) return Standard_False;

    if (!VEmap.Contains(theVertex1) || !VEmap.Contains(theVertex2)) return Standard_False;
    ...
    for (;;) {
        ...
        if (CurEdge.IsNull()) return Standard_False;
        ...
        if (CurVertex.IsSame(theVertex2)) return Standard_True;
    }
}
...
static Standard_Boolean FindCommonVertex(const TopoDS_Edge& theFirstEdge, const TopoDS_Edge& theLastEdge,
    ...
    if (!theFirstVertex.IsSame(theLastVertex)) {
        Standard_Boolean CommonVertexExists = TopExp::CommonVertex(theFirstEdge, theLastEdge, theCommonVertex);
