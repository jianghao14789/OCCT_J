...
public:
    ...
    Standard_EXPORT BRepFill_Pipe(const TopoDS_Wire& Spine, const TopoDS_Shape& Profile,
    ...
    Standard_EXPORT void Perform(const TopoDS_Wire& Spine, const TopoDS_Shape& Profile,
                                 const Standard_Boolean GeneratePartCase = Standard_False);
...
private:
    ...
    //! result.
    Standard_EXPORT TopoDS_Shape MakeShape(const TopoDS_Shape& S, const TopoDS_Shape& theOriginalS,
                                           const TopoDS_Shape& FirstShape, const TopoDS_Shape& LastShape);

    //! Auxiliary recursive method used to find the edge's index
    Standard_EXPORT Standard_Integer FindEdge(const TopoDS_Shape& S, const TopoDS_Edge& E,
