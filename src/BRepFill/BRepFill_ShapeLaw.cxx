...
BRepFill_ShapeLaw::BRepFill_ShapeLaw(const TopoDS_Vertex& V, const Standard_Boolean Build)
    : vertex(Standard_True), myShape(V) {
    TheLaw.Nullify();
...
BRepFill_ShapeLaw::BRepFill_ShapeLaw(const TopoDS_Wire& W, const Standard_Boolean Build)
    : vertex(Standard_False), myShape(W)
...
BRepFill_ShapeLaw::BRepFill_ShapeLaw(const TopoDS_Wire& W, const Handle(Law_Function) & L, const Standard_Boolean Build)
    : vertex(Standard_False), myShape(W)
...
// purpose  :
//=======================================================================
TopoDS_Vertex BRepFill_ShapeLaw::Vertex(const Standard_Integer Index, const Standard_Real Param) const {
    TopoDS_Edge E;
    TopoDS_Vertex V;
...
//=======================================================================
Standard_Real BRepFill_ShapeLaw::VertexTol(const Standard_Integer Index, const Standard_Real Param) const {
    ...
    if (myLaws->Length() == 1)
        ...
        if (!W.IsNull()) {
            ...
            for (ii = 2, Bof = Standard_True; ii <= myEdges->Length() && Bof; ii++) {
                ...
                if (!Bof) Bof = Concat.Add(TC, 200 * epsV, Standard_True, Standard_False, 20);
#ifdef OCCT_DEBUG
                if (!Bof) std::cout << "BRepFill_ShapeLaw::ConcatenedLaw INCOMPLET !!!" << std::endl;
#endif
            }
...
// purpose  :
//=======================================================================
GeomAbs_Shape BRepFill_ShapeLaw::Continuity(const Standard_Integer Index, const Standard_Real TolAngular) const {
