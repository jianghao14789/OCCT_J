...
public:
    ...
    Standard_EXPORT void PerformVertex(const Standard_Integer Index, const TopoDS_Vertex& InputVertex,
                                       const Standard_Real TolMin, TopoDS_Vertex& OutputVertex,
                                       const Standard_Integer Location = 0) const;

    //! Return the Curvilinear Bounds of the <Index> Law
    Standard_EXPORT void CurvilinearBounds(const Standard_Integer Index, Standard_Real& First,
    ...
    //! 0  : It is connex (G0)
    //! 1  : It is tangent (G1)
    Standard_EXPORT Standard_Integer IsG1(const Standard_Integer Index, const Standard_Real SpatialTolerance = 1.0e-7,
