...
public:
    ...
    //! Constructor
    Standard_EXPORT BRepFill_Filling(const Standard_Integer Degree = 3, const Standard_Integer NbPtsOnCur = 15,
                                     ...
                                     const Standard_Integer MaxDeg = 8, const Standard_Integer MaxSegments = 9);
    ...
    Standard_EXPORT Standard_Integer Add(const TopoDS_Edge& anEdge, const GeomAbs_Shape Order,
    ...
    //! of the edge and to respect tangency and curvature
    //! with the given face.
    Standard_EXPORT Standard_Integer Add(const TopoDS_Edge& anEdge, const TopoDS_Face& Support,
