...
public:
    ...
    Standard_EXPORT static void Axe(const TopoDS_Shape& Spine, const TopoDS_Wire& Profile, gp_Ax3& AxeProf,
    ...
    Standard_EXPORT static TopoDS_Wire InsertACR(const TopoDS_Wire& wire, const TColStd_Array1OfReal& ACRcuts,
