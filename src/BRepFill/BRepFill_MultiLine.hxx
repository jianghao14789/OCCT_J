...
public:
    ...
    Standard_EXPORT BRepFill_MultiLine(const TopoDS_Face& Face1, const TopoDS_Face& Face2, const TopoDS_Edge& Edge1,
    ...
    Standard_EXPORT void Curves(Handle(Geom_Curve) & Curve, Handle(Geom2d_Curve) & PCurve1,
    ...
    Standard_EXPORT virtual Standard_Boolean Value(const Standard_Real theU, NCollection_Array1<gp_Pnt2d>& thePnt2d,
                                                   NCollection_Array1<gp_Pnt>& thePnt) const;

    //! Returns the derivative at parameter <theU>.
    Standard_EXPORT virtual Standard_Boolean D1(const Standard_Real theU, NCollection_Array1<gp_Vec2d>& theVec2d,
