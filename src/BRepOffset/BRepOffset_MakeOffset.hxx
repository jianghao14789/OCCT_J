...
public:
    ...
    Standard_EXPORT BRepOffset_MakeOffset(const TopoDS_Shape& S, const Standard_Real Offset, const Standard_Real Tol,
    ...
    Standard_EXPORT void Initialize(const TopoDS_Shape& S, const Standard_Real Offset, const Standard_Real Tol,
                                    const BRepOffset_Mode Mode = BRepOffset_Skin,
                                    const Standard_Boolean Intersection = Standard_False,
                                    const Standard_Boolean SelfInter = Standard_False,
                                    const GeomAbs_JoinType Join = GeomAbs_Arc,
...
protected:
    ...
    Standard_EXPORT void analyzeProgress(const Standard_Real theWhole, TColStd_Array1OfReal& theSteps) const;
...
private:
    ...
    //! Intersects edges
    Standard_EXPORT void IntersectEdges(const TopTools_ListOfShape& theFaces, BRepOffset_DataMapOfShapeOffset& theMapSF,
    ...
    Standard_EXPORT void BuildSplitsOfExtendedFaces(const TopTools_ListOfShape& theLF,
                                                    ...
                                                    BRepAlgo_Image& theImage, const Message_ProgressRange& theRange);
