...
public:
    //! Constructor
    Standard_EXPORT BRepOffset_Inter3d(const Handle(BRepAlgo_AsDes) & AsDes, const TopAbs_State Side,
    ...
    Standard_EXPORT void ConnexIntByArc(const TopTools_ListOfShape& SetOfFaces, const TopoDS_Shape& ShapeInit,
    ...
    Standard_EXPORT void ConnexIntByInt(const TopoDS_Shape& SI, const BRepOffset_DataMapOfShapeOffset& MapSF,
                                        const BRepOffset_Analyse& A, TopTools_DataMapOfShapeShape& MES,
    ...
    Standard_EXPORT void ContextIntByInt(const TopTools_IndexedMapOfShape& ContextFaces,
                                         ...
                                         const BRepOffset_DataMapOfShapeOffset& MapSF, const BRepOffset_Analyse& A,
                                         TopTools_DataMapOfShapeShape& MES, TopTools_DataMapOfShapeShape& Build,
                                         TopTools_ListOfShape& Failed, const Message_ProgressRange& theRange,
                                         const Standard_Boolean bIsPlanar = Standard_False);
    ...
    Standard_EXPORT void ContextIntByArc(const TopTools_IndexedMapOfShape& ContextFaces,
                                         const Standard_Boolean ExtentContext, const BRepOffset_Analyse& Analyse,
                                         const BRepAlgo_Image& InitOffsetFace, BRepAlgo_Image& InitOffsetEdge,
                                         const Message_ProgressRange& theRange);
...
private:
    ...
    Standard_EXPORT void Store(const TopoDS_Face& F1, const TopoDS_Face& F2, const TopTools_ListOfShape& LInt1,
