...
static void AddToContainer(const TopoDS_Shape& theKey, const TopoDS_Shape& theValue,
...
static Standard_Boolean TakeModified(const TopoDS_Shape& theS, const TopTools_DataMapOfShapeListOfShape& theImages,
                                     ContainerType& theContainer, FenceMapType* theMFence) {
    ...
    if (pLSIm) {
        ...
        for (; itLSIm.More(); itLSIm.Next()) {
            ...
            if (!theMFence || AddToContainer(aSIm, *theMFence)) AddToContainer(aSIm, theContainer);
        }
        return Standard_True;
    } else {
        if (!theMFence || AddToContainer(theS, *theMFence)) AddToContainer(theS, theContainer);
...
//=======================================================================
template <class Container> static Standard_Boolean hasData(const Container* theData) {
...
//=======================================================================
static Standard_Boolean ProcessMicroEdge(const TopoDS_Edge& theEdge, const Handle(IntTools_Context) & theCtx) {
...
//=======================================================================
static void UpdateOrigins(const TopTools_ListOfShape& theLA, TopTools_DataMapOfShapeListOfShape& theOrigins,
...
//=======================================================================
static void UpdateImages(const TopTools_ListOfShape& theLA, TopTools_DataMapOfShapeListOfShape& theImages,
                         BOPAlgo_Builder& theGF, TopTools_MapOfShape& theModified) {
...
//=======================================================================
static void FindCommonParts(const TopTools_ListOfShape& theLS1, const TopTools_ListOfShape& theLS2,
                            TopTools_ListOfShape& theLSC, const TopAbs_ShapeEnum theType = TopAbs_EDGE) {
...
//=======================================================================
static Standard_Boolean FindShape(const TopoDS_Shape& theSWhat, const TopoDS_Shape& theSWhere,
                                  const BRepOffset_Analyse* theAnalyse, TopoDS_Shape& theRes) {
...
//=======================================================================
static void BuildSplitsOfTrimmedFace(const TopoDS_Face& theFace, const TopoDS_Shape& theEdges,
                                     TopTools_ListOfShape& theLFImages, const Message_ProgressRange& theRange) {
...
// purpose  : Building the splits of offset face
//=======================================================================
static void BuildSplitsOfFace(const TopoDS_Face& theFace, const TopoDS_Shape& theEdges,
                              TopTools_DataMapOfShapeShape& theFacesOrigins, TopTools_ListOfShape& theLFImages) {
    theLFImages.Clear();
    //
...
public: //! @name Constructor
    ...
    BRepOffset_BuildOffsetFaces(BRepAlgo_Image& theImage)
        : myFaces(NULL), myAnalyzer(NULL), myEdgesOrigins(NULL), myFacesOrigins(NULL), myETrimEInf(NULL),
          myImage(&theImage) {
...
public: //! @name Setting data
    ...
    void SetFaces(const TopTools_ListOfShape& theFaces) {
        myFaces = &theFaces;
    }

    //! Sets ascendants/descendants information
    void SetAsDesInfo(const Handle(BRepAlgo_AsDes) & theAsDes) {
        myAsDes = theAsDes;
    }

    //! Sets the analysis info of the input shape
    void SetAnalysis(const BRepOffset_Analyse& theAnalyse) {
        myAnalyzer = &theAnalyse;
    }
    ...
    void SetInfEdges(TopTools_DataMapOfShapeShape& theETrimEInf) {
...
private: //! @name Intersection and post-treatment of edges
    ...
    Standard_Boolean GetEdges(const TopoDS_Face& theFace, TopoDS_Shape& theEdges,
    ...
    void FindInvalidEdges(const TopoDS_Face& theF, const TopTools_ListOfShape& theLFImages,
                          ...
                          TopTools_MapOfShape& theEdgesInvalidByVertex, TopTools_MapOfShape& theEdgesValidByVertex,
    ...
    Standard_Boolean CheckInverted(const TopoDS_Edge& theEIm, const TopoDS_Face& theFOr,
    ...
    Standard_Boolean CheckInvertedBlock(const TopoDS_Shape& theCB, const TopTools_ListOfShape& theLCBF,
    ...
    void FilterInvalidEdges(const BRepOffset_DataMapOfShapeIndexedMapOfShape& theDMFMIE,
                            ...
                            const TopTools_IndexedMapOfShape& theMEInside, TopTools_MapOfShape& theMEUseInRebuild);
...
private: //! @name Checking faces
    ...
    void FindInvalidFaces(TopTools_ListOfShape& theLFImages, const BRepOffset_DataMapOfShapeMapOfShape& theDMFMVE,
                          const BRepOffset_DataMapOfShapeIndexedMapOfShape& theDMFMIE,
                          const TopTools_MapOfShape& theMENeutral, const TopTools_MapOfShape& theEdgesInvalidByVertex,
                          const TopTools_MapOfShape& theEdgesValidByVertex, const TopTools_MapOfShape& theMFHoles,
                          TopTools_IndexedMapOfShape& theMFInvInHole, TopTools_ListOfShape& theInvFaces,
                          TopTools_ListOfShape& theInvertedFaces);

    //! Find faces inside holes wires from the original face
    void FindFacesInsideHoleWires(const TopoDS_Face& theFOrigin, const TopoDS_Face& theFOffset,
    ...
    void RemoveInsideFaces(const TopTools_ListOfShape& theInvertedFaces,
                           ...
                           const TopTools_IndexedMapOfShape& theMFInvInHole, const TopoDS_Shape& theFHoles,
                           TopTools_IndexedMapOfShape& theMERemoved, TopTools_IndexedMapOfShape& theMEInside,
                           const Message_ProgressRange& theRange);
    ...
    void RemoveHangingParts(const BOPAlgo_MakerVolume& theMV, const TopTools_DataMapOfShapeShape& theDMFImF,
                            const TopTools_IndexedMapOfShape& theMFInv, TopTools_MapOfShape& theMFToRem);

    //! Removing valid splits according to results of intersection
    void RemoveValidSplits(const TopTools_MapOfShape& theSpRem, BOPAlgo_Builder& theGF,
                           TopTools_IndexedMapOfShape& theMERemoved);

    //! Removing invalid splits according to the results of intersection
    void RemoveInvalidSplits(const TopTools_MapOfShape& theSpRem, BOPAlgo_Builder& theGF,
                             TopTools_IndexedMapOfShape& theMERemoved);
    ...
    Standard_Boolean CheckIfArtificial(const TopoDS_Shape& theF, const TopTools_ListOfShape& theLFImages,
                                       const TopoDS_Shape& theCE, const TopTools_IndexedMapOfShape& theMapEInv,
    ...
    void FindVerticesToAvoid(const TopTools_IndexedDataMapOfShapeListOfShape& theDMEFInv,
                             const TopTools_DataMapOfShapeListOfShape& theDMVEFull, TopTools_MapOfShape& theMVRInv);

    //! Looking for the faces around each invalidity for intersection
    void FindFacesForIntersection(const TopoDS_Shape& theFInv, const TopTools_IndexedMapOfShape& theME,
                                  const TopTools_DataMapOfShapeListOfShape& theDMSF,
                                  const TopTools_MapOfShape& theMVInvAll, const Standard_Boolean theArtCase,
                                  TopTools_IndexedMapOfShape& theMFAvoid, TopTools_IndexedMapOfShape& theMFInt,
                                  TopTools_IndexedMapOfShape& theMFIntExt, TopTools_ListOfShape& theLFImInt);

    //! Analyzing the common edges between splits of offset faces
    void ProcessCommonEdges(const TopTools_ListOfShape& theLEC, const TopTools_IndexedMapOfShape& theME,
                            const TopTools_DataMapOfShapeListOfShape& theMEInfETrim,
                            const TopTools_MapOfShape& theAllInvs, const Standard_Boolean theForceUse,
                            TopTools_IndexedMapOfShape& theMECV, TopTools_MapOfShape& theMECheckExt,
                            TopTools_DataMapOfShapeListOfShape& theDMEETrim, TopTools_ListOfShape& theLFEi,
                            TopTools_ListOfShape& theLFEj, TopTools_IndexedMapOfShape& theMEToInt);

    //! Updating the already interfered faces
    void UpdateIntersectedFaces(const TopoDS_Shape& theFInv, const TopoDS_Shape& theFi, const TopoDS_Shape& theFj,
                                const TopTools_ListOfShape& theLFInv, const TopTools_ListOfShape& theLFImi,
                                const TopTools_ListOfShape& theLFImj, const TopTools_ListOfShape& theLFEi,
                                const TopTools_ListOfShape& theLFEj, TopTools_IndexedMapOfShape& theMEToInt);

    //! Intersection of the pair of faces
    void IntersectFaces(const TopoDS_Shape& theFInv, const TopoDS_Shape& theFi, const TopoDS_Shape& theFj,
                        const TopTools_ListOfShape& theLFInv, const TopTools_ListOfShape& theLFImi,
                        const TopTools_ListOfShape& theLFImj, TopTools_ListOfShape& theLFEi,
                        TopTools_ListOfShape& theLFEj, TopTools_IndexedMapOfShape& theMECV,
                        TopTools_IndexedMapOfShape& theMEToInt);

    //! Intersection of the new intersection edges among themselves
    void IntersectAndTrimEdges(const TopTools_IndexedMapOfShape& theMFInt, const TopTools_IndexedMapOfShape& theMEInt,
                               const TopTools_DataMapOfShapeListOfShape& theDMEETrim,
                               const TopTools_IndexedMapOfShape& theMSInv, const TopTools_IndexedMapOfShape& theMVE,
                               const TopTools_MapOfShape& theVertsToAvoid,
                               const TopTools_MapOfShape& theNewVertsToAvoid, const TopTools_MapOfShape& theMECheckExt,
                               const TopTools_DataMapOfShapeListOfShape* theSSInterfs, TopTools_MapOfShape& theMVBounds,
                               TopTools_DataMapOfShapeListOfShape& theEImages);

    //! Looking for the invalid edges by intersecting with invalid vertices
    void GetInvalidEdges(const TopTools_MapOfShape& theVertsToAvoid, const TopTools_MapOfShape& theMVBounds,
                         BOPAlgo_Builder& theGF, TopTools_MapOfShape& theMEInv);
    ...
    void UpdateValidEdges(const TopTools_IndexedDataMapOfShapeListOfShape& theFLE,
                          ...
                          const TopTools_MapOfShape& theMVBounds, const TopTools_MapOfShape& theMEInvOnArt,
                          TopTools_MapOfShape& theMECheckExt, TopTools_MapOfShape& theVertsToAvoid,
                          TopTools_DataMapOfShapeListOfShape& theEImages, TopTools_DataMapOfShapeListOfShape& theEETrim,
                          const Message_ProgressRange& theRange);
    ...
    void TrimNewIntersectionEdges(const TopTools_ListOfShape& theLE,
                                  ...
                                  const TopTools_MapOfShape& theMVBounds, TopTools_MapOfShape& theMECheckExt,
                                  TopTools_DataMapOfShapeListOfShape& theEImages, TopTools_MapOfShape& theMEB,
                                  TopTools_MapOfShape& theMVOld, TopTools_MapOfShape& theMENew,
    ...
    void IntersectEdges(const TopTools_ListOfShape& theLA, const TopTools_ListOfShape& theLE,
                        const TopTools_MapOfShape& theMVBounds, const TopTools_MapOfShape& theVertsToAvoid,
                        TopTools_MapOfShape& theMENew, TopTools_MapOfShape& theMECheckExt,
                        TopTools_DataMapOfShapeListOfShape& theEImages, TopTools_DataMapOfShapeListOfShape& theDMEOr,
                        TopTools_DataMapOfShapeListOfShape& theMELF, TopoDS_Shape& theSplits);

    //! Getting edges from the splits of offset faces
    void GetBounds(const TopTools_ListOfShape& theLFaces, const TopTools_MapOfShape& theMEB, TopoDS_Shape& theBounds);

    //! Get bounding edges that should be updated
    void GetBoundsToUpdate(const TopTools_ListOfShape& theLF, const TopTools_MapOfShape& theMEB,
                           TopTools_ListOfShape& theLABounds, TopTools_ListOfShape& theLAValid,
                           TopoDS_Shape& theBounds);

    //! Filter new splits by intersection with bounds
    void GetInvalidEdgesByBounds(const TopoDS_Shape& theSplits, const TopoDS_Shape& theBounds,
                                 const TopTools_MapOfShape& theMVOld, const TopTools_MapOfShape& theMENew,
                                 ...
                                 const TopTools_MapOfShape& theMECheckExt, const TopTools_MapOfShape& theMEInvOnArt,
                                 TopTools_MapOfShape& theVertsToAvoid, TopTools_MapOfShape& theMEInv);

    //! Filter the images of edges from the invalid edges
    void FilterSplits(const TopTools_ListOfShape& theLE, const TopTools_MapOfShape& theMEFilter,
                      const Standard_Boolean theIsInv, TopTools_DataMapOfShapeListOfShape& theEImages,
...
private:
    ...
    TopTools_DataMapOfShapeListOfShape*
        myEdgesOrigins; //!< Origins of the offset edges (binding between offset edge and original edge)
    TopTools_DataMapOfShapeShape*
        myFacesOrigins; //!< Origins of the offset faces (binding between offset face and original face)
    ...
    TopTools_IndexedMapOfShape
        myInvalidEdges; //!< Edges considered invalid (orientation is changed) in some split of face
    ...
    TopTools_IndexedMapOfShape
        myInsideEdges; //!< Edges located fully inside solids built from the splits of offset faces

    TopTools_IndexedDataMapOfShapeListOfShape
        myInvalidFaces; //!< Invalid faces - splits of offset faces consisting of invalid edges
    BRepOffset_DataMapOfShapeIndexedMapOfShape
        myArtInvalidFaces; //!< Artificially invalid faces - valid faces intentionally marked invalid
    ...
    TopTools_DataMapOfShapeInteger
        myAlreadyInvFaces; //!< Count number of the same face being marked invalid to avoid infinite
                           //!  rebuilding of the same face
    TopTools_DataMapOfShapeListOfShape myFNewHoles; //!< Images of the hole faces of the original face

    TopTools_DataMapOfShapeListOfShape
        mySSInterfs; //!< Intersection information, used to collect intersection pairs during rebuild
    TopTools_DataMapOfShapeListOfShape
        mySSInterfsArt; //!< Intersection information, used to collect intersection pairs during rebuild
    NCollection_DataMap<TopoDS_Shape, BRepOffset_DataMapOfShapeMapOfShape,
                        TopTools_ShapeMapHasher>
        myIntersectionPairs; //!< All possible intersection pairs, used to avoid some of the intersections

    TopTools_IndexedDataMapOfShapeListOfShape
        myFacesToRebuild; //!< Faces that have to be rebuilt (invalid and close to invalid faces)
    TopTools_MapOfShape
        myFSelfRebAvoid; //!< Faces that have to be avoided when rebuilding splits of the same offset face
...
//=======================================================================
void BRepOffset_BuildOffsetFaces::UpdateIntersectedEdges(const TopTools_ListOfShape& theLA, BOPAlgo_Builder& theGF) {
    for (TopTools_ListOfShape::Iterator aItA(theLA); aItA.More(); aItA.Next()) {
        const TopoDS_Shape& aS = aItA.Value();
...
void BRepOffset_BuildOffsetFaces::BuildSplitsOfFaces(const Message_ProgressRange& theRange) {
    ...
    for (; aItLF.More(); aItLF.Next(), aPSBF.Next()) {
        ...
        // find invalid edges
        FindInvalidEdges(aF, aLFImages, aDMFMVE, aDMFMNE, aDMFMIE, aDMFMVIE, aDMEOrLEIm, aMEdgeInvalidByVertex,
                         aMEdgeValidByVertex, aPSBF.Next());
    ...
    for (; aItLF.More(); aItLF.Next(), aPSIF.Next()) {
        ...
        if (bArtificialCase) {
            ...
            //
            // find invalid faces
            FindInvalidFaces(aLFImages, aDMFMVE, aDMFMIE, *pMNE, aMEdgeInvalidByVertex, aMEdgeValidByVertex, aMFHoles,
                             aMFInvInHole, aLFInv, anInvertedFaces);
        }
        //
        if (aLFInv.Extent()) {
    ...
    //
    // remove inside faces
    RemoveInsideFaces(anInvertedFaces, aMFToCheckInt, aMFInvInHole, aFHoles, aMERemoved, myInsideEdges,
                      aPSOuter.Next(5.));
    //
    ...
    FilterInvalidEdges(aDMFMIE, aMERemoved, aMERemoved.Extent() ? myInsideEdges : aMERemoved, aMEUseInRebuild);
    //
...
//=======================================================================
Standard_Boolean BRepOffset_BuildOffsetFaces::GetEdges(const TopoDS_Face& theFace, TopoDS_Shape& theEdges,
...
void BRepOffset_BuildOffsetFaces::FindInvalidEdges(
    const TopoDS_Face& theF, const TopTools_ListOfShape& theLFImages, BRepOffset_DataMapOfShapeMapOfShape& theDMFMVE,
    BRepOffset_DataMapOfShapeMapOfShape& theDMFMNE, BRepOffset_DataMapOfShapeIndexedMapOfShape& theDMFMIE,
    BRepOffset_DataMapOfShapeMapOfShape& theDMFMVIE, TopTools_DataMapOfShapeListOfShape& theDMEOrLEIm,
    TopTools_MapOfShape& theEdgesInvalidByVertex, TopTools_MapOfShape& theEdgesValidByVertex,
    const Message_ProgressRange& theRange) {
    ...
    for (; aItLF.More(); aItLF.Next(), aPS.Next()) {
        ...
        for (; aExp.More(); aExp.Next()) {
            ...
            for (TopTools_ListOfShape::Iterator itOr(*pLOr); itOr.More(); itOr.Next()) {
                ...
                TopoDS_Shape aSInF;
                if (!FindShape(aSOr, aFOr, myAnalyzer, aSInF)) continue;
                TopTools_ListOfShape* pImages = anImages.ChangeSeek(aSInF);
                if (!pImages) pImages = anImages.Bound(aSInF, TopTools_ListOfShape());
    ...
    for (; aItLF.More(); aItLF.Next(), aPS.Next()) {
        ...
        for (; aExp.More(); aExp.Next()) {
            ...
            if (aNbVOr > 1 && (pLEOr->Extent() - aNbVOr) > 1) continue;
            //
            ...
            Standard_Boolean bUseVertex =
                !aNbVOr ? Standard_False
                        : (aNbVOr == 1 && aDMEF.FindFromKey(aEIm).Extent() == 1 && !myOEOrigins.IsBound(aEIm));
            //
                ...
                if (bVertex) {
                    ...
                    if (pLEFOr) {
                        ...
                        for (; aItLEFOr.More(); aItLEFOr.Next()) {
                            ...
                            if (!aVRef.IsParallel(aVCur, Precision::Angular())) bAllTgt = Standard_False;
                        }
                        if (!bAllTgt) aEOrF = aCEOr;
                    }
                } else {
                    ...
                    if (theLFImages.Extent() > 2) {
                        ...
                        for (; itV.More(); itV.Next()) {
                            ...
                            for (; itE.More(); itE.Next())
                                if (aDMEF.FindFromKey(itE.Value()).Extent() < 2) break;
                            if (itE.More()) break;
                        }
                        bSkip = itV.More();
                    }
            ...
            //
            if (bInvalid) {
                if (!bLocalOnly) myInvalidEdges.Add(aEIm);
                aMIE.Add(aEIm);
                aMEInv.Add(aEIm);
                continue;
            }
            ...
            //
            if (!bInverted || !aNbVOr) {
                if (!bLocalOnly) myValidEdges.Add(aEIm);
                aMVE.Add(aEIm);
                aMEVal.Add(aEIm);
            }
        }
...
//=======================================================================
static void addAsNeutral(const TopoDS_Shape& theE, const TopoDS_Shape& theFInv, const TopoDS_Shape& theFVal,
                         BRepOffset_DataMapOfShapeIndexedMapOfShape& theLocInvEdges,
                         BRepOffset_DataMapOfShapeMapOfShape& theLocValidEdges) {
    TopTools_IndexedMapOfShape* pMEInv = theLocInvEdges.ChangeSeek(theFInv);
    if (!pMEInv) pMEInv = theLocInvEdges.Bound(theFInv, TopTools_IndexedMapOfShape());
    pMEInv->Add(theE);

    TopTools_MapOfShape* pMEVal = theLocValidEdges.ChangeSeek(theFVal);
    if (!pMEVal) pMEVal = theLocValidEdges.Bound(theFVal, TopTools_MapOfShape());
    pMEVal->Add(theE);
}
...
void BRepOffset_BuildOffsetFaces::FindInvalidEdges(const TopTools_ListOfShape& theLFOffset,
    ...
    if (myAnalyzer) {
        ...
        for (TopTools_ListOfShape::Iterator it(theLFOffset); it.More(); it.Next()) {
            ...
            if (aMapNewTmp.Contains(aFOrigin)) aNewFaces.Add(aFOffset);
        }
    }
    ...
    for (TopTools_ListOfShape::Iterator itLFO(theLFOffset); itLFO.More(); itLFO.Next()) {
        ...
        if (aNewFaces.Contains(aF)) continue;
            ...
            for (TopExp_Explorer expE(aFIm, TopAbs_EDGE); expE.More(); expE.Next()) {
                ...
                if (myInvalidEdges.Contains(aE) != myValidEdges.Contains(aE)) {
                    ...
                    if ((!pMEInvalid || !pMEInvalid->Contains(aE)) && (!pMEValid || !pMEValid->Contains(aE))) {
                        ...
                        if (!pMap) pMap = &aMEUnclassified(aMEUnclassified.Add(aE, TopTools_MapOfShape()));
                        pMap->Add(aFIm);
    ...
    if (aMEUnclassified.IsEmpty()) return;
    ...
    for (Standard_Integer iE = 1; iE <= aNbE; ++iE) {
        ...
        for (TopTools_ListOfShape::Iterator itLF(aLF); itLF.More(); itLF.Next()) {
            ...
            if (aMFUnclassified.Contains(aFClassified)) continue;
            ...
            gp_Dir aDNClass;
            BOPTools_AlgoTools3D::GetNormalToFaceOnEdge(TopoDS::Edge(aEClassified), TopoDS::Face(aFClassified),
                                                        aDNClass);
            ...
            for (TopTools_MapOfShape::Iterator itM(aMFUnclassified); itM.More(); itM.Next()) {
                ...
                if (anEdgeSetClass.IsEqual(anEdgeSetUnclass)) {
                    gp_Dir aDNUnclass;
                    BOPTools_AlgoTools3D::GetNormalToFaceOnEdge(TopoDS::Edge(aE), TopoDS::Face(aFUnclassified),
                                                                aDNUnclass);
                    ...
                    for (; itLFSp.More(); itLFSp.Next()) {
                        ...
                        if (!aFSp.IsSame(aFUnclassified) && aMFUnclassified.Contains(aFSp)) {
                            ...
                            if (!isSameOri) anOriUnclass = TopAbs::Reverse(anOriUnclass);
                            ...
                            if (anOriClass != anOriUnclass) {
                                ...
                                if (!pMENeutral) pMENeutral = theNeutralEdges.Bound(aFOffset, TopTools_MapOfShape());
                                pMENeutral->Add(aE);
...
void BRepOffset_BuildOffsetFaces::MakeInvertedEdgesInvalid(const TopTools_ListOfShape& theLFOffset) {
    if (myInvalidEdges.IsEmpty() || myInvertedEdges.IsEmpty()) return;
...
void BRepOffset_BuildOffsetFaces::FindInvalidFaces(
    TopTools_ListOfShape& theLFImages, const BRepOffset_DataMapOfShapeMapOfShape& theDMFMVE,
    const BRepOffset_DataMapOfShapeIndexedMapOfShape& theDMFMIE, const TopTools_MapOfShape& theMENeutral,
    const TopTools_MapOfShape& theEdgesInvalidByVertex, const TopTools_MapOfShape& theEdgesValidByVertex,
    const TopTools_MapOfShape& theMFHoles, TopTools_IndexedMapOfShape& theMFInvInHole,
    TopTools_ListOfShape& theInvFaces, TopTools_ListOfShape& theInvertedFaces) {
    ...
    for (; aItLF.More();) {
        ...
        //
        if (bHasReallyInvalid || (bAllInvalid && !(bHasValid || bAllValid) && !(bAllInvNeutral && (aNbChecked == 1)))) {
...
//=======================================================================
void BRepOffset_BuildOffsetFaces::FindFacesInsideHoleWires(const TopoDS_Face& theFOrigin, const TopoDS_Face& theFOffset,
                                                           const TopTools_ListOfShape& theLFImages,
                                                           const TopTools_DataMapOfShapeListOfShape& theDMEOrLEIm,
                                                           const TopTools_IndexedDataMapOfShapeListOfShape& theEFMap,
                                                           TopTools_MapOfShape& theMFHoles) {
...
//=======================================================================
Standard_Boolean BRepOffset_BuildOffsetFaces::CheckInverted(const TopoDS_Edge& theEIm, const TopoDS_Face& theFOr,
                                                            const TopTools_IndexedDataMapOfShapeListOfShape& theDMVE,
                                                            const TopTools_IndexedMapOfShape& theMEdges) {
...
//=======================================================================
static void GetVerticesOnEdges(const TopoDS_Shape& theCB, const TopTools_IndexedMapOfShape& theEdges,
                               TopTools_MapOfShape& theVerticesOnEdges, TopTools_MapOfShape& theAllVertices) {
...
void BRepOffset_BuildOffsetFaces::RemoveInvalidSplitsFromValid(const BRepOffset_DataMapOfShapeMapOfShape& theDMFMVIE) {
    ...
    for (; aItLF.More(); aItLF.Next()) {
        ...
        for (; aExp.More(); aExp.Next()) {
            ...
            if (!pList) pList = aDMFF.Bound(aF, TopTools_ListOfShape());
            pList->Append(aFCB);
        }
        ...
        for (TopTools_DataMapOfShapeListOfShape::Iterator itM(aDMFF); itM.More(); itM.Next()) {
            ...
            for (; itL.More(); itL.Next()) {
                ...
                for (; aExpE.More(); aExpE.Next()) {
                    ...
                    if (pValidInverted && pValidInverted->Contains(aECB)) break;
                    if (aDMEF.FindFromKey(aECB).Extent() > 1) {
                        if (!myInvertedEdges.Contains(aECB)) break;
                    }
                }
                if (!aExpE.More())
...
//=======================================================================
static void buildPairs(const TopTools_IndexedMapOfShape& theSMap, BRepOffset_DataMapOfShapeMapOfShape& theIntPairs) {
    const Standard_Integer aNbS = theSMap.Extent();
    if (aNbS < 2) return;
    for (Standard_Integer it1 = 1; it1 <= aNbS; ++it1) {
        const TopoDS_Shape& aS = theSMap(it1);
        if (!theIntPairs.IsBound(aS)) theIntPairs.Bind(aS, TopTools_MapOfShape());
    }
...
static void buildIntersectionPairs(
    ...
    const TopTools_IndexedDataMapOfShapeListOfShape& myInvalidFaces, const BOPAlgo_Builder& theBuilder,
    const TopTools_MapOfShape& theMFRemoved, const TopTools_DataMapOfShapeShape& theFOrigins,
    NCollection_DataMap<TopoDS_Shape, BRepOffset_DataMapOfShapeMapOfShape, TopTools_ShapeMapHasher>& theIntPairs) {
    ...
    for (Standard_Integer iF = 1; iF <= myInvalidFaces.Extent(); ++iF) {
        ...
        for (TopTools_ListOfShape::Iterator itCB(aLCB); itCB.More(); itCB.Next()) {
            ...
            for (Standard_Integer iE = 1; iE <= aDMEF.Extent(); ++iE) {
                ...
                if (aLFConnected.Extent() < 2) continue;
...
void BRepOffset_BuildOffsetFaces::RemoveInsideFaces(const TopTools_ListOfShape& theInvertedFaces,
        ...
        for (i = 1; i <= aNb; ++i) {
            ...
            for (; aItLF.More(); aItLF.Next()) {
                ...
                for (; aExpE.More(); aExpE.Next()) {
                    ...
                    if (!bFaceKept && bInvalid && !bConnected) bConnected = aMESols.Contains(aExpE.Current());
                }
            }
            //
    ...
    for (; aExpS.More(); aExpS.Next()) {
        ...
        for (TopExp_Explorer aExpF(aSol, TopAbs_FACE); aExpF.More(); aExpF.Next()) {
            ...
            if (aMFToRem.Contains(aFS)) continue;
...
void BRepOffset_BuildOffsetFaces::ShapesConnections(const TopTools_DataMapOfShapeShape& theDMFOr,
    ...
    for (iInt = 0; iInt < aNbFF; ++iInt) {
        ...
        for (Standard_Integer iF = 0; iF < 2; ++iF) {
            ...
            if (!myArtInvalidFaces.IsBound(aFArt)) continue;

            if (myInvalidFaces.Contains(aFOpposite) && !myArtInvalidFaces.IsBound(aFOpposite)) continue;
            ...
            for (TopExp_Explorer expE(aFArtIm, TopAbs_EDGE); expE.More(); expE.Next()) {
                ...
                for (Standard_Integer iEF = 0; iEF < aEFs.Size(); ++iEF) {
                    ...
                    if (aEF.Contains(nE) && aEF.Contains(nFOp)) {
                        if (aEF.CommonPart().Type() == TopAbs_VERTEX) aLV.Append(pDS->Shape(aEF.IndexNew()));
                    }
                }
...
void BRepOffset_BuildOffsetFaces::RemoveHangingParts(const BOPAlgo_MakerVolume& theMV,
    ...
    for (; aItLCBH.More(); aItLCBH.Next()) {
        ...
        for (; anExpF.More(); anExpF.Next()) {
            ...
            if (!bHasInvalidFace) bHasInvalidFace = theMFInv.Contains(aF);
            ...
            if (pLFOr) {
                ...
                for (; aItLFOr.More(); aItLFOr.Next()) {
                    ...
                    if (pFOffset) aMOffsetF.Add(*pFOffset);
                }
            } else {
        ...
        if (bRemove) aBlocksToRemove.Append(aCBH);
    }
...
//=======================================================================
void BRepOffset_BuildOffsetFaces::RemoveValidSplits(const TopTools_MapOfShape& theSpRem, BOPAlgo_Builder& theGF,
                                                    TopTools_IndexedMapOfShape& theMERemoved) {
    Standard_Integer i, aNb = myOFImages.Extent();
    if (!aNb) {
        return;
...
//=======================================================================
void BRepOffset_BuildOffsetFaces::RemoveInvalidSplits(const TopTools_MapOfShape& theSpRem, BOPAlgo_Builder& theGF,
                                                      TopTools_IndexedMapOfShape& theMERemoved) {
    Standard_Integer i, aNb = myInvalidFaces.Extent();
    if (!aNb) {
        return;
                ...
                for (; aExp.More(); aExp.Next()) {
                    ...
                    if (myInvalidEdges.Contains(aE) && !theMERemoved.Contains(aE)) {
                        ...
                        for (; itLF.More(); itLF.Next()) {
                            if (!aLocalSplits.Contains(itLF.Value())) break;
                        }
                        if (itLF.More()) break;
                    }
                }
...
void BRepOffset_BuildOffsetFaces::CheckEdgesCreatedByVertex() {
    ...
    for (Standard_Integer i = 1; i <= aNbF; ++i) {
        const TopoDS_Shape& aF = myInvalidFaces.FindKey(i);
        if (myArtInvalidFaces.IsBound(aF)) continue;
        ...
        for (TopTools_ListOfShape::Iterator it(aLFIm); it.More(); it.Next()) {
            ...
            for (TopExp_Explorer expE(aFIm, TopAbs_EDGE); expE.More(); expE.Next()) {
                ...
                for (; itLEO.More(); itLEO.Next()) {
                    if (itLEO.Value().ShapeType() != TopAbs_VERTEX) break;
                }
                if (!itLEO.More()) {
                    myInvalidEdges.Add(aE);
                }
    ...
    for (k = 1; k <= aNbInv; ++k) {
        ...
        for (; aItLCB.More(); aItLCB.Next()) {
            ...
            for (; aItLCBE.More(); aItLCBE.Next()) {
                ...
                //
                FindFacesForIntersection(aFInv, aME, aDMSF, aMVInvAll, bArtificial, aMFAvoid, aMFInt, aMFIntExt,
                                         aLFInt);
                if (aMFInt.Extent() < 3) {
                    // nothing to intersect
                    aPSCBE.Next();
                ...
                for (i = 1; i <= aNb; ++i, aPSIntPair.Next()) {
                    ...
                    for (j = i + 1; j <= aNb; ++j) {
                        ...
                        //
                        if (pInterFi && !pInterFi->Contains(aFj)) continue;
                        ...
                        if (aLEC.Extent()) {
                            ...
                            ProcessCommonEdges(aLEC, aME, aMEInfETrim, aMAllInvs, bForceUse, aMECV, aMECheckExt,
                                               aDMEETrim, *aLFEi, *aLFEj, aMEToInt);
                ...
                IntersectAndTrimEdges(aMFInt, aMEToInt, aDMEETrim, aME, aMECV, aMVInv, aMVRInv, aMECheckExt,
                                      bArtificial ? &mySSInterfsArt : 0, aMVBounds, aEImages);
                //
                ...
                for (iE = 1; iE <= aNbEToInt; ++iE) {
                    ...
                    for (; anExpE.More(); anExpE.Next()) {
                        ...
                        if (!pLEToInt) pLEToInt = &aDMOENEdges(aDMOENEdges.Add(aE, TopTools_ListOfShape()));
...
void BRepOffset_BuildOffsetFaces::FindVerticesToAvoid(const TopTools_IndexedDataMapOfShapeListOfShape& theDMEFInv,
    ...
    for (i = 1; i <= aNb; ++i) {
        ...
        for (j = 1; j <= aNbV; ++j) {
            if (aMVEEdges(j).Extent() != 1) continue;

            const TopoDS_Shape& aV = aMVEEdges.FindKey(j);
            if (!aMFence.Add(aV)) continue;
            ...
            for (; aItLE.More(); aItLE.Next()) {
                ...
                if (myInvertedEdges.Contains(aEV)) ++iNbEInverted;

                if (bAllEdgesInv) bAllEdgesInv = myInvalidEdges.Contains(aEV);
            }
...
void BRepOffset_BuildOffsetFaces::FindFacesForIntersection(
    const TopoDS_Shape& theFInv, const TopTools_IndexedMapOfShape& theME,
    const TopTools_DataMapOfShapeListOfShape& theDMSF, const TopTools_MapOfShape& theMVInvAll,
    const Standard_Boolean theArtCase, TopTools_IndexedMapOfShape& theMFAvoid, TopTools_IndexedMapOfShape& theMFInt,
    TopTools_IndexedMapOfShape& theMFIntExt, TopTools_ListOfShape& theLFImInt) {
    ...
    for (i = 1; i <= aNbE; ++i) {
        ...
        Standard_Boolean bAvoid =
            theArtCase ? ((aS.ShapeType() == TopAbs_VERTEX) && !theMVInvAll.Contains(aS)) : Standard_False;
        //
...
void BRepOffset_BuildOffsetFaces::ProcessCommonEdges(
    const TopTools_ListOfShape& theLEC, const TopTools_IndexedMapOfShape& theME,
    const TopTools_DataMapOfShapeListOfShape& theMEInfETrim, const TopTools_MapOfShape& theAllInvs,
    const Standard_Boolean theForceUse, TopTools_IndexedMapOfShape& theMECV, TopTools_MapOfShape& theMECheckExt,
    TopTools_DataMapOfShapeListOfShape& theDMEETrim, TopTools_ListOfShape& theLFEi, TopTools_ListOfShape& theLFEj,
    TopTools_IndexedMapOfShape& theMEToInt) {
    TopTools_ListOfShape aLEC;
...
//=======================================================================
static void FindOrigins(const TopTools_ListOfShape& theLFIm1, const TopTools_ListOfShape& theLFIm2,
                        const TopTools_IndexedMapOfShape& theME, const TopTools_DataMapOfShapeListOfShape& theOrigins,
...
void BRepOffset_BuildOffsetFaces::UpdateIntersectedFaces(
    const TopoDS_Shape& theFInv, const TopoDS_Shape& theFi, const TopoDS_Shape& theFj,
    const TopTools_ListOfShape& theLFInv, const TopTools_ListOfShape& theLFImi, const TopTools_ListOfShape& theLFImj,
    const TopTools_ListOfShape& theLFEi, const TopTools_ListOfShape& theLFEj, TopTools_IndexedMapOfShape& theMEToInt) {
...
//=======================================================================
void BRepOffset_BuildOffsetFaces::IntersectFaces(const TopoDS_Shape& theFInv, const TopoDS_Shape& theFi,
                                                 const TopoDS_Shape& theFj, const TopTools_ListOfShape& theLFInv,
    ...
    BRepOffset_Tool::Inter3D(TopoDS::Face(theFi), TopoDS::Face(theFj), aLInt1, aLInt2, aSide, aNullEdge, aNullFace,
                             aNullFace);
    //
    if (aLInt1.IsEmpty()) {
        return;
...
void BRepOffset_BuildOffsetFaces::IntersectAndTrimEdges(
    const TopTools_IndexedMapOfShape& theMFInt, const TopTools_IndexedMapOfShape& theMEInt,
    const TopTools_DataMapOfShapeListOfShape& theDMEETrim, const TopTools_IndexedMapOfShape& theMSInv,
    const TopTools_IndexedMapOfShape& theMVE, const TopTools_MapOfShape& theVertsToAvoid,
    const TopTools_MapOfShape& theNewVertsToAvoid, const TopTools_MapOfShape& theMECheckExt,
    const TopTools_DataMapOfShapeListOfShape* theSSInterfs, TopTools_MapOfShape& theMVBounds,
    TopTools_DataMapOfShapeListOfShape& theEImages) {
...
void BRepOffset_BuildOffsetFaces::GetInvalidEdges(const TopTools_MapOfShape& theVertsToAvoid,
                                                  const TopTools_MapOfShape& theMVBounds, BOPAlgo_Builder& theGF,
...
void BRepOffset_BuildOffsetFaces::UpdateValidEdges(
    ...
    const TopTools_IndexedDataMapOfShapeListOfShape& theOENEdges, const TopTools_MapOfShape& theMVBounds,
    const TopTools_MapOfShape& theMEInvOnArt, TopTools_MapOfShape& theMECheckExt, TopTools_MapOfShape& theVertsToAvoid,
    TopTools_DataMapOfShapeListOfShape& theEImages, TopTools_DataMapOfShapeListOfShape& theEETrim,
    const Message_ProgressRange& theRange) {
    ...
    TrimNewIntersectionEdges(aLE, theEETrim, theMVBounds, theMECheckExt, theEImages, aMEB, aMVOld, aMENew, aDMEOr,
                             aMELF);
    //
    ...
    for (; aItLB.More(); aItLB.Next(), aPSB.Next()) {
        ...
        TopTools_ListOfShape aBlockLENew;
        {
            ...
            for (; anExpE.More(); anExpE.Next()) {
                ...
                for (; aItLEInt.More(); aItLEInt.Next()) {
                    if (aMEFence.Add(aItLEInt.Value())) aBlockLENew.Append(aItLEInt.Value());
                }
            }
        }

        if (aBlockLENew.IsEmpty()) continue;
        ...
        for (; aItLE.More(); aItLE.Next()) {
            const TopoDS_Shape& aE = aItLE.Value();
            TopTools_ListOfShape* pLEIm = theEImages.ChangeSeek(aE);
            if (!pLEIm || pLEIm->IsEmpty()) continue;
        ...
        if (aLSplits.IsEmpty()) continue;

        TopoDS_Shape aCE;
        if (aLSplits.Extent() > 1)
            // Intersect the new splits among themselves to avoid self-intersections
            IntersectEdges(aLSplits, aBlockLENew, theMVBounds, theVertsToAvoid, aMENew, theMECheckExt, theEImages,
                           aDMEOr, aMELF, aCE);
        else
            aCE = aLSplits.First();
    ...
    for (i = 1; i <= aNbB; ++i, aPSBSp.Next()) {
        ...
        GetInvalidEdgesByBounds(aCE, aFilterBounds, aMVOld, aMENew, aDMEOr, aMELF, theEImages, theMECheckExt,
                                theMEInvOnArt, theVertsToAvoid, aMEInvLoc);
        ...
        if (bKept) aLValBlocks.Append(aCEVal);
    }
    ...
    for (i = 1; i <= aNbB; ++i) {
        ...
        for (TopExp_Explorer anExp(aCE, TopAbs_EDGE); anExp.More(); anExp.Next()) {
            ...
            if (aMENew.Contains(aEIm) && !aMEVal.Contains(aEIm)) aLValBlocks.Append(aEIm);
        }
    }

    if (aLValBlocks.Extent() > 1)
        // intersect the new splits among themselves to avoid self-intersections
        IntersectEdges(aLValBlocks, aLE, theMVBounds, theVertsToAvoid, aMENew, theMECheckExt, theEImages, aDMEOr, aMELF,
                       aSplits1);
    else
    ...
    TopTools_MapOfShape aMEInv;
    GetInvalidEdgesByBounds(aSplits1, aFilterBounds, aMVOld, aMENew, aDMEOr, aMELF, theEImages, theMECheckExt,
                            theMEInvOnArt, theVertsToAvoid, aMEInv);
        ...
        if (aLEIm.Extent() == 1 && aE.IsSame(aLEIm.First())) {
            ...
            if (aLPB.Extent() == 1) {
                ...
                if (!aCB.IsNull()) {
                    ...
                    for (; aItLPB.More(); aItLPB.Next()) {
                        if (pDS->PaveBlocks(aItLPB.Value()->OriginalEdge()).Extent() > 1) break;
                    }
                    bKeep = !aItLPB.More();
                }
            }
...
void BRepOffset_BuildOffsetFaces::TrimNewIntersectionEdges(
    const TopTools_ListOfShape& theLE, const TopTools_DataMapOfShapeListOfShape& theEETrim,
    const TopTools_MapOfShape& theMVBounds, TopTools_MapOfShape& theMECheckExt,
    TopTools_DataMapOfShapeListOfShape& theEImages, TopTools_MapOfShape& theMEB, TopTools_MapOfShape& theMVOld,
    TopTools_MapOfShape& theMENew, TopTools_DataMapOfShapeListOfShape& theDMEOr,
    TopTools_DataMapOfShapeListOfShape& theMELF) {
    TopTools_ListIteratorOfListOfShape aIt, aIt1;
...
//=======================================================================
void BRepOffset_BuildOffsetFaces::IntersectEdges(const TopTools_ListOfShape& theLA, const TopTools_ListOfShape& theLE,
    ...
    for (; aIt.More(); aIt.Next()) {
        const TopoDS_Shape& aE = aIt.Value();
        if (!theMENew.Contains(aE)) continue;

        const TopTools_ListOfShape& aLEIm = aGFA.Modified(aE);
        if (aLEIm.IsEmpty()) continue;
...
//=======================================================================
void BRepOffset_BuildOffsetFaces::GetBounds(const TopTools_ListOfShape& theLFaces, const TopTools_MapOfShape& theMEB,
                                            TopoDS_Shape& theBounds) {
    BRep_Builder aBB;
...
void BRepOffset_BuildOffsetFaces::GetInvalidEdgesByBounds(
    const TopoDS_Shape& theSplits, const TopoDS_Shape& theBounds, const TopTools_MapOfShape& theMVOld,
    const TopTools_MapOfShape& theMENew, const TopTools_DataMapOfShapeListOfShape& theDMEOr,
    const TopTools_DataMapOfShapeListOfShape& theMELF, const TopTools_DataMapOfShapeListOfShape& theEImages,
    const TopTools_MapOfShape& theMECheckExt, const TopTools_MapOfShape& theMEInvOnArt,
    TopTools_MapOfShape& theVertsToAvoid, TopTools_MapOfShape& theMEInv) {
...
void BRepOffset_BuildOffsetFaces::FilterSplits(const TopTools_ListOfShape& theLE,
                                               const TopTools_MapOfShape& theMEFilter, const Standard_Boolean theIsInv,
                                               TopTools_DataMapOfShapeListOfShape& theEImages,
                                               TopoDS_Shape& theSplits) {
    ...
    for (; aItLE.More(); aItLE.Next()) {
        ...
        for (; aItLEIm.More();) {
            ...
            if (aMFence.Add(aEIm)) BRep_Builder().Add(aSplits, aEIm);
            aItLEIm.Next();
        }

        if (pLEIm->IsEmpty()) theEImages.UnBind(aE);
    }
    theSplits = aSplits;
}
    ...
    for (Standard_Integer i = 1; i <= aNbF; ++i, aPS.Next()) {
        ...
        for (; itLF.More(); itLF.Next()) {
            ...
            for (; anExpE.More(); anExpE.Next()) {
                ...
                const TopTools_ListOfShape& aLF = anEFMap.FindFromKey(aE);
                if (aLF.Extent() == 1) aFreeEdgesMap.Add(aE.Reversed());
...
void BRepOffset_MakeOffset::BuildSplitsOfTrimmedFaces(const TopTools_ListOfShape& theLF,
                                                      const Handle(BRepAlgo_AsDes) & theAsDes, BRepAlgo_Image& theImage,
                                                      const Message_ProgressRange& theRange) {
...
void BRepOffset_MakeOffset::BuildSplitsOfExtendedFaces(
    const TopTools_ListOfShape& theLF, const BRepOffset_Analyse& theAnalyse, const Handle(BRepAlgo_AsDes) & theAsDes,
    TopTools_DataMapOfShapeListOfShape& theEdgesOrigins, TopTools_DataMapOfShapeShape& theFacesOrigins,
    TopTools_DataMapOfShapeShape& theETrimEInf, BRepAlgo_Image& theImage, const Message_ProgressRange& theRange) {
    BRepOffset_BuildOffsetFaces aBFTool(theImage);
    aBFTool.SetFaces(theLF);
    aBFTool.SetAsDesInfo(theAsDes);
