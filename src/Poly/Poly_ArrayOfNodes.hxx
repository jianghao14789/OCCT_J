...
public:
    ...
    bool IsDoublePrecision() const {
        return myStride == (Standard_Integer)sizeof(gp_Pnt);
    }
    ...
    void SetDoublePrecision(bool theIsDouble) {
        if (myData != NULL) {
            throw Standard_ProgramError("Poly_ArrayOfNodes::SetDoublePrecision() should be called before allocation");
        }
    ...
    //! Move constructor
    Poly_ArrayOfNodes(Poly_ArrayOfNodes&& theOther) : NCollection_AliasedArray(std::move(theOther)) {
        //
    }
