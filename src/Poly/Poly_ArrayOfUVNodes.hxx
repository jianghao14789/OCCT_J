...
public:
    ...
    bool IsDoublePrecision() const {
        return myStride == (Standard_Integer)sizeof(gp_Pnt2d);
    }
    ...
    void SetDoublePrecision(bool theIsDouble) {
        if (myData != NULL) {
            throw Standard_ProgramError("Poly_ArrayOfUVNodes::SetDoublePrecision() should be called before allocation");
        }
    ...
    //! Move constructor
    Poly_ArrayOfUVNodes(Poly_ArrayOfUVNodes&& theOther) : NCollection_AliasedArray(std::move(theOther)) {
        //
    }
