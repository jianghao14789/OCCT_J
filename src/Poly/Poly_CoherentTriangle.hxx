...
public:
     ...
     * Constructor.
     */
    Standard_EXPORT Poly_CoherentTriangle(const Standard_Integer iNode0, const Standard_Integer iNode1,
     ...
     */
    Standard_EXPORT Standard_Boolean SetConnection(const Standard_Integer iConn, Poly_CoherentTriangle& theTr);
