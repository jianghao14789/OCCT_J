...
public:
    ...
    Standard_EXPORT static void Write(const Handle(Poly_Triangulation) & T, Standard_OStream& OS,
    ...
    //! method. If compact is False  it is a "Dump" format
    //! intended to be informative.
    Standard_EXPORT static void Write(const Handle(Poly_Polygon3D) & P, Standard_OStream& OS,
                                      const Standard_Boolean Compact = Standard_True);
    ...
    //! method. If compact is False  it is a "Dump" format
    //! intended to be informative.
    Standard_EXPORT static void Write(const Handle(Poly_Polygon2D) & P, Standard_OStream& OS,
                                      const Standard_Boolean Compact = Standard_True);
    ...
    //! point is inside).
    Standard_EXPORT static Standard_Real PointOnTriangle(const gp_XY& P1, const gp_XY& P2, const gp_XY& P3,
                                                         const gp_XY& P, gp_XY& UV);
    ...
    Standard_EXPORT static Standard_Boolean Intersect(const Handle(Poly_Triangulation) & theTri, const gp_Ax1& theAxis,
    ...
    Standard_EXPORT static Standard_Integer IntersectTriLine(const gp_XYZ& theStart, const gp_Dir& theDir,
                                                             const gp_XYZ& theV0, const gp_XYZ& theV1,
                                                             const gp_XYZ& theV2, Standard_Real& theParam);
    ...
    Standard_EXPORT static Standard_Boolean PolygonProperties(const TypeSequencePnts& theSeqPnts,
                                                              Standard_Real& theArea, Standard_Real& thePerimeter) {
