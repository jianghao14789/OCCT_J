...
public:
    ...
    Standard_EXPORT Poly_PolygonOnTriangulation(const Standard_Integer theNbNodes, const Standard_Boolean theHasParams);
...
public:
    ...
    Standard_DEPRECATED("Deprecated method, SetNode() should be used instead") TColStd_Array1OfInteger& ChangeNodes() {
        return myNodes;
    }
