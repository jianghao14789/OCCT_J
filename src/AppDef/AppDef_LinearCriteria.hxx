...
public:
    Standard_EXPORT AppDef_LinearCriteria(const AppDef_MultiLine& SSP, const Standard_Integer FirstPoint,
    ...
    Standard_EXPORT void SetEstimation(const Standard_Real E1, const Standard_Real E2,
    ...
    Standard_EXPORT Standard_Integer QualityValues(const Standard_Real J1min, const Standard_Real J2min,
                                                   const Standard_Real J3min, Standard_Real& J1, Standard_Real& J2,
                                                   Standard_Real& J3) Standard_OVERRIDE;

    Standard_EXPORT void ErrorValues(Standard_Real& MaxError, Standard_Real& QuadraticError,
                                     Standard_Real& AverageError) Standard_OVERRIDE;

    Standard_EXPORT void Hessian(const Standard_Integer Element, const Standard_Integer Dimension1,
                                 const Standard_Integer Dimension2, math_Matrix& H) Standard_OVERRIDE;

    Standard_EXPORT void Gradient(const Standard_Integer Element, const Standard_Integer Dimension,
    ...
    Standard_EXPORT void InputVector(const math_Vector& X,
                                     const Handle(FEmTool_HAssemblyTable) & AssTable) Standard_OVERRIDE;

    Standard_EXPORT void SetWeight(const Standard_Real QuadraticWeight, const Standard_Real QualityWeight,
