...
void AppDef_MyLineTool::Value(const AppDef_MultiLine& ML, const Standard_Integer MPointIndex,
...
void AppDef_MyLineTool::Value(const AppDef_MultiLine& ML, const Standard_Integer MPointIndex, TColgp_Array1OfPnt& tabPt,
                              TColgp_Array1OfPnt2d& tabPt2d) {
    AppDef_MultiPointConstraint MPC = ML.Value(MPointIndex);
...
Standard_Boolean AppDef_MyLineTool::Tangency(const AppDef_MultiLine& ML, const Standard_Integer MPointIndex,
...
AppDef_MultiLine AppDef_MyLineTool::MakeMLBetween(const AppDef_MultiLine& theML, const Standard_Integer,
                                                  const Standard_Integer, const Standard_Integer) {
    return theML; // stub
}

Standard_Boolean AppDef_MyLineTool::MakeMLOneMorePoint(const AppDef_MultiLine&, const Standard_Integer,
                                                       const Standard_Integer, const Standard_Integer,
                                                       AppDef_MultiLine&) {
    return Standard_False;
}

Approx_Status AppDef_MyLineTool::WhatStatus(const AppDef_MultiLine&, const Standard_Integer, const Standard_Integer) {
    return Approx_NoPointsAdded;
}

Standard_Boolean AppDef_MyLineTool::Curvature(const AppDef_MultiLine& ML, const Standard_Integer MPointIndex,
                                              TColgp_Array1OfVec& tabV) {
    AppDef_MultiPointConstraint MPC = ML.Value(MPointIndex);
