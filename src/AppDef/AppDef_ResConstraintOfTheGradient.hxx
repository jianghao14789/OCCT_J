...
public:
    ...
    Standard_EXPORT AppDef_ResConstraintOfTheGradient(
        const AppDef_MultiLine& SSP, AppParCurves_MultiCurve& SCurv, const Standard_Integer FirstPoint,
    ...
    Standard_EXPORT const math_Matrix& ConstraintDerivative(const AppDef_MultiLine& SSP, const math_Vector& Parameters,
                                                            const Standard_Integer Deg, const math_Matrix& DA);
...
protected:
    ...
    Standard_EXPORT Standard_Integer NbConstraints(const AppDef_MultiLine& SSP, const Standard_Integer FirstPoint,
