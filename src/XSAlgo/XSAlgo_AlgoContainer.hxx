...
public:
    ...
    //! translation map
    Standard_EXPORT virtual TopoDS_Shape
    ProcessShape(const TopoDS_Shape& shape, const Standard_Real Prec, const Standard_Real MaxTol,
    ...
    Standard_EXPORT virtual Standard_Boolean CheckPCurve(const TopoDS_Edge& edge, const TopoDS_Face& face,
