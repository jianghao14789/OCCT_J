...
static Standard_Integer DPrsStd_AISInitViewer(Draw_Interpretor& theDI, Standard_Integer theArgNb,
...
static Standard_Integer DPrsStd_AISRepaint(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 2) {
