...
// purpose  : Constructor
//=======================================================================
BinMDataStd_IntegerArrayDriver::BinMDataStd_IntegerArrayDriver(const Handle(Message_Messenger) & theMsgDriver)
...
Standard_Boolean BinMDataStd_IntegerArrayDriver::Paste(const BinObjMgt_Persistent& theSource,
    ...
    if (!theSource.GetIntArray(&aTargetArray(aFirstInd), aLength)) return Standard_False;
...
void BinMDataStd_IntegerArrayDriver::Paste(const Handle(TDF_Attribute) & theSource, BinObjMgt_Persistent& theTarget,
    ...
    if (anAtt->ID() != TDataStd_IntegerArray::GetID()) theTarget << anAtt->ID();
}
