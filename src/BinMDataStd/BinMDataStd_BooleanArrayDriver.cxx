...
Standard_Boolean BinMDataStd_BooleanArrayDriver::Paste(const BinObjMgt_Persistent& theSource,
    ...
    if (aLastInd < aFirstInd) return Standard_False;
...
//=======================================================================
void BinMDataStd_BooleanArrayDriver::Paste(const Handle(TDF_Attribute) & theSource, BinObjMgt_Persistent& theTarget,
    ...
    if (anAtt->ID() != TDataStd_BooleanArray::GetID()) theTarget << anAtt->ID();
}
