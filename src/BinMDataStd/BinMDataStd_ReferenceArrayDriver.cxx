...
Standard_Boolean BinMDataStd_ReferenceArrayDriver::Paste(const BinObjMgt_Persistent& theSource,
    ...
    for (Standard_Integer i = aFirstInd; i <= aLastInd; i++) {
        ...
        if (!L.IsNull()) anAtt->SetValue(i, L);
    }
...
//=======================================================================
void BinMDataStd_ReferenceArrayDriver::Paste(const Handle(TDF_Attribute) & theSource, BinObjMgt_Persistent& theTarget,
    ...
    if (anAtt->ID() != TDataStd_ReferenceArray::GetID()) theTarget << anAtt->ID();
}
