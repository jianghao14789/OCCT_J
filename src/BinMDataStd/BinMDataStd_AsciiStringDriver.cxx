...
// purpose  :
//=======================================================================
BinMDataStd_AsciiStringDriver::BinMDataStd_AsciiStringDriver(const Handle(Message_Messenger) & theMessageDriver)
...
void BinMDataStd_AsciiStringDriver::Paste(const Handle(TDF_Attribute) & Source, BinObjMgt_Persistent& Target,
    ...
    if (anAtt->ID() != TDataStd_AsciiString::GetID()) Target << anAtt->ID();
}
