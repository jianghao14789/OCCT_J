...
// purpose  :
//=======================================================================
BinMDataStd_GenericExtStringDriver::BinMDataStd_GenericExtStringDriver(const Handle(Message_Messenger) &
                                                                       theMessageDriver)
...
Standard_Boolean BinMDataStd_GenericExtStringDriver::Paste(const BinObjMgt_Persistent& Source,
    ...
    if (ok) aStrAttr->Set(aStr);
    if (RelocTable.GetHeaderData()->StorageVersion().IntegerValue() >=
        TDocStd_FormatVersion_VERSION_9) { // process user defined guid
...
void BinMDataStd_GenericExtStringDriver::Paste(const Handle(TDF_Attribute) & Source, BinObjMgt_Persistent& Target,
