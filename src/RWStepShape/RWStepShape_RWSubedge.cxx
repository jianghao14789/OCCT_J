...
void RWStepShape_RWSubedge::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepShape_RWSubedge::WriteStep(StepData_StepWriter& SW, const Handle(StepShape_Subedge) & ent) const {
...
void RWStepShape_RWSubedge::Share(const Handle(StepShape_Subedge) & ent, Interface_EntityIterator& iter) const {
