...
void RWStepShape_RWCsgShapeRepresentation::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepShape_RWCsgShapeRepresentation::WriteStep(StepData_StepWriter& SW,
                                                     const Handle(StepShape_CsgShapeRepresentation) & ent) const {
...
void RWStepShape_RWCsgShapeRepresentation::Share(const Handle(StepShape_CsgShapeRepresentation) & ent,
