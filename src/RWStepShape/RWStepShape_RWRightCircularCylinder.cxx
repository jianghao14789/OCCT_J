...
void RWStepShape_RWRightCircularCylinder::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepShape_RWRightCircularCylinder::WriteStep(StepData_StepWriter& SW,
                                                    const Handle(StepShape_RightCircularCylinder) & ent) const {
