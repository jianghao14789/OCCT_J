...
void RWStepShape_RWCsgSolid::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                      Handle(Interface_Check) & ach, const Handle(StepShape_CsgSolid) & ent) const {
...
void RWStepShape_RWCsgSolid::WriteStep(StepData_StepWriter& SW, const Handle(StepShape_CsgSolid) & ent) const {
