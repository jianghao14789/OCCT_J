...
void RWStepShape_RWQualifiedRepresentationItem::ReadStep(const Handle(StepData_StepReaderData) & data,
    ...
    if (data->ReadSubList(num, 2, "qualifiers", ach, nsub2)) {
        ...
        for (Standard_Integer i2 = 1; i2 <= nb2; i2++) {
            ...
            if (data->ReadEntity(nsub2, i2, "qualifier", ach, VQ)) quals->SetValue(i2, VQ);
        }
    }
...
void RWStepShape_RWQualifiedRepresentationItem::WriteStep(StepData_StepWriter& SW,
                                                          const Handle(StepShape_QualifiedRepresentationItem) &
                                                              ent) const {
    // --- inherited field name ---
...
void RWStepShape_RWQualifiedRepresentationItem::Share(const Handle(StepShape_QualifiedRepresentationItem) & ent,
