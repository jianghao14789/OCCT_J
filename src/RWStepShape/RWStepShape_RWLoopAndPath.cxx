...
void RWStepShape_RWLoopAndPath::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num0,
...
void RWStepShape_RWLoopAndPath::WriteStep(StepData_StepWriter& SW, const Handle(StepShape_LoopAndPath) & ent) const {
