...
void RWStepShape_RWOrientedFace::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepShape_RWOrientedFace::WriteStep(StepData_StepWriter& SW, const Handle(StepShape_OrientedFace) & ent) const {
