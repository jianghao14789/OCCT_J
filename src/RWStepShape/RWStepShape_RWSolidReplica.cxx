...
void RWStepShape_RWSolidReplica::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
    ...
    data->ReadEntity(num, 3, "transformation", ach, STANDARD_TYPE(StepGeom_CartesianTransformationOperator3d),
                     aTransformation);
...
void RWStepShape_RWSolidReplica::WriteStep(StepData_StepWriter& SW, const Handle(StepShape_SolidReplica) & ent) const {
