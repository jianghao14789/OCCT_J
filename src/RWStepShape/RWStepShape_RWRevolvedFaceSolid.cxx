...
void RWStepShape_RWRevolvedFaceSolid::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepShape_RWRevolvedFaceSolid::WriteStep(StepData_StepWriter& SW,
                                                const Handle(StepShape_RevolvedFaceSolid) & ent) const {
...
void RWStepShape_RWRevolvedFaceSolid::Share(const Handle(StepShape_RevolvedFaceSolid) & ent,
