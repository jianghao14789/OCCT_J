...
void RWStepShape_RWTransitionalShapeRepresentation::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                             const Standard_Integer num, Handle(Interface_Check) & ach,
                                                             const Handle(StepShape_TransitionalShapeRepresentation) &
                                                                 ent) const {
...
void RWStepShape_RWTransitionalShapeRepresentation::WriteStep(StepData_StepWriter& SW,
                                                              const Handle(StepShape_TransitionalShapeRepresentation) &
                                                                  ent) const {
...
void RWStepShape_RWTransitionalShapeRepresentation::Share(const Handle(StepShape_TransitionalShapeRepresentation) & ent,
