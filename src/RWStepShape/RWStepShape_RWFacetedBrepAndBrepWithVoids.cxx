...
void RWStepShape_RWFacetedBrepAndBrepWithVoids::ReadStep(const Handle(StepData_StepReaderData) & data,
    ...
    if (data->ReadSubList(num, 1, "voids", ach, nsub1)) {
        ...
        for (Standard_Integer i1 = 1; i1 <= nb1; i1++) {
            ...
            if (data->ReadEntity(nsub1, i1, "oriented_closed_shell", ach, STANDARD_TYPE(StepShape_OrientedClosedShell),
                                 anent))
...
void RWStepShape_RWFacetedBrepAndBrepWithVoids::WriteStep(StepData_StepWriter& SW,
                                                          const Handle(StepShape_FacetedBrepAndBrepWithVoids) &
                                                              ent) const {
...
void RWStepShape_RWFacetedBrepAndBrepWithVoids::Share(const Handle(StepShape_FacetedBrepAndBrepWithVoids) & ent,
