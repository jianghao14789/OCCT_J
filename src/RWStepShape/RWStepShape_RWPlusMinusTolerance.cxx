...
void RWStepShape_RWPlusMinusTolerance::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepShape_RWPlusMinusTolerance::WriteStep(StepData_StepWriter& SW,
                                                 const Handle(StepShape_PlusMinusTolerance) & ent) const {
