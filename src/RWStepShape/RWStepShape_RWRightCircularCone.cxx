...
void RWStepShape_RWRightCircularCone::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepShape_RWRightCircularCone::WriteStep(StepData_StepWriter& SW,
                                                const Handle(StepShape_RightCircularCone) & ent) const {
