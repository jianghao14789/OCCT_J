...
void RWStepShape_RWFaceOuterBound::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepShape_RWFaceOuterBound::Share(const Handle(StepShape_FaceOuterBound) & ent,
