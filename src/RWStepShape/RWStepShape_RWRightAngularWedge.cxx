...
void RWStepShape_RWRightAngularWedge::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepShape_RWRightAngularWedge::WriteStep(StepData_StepWriter& SW,
                                                const Handle(StepShape_RightAngularWedge) & ent) const {
