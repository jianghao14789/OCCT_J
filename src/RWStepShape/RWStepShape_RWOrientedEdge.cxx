...
void RWStepShape_RWOrientedEdge::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepShape_RWOrientedEdge::WriteStep(StepData_StepWriter& SW, const Handle(StepShape_OrientedEdge) & ent) const {
