...
void RWStepShape_RWOrientedPath::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepShape_RWOrientedPath::WriteStep(StepData_StepWriter& SW, const Handle(StepShape_OrientedPath) & ent) const {
