...
void RWStepShape_RWSphere::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                    Handle(Interface_Check) & ach, const Handle(StepShape_Sphere) & ent) const {
...
void RWStepShape_RWSphere::WriteStep(StepData_StepWriter& SW, const Handle(StepShape_Sphere) & ent) const {
