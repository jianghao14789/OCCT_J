...
void RWStepShape_RWGeometricCurveSet::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepShape_RWGeometricCurveSet::WriteStep(StepData_StepWriter& SW,
                                                const Handle(StepShape_GeometricCurveSet) & ent) const {
