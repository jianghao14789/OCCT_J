...
void RWStepShape_RWManifoldSurfaceShapeRepresentation::WriteStep(
    StepData_StepWriter& SW, const Handle(StepShape_ManifoldSurfaceShapeRepresentation) & ent) const {
...
void RWStepShape_RWManifoldSurfaceShapeRepresentation::Share(
    const Handle(StepShape_ManifoldSurfaceShapeRepresentation) & ent, Interface_EntityIterator& iter) const {
