...
void RWStepShape_RWTorus::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                   Handle(Interface_Check) & ach, const Handle(StepShape_Torus) & ent) const {
...
void RWStepShape_RWTorus::WriteStep(StepData_StepWriter& SW, const Handle(StepShape_Torus) & ent) const {
