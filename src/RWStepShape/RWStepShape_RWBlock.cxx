...
void RWStepShape_RWBlock::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                   Handle(Interface_Check) & ach, const Handle(StepShape_Block) & ent) const {
...
void RWStepShape_RWBlock::WriteStep(StepData_StepWriter& SW, const Handle(StepShape_Block) & ent) const {
