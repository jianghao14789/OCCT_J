...
void RWStepShape_RWClosedShell::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepShape_RWClosedShell::WriteStep(StepData_StepWriter& SW, const Handle(StepShape_ClosedShell) & ent) const {
