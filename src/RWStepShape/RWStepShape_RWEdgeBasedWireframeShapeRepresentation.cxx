...
void RWStepShape_RWEdgeBasedWireframeShapeRepresentation::WriteStep(
    StepData_StepWriter& SW, const Handle(StepShape_EdgeBasedWireframeShapeRepresentation) & ent) const {
...
void RWStepShape_RWEdgeBasedWireframeShapeRepresentation::Share(
    const Handle(StepShape_EdgeBasedWireframeShapeRepresentation) & ent, Interface_EntityIterator& iter) const {
