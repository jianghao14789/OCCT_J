...
void RWStepShape_RWShellBasedSurfaceModel::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepShape_RWShellBasedSurfaceModel::WriteStep(StepData_StepWriter& SW,
                                                     const Handle(StepShape_ShellBasedSurfaceModel) & ent) const {
...
void RWStepShape_RWShellBasedSurfaceModel::Share(const Handle(StepShape_ShellBasedSurfaceModel) & ent,
