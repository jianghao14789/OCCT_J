...
void RWStepShape_RWSeamEdge::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
    ...
    data->ReadEntity(num, 4, "oriented_edge.edge_element", ach, STANDARD_TYPE(StepShape_Edge),
    ...
    ent->Init(aRepresentationItem_Name, aOrientedEdge_EdgeElement, aOrientedEdge_Orientation, aPcurveReference);
}
...
void RWStepShape_RWSeamEdge::WriteStep(StepData_StepWriter& SW, const Handle(StepShape_SeamEdge) & ent) const {
...
void RWStepShape_RWSeamEdge::Share(const Handle(StepShape_SeamEdge) & ent, Interface_EntityIterator& iter) const {
