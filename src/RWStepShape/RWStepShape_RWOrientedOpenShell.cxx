...
void RWStepShape_RWOrientedOpenShell::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepShape_RWOrientedOpenShell::WriteStep(StepData_StepWriter& SW,
                                                const Handle(StepShape_OrientedOpenShell) & ent) const {
