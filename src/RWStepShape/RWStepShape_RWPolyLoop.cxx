...
void RWStepShape_RWPolyLoop::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                      Handle(Interface_Check) & ach, const Handle(StepShape_PolyLoop) & ent) const {
...
void RWStepShape_RWPolyLoop::WriteStep(StepData_StepWriter& SW, const Handle(StepShape_PolyLoop) & ent) const {
