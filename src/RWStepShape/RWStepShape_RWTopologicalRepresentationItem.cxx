...
void RWStepShape_RWTopologicalRepresentationItem::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepShape_RWTopologicalRepresentationItem::WriteStep(StepData_StepWriter& SW,
                                                            const Handle(StepShape_TopologicalRepresentationItem) &
                                                                ent) const {
