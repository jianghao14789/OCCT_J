...
void RWStepShape_RWShapeRepresentation::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepShape_RWShapeRepresentation::WriteStep(StepData_StepWriter& SW,
                                                  const Handle(StepShape_ShapeRepresentation) & ent) const {
