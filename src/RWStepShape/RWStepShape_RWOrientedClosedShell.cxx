...
void RWStepShape_RWOrientedClosedShell::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepShape_RWOrientedClosedShell::WriteStep(StepData_StepWriter& SW,
                                                  const Handle(StepShape_OrientedClosedShell) & ent) const {
