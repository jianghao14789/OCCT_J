...
void RWStepShape_RWFacetedBrepShapeRepresentation::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                            const Standard_Integer num, Handle(Interface_Check) & ach,
                                                            const Handle(StepShape_FacetedBrepShapeRepresentation) &
                                                                ent) const {
...
void RWStepShape_RWFacetedBrepShapeRepresentation::WriteStep(StepData_StepWriter& SW,
                                                             const Handle(StepShape_FacetedBrepShapeRepresentation) &
                                                                 ent) const {
...
void RWStepShape_RWFacetedBrepShapeRepresentation::Share(const Handle(StepShape_FacetedBrepShapeRepresentation) & ent,
