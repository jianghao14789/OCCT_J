...
void RWStepShape_RWAdvancedFace::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepShape_RWAdvancedFace::WriteStep(StepData_StepWriter& SW, const Handle(StepShape_AdvancedFace) & ent) const {
