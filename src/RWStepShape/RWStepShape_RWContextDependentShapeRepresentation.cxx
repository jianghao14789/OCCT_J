...
void RWStepShape_RWContextDependentShapeRepresentation::ReadStep(
    ...
    data->ReadEntity(num, 1, "representation_relation", ach, STANDARD_TYPE(StepRepr_ShapeRepresentationRelationship),
                     aRepRel);
    ...
    data->ReadEntity(num, 2, "represented_product_relation", ach, STANDARD_TYPE(StepRepr_ProductDefinitionShape),
                     aProRel);
...
void RWStepShape_RWContextDependentShapeRepresentation::WriteStep(
    StepData_StepWriter& SW, const Handle(StepShape_ContextDependentShapeRepresentation) & ent) const {
...
void RWStepShape_RWContextDependentShapeRepresentation::Share(
    const Handle(StepShape_ContextDependentShapeRepresentation) & ent, Interface_EntityIterator& iter) const {
