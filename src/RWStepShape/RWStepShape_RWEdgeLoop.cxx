...
void RWStepShape_RWEdgeLoop::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                      Handle(Interface_Check) & ach, const Handle(StepShape_EdgeLoop) & ent) const {
...
void RWStepShape_RWEdgeLoop::WriteStep(StepData_StepWriter& SW, const Handle(StepShape_EdgeLoop) & ent) const {
...
void RWStepShape_RWEdgeLoop::Check(const Handle(StepShape_EdgeLoop) & ent, const Interface_ShareTool&,
