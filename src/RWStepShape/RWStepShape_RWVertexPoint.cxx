...
void RWStepShape_RWVertexPoint::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepShape_RWVertexPoint::WriteStep(StepData_StepWriter& SW, const Handle(StepShape_VertexPoint) & ent) const {
