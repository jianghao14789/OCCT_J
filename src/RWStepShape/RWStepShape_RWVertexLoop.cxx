...
void RWStepShape_RWVertexLoop::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                        Handle(Interface_Check) & ach, const Handle(StepShape_VertexLoop) & ent) const {
...
void RWStepShape_RWVertexLoop::WriteStep(StepData_StepWriter& SW, const Handle(StepShape_VertexLoop) & ent) const {
