...
void RWStepShape_RWExtrudedAreaSolid::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepShape_RWExtrudedAreaSolid::WriteStep(StepData_StepWriter& SW,
                                                const Handle(StepShape_ExtrudedAreaSolid) & ent) const {
...
void RWStepShape_RWExtrudedAreaSolid::Share(const Handle(StepShape_ExtrudedAreaSolid) & ent,
