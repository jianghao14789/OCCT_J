...
void RWStepShape_RWOpenShell::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                       Handle(Interface_Check) & ach, const Handle(StepShape_OpenShell) & ent) const {
...
void RWStepShape_RWOpenShell::WriteStep(StepData_StepWriter& SW, const Handle(StepShape_OpenShell) & ent) const {
