...
public:
    ...
    Standard_EXPORT void ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                  Handle(Interface_Check) & ach, const Handle(StepShape_BrepWithVoids) & ent) const;
    ...
    Standard_EXPORT void Check(const Handle(StepShape_BrepWithVoids) & ent, const Interface_ShareTool& shares,
