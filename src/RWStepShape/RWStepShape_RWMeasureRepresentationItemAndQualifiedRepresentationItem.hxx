...
public:
    ...
    Standard_EXPORT void WriteStep(StepData_StepWriter& SW,
                                   const Handle(StepShape_MeasureRepresentationItemAndQualifiedRepresentationItem) &
                                       ent) const;

    Standard_EXPORT void Share(const Handle(StepShape_MeasureRepresentationItemAndQualifiedRepresentationItem) & ent,
