...
void RWStepShape_RWManifoldSolidBrep::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepShape_RWManifoldSolidBrep::WriteStep(StepData_StepWriter& SW,
                                                const Handle(StepShape_ManifoldSolidBrep) & ent) const {
