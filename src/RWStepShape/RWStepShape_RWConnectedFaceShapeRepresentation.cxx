...
void RWStepShape_RWConnectedFaceShapeRepresentation::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                              ...
                                                              const Handle(StepShape_ConnectedFaceShapeRepresentation) &
                                                                  ent) const {
...
void RWStepShape_RWConnectedFaceShapeRepresentation::WriteStep(
    StepData_StepWriter& SW, const Handle(StepShape_ConnectedFaceShapeRepresentation) & ent) const {
...
void RWStepShape_RWConnectedFaceShapeRepresentation::Share(const Handle(StepShape_ConnectedFaceShapeRepresentation) &
                                                               ent,
