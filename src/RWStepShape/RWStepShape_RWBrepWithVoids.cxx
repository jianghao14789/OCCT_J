...
void RWStepShape_RWBrepWithVoids::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
    ...
    if (data->ReadSubList(num, 3, "voids", ach, nsub3)) {
        ...
        for (Standard_Integer i3 = 1; i3 <= nb3; i3++) {
            ...
            if (data->ReadEntity(nsub3, i3, "oriented_closed_shell", ach, STANDARD_TYPE(StepShape_OrientedClosedShell),
                                 anent3))
...
void RWStepShape_RWBrepWithVoids::Check(const Handle(StepShape_BrepWithVoids) & ent, const Interface_ShareTool&,
