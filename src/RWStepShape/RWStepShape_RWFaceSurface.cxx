...
void RWStepShape_RWFaceSurface::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepShape_RWFaceSurface::WriteStep(StepData_StepWriter& SW, const Handle(StepShape_FaceSurface) & ent) const {
