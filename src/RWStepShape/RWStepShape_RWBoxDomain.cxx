...
void RWStepShape_RWBoxDomain::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                       Handle(Interface_Check) & ach, const Handle(StepShape_BoxDomain) & ent) const {
...
void RWStepShape_RWBoxDomain::WriteStep(StepData_StepWriter& SW, const Handle(StepShape_BoxDomain) & ent) const {
