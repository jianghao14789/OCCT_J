...
void RWStepShape_RWRevolvedAreaSolid::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepShape_RWRevolvedAreaSolid::WriteStep(StepData_StepWriter& SW,
                                                const Handle(StepShape_RevolvedAreaSolid) & ent) const {
