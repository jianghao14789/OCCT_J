...
void RWStepShape_RWSubface::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepShape_RWSubface::WriteStep(StepData_StepWriter& SW, const Handle(StepShape_Subface) & ent) const {
...
void RWStepShape_RWSubface::Share(const Handle(StepShape_Subface) & ent, Interface_EntityIterator& iter) const {
