...
void RWStepShape_RWFacetedBrep::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepShape_RWFacetedBrep::WriteStep(StepData_StepWriter& SW, const Handle(StepShape_FacetedBrep) & ent) const {
