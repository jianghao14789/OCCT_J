...
void RWStepShape_RWBoxedHalfSpace::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepShape_RWBoxedHalfSpace::Share(const Handle(StepShape_BoxedHalfSpace) & ent,
