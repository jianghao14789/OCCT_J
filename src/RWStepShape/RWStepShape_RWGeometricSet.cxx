...
void RWStepShape_RWGeometricSet::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
    ...
    if (data->ReadSubList(num, 2, "elements", ach, nsub2)) {
        ...
        for (Standard_Integer i2 = 1; i2 <= nb2; i2++) {
            ...
            if (data->ReadEntity(nsub2, i2, "elements", ach, aElementsItem)) aElements->SetValue(i2, aElementsItem);
        }
    }
...
void RWStepShape_RWGeometricSet::WriteStep(StepData_StepWriter& SW, const Handle(StepShape_GeometricSet) & ent) const {
