...
void RWStepShape_RWEdge::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                  Handle(Interface_Check) & ach, const Handle(StepShape_Edge) & ent) const {
...
void RWStepShape_RWEdge::WriteStep(StepData_StepWriter& SW, const Handle(StepShape_Edge) & ent) const {
