...
// purpose  :
//=======================================================================
GeomAdaptor_SurfaceOfLinearExtrusion::GeomAdaptor_SurfaceOfLinearExtrusion() : myHaveDir(Standard_False) {}
...
void GeomAdaptor_SurfaceOfLinearExtrusion::UIntervals(TColStd_Array1OfReal& T, const GeomAbs_Shape S) const {
...
void GeomAdaptor_SurfaceOfLinearExtrusion::VIntervals(TColStd_Array1OfReal& T, const GeomAbs_Shape) const {
...
Handle(Adaptor3d_Surface) GeomAdaptor_SurfaceOfLinearExtrusion::UTrim(const Standard_Real, const Standard_Real,
                                                                      const Standard_Real) const {
    Handle(GeomAdaptor_SurfaceOfLinearExtrusion) HR =
        new GeomAdaptor_SurfaceOfLinearExtrusion(GeomAdaptor_SurfaceOfLinearExtrusion(myBasisCurve, myDirection));
    return HR;
}
...
GeomAbs_SurfaceType GeomAdaptor_SurfaceOfLinearExtrusion::GetType() const {
    switch (myBasisCurve->GetType()) {
        ...
        case GeomAbs_Line: {
            ...
            if (!myDirection.IsParallel(D, Precision::Angular())) return GeomAbs_Plane;
            break;
        }
        ...
        case GeomAbs_Ellipse: {
            ...
            if (myDirection.IsNormal(D, Precision::Angular())) return GeomAbs_Plane;
            break;
        }
...
gp_Pln GeomAdaptor_SurfaceOfLinearExtrusion::Plane() const {
    Standard_NoSuchObject_Raise_if(GetType() != GeomAbs_Plane, "GeomAdaptor_SurfaceOfLinearExtrusion::Plane");
...
gp_Cylinder GeomAdaptor_SurfaceOfLinearExtrusion::Cylinder() const {
    Standard_NoSuchObject_Raise_if(GetType() != GeomAbs_Cylinder, "GeomAdaptor_SurfaceOfLinearExtrusion::Cylinder");
