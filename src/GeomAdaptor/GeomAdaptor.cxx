...
Handle(Geom_Curve) GeomAdaptor::MakeCurve(const Adaptor3d_Curve& HC) {
    ...
    if ((!C.IsNull() && (HC.FirstParameter() != C->FirstParameter())) || (HC.LastParameter() != C->LastParameter())) {
...
Handle(Geom_Surface) GeomAdaptor::MakeSurface(const Adaptor3d_Surface& HS, const Standard_Boolean theTrimFlag) {
    ...
    switch (HS.GetType()) {
        ...
        case GeomAbs_SurfaceOfRevolution:
            S = new Geom_SurfaceOfRevolution(GeomAdaptor::MakeCurve(*HS.BasisCurve()), HS.AxeOfRevolution());
            break;

        case GeomAbs_SurfaceOfExtrusion:
            S = new Geom_SurfaceOfLinearExtrusion(GeomAdaptor::MakeCurve(*HS.BasisCurve()), HS.Direction());
            break;
    ...
    if (S.IsNull() || !theTrimFlag) return S;
    ...
    if ((HS.FirstUParameter() != U1) || (HS.LastUParameter() != U2) || (HS.FirstVParameter() != V1) ||
        ...
        S = new Geom_RectangularTrimmedSurface(S, HS.FirstUParameter(), HS.LastUParameter(), HS.FirstVParameter(),
                                               HS.LastVParameter());
    }
