...
void StepDimTol_CommonDatum::Init(const Handle(TCollection_HAsciiString) & theShapeAspect_Name,
    ...
    StepRepr_CompositeShapeAspect::Init(theShapeAspect_Name, theShapeAspect_Description, theShapeAspect_OfShape,
                                        theShapeAspect_ProductDefinitional);
    myDatum->Init(theDatum_Name, theDatum_Description, theDatum_OfShape, theDatum_ProductDefinitional,
