...
void StepDimTol_GeoTolAndGeoTolWthDatRefAndGeoTolWthMaxTol::Init(
    ...
    const Handle(StepBasic_LengthMeasureWithUnit) & theMaxTol, const StepDimTol_GeometricToleranceType theType) {
    StepDimTol_GeoTolAndGeoTolWthDatRefAndGeoTolWthMod::Init(theName, theDescription, theMagnitude,
                                                             theTolerancedShapeAspect, theGTWDR, theGTWM, theType);
    myMaxTol = theMaxTol;
}
