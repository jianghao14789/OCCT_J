...
Handle(StepDimTol_DatumReferenceModifierWithValue)
    StepDimTol_DatumReferenceModifier::DatumReferenceModifierWithValue() const {
    return GetCasted(StepDimTol_DatumReferenceModifierWithValue, Value());
}

Handle(StepDimTol_SimpleDatumReferenceModifierMember)
    StepDimTol_DatumReferenceModifier::SimpleDatumReferenceModifierMember() const {
