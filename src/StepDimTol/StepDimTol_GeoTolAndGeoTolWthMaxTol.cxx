...
void StepDimTol_GeoTolAndGeoTolWthMaxTol::Init(const Handle(TCollection_HAsciiString) & theName,
    ...
    StepDimTol_GeoTolAndGeoTolWthMod::Init(theName, theDescription, theMagnitude, theTolerancedShapeAspect, theGTWM,
                                           theType);
    myMaxTol = theMaxTol;
}
