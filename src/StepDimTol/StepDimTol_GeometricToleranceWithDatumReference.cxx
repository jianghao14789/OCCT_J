...
void StepDimTol_GeometricToleranceWithDatumReference::Init(
    ...
    StepDimTol_GeometricTolerance::Init(theGeometricTolerance_Name, theGeometricTolerance_Description,
                                        theGeometricTolerance_Magnitude, theGeometricTolerance_TolerancedShapeAspect);
...
void StepDimTol_GeometricToleranceWithDatumReference::SetDatumSystem(const Handle(StepDimTol_HArray1OfDatumReference) &
                                                                     theDatumSystem) {
    myDatumSystem = new StepDimTol_HArray1OfDatumSystemOrReference(theDatumSystem->Lower(), theDatumSystem->Upper());
    StepDimTol_DatumSystemOrReference anAux;
    for (Standard_Integer i = theDatumSystem->Lower(); i <= theDatumSystem->Upper(); i++) {
