    ...
    for (Standard_Integer i = 1; i <= 19; i++) {
        ...
        switch (i) {
            ...
            case 10:
                ...
                break;
            case 11:
                if (uncar != 'T') return Standard_False;
...
APIHeaderSection_EditHeader::APIHeaderSection_EditHeader() : IFSelect_Editor(10) {
    //  Definition
...
Standard_Boolean APIHeaderSection_EditHeader::Recognize(const Handle(IFSelect_EditForm) & /*form*/) const {
    return Standard_True;
} // ??

Handle(TCollection_HAsciiString) APIHeaderSection_EditHeader::StringValue(const Handle(IFSelect_EditForm) & /*form*/,
