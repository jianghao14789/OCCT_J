...
public:
    ...
    //! built open wires.
    Standard_EXPORT ShapeAnalysis_FreeBounds(const TopoDS_Shape& shape, const Standard_Real toler,
    ...
    Standard_EXPORT static void SplitWires(const Handle(TopTools_HSequenceOfShape) & wires, const Standard_Real toler,
    ...
    Standard_EXPORT static void DispatchWires(const Handle(TopTools_HSequenceOfShape) & wires, TopoDS_Compound& closed,
