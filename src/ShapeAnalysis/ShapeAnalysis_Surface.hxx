...
public:
    ...
    Standard_EXPORT void SetDomain(const Standard_Real U1, const Standard_Real U2, const Standard_Real V1,
    ...
    Standard_EXPORT Standard_Boolean Singularity(const Standard_Integer num, Standard_Real& preci, gp_Pnt& P3d,
    ...
    //! those criteria.
    Standard_EXPORT Standard_Boolean DegeneratedValues(const gp_Pnt& P3d, const Standard_Real preci, gp_Pnt2d& firstP2d,
                                                       gp_Pnt2d& lastP2d, Standard_Real& firstpar,
    ...
    Standard_EXPORT Standard_Boolean ProjectDegenerated(const gp_Pnt& P3d, const Standard_Real preci,
    ...
    Standard_EXPORT Standard_Boolean IsDegenerated(const gp_Pnt2d& p2d1, const gp_Pnt2d& p2d2, const Standard_Real tol,
    ...
    Standard_EXPORT gp_Pnt2d NextValueOfUV(const gp_Pnt2d& p2dPrev, const gp_Pnt& P3D, const Standard_Real preci,
    ...
    Standard_EXPORT Standard_Real UVFromIso(const gp_Pnt& P3D, const Standard_Real preci, Standard_Real& U,
                                            Standard_Real& V);
...
private:
    ...
    //! @return 0, 1 or 2.
    Standard_EXPORT Standard_Integer SurfaceNewton(const gp_Pnt2d& p2dPrev, const gp_Pnt& P3D,
