...
ShapeAnalysis_TransferParameters::ShapeAnalysis_TransferParameters(const TopoDS_Edge& E, const TopoDS_Face& F) {
    Init(E, F);
}
...
Handle(TColStd_HSequenceOfReal) ShapeAnalysis_TransferParameters::Perform(const Handle(TColStd_HSequenceOfReal) &
                                                                              Params,
...
Standard_Real ShapeAnalysis_TransferParameters::Perform(const Standard_Real Param, const Standard_Boolean To2d) {
...
void ShapeAnalysis_TransferParameters::TransferRange(TopoDS_Edge& newEdge, const Standard_Real prevPar,
