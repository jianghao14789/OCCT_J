...
public:
    ...
    //! and precision
    Standard_EXPORT ShapeAnalysis_Wire(const Handle(ShapeExtend_WireData) & sbwd, const TopoDS_Face& face,
    ...
    //! and precision
    Standard_EXPORT void Init(const Handle(ShapeExtend_WireData) & sbwd, const TopoDS_Face& face,
                              const Standard_Real precision);
    ...
    Standard_EXPORT Standard_Boolean CheckSeam(const Standard_Integer num, Handle(Geom2d_Curve) & C1,
    ...
    Standard_EXPORT Standard_Boolean CheckLacking(const Standard_Integer num, const Standard_Real Tolerance,
    ...
    //! Detects a notch
    Standard_EXPORT Standard_Boolean CheckNotchedEdges(const Standard_Integer num, Standard_Integer& shortNum,
                                                       Standard_Real& param, const Standard_Real Tolerance = 0.0);
    ...
    Standard_EXPORT Standard_Boolean CheckShapeConnect(Standard_Real& tailhead, Standard_Real& tailtail,
                                                       Standard_Real& headtail, Standard_Real& headhead,
                                                       const TopoDS_Shape& shape, const Standard_Real prec = 0.0);
    ...
    Standard_EXPORT Standard_Boolean CheckLoop(TopTools_IndexedMapOfShape& aMapLoopVertices,
                                               ...
                                               TopTools_MapOfShape& aMapSmallEdges, TopTools_MapOfShape& aMapSeemEdges);

    Standard_EXPORT Standard_Boolean CheckTail(const TopoDS_Edge& theEdge1, const TopoDS_Edge& theEdge2,
