...
public:
    ...
    Standard_EXPORT static Handle(Poly_Triangulation)
        ToPolyTriangulation(const TColgp_Array1OfPnt& theNodes,
...
private:
    ...
    void addTriange34(const TColStd_SequenceOfInteger& theW, NCollection_List<Poly_Triangle>& thePolyTriangles);

    // auxiliary for addTriange34
    Standard_Boolean checkCondition(const int (&theNodes)[4], const TColStd_SequenceOfInteger& theWire);
