...
void BRepMesh_CylinderRangeSplitter::Reset(const IMeshData::IFaceHandle& theDFace,
    ...
    myDu = GCPnts_TangentialDeflection::ArcAngularStep(aRadius, GetDFace()->GetDeflection(), theParameters.Angle,
...
Handle(IMeshData::ListOfPnt2d)
    BRepMesh_CylinderRangeSplitter::GenerateSurfaceNodes(const IMeshTools_Parameters& /*theParameters*/) const {
...
// Purpose :
//=======================================================================
void BRepMesh_CylinderRangeSplitter::computeDelta(const Standard_Real /*theLengthU*/, const Standard_Real theLengthV) {
