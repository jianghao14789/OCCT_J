...
public:
    ...
    Standard_EXPORT BRepMesh_GeomTool(const BRepAdaptor_Curve& theCurve, const Standard_Real theFirstParam,
                                      const Standard_Real theLastParam, const Standard_Real theLinDeflection,
                                      const Standard_Real theAngDeflection, const Standard_Integer theMinPointsNb = 2,
    ...
    //! @param theAngDeflection angular deflection.
    //! @param theMinPointsNb minimum number of points to be produced.
    Standard_EXPORT BRepMesh_GeomTool(const Handle(BRepAdaptor_Surface) & theSurface, const GeomAbs_IsoType theIsoType,
    ...
    Standard_Integer AddPoint(const gp_Pnt& thePoint, const Standard_Real theParam,
    ...
    Standard_EXPORT Standard_Boolean Value(const Standard_Integer theIndex, const Standard_Real theIsoParam,
...
public: //! @name static API
    ...
    Standard_EXPORT static IntFlag IntLinLin(const gp_XY& theStartPnt1, const gp_XY& theEndPnt1,
                                             const gp_XY& theStartPnt2, const gp_XY& theEndPnt2, gp_XY& theIntPnt,
    ...
    //! @param[out] theIntPnt point of intersection.
    //! @return status of intersection check.
    Standard_EXPORT static IntFlag IntSegSeg(const gp_XY& theStartPnt1, const gp_XY& theEndPnt1,
                                             const gp_XY& theStartPnt2, const gp_XY& theEndPnt2,
                                             const Standard_Boolean isConsiderEndPointTouch,
                                             const Standard_Boolean isConsiderPointOnSegment, gp_Pnt2d& theIntPnt);

    //! Compute deflection of the given segment.
    static Standard_Real SquareDeflectionOfSegment(const gp_Pnt& theFirstPoint, const gp_Pnt& theLastPoint,
    ...
    Standard_EXPORT static std::pair<Standard_Integer, Standard_Integer>
    CellsCount(const Handle(Adaptor3d_Surface) & theSurface, const Standard_Integer theVerticesNb,
               const Standard_Real theDeflection, const BRepMesh_DefaultRangeSplitter* theRangeSplitter);
...
private:
    ...
    static Standard_Integer classifyPoint(const gp_XY& thePoint1, const gp_XY& thePoint2, const gp_XY& thePointToCheck);
