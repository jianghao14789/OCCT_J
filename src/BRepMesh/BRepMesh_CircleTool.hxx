...
public:
    ...
    Standard_EXPORT static Standard_Boolean MakeCircle(const gp_XY& thePoint1, const gp_XY& thePoint2,
                                                       const gp_XY& thePoint3, gp_XY& theLocation,
    ...
    //! @return FALSE in case of impossibility to build a circle
    //! on the given points, TRUE elsewhere.
    Standard_EXPORT Standard_Boolean Bind(const Standard_Integer theIndex, const gp_XY& thePoint1,
...
private:
    ...
    void bind(const Standard_Integer theIndex, const gp_XY& theLocation, const Standard_Real theRadius);
