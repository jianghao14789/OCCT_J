...
public: //! @name mesher API
    ...
    Standard_EXPORT BRepMesh_IncrementalMesh(const TopoDS_Shape& theShape, const Standard_Real theLinDeflection,
    ...
    Standard_EXPORT BRepMesh_IncrementalMesh(const TopoDS_Shape& theShape, const IMeshTools_Parameters& theParameters,
    ...
    void initParameters() {
        ...
        if (myParameters.MinSize < Precision::Confusion()) {
            myParameters.MinSize =
                Max(IMeshTools_Parameters::RelMinSize() * Min(myParameters.Deflection, myParameters.DeflectionInterior),
                    Precision::Confusion());
        }
...
public: //! @name plugin API
    ...
    Standard_EXPORT static Standard_Integer Discret(const TopoDS_Shape& theShape, const Standard_Real theLinDeflection,
