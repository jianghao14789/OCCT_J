...
private:
    ...
    TopoDS_Vertex getCommonVertex(const IMeshData::IEdgeHandle& theEdge1, const IMeshData::IEdgeHandle& theEdge2) const;
    ...
    Standard_Real closestPoint(gp_Pnt2d& theRefPnt, gp_Pnt2d& theFristPnt, gp_Pnt2d& theSecondPnt,
    ...
    //! Returns square distance between reference point and closest one as
    //! well as pointer to closest point.
    Standard_Real closestPoints(gp_Pnt2d& theFirstPnt1, gp_Pnt2d& theSecondPnt1, gp_Pnt2d& theFirstPnt2,
                                gp_Pnt2d& theSecondPnt2, gp_Pnt2d*& theClosestPnt1, gp_Pnt2d*& theClosestPnt2) const {
    ...
    void adjustSamePoints(gp_Pnt2d*& theMajorSamePnt1, gp_Pnt2d*& theMinorSamePnt1, gp_Pnt2d*& theMajorSamePnt2,
                          gp_Pnt2d*& theMinorSamePnt2, gp_Pnt2d& theMajorFirstPnt, gp_Pnt2d& theMajorLastPnt,
                          gp_Pnt2d& theMinorFirstPnt, gp_Pnt2d& theMinorLastPnt) const {
