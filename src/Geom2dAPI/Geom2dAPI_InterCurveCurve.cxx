...
Geom2dAPI_InterCurveCurve::Geom2dAPI_InterCurveCurve(const Handle(Geom2d_Curve) & C1, const Handle(Geom2d_Curve) & C2,
...
Geom2dAPI_InterCurveCurve::Geom2dAPI_InterCurveCurve(const Handle(Geom2d_Curve) & C1, const Standard_Real Tol) {
    Init(C1, Tol);
}
...
void Geom2dAPI_InterCurveCurve::Init(const Handle(Geom2d_Curve) & C1, const Handle(Geom2d_Curve) & C2,
                                     const Standard_Real Tol) {
...
gp_Pnt2d Geom2dAPI_InterCurveCurve::Point(const Standard_Integer Index) const {
    Standard_OutOfRange_Raise_if(Index < 0 || Index > NbPoints(), "Geom2dAPI_InterCurveCurve::Points");
...
void Geom2dAPI_InterCurveCurve::Segment(const Standard_Integer theIndex, Handle(Geom2d_Curve) & theCurve1,
                                        Handle(Geom2d_Curve) & theCurve2) const {
    Standard_OutOfRange_Raise_if(theIndex < 1 || theIndex > NbSegments(), "Geom2dAPI_InterCurveCurve::Segment");
