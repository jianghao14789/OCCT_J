...
Geom2dAPI_PointsToBSpline::Geom2dAPI_PointsToBSpline(const TColgp_Array1OfPnt2d& Points, const Standard_Integer DegMin,
...
Geom2dAPI_PointsToBSpline::Geom2dAPI_PointsToBSpline(const TColStd_Array1OfReal& YValues, const Standard_Real X0,
                                                     const Standard_Real DX, const Standard_Integer DegMin,
                                                     const Standard_Integer DegMax, const GeomAbs_Shape Continuity,
                                                     const Standard_Real Tol2D) {
...
Geom2dAPI_PointsToBSpline::Geom2dAPI_PointsToBSpline(const TColgp_Array1OfPnt2d& Points,
                                                     ...
                                                     const GeomAbs_Shape Continuity, const Standard_Real Tol2D) {
    myIsDone = Standard_False;
...
Geom2dAPI_PointsToBSpline::Geom2dAPI_PointsToBSpline(const TColgp_Array1OfPnt2d& Points,
                                                     const TColStd_Array1OfReal& Params, const Standard_Integer DegMin,
                                                     const Standard_Integer DegMax, const GeomAbs_Shape Continuity,
                                                     const Standard_Real Tol2D) {
    myIsDone = Standard_False;
...
Geom2dAPI_PointsToBSpline::Geom2dAPI_PointsToBSpline(const TColgp_Array1OfPnt2d& Points, const Standard_Real W1,
                                                     const Standard_Real W2, const Standard_Real W3,
                                                     const Standard_Integer DegMax, const GeomAbs_Shape Continuity,
                                                     const Standard_Real Tol2D) {
    myIsDone = Standard_False;
...
void Geom2dAPI_PointsToBSpline::Init(const TColgp_Array1OfPnt2d& Points, const Approx_ParametrizationType ParType,
                                     const Standard_Integer DegMin, const Standard_Integer DegMax,
                                     const GeomAbs_Shape Continuity, const Standard_Real Tol2D) {
    ...
    myCurve = new Geom2d_BSplineCurve(Poles, TheCurve.Knots(), TheCurve.Multiplicities(), TheCurve.Degree());
...
void Geom2dAPI_PointsToBSpline::Init(const TColStd_Array1OfReal& YValues, const Standard_Real X0,
                                     const Standard_Real DX, const Standard_Integer DegMin,
                                     const Standard_Integer DegMax, const GeomAbs_Shape Continuity,
                                     const Standard_Real Tol2D) {
    ...
    BSplCLib::IncreaseDegree(1, Degree, Standard_False, 1, TempPoles, TempKnots, TempMults, NewTempPoles, NewTempKnots,
                             NewTempMults);

    // insert the Knots
    BSplCLib::InsertKnots(Degree, Standard_False, 1, NewTempPoles, NewTempKnots, NewTempMults, TheCurve.Knots(),
                          &TheCurve.Multiplicities(), XPoles, Knots, Mults, Epsilon(1));
...
void Geom2dAPI_PointsToBSpline::Init(const TColgp_Array1OfPnt2d& Points, const Standard_Integer DegMin,
                                     const Standard_Integer DegMax, const GeomAbs_Shape Continuity,
                                     const Standard_Real Tol2D) {
    myIsDone = Standard_False;
...
void Geom2dAPI_PointsToBSpline::Init(const TColgp_Array1OfPnt2d& Points, const TColStd_Array1OfReal& Params,
                                     const Standard_Integer DegMin, const Standard_Integer DegMax,
                                     const GeomAbs_Shape Continuity, const Standard_Real Tol2D) {
    ...
    AppDef_BSplineCompute TheComputer(DegMin, DegMax, Tol3D, Tol2D, 0, Standard_True, Approx_IsoParametric,
                                      Standard_True);
...
void Geom2dAPI_PointsToBSpline::Init(const TColgp_Array1OfPnt2d& Points, const Standard_Real W1, const Standard_Real W2,
                                     const Standard_Real W3, const Standard_Integer DegMax,
                                     const GeomAbs_Shape Continuity, const Standard_Real Tol2D) {
    ...
    Handle(AppParCurves_HArray1OfConstraintCouple) TABofCC = new AppParCurves_HArray1OfConstraintCouple(1, NbPoint);
