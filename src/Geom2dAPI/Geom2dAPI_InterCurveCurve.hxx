...
public:
    ...
    Standard_EXPORT Geom2dAPI_InterCurveCurve(const Handle(Geom2d_Curve) & C1, const Handle(Geom2d_Curve) & C2,
    ...
    Standard_EXPORT void Init(const Handle(Geom2d_Curve) & C1, const Handle(Geom2d_Curve) & C2,
                              const Standard_Real Tol = 1.0e-6);
    ...
    Standard_EXPORT void Segment(const Standard_Integer Index, Handle(Geom2d_Curve) & Curve1,
