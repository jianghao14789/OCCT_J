...
// purpose  :
//=======================================================================
static Standard_Boolean CheckPoints(const TColgp_Array1OfPnt2d& PointArray, const Standard_Real Tolerance) {
    Standard_Integer ii;
...
// purpose  :
//=======================================================================
static Standard_Boolean CheckTangents(const TColgp_Array1OfVec2d& Tangents, const TColStd_Array1OfBoolean& TangentFlags,
...
// purpose  :
//=======================================================================
static void BuildParameters(const Standard_Boolean PeriodicFlag, const TColgp_Array1OfPnt2d& PointsArray,
...
static void BuildPeriodicTangent(const TColgp_Array1OfPnt2d& PointsArray, TColgp_Array1OfVec2d& TangentsArray,
                                 TColStd_Array1OfBoolean& TangentFlags, const TColStd_Array1OfReal& ParametersArray) {
    ...
    if (!TangentFlags.Value(1)) {
        ...
        PLib::EvalLagrange(ParametersArray.Value(1), 1, degree, 2, point_array[0], parameter_array[0],
                           eval_result[0][0]);
        for (ii = 1; ii <= 2; ii++) {
...
static void BuildTangents(const TColgp_Array1OfPnt2d& PointsArray, TColgp_Array1OfVec2d& TangentsArray,
                          TColStd_Array1OfBoolean& TangentFlags, const TColStd_Array1OfReal& ParametersArray) {
    Standard_Integer ii, degree;
    ...
    if (!TangentFlags.Value(TangentFlags.Upper())) {
        ...
        PLib::EvalLagrange(ParametersArray.Value(ParametersArray.Upper()), 1, degree, 2, point_array[0],
...
//
//=======================================================================
static void ScaleTangents(const TColgp_Array1OfPnt2d& PointsArray, TColgp_Array1OfVec2d& TangentsArray,
                          const TColStd_Array1OfBoolean& TangentFlags, const TColStd_Array1OfReal& ParametersArray) {
    ...
    for (ii = TangentFlags.Lower(); ii <= TangentFlags.Upper(); ii++) {
        if (TangentFlags.Value(ii)) {
            ...
            PLib::EvalLagrange(ParametersArray.Value(ii), 1, degree, 2, point_array[0], parameter_array[0],
                               eval_result[0][0]);
...
Geom2dAPI_Interpolate::Geom2dAPI_Interpolate(const Handle(TColgp_HArray1OfPnt2d) & PointsPtr,
                                             const Standard_Boolean PeriodicFlag, const Standard_Real Tolerance)
    : myTolerance(Tolerance), myPoints(PointsPtr), myIsDone(Standard_False), myPeriodic(PeriodicFlag),
...
Geom2dAPI_Interpolate::Geom2dAPI_Interpolate(const Handle(TColgp_HArray1OfPnt2d) & PointsPtr,
                                             ...
                                             const Standard_Boolean PeriodicFlag, const Standard_Real Tolerance)
    : myTolerance(Tolerance), myPoints(PointsPtr), myIsDone(Standard_False), myParameters(ParametersPtr),
      myPeriodic(PeriodicFlag), myTangentRequest(Standard_False) {
    Standard_Integer ii;
...
void Geom2dAPI_Interpolate::Load(const TColgp_Array1OfVec2d& Tangents,
                                 const Handle(TColStd_HArray1OfBoolean) & TangentFlagsPtr, const Standard_Boolean Scale)

{
    ...
    if (result) {
        ...
        if (Scale) {
            ScaleTangents(myPoints->Array1(), myTangents->ChangeArray1(), TangentFlagsPtr->Array1(),
                          myParameters->Array1());
        }
    } else {
        throw Standard_ConstructionError();
...
void Geom2dAPI_Interpolate::Load(const gp_Vec2d& InitialTangent, const gp_Vec2d& FinalTangent,
    ...
    if (Scale) {
        ScaleTangents(myPoints->Array1(), myTangents->ChangeArray1(), myTangentFlags->Array1(), myParameters->Array1());
    }
}
//=======================================================================
// function : Perform
...
void Geom2dAPI_Interpolate::PerformPeriodic() {
    ...
    if (num_points == 2 && !myTangentRequest) {
        ...
        myCurve = new Geom2d_BSplineCurve(myPoints->Array1(), myParameters->Array1(), deg1_mults, degree, myPeriodic);
        ...
        if (num_points >= 3) {
            ...
            //
            BuildPeriodicTangent(myPoints->Array1(), myTangents->ChangeArray1(), myTangentFlags->ChangeArray1(),
                                 myParameters->Array1());
        }
        ...
        BSplCLib::Interpolate(degree, flatknots, parameters, contact_order_array, poles, inversion_problem);
        if (!inversion_problem) {
            TColgp_Array1OfPnt2d newpoles(poles.Value(1), 1, num_poles - 2);
            myCurve = new Geom2d_BSplineCurve(newpoles, myParameters->Array1(), mults, degree, myPeriodic);
            myIsDone = Standard_True;
        }
    }
}
...
void Geom2dAPI_Interpolate::PerformNonPeriodic() {
    Standard_Integer degree, ii, jj, index, index1, index2, index3, mult_index, inversion_problem, num_points,
    ...
    switch (degree) {
        ...
        case 2:
            ...
            BSplCLib::Interpolate(degree, flatknots, myParameters->Array1(), contact_order_array, poles,
                                  inversion_problem);
            if (!inversion_problem) {
        ...
        case 3:
            ...
            if (num_points >= 3) {
                ...
                //
                BuildTangents(myPoints->Array1(), myTangents->ChangeArray1(), myTangentFlags->ChangeArray1(),
                              myParameters->Array1());
            }
            contact_order_array.SetValue(2, 1);
            parameters.SetValue(1, myParameters->Value(1));
