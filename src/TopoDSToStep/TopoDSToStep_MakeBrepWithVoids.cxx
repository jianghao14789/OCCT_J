...
TopoDSToStep_MakeBrepWithVoids::TopoDSToStep_MakeBrepWithVoids(const TopoDS_Solid& aSolid,
    ...
    if (!aOutShell.IsNull()) {
        ...
        for (It.Initialize(aSolid); It.More() && aPS.More(); It.Next()) {
            if (It.Value().ShapeType() == TopAbs_SHELL) {
                ...
                if (!aOutShell.IsEqual(
                        CurrentShell)) //: e0 abv 25 Mar 98: voids should be reversed according to EXPRESS for ABSR
