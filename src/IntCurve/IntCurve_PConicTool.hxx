...
public:
    ...
    Standard_EXPORT static Standard_Integer NbSamples(const IntCurve_PConic& C, const Standard_Real U0,
    ...
    Standard_EXPORT static void D2(const IntCurve_PConic& C, const Standard_Real U, gp_Pnt2d& P, gp_Vec2d& T,
                                   gp_Vec2d& N);
