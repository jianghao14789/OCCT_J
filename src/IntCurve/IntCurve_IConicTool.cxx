...
//======================================================================
IntCurve_IConicTool::IntCurve_IConicTool(void) : prm1(0.0), prm2(0.0), prm3(0.0), type(GeomAbs_OtherCurve) {
...
//======================================================================
//======================================================================
IntCurve_IConicTool::IntCurve_IConicTool(const gp_Lin2d& Line) : prm1(0.0), prm2(0.0), prm3(0.0) {
    Line.Coefficients(Line_a, Line_b, Line_c);
    Axis = gp_Ax22d(Line.Position(), Standard_True);
    type = GeomAbs_Line;
}
//======================================================================
IntCurve_IConicTool::IntCurve_IConicTool(const gp_Elips2d& Elips) : prm1(0.0), prm2(0.0), prm3(0.0) {
...
//======================================================================
IntCurve_IConicTool::IntCurve_IConicTool(const gp_Circ2d& C) : prm1(0.0), prm2(0.0), prm3(0.0) {
    Circle_r = C.Radius();
    Axis = C.Axis();
...
//======================================================================
IntCurve_IConicTool::IntCurve_IConicTool(const gp_Parab2d& P) : prm1(0.0), prm2(0.0), prm3(0.0) {
    Parab_f = P.Focal();
...
//======================================================================
IntCurve_IConicTool::IntCurve_IConicTool(const gp_Hypr2d& H) : prm1(0.0), prm2(0.0), prm3(0.0) {
...
//----------------------------------------------------------------------
void IntCurve_IConicTool::D2(const Standard_Real X, gp_Pnt2d& Pt, gp_Vec2d& Tan, gp_Vec2d& Norm) const {
...
Standard_Real IntCurve_IConicTool::Distance(const gp_Pnt2d& ThePoint) const {
    ...
    switch (type) {
        ...
        case GeomAbs_Ellipse: {
            ...
            return (sqrt(y2 + (x + Elips_c) * (x + Elips_c)) + sqrt(y2 + (x - Elips_c) * (x - Elips_c)) - Elips_a -
                    Elips_a);
#else
            gp_Pnt2d P = ThePoint;
            P.Transform(Abs_To_Object);
