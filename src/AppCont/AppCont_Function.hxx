...
public:
    ...
    virtual Standard_Boolean Value(const Standard_Real theU, NCollection_Array1<gp_Pnt2d>& thePnt2d,
                                   NCollection_Array1<gp_Pnt>& thePnt) const = 0;

    //! Returns the derivative at parameter <theU>.
    virtual Standard_Boolean D1(const Standard_Real theU, NCollection_Array1<gp_Vec2d>& theVec2d,
    ...
    virtual void PeriodInformation(const Standard_Integer /*theDimIdx*/, Standard_Boolean& IsPeriodic,
