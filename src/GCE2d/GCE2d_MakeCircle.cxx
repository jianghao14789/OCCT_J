...
GCE2d_MakeCircle::GCE2d_MakeCircle(const gp_Ax2d& A, const Standard_Real Radius, const Standard_Boolean Sense) {
    if (Radius < 0.0) {
...
GCE2d_MakeCircle::GCE2d_MakeCircle(const gp_Pnt2d& Point, const Standard_Real Radius, const Standard_Boolean Sense) {
...
GCE2d_MakeCircle::GCE2d_MakeCircle(const gp_Pnt2d& Center, const gp_Pnt2d& Point, const Standard_Boolean Sense) {
