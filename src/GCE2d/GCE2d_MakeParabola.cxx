...
GCE2d_MakeParabola::GCE2d_MakeParabola(const gp_Ax2d& MirrorAxis, const Standard_Real Focal,
...
GCE2d_MakeParabola::GCE2d_MakeParabola(const gp_Ax2d& D, const gp_Pnt2d& F, const Standard_Boolean Sense) {
    TheError = gce_Done;
