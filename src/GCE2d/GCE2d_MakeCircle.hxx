...
public:
    ...
    Standard_EXPORT GCE2d_MakeCircle(const gp_Ax2d& A, const Standard_Real Radius,
    ...
    Standard_EXPORT GCE2d_MakeCircle(const gp_Pnt2d& P, const Standard_Real Radius,
                                     const Standard_Boolean Sense = Standard_True);
    ...
    Standard_EXPORT GCE2d_MakeCircle(const gp_Pnt2d& Center, const gp_Pnt2d& Point,
                                     const Standard_Boolean Sense = Standard_True);
