...
GCE2d_MakeArcOfCircle::GCE2d_MakeArcOfCircle(const gp_Pnt2d& P1, const gp_Pnt2d& P2, const gp_Pnt2d& P3) {
...
GCE2d_MakeArcOfCircle::GCE2d_MakeArcOfCircle(const gp_Pnt2d& P1, const gp_Vec2d& V, const gp_Pnt2d& P2) {
    Standard_Boolean Sense;
    gp_Circ2d cir;
    gp_Lin2d corde = gce_MakeLin2d(P1, P2);
    gp_Dir2d dir(corde.Direction());
    gp_Lin2d bis(gp_Pnt2d((P1.X() + P2.X()) / 2., (P1.Y() + P2.Y()) / 2.), gp_Dir2d(-dir.Y(), dir.X()));
...
GCE2d_MakeArcOfCircle::GCE2d_MakeArcOfCircle(const gp_Circ2d& Circ, const gp_Pnt2d& P1, const gp_Pnt2d& P2,
...
GCE2d_MakeArcOfCircle::GCE2d_MakeArcOfCircle(const gp_Circ2d& Circ, const gp_Pnt2d& P, const Standard_Real Alpha,
                                             const Standard_Boolean Sense) {
...
GCE2d_MakeArcOfCircle::GCE2d_MakeArcOfCircle(const gp_Circ2d& Circ, const Standard_Real Alpha1,
                                             const Standard_Real Alpha2, const Standard_Boolean Sense) {
    Handle(Geom2d_Circle) C = new Geom2d_Circle(Circ);
    TheArc = new Geom2d_TrimmedCurve(C, Alpha1, Alpha2, Sense);
    TheError = gce_Done;
}
