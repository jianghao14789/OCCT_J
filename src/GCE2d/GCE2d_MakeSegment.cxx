...
GCE2d_MakeSegment::GCE2d_MakeSegment(const gp_Lin2d& Line, const gp_Pnt2d& Point, const Standard_Real U) {
...
GCE2d_MakeSegment::GCE2d_MakeSegment(const gp_Lin2d& Line, const Standard_Real U1, const Standard_Real U2) {
    Handle(Geom2d_Line) L = new Geom2d_Line(Line);
