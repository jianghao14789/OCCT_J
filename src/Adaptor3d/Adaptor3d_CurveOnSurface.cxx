    ...
    gp_Pnt2d& LeftBot, gp_Pnt2d& RightTop)
{
    ...
    else//*********if Coord != Knot
    {
        ...
        if (i != Up) {
            if (Abs(DComp1) < Tol)
            {
                if (Index == 1) { LeftBot.SetX(f); RightTop.SetX(l); }
                else
                ...
                {
                    if (Index == 1) {
                        if (DComp1 > 0) { LeftBot.SetX(Comp1); RightTop.SetX(l); }
                        else
                            if (DComp1 < 0) { LeftBot.SetX(f); RightTop.SetX(Comp1); }
                    }
                    else
                        if (Index == 2) {
                            if (DComp1 > 0) { LeftBot.SetY(Comp1); RightTop.SetY(l); }
                            else
            ...
            if (i == Up) {
                if (Index == 1) { LeftBot.SetX(Comp1); RightTop.SetX(BSplC->Knot(i)); }
                else
