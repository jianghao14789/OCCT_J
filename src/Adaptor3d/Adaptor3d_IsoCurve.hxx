...
public:
    ...
    //! of the surface.
    Standard_EXPORT Adaptor3d_IsoCurve(const Handle(Adaptor3d_Surface) & S, const GeomAbs_IsoType Iso,
    ...
    Standard_EXPORT Adaptor3d_IsoCurve(const Handle(Adaptor3d_Surface) & S, const GeomAbs_IsoType Iso,
                                       const Standard_Real Param, const Standard_Real WFirst,
    ...
    //! Changes the iso on the current surface.
    Standard_EXPORT void Load(const GeomAbs_IsoType Iso, const Standard_Real Param, const Standard_Real WFirst,
                              const Standard_Real WLast);
