...
public:
    ...
    Standard_EXPORT ProjLib_PrjResolve(const Adaptor3d_Curve& C, const Adaptor3d_Surface& S,
    ...
    Standard_EXPORT void Perform(const Standard_Real t, const Standard_Real U, const Standard_Real V,
                                 const gp_Pnt2d& Tol, const gp_Pnt2d& Inf, const gp_Pnt2d& Sup,
                                 const Standard_Real FTol = -1, const Standard_Boolean StrictInside = Standard_False);
