...
void StepAP203_CcDesignDateAndTimeAssignment::Init(const Handle(StepBasic_DateAndTime) &
    ...
    StepBasic_DateAndTimeAssignment::Init(aDateAndTimeAssignment_AssignedDateAndTime, aDateAndTimeAssignment_Role);
