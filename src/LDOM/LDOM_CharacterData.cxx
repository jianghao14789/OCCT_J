...
LDOM_CharacterData::LDOM_CharacterData(const LDOM_BasicText& aText, const Handle(LDOM_MemManager) & aDoc)
...
Standard_Integer LDOM_CharacterData::getLength() const {
    if (myLength < 0) (Standard_Integer&)myLength = (Standard_Integer)strlen(getNodeValue().GetString());
    return myLength;
}
