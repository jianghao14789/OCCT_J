...
LDOM_BasicAttribute::LDOM_BasicAttribute(const LDOM_Attr& anAttr)
    : LDOM_BasicNode(anAttr.Origin()), myName(anAttr.getName().GetString()), myValue(anAttr.getValue()) {}
...
LDOM_BasicAttribute& LDOM_BasicAttribute::Create(const LDOMBasicString& theName, const Handle(LDOM_MemManager) & theDoc,
