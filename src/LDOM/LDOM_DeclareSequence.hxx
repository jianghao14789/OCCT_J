    ...
    private:                                                                                                           \
        ...
        private:                                                                                                       \
            ...
            Node* myNext;                                                                                              \
                                                                                                                       \
        public:                                                                                                        \
            Node(const Type& aValue, Node* aPrv, Node* aNxt) : myValue(aValue), myPrev(aPrv), myNext(aNxt) {}          \
        ...
        Standard_Integer myLength;                                                                                     \
                                                                                                                       ...
                                                                                                                       \
    inline ClassName::ClassName() : myFirst(NULL), myLast(NULL), myCurrent(NULL), myICur(0), myLength(0) {}            \
                                                                                                                       \
    inline ClassName::ClassName(const ClassName& anOther) : myFirst(NULL) {                                            \
        Assign(anOther);                                                                                               \
    }                                                                                                                  \
                                                                                                                       \
