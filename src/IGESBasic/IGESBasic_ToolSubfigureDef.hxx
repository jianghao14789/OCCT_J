...
public:
    ...
    Standard_EXPORT void OwnCheck(const Handle(IGESBasic_SubfigureDef) & ent, const Interface_ShareTool& shares,
                                  Handle(Interface_Check) & ach) const;

    //! Copies Specific Parameters
    Standard_EXPORT void OwnCopy(const Handle(IGESBasic_SubfigureDef) & entfrom,
                                 const Handle(IGESBasic_SubfigureDef) & entto, Interface_CopyTool& TC) const;

    //! Dump of Specific Parameters
    Standard_EXPORT void OwnDump(const Handle(IGESBasic_SubfigureDef) & ent, const IGESData_IGESDumper& dumper,
