...
Standard_Boolean IGESBasic_ToolOrderedGroup::OwnCorrect(const Handle(IGESBasic_OrderedGroup) & ent) const {
...
IGESData_DirChecker IGESBasic_ToolOrderedGroup::DirChecker(const Handle(IGESBasic_OrderedGroup) & /* ent */) const {
...
void IGESBasic_ToolOrderedGroup::OwnCheck(const Handle(IGESBasic_OrderedGroup) & ent, const Interface_ShareTool&,
...
void IGESBasic_ToolOrderedGroup::OwnDump(const Handle(IGESBasic_OrderedGroup) & ent, const IGESData_IGESDumper& dumper,
