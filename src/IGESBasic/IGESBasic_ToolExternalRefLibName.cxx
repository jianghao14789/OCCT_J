...
void IGESBasic_ToolExternalRefLibName::OwnCopy(const Handle(IGESBasic_ExternalRefLibName) & another,
    ...
    Handle(TCollection_HAsciiString) tempLibName = new TCollection_HAsciiString(another->LibraryName());
...
IGESData_DirChecker
IGESBasic_ToolExternalRefLibName::DirChecker(const Handle(IGESBasic_ExternalRefLibName) & /* ent */) const {
