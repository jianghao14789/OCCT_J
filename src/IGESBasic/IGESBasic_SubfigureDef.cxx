...
void IGESBasic_SubfigureDef::Init(const Standard_Integer aDepth, const Handle(TCollection_HAsciiString) & aName,
...
Handle(IGESData_IGESEntity) IGESBasic_SubfigureDef::AssociatedEntity(const Standard_Integer Index) const {
