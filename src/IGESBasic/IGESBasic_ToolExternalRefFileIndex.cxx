...
void IGESBasic_ToolExternalRefFileIndex::ReadOwnParams(const Handle(IGESBasic_ExternalRefFileIndex) & ent,
...
void IGESBasic_ToolExternalRefFileIndex::WriteOwnParams(const Handle(IGESBasic_ExternalRefFileIndex) & ent,
...
void IGESBasic_ToolExternalRefFileIndex::OwnShared(const Handle(IGESBasic_ExternalRefFileIndex) & ent,
...
void IGESBasic_ToolExternalRefFileIndex::OwnCopy(const Handle(IGESBasic_ExternalRefFileIndex) & another,
...
IGESData_DirChecker
IGESBasic_ToolExternalRefFileIndex::DirChecker(const Handle(IGESBasic_ExternalRefFileIndex) & /* ent */) const {
...
void IGESBasic_ToolExternalRefFileIndex::OwnCheck(const Handle(IGESBasic_ExternalRefFileIndex) & /* ent */,
