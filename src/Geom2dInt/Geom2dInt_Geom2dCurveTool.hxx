...
public:
    ...
    Standard_EXPORT static Standard_Integer NbSamples(const Adaptor2d_Curve2d& C, const Standard_Real U0,
    ...
    static void D3(const Adaptor2d_Curve2d& C, const Standard_Real U, gp_Pnt2d& P, gp_Vec2d& T, gp_Vec2d& N,
                   gp_Vec2d& V);
    ...
    static void GetInterval(const Adaptor2d_Curve2d& C, const Standard_Integer Index, const TColStd_Array1OfReal& Tab,
