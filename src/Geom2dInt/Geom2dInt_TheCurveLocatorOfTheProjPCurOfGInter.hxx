...
public:
    ...
    Standard_EXPORT static void Locate(const gp_Pnt2d& P, const Adaptor2d_Curve2d& C, const Standard_Integer NbU,
    ...
    Standard_EXPORT static void Locate(const gp_Pnt2d& P, const Adaptor2d_Curve2d& C, const Standard_Integer NbU,
                                       const Standard_Real Umin, const Standard_Real Usup, Extrema_POnCurv2d& Papp);
    ...
    Standard_EXPORT static void Locate(const Adaptor2d_Curve2d& C1, const Adaptor2d_Curve2d& C2,
                                       const Standard_Integer NbU, const Standard_Integer NbV, Extrema_POnCurv2d& Papp1,
