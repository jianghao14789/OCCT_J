...
public:
    ...
    //! Thus all entities returned by GetConnected() share the same location propagated from corresponding selectable
    //! object. You must redefine this function for any type of sensitive entity which can accept another connected
    //! sensitive entity.
    ...
    virtual Standard_Boolean ToBuildBVH() const {
        return Standard_True;
    }

    //! Clears up all resources and memory
    virtual void Clear() {
        Set(Handle(SelectMgr_EntityOwner)());
    }
...
Standard_DEPRECATED(
    "Deprecated alias - Select3D_SensitiveEntity should be used instead") typedef Select3D_SensitiveEntity
