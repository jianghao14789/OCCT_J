...
public:
    ...
    Standard_EXPORT Select3D_SensitiveTriangulation(const Handle(SelectMgr_EntityOwner) & theOwnerId,
                                                    ...
                                                    const gp_Pnt& theCOG, const Standard_Boolean theIsInterior);
...
public:
    ...
    //! @return TRUE if defined
    Standard_EXPORT bool LastDetectedTriangle(Poly_Triangle& theTriangle, gp_Pnt theTriNodes[3]) const;
