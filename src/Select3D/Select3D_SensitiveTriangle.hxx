...
public:
    ...
    Standard_EXPORT Select3D_SensitiveTriangle(const Handle(SelectMgr_EntityOwner) & theOwnerId, const gp_Pnt& thePnt0,
                                               const gp_Pnt& thePnt1, const gp_Pnt& thePnt2,
