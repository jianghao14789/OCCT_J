...
public:
    ...
    Standard_EXPORT Select3D_SensitiveBox(const Handle(SelectMgr_EntityOwner) & theOwnerId, const Standard_Real theXMin,
                                          const Standard_Real theYMin, const Standard_Real theZMin,
                                          const Standard_Real theXMax, const Standard_Real theYMax,
