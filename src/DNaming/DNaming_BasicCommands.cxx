...
static Standard_Integer DNaming_ImportShape(Draw_Interpretor& di, Standard_Integer nb, const char** a) {
    if (nb >= 4) {
        Handle(TDF_Data) aDF;
...
static Standard_Integer CheckIter(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb > 3) {
        Handle(TDF_Data) aDF;
