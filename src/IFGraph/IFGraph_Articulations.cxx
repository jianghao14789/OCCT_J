...
IFGraph_Articulations::IFGraph_Articulations(const Interface_Graph& agraph, const Standard_Boolean whole)
    : thegraph(agraph) {
...
Standard_Integer IFGraph_Articulations::Visit(const Standard_Integer num) {
    ...
    for (Interface_EntityIterator iter = thegraph.Shareds(thegraph.Entity(num)); iter.More(); iter.Next()) {
