...
static Standard_Integer BuildNamedShape(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb >= 4) {
        ...
        di << "Usage: BuildName df entry evolution(P[RIMITIVE] G[ENERATED] M[ODIFY] D[ELETE] R[EPLACE] S[ELECTED]) "
              "[shape1 shape2 ...]\n";
        return 1;
    }
    return 0;
...
void QADNaming::BuilderCommands(Draw_Interpretor& theCommands) {
    ...
    theCommands.Add("BuildNamedShape",
                    "BuildNamedShape df entry evolution(P[RIMITIVE] G[ENERATED] M[ODIFY] D[ELETE] R[EPLACE] "
