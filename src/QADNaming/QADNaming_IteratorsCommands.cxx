...
static int GetAllNew(const TopoDS_Shape& theShape, const TDF_Label& theAccess, const TCollection_AsciiString& theName,
...
static int GetAllOld(const TopoDS_Shape& theShape, const TDF_Label& theAccess, const TCollection_AsciiString& theName,
                     Standard_Integer theIndex) {
    TCollection_AsciiString aName;
