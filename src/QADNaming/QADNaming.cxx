...
// purpose  :
//=======================================================================
void QADNaming::GetShape(const Standard_CString LabelName, const Handle(TDF_Data) & DF, TopTools_ListOfShape& L) {
    L.Clear();
    TDF_Label Label;
...
TopoDS_Shape QADNaming::CurrentShape(const Standard_CString LabelName, const Handle(TDF_Data) & DF) {
    ...
    if (Found) {
        ...
        if (S.IsNull()) std::cout << "current shape from " << LabelName << " is deleted" << std::endl;
        return S;
    }
    return S;
}
...
TCollection_AsciiString QADNaming::GetEntry(const TopoDS_Shape& Shape, const Handle(TDF_Data) & DF,
...
//=======================================================================
static Standard_Integer QADNaming_IsSameShapes(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 3) {
...
//=======================================================================
static Standard_Integer QADNaming_CenterOfShape(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 2) {
...
void QADNaming::AllCommands(Draw_Interpretor& theCommands) {
    ...
    theCommands.Add("IsSameShapes", "IsSameShapes DrawShape1 DrawShape2", __FILE__, QADNaming_IsSameShapes,
                    "Auxiliary methods");
