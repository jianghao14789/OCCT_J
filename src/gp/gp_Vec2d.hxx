...
public:
    ...
    gp_Vec2d(const gp_XY& theCoord) : coord(theCoord) {}

    //! Creates a point with its two Cartesian coordinates.
    gp_Vec2d(const Standard_Real theXv, const Standard_Real theYv) : coord(theXv, theYv) {}
    ...
    Standard_EXPORT Standard_Boolean IsEqual(const gp_Vec2d& theOther, const Standard_Real theLinearTolerance,
    ...
    Standard_NODISCARD gp_Vec2d operator+(const gp_Vec2d& theOther) const {
    ...
    void SetLinearForm(const Standard_Real theA1, const gp_Vec2d& theV1, const Standard_Real theA2,
                       const gp_Vec2d& theV2, const gp_Vec2d& theV3) {
