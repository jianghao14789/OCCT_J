...
public:
    ...
    gp_Hypr() : majorRadius(RealLast()), minorRadius(RealFirst()) {}
    ...
    gp_Hypr(const gp_Ax2& theA2, const Standard_Real theMajorRadius, const Standard_Real theMinorRadius)
        : pos(theA2), majorRadius(theMajorRadius), minorRadius(theMinorRadius) {
    ...
    void SetLocation(const gp_Pnt& theP) {
        pos = gp_Ax2(theP, pos.Direction(), pos.XDirection());
    }
    ...
    Standard_Real Parameter() const {
        Standard_DomainError_Raise_if(majorRadius <= gp::Resolution(), "gp_Hypr::Parameter() - major radius is zero");
