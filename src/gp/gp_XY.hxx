...
public:
    ...
    gp_XY(const Standard_Real theX, const Standard_Real theY) : x(theX), y(theY) {}
    ...
    Standard_NODISCARD gp_XY operator+(const gp_XY& theOther) const {
    ...
    inline void SetLinearForm(const Standard_Real theA1, const gp_XY& theXY1, const Standard_Real theA2,
                              const gp_XY& theXY2) {
    ...
    inline void SetLinearForm(const Standard_Real theA1, const gp_XY& theXY1, const Standard_Real theA2,
                              const gp_XY& theXY2, const gp_XY& theXY3) {
