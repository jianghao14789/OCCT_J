...
public:
    ...
    gp_Ax2d(const gp_Pnt2d& theP, const gp_Dir2d& theV) : loc(theP), vdir(theV) {}
    ...
    Standard_EXPORT Standard_Boolean IsCoaxial(const gp_Ax2d& Other, const Standard_Real AngularTolerance,
