...
Standard_Boolean gp_Vec2d::IsEqual(const gp_Vec2d& Other, const Standard_Real LinearTolerance,
...
Standard_Real gp_Vec2d::Angle(const gp_Vec2d& Other) const {
    ...
    const Standard_Real theNorm = Magnitude();
    const Standard_Real theOtherNorm = Other.Magnitude();
    if (theNorm <= gp::Resolution() || theOtherNorm <= gp::Resolution()) throw gp_VectorWithNullMagnitude();
