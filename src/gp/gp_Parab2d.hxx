...
public:
    ...
    gp_Parab2d() : focalLength(RealLast()) {}
    ...
    gp_Parab2d(const gp_Ax2d& theMirrorAxis, const Standard_Real theFocalLength,
    ...
    gp_Parab2d(const gp_Ax22d& theAxes, const Standard_Real theFocalLength)
        : pos(theAxes), focalLength(theFocalLength) {
        Standard_ConstructionError_Raise_if(theFocalLength < 0.0, "gp_Parab2d() - focal length should be >= 0");
    }
    ...
    Standard_EXPORT gp_Parab2d(const gp_Ax2d& theDirectrix, const gp_Pnt2d& theFocus,
                               const Standard_Boolean theSense = Standard_True);
