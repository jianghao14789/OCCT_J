...
public:
    ...
    Standard_EXPORT Geom2dHatch_Hatcher(const Geom2dHatch_Intersector& Intersector, const Standard_Real Confusion2d,
    ...
    Standard_EXPORT Standard_Integer AddElement(const Geom2dAdaptor_Curve& Curve,
