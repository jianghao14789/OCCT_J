...
Geom2dHatch_Hatching::Geom2dHatch_Hatching()
    : myTrimDone(Standard_False), myTrimFailed(Standard_False), myIsDone(Standard_False), myStatus(HatchGen_NoProblem) {
}
...
Geom2dHatch_Hatching::Geom2dHatch_Hatching(const Geom2dAdaptor_Curve& Curve)
    : myCurve(Curve), myTrimDone(Standard_False), myTrimFailed(Standard_False), myIsDone(Standard_False),
...
void Geom2dHatch_Hatching::AddPoint(const HatchGen_PointOnHatching& Point, const Standard_Real Confusion) {
