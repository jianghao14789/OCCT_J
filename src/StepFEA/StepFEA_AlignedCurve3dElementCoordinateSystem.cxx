...
void StepFEA_AlignedCurve3dElementCoordinateSystem::Init(const Handle(TCollection_HAsciiString) &
...
void StepFEA_AlignedCurve3dElementCoordinateSystem::SetCoordinateSystem(const Handle(StepFEA_FeaAxis2Placement3d) &
                                                                        aCoordinateSystem) {
    theCoordinateSystem = aCoordinateSystem;
}
