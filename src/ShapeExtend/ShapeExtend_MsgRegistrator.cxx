...
void ShapeExtend_MsgRegistrator::Send(const Handle(Standard_Transient) & object, const Message_Msg& message,
...
void ShapeExtend_MsgRegistrator::Send(const TopoDS_Shape& shape, const Message_Msg& message, const Message_Gravity) {
    if (shape.IsNull()) {
#ifdef OCCT_DEBUG
