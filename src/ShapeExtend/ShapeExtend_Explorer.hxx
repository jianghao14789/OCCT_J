...
public:
    ...
    Standard_EXPORT Handle(TopTools_HSequenceOfShape)
        SeqFromCompound(const TopoDS_Shape& comp, const Standard_Boolean expcomp) const;
    ...
    Standard_EXPORT void ListFromSeq(const Handle(TopTools_HSequenceOfShape) & seqval, TopTools_ListOfShape& lisval,
    ...
    Standard_EXPORT TopoDS_Shape SortedCompound(const TopoDS_Shape& shape, const TopAbs_ShapeEnum type,
    ...
    DispatchList(const Handle(TopTools_HSequenceOfShape) & list, Handle(TopTools_HSequenceOfShape) & vertices,
