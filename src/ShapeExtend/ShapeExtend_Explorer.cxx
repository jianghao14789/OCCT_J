...
static void FillList(const Handle(TopTools_HSequenceOfShape) & list, const TopoDS_Shape& comp,
...
void ShapeExtend_Explorer::ListFromSeq(const Handle(TopTools_HSequenceOfShape) & seqval, TopTools_ListOfShape& lisval,
...
TopAbs_ShapeEnum ShapeExtend_Explorer::ShapeType(const TopoDS_Shape& shape, const Standard_Boolean compound) const {
...
TopoDS_Shape ShapeExtend_Explorer::SortedCompound(const TopoDS_Shape& shape, const TopAbs_ShapeEnum type,
...
void ShapeExtend_Explorer::DispatchList(
    const Handle(TopTools_HSequenceOfShape) & list, Handle(TopTools_HSequenceOfShape) & vertices,
    Handle(TopTools_HSequenceOfShape) & edges, Handle(TopTools_HSequenceOfShape) & wires,
    Handle(TopTools_HSequenceOfShape) & faces, Handle(TopTools_HSequenceOfShape) & shells,
    Handle(TopTools_HSequenceOfShape) & solids, Handle(TopTools_HSequenceOfShape) & compsols,
