...
Geom_Ellipse::Geom_Ellipse(const gp_Elips& E) : majorRadius(E.MajorRadius()), minorRadius(E.MinorRadius()) {
    pos = E.Position();
}
...
Geom_Ellipse::Geom_Ellipse(const Ax2& A, const Standard_Real MajorRadius, const Standard_Real MinorRadius)
