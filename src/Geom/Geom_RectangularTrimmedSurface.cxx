...
Handle(Geom_Geometry) Geom_RectangularTrimmedSurface::Copy() const {
    ...
    if (isutrimmed && isvtrimmed)
        S = new RectangularTrimmedSurface(basisSurf, utrim1, utrim2, vtrim1, vtrim2, Standard_True, Standard_True);
    else if (isutrimmed)
...
Geom_RectangularTrimmedSurface::Geom_RectangularTrimmedSurface(
    ...
    const Handle(Geom_Surface) & S, const Standard_Real U1, const Standard_Real U2, const Standard_Real V1,
    const Standard_Real V2, const Standard_Boolean USense, const Standard_Boolean VSense)

    : utrim1(U1), vtrim1(V1), utrim2(U2), vtrim2(V2), isutrimmed(Standard_True), isvtrimmed(Standard_True) {
...
Geom_RectangularTrimmedSurface::Geom_RectangularTrimmedSurface(
    ...
    const Handle(Geom_Surface) & S, const Standard_Real Param1, const Standard_Real Param2,
    const Standard_Boolean UTrim, const Standard_Boolean Sense) {
    // kill trimmed basis surfaces
    Handle(Geom_RectangularTrimmedSurface) T = Handle(Geom_RectangularTrimmedSurface)::DownCast(S);
    if (!T.IsNull())
        basisSurf = Handle(Geom_Surface)::DownCast(T->BasisSurface()->Copy());
...
void Geom_RectangularTrimmedSurface::SetTrim(const Standard_Real U1, const Standard_Real U2, const Standard_Real V1,
                                             const Standard_Real V2, const Standard_Boolean USense,
...
void Geom_RectangularTrimmedSurface::SetTrim(const Standard_Real Param1, const Standard_Real Param2,
                                             const Standard_Boolean UTrim, const Standard_Boolean Sense) {
...
void Geom_RectangularTrimmedSurface::SetTrim(const Standard_Real U1, const Standard_Real U2, const Standard_Real V1,
                                             const Standard_Real V2, const Standard_Boolean UTrim,
                                             const Standard_Boolean VTrim, const Standard_Boolean USense,
                                             const Standard_Boolean VSense) {
    ...
    if (!UTrim) {
        ...
        if (U1 == U2) throw Standard_ConstructionError("Geom_RectangularTrimmedSurface::U1==U2");
    ...
    if (!VTrim) {
        ...
        if (V1 == V2) throw Standard_ConstructionError("Geom_RectangularTrimmedSurface::V1==V2");
        ...
        if (basisSurf->IsVPeriodic()) {
            ...
            vtrim1 = V1;
            vtrim2 = V2;
            ElCLib::AdjustPeriodic(Vdeb, Vfin, Min(Abs(vtrim2 - vtrim1) / 2, Precision::PConfusion()), vtrim1, vtrim2);
        } else {
            if (V1 < V2) {
                VsameSense = VSense;
                vtrim1 = V1;
...
void Geom_RectangularTrimmedSurface::D1(const Standard_Real U, const Standard_Real V, Pnt& P, Vec& D1U,
                                        Vec& D1V) const {
...
void Geom_RectangularTrimmedSurface::D2(const Standard_Real U, const Standard_Real V, Pnt& P, Vec& D1U, Vec& D1V,
...
void Geom_RectangularTrimmedSurface::D3(const Standard_Real U, const Standard_Real V, Pnt& P, Vec& D1U, Vec& D1V,
                                        Vec& D2U, Vec& D2V, Vec& D2UV, Vec& D3U, Vec& D3V, Vec& D3UUV,
                                        Vec& D3UVV) const {
...
Vec Geom_RectangularTrimmedSurface::DN(const Standard_Real U, const Standard_Real V, const Standard_Integer Nu,
...
void Geom_RectangularTrimmedSurface::Bounds(Standard_Real& U1, Standard_Real& U2, Standard_Real& V1,
...
Standard_Boolean Geom_RectangularTrimmedSurface::IsUPeriodic() const {
    if (basisSurf->IsUPeriodic() && !isutrimmed) return Standard_True;
...
Standard_Boolean Geom_RectangularTrimmedSurface::IsVPeriodic() const {
    if (basisSurf->IsVPeriodic() && !isvtrimmed) return Standard_True;
    return Standard_False;
}
...
void Geom_RectangularTrimmedSurface::TransformParameters(Standard_Real& U, Standard_Real& V, const gp_Trsf& T) const {
