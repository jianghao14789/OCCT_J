...
Geom_Hyperbola::Geom_Hyperbola(const gp_Hypr& H) : majorRadius(H.MajorRadius()), minorRadius(H.MinorRadius()) {
...
Geom_Hyperbola::Geom_Hyperbola(const Ax2& A, const Standard_Real MajorRadius, const Standard_Real MinorRadius)
