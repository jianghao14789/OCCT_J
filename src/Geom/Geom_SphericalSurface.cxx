...
Geom_SphericalSurface::Geom_SphericalSurface(const Ax3& A, const Standard_Real R) : radius(R) {
...
Geom_SphericalSurface::Geom_SphericalSurface(const gp_Sphere& S) : radius(S.Radius()) {
...
void Geom_SphericalSurface::Bounds(Standard_Real& U1, Standard_Real& U2, Standard_Real& V1, Standard_Real& V2) const {
...
void Geom_SphericalSurface::Coefficients(Standard_Real& A1, Standard_Real& A2, Standard_Real& A3, Standard_Real& B1,
...
void Geom_SphericalSurface::D1(const Standard_Real U, const Standard_Real V, Pnt& P, Vec& D1U, Vec& D1V) const {
...
void Geom_SphericalSurface::D2(const Standard_Real U, const Standard_Real V, Pnt& P, Vec& D1U, Vec& D1V, Vec& D2U,
...
void Geom_SphericalSurface::D3(const Standard_Real U, const Standard_Real V, Pnt& P, Vec& D1U, Vec& D1V, Vec& D2U,
...
Vec Geom_SphericalSurface::DN(const Standard_Real U, const Standard_Real V, const Standard_Integer Nu,
