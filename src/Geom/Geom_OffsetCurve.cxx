...
Geom_OffsetCurve::Geom_OffsetCurve(const Handle(Geom_Curve) & theCurve, const Standard_Real theOffset,
                                   const gp_Dir& theDir, const Standard_Boolean isTheNotCheckC0)
...
void Geom_OffsetCurve::SetBasisCurve(const Handle(Geom_Curve) & C, const Standard_Boolean isNotCheckC0) {
...
void Geom_OffsetCurve::D3(const Standard_Real theU, gp_Pnt& theP, gp_Vec& theV1, gp_Vec& theV2, gp_Vec& theV3) const {
