...
void Geom_BSplineSurface::D0(const Standard_Real U, const Standard_Real V, gp_Pnt& P) const {
    ...
    BSplSLib::D0(aNewU, aNewV, 0, 0, POLES, &WEIGHTS, UFKNOTS, VFKNOTS, FMULTS, FMULTS, udeg, vdeg, urational,
                 vrational, uperiodic, vperiodic, P);
}
...
void Geom_BSplineSurface::D1(const Standard_Real U, const Standard_Real V, gp_Pnt& P, gp_Vec& D1U, gp_Vec& D1V) const {
    Standard_Real aNewU = U;
    Standard_Real aNewV = V;
    PeriodicNormalization(aNewU, aNewV);
    ...
    BSplSLib::D1(aNewU, aNewV, uindex, vindex, POLES, &WEIGHTS, UFKNOTS, VFKNOTS, FMULTS, FMULTS, udeg, vdeg, urational,
                 vrational, uperiodic, vperiodic, P, D1U, D1V);
}
...
void Geom_BSplineSurface::D2(const Standard_Real U, const Standard_Real V, gp_Pnt& P, gp_Vec& D1U, gp_Vec& D1V,
    ...
    BSplSLib::D2(aNewU, aNewV, uindex, vindex, POLES, &WEIGHTS, UFKNOTS, VFKNOTS, FMULTS, FMULTS, udeg, vdeg, urational,
                 vrational, uperiodic, vperiodic, P, D1U, D1V, D2U, D2V, D2UV);
}
...
void Geom_BSplineSurface::D3(const Standard_Real U, const Standard_Real V, gp_Pnt& P, gp_Vec& D1U, gp_Vec& D1V,
                             gp_Vec& D2U, gp_Vec& D2V, gp_Vec& D2UV, gp_Vec& D3U, gp_Vec& D3V, gp_Vec& D3UUV,
                             gp_Vec& D3UVV) const {
    BSplSLib::D3(U, V, 0, 0, POLES, &WEIGHTS, UFKNOTS, VFKNOTS, FMULTS, FMULTS, udeg, vdeg, urational, vrational,
                 uperiodic, vperiodic, P, D1U, D1V, D2U, D2V, D2UV, D3U, D3V, D3UUV, D3UVV);
}
...
gp_Vec Geom_BSplineSurface::DN(const Standard_Real U, const Standard_Real V, const Standard_Integer Nu,
                               const Standard_Integer Nv) const {
    gp_Vec Vn;
    BSplSLib::DN(U, V, Nu, Nv, 0, 0, POLES, &WEIGHTS, UFKNOTS, VFKNOTS, FMULTS, FMULTS, udeg, vdeg, urational,
                 vrational, uperiodic, vperiodic, Vn);
    return Vn;
}
...
gp_Pnt Geom_BSplineSurface::LocalValue(const Standard_Real U, const Standard_Real V, const Standard_Integer FromUK1,
                                       const Standard_Integer ToUK2, const Standard_Integer FromVK1,
...
void Geom_BSplineSurface::LocalD0(const Standard_Real U, const Standard_Real V, const Standard_Integer FromUK1,
                                  const Standard_Integer ToUK2, const Standard_Integer FromVK1,
                                  const Standard_Integer ToVK2, gp_Pnt& P) const {
    Standard_DomainError_Raise_if(FromUK1 == ToUK2 || FromVK1 == ToVK2, "Geom_BSplineSurface::LocalD0");
    ...
    BSplSLib::D0(u, v, uindex, vindex, POLES, &WEIGHTS, UFKNOTS, VFKNOTS, FMULTS, FMULTS, udeg, vdeg, urational,
                 vrational, uperiodic, vperiodic, P);
}
...
void Geom_BSplineSurface::LocalD1(const Standard_Real U, const Standard_Real V, const Standard_Integer FromUK1,
                                  const Standard_Integer ToUK2, const Standard_Integer FromVK1,
                                  const Standard_Integer ToVK2, gp_Pnt& P, gp_Vec& D1U, gp_Vec& D1V) const {
    Standard_DomainError_Raise_if(FromUK1 == ToUK2 || FromVK1 == ToVK2, "Geom_BSplineSurface::LocalD1");
    ...
    BSplSLib::D1(u, v, uindex, vindex, POLES, &WEIGHTS, UFKNOTS, VFKNOTS, FMULTS, FMULTS, udeg, vdeg, urational,
                 vrational, uperiodic, vperiodic, P, D1U, D1V);
}
...
void Geom_BSplineSurface::LocalD2(const Standard_Real U, const Standard_Real V, const Standard_Integer FromUK1,
                                  const Standard_Integer ToUK2, const Standard_Integer FromVK1,
                                  const Standard_Integer ToVK2, gp_Pnt& P, gp_Vec& D1U, gp_Vec& D1V, gp_Vec& D2U,
                                  gp_Vec& D2V, gp_Vec& D2UV) const {
    Standard_DomainError_Raise_if(FromUK1 == ToUK2 || FromVK1 == ToVK2, "Geom_BSplineSurface::LocalD2");
    ...
    BSplSLib::D2(u, v, uindex, vindex, POLES, &WEIGHTS, UFKNOTS, VFKNOTS, FMULTS, FMULTS, udeg, vdeg, urational,
                 vrational, uperiodic, vperiodic, P, D1U, D1V, D2U, D2V, D2UV);
}
...
void Geom_BSplineSurface::LocalD3(const Standard_Real U, const Standard_Real V, const Standard_Integer FromUK1,
                                  const Standard_Integer ToUK2, const Standard_Integer FromVK1,
                                  const Standard_Integer ToVK2, gp_Pnt& P, gp_Vec& D1U, gp_Vec& D1V, gp_Vec& D2U,
                                  gp_Vec& D2V, gp_Vec& D2UV, gp_Vec& D3U, gp_Vec& D3V, gp_Vec& D3UUV,
                                  gp_Vec& D3UVV) const {
    Standard_DomainError_Raise_if(FromUK1 == ToUK2 || FromVK1 == ToVK2, "Geom_BSplineSurface::LocalD3");
    ...
    BSplSLib::D3(u, v, uindex, vindex, POLES, &WEIGHTS, UFKNOTS, VFKNOTS, FMULTS, FMULTS, udeg, vdeg, urational,
                 vrational, uperiodic, vperiodic, P, D1U, D1V, D2U, D2V, D2UV, D3U, D3V, D3UUV, D3UVV);
}
...
gp_Vec Geom_BSplineSurface::LocalDN(const Standard_Real U, const Standard_Real V, const Standard_Integer FromUK1,
                                    const Standard_Integer ToUK2, const Standard_Integer FromVK1,
                                    const Standard_Integer ToVK2, const Standard_Integer Nu,
                                    const Standard_Integer Nv) const {
    Standard_DomainError_Raise_if(FromUK1 == ToUK2 || FromVK1 == ToVK2, "Geom_BSplineSurface::LocalDN");
    ...
    gp_Vec Vn;
    BSplSLib::DN(u, v, Nu, Nv, uindex, vindex, POLES, &WEIGHTS, UFKNOTS, VFKNOTS, FMULTS, FMULTS, udeg, vdeg, urational,
                 vrational, uperiodic, vperiodic, Vn);
    return Vn;
}
...
const gp_Pnt& Geom_BSplineSurface::Pole(const Standard_Integer UIndex, const Standard_Integer VIndex) const {
    Standard_OutOfRange_Raise_if(UIndex < 1 || UIndex > poles->ColLength() || VIndex < 1 || VIndex > poles->RowLength(),
                                 " ");
...
void Geom_BSplineSurface::Poles(TColgp_Array2OfPnt& P) const {
    Standard_DimensionError_Raise_if(P.ColLength() != poles->ColLength() || P.RowLength() != poles->RowLength(), " ");
    P = poles->Array2();
}
...
Handle(Geom_Curve) Geom_BSplineSurface::UIso(const Standard_Real U) const {
    ...
    if (urational || vrational) {
        BSplSLib::Iso(U, Standard_True, POLES, &WEIGHTS, UFKNOTS, FMULTS, udeg, uperiodic, cpoles, &cweights);
        C = new Geom_BSplineCurve(cpoles, cweights, vknots->Array1(), vmults->Array1(), vdeg, vperiodic);
    } else {
        BSplSLib::Iso(U, Standard_True, POLES, BSplSLib::NoWeights(), UFKNOTS, FMULTS, udeg, uperiodic, cpoles,
                      &cweights);
...
Handle(Geom_Curve) Geom_BSplineSurface::UIso(const Standard_Real U, const Standard_Boolean CheckRational) const {
    TColgp_Array1OfPnt cpoles(1, poles->RowLength());
    TColStd_Array1OfReal cweights(1, poles->RowLength());
    ...
    if (urational || vrational) {
        BSplSLib::Iso(U, Standard_True, POLES, &WEIGHTS, UFKNOTS, FMULTS, udeg, uperiodic, cpoles, &cweights);
        C = new Geom_BSplineCurve(cpoles, cweights, vknots->Array1(), vmults->Array1(), vdeg, vperiodic, CheckRational);
    } else {
        BSplSLib::Iso(U, Standard_True, POLES, BSplSLib::NoWeights(), UFKNOTS, FMULTS, udeg, uperiodic, cpoles,
                      &cweights);
        C = new Geom_BSplineCurve(cpoles, vknots->Array1(), vmults->Array1(), vdeg, vperiodic);
...
Handle(Geom_Curve) Geom_BSplineSurface::VIso(const Standard_Real V) const {
    ...
    if (urational || vrational) {
        BSplSLib::Iso(V, Standard_False, POLES, &WEIGHTS, VFKNOTS, FMULTS, vdeg, vperiodic, cpoles, &cweights);
        C = new Geom_BSplineCurve(cpoles, cweights, uknots->Array1(), umults->Array1(), udeg, uperiodic);
    } else {
        BSplSLib::Iso(V, Standard_False, POLES, BSplSLib::NoWeights(), VFKNOTS, FMULTS, vdeg, vperiodic, cpoles,
                      &cweights);
...
Handle(Geom_Curve) Geom_BSplineSurface::VIso(const Standard_Real V, const Standard_Boolean CheckRational) const {
    TColgp_Array1OfPnt cpoles(1, poles->ColLength());
    TColStd_Array1OfReal cweights(1, poles->ColLength());
    ...
    if (urational || vrational) {
        BSplSLib::Iso(V, Standard_False, POLES, &WEIGHTS, VFKNOTS, FMULTS, vdeg, vperiodic, cpoles, &cweights);
        C = new Geom_BSplineCurve(cpoles, cweights, uknots->Array1(), umults->Array1(), udeg, uperiodic, CheckRational);
    } else {
        BSplSLib::Iso(V, Standard_False, POLES, BSplSLib::NoWeights(), VFKNOTS, FMULTS, vdeg, vperiodic, cpoles,
                      &cweights);
        C = new Geom_BSplineCurve(cpoles, uknots->Array1(), umults->Array1(), udeg, uperiodic);
...
Standard_Real Geom_BSplineSurface::Weight(const Standard_Integer UIndex, const Standard_Integer VIndex) const {
    Standard_OutOfRange_Raise_if(
        UIndex < 1 || UIndex > weights->ColLength() || VIndex < 1 || VIndex > weights->RowLength(), " ");
...
void Geom_BSplineSurface::Weights(TColStd_Array2OfReal& W) const {
    Standard_DimensionError_Raise_if(W.ColLength() != weights->ColLength() || W.RowLength() != weights->RowLength(),
                                     " ");
    W = weights->Array2();
}

const TColStd_Array2OfReal* Geom_BSplineSurface::Weights() const {
    if (urational || vrational) return &weights->Array2();
...
void Geom_BSplineSurface::SetUOrigin(const Standard_Integer Index) {
    if (!uperiodic) throw Standard_NoSuchObject("Geom_BSplineSurface::SetUOrigin: surface is not U periodic");
    ...
    uknots = nknots;
    umults = nmults;
    if (urational || vrational) weights = nweights;
    UpdateUKnots();
}
...
void Geom_BSplineSurface::SetVOrigin(const Standard_Integer Index) {
    if (!vperiodic) throw Standard_NoSuchObject("Geom_BSplineSurface::SetVOrigin: surface is not V periodic");
...
void Geom_BSplineSurface::SetUNotPeriodic() {
    if (uperiodic) {
        ...
        if (urational || vrational) {
            ...
            BSplSLib::Unperiodize(Standard_True, udeg, umults->Array1(), uknots->Array1(), poles->Array2(),
                                  &weights->Array2(), nmults->ChangeArray1(), nknots->ChangeArray1(),
                                  npoles->ChangeArray2(), &nweights->ChangeArray2());
        } else {

            BSplSLib::Unperiodize(Standard_True, udeg, umults->Array1(), uknots->Array1(), poles->Array2(),
                                  BSplSLib::NoWeights(), nmults->ChangeArray1(), nknots->ChangeArray1(),
...
void Geom_BSplineSurface::SetVNotPeriodic() {
    if (vperiodic) {
        ...
        if (urational || vrational) {
            ...
            BSplSLib::Unperiodize(Standard_False, vdeg, vmults->Array1(), vknots->Array1(), poles->Array2(),
                                  &weights->Array2(), nmults->ChangeArray1(), nknots->ChangeArray1(),
                                  npoles->ChangeArray2(), &nweights->ChangeArray2());
        } else {
...
Standard_Boolean Geom_BSplineSurface::IsVClosed() const {
    if (vperiodic) return Standard_True;

    Standard_Real aU1, aU2, aV1, aV2;
    Bounds(aU1, aU2, aV1, aV2);
    Handle(Geom_Curve) aCVF = VIso(aV1);
    Handle(Geom_Curve) aCVL = VIso(aV2);
    if (aCVF.IsNull() || aCVL.IsNull()) return Standard_False;
...
void Geom_BSplineSurface::LocateU(const Standard_Real U, const Standard_Real ParametricTolerance, Standard_Integer& I1,
...
void Geom_BSplineSurface::LocateV(const Standard_Real V, const Standard_Real ParametricTolerance, Standard_Integer& I1,
                                  Standard_Integer& I2, const Standard_Boolean WithKnotRepetition) const {
...
void Geom_BSplineSurface::UReverse() {
    ...
    if (urational || vrational) BSplSLib::Reverse(weights->ChangeArray2(), last, Standard_True);
    UpdateUKnots();
}
...
void Geom_BSplineSurface::VReverse() {
    ...
    if (urational || vrational) BSplSLib::Reverse(weights->ChangeArray2(), last, Standard_False);
    UpdateVKnots();
}
...
void Geom_BSplineSurface::SetPoleCol(const Standard_Integer VIndex, const TColgp_Array1OfPnt& CPoles) {
...
void Geom_BSplineSurface::SetPoleRow(const Standard_Integer UIndex, const TColgp_Array1OfPnt& CPoles) {
...
void Geom_BSplineSurface::SetPole(const Standard_Integer UIndex, const Standard_Integer VIndex, const gp_Pnt& P) {
...
void Geom_BSplineSurface::MovePoint(const Standard_Real U, const Standard_Real V, const gp_Pnt& P,
                                    const Standard_Integer UIndex1, const Standard_Integer UIndex2,
                                    const Standard_Integer VIndex1, const Standard_Integer VIndex2,
                                    Standard_Integer& UFirstModifiedPole, Standard_Integer& ULastmodifiedPole,
                                    Standard_Integer& VFirstModifiedPole, Standard_Integer& VLastmodifiedPole) {
    if (UIndex1 < 1 || UIndex1 > poles->UpperRow() || UIndex2 < 1 || UIndex2 > poles->UpperRow() || UIndex1 > UIndex2 ||
        VIndex1 < 1 || VIndex1 > poles->UpperCol() || VIndex2 < 1 || VIndex2 > poles->UpperCol() || VIndex1 > VIndex2) {
    ...
    BSplSLib::MovePoint(U, V, Displ, UIndex1, UIndex2, VIndex1, VIndex2, udeg, vdeg, rational, poles->Array2(),
                        weights->Array2(), ufknots->Array1(), vfknots->Array1(), UFirstModifiedPole, ULastmodifiedPole,
                        VFirstModifiedPole, VLastmodifiedPole, npoles);
...
void Geom_BSplineSurface::Bounds(Standard_Real& U1, Standard_Real& U2, Standard_Real& V1, Standard_Real& V2) const {
...
void Geom_BSplineSurface::InsertUKnots(const TColStd_Array1OfReal& Knots, const TColStd_Array1OfInteger& Mults,
                                       const Standard_Real ParametricTolerance, const Standard_Boolean Add) {
    // Check and compute new sizes
    Standard_Integer nbpoles, nbknots;

    if (!BSplCLib::PrepareInsertKnots(udeg, uperiodic, uknots->Array1(), umults->Array1(), Knots, &Mults, nbpoles,
                                      nbknots, ParametricTolerance, Add))
        throw Standard_ConstructionError("Geom_BSplineSurface::InsertUKnots");

    if (nbpoles == poles->ColLength()) return;

    Handle(TColgp_HArray2OfPnt) npoles = new TColgp_HArray2OfPnt(1, nbpoles, 1, poles->RowLength());
    Handle(TColStd_HArray2OfReal) nweights = new TColStd_HArray2OfReal(1, nbpoles, 1, poles->RowLength(), 1.0);
    ...
    if (urational || vrational) {
        BSplSLib::InsertKnots(Standard_True, udeg, uperiodic, poles->Array2(), &weights->Array2(), uknots->Array1(),
                              umults->Array1(), Knots, &Mults, npoles->ChangeArray2(), &nweights->ChangeArray2(),
                              nknots->ChangeArray1(), nmults->ChangeArray1(), ParametricTolerance, Add);
    } else {
        BSplSLib::InsertKnots(Standard_True, udeg, uperiodic, poles->Array2(), BSplSLib::NoWeights(), uknots->Array1(),
                              umults->Array1(), Knots, &Mults, npoles->ChangeArray2(), BSplSLib::NoWeights(),
                              nknots->ChangeArray1(), nmults->ChangeArray1(), ParametricTolerance, Add);
    }
...
void Geom_BSplineSurface::InsertVKnots(const TColStd_Array1OfReal& Knots, const TColStd_Array1OfInteger& Mults,
                                       const Standard_Real ParametricTolerance, const Standard_Boolean Add) {
    // Check and compute new sizes
    Standard_Integer nbpoles, nbknots;

    if (!BSplCLib::PrepareInsertKnots(vdeg, vperiodic, vknots->Array1(), vmults->Array1(), Knots, &Mults, nbpoles,
                                      nbknots, ParametricTolerance, Add))
    ...
    Handle(TColgp_HArray2OfPnt) npoles = new TColgp_HArray2OfPnt(1, poles->ColLength(), 1, nbpoles);
    Handle(TColStd_HArray2OfReal) nweights = new TColStd_HArray2OfReal(1, poles->ColLength(), 1, nbpoles, 1.0);
    ...
    if (urational || vrational) {
        BSplSLib::InsertKnots(Standard_False, vdeg, vperiodic, poles->Array2(), &weights->Array2(), vknots->Array1(),
                              vmults->Array1(), Knots, &Mults, npoles->ChangeArray2(), &nweights->ChangeArray2(),
                              nknots->ChangeArray1(), nmults->ChangeArray1(), ParametricTolerance, Add);
    } else {
        BSplSLib::InsertKnots(Standard_False, vdeg, vperiodic, poles->Array2(), BSplSLib::NoWeights(), vknots->Array1(),
                              vmults->Array1(), Knots, &Mults, npoles->ChangeArray2(), BSplSLib::NoWeights(),
                              nknots->ChangeArray1(), nmults->ChangeArray1(), ParametricTolerance, Add);
    }
...
Standard_Boolean Geom_BSplineSurface::RemoveUKnot(const Standard_Integer Index, const Standard_Integer M,
    ...
    if (urational || vrational) {
        ...
        if (!BSplSLib::RemoveKnot(Standard_True, Index, M, udeg, uperiodic, poles->Array2(), &weights->Array2(),
                                  uknots->Array1(), umults->Array1(), npoles->ChangeArray2(), &nweights->ChangeArray2(),
                                  nknots->ChangeArray1(), nmults->ChangeArray1(), Tolerance))
            return Standard_False;
    } else {
        //
        ...
        if (!BSplSLib::RemoveKnot(Standard_True, Index, M, udeg, uperiodic, poles->Array2(), BSplSLib::NoWeights(),
                                  uknots->Array1(), umults->Array1(), npoles->ChangeArray2(), BSplSLib::NoWeights(),
                                  nknots->ChangeArray1(), nmults->ChangeArray1(), Tolerance))
            return Standard_False;
    }
...
Standard_Boolean Geom_BSplineSurface::RemoveVKnot(const Standard_Integer Index, const Standard_Integer M,
                                                  const Standard_Real Tolerance) {
    if (M < 0) return Standard_True;
    ...
    if (urational || vrational) {
        ...
        if (!BSplSLib::RemoveKnot(Standard_False, Index, M, vdeg, vperiodic, poles->Array2(), &weights->Array2(),
                                  vknots->Array1(), vmults->Array1(), npoles->ChangeArray2(), &nweights->ChangeArray2(),
                                  nknots->ChangeArray1(), nmults->ChangeArray1(), Tolerance))
            return Standard_False;
    } else {
        //
        ...
        //
        nweights = new TColStd_HArray2OfReal(1, npoles->ColLength(), 1, npoles->RowLength(), 1.0e0);
        if (!BSplSLib::RemoveKnot(Standard_False, Index, M, vdeg, vperiodic, poles->Array2(), BSplSLib::NoWeights(),
                                  vknots->Array1(), vmults->Array1(), npoles->ChangeArray2(), BSplSLib::NoWeights(),
                                  nknots->ChangeArray1(), nmults->ChangeArray1(), Tolerance))
            return Standard_False;
    }
...
void Geom_BSplineSurface::Resolution(const Standard_Real Tolerance3D, Standard_Real& UTolerance,
                                     Standard_Real& VTolerance) {
    if (!maxderivinvok) {
        BSplSLib::Resolution(poles->Array2(), &weights->Array2(), uknots->Array1(), vknots->Array1(), umults->Array1(),
                             vmults->Array1(), udeg, vdeg, urational, vrational, uperiodic, vperiodic, 1., umaxderivinv,
                             vmaxderivinv);
        maxderivinvok = 1;
    }
