...
Geom_SurfaceOfLinearExtrusion::Geom_SurfaceOfLinearExtrusion(const Handle(Geom_Curve) & C, const Dir& V) {
...
void Geom_SurfaceOfLinearExtrusion::Bounds(Standard_Real& U1, Standard_Real& U2, Standard_Real& V1,
...
void Geom_SurfaceOfLinearExtrusion::D1(const Standard_Real U, const Standard_Real V, Pnt& P, Vec& D1U, Vec& D1V) const {
...
void Geom_SurfaceOfLinearExtrusion::D2(const Standard_Real U, const Standard_Real V, Pnt& P, Vec& D1U, Vec& D1V,
...
void Geom_SurfaceOfLinearExtrusion::D3(const Standard_Real U, const Standard_Real V, Pnt& P, Vec& D1U, Vec& D1V,
...
Vec Geom_SurfaceOfLinearExtrusion::DN(const Standard_Real U, const Standard_Real V, const Standard_Integer Nu,
...
void Geom_SurfaceOfLinearExtrusion::TransformParameters(Standard_Real& U, Standard_Real& V, const gp_Trsf& T) const {
