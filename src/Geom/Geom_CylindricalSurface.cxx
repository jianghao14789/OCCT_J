...
Geom_CylindricalSurface::Geom_CylindricalSurface(const gp_Cylinder& C) : radius(C.Radius()) {
...
Geom_CylindricalSurface::Geom_CylindricalSurface(const Ax3& A3, const Standard_Real R) : radius(R) {
...
void Geom_CylindricalSurface::Bounds(Standard_Real& U1, Standard_Real& U2, Standard_Real& V1, Standard_Real& V2) const {
...
void Geom_CylindricalSurface::Coefficients(Standard_Real& A1, Standard_Real& A2, Standard_Real& A3, Standard_Real& B1,
...
void Geom_CylindricalSurface::D1(const Standard_Real U, const Standard_Real V, Pnt& P, Vec& D1U, Vec& D1V) const {
...
void Geom_CylindricalSurface::D2(const Standard_Real U, const Standard_Real V, Pnt& P, Vec& D1U, Vec& D1V, Vec& D2U,
...
void Geom_CylindricalSurface::D3(const Standard_Real U, const Standard_Real V, Pnt& P, Vec& D1U, Vec& D1V, Vec& D2U,
...
Vec Geom_CylindricalSurface::DN(const Standard_Real U, const Standard_Real V, const Standard_Integer Nu,
...
void Geom_CylindricalSurface::TransformParameters(Standard_Real&, Standard_Real& V, const gp_Trsf& T) const {
