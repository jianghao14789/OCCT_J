...
Geom_Direction::Geom_Direction(const Standard_Real X, const Standard_Real Y, const Standard_Real Z) {
    ...
    Standard_ConstructionError_Raise_if(D <= gp::Resolution(), "Geom_Direction() - input vector has zero length");
...
void Geom_Direction::SetX(const Standard_Real X) {
    ...
    Standard_ConstructionError_Raise_if(D <= gp::Resolution(), "Geom_Direction::SetX() - input vector has zero length");
...
void Geom_Direction::SetY(const Standard_Real Y) {
    ...
    Standard_ConstructionError_Raise_if(D <= gp::Resolution(), "Geom_Direction::SetY() - input vector has zero length");
...
void Geom_Direction::SetZ(const Standard_Real Z) {
    ...
    Standard_ConstructionError_Raise_if(D <= gp::Resolution(), "Geom_Direction::SetZ() - input vector has zero length");
