...
Geom_ToroidalSurface::Geom_ToroidalSurface(const Ax3& A3, const Standard_Real MajorRadius,
...
void Geom_ToroidalSurface::Bounds(Standard_Real& U1, Standard_Real& U2, Standard_Real& V1, Standard_Real& V2) const {
...
void Geom_ToroidalSurface::D1(const Standard_Real U, const Standard_Real V, Pnt& P, Vec& D1U, Vec& D1V) const {
...
void Geom_ToroidalSurface::D2(const Standard_Real U, const Standard_Real V, Pnt& P, Vec& D1U, Vec& D1V, Vec& D2U,
...
void Geom_ToroidalSurface::D3(const Standard_Real U, const Standard_Real V, Pnt& P, Vec& D1U, Vec& D1V, Vec& D2U,
                              Vec& D2V, Vec& D2UV, Vec& D3U, Vec& D3V, Vec& D3UUV, Vec& D3UVV) const {

    ElSLib::TorusD3(U, V, pos, majorRadius, minorRadius, P, D1U, D1V, D2U, D2V, D2UV, D3U, D3V, D3UUV, D3UVV);
}
...
Vec Geom_ToroidalSurface::DN(const Standard_Real U, const Standard_Real V, const Standard_Integer Nu,
