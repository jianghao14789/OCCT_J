...
public:
    ...
    Standard_EXPORT Geom_BSplineCurve(const TColgp_Array1OfPnt& Poles, const TColStd_Array1OfReal& Knots,
    ...
    Standard_EXPORT Geom_BSplineCurve(const TColgp_Array1OfPnt& Poles, const TColStd_Array1OfReal& Weights,
    ...
    Standard_EXPORT void MovePoint(const Standard_Real U, const gp_Pnt& P, const Standard_Integer Index1,
    ...
    Standard_EXPORT void MovePointAndTangent(const Standard_Real U, const gp_Pnt& P, const gp_Vec& Tangent,
    ...
    Standard_EXPORT gp_Pnt LocalValue(const Standard_Real U, const Standard_Integer FromK1,
    ...
    //! Raised if FromK1 = ToK2.
    //! Raised if N < 1.
    Standard_EXPORT gp_Vec LocalDN(const Standard_Real U, const Standard_Integer FromK1, const Standard_Integer ToK2,
