...
//=======================================================================
static void Rational(const TColStd_Array2OfReal& Weights, Standard_Boolean& Urational, Standard_Boolean& Vrational) {
...
static void AddPoleCol(const TColgp_Array2OfPnt& Poles, const TColgp_Array1OfPnt& PoleCol,
                       const Standard_Integer AfterIndex, TColgp_Array2OfPnt& NewPoles) {
...
static void AddRatPoleCol(const TColgp_Array2OfPnt& Poles, const TColStd_Array2OfReal& Weights,
                          const TColgp_Array1OfPnt& PoleCol, const TColStd_Array1OfReal& PoleWeightCol,
                          const Standard_Integer AfterIndex, TColgp_Array2OfPnt& NewPoles,
...
static void AddPoleRow(const TColgp_Array2OfPnt& Poles, const TColgp_Array1OfPnt& PoleRow,
                       const Standard_Integer AfterIndex, TColgp_Array2OfPnt& NewPoles) {
...
static void AddRatPoleRow(const TColgp_Array2OfPnt& Poles, const TColStd_Array2OfReal& Weights,
                          const TColgp_Array1OfPnt& PoleRow, const TColStd_Array1OfReal& PoleWeightRow,
                          const Standard_Integer AfterIndex, TColgp_Array2OfPnt& NewPoles,
                          TColStd_Array2OfReal& NewWeights) {
    Standard_Integer InsertIndex = AfterIndex + NewPoles.LowerRow();
...
static void DeletePoleCol(const TColgp_Array2OfPnt& Poles, const Standard_Integer Index, TColgp_Array2OfPnt& NewPoles) {
...
static void DeleteRatPoleCol(const TColgp_Array2OfPnt& Poles, const TColStd_Array2OfReal& Weights,
                             const Standard_Integer Index, TColgp_Array2OfPnt& NewPoles,
                             TColStd_Array2OfReal& NewWeights) {
    Standard_Integer Offset = 0;
    Standard_Integer RowIndex;
    Standard_Integer ColIndex = NewPoles.LowerCol();
...
static void DeletePoleRow(const TColgp_Array2OfPnt& Poles, const Standard_Integer Index, TColgp_Array2OfPnt& NewPoles) {
    Standard_Integer Offset = 0;
    Standard_Integer ColIndex;
    Standard_Integer RowIndex = NewPoles.LowerRow();
    while (RowIndex <= NewPoles.UpperRow()) {
...
static void DeleteRatPoleRow(const TColgp_Array2OfPnt& Poles, const TColStd_Array2OfReal& Weights,
                             const Standard_Integer Index, TColgp_Array2OfPnt& NewPoles,
                             TColStd_Array2OfReal& NewWeights) {
    Standard_Integer Offset = 0;
    Standard_Integer ColIndex;
...
Geom_BezierSurface::Geom_BezierSurface(const TColgp_Array2OfPnt& SurfacePoles) : maxderivinvok(Standard_False) {
...
Geom_BezierSurface::Geom_BezierSurface(const TColgp_Array2OfPnt& SurfacePoles, const TColStd_Array2OfReal& PoleWeights)
    ...
    while (!vrational && J <= PoleWeights.UpperCol()) {
        ...
        while (!vrational && I <= PoleWeights.UpperRow() - 1) {
            vrational = (Abs(PoleWeights(I, J) - PoleWeights(I + 1, J)) > Epsilon(Abs(PoleWeights(I, J))));
            I++;
        }
        J++;
    }
    ...
    while (!urational && I <= PoleWeights.UpperRow()) {
        ...
        while (!urational && J <= PoleWeights.UpperCol() - 1) {
            urational = (Abs(PoleWeights(I, J) - PoleWeights(I, J + 1)) > Epsilon(Abs(PoleWeights(I, J))));
            J++;
        }
        I++;
    }
...
Geom_BezierSurface::Geom_BezierSurface(const Handle(TColgp_HArray2OfPnt) & SurfacePoles,
                                       ...
                                       const Standard_Boolean IsURational, const Standard_Boolean IsVRational)
    : maxderivinvok(Standard_False) {
...
void Geom_BezierSurface::Increase(const Standard_Integer UDeg, const Standard_Integer VDeg) {
    ...
    if (IncUDeg > 0) {
        ...
        if (urational || vrational) {
            ...
            BSplSLib::IncreaseDegree(1, oldUDeg, UDeg, 0, poles->Array2(), &weights->Array2(), biduknots, bidumults,
                                     npoles->ChangeArray2(), &nweights->ChangeArray2(), biduknots, bidumults);
            weights = nweights;
        } else {
            BSplSLib::IncreaseDegree(1, oldUDeg, UDeg, 0, poles->Array2(), BSplSLib::NoWeights(), biduknots, bidumults,
                                     npoles->ChangeArray2(), BSplSLib::NoWeights(), biduknots, bidumults);
        }
        poles = npoles;
    }
    if (IncVDeg > 0) {
        ...
        if (urational || vrational) {
            ...
            BSplSLib::IncreaseDegree(0, oldVDeg, VDeg, 0, poles->Array2(), &weights->Array2(), bidvknots, bidvmults,
                                     npoles->ChangeArray2(), &nweights->ChangeArray2(), bidvknots, bidvmults);
            weights = nweights;
        } else {
            BSplSLib::IncreaseDegree(0, oldVDeg, VDeg, 0, poles->Array2(), BSplSLib::NoWeights(), bidvknots, bidvmults,
                                     npoles->ChangeArray2(), BSplSLib::NoWeights(), bidvknots, bidvmults);
        }
        poles = npoles;
    }
    Init(npoles, nweights);
...
void Geom_BezierSurface::InsertPoleColAfter(const Standard_Integer VIndex, const TColgp_Array1OfPnt& CPoles) {
    ...
    Handle(TColgp_HArray2OfPnt) npoles = new TColgp_HArray2OfPnt(1, poles->ColLength(), 1, poles->RowLength() + 1);
    ...
    if (urational || vrational) {
        ...
        AddRatPoleCol(poles->Array2(), weights->Array2(), CPoles, CWeights, VIndex, npoles->ChangeArray2(),
...
void Geom_BezierSurface::InsertPoleColAfter(const Standard_Integer VIndex, const TColgp_Array1OfPnt& CPoles,
    ...
    AddRatPoleCol(poles->Array2(), weights->Array2(), CPoles, CPoleWeights, VIndex, npoles->ChangeArray2(),
                  nweights->ChangeArray2());
...
void Geom_BezierSurface::InsertPoleColBefore(const Standard_Integer VIndex, const TColgp_Array1OfPnt& CPoles) {
...
void Geom_BezierSurface::InsertPoleRowAfter(const Standard_Integer UIndex, const TColgp_Array1OfPnt& CPoles) {
    const TColgp_Array2OfPnt& Poles = poles->Array2();
    ...
    Handle(TColgp_HArray2OfPnt) npoles = new TColgp_HArray2OfPnt(1, poles->ColLength() + 1, 1, poles->RowLength());
    ...
    if (urational || vrational) {
        ...
        //				  1.0); ???????????
        TColStd_Array1OfReal CWeights(1.0, nweights->LowerCol(), nweights->UpperCol());

        AddRatPoleRow(poles->Array2(), weights->Array2(), CPoles, CWeights, UIndex, npoles->ChangeArray2(),
                      nweights->ChangeArray2());
    } else {
...
void Geom_BezierSurface::InsertPoleRowAfter(const Standard_Integer UIndex, const TColgp_Array1OfPnt& CPoles,
    ...
    AddRatPoleCol(poles->Array2(), weights->Array2(), CPoles, CPoleWeights, UIndex, npoles->ChangeArray2(),
                  nweights->ChangeArray2());
...
void Geom_BezierSurface::InsertPoleRowBefore(const Standard_Integer UIndex, const TColgp_Array1OfPnt& CPoles) {
...
void Geom_BezierSurface::RemovePoleCol(const Standard_Integer VIndex) {
    ...
    if (urational || vrational) {
        ...
        DeleteRatPoleCol(poles->Array2(), weights->Array2(), VIndex, npoles->ChangeArray2(), nweights->ChangeArray2());
...
void Geom_BezierSurface::RemovePoleRow(const Standard_Integer UIndex) {
    ...
    if (urational || vrational) {
        ...
        DeleteRatPoleRow(poles->Array2(), weights->Array2(), UIndex, npoles->ChangeArray2(), nweights->ChangeArray2());
...
void Geom_BezierSurface::Segment(const Standard_Real U1, const Standard_Real U2, const Standard_Real V1,
    ...
    if (rat) WCoefs = new TColStd_HArray2OfReal(1, aMaxDegree + 1, 1, aMinDegree + 1);
    ...
    if (urational || vrational) {
        BSplSLib::BuildCache(uparameter_11, vparameter_11, uspanlenght_11, vspanlenght_11, 0, 0, UDegree(), VDegree(),
                             0, 0, biduflatknots, bidvflatknots, poles->Array2(), &weights->Array2(),
                             Coefs->ChangeArray2(), &WCoefs->ChangeArray2());
    } else {
        BSplSLib::BuildCache(uparameter_11, vparameter_11, uspanlenght_11, vspanlenght_11, 0, 0, UDegree(), VDegree(),
                             0, 0, biduflatknots, bidvflatknots, poles->Array2(), BSplSLib::NoWeights(),
                             Coefs->ChangeArray2(), BSplSLib::NoWeights());
    }
    ...
    Standard_Real ufirst = 2 * (U1 - 0.5), ulast = 2 * (U2 - 0.5), vfirst = 2 * (V1 - 0.5), vlast = 2 * (V2 - 0.5);
    if (rat) {
        ...
        PLib::CoefficientsPoles(Coefs->Array2(), &WCoefs->Array2(), poles->ChangeArray2(), &weights->ChangeArray2());
    } else {
        ...
        PLib::CoefficientsPoles(Coefs->Array2(), PLib::NoWeights2(), poles->ChangeArray2(), PLib::NoWeights2());
    }
}
...
void Geom_BezierSurface::SetPole(const Standard_Integer UIndex, const Standard_Integer VIndex, const gp_Pnt& P) {
...
void Geom_BezierSurface::SetPole(const Standard_Integer UIndex, const Standard_Integer VIndex, const gp_Pnt& P,
    ...
    if (Weight <= gp::Resolution()) throw Standard_ConstructionError("Geom_BezierSurface::SetPole");
    if (UIndex < 1 || UIndex > poles->ColLength() || VIndex < 1 || VIndex > poles->RowLength())
...
void Geom_BezierSurface::SetWeight(const Standard_Integer UIndex, const Standard_Integer VIndex,
                                   const Standard_Real Weight) {
    ...
    if (Weight <= gp::Resolution()) throw Standard_ConstructionError("Geom_BezierSurface::SetWeight");
    ...
    if (wasrat && !(urational || vrational)) weights.Nullify();
}
...
void Geom_BezierSurface::SetWeightRow(const Standard_Integer UIndex, const TColStd_Array1OfReal& CPoleWeights) {
    ...
    TColStd_Array2OfReal& Weights = weights->ChangeArray2();
    if (UIndex < 1 || UIndex > Weights.ColLength()) throw Standard_OutOfRange("Geom_BezierSurface::SetWeightRow");
    if (CPoleWeights.Lower() < 1 || CPoleWeights.Lower() > Weights.RowLength() || CPoleWeights.Upper() < 1 ||
...
void Geom_BezierSurface::D0(const Standard_Real U, const Standard_Real V, gp_Pnt& P) const {
    ...
    if (urational || vrational) {
        BSplSLib::D0(U, V, 1, 1, poles->Array2(), &weights->Array2(), biduknots, bidvknots, &bidumults, &bidvmults,
                     UDegree(), VDegree(), urational, vrational, Standard_False, Standard_False, P);
    } else {

        BSplSLib::D0(U, V, 1, 1, poles->Array2(), BSplSLib::NoWeights(), biduknots, bidvknots, &bidumults, &bidvmults,
                     UDegree(), VDegree(), urational, vrational, Standard_False, Standard_False, P);
    }
}
...
void Geom_BezierSurface::D1(const Standard_Real U, const Standard_Real V, gp_Pnt& P, gp_Vec& D1U, gp_Vec& D1V) const {
    ...
    TColStd_Array1OfInteger bidvmults(mult_v[0], 1, 2);
    if (urational || vrational) {
        BSplSLib::D1(U, V, 1, 1, poles->Array2(), &weights->Array2(), biduknots, bidvknots, &bidumults, &bidvmults,
                     UDegree(), VDegree(), urational, vrational, Standard_False, Standard_False, P, D1U, D1V);
    } else {
        BSplSLib::D1(U, V, 1, 1, poles->Array2(), BSplSLib::NoWeights(), biduknots, bidvknots, &bidumults, &bidvmults,
                     UDegree(), VDegree(), urational, vrational, Standard_False, Standard_False, P, D1U, D1V);
    }
}
...
void Geom_BezierSurface::D2(const Standard_Real U, const Standard_Real V, gp_Pnt& P, gp_Vec& D1U, gp_Vec& D1V,
    ...
    if (urational || vrational) {
        ...
        BSplSLib::D2(U, V, 1, 1, poles->Array2(), &weights->Array2(), biduknots, bidvknots, &bidumults, &bidvmults,
                     UDegree(), VDegree(), urational, vrational, Standard_False, Standard_False, P, D1U, D1V, D2U, D2V,
                     D2UV);
    } else {
        //-- ATTENTION a l'ORDRE d'appel ds BSPLSLIB
        BSplSLib::D2(U, V, 1, 1, poles->Array2(), BSplSLib::NoWeights(), biduknots, bidvknots, &bidumults, &bidvmults,
                     UDegree(), VDegree(), urational, vrational, Standard_False, Standard_False, P, D1U, D1V, D2U, D2V,
                     D2UV);
    }
}
...
void Geom_BezierSurface::D3(const Standard_Real U, const Standard_Real V, gp_Pnt& P, gp_Vec& D1U, gp_Vec& D1V,
    ...
    bidvmults.Init(VDegree() + 1);
    if (urational || vrational) {
        BSplSLib::D3(U, V, 0, 0, poles->Array2(), &weights->Array2(), biduknots, bidvknots, &bidumults, &bidvmults,
                     UDegree(), VDegree(), urational, vrational, 0, 0, P, D1U, D1V, D2U, D2V, D2UV, D3U, D3V, D3UUV,
                     D3UVV);
    } else {
        BSplSLib::D3(U, V, 0, 0, poles->Array2(), BSplSLib::NoWeights(), biduknots, bidvknots, &bidumults, &bidvmults,
                     UDegree(), VDegree(), urational, vrational, 0, 0, P, D1U, D1V, D2U, D2V, D2UV, D3U, D3V, D3UUV,
                     D3UVV);
    }
}
...
gp_Vec Geom_BezierSurface::DN(const Standard_Real U, const Standard_Real V, const Standard_Integer Nu,
    ...
    bidvmults.Init(VDegree() + 1);
    if (urational || vrational) {
        BSplSLib::DN(U, V, Nu, Nv, 0, 0, poles->Array2(), &weights->Array2(), biduknots, bidvknots, &bidumults,
                     &bidvmults, UDegree(), VDegree(), urational, vrational, 0, 0, Derivative);
    } else {
        BSplSLib::DN(U, V, Nu, Nv, 0, 0, poles->Array2(), BSplSLib::NoWeights(), biduknots, bidvknots, &bidumults,
                     &bidvmults, UDegree(), VDegree(), urational, vrational, 0, 0, Derivative);
    }
    return Derivative;
}
...
const gp_Pnt& Geom_BezierSurface::Pole(const Standard_Integer UIndex, const Standard_Integer VIndex) const {
...
void Geom_BezierSurface::Poles(TColgp_Array2OfPnt& P) const {
    Standard_DimensionError_Raise_if(P.RowLength() != poles->RowLength() || P.ColLength() != poles->ColLength(), " ");
    P = poles->Array2();
}
...
Handle(Geom_Curve) Geom_BezierSurface::UIso(const Standard_Real U) const {
    ...
    if (urational || vrational) {
        ...
        BSplSLib::Iso(U, 1, Poles, &Weights, biduknots, &bidumults, UDegree(), 0, VCurvePoles, &VCurveWeights);
        if (urational)
            UIsoCurve = new Geom_BezierCurve(VCurvePoles, VCurveWeights);
        else
            UIsoCurve = new Geom_BezierCurve(VCurvePoles);
    } else {
        BSplSLib::Iso(U, 1, Poles, BSplSLib::NoWeights(), biduknots, &bidumults, UDegree(), 0, VCurvePoles,
                      PLib::NoWeights());
        UIsoCurve = new Geom_BezierCurve(VCurvePoles);
    }
    return UIsoCurve;
...
Handle(Geom_Curve) Geom_BezierSurface::VIso(const Standard_Real V) const {
    ...
    if (vrational || urational) {
        ...
        BSplSLib::Iso(V, 0, Poles, &Weights, bidvknots, &bidvmults, VDegree(), 0, VCurvePoles, &VCurveWeights);
        if (vrational)
            VIsoCurve = new Geom_BezierCurve(VCurvePoles, VCurveWeights);
        else
            VIsoCurve = new Geom_BezierCurve(VCurvePoles);
    } else {
        BSplSLib::Iso(V, 0, Poles, BSplSLib::NoWeights(), bidvknots, &bidvmults, VDegree(), 0, VCurvePoles,
                      PLib::NoWeights());
        VIsoCurve = new Geom_BezierCurve(VCurvePoles);
    }
    return VIsoCurve;
...
Standard_Real Geom_BezierSurface::Weight(const Standard_Integer UIndex, const Standard_Integer VIndex) const {
...
void Geom_BezierSurface::Weights(TColStd_Array2OfReal& W) const {
    Standard_DimensionError_Raise_if(W.RowLength() != weights->RowLength() || W.ColLength() != weights->ColLength(),
                                     " ");
    if (urational || vrational)
        W = weights->Array2();
    else
...
void Geom_BezierSurface::Resolution(const Standard_Real Tolerance3D, Standard_Real& UTolerance,
    ...
    if (!maxderivinvok) {
        ...
        bidvmults.Init(VDegree() + 1);
        if (urational || vrational) {
            BSplSLib::Resolution(poles->Array2(), &weights->Array2(), biduknots, bidvknots, bidumults, bidvmults,
                                 UDegree(), VDegree(), urational, vrational, 0, 0, 1., umaxderivinv, vmaxderivinv);
        } else {
            BSplSLib::Resolution(poles->Array2(), BSplSLib::NoWeights(), biduknots, bidvknots, bidumults, bidvmults,
                                 UDegree(), VDegree(), urational, vrational, 0, 0, 1., umaxderivinv, vmaxderivinv);
        }
        maxderivinvok = 1;
    }
...
void Geom_BezierSurface::DumpJson(Standard_OStream& theOStream, Standard_Integer theDepth) const {
    ...
    if (!poles.IsNull()) OCCT_DUMP_FIELD_VALUE_NUMERICAL(theOStream, poles->Size())
    if (!weights.IsNull()) OCCT_DUMP_FIELD_VALUE_NUMERICAL(theOStream, weights->Size())
