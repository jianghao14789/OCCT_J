...
//=======================================================================
static void CheckCurveData(const TColgp_Array1OfPnt& CPoles, const TColStd_Array1OfReal& CKnots,
...
Handle(Geom_Geometry) Geom_BSplineCurve::Copy() const {
    ...
    if (IsRational())
        C = new Geom_BSplineCurve(poles->Array1(), weights->Array1(), knots->Array1(), mults->Array1(), deg, periodic);
    else
...
Geom_BSplineCurve::Geom_BSplineCurve(const TColgp_Array1OfPnt& Poles, const TColStd_Array1OfReal& Knots,
...
Geom_BSplineCurve::Geom_BSplineCurve(const TColgp_Array1OfPnt& Poles, const TColStd_Array1OfReal& Weights,
...

{
    ...
    if (CheckRational) rational = Rational(Weights);
...
void Geom_BSplineCurve::IncreaseDegree(const Standard_Integer Degree) {
    ...
    Handle(TColgp_HArray1OfPnt) npoles = new TColgp_HArray1OfPnt(1, poles->Length() + Step * (ToK2 - FromK1));
...
void Geom_BSplineCurve::IncreaseMultiplicity(const Standard_Integer I1, const Standard_Integer I2,
...
void Geom_BSplineCurve::IncrementMultiplicity(const Standard_Integer I1, const Standard_Integer I2,
...
void Geom_BSplineCurve::InsertKnot(const Standard_Real U, const Standard_Integer M,
...
void Geom_BSplineCurve::InsertKnots(const TColStd_Array1OfReal& Knots, const TColStd_Array1OfInteger& Mults,
...
Standard_Boolean Geom_BSplineCurve::RemoveKnot(const Standard_Integer Index, const Standard_Integer M,
...
void Geom_BSplineCurve::Segment(const Standard_Real U1, const Standard_Real U2, const Standard_Real theTolerance) {
    if (U2 < U1) throw Standard_DomainError("Geom_BSplineCurve::Segment");
    ...
    if (periodic) {
        ...
        DU = U2 - U1;
        if (DU - Period > Precision::PConfusion()) throw Standard_DomainError("Geom_BSplineCurve::Segment");
    ...
    if (Abs(knots->Value(index1 + 1) - U) <= Eps) index1++;

    BSplCLib::LocateParameter(deg, knots->Array1(), mults->Array1(), NewU2, periodic, FromU1, ToU2, index2, U);
    if (Abs(knots->Value(index2 + 1) - U) <= Eps || index2 == index1) index2++;
...
void Geom_BSplineCurve::SetOrigin(const Standard_Integer Index) {
    if (!periodic) throw Standard_NoSuchObject("Geom_BSplineCurve::SetOrigin");

    Standard_Integer i, k;
    Standard_Integer first = FirstUKnotIndex();
    Standard_Integer last = LastUKnotIndex();

    if ((Index < first) || (Index > last)) throw Standard_DomainError("Geom_BSplineCurve::SetOrigin");
...
void Geom_BSplineCurve::SetPole(const Standard_Integer Index, const gp_Pnt& P, const Standard_Real W) {
    SetPole(Index, P);
    SetWeight(Index, W);
}
...
void Geom_BSplineCurve::MovePoint(const Standard_Real U, const gp_Pnt& P, const Standard_Integer Index1,
...
void Geom_BSplineCurve::MovePointAndTangent(const Standard_Real U, const gp_Pnt& P, const gp_Vec& Tangent,
