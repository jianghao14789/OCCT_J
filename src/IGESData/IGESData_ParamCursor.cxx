...
IGESData_ParamCursor::IGESData_ParamCursor(const Standard_Integer num, const Standard_Integer nb,
...
void IGESData_ParamCursor::SetTerm(const Standard_Integer size, const Standard_Boolean autoadv) {
    ...
    if (theoffst + thetsize > theisize)
        throw Interface_InterfaceError("IGESDAta ParamCursor : required Term size overpass whole Item size");
}
