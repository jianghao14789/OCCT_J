...
public:
    ...
    template <class T>
    void
    Send(const Handle(T) & val, Standard_Boolean negative = Standard_False,
...
private:
    ...
    //! <more>, if precised, requires that <more> characters will
    //! remain free on the current line once this AddString done
    Standard_EXPORT void AddString(const Standard_CString val, const Standard_Integer lnval = 0,
