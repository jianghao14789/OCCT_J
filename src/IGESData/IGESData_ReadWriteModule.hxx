...
public:
    ...
    Standard_EXPORT void Read(const Standard_Integer CN, const Handle(Interface_FileReaderData) & data,
    ...
    //! in ParamReader
    Standard_EXPORT virtual void ReadOwnParams(const Standard_Integer CN, const Handle(IGESData_IGESEntity) & ent,
    ...
    Standard_EXPORT virtual void WriteOwnParams(const Standard_Integer CN, const Handle(IGESData_IGESEntity) & ent,
