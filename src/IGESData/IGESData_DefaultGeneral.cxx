...
void IGESData_DefaultGeneral::OwnSharedCase(const Standard_Integer CN, const Handle(IGESData_IGESEntity) & ent,
...
void IGESData_DefaultGeneral::OwnCheckCase(const Standard_Integer, const Handle(IGESData_IGESEntity) &,
                                           const Interface_ShareTool&, Handle(Interface_Check) &) const {
} // aucun critere specifique

Standard_Boolean IGESData_DefaultGeneral::NewVoid(const Standard_Integer CN, Handle(Standard_Transient) & entto) const {
    entto.Nullify();
...
void IGESData_DefaultGeneral::OwnCopyCase(const Standard_Integer CN, const Handle(IGESData_IGESEntity) & entfrom,
