...
public:
    ...
    Standard_EXPORT IGESData_ParamReader(const Handle(Interface_ParamList) & list, const Handle(Interface_Check) & ach,
                                         const Standard_Integer base = 1, const Standard_Integer nbpar = 0,
    ...
    Standard_EXPORT Handle(IGESData_IGESEntity)
        ParamEntity(const Handle(IGESData_IGESReaderData) & IR, const Standard_Integer num);
    ...
    //! and returns False
    Standard_EXPORT Standard_Boolean ReadInteger(const IGESData_ParamCursor& PC, const Standard_CString mess,
                                                 Standard_Integer& val);

    Standard_EXPORT Standard_Boolean ReadBoolean(const IGESData_ParamCursor& PC, const Message_Msg& amsg,
                                                 Standard_Boolean& val, const Standard_Boolean exact = Standard_True);
    ...
    Standard_EXPORT Standard_Boolean ReadBoolean(const IGESData_ParamCursor& PC, const Standard_CString mess,
                                                 Standard_Boolean& val, const Standard_Boolean exact = Standard_True);
    ...
    Standard_EXPORT Standard_Boolean ReadReal(const IGESData_ParamCursor& PC, const Standard_CString mess,
                                              Standard_Real& val);
    ...
    Standard_EXPORT Standard_Boolean ReadText(const IGESData_ParamCursor& PC, const Message_Msg& amsg,
    ...
    //! and returns False
    Standard_EXPORT Standard_Boolean ReadText(const IGESData_ParamCursor& PC, const Standard_CString mess,
                                              Handle(TCollection_HAsciiString) & val);
    ...
    template <class T>
    Standard_Boolean ReadEntity(const Handle(IGESData_IGESReaderData) & IR, const IGESData_ParamCursor& PC,
                                IGESData_Status& aStatus, const Handle(Standard_Type) & type, Handle(T) & val,
                                const Standard_Boolean canbenul = Standard_False) {
    ...
    template <class T>
    Standard_Boolean ReadEntity(const Handle(IGESData_IGESReaderData) & IR, const IGESData_ParamCursor& PC,
                                const Standard_CString mess, const Handle(Standard_Type) & type, Handle(T) & val,
                                const Standard_Boolean canbenul = Standard_False) {
        Handle(IGESData_IGESEntity) aVal = val;
    ...
    Standard_EXPORT Standard_Boolean ReadInts(const IGESData_ParamCursor& PC, const Message_Msg& amsg,
                                              Handle(TColStd_HArray1OfInteger) & val, const Standard_Integer index = 1);
    ...
    Standard_EXPORT Standard_Boolean ReadInts(const IGESData_ParamCursor& PC, const Standard_CString mess,
                                              Handle(TColStd_HArray1OfInteger) & val, const Standard_Integer index = 1);

    Standard_EXPORT Standard_Boolean ReadReals(const IGESData_ParamCursor& PC, Message_Msg& amsg,
                                               Handle(TColStd_HArray1OfReal) & val, const Standard_Integer index = 1);
    ...
    Standard_EXPORT Standard_Boolean ReadReals(const IGESData_ParamCursor& PC, const Standard_CString mess,
                                               Handle(TColStd_HArray1OfReal) & val, const Standard_Integer index = 1);

    Standard_EXPORT Standard_Boolean ReadTexts(const IGESData_ParamCursor& PC, const Message_Msg& amsg,
    ...
    //! and return value is False
    Standard_EXPORT Standard_Boolean ReadTexts(const IGESData_ParamCursor& PC, const Standard_CString mess,
                                               Handle(Interface_HArray1OfHAsciiString) & val,
                                               const Standard_Integer index = 1);
    ...
    Standard_EXPORT Standard_Boolean ReadEntList(const Handle(IGESData_IGESReaderData) & IR,
                                                 ...
                                                 Interface_EntityList& val, const Standard_Boolean ord = Standard_True);
    ...
    Standard_EXPORT Standard_Boolean ReadingReal(const Standard_Integer num, const Standard_CString mess,
                                                 Standard_Real& val);
    ...
    Standard_EXPORT Standard_Boolean ReadingEntityNumber(const Standard_Integer num, const Standard_CString mess,
                                                         Standard_Integer& val);
...
protected:
private:
    Standard_EXPORT Standard_Boolean PrepareRead(const IGESData_ParamCursor& PC, const Standard_Boolean several,
    ...
    Standard_EXPORT Standard_Boolean PrepareRead(const IGESData_ParamCursor& PC, const Standard_CString mess,
                                                 const Standard_Boolean several, const Standard_Integer size = 1);
    ...
    Standard_EXPORT void AddFail(const Standard_CString idm, const Handle(TCollection_HAsciiString) & af,
                                 const Handle(TCollection_HAsciiString) & bf);

    //! Same as above but with CString
    //! <bf> empty means = <af>
    Standard_EXPORT void AddFail(const Standard_CString idm, const Standard_CString afail,
    ...
    //! Also feeds LastReadStatus
    Standard_EXPORT void AddWarning(const Standard_CString idm, const Handle(TCollection_HAsciiString) & aw,
                                    const Handle(TCollection_HAsciiString) & bw);
