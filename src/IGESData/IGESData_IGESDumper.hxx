...
public:
    ...
    Standard_EXPORT void Dump(const Handle(IGESData_IGESEntity) & ent, Standard_OStream& S, const Standard_Integer own,
    ...
    Standard_EXPORT void OwnDump(const Handle(IGESData_IGESEntity) & ent, Standard_OStream& S,
