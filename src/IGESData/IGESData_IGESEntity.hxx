...
public:
    ...
    Standard_EXPORT void InitStatus(const Standard_Integer blank, const Standard_Integer subordinate,
    ...
    Standard_EXPORT Handle(IGESData_IGESEntity)
        TypedProperty(const Handle(Standard_Type) & atype, const Standard_Integer anum = 0) const;
    ...
    Standard_EXPORT void SetLineWeight(const Standard_Real defw, const Standard_Real maxw,
