...
IGESData_DirChecker::IGESData_DirChecker(const Standard_Integer atype, const Standard_Integer aform1,
...
void IGESData_DirChecker::Check(Handle(Interface_Check) & ach, const Handle(IGESData_IGESEntity) & ent) const {
    // MGE 23/07/98
    // =====================================
...
Standard_Boolean IGESData_DirChecker::Correct(const Handle(IGESData_IGESEntity) & ent) const {
    ...
    if (thegraphier != -1 && thelineweig != IGESData_DefVoid) linew = ent->LineWeightNumber();
