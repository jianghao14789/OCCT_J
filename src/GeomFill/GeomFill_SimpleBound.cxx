...
// purpose  :
//=======================================================================
GeomFill_SimpleBound::GeomFill_SimpleBound(const Handle(Adaptor3d_Curve) & Curve, const Standard_Real Tol3d,
...
void GeomFill_SimpleBound::Reparametrize(const Standard_Real First, const Standard_Real Last,
    ...
    Handle(Law_BSpline) curve = Law::Reparametrize(*myC3d, First, Last, HasDF, HasDL, DF, DL, Rev, 30);
