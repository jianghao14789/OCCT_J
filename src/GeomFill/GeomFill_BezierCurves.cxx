...
//=======================================================================
static void SetSameWeights(TColStd_Array1OfReal& W1, TColStd_Array1OfReal& W2, TColStd_Array1OfReal& W3,
...
static Standard_Boolean Arrange(const Handle(Geom_BezierCurve) & C1, const Handle(Geom_BezierCurve) & C2,
                                const Handle(Geom_BezierCurve) & C3, const Handle(Geom_BezierCurve) & C4,
                                Handle(Geom_BezierCurve) & CC1, Handle(Geom_BezierCurve) & CC2,
                                Handle(Geom_BezierCurve) & CC3, Handle(Geom_BezierCurve) & CC4,
...
GeomFill_BezierCurves::GeomFill_BezierCurves(const Handle(Geom_BezierCurve) & C1, const Handle(Geom_BezierCurve) & C2,
                                             const Handle(Geom_BezierCurve) & C3, const Handle(Geom_BezierCurve) & C4,
...
GeomFill_BezierCurves::GeomFill_BezierCurves(const Handle(Geom_BezierCurve) & C1, const Handle(Geom_BezierCurve) & C2,
                                             const Handle(Geom_BezierCurve) & C3, const GeomFill_FillingStyle Type) {
    Init(C1, C2, C3, Type);
}
...
void GeomFill_BezierCurves::Init(const Handle(Geom_BezierCurve) & C1, const Handle(Geom_BezierCurve) & C2,
                                 const Handle(Geom_BezierCurve) & C3, const Handle(Geom_BezierCurve) & C4,
                                 const GeomFill_FillingStyle Type) {
...
void GeomFill_BezierCurves::Init(const Handle(Geom_BezierCurve) & C1, const Handle(Geom_BezierCurve) & C2,
    ...
    if (Type != GeomFill_CurvedStyle) {
        ...
        if (!IsOK) throw Standard_OutOfRange("GeomFill_BezierCurves: Courbes non jointives");
