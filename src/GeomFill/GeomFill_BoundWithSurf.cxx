...
// purpose  :
//=======================================================================
GeomFill_BoundWithSurf::GeomFill_BoundWithSurf(const Adaptor3d_CurveOnSurface& CurveOnSurf, const Standard_Real Tol3d,
...
gp_Vec GeomFill_BoundWithSurf::Norm(const Standard_Real U) const {
    ...
    if (!HasNormals()) throw Standard_Failure("BoundWithSurf Norm : pas de contrainte");
...
void GeomFill_BoundWithSurf::Reparametrize(const Standard_Real First, const Standard_Real Last,
                                           const Standard_Boolean HasDF, const Standard_Boolean HasDL,
                                           const Standard_Real DF, const Standard_Real DL, const Standard_Boolean Rev) {
    Handle(Law_BSpline) curve = Law::Reparametrize(myConS, First, Last, HasDF, HasDL, DF, DL, Rev, 30);
