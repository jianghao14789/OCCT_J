...
public:
    ...
    Standard_EXPORT void Init(const Handle(GeomFill_Boundary) & B1, const Handle(GeomFill_Boundary) & B2,
                              const Handle(GeomFill_Boundary) & B3, const Standard_Boolean NoCheck = Standard_False);
    ...
    Standard_EXPORT Standard_Integer Eval(const Standard_Real W, const Standard_Integer Ord,
