...
//*******************************************************
GeomFill_FunctionDraft::GeomFill_FunctionDraft(const Handle(Adaptor3d_Surface) & S, const Handle(Adaptor3d_Curve) & C) {
    TheCurve = C;
    TheSurface = S;
}
...
//*******************************************************
Standard_Boolean GeomFill_FunctionDraft::Values(const math_Vector& X, math_Vector& F, math_Matrix& D) {
    Standard_Integer i;
    gp_Pnt P, P1;
    gp_Vec DP, DP1U, DP1V;
...
//*******************************************************
Standard_Boolean GeomFill_FunctionDraft::DerivT(const Handle(Adaptor3d_Curve) & C, const Standard_Real Param,
...
//*******************************************************
Standard_Boolean GeomFill_FunctionDraft::Deriv2T(const Handle(Adaptor3d_Curve) & C, const Standard_Real Param,
...
//*******************************************************
Standard_Boolean GeomFill_FunctionDraft::DerivTX(const gp_Vec& dN, const Standard_Real teta, math_Matrix& D) {
    //  gp_Pnt P;
    //  gp_Vec DP,D2P;
