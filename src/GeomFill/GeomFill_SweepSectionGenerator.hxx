...
public:
    ...
    //! guide-line.
    Standard_EXPORT GeomFill_SweepSectionGenerator(const Handle(Geom_Curve) & Path, const Handle(Geom_Curve) & Curve1,
    ...
    Standard_EXPORT void Init(const Handle(Geom_Curve) & Path, const Handle(Geom_Curve) & Curve1,
                              const Handle(Geom_Curve) & Curve2, const Standard_Real Radius);
    ...
    Standard_EXPORT Standard_Boolean Section(const Standard_Integer P, TColgp_Array1OfPnt& Poles,
    ...
    Standard_EXPORT void Section(const Standard_Integer P, TColgp_Array1OfPnt& Poles, TColgp_Array1OfPnt2d& Poles2d,
