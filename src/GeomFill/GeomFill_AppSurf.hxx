...
public:
    ...
    Standard_EXPORT GeomFill_AppSurf(const Standard_Integer Degmin, const Standard_Integer Degmax,
    ...
    Standard_EXPORT void Perform(const Handle(GeomFill_Line) & Lin, GeomFill_SectionGenerator& SecGen,
...
protected:
private:
    Standard_EXPORT void InternalPerform(const Handle(GeomFill_Line) & Lin, GeomFill_SectionGenerator& SecGen,
