...
public:
    ...
    Standard_EXPORT void Set(const Handle(GeomFill_SectionLaw) & Section, const Standard_Boolean rotat,
    ...
    Standard_EXPORT virtual Standard_Boolean D1(const Standard_Real Param, gp_Mat& M, gp_Vec& V, gp_Mat& DM, gp_Vec& DV,
    ...
    Standard_EXPORT virtual Standard_Boolean D2(const Standard_Real Param, gp_Mat& M, gp_Vec& V, gp_Mat& DM, gp_Vec& DV,
