...
GeomFill_PolynomialConvertor::GeomFill_PolynomialConvertor()
    : Ordre(8), myinit(Standard_False), BH(1, Ordre, 1, Ordre) {}
...
void GeomFill_PolynomialConvertor::Section(const gp_Pnt& FirstPnt, const gp_Pnt& Center, const gp_Vec& Dir,
                                           const Standard_Real Angle, TColgp_Array1OfPnt& Poles) const {
...
void GeomFill_PolynomialConvertor::Section(const gp_Pnt& FirstPnt, const gp_Vec& DFirstPnt, const gp_Pnt& Center,
                                           const gp_Vec& DCenter, const gp_Vec& Dir, const gp_Vec& DDir,
                                           const Standard_Real Angle, const Standard_Real DAngle,
                                           TColgp_Array1OfPnt& Poles, TColgp_Array1OfVec& DPoles) const {
...
void GeomFill_PolynomialConvertor::Section(const gp_Pnt& FirstPnt, const gp_Vec& DFirstPnt, const gp_Vec& D2FirstPnt,
                                           ...
                                           TColgp_Array1OfVec& DPoles, TColgp_Array1OfVec& D2Poles) const {
    math_Vector Vx(1, Ordre), Vy(1, Ordre), DVx(1, Ordre), DVy(1, Ordre), D2Vx(1, Ordre), D2Vy(1, Ordre);
    math_Vector Px(1, Ordre), Py(1, Ordre), DPx(1, Ordre), DPy(1, Ordre), D2Px(1, Ordre), D2Py(1, Ordre);
