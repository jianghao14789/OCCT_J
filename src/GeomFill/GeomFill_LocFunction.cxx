...
Standard_Boolean GeomFill_LocFunction::D2(const Standard_Real Param,
    ...
    gp_Mat aM, aDM, aD2M;
    Standard_Boolean B;
    B = myLaw->D2(Param, aM, V.ChangeValue(1), aDM, DV.ChangeValue(1), aD2M, D2V.ChangeValue(1), T1, T2, T3);
    V(2).SetXYZ(aM.Column(1));
    V(3).SetXYZ(aM.Column(2));
    V(4).SetXYZ(aM.Column(3));
...
void GeomFill_LocFunction::DN(const Standard_Real Param, const Standard_Real First, const Standard_Real Last,
                              const Standard_Integer Order, Standard_Real& Result, Standard_Integer& Ier) {
    Standard_Boolean B;
