...
//==============================================
GeomFill_FunctionGuide::GeomFill_FunctionGuide(const Handle(GeomFill_SectionLaw) & S, const Handle(Adaptor3d_Curve) & C,
                                               const Standard_Real Param)
    : TheGuide(C), TheLaw(S), isconst(Standard_False), First(0.0), Last(0.0), TheUonS(Param) {
...
void GeomFill_FunctionGuide::SetParam(const Standard_Real, const gp_Pnt& C, const gp_XYZ& D, const gp_XYZ& DX) {
    Centre = C.XYZ();
    Dir = D;
...
//==============================================
Standard_Boolean GeomFill_FunctionGuide::Values(const math_Vector& X, math_Vector& F, math_Matrix& D) {
    gp_Pnt P, P1;
    gp_Vec DP, DP1U, DP1V;
...
//==============================================
Standard_Boolean GeomFill_FunctionGuide::DerivT(const math_Vector& X, const gp_XYZ& DCentre, const gp_XYZ& DDir,
                                                math_Vector& F) {
    gp_Pnt P;
    gp_Vec DS;
...
//=========================================================
void GeomFill_FunctionGuide::DSDT(const Standard_Real U, const Standard_Real V, const gp_XYZ& DC, const gp_XYZ& DDir,
                                  gp_Vec& DS) const {
