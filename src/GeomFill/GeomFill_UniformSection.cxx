...
GeomFill_UniformSection::GeomFill_UniformSection(const Handle(Geom_Curve) & C, const Standard_Real FirstParameter,
                                                 const Standard_Real LastParameter)
    : First(FirstParameter), Last(LastParameter) {
...
// Purpose :D0
//=======================================================
Standard_Boolean GeomFill_UniformSection::D0(const Standard_Real, TColgp_Array1OfPnt& Poles,
...
// Purpose :D1
//=======================================================
Standard_Boolean GeomFill_UniformSection::D1(const Standard_Real, TColgp_Array1OfPnt& Poles, TColgp_Array1OfVec& DPoles,
...
// Purpose :D2
//=======================================================
Standard_Boolean GeomFill_UniformSection::D2(const Standard_Real, TColgp_Array1OfPnt& Poles, TColgp_Array1OfVec& DPoles,
...
Handle(Geom_BSplineSurface) GeomFill_UniformSection::BSplineSurface() const {
    ...
    Handle(Geom_BSplineSurface) BS =
        new (Geom_BSplineSurface)(Poles, UKnots, VKnots, UMults, VMults, myCurve->Degree(), 1, myCurve->IsPeriodic());
...
//=======================================================
void GeomFill_UniformSection::SectionShape(Standard_Integer& NbPoles, Standard_Integer& NbKnots,
...
//=======================================================
void GeomFill_UniformSection::GetTolerance(const Standard_Real BoundTol, const Standard_Real SurfTol,
