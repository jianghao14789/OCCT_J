...
// purpose  : calculation of trihedron
//=======================================================================
Standard_Boolean GeomFill_GuideTrihedronAC::D0(const Standard_Real Param, gp_Vec& Tangent, gp_Vec& Normal,
                                               gp_Vec& BiNormal) {
...
//=======================================================================
Standard_Boolean GeomFill_GuideTrihedronAC::D1(const Standard_Real Param, gp_Vec& Tangent, gp_Vec& DTangent,
...
//=======================================================================
Standard_Boolean GeomFill_GuideTrihedronAC::D2(const Standard_Real Param, gp_Vec& Tangent, gp_Vec& DTangent,
    ...
    d2tp_dt2 =
        (Orig2 - Orig1) * (Lguide / L) * (DTo.Dot(To) / (NTo * NTG) - N2To * TG * DTG * (Lguide / L) / (N2Tp * N2Tp));
...
// derivee seconde du triedre
    ...
    D2Tangent.SetLinearForm(1, D2Normal.Crossed(BiNormal), 2, DNormal.Crossed(DBiNormal), Normal.Crossed(D2BiNormal));
