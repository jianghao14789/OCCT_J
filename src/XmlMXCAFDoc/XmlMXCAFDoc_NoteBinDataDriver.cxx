...
Standard_Boolean XmlMXCAFDoc_NoteBinDataDriver::Paste(const XmlObjMgt_Persistent& theSource,
    ...
    if (aTitle == NULL || aMIMEtype == NULL || aSize == NULL) return Standard_False;
    ...
    if (!aSize.GetInteger(nbSize)) return Standard_False;
...
// purpose  :
//=======================================================================
void XmlMXCAFDoc_NoteBinDataDriver::Paste(const Handle(TDF_Attribute) & theSource, XmlObjMgt_Persistent& theTarget,
