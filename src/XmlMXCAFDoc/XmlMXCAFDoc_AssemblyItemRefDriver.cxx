...
Standard_Boolean XmlMXCAFDoc_AssemblyItemRefDriver::Paste(const XmlObjMgt_Persistent& theSource,
    ...
    if (aPath == NULL) return Standard_False;
    ...
    if (aSubshapeIndex != NULL) {
        ...
        if (!aSubshapeIndex.GetInteger(anIndex)) return Standard_False;
...
// purpose  :
//=======================================================================
void XmlMXCAFDoc_AssemblyItemRefDriver::Paste(const Handle(TDF_Attribute) & theSource, XmlObjMgt_Persistent& theTarget,
