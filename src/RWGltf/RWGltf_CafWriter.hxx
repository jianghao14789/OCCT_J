...
public:
    ...
    Standard_EXPORT RWGltf_CafWriter(const TCollection_AsciiString& theFile, Standard_Boolean theIsBinary);
...
protected:
    ...
    Standard_EXPORT virtual TCollection_AsciiString formatName(RWMesh_NameFormat theFormat, const TDF_Label& theLabel,
    ...
    Standard_EXPORT virtual void saveNodes(RWGltf_GltfFace& theGltfFace, std::ostream& theBinFile,
    ...
    //! @param theFaceIter [in]  current face to write
    //! @param theAccessorNb [in] [out] last accessor index
    Standard_EXPORT virtual void saveNormals(RWGltf_GltfFace& theGltfFace, std::ostream& theBinFile,
    ...
    //! @param theFaceIter [in]  current face to write
    //! @param theAccessorNb [in] [out] last accessor index
    Standard_EXPORT virtual void saveTextCoords(RWGltf_GltfFace& theGltfFace, std::ostream& theBinFile,
                                                const RWMesh_FaceIterator& theFaceIter,
                                                Standard_Integer& theAccessorNb) const;
    ...
    //! @param theFaceIter [in]  current face to write
    //! @param theAccessorNb [in] [out] last accessor index
    Standard_EXPORT virtual void saveIndices(RWGltf_GltfFace& theGltfFace, std::ostream& theBinFile,
...
protected:
    ...
    Standard_EXPORT virtual void writePrimArray(const RWGltf_GltfFace& theGltfFace,
                                                const TCollection_AsciiString& theName, bool& theToStartPrims);
...
protected:
    ...
    public:
        ...
        static Standard_Boolean IsEqual(const RWGltf_StyledShape& theS1, const RWGltf_StyledShape& theS2) {
            return theS1.Shape.IsSame(theS2.Shape) && theS1.Style.IsEqual(theS2.Style);
        }
    };

    typedef NCollection_IndexedDataMap<RWGltf_StyledShape, Handle(RWGltf_GltfFaceList), RWGltf_StyledShape>
        ShapeToGltfFaceMap;
...
protected:
    ...
    opencascade::std::shared_ptr<RWGltf_GltfOStreamWriter> myWriter; //!< JSON writer
