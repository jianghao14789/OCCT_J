...
public:
    ...
    //! Empty constructor.
    RWGltf_GltfAccessor()
        : Id(INVALID_ID), ByteOffset(0), Count(0), ByteStride(0), Type(RWGltf_GltfAccessorLayout_UNKNOWN),
          ComponentType(RWGltf_GltfAccessorCompType_UNKNOWN), IsCompressed(false) {}
};
