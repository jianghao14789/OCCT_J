...
static Standard_ShortReal takeColorComponentFromInteger(ColorInteger& theColorInteger,
    ...
    Standard_ASSERT_RETURN(theColorComponentBase >= 2, "'theColorComponentBase' must be greater than 1.", 0.0f);
...
static bool convertIntegerToColorRGBA(ColorInteger theColorInteger, const ColorInteger theColorComponentBase,
                                      const bool hasAlphaComponent, Quantity_ColorRGBA& theColor) {
    Standard_ASSERT_RETURN(theColorComponentBase >= 2, "'theColorComponentBase' must be greater than 1.", 0.0f);
...
// purpose  :
//=======================================================================
bool Quantity_ColorRGBA::ColorFromHex(const char* const theHexColorString, Quantity_ColorRGBA& theColor,
    ...
    switch (static_cast<HexColorLength>(aHexColorStringLength)) {
        ...
        Standard_FALLTHROUGH case HexColorLength_ShortRGB:
            isShort = true;
            break;
...
Standard_Boolean Quantity_ColorRGBA::InitFromJson(const Standard_SStream& theSStream, Standard_Integer& theStreamPos) {
    ...
    SetValues((Standard_ShortReal)aRed, (Standard_ShortReal)aGreen, (Standard_ShortReal)aBlue,
