...
// purpose  :
//=======================================================================
Intrv_Interval::Intrv_Interval() : myStart(RealFirst()), myEnd(RealLast()) {
...
Intrv_Interval::Intrv_Interval(const Standard_Real Start, const Standard_Real End) : myStart(Start), myEnd(End) {
...
Intrv_Interval::Intrv_Interval(const Standard_Real Start, const Standard_ShortReal TolStart, const Standard_Real End,
                               const Standard_ShortReal TolEnd)
    : myStart(Start), myEnd(End), myTolStart(TolStart), myTolEnd(TolEnd) {
