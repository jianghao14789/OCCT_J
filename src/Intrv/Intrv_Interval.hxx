...
public:
    ...
    Standard_EXPORT Intrv_Interval(const Standard_Real Start, const Standard_ShortReal TolStart,
    ...
    void Bounds(Standard_Real& Start, Standard_ShortReal& TolStart, Standard_Real& End,
                Standard_ShortReal& TolEnd) const;
