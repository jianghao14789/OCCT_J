...
// Standard_IMPORT Standard_Boolean FUN_DetectEdgeswithfaultyUV(const TopoDS_Face& Fin, const TopoDS_Shape& fF, const
// TopTools_ListOfShape& ISOEds, 						const Standard_Boolean has2fybounds, TopTools_ListOfShape& lfyE, Standard_Integer&
//Ivfaulty, 						const Standard_Boolean& stopatfirst=Standard_False); Standard_IMPORT Standard_Boolean
// FUN_DetectEdgewithfaultyUV(const TopoDS_Face& Fin, const TopoDS_Shape& fF, const TopTools_ListOfShape& ISOEds, 					       const
//Standard_Boolean has2fybounds, TopoDS_Shape& fyE, Standard_Integer& Ivfaulty); Standard_IMPORT Standard_Boolean
// FUN_DetectFaultyClosingEdge(const TopoDS_Face& Fin,const TopTools_ListOfShape& Eds,const TopTools_ListOfShape&
// cEds,TopTools_ListOfShape& fyE); Standard_IMPORT Standard_Boolean FUN_isUVClosed(const TopoDS_Face& F, const
// TopoDS_Face& fF);
