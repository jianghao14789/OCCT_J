...
public:
    ...
    Standard_EXPORT static Standard_Boolean WireToFace(const TopoDS_Face& Fanc, const TopTools_ListOfShape& nWs,
    ...
    Standard_EXPORT Standard_Boolean NearestF(const TopoDS_Edge& e, const TopTools_ListOfShape& lof,
