...
public:
    ...
    Standard_EXPORT TopAbs_State StateShapeShape(const TopoDS_Shape& S, const TopoDS_Shape& SRef,
    ...
    Standard_EXPORT TopAbs_State StateShapeShape(const TopoDS_Shape& S, const TopoDS_Shape& AvoidS,
    ...
    //! AvoidS is not used in classification; AvoidS may be IsNull().
    //! (useful to avoid ON or UNKNOWN state in special cases)
    Standard_EXPORT TopAbs_State StateShapeShape(const TopoDS_Shape& S, const TopTools_ListOfShape& LAvoidS,
                                                 const TopoDS_Shape& SRef);
