...
public:
    ...
    Standard_EXPORT Standard_Integer ClassiBnd2d(const TopoDS_Shape& S1, const TopoDS_Shape& S2,
                                                 const Standard_Real tol, const Standard_Boolean checklarge);

    Standard_EXPORT Standard_Integer Classip2d(const TopoDS_Shape& S1, const TopoDS_Shape& S2,
