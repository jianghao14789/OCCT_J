...
public:
    ...
    Standard_EXPORT static Standard_Boolean PurgeClosingEdges(const TopoDS_Face& F, const TopoDS_Face& FF,
                                                              const TopTools_DataMapOfShapeInteger& MWisOld,
                                                              TopTools_IndexedMapOfOrientedShape& MshNOK);

    Standard_EXPORT static Standard_Boolean PurgeClosingEdges(const TopoDS_Face& F, const TopTools_ListOfShape& LOF,
                                                              const TopTools_DataMapOfShapeInteger& MWisOld,
                                                              TopTools_IndexedMapOfOrientedShape& MshNOK);
    ...
    Standard_EXPORT static Standard_Boolean MakeFaces(const TopoDS_Face& F, const TopTools_ListOfShape& LOF,
    ...
    //! faces.
    Standard_EXPORT static Standard_Boolean Regularize(const TopoDS_Face& aFace, TopTools_ListOfShape& aListOfFaces,
    ...
    Standard_EXPORT static Standard_Boolean RegularizeWires(const TopoDS_Face& aFace,
    ...
    Standard_EXPORT static Standard_Boolean RegularizeFace(const TopoDS_Face& aFace,
    ...
    //! (face, splits of face).
    Standard_EXPORT static Standard_Boolean RegularizeShells(const TopoDS_Solid& aSolid,
