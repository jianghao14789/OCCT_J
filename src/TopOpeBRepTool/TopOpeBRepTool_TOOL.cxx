...
static Standard_Boolean CheckEdgeLength(const TopoDS_Edge& E) {
    ...
    if (anExtent != 1) return Standard_True;
...
Standard_Integer TopOpeBRepTool_TOOL::OriinSor(const TopoDS_Shape& sub, const TopoDS_Shape& S,
...
Standard_Boolean TopOpeBRepTool_TOOL::ClosedS(const TopoDS_Face& F) {
    ...
    if (uclosed) uclosed = S->IsUPeriodic();
    Standard_Boolean vclosed = S->IsVClosed();
    if (vclosed) vclosed = S->IsVPeriodic();
...
Standard_Boolean TopOpeBRepTool_TOOL::TgINSIDE(const TopoDS_Vertex& v, const TopoDS_Edge& E, gp_Vec& Tg,
...
Standard_Boolean TopOpeBRepTool_TOOL::TggeomE(const Standard_Real par, const BRepAdaptor_Curve& BC, gp_Vec& Tg) {
    // #ifdef OCCT_DEBUG
...
gp_Vec2d TopOpeBRepTool_TOOL::Tg2d(const Standard_Integer iv, const TopoDS_Edge& E, const TopOpeBRepTool_C2DF& C2DF) {
    Standard_Real f, l, tol;
    const Handle(Geom2d_Curve) & PC = C2DF.PC(f, l, tol);
...
gp_Vec2d TopOpeBRepTool_TOOL::Tg2dApp(const Standard_Integer iv, const TopoDS_Edge& E, const TopOpeBRepTool_C2DF& C2DF,
...
Standard_Boolean TopOpeBRepTool_TOOL::NgApp(const Standard_Real par, const TopoDS_Edge& e, const TopoDS_Face& f,
...
Standard_Boolean TopOpeBRepTool_TOOL::tryNgApp(const Standard_Real par, const TopoDS_Edge& e, const TopoDS_Face& f,
                                               const Standard_Real tola, gp_Dir& Ng) {
    gp_Pnt2d uv;
    Standard_Boolean ok = FUN_tool_paronEF(e, par, f, uv);
    if (!ok) return Standard_False;
...
static Standard_Boolean FUN_analyticcS(const gp_Pnt2d& uv0, const Handle(Geom_Surface) & S, const gp_Dir& ngS,
                                       const gp_Dir& tg0, Standard_Real& curv,
...
Standard_Boolean TopOpeBRepTool_TOOL::UVISO(const Handle(Geom2d_Curve) & PC, Standard_Boolean& isoU,
...
Standard_Boolean TopOpeBRepTool_TOOL::UVISO(const TopoDS_Edge& E, const TopoDS_Face& F, Standard_Boolean& isoU,
                                            Standard_Boolean& isoV, gp_Dir2d& d2d, gp_Pnt2d& o2d) {
...
Standard_Boolean TopOpeBRepTool_TOOL::UVISO(const TopOpeBRepTool_C2DF& C2DF, Standard_Boolean& isoU,
                                            Standard_Boolean& isoV, gp_Dir2d& d2d, gp_Pnt2d& o2d) {
    Standard_Real f, l, tol;
    const Handle(Geom2d_Curve) & PC = C2DF.PC(f, l, tol);
    // #ifdef OCCT_DEBUG
...
Standard_Boolean TopOpeBRepTool_TOOL::IsonCLO(const Handle(Geom2d_Curve) & PC, const Standard_Boolean onU,
...
Standard_Boolean TopOpeBRepTool_TOOL::IsonCLO(const TopOpeBRepTool_C2DF& C2DF, const Standard_Boolean onU,
                                              const Standard_Real xfirst, const Standard_Real xperiod,
                                              const Standard_Real xtol) {
    Standard_Real f, l, tol;
    const Handle(Geom2d_Curve) & PC = C2DF.PC(f, l, tol);
...
Standard_Boolean TopOpeBRepTool_TOOL::Matter(const gp_Dir& xx1, const gp_Dir& nt1, const gp_Dir& xx2, const gp_Dir& nt2,
...
Standard_Boolean TopOpeBRepTool_TOOL::uvApp(const TopoDS_Face& f, const TopoDS_Edge& e, const Standard_Real pare,
...
Standard_Boolean TopOpeBRepTool_TOOL::XX(const gp_Pnt2d& uv, const TopoDS_Face& f, const Standard_Real par,
...
Standard_Boolean TopOpeBRepTool_TOOL::Matter(const TopoDS_Face& f1, const TopoDS_Face& f2, const TopoDS_Edge& e,
                                             const Standard_Real par, const Standard_Real tola, Standard_Real& ang) {
    gp_Dir xx1, xx2;
    gp_Dir nt1, nt2;
...
#define ONFIRST (1)
#define ONLAST (2)
void TopOpeBRepTool_TOOL::stuvF(const gp_Pnt2d& uv, const TopoDS_Face& f, Standard_Integer& onU,
...
Standard_Boolean TopOpeBRepTool_TOOL::EdgeONFace(const Standard_Real par, const TopoDS_Edge& ed, const gp_Pnt2d& uv,
                                                 const TopoDS_Face& fa, Standard_Boolean& isonfa) {
