...
public:
    ...
    Standard_EXPORT TopOpeBRepTool_C2DF(const Handle(Geom2d_Curve) & PC, const Standard_Real f2d,
                                        const Standard_Real l2d, const Standard_Real tol, const TopoDS_Face& F);

    Standard_EXPORT void SetPC(const Handle(Geom2d_Curve) & PC, const Standard_Real f2d, const Standard_Real l2d,
