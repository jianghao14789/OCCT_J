...
public:
    ...
    Standard_EXPORT Standard_Boolean REGU(const Standard_Integer istep, const TopoDS_Shape& Scur,
    ...
    Standard_EXPORT Standard_Boolean AddNewConnexity(const TopoDS_Vertex& v, const Standard_Integer OriKey,
                                                     const TopoDS_Edge& e);

    Standard_EXPORT Standard_Boolean RemoveOldConnexity(const TopoDS_Vertex& v, const Standard_Integer OriKey,
                                                        const TopoDS_Edge& e);
