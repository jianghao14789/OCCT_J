...
public:
    ...
    Standard_EXPORT Standard_Integer EdgeOUTofBoundsUV(const TopoDS_Edge& E, const Standard_Boolean onU,
                                                       const Standard_Real tolx, Standard_Real& parspE) const;

    Standard_EXPORT Standard_Boolean EdgesOUTofBoundsUV(const TopTools_ListOfShape& EdsToCheck,
    ...
    Standard_EXPORT Standard_Boolean EdgesWithFaultyUV(const TopTools_ListOfShape& EdsToCheck,
