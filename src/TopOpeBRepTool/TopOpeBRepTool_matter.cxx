...
Standard_EXPORT gp_Vec FUN_tool_getgeomxx(const TopoDS_Face&, const TopoDS_Edge& Ei, const Standard_Real parEi,
                                          const gp_Dir& ngFi) {
    // <Ei> is an edge of <Fi>,
...
FUN_tool_getdxx(const TopoDS_Face& F, const TopoDS_Edge& E,
                //                                                 const Standard_Real parE,
                const Standard_Real, gp_Vec2d& dxx)
// E xiso (x=u,v)
