...
Standard_Boolean TopOpeBRepTool_mkTondgE::Initialize(const TopoDS_Edge& dgE, const TopoDS_Face& F, const gp_Pnt2d& uvi,
...
static Standard_Boolean FUN_MkTonE(const gp_Vec& faxis, const gp_Vec& dirINcle, const gp_Vec& xxi,
                                   const gp_Vec& /*ngf*/, Standard_Real& par1, Standard_Real& par2,
...
Standard_Boolean TopOpeBRepTool_mkTondgE::MkTonE(const TopoDS_Edge& ei, Standard_Integer& mkT, Standard_Real& par1,
                                                 Standard_Real& par2)
// isT2d = true :
...
//
{
    ...
    if (isT2d) {
        ...
        if (!onfi && !onli) {
            mkT = MKI12;
            return Standard_True;
        } // => the same for all edges of lei @190499
        if (closedi) {
            mkT = MKI12;
            return Standard_True;
        } // onfi || onli @190499
