...
Standard_Boolean TopOpeBRepTool_REGUS::WireToFace(const TopoDS_Face& Fanc, const TopTools_ListOfShape& nWs,
...
static Standard_Boolean FUN_vectors(const TopoDS_Face& f, const TopoDS_Edge& e, const Standard_Real pare, gp_Dir& nt,
                                    gp_Dir& xx, const Standard_Real tola, const Standard_Boolean approx) {
    // <nt> :
    if (approx) {
...
Standard_Boolean TopOpeBRepTool_REGUS::NearestF(const TopoDS_Edge& e, const TopTools_ListOfShape& lof,
