...
// purpose  :
//=======================================================================
void TopOpeBRepTool_ShapeTool::UVBOUNDS(const Handle(Geom_Surface) & S, Standard_Boolean& UPeriodic,
                                        Standard_Boolean& VPeriodic, Standard_Real& Umin, Standard_Real& Umax,
...
void TopOpeBRepTool_ShapeTool::UVBOUNDS(const TopoDS_Face& F, Standard_Boolean& UPeriodic, Standard_Boolean& VPeriodic,
                                        Standard_Real& Umin, Standard_Real& Umax, Standard_Real& Vmin,
                                        Standard_Real& Vmax) {
    TopLoc_Location L;
    Handle(Geom_Surface) S = BRep_Tool::Surface(F, L);
...
void TopOpeBRepTool_ShapeTool::AdjustOnPeriodic(const TopoDS_Shape& F, Standard_Real& u, Standard_Real& v) {
    ...
    if (isUperio) {
        ...
        if (Abs(u - UFfirst - Uperiod) > tol) u = ElCLib::InPeriod(u, UFfirst, UFfirst + Uperiod);
    }
    if (isVperio) {
        ...
        if (Abs(v - VFfirst - Vperiod) > tol) v = ElCLib::InPeriod(v, VFfirst, VFfirst + Vperiod);
    }
}
...
inline Standard_Boolean PARINBOUNDS(const Standard_Real par, const Standard_Real first, const Standard_Real last,
                                    const Standard_Real tol) {
    Standard_Boolean b = (((first + tol) <= par) && (par <= (last - tol)));
    return b;
}

inline Standard_Boolean PARONBOUND(const Standard_Real par, const Standard_Real bound, const Standard_Real tol) {
    Standard_Boolean b = (((bound - tol) <= par) && (par <= (bound + tol)));
    return b;
}

Standard_Real ADJUST(const Standard_Real par, const Standard_Real first, const Standard_Real last,
                     const Standard_Real tol) {
...
Standard_Real TopOpeBRepTool_ShapeTool::PeriodizeParameter(const Standard_Real par, const TopoDS_Shape& EE,
...
Standard_Boolean TopOpeBRepTool_ShapeTool::ShapesSameOriented(const TopoDS_Shape& S1, const TopoDS_Shape& S2) {
    ...
    if (sam) {
        ...
        if ((o1 == TopAbs_FORWARD || o1 == TopAbs_REVERSED) && (o2 == TopAbs_FORWARD || o2 == TopAbs_REVERSED)) {
            so = (o1 == o2);
            return so;
        }
    }
...
Standard_Boolean TopOpeBRepTool_ShapeTool::FacesSameOriented(const TopoDS_Shape& S1, const TopoDS_Shape& Sref) {
...
Standard_Boolean TopOpeBRepTool_ShapeTool::EdgesSameOriented(const TopoDS_Shape& S1, const TopoDS_Shape& Sref) {
    const TopoDS_Shape& S2 = Sref;
...
Standard_Real TopOpeBRepTool_ShapeTool::EdgeData(const BRepAdaptor_Curve& BAC, const Standard_Real P, gp_Dir& T,
                                                 gp_Dir& N, Standard_Real& C)
...
Standard_Real TopOpeBRepTool_ShapeTool::EdgeData(const TopoDS_Shape& E, const Standard_Real P, gp_Dir& T, gp_Dir& N,
                                                 Standard_Real& C) {
...
Standard_Real TopOpeBRepTool_ShapeTool::Resolution3dU(const Handle(Geom_Surface) & SU, const Standard_Real Tol2d) {
...
Standard_Real TopOpeBRepTool_ShapeTool::Resolution3dV(const Handle(Geom_Surface) & SU, const Standard_Real Tol2d) {
    GeomAdaptor_Surface GAS(SU);
    Standard_Real r3dunit = 0.00001; // petite valeur (1.0 -> RangeError sur un tore)
...
Standard_Real TopOpeBRepTool_ShapeTool::Resolution3d(const Handle(Geom_Surface) & SU, const Standard_Real Tol2d) {
...
Standard_Real TopOpeBRepTool_ShapeTool::Resolution3d(const TopoDS_Face& F, const Standard_Real Tol2d) {
    TopLoc_Location L;
