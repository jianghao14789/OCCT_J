...
public:
    ...
    //! walking points of <L>.
    Standard_EXPORT TopOpeBRepTool_GeomTool(const TopOpeBRepTool_OutCurveType TypeC3D = TopOpeBRepTool_BSPLINE1,
    ...
    Standard_EXPORT void Define(const TopOpeBRepTool_OutCurveType TypeC3D, const Standard_Boolean CompC3D,
