...
// ------------------------------------------------------------------------------------
Standard_EXPORT Standard_Boolean FC2D_HasOldCurveOnSurface(const TopoDS_Edge& E, const TopoDS_Face& F,
                                                           Handle(Geom2d_Curve) & C2D, Standard_Real& f2d,
                                                           Standard_Real& l2d, Standard_Real& tol) {
...
Standard_EXPORT Standard_Boolean FC2D_HasNewCurveOnSurface(const TopoDS_Edge& E, const TopoDS_Face& F,
                                                           Handle(Geom2d_Curve) & C2D, Standard_Real& f2d,
                                                           Standard_Real& l2d, Standard_Real& tol) {
...
// ------------------------------------------------------------------------------------
Standard_Integer FC2D_AddNewCurveOnSurface(Handle(Geom2d_Curve) C2D, const TopoDS_Edge& E, const TopoDS_Face& F,
...
static Handle(Geom2d_Curve)
    FC2D_make2d(const TopoDS_Edge& E, const TopoDS_Face& F, Standard_Real& f2d, Standard_Real& l2d, Standard_Real& tol,
                const Standard_Boolean trim3d = Standard_False);
static Handle(Geom2d_Curve) FC2D_make2d(const TopoDS_Edge& E, const TopoDS_Face& F, Standard_Real& f2d,
                                        Standard_Real& l2d, Standard_Real& tol, const Standard_Boolean trim3d) {
...
Standard_EXPORT Handle(Geom2d_Curve)
    FC2D_MakeCurveOnSurface(const TopoDS_Edge& E, const TopoDS_Face& F, Standard_Real& f, Standard_Real& l,
                            Standard_Real& tol, const Standard_Boolean trim3d) {
#ifdef DRAW
...
// ------------------------------------------------------------------------------------
Standard_EXPORT Handle(Geom2d_Curve)
    FC2D_CurveOnSurface(const TopoDS_Edge& E, const TopoDS_Face& F, Standard_Real& f, Standard_Real& l,
                        Standard_Real& tol, const Standard_Boolean trim3d) {
    Handle(Geom2d_Curve) C2D;
...
// ------------------------------------------------------------------------------------
Standard_EXPORT Handle(Geom2d_Curve)
    FC2D_EditableCurveOnSurface(const TopoDS_Edge& E, const TopoDS_Face& F, Standard_Real& f, Standard_Real& l,
                                Standard_Real& tol, const Standard_Boolean trim3d) {
    Standard_Boolean hasold = Standard_False;
    {
        Handle(Geom2d_Curve) C2D;
...
static void FC2D_translate(Handle(Geom2d_Curve) C2D,
                           //                           const TopoDS_Edge& E,
                           const TopoDS_Edge&, const TopoDS_Face& F, const TopoDS_Edge& EF) {
...
// ------------------------------------------------------------------------------------
static Handle(Geom2d_Curve)
    FC2D_make2d(const TopoDS_Edge& E, const TopoDS_Face& F, const TopoDS_Edge& EF, Standard_Real& f2d,
                Standard_Real& l2d, Standard_Real& tol, const Standard_Boolean trim3d = Standard_False);
static Handle(Geom2d_Curve)
    FC2D_make2d(const TopoDS_Edge& E, const TopoDS_Face& F, const TopoDS_Edge& EF, Standard_Real& f2d,
                Standard_Real& l2d, Standard_Real& tol, const Standard_Boolean trim3d) {
    Handle(Geom2d_Curve) C2D = BRep_Tool::CurveOnSurface(E, F, f2d, l2d);
...
// ------------------------------------------------------------------------------------
Standard_EXPORT Handle(Geom2d_Curve)
    FC2D_CurveOnSurface(const TopoDS_Edge& E, const TopoDS_Face& F, const TopoDS_Edge& EF, Standard_Real& f2d,
                        Standard_Real& l2d, Standard_Real& tol, const Standard_Boolean trim3d) {
    Handle(Geom2d_Curve) C2D;
