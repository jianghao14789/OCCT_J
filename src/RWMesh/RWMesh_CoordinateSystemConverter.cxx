...
RWMesh_CoordinateSystemConverter::RWMesh_CoordinateSystemConverter()
    : myInputLengthUnit(-1.0), myOutputLengthUnit(-1.0), myHasInputAx3(Standard_False), myHasOutputAx3(Standard_False),
      //
      myUnitFactor(1), myHasScale(Standard_False), myIsEmpty(Standard_True) {
    //
}
...
// Purpose  :
// ================================================================
void RWMesh_CoordinateSystemConverter::Init(const gp_Ax3& theInputSystem, Standard_Real theInputLengthUnit,
