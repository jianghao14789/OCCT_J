...
enum RWMesh_NameFormat {
    ...
    RWMesh_NameFormat_Product,  //!< return Product name
                                //!  (e.g. from XCAFDoc_ShapeTool::GetReferredShape(), which could be shared by multiple
                                //!  Instances)
    ...
    RWMesh_NameFormat_ProductAndInstanceAndOcaf, //!< generate name combining Product+Instance+Ocaf (useful for
                                                 //!< debugging purposes)
};
