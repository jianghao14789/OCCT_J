...
public:
    ...
    virtual void DefineMaterial(const XCAFPrs_Style& theStyle, const TCollection_AsciiString& theKey,
...
protected:
    ...
    NCollection_DoubleMap<XCAFPrs_Style, TCollection_AsciiString, XCAFPrs_Style, TCollection_AsciiString>
        myStyles;                                                         //!< map of processed styles
    NCollection_Map<Handle(Image_Texture), Image_Texture> myImageFailMap; //!< map of images failed to be copied
