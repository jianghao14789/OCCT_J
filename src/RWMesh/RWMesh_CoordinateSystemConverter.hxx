...
public:
    ...
    Standard_EXPORT void Init(const gp_Ax3& theInputSystem, Standard_Real theInputLengthUnit,
                              const gp_Ax3& theOutputSystem, Standard_Real theOutputLengthUnit);
...
private:
    ...
    Standard_Real myInputLengthUnit;  //!< source      length units, defined as scale factor to m (meters); -1.0 by
                                      //!< default which means UNDEFINED
    Standard_Real myOutputLengthUnit; //!< destination length units, defined as scale factor to m (meters); -1.0 by
                                      //!< default which means UNDEFINED
