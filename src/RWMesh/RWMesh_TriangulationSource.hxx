...
protected:
    ...
    Standard_EXPORT virtual Standard_Boolean loadDeferredData(const Handle(OSD_FileSystem) & theFileSystem,
                                                              const Handle(Poly_Triangulation) &
                                                                  theDestTriangulation) const Standard_OVERRIDE;
