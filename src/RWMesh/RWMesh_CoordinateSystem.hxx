...
enum RWMesh_CoordinateSystem {
    ...
    RWMesh_CoordinateSystem_Blender =
        RWMesh_CoordinateSystem_posYfwd_posZup, //!< coordinate system used by Blender (+YForward+Zup+Xright)
    RWMesh_CoordinateSystem_glTF =
        RWMesh_CoordinateSystem_negZfwd_posYup, //!< coordinate system used by glTF    (-ZForward+Yup+Xright)
