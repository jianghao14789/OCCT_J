...
public:
    ...
    Standard_EXPORT virtual Handle(Select3D_SensitiveEntity)
        CustomSensitiveEntity(const Handle(SelectMgr_EntityOwner) & Owner, const Standard_Integer SelectMode) const;
...
protected:
    ...
    Standard_EXPORT MeshVS_PrsBuilder(const Handle(MeshVS_Mesh) & Parent, const MeshVS_DisplayModeFlags& Flags,
