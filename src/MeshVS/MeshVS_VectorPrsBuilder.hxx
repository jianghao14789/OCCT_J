...
public:
    Standard_EXPORT MeshVS_VectorPrsBuilder(const Handle(MeshVS_Mesh) & Parent, const Standard_Real MaxLength,
    ...
    Standard_EXPORT void DrawVector(const gp_Trsf& theTrsf, const Standard_Real Length, const Standard_Real MaxLength,
    ...
    Standard_EXPORT static Standard_Real calculateArrow(TColgp_Array1OfPnt& Points, const Standard_Real Length,
    ...
    Standard_EXPORT Standard_Boolean GetVector(const Standard_Boolean IsElement, const Standard_Integer ID,
                                               gp_Vec& Vect) const;
    ...
    Standard_EXPORT void GetMinMaxVectorValue(const Standard_Boolean IsElement, Standard_Real& MinValue,
    ...
    //! theStartParam     = 0.85
    //! theEndParam       = 0.95
    Standard_EXPORT void SetSimplePrsParams(const Standard_Real theLineWidthParam, const Standard_Real theStartParam,
