...
//! If this parameter is false, the nodes won't be shown in viewer, otherwise will be.//! If this parameter is true, the
//! selectable nodes map will be updated automatically when hidden elements change//! If this parameter is false, the
//! face's edges are not shown Warning: in wireframe mode this parameter is ignored Is mesh drawing in smooth shading
//! mode Is back faces of volume elements should be suppressed The integer keys for most useful constants attuning mesh
//! presentation appearance WARNING: DA_TextExpansionFactor, DA_TextSpace, DA_TextDisplayType have no effect and might
