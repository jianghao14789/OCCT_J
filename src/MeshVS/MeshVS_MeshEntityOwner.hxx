...
public:
    Standard_EXPORT MeshVS_MeshEntityOwner(const SelectMgr_SelectableObject* SelObj, const Standard_Integer ID,
    ...
    Standard_EXPORT virtual Standard_Boolean IsHilighted(const Handle(PrsMgr_PresentationManager) & PM,
                                                         const Standard_Integer Mode = 0) const Standard_OVERRIDE;
