...
Handle(MeshVS_HArray1OfSequenceOfInteger)
    ...
    if (myPrismTopos.IsBound(BasePoints))
        ...
        if (!result.IsNull()) ((MeshVS_DataSource3D*)this)->myPrismTopos.Bind(BasePoints, result);
        return result;
    }
}
...
Handle(MeshVS_HArray1OfSequenceOfInteger)
    ...
    if (myPyramidTopos.IsBound(BasePoints))
        ...
        if (!result.IsNull()) ((MeshVS_DataSource3D*)this)->myPyramidTopos.Bind(BasePoints, result);
        return result;
    }
}
...
// Purpose  :
//================================================================
Handle(MeshVS_HArray1OfSequenceOfInteger) MeshVS_DataSource3D::CreatePrismTopology(const Standard_Integer BasePoints) {
