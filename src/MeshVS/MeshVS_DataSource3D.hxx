...
public:
    ...
    Standard_EXPORT Handle(MeshVS_HArray1OfSequenceOfInteger)
        GetPyramidTopology(const Standard_Integer BasePoints) const;

    Standard_EXPORT static Handle(MeshVS_HArray1OfSequenceOfInteger)
        CreatePrismTopology(const Standard_Integer BasePoints);

    Standard_EXPORT static Handle(MeshVS_HArray1OfSequenceOfInteger)
        CreatePyramidTopology(const Standard_Integer BasePoints);
