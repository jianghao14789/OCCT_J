...
public:
    //! Constructor
    Standard_EXPORT
    MeshVS_ElementalColorPrsBuilder(const Handle(MeshVS_Mesh) & Parent,
    ...
    Standard_EXPORT Standard_Boolean GetColor2(const Standard_Integer ID, Quantity_Color& theColor1,
    ...
    //! theColor1 is the front element color
    //! theColor2 is the back element color
    Standard_EXPORT void SetColor2(const Standard_Integer ID, const Quantity_Color& theColor1,
