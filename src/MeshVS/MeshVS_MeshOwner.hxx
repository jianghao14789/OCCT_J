...
public:
    Standard_EXPORT MeshVS_MeshOwner(const SelectMgr_SelectableObject* theSelObj,
                                     const Handle(MeshVS_DataSource) & theDS, const Standard_Integer thePriority = 0);
    ...
    Standard_EXPORT virtual void AddSelectedEntities(const Handle(TColStd_HPackedMapOfInteger) & Nodes,
