...
void IGESDraw_SegmentedViewsVisible::Init(const Handle(IGESDraw_HArray1OfViewKindEntity) & allViews,
    ...
    if (allViews->Lower() != 1 || (allBreakpointParameters->Lower() != 1 || allBreakpointParameters->Length() != Len) ||
...
Handle(IGESData_LineFontEntity)
    IGESDraw_SegmentedViewsVisible::LineFontDefinition(const Standard_Integer FontIndex) const {
