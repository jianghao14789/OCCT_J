...
Handle(IGESData_ViewKindEntity) IGESDraw_DrawingWithRotation::ViewItem(const Standard_Integer Index) const {
...
Handle(IGESData_IGESEntity) IGESDraw_DrawingWithRotation::Annotation(const Standard_Integer Index) const {
