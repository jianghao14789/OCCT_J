...
void IGESDraw_ViewsVisibleWithAttr::Init(const Handle(IGESDraw_HArray1OfViewKindEntity) & allViewEntities,
    ...
    if (!allViewEntities.IsNull()) {
        ...
        if (allViewEntities->Lower() != 1 || (allLineFonts->Lower() != 1 || allLineFonts->Length() != Exp) ||
...
Handle(IGESData_ViewKindEntity) IGESDraw_ViewsVisibleWithAttr::ViewItem(const Standard_Integer Index) const {
...
Handle(IGESData_LineFontEntity) IGESDraw_ViewsVisibleWithAttr::FontDefinition(const Standard_Integer Index) const {
...
Handle(IGESGraph_Color) IGESDraw_ViewsVisibleWithAttr::ColorDefinition(const Standard_Integer Index) const {
...
Handle(IGESData_IGESEntity) IGESDraw_ViewsVisibleWithAttr::DisplayedEntity(const Standard_Integer Index) const {
