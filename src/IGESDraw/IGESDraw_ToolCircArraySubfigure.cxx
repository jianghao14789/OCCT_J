...
void IGESDraw_ToolCircArraySubfigure::ReadOwnParams(const Handle(IGESDraw_CircArraySubfigure) & ent,
    ...
    ent->Init(tempBase, tempNumLocs, tempCenter, tempRadius, tempStAngle, tempDelAngle, tempFlag, tempNumPos);
}
...
IGESData_DirChecker
IGESDraw_ToolCircArraySubfigure::DirChecker(const Handle(IGESDraw_CircArraySubfigure) & /*ent*/) const {
