...
void IGESDraw_NetworkSubfigureDef::Init(const Standard_Integer aDepth, const Handle(TCollection_HAsciiString) & aName,
...
Handle(IGESDraw_ConnectPoint) IGESDraw_NetworkSubfigureDef::PointEntity(const Standard_Integer Index) const {
