...
void IGESDraw_ToolDrawingWithRotation::ReadOwnParams(const Handle(IGESDraw_DrawingWithRotation) & ent,
...
void IGESDraw_ToolDrawingWithRotation::WriteOwnParams(const Handle(IGESDraw_DrawingWithRotation) & ent,
...
Standard_Boolean IGESDraw_ToolDrawingWithRotation::OwnCorrect(const Handle(IGESDraw_DrawingWithRotation) & ent) const {
...
IGESData_DirChecker
IGESDraw_ToolDrawingWithRotation::DirChecker(const Handle(IGESDraw_DrawingWithRotation) & /*ent*/) const {
