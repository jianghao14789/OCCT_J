...
public:
    ...
    //! 3. (0,  0,  4.5   ) 返回 "4.50s"
    Standard_EXPORT static TCollection_AsciiString FillTime(const Standard_Integer Hour, const Standard_Integer Minute,
...
public:
    ...
    Standard_EXPORT static const Handle(Message_Report) &
        DefaultReport(const Standard_Boolean theToCreate = Standard_False);
