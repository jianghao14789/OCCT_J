...
ChFiDS_Stripe::ChFiDS_Stripe()
    : pardeb1(0.0), parfin1(0.0), pardeb2(0.0), parfin2(0.0), myChoix(0), indexOfSolid(0), indexOfcurve1(0),
      indexOfcurve2(0), indexfirstPOnS1(0), indexlastPOnS1(0), indexfirstPOnS2(0), indexlastPOnS2(0),
      begfilled(/*Standard_False*/ 0), // eap, Apr 29 2002, occ293
      endfilled(/*Standard_False*/ 0), myOr1(TopAbs_FORWARD), myOr2(TopAbs_FORWARD), orcurv1(TopAbs_FORWARD),
...
void ChFiDS_Stripe::Parameters(const Standard_Boolean First, Standard_Real& Pdeb, Standard_Real& Pfin) const {
    if (First) {
        Pdeb = pardeb1;
        Pfin = parfin1;
    } else {
...
void ChFiDS_Stripe::SetParameters(const Standard_Boolean First, const Standard_Real Pdeb, const Standard_Real Pfin) {
    if (First) {
        pardeb1 = Pdeb;
        parfin1 = Pfin;
    } else {
...
Standard_Integer ChFiDS_Stripe::IndexPoint(const Standard_Boolean First, const Standard_Integer OnS) const {
    if (First) {
        if (OnS == 1)
...
void ChFiDS_Stripe::SetIndexPoint(const Standard_Integer Index, const Standard_Boolean First,
