...
ChFiDS_SurfData::ChFiDS_SurfData()
    : ufspine(0.0), ulspine(0.0), myfirstextend(0.0), mylastextend(0.0), indexOfS1(0), indexOfC1(0), indexOfS2(0),
      indexOfC2(0), indexOfConge(0), isoncurv1(Standard_False), isoncurv2(Standard_False), twistons1(Standard_False),
      twistons2(Standard_False), orientation(TopAbs_FORWARD) {}
...
const ChFiDS_CommonPoint& ChFiDS_SurfData::Vertex(const Standard_Boolean First, const Standard_Integer OnS) const {
    if (First && OnS == 1)
        return pfirstOnS1;
    else if (First && OnS == 2)
        return pfirstOnS2;
...
ChFiDS_CommonPoint& ChFiDS_SurfData::ChangeVertex(const Standard_Boolean First, const Standard_Integer OnS) {
    if (First && OnS == 1)
        return pfirstOnS1;
    else if (First && OnS == 2)
        return pfirstOnS2;
...
void ChFiDS_SurfData::Get2dPoints(gp_Pnt2d& P2df1, gp_Pnt2d& P2dl1, gp_Pnt2d& P2df2, gp_Pnt2d& P2dl2) const {
    P2df1 = p2df1;
    P2dl1 = p2dl1;
    P2df2 = p2df2;
    P2dl2 = p2dl2;
...
gp_Pnt2d ChFiDS_SurfData::Get2dPoints(const Standard_Boolean First, const Standard_Integer OnS) const
...
void ChFiDS_SurfData::Set2dPoints(const gp_Pnt2d& P2df1, const gp_Pnt2d& P2dl1, const gp_Pnt2d& P2df2,
