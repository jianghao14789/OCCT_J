...
ChFiDS_ElSpine::ChFiDS_ElSpine()
    : pfirst(0.0), plast(0.0), period(0.0), periodic(Standard_False), pfirstsav(Precision::Infinite()),
...
Handle(Adaptor3d_Curve) ChFiDS_ElSpine::Trim(const Standard_Real First, const Standard_Real Last,
...
void ChFiDS_ElSpine::D3(const Standard_Real AbsC, gp_Pnt& P, gp_Vec& V1, gp_Vec& V2, gp_Vec& V3) const {
