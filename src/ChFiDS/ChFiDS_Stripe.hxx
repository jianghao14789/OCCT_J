...
public:
    ...
    Standard_EXPORT void SetParameters(const Standard_Boolean First, const Standard_Real Pdeb,
    ...
    Standard_EXPORT void SetIndexPoint(const Standard_Integer Index, const Standard_Boolean First,
