...
public:
    ...
    Standard_EXPORT virtual Handle(Adaptor3d_Curve)
    ...
    Standard_EXPORT virtual void D2(const Standard_Real AbsC, gp_Pnt& P, gp_Vec& V1,
                                    gp_Vec& V2) const Standard_OVERRIDE;

    Standard_EXPORT virtual void D3(const Standard_Real AbsC, gp_Pnt& P, gp_Vec& V1, gp_Vec& V2,
