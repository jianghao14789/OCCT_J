...
Standard_Boolean BinMXCAFDoc_DimTolDriver::Paste(const BinObjMgt_Persistent& theSource,
    ...
    if (!(theSource >> aKind >> aName >> aDescr >> aFirstInd >> aLastInd)) return Standard_False;
    ...
    anAtt->Set(aKind, aHArr, new TCollection_HAsciiString(aName), new TCollection_HAsciiString(aDescr));
...
// purpose  :
//=======================================================================
void BinMXCAFDoc_DimTolDriver::Paste(const Handle(TDF_Attribute) & theSource, BinObjMgt_Persistent& theTarget,
