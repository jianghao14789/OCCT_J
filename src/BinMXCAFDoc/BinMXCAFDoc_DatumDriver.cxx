...
Standard_Boolean BinMXCAFDoc_DatumDriver::Paste(const BinObjMgt_Persistent& theSource,
    ...
    if (!(theSource >> aName >> aDescr >> anId)) return Standard_False;

    anAtt->Set(new TCollection_HAsciiString(aName), new TCollection_HAsciiString(aDescr),
...
// purpose  :
//=======================================================================
void BinMXCAFDoc_DatumDriver::Paste(const Handle(TDF_Attribute) & theSource, BinObjMgt_Persistent& theTarget,
