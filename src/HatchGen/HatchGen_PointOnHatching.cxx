...
HatchGen_PointOnHatching::HatchGen_PointOnHatching() : HatchGen_IntersectionPoint(), myPoints() {}
...
void HatchGen_PointOnHatching::AddPoint(const HatchGen_PointOnElement& Point, const Standard_Real Confusion) {
