...
//!
//! This class is not bound to particular data structure and can be used to read the file directly into arbitrary data
//! model. To use it, create descendant class and implement methods addNode() and addTriangle().
//!
//! Call method Read() to read the file. In the process of reading, the tool will call methods addNode() and
//! addTriangle() to fill the mesh data structure.
//!
...
public:
    ...
    Standard_EXPORT Standard_Boolean Read(const char* theFile, const Message_ProgressRange& theProgress);
    ...
    Standard_EXPORT Standard_Boolean IsAscii(Standard_IStream& theStream, const bool isSeekgAvailable);
    ...
    //! Returns true if success, false on error or user break.
    Standard_EXPORT Standard_Boolean ReadBinary(Standard_IStream& theStream, const Message_ProgressRange& theProgress);
    ...
    //! Returns true if success, false on error or user break.
    Standard_EXPORT Standard_Boolean ReadAscii(Standard_IStream& theStream, Standard_ReadLineBuffer& theBuffer,
