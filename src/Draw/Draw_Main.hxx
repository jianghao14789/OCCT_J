...
Standard_EXPORT Standard_Integer Draw_Main(Standard_Integer argc, Standard_PCharacter argv[],
...
Standard_EXPORT Standard_Integer Draw_WinMain(HINSTANCE hInstance, HINSTANCE hPrevinstance, LPSTR lpCmdLine,
                                              Standard_Integer nCmdShow, const FDraw_InitAppli Draw_InitAppli);

// WinMain() and main()
#define DRAW_MAIN                                                                                                      \
    Standard_Integer PASCAL WinMain(HINSTANCE hInstance, HINSTANCE hPrevinstance, LPSTR lpCmdLine,                     \
