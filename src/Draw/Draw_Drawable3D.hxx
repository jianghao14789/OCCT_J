...
public:
    ...
    Standard_EXPORT static void RegisterFactory(const Standard_CString theType, const FactoryFunction_t& theFactory);
    ...
    Standard_EXPORT static Handle(Draw_Drawable3D) Restore(const Standard_CString theType, Standard_IStream& theStream);
...
#define Draw_Drawable3D_FACTORY                                                                                        \
    static void RegisterFactory() {                                                                                    \
        Draw_Drawable3D::RegisterFactory(get_type_name(), &Restore);                                                   \
    }                                                                                                                  \
...
public:
    ...
    Standard_EXPORT virtual Standard_Boolean PickReject(const Standard_Real X, const Standard_Real Y,
    ...
    void SetBounds(const Standard_Real theXMin, const Standard_Real theXMax, const Standard_Real theYMin,
