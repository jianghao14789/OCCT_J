...
// purpose  :
//==============================================================================
static Standard_Boolean printerType(const TCollection_AsciiString& theTypeName, Handle(Standard_Type) & theType) {
...
static Standard_Integer SetMessagePrinter(Draw_Interpretor& theDI, Standard_Integer theArgNb, const char** theArgVec) {
    ...
    for (NCollection_List<TCollection_AsciiString>::Iterator anIterator(aPrinterTypes); anIterator.More();
         anIterator.Next()) {
...
// purpose  :
//==============================================================================
static Standard_Integer CollectMetricMessages(Draw_Interpretor& theDI, Standard_Integer theArgNb,
...
void Draw::MessageCommands(Draw_Interpretor& theCommands) {
    ...
    theCommands.Add("ClearReport", "Removes all alerts in default printer", __FILE__, ClearReport, group);
