...
HWND CreateAppWindow(HINSTANCE theInstance) {
    return CreateWindowW(APPCLASS, APPTITLE, WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN, 400, 0, 623, 767, NULL, NULL,
                         theInstance, NULL);
}
...
HWND CreateMDIClientWindow(HWND theWndFrame) {
    ...
    HWND hWndClient = CreateWindowW(L"MDICLIENT", NULL, WS_CHILD | WS_CLIPSIBLINGS | WS_VISIBLE | MDIS_ALLCHILDSTYLES,
                                    0, 0, 1, 1, theWndFrame, NULL, hInstance, (LPVOID)&ccs);
    return hWndClient;
}
#endif
