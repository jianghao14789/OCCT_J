...
public: //! @name Tcl variables management tools
    ...
    //! The name "." does a graphic selection; in this case theName will be is overwritten with the name of the
    //! variable.
...
public: //! @name argument parsing tools
    ...
    static Standard_Integer ParseColor(const Standard_Integer theArgNb, const char* const* const theArgVec,
    ...
    Standard_EXPORT static Standard_Boolean ParseOnOff(Standard_CString theArg, Standard_Boolean& theIsOn);
    ...
    //! @return flag value
    Standard_EXPORT static Standard_Boolean ParseOnOffIterator(Standard_Integer theArgsNb, const char** theArgVec,
    ...
    //! @param theArgIter [in] [out] argument position to parse
    //! @return flag value
    Standard_EXPORT static Standard_Boolean ParseOnOffNoIterator(Standard_Integer theArgsNb, const char** theArgVec,
                                                                 Standard_Integer& theArgIter);

public:
    //! Returns last graphic selection description.
    Standard_EXPORT static void LastPick(Standard_Integer& view, Standard_Integer& X, Standard_Integer& Y,
...
protected:
    ...
    Standard_EXPORT static Handle(Draw_Drawable3D)
        getDrawable(Standard_CString& theName, Standard_Boolean theToAllowPick);
    ...
    Standard_EXPORT static Standard_Integer parseColor(Standard_Integer theArgNb, const char* const* theArgVec,
                                                       Quantity_ColorRGBA& theColor, bool theToParseAlpha);
};
