...
Draw_Grid::Draw_Grid() : myStepX(0.0), myStepY(0.0), myStepZ(0.0), myIsActive(Standard_False) {}
...
void Draw_Grid::Steps(const Standard_Real StepX, const Standard_Real StepY, const Standard_Real StepZ) {
    myStepX = Abs(StepX);
    myStepY = Abs(StepY);
    myStepZ = Abs(StepZ);
