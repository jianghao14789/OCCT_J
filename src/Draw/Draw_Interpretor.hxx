...
public:
    ...
    typedef Standard_Integer (*CommandFunction)(Draw_Interpretor& theDI, Standard_Integer theArgNb,
...
protected:
    ...
    struct CallBackDataFunc : public CallBackData {
        ...
        CallBackDataFunc(Draw_Interpretor* theDI, CommandFunction theFunc) : CallBackData(theDI), myFunc(theFunc) {}
    ...
    template <typename theObjHandle> struct CallBackDataMethod : public CallBackData {
        ...
        CallBackDataMethod(Draw_Interpretor* theDI, const theObjHandle& theObjPtr, methodType theMethod)
            : CallBackData(theDI), myObjPtr(theObjPtr), myMethod(theMethod) {}
...
public:
    ...
    inline void Add(Standard_CString theCommandName, Standard_CString theHelp, CommandFunction theFunction,
    ...
    inline void Add(Standard_CString theCommandName, Standard_CString theHelp, Standard_CString theFileName,
                    CommandFunction theFunction, Standard_CString theGroup = "User Commands") {
...
public:
    ...
    inline Draw_Interpretor& operator<<(const Standard_Real theResult) {
        return Append(theResult);
    }
...
protected:
    Standard_EXPORT void add(Standard_CString theCommandName, Standard_CString theHelp, Standard_CString theFileName,
                             CallBackData* theCallback, Standard_CString theGroup);
