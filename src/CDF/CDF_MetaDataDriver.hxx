...
public:
    ...
    Standard_EXPORT virtual void CreateReference(const Handle(CDM_MetaData) & aFrom, const Handle(CDM_MetaData) & aTo,
    ...
    Standard_EXPORT virtual TCollection_ExtendedString SetName(const Handle(CDM_Document) & aDocument,
                                                               const TCollection_ExtendedString& aName);
    ...
    Standard_EXPORT virtual Standard_Boolean HasReadPermission(const TCollection_ExtendedString& aFolder,
                                                               const TCollection_ExtendedString& aName,
                                                               const TCollection_ExtendedString& aVersion) = 0;
    ...
    Standard_EXPORT virtual Handle(CDM_MetaData)
        MetaData(const TCollection_ExtendedString& aFolder, const TCollection_ExtendedString& aName,
                 const TCollection_ExtendedString& aVersion) = 0;
    ...
    Standard_EXPORT virtual Handle(CDM_MetaData)
        CreateMetaData(const Handle(CDM_Document) & aDocument, const TCollection_ExtendedString& aFileName) = 0;
    ...
    Standard_EXPORT virtual Handle(PCDM_ReferenceIterator)
        ReferenceIterator(const Handle(Message_Messenger) & theMessageDriver);
