...
public:
    ...
    Standard_EXPORT Standard_Boolean Find(const TCollection_ExtendedString& aFolder,
                                          ...
                                          const TCollection_ExtendedString& aVersion) Standard_OVERRIDE;
    ...
    Standard_EXPORT virtual TCollection_ExtendedString
    SetName(const Handle(CDM_Document) & aDocument, const TCollection_ExtendedString& aName) Standard_OVERRIDE;
...
private:
    ...
    Standard_EXPORT Handle(CDM_MetaData) CreateMetaData(const Handle(CDM_Document) & aDocument,
                                                        const TCollection_ExtendedString& aFileName) Standard_OVERRIDE;

    Standard_EXPORT static TCollection_ExtendedString Concatenate(const TCollection_ExtendedString& aFolder,
                                                                  const TCollection_ExtendedString& aName);
