...
public:
    ...
    Init(const Handle(TCollection_HAsciiString) & aCurveElementSectionDefinition_Description,
    ...
    Standard_EXPORT void SetLocationOfCentroid(const Handle(StepElement_HArray1OfMeasureOrUnspecifiedValue) &
                                               LocationOfCentroid);
    ...
    Standard_EXPORT void SetLocationOfShearCentre(const Handle(StepElement_HArray1OfMeasureOrUnspecifiedValue) &
    ...
    Standard_EXPORT void SetLocationOfNonStructuralMass(const Handle(StepElement_HArray1OfMeasureOrUnspecifiedValue) &
