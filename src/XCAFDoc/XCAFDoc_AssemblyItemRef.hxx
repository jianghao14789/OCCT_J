...
public:
    ...
    Standard_EXPORT static Handle(XCAFDoc_AssemblyItemRef)
        Set(const TDF_Label& theLabel, const XCAFDoc_AssemblyItemId& theItemId);
    ...
    //! \return A handle to the attribute instance.
    Standard_EXPORT static Handle(XCAFDoc_AssemblyItemRef)
        Set(const TDF_Label& theLabel, const XCAFDoc_AssemblyItemId& theItemId, const Standard_GUID& theGUID);
    ...
    //! \return A handle to the attribute instance.
    Standard_EXPORT static Handle(XCAFDoc_AssemblyItemRef)
        Set(const TDF_Label& theLabel, const XCAFDoc_AssemblyItemId& theItemId, const Standard_Integer theShapeIndex);
