...
public:
    ...
    Standard_EXPORT Standard_Boolean SearchUsingMap(const TopoDS_Shape& S, TDF_Label& L,
    ...
    Standard_EXPORT Standard_Boolean Search(const TopoDS_Shape& S, TDF_Label& L,
    ...
    Standard_EXPORT Standard_Boolean FindShape(const TopoDS_Shape& S, TDF_Label& L,
    ...
    Standard_EXPORT Standard_Boolean RemoveShape(const TDF_Label& L,
    ...
    Standard_EXPORT static Standard_Integer GetUsers(const TDF_Label& L, TDF_LabelSequence& Labels,
    ...
    Standard_EXPORT static Standard_Integer NbComponents(const TDF_Label& L,
                                                         const Standard_Boolean getsubchilds = Standard_False);

    //! Returns list of components of assembly
    //! Returns False if label is not assembly
    Standard_EXPORT static Standard_Boolean GetComponents(const TDF_Label& L, TDF_LabelSequence& Labels,
                                                          const Standard_Boolean getsubchilds = Standard_False);

    //! Adds a component given by its label and location to the assembly
    //! Note: assembly must be IsAssembly() or IsSimpleShape()
    Standard_EXPORT TDF_Label AddComponent(const TDF_Label& assembly, const TDF_Label& comp,
    ...
    //! Note: assembly must be IsAssembly() or IsSimpleShape()
    Standard_EXPORT TDF_Label AddComponent(const TDF_Label& assembly, const TopoDS_Shape& comp,
    ...
    Standard_EXPORT Standard_Boolean AddSubShape(const TDF_Label& shapeL, const TopoDS_Shape& sub,
    ...
    Standard_EXPORT static void DumpShape(Standard_OStream& theDumpLog, const TDF_Label& L,
    ...
    Standard_EXPORT Standard_Boolean GetAllSHUOInstances(const Handle(XCAFDoc_GraphNode) & theSHUO,
    ...
    Standard_EXPORT Handle(TDataStd_NamedData)
        GetNamedProperties(const TDF_Label& theLabel, const Standard_Boolean theToCreate = Standard_False) const;
    ...
    //! @return Handle to the NamedData attribute or Null if there is none
    Standard_EXPORT Handle(TDataStd_NamedData)
        GetNamedProperties(const TopoDS_Shape& theShape, const Standard_Boolean theToCreate = Standard_False) const;
...
private:
    ...
    Standard_EXPORT Standard_Boolean updateComponent(const TDF_Label& theAssmLabel, TopoDS_Shape& theUpdatedShape,
    ...
    Standard_EXPORT void makeSubShape(const TDF_Label& theMainShapeL, const TDF_Label& thePart,
