...
public:
    ...
    //! in the colortable
    //! Adds a color as necessary
    Standard_EXPORT void SetColor(const TDF_Label& L, const Quantity_ColorRGBA& Color,
    ...
    Standard_EXPORT static Standard_Boolean GetColor(const TDF_Label& L, const XCAFDoc_ColorType type,
                                                     TDF_Label& colorL);
    ...
    //! Returns color assigned to <L> as <type>
    //! Returns False if no such color is assigned
    Standard_EXPORT Standard_Boolean GetColor(const TDF_Label& L, const XCAFDoc_ColorType type,
    ...
    Standard_EXPORT Standard_Boolean SetColor(const TopoDS_Shape& S, const TDF_Label& colorL,
    ...
    //! Adds a color as necessary
    //! Returns False if cannot find a label for shape S
    Standard_EXPORT Standard_Boolean SetColor(const TopoDS_Shape& S, const Quantity_Color& Color,
                                              const XCAFDoc_ColorType type);
    ...
    //! Adds a color as necessary
    //! Returns False if cannot find a label for shape S
    Standard_EXPORT Standard_Boolean SetColor(const TopoDS_Shape& S, const Quantity_ColorRGBA& Color,
                                              const XCAFDoc_ColorType type);
    ...
    //! Returns color assigned to <L> as <type>
    //! Returns False if no such color is assigned
    Standard_EXPORT Standard_Boolean GetColor(const TopoDS_Shape& S, const XCAFDoc_ColorType type,
    ...
    Standard_EXPORT Standard_Boolean SetInstanceColor(const TopoDS_Shape& theShape, const XCAFDoc_ColorType type,
    ...
    Standard_EXPORT Standard_Boolean GetInstanceColor(const TopoDS_Shape& theShape, const XCAFDoc_ColorType type,
                                                      Quantity_Color& color);
