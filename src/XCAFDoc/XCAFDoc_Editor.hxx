...
public:
    ...
    Standard_EXPORT static Standard_Boolean Expand(const TDF_Label& theDoc, const TDF_Label& theShape,
    ...
    Standard_EXPORT static Standard_Boolean Extract(const TDF_LabelSequence& theSrcLabels, const TDF_Label& theDstLabel,
    ...
    //! @param[in] theIsNoVisMat get a VisMaterial attributes as is or convert to color
    //! @return True if shape successfully extracted
    Standard_EXPORT static Standard_Boolean Extract(const TDF_Label& theSrcLabel, const TDF_Label& theDstLabel,
                                                    const Standard_Boolean theIsNoVisMat = Standard_False);
    ...
    CloneMetaData(const TDF_Label& theSrcLabel, const TDF_Label& theDstLabel,
