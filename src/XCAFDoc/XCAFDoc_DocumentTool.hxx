...
public:
    ...
    Standard_EXPORT static Handle(XCAFDoc_DocumentTool)
    ...
    Standard_EXPORT static void SetLengthUnit(const Handle(TDocStd_Document) & theDoc, const Standard_Real theUnitValue,
                                              const UnitsMethods_LengthUnit theBaseUnit);
