...
// purpose  :
//=======================================================================
Handle(XCAFDoc_LengthUnit) XCAFDoc_LengthUnit::Set(const TDF_Label& theLabel, const Standard_Real theUnitValue) {
...
// purpose  :
//=======================================================================
Handle(XCAFDoc_LengthUnit) XCAFDoc_LengthUnit::Set(const TDF_Label& theLabel, const Standard_GUID& theGUID,
                                                   const TCollection_AsciiString& theUnitName,
                                                   const Standard_Real theUnitValue) {
...
// purpose  :
//=======================================================================
void XCAFDoc_LengthUnit::Set(const TCollection_AsciiString& theUnitName, const Standard_Real theUnitValue) {
    Backup();
...
// purpose  :
//=======================================================================
void XCAFDoc_LengthUnit::Paste(const Handle(TDF_Attribute) & theInto, const Handle(TDF_RelocationTable) & theRT) const {
    (void)theRT;
