...
public:
    ...
    Standard_EXPORT Standard_Boolean GetClippingPlane(const TDF_Label& theLabel, gp_Pln& thePlane,
    ...
    //! is already defined)
    Standard_EXPORT TDF_Label AddClippingPlane(const gp_Pln thePlane, const TCollection_ExtendedString theName,
                                               const Standard_Boolean theCapping) const;

    //! Adds a clipping plane definition to a ClippingPlane table and returns
    //! its label (returns existing label if the same clipping plane
    //! is already defined)
    Standard_EXPORT TDF_Label AddClippingPlane(const gp_Pln thePlane, const Handle(TCollection_HAsciiString) & theName,
                                               const Standard_Boolean theCapping) const;
    ...
    Standard_EXPORT void UpdateClippingPlane(const TDF_Label& theLabelL, const gp_Pln thePlane,
