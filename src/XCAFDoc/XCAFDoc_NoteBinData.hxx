...
public:
    ...
    Standard_EXPORT static Handle(XCAFDoc_NoteBinData)
        Set(const TDF_Label& theLabel, const TCollection_ExtendedString& theUserName,
            const TCollection_ExtendedString& theTimeStamp, const TCollection_ExtendedString& theTitle,
    ...
    //! \param [in] theMIMEtype  - MIME type of data.
    //! \param [in] theData      - byte data array.
    Standard_EXPORT void Set(const TCollection_ExtendedString& theTitle, const TCollection_AsciiString& theMIMEtype,
    ...
    const Handle(TColStd_HArray1OfByte) & Data() const {
        return myData;
    }
