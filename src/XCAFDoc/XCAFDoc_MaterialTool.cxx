...
void XCAFDoc_MaterialTool::SetMaterial(const TDF_Label& L, const Handle(TCollection_HAsciiString) & aName,
                                       const Handle(TCollection_HAsciiString) & aDescription,
                                       const Standard_Real aDensity, const Handle(TCollection_HAsciiString) & aDensName,
                                       const Handle(TCollection_HAsciiString) & aDensValType) const {
...
Standard_Boolean XCAFDoc_MaterialTool::GetMaterial(const TDF_Label& MatL, Handle(TCollection_HAsciiString) & aName,
...
Standard_Real XCAFDoc_MaterialTool::GetDensityForShape(const TDF_Label& ShapeL) {
    ...
    if (!ShapeL.FindAttribute(XCAFDoc::MaterialRefGUID(), Node) || !Node->HasFather()) return Dens;
