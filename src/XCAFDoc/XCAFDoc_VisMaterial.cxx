...
XCAFDoc_VisMaterial::XCAFDoc_VisMaterial()
    : myAlphaMode(Graphic3d_AlphaMode_BlendAuto), myAlphaCutOff(0.5f),
...
// purpose  :
//=======================================================================
void XCAFDoc_VisMaterial::Paste(const Handle(TDF_Attribute) & theInto, const Handle(TDF_RelocationTable) &) const {
...
void XCAFDoc_VisMaterial::FillAspect(const Handle(Graphic3d_Aspects) & theAspect) const {
    ...
    if (!myPbrMat.MetallicRoughnessTexture.IsNull()) {
        aTextureSet->SetValue(aTexIter++, new XCAFPrs_Texture(*myPbrMat.MetallicRoughnessTexture,
