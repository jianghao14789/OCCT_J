...
public:
    ...
    Standard_EXPORT static Handle(XCAFDoc_LengthUnit)
        Set(const TDF_Label& theLabel, const TCollection_AsciiString& theUnitName, const Standard_Real theUnitValue);

    //! Finds or creates a LengthUnit attribute
    //! @param theUnitValue - length scale factor to meter
    //! The LengthUnit attribute is returned.
    Standard_EXPORT static Handle(XCAFDoc_LengthUnit) Set(const TDF_Label& theLabel, const Standard_Real theUnitValue);
    ...
    //! The LengthUnit attribute is returned
    Standard_EXPORT static Handle(XCAFDoc_LengthUnit)
        Set(const TDF_Label& theLabel, const Standard_GUID& theGUID, const TCollection_AsciiString& theUnitName,
            const Standard_Real theUnitValue);

    //! Creates a LengthUnit attribute
    //! @param theUnitName - name of the unit: mm, m, cm, km, micron, in, min, nin, ft, stat.mile
    //! @param theUnitValue - length scale factor to meter
    Standard_EXPORT void Set(const TCollection_AsciiString& theUnitName, const Standard_Real theUnitValue);
    ...
    Standard_Real GetUnitValue() const {
        return myUnitScaleValue;
    }

    Standard_EXPORT Standard_Boolean IsEmpty() const {
        return myUnitName.IsEmpty();
    }
