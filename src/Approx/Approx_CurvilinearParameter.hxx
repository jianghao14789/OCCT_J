...
public:
    ...
    Standard_EXPORT Approx_CurvilinearParameter(const Handle(Adaptor3d_Curve) & C3D, const Standard_Real Tol,
    ...
    Standard_EXPORT Approx_CurvilinearParameter(const Handle(Adaptor2d_Curve2d) & C2D,
                                                const Handle(Adaptor3d_Surface) & Surf, const Standard_Real Tol,
                                                const GeomAbs_Shape Order, const Standard_Integer MaxDegree,
                                                const Standard_Integer MaxSegments);
    ...
    Standard_EXPORT Approx_CurvilinearParameter(const Handle(Adaptor2d_Curve2d) & C2D1,
                                                ...
                                                const Handle(Adaptor3d_Surface) & Surf2, const Standard_Real Tol,
                                                const GeomAbs_Shape Order, const Standard_Integer MaxDegree,
                                                const Standard_Integer MaxSegments);
