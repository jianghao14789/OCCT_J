...
public:
    Approx_Curve2d_Eval(const Handle(Adaptor2d_Curve2d) & theFunc, Standard_Real First, Standard_Real Last)
        : fonct(theFunc) {
        StartEndSav[0] = First;
        StartEndSav[1] = Last;
    }
...
void Approx_Curve2d_Eval::Evaluate(Standard_Integer* Dimension, Standard_Real StartEnd[2],
...
Approx_Curve2d::Approx_Curve2d(const Handle(Adaptor2d_Curve2d) & C2D, const Standard_Real First,
                               const Standard_Real Last, const Standard_Real TolU, const Standard_Real TolV,
    ...
    AdvApprox_ApproxAFunction aApprox(Num1DSS, Num2DSS, Num3DSS, OneDTol, TwoDTolNul, ThreeDTolNul, First, Last,
                                      Continuity, MaxDegree, MaxSegments, ev, CutTool);
