...
public:
    Approx_Curve3d_Eval(const Handle(Adaptor3d_Curve) & theFunc, Standard_Real First, Standard_Real Last)
        : fonct(theFunc) {
        StartEndSav[0] = First;
        StartEndSav[1] = Last;
    }
...
void Approx_Curve3d_Eval::Evaluate(Standard_Integer* Dimension, Standard_Real StartEnd[2],
...
Approx_Curve3d::Approx_Curve3d(const Handle(Adaptor3d_Curve) & Curve, const Standard_Real Tol3d,
    ...
    AdvApprox_ApproxAFunction aApprox(Num1DSS, Num2DSS, Num3DSS, OneDTolNul, TwoDTolNul, ThreeDTol, First, Last, Order,
                                      MaxDegree, MaxSegments, ev, CutTool);
