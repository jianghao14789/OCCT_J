...
public:
    ...
    Standard_DEPRECATED("This constructor is deprecated. Use other constructor and perform method instead.")
        Standard_EXPORT
        Approx_CurveOnSurface(const Handle(Adaptor2d_Curve2d) & C2D, const Handle(Adaptor3d_Surface) & Surf,
                              ...
                              const Standard_Integer MaxSegments, const Standard_Boolean Only3d = Standard_False,
    ...
    Standard_EXPORT void Perform(const Standard_Integer theMaxSegments, const Standard_Integer theMaxDegree,
                                 const GeomAbs_Shape theContinuity, const Standard_Boolean theOnly3d = Standard_False,
...
protected:
    ...
    Standard_Boolean isIsoLine(const Handle(Adaptor2d_Curve2d) theC2D, Standard_Boolean& theIsU,
    ...
    Standard_Boolean buildC3dOnIsoLine(const Handle(Adaptor2d_Curve2d) theC2D, const Standard_Boolean theIsU,
                                       const Standard_Real theParam, const Standard_Boolean theIsForward);
