...
public:
    ...
    Standard_EXPORT Approx_FitAndDivide(const AppCont_Function& Line, const Standard_Integer degreemin = 3,
                                        const Standard_Integer degreemax = 8, const Standard_Real Tolerance3d = 1.0e-5,
    ...
    Standard_EXPORT Approx_FitAndDivide(const Standard_Integer degreemin = 3, const Standard_Integer degreemax = 8,
...
private:
    ...
    Standard_EXPORT Standard_Boolean Compute(const AppCont_Function& Line, const Standard_Real Ufirst,
                                             const Standard_Real Ulast, Standard_Real& TheTol3d,
