...
void IntSurf::MakeTransition(const gp_Vec& TgFirst, const gp_Vec& TgSecond, const gp_Dir& Normale,
...
// purpose  :
//=======================================================================
void IntSurf::SetPeriod(const Handle(Adaptor3d_Surface) & theFirstSurf, const Handle(Adaptor3d_Surface) & theSecondSurf,
