...
public:
    ...
    Standard_EXPORT BRepPrimAPI_MakeBox(const gp_Pnt& P, const Standard_Real dx, const Standard_Real dy,
    ...
    Standard_EXPORT BRepPrimAPI_MakeBox(const gp_Ax2& Axes, const Standard_Real dx, const Standard_Real dy,
                                        const Standard_Real dz);
    ...
    Standard_EXPORT void Init(const gp_Pnt& thePnt, const Standard_Real theDX, const Standard_Real theDY,
    ...
    Standard_EXPORT void Init(const gp_Ax2& theAxes, const Standard_Real theDX, const Standard_Real theDY,
                              const Standard_Real theDZ);
