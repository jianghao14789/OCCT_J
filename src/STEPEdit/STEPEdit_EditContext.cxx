...
STEPEdit_EditContext::STEPEdit_EditContext() : IFSelect_Editor(5) {
...
Handle(TCollection_HAsciiString) STEPEdit_EditContext::StringValue(const Handle(IFSelect_EditForm) & /*form*/,
