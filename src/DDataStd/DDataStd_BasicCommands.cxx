...
static Standard_Integer DDataStd_SetInteger(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb >= 4) {
        Handle(TDF_Data) DF;
...
static Standard_Integer DDataStd_SetReal(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb >= 4) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        TDF_Label L;
...
static Standard_Integer DDataStd_SetReference(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 4) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        TDF_Label L;
...
static Standard_Integer DDataStd_SetComment(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 4) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        TDF_Label L;
...
static Standard_Integer DDataStd_GetInteger(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 3 || nb == 4 || nb == 5) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        ...
        if (nb < 5) {
            if (nb == 4) { // DF, entry, guid
                if (Standard_GUID::CheckGUIDFormat(arg[3])) aGuid = Standard_GUID(arg[3]);
            }
...
static Standard_Integer DDataStd_GetReal(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 3 || nb == 4 || nb == 5) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
static Standard_Integer DDataStd_GetReference(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 3) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
static Standard_Integer DDataStd_GetComment(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 3) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_SetUAttribute(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 4) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        TDF_Label label;
...
//=======================================================================
static Standard_Integer DDataStd_GetUAttribute(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 4) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        TDF_Label label;
...
//=======================================================================
static Standard_Integer DDataStd_SetIntArray(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb >= 6) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        TDF_Label label;
...
//=======================================================================
static Standard_Integer DDataStd_SetIntArrayValue(Draw_Interpretor&, Standard_Integer, const char** arg) {
    // Get document.
    Handle(TDF_Data) DF;
    if (!DDF::GetDF(arg[1], DF)) return 1;
    ...
    // Get label.
    TDF_Label label;
    if (!DDF::AddLabel(DF, arg[2], label)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_GetIntArray(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
...
//=======================================================================
static Standard_Integer DDataStd_GetIntArrayValue(Draw_Interpretor& di, Standard_Integer, const char** arg) {
    Handle(TDF_Data) DF;
    if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_ChangeIntArray(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
...
//         : huge arrays
//=======================================================================
static Standard_Integer DDataStd_SetIntArrayTest(Draw_Interpretor& di, Standard_Integer, const char** arg) {
...
//=======================================================================
static Standard_Integer DDataStd_SetRealArray(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb >= 6) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        TDF_Label label;
...
//=======================================================================
static Standard_Integer DDataStd_SetRealArrayValue(Draw_Interpretor&, Standard_Integer, const char** arg) {
    // Get document.
    Handle(TDF_Data) DF;
    if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_GetRealArray(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb >= 3) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        TDF_Label label;
...
//=======================================================================
static Standard_Integer DDataStd_GetRealArrayValue(Draw_Interpretor& di, Standard_Integer, const char** arg) {
    Handle(TDF_Data) DF;
    if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_ChangeRealArray(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
...
//=======================================================================
static Standard_Integer DDataStd_SetVariable(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 5) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        TDF_Label label;
...
//=======================================================================
static Standard_Integer DDataStd_GetVariable(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 5) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        TDF_Label label;
...
//=======================================================================
static Standard_Integer DDataStd_SetRelation(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb >= 5) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        TDF_Label label;
...
//=======================================================================
static Standard_Integer DDataStd_DumpRelation(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 3) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_SetFunction(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 5) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        TDF_Label label;
...
//=======================================================================
static Standard_Integer DDataStd_GetFunction(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 5) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        TDF_Label label;
...
//=======================================================================
static Standard_Integer DDataStd_SetExtStringArray(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb >= 6) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        TDF_Label label;
...
//=======================================================================
static Standard_Integer DDataStd_SetExtStringArrayValue(Draw_Interpretor&, Standard_Integer, const char** arg) {
    // Get document.
    Handle(TDF_Data) DF;
    if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_GetExtStringArray(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb >= 3) {
...
//=======================================================================
static Standard_Integer DDataStd_GetExtStringArrayValue(Draw_Interpretor& di, Standard_Integer, const char** arg) {
    Handle(TDF_Data) DF;
    if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_ChangeExtStrArray(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
...
//=======================================================================
static Standard_Integer DDataStd_KeepUTF(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 4) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        TDF_Label L;
...
//=======================================================================
static Standard_Integer DDataStd_GetUTFtoFile(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 4) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        TDF_Label L;
...
//=======================================================================
static Standard_Integer DDataStd_SetByteArray(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb >= 6) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        TDF_Label label;
...
//=======================================================================
static Standard_Integer DDataStd_SetByteArrayValue(Draw_Interpretor&, Standard_Integer, const char** arg) {
    // Get document.
    Handle(TDF_Data) DF;
    if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_SetBooleanArray(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb >= 5) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_SetBooleanArrayValue(Draw_Interpretor& di, Standard_Integer, const char** arg) {
    // Get document.
    Handle(TDF_Data) DF;
    if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_SetExtStringList(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb > 2) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_SetReferenceList(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb > 2) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_SetBooleanList(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb > 2) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_SetIntegerList(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb > 2) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_SetRealList(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb > 2) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_InsertBeforeExtStringList(Draw_Interpretor& di, Standard_Integer nb,
                                                           const char** arg) {
    if (nb == 5) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        ...
        Handle(TDataStd_ExtStringList) A;
        if (!label.FindAttribute(TDataStd_ExtStringList::GetID(), A)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_InsertAfterExtStringList(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 5) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_RemoveExtStringList(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 4) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_InsertBeforeBooleanList(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 5) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        ...
        Handle(TDataStd_BooleanList) A;
        if (!label.FindAttribute(TDataStd_BooleanList::GetID(), A)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_InsertAfterBooleanList(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 5) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_RemoveBooleanList(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 4) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_InsertBeforeIntegerList(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 5) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        ...
        Handle(TDataStd_IntegerList) A;
        if (!label.FindAttribute(TDataStd_IntegerList::GetID(), A)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_InsertAfterIntegerList(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 5) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_RemoveIntegerList(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 4) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_InsertBeforeRealList(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 5) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        ...
        Handle(TDataStd_RealList) A;
        if (!label.FindAttribute(TDataStd_RealList::GetID(), A)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_InsertAfterRealList(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 5) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_RemoveRealList(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 4) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_InsertBeforeReferenceList(Draw_Interpretor& di, Standard_Integer nb,
                                                           const char** arg) {
    if (nb == 5) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        ...
        Handle(TDataStd_ReferenceList) A;
        if (!label.FindAttribute(TDataStd_ReferenceList::GetID(), A)) return 1;

        Standard_Integer index = Draw::Atoi(arg[3]);

        TDF_Label refLabel;
        if (!DDF::AddLabel(DF, arg[4], refLabel)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_InsertAfterReferenceList(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 5) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_RemoveReferenceList(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 4) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_GetByteArray(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb >= 3) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        TDF_Label label;
...
//=======================================================================
static Standard_Integer DDataStd_GetByteArrayValue(Draw_Interpretor& di, Standard_Integer, const char** arg) {
    Handle(TDF_Data) DF;
    if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_GetBooleanArray(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb >= 3) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_GetBooleanArrayValue(Draw_Interpretor& di, Standard_Integer, const char** arg) {
    Handle(TDF_Data) DF;
    if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_ChangeByteArray(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
...
//=======================================================================
static Standard_Integer DDataStd_GetBooleanList(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb >= 3) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_GetIntegerList(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb >= 3) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_GetRealList(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb >= 3) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_GetExtStringList(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb >= 3) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_GetReferenceList(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb >= 3) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
static Standard_Integer DDataStd_SetIntPackedMap(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
...
static Standard_Integer DDataStd_GetIntPackedMap(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
...
//=======================================================================
static Standard_Integer DDataStd_ChangeIntPackedMap_Add(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    ...
    if (nb >= 4) {
        ...
        if (!aHMap.IsNull()) {
            ...
            for (i = 1; i <= aNum; i++) {
                ...
                if (!ahMap->Map().Contains(val)) ahMap->ChangeMap().Add(val);
            }
...
//=======================================================================
static Standard_Integer DDataStd_ChangeIntPackedMap_Rem(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    ...
    if (nb >= 4) {
        ...
        if (!aHMap.IsNull()) {
            ...
            for (i = 1; i <= aNum; i++) {
                Standard_Integer val = Draw::Atoi(arg[i + 2]);
                if (ahMap->Map().Contains(val)) ahMap->ChangeMap().Remove(val);
            }
...
//=======================================================================
static Standard_Integer DDataStd_ChangeIntPackedMap_AddRem(Draw_Interpretor& di, Standard_Integer nb,
                                                           const char** arg) {
...
static Standard_Integer DDataStd_SetIntPHugeMap(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
...
static Standard_Integer DDataStd_SetNDataIntegers2(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    ...
    if (nb == 4) {
        ...
        if (!aLabel.FindAttribute(TDataStd_NamedData::GetID(), anAtt)) anAtt = TDataStd_NamedData::Set(aLabel);
        if (anAtt.IsNull()) {
...
static Standard_Integer DDataStd_SetNDataIntAr2(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
...
static Standard_Integer DDataStd_SetAsciiString(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
...
static Standard_Integer DDataStd_GetAsciiString(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 3 || nb == 4) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        TDF_Label aLabel;
...
static Standard_Integer DDataStd_SetNDataIntegers(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
...
//=======================================================================
static Standard_Integer DDataStd_GetNDIntegers(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
...
//=======================================================================
static Standard_Integer DDataStd_GetNDInteger(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
...
static Standard_Integer DDataStd_SetNDataReals(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
...
//=======================================================================
static Standard_Integer DDataStd_GetNDReals(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
...
//=======================================================================
static Standard_Integer DDataStd_GetNDReal(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    ...
    if (nb >= 4) {
        ...
        if (!anAtt->HasReal(aKey)) {
            ...
            if (nb == 5) Draw::Set(arg[4], anAtt->GetReal(aKey));
            return 0;
        }
    }
...
static Standard_Integer DDataStd_SetNDataStrings(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
...
//=======================================================================
namespace {
typedef std::pair<TCollection_ExtendedString, TCollection_ExtendedString> DDataStd_GetNDStrings_Property;

bool isLess(const DDataStd_GetNDStrings_Property& theProperty1, const DDataStd_GetNDStrings_Property& theProperty2) {
    return theProperty1.first.IsLess(theProperty2.first);
}
} // namespace

static Standard_Integer DDataStd_GetNDStrings(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
...
//=======================================================================
static Standard_Integer DDataStd_GetNDString(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    ...
    if (nb >= 4) {
        ...
        if (!anAtt->HasString(aKey)) {
            ...
            if (nb == 5) Draw::Set(arg[4], aValue.ToCString());
            return 0;
        }
    }
...
static Standard_Integer DDataStd_SetNDataBytes(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
...
//=======================================================================
static Standard_Integer DDataStd_GetNDBytes(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
...
//=======================================================================
static Standard_Integer DDataStd_GetNDByte(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    ...
    if (nb >= 4) {
        ...
        if (!anAtt->HasByte(aKey)) {
            ...
            if (nb == 5) Draw::Set(arg[4], anAtt->GetByte(aKey));
            return 0;
        }
    }
...
static Standard_Integer DDataStd_SetNDataIntAr(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
...
//=======================================================================
static Standard_Integer DDataStd_GetNDIntArrays(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
...
//=======================================================================
static Standard_Integer DDataStd_GetNDIntArray(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
...
static Standard_Integer DDataStd_SetNDataRealAr(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
...
//=======================================================================
static Standard_Integer DDataStd_GetNDRealArrays(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
...
//=======================================================================
static Standard_Integer DDataStd_GetNDRealArray(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
...
//=======================================================================
static Standard_Integer DDataStd_SetRefArray(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb >= 5) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        TDF_Label label;
...
//=======================================================================
static Standard_Integer DDataStd_SetRefArrayValue(Draw_Interpretor&, Standard_Integer, const char** arg) {
    // Get document.
    Handle(TDF_Data) DF;
    if (!DDF::GetDF(arg[1], DF)) return 1;
...
//=======================================================================
static Standard_Integer DDataStd_GetRefArray(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb >= 3) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
        TDF_Label label;
...
//=======================================================================
static Standard_Integer DDataStd_GetRefArrayValue(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb >= 3) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
static Standard_Integer DDataStd_SetTriangulation(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 4) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;

        TDF_Label L;
        if (!DDF::AddLabel(DF, arg[2], L)) return 1;
...
static Standard_Integer DDataStd_DumpMesh(Draw_Interpretor& di, Standard_Integer nb, const char** arg) {
    if (nb == 3) {
        Handle(TDF_Data) DF;
        if (!DDF::GetDF(arg[1], DF)) return 1;
...
void DDataStd::BasicCommands(Draw_Interpretor& theCommands) {
    ...
    theCommands.Add("SetInteger", "SetInteger (DF, entry, value [,guid])", __FILE__, DDataStd_SetInteger, g);

    theCommands.Add("SetIntArray", "SetIntArray (DF, entry, isDelta, [-g Guid,] From, To [, elmt1, elmt2, ...])",
                    __FILE__, DDataStd_SetIntArray, g);

    theCommands.Add("SetIntArrayValue", "SetIntArrayValue (DF, entry, index, value)", __FILE__,
                    DDataStd_SetIntArrayValue, g);

    theCommands.Add("SetReal", "SetReal (DF, entry, value [,guid])", __FILE__, DDataStd_SetReal, g);

    theCommands.Add("SetRealArray", "SetRealArray (DF, entry, isDelta, [-g Guid,] From, To [, elmt1, elmt2, ...])",
                    __FILE__, DDataStd_SetRealArray, g);

    theCommands.Add("SetRealArrayValue", "SetRealArrayValue (DF, entry, index, value)", __FILE__,
                    DDataStd_SetRealArrayValue, g);

    theCommands.Add("SetByteArray", "SetByteArray (DF, entry, isDelta, [-g Guid,] From, To [, elmt1, elmt2, ...])",
                    __FILE__, DDataStd_SetByteArray, g);

    theCommands.Add("SetByteArrayValue", "SetByteArrayValue (DF, entry, index, value)", __FILE__,
                    DDataStd_SetByteArrayValue, g);

    theCommands.Add("SetExtStringArray",
                    "SetExtStringArray (DF, entry, isDelta, [-g Guid,] From, To [, elmt1, elmt2, ...])", __FILE__,
                    DDataStd_SetExtStringArray, g);

    theCommands.Add("SetExtStringArrayValue", "SetExtStringArrayValue (DF, entry, index, value)", __FILE__,
                    DDataStd_SetExtStringArrayValue, g);

    theCommands.Add("SetRefArray", "SetRefArray (DF, entry, [-g Guid,] From, To [, lab1, lab2, ...])", __FILE__,
                    DDataStd_SetRefArray, g);

    theCommands.Add("SetRefArrayValue", "SetRefArrayValue (DF, entry, index, value)", __FILE__,
                    DDataStd_SetRefArrayValue, g);

    theCommands.Add("SetIntPackedMap", "SetIntPackedMap (DF, entry, isDelta, key1, key2, ...  )", __FILE__,
                    DDataStd_SetIntPackedMap, g);

    theCommands.Add("SetReference", "SetReference (DF, entry, reference)", __FILE__, DDataStd_SetReference, g);

    theCommands.Add("SetComment", "SetComment (DF, entry, comment)", __FILE__, DDataStd_SetComment, g);

    theCommands.Add("SetUAttribute", "SetUAttribute (DF, entry, LocalID)", __FILE__, DDataStd_SetUAttribute, g);

    theCommands.Add("SetVariable", "SetVariable (DF, entry, isConstant[0/1], units)", __FILE__, DDataStd_SetVariable,
                    g);

    theCommands.Add("SetAsciiString", "SetAsciiString (DF, entry, String  )", __FILE__, DDataStd_SetAsciiString, g);

    theCommands.Add("SetBooleanArray", "SetBooleanArray (DF, entry, [-g Guid,] From, To [, elmt1, elmt2, ...])",
                    __FILE__, DDataStd_SetBooleanArray, g);

    theCommands.Add("SetBooleanArrayValue", "SetBooleanArrayValue (DF, entry, index, value)", __FILE__,
                    DDataStd_SetBooleanArrayValue, g);

    theCommands.Add("SetBooleanList", "SetBooleanList (DF, entry, [-g Guid,] elmt1, elmt2, ...  )", __FILE__,
                    DDataStd_SetBooleanList, g);

    theCommands.Add("SetIntegerList", "SetIntegerList (DF, entry, [-g Guid,] elmt1, elmt2, ...  )", __FILE__,
                    DDataStd_SetIntegerList, g);

    theCommands.Add("SetRealList", "SetRealList (DF, entry, [-g guid,] elmt1, elmt2, ...  )", __FILE__,
                    DDataStd_SetRealList, g);

    theCommands.Add("SetExtStringList", "SetExtStringList (DF, entry,[-g Guid,] elmt1, elmt2, ...  )", __FILE__,
                    DDataStd_SetExtStringList, g);

    theCommands.Add("SetReferenceList", "SetReferenceList (DF, entry, [-g Guid,] elmt1, elmt2, ...  )", __FILE__,
                    DDataStd_SetReferenceList, g);

    theCommands.Add("SetTriangulation", "SetTriangulation (DF, entry, face) - adds label with passed entry to \
                    DF and put an attribute with the triangulation from passed face",
                    __FILE__, DDataStd_SetTriangulation, g);

    theCommands.Add("InsertBeforeExtStringList", "InsertBeforeExtStringList (DF, entry, index, value )", __FILE__,
                    DDataStd_InsertBeforeExtStringList, g);

    theCommands.Add("InsertAfterExtStringList", "InsertAfterExtStringList (DF, entry, index, value )", __FILE__,
                    DDataStd_InsertAfterExtStringList, g);

    theCommands.Add("RemoveExtStringList", "RemoveExtStringList (DF, entry, index )", __FILE__,
                    DDataStd_RemoveExtStringList, g);

    theCommands.Add("InsertBeforeBooleanList", "InsertBeforeBooleanList (DF, entry, index, value )", __FILE__,
                    DDataStd_InsertBeforeBooleanList, g);

    theCommands.Add("InsertAfterBooleanList", "InsertAfterBooleanList (DF, entry, index, value )", __FILE__,
                    DDataStd_InsertAfterBooleanList, g);

    theCommands.Add("RemoveBooleanList", "RemoveBooleanList (DF, entry, index )", __FILE__, DDataStd_RemoveBooleanList,
                    g);

    theCommands.Add("InsertBeforeIntegerList", "InsertBeforeIntegerList (DF, entry, index, value )", __FILE__,
                    DDataStd_InsertBeforeIntegerList, g);

    theCommands.Add("InsertAfterIntegerList", "InsertAfterIntegerList (DF, entry, index, value )", __FILE__,
                    DDataStd_InsertAfterIntegerList, g);

    theCommands.Add("RemoveIntegerList", "RemoveIntegerList (DF, entry, index )", __FILE__, DDataStd_RemoveIntegerList,
                    g);

    theCommands.Add("InsertBeforeRealList", "InsertBeforeRealList (DF, entry, index, value )", __FILE__,
                    DDataStd_InsertBeforeRealList, g);

    theCommands.Add("InsertAfterRealList", "InsertAfterRealList (DF, entry, index, value )", __FILE__,
                    DDataStd_InsertAfterRealList, g);

    theCommands.Add("RemoveRealList", "RemoveRealList (DF, entry, index )", __FILE__, DDataStd_RemoveRealList, g);

    theCommands.Add("InsertBeforeReferenceList", "InsertBeforeReferenceList (DF, entry, index, value )", __FILE__,
                    DDataStd_InsertBeforeReferenceList, g);

    theCommands.Add("InsertAfterReferenceList", "InsertAfterReferenceList (DF, entry, index, value )", __FILE__,
                    DDataStd_InsertAfterReferenceList, g);

    theCommands.Add("RemoveReferenceList", "RemoveReferenceList (DF, entry, index )", __FILE__,
                    DDataStd_RemoveReferenceList, g);

    // GET

    theCommands.Add("GetAsciiString", "GetAsciiString (DF, entry  )", __FILE__, DDataStd_GetAsciiString, g);

    theCommands.Add("GetInteger", "GetInteger (DF, entry, [drawname][, guid])", __FILE__, DDataStd_GetInteger, g);

    theCommands.Add("GetIntArray", "GetIntArray (DF, entry [, guid])", __FILE__, DDataStd_GetIntArray, g);

    theCommands.Add("GetIntArrayValue", "GetIntArrayValue (DF, entry, index)", __FILE__, DDataStd_GetIntArrayValue, g);

    theCommands.Add("GetRealArray", "GetRealArray (DF, entry [, guid])", __FILE__, DDataStd_GetRealArray, g);

    theCommands.Add("GetRealArrayValue", "GetRealArrayValue (DF, entry, index)", __FILE__, DDataStd_GetRealArrayValue,
                    g);

    theCommands.Add("GetByteArray", "GetByteArray (DF, entry [, guid])", __FILE__, DDataStd_GetByteArray, g);

    theCommands.Add("GetByteArrayValue", "GetByteArrayValue (DF, entry, index)", __FILE__, DDataStd_GetByteArrayValue,
                    g);

    theCommands.Add("GetExtStringArray", "GetExtStringArray (DF, entry [, guid])", __FILE__, DDataStd_GetExtStringArray,
                    g);

    theCommands.Add("GetExtStringArrayValue", "GetExtStringArrayValue (DF, entry, index)", __FILE__,
                    DDataStd_GetExtStringArrayValue, g);

    theCommands.Add("GetRefArray", "GetRefArray (DF, entry [, guid])", __FILE__, DDataStd_GetRefArray, g);

    theCommands.Add("GetRefArrayValue", "GetRefArrayValue (DF, entry, index)", __FILE__, DDataStd_GetRefArrayValue, g);

    theCommands.Add("GetIntPackedMap", "GetIntPackedMap (DF, entry  )", __FILE__, DDataStd_GetIntPackedMap, g);

    theCommands.Add("GetReal", "GetReal (DF, entry, [drawname][, guid])", __FILE__, DDataStd_GetReal, g);
    ...
    theCommands.Add("GetUAttribute", "GetUAttribute (DF, entry)", __FILE__, DDataStd_GetUAttribute, g);

    theCommands.Add("GetVariable", "GetVariable (DF, entry, [isConstant], [units])", __FILE__, DDataStd_GetVariable, g);

    theCommands.Add("SetRelation", "SetRelation (DF, entry, expression, var1[, var2, ...])", __FILE__,
                    DDataStd_SetRelation, g);

    theCommands.Add("DumpRelation", "DumpRelation (DF, entry)", __FILE__, DDataStd_DumpRelation, g);

    theCommands.Add("GetBooleanArray", "GetBooleanArray (DF, entry [, guid])", __FILE__, DDataStd_GetBooleanArray, g);

    theCommands.Add("GetBooleanArrayValue", "GetBooleanArrayValue (DF, entry, index)", __FILE__,
                    DDataStd_GetBooleanArrayValue, g);

    theCommands.Add("GetBooleanList", "GetBooleanList (DF, entry [, guid])", __FILE__, DDataStd_GetBooleanList, g);

    theCommands.Add("GetIntegerList", "GetIntegerList (DF, entry [, guid])", __FILE__, DDataStd_GetIntegerList, g);

    theCommands.Add("GetRealList", "GetRealList (DF, entry [, guid])", __FILE__, DDataStd_GetRealList, g);

    theCommands.Add("GetExtStringList", "GetExtStringList (DF, entry [, guid])", __FILE__, DDataStd_GetExtStringList,
                    g);

    theCommands.Add("GetReferenceList", "GetReferenceList (DF, entry [, guid])", __FILE__, DDataStd_GetReferenceList,
                    g);

    // ========================= UTF =====================================
    const char* ggg = "UTF Commands";

    theCommands.Add("SetUTFName", "SetUTFName (DF, entry, fileName)", __FILE__, DDataStd_KeepUTF, ggg);
    ...
    theCommands.Add("SetNDataIntegers", "SetNDataIntegers (DF, entry, NumPairs, key1, val1, ...  )", __FILE__,
                    DDataStd_SetNDataIntegers, gN);

    theCommands.Add("SetNDataReals", "SetNDataReals (DF, entry, NumPairs, key1, val1, ...  )", __FILE__,
                    DDataStd_SetNDataReals, gN);

    theCommands.Add("SetNDataStrings", "SetNDataStrings (DF, entry, NumPairs, key1, val1, ...  )", __FILE__,
                    DDataStd_SetNDataStrings, gN);

    theCommands.Add("SetNDataBytes", "SetNDataBytes (DF, entry, NumPairs, key1, val1, ...  )", __FILE__,
                    DDataStd_SetNDataBytes, gN);

    theCommands.Add("SetNDataIntArrays", "SetNDataIntArrays (DF entry entry  key NumOfArrElems val1 val2...  )",
                    __FILE__, DDataStd_SetNDataIntAr, gN);

    theCommands.Add("SetNDataRealArrays", "SetNDataRealArrays (DF entry key NumOfArrElems val1 val2...  )", __FILE__,
                    DDataStd_SetNDataRealAr, gN);

    // GET

    theCommands.Add("GetNDIntegers", "GetNDIntegers (DF, entry )", __FILE__, DDataStd_GetNDIntegers, g);

    theCommands.Add("GetNDInteger", "GetNDInteger (DF entry key [drawname])", __FILE__, DDataStd_GetNDInteger, g);

    theCommands.Add("GetNDReals", "GetNDReals (DF entry )", __FILE__, DDataStd_GetNDReals, g);

    theCommands.Add("GetNDReal", "GetNDReal (DF entry key [drawname])", __FILE__, DDataStd_GetNDReal, g);

    theCommands.Add("GetNDStrings", "GetNDStrings (DF entry )", __FILE__, DDataStd_GetNDStrings, g);

    theCommands.Add("GetNDString", "GetNDString (DF entry key [drawname])", __FILE__, DDataStd_GetNDString, g);

    theCommands.Add("GetNDBytes", "GetNDBytes (DF entry )", __FILE__, DDataStd_GetNDBytes, g);

    theCommands.Add("GetNDByte", "GetNDByte (DF entry key [drawname])", __FILE__, DDataStd_GetNDByte, g);

    theCommands.Add("GetNDIntArrays", "GetNDIntArrays (DF, entry )", __FILE__, DDataStd_GetNDIntArrays, g);

    theCommands.Add("GetNDIntArray", "GetNDIntArray (DF entry key )", __FILE__, DDataStd_GetNDIntArray, g);

    theCommands.Add("GetNDRealArrays", "GetNDRealArrays (DF entry )", __FILE__, DDataStd_GetNDRealArrays, g);

    theCommands.Add("GetNDRealArray", "GetNDRealArray (DF entry key )", __FILE__, DDataStd_GetNDRealArray, g);

    //====================== Change =======================
    theCommands.Add("ChangeByteArray", "ChangeByteArray (DF, entry, indx, value )", __FILE__, DDataStd_ChangeByteArray,
                    g);

    theCommands.Add("ChangeIntArray", "ChangeIntArray (DF, entry, indx, value )", __FILE__, DDataStd_ChangeIntArray, g);

    theCommands.Add("ChangeRealArray", "ChangeRealArray (DF, entry, indx, value )", __FILE__, DDataStd_ChangeRealArray,
                    g);

    theCommands.Add("ChangeExtStrArray", "ChangeExtStrArray (DF, entry, indx, value )", __FILE__,
                    DDataStd_ChangeExtStrArray, g);

    theCommands.Add("ChangeIntPackedMap_Add", "ChangeIntPackedMAp_Add (DF, entry, key[,key [...]] )", __FILE__,
                    DDataStd_ChangeIntPackedMap_Add, g);

    theCommands.Add("ChangeIntPackedMap_Rem", "ChangeIntPackedMAp_Rem (DF, entry, key[,key [...]] )", __FILE__,
                    DDataStd_ChangeIntPackedMap_Rem, g);

    theCommands.Add("ChangeIntPackedMap_AddRem", "ChangeIntPackedMAp_AddRem (DF, entry, key[,key [...]] )", __FILE__,
                    DDataStd_ChangeIntPackedMap_AddRem, g);

    //=========================================================
    // TFunction commands
    const char* gg = "DFunction Commands";

    theCommands.Add("SetFunction", "SetFunction (DF, entry, guid, failure)", __FILE__, DDataStd_SetFunction, gg);

    theCommands.Add("GetFunction", "GetFunction (DF, entry, guid(out), failure(out))", __FILE__, DDataStd_GetFunction,
                    gg);

    //=========================================================

    theCommands.Add("DumpTriangulation", "DumpTriangulations (DF, entry) - dumps info about triangulation that \
    ...
    theCommands.Add("SetNDataIntegers2", "SetNDataIntegers2 (DF, entry, NumPair  )", __FILE__,
                    DDataStd_SetNDataIntegers2, gN);

    theCommands.Add("SetNDataIntArrays2", "SetNDataIntArrays2 (DF entry entry  key NumOfArrElems)", __FILE__,
                    DDataStd_SetNDataIntAr2, gN);

    theCommands.Add("SetIntArrayT", "SetIntArrayT (DF, entry, isDelta, From, To  )", __FILE__, DDataStd_SetIntArrayTest,
                    g);

    theCommands.Add("SetIntPHugeMap", "SetIntPHugeMap (DF, entry, isDelta Num)", __FILE__, DDataStd_SetIntPHugeMap, g);
