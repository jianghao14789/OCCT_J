...
//! or when user scales page in the browser (in both cases window.devicePixelRatio JavaScript property becomes not equal
//! to 1.0).
//!
...
public:
    ...
    Standard_EXPORT Wasm_Window(const TCollection_AsciiString& theCanvasId, const bool theToScaleBacking = true);
    ...
    Standard_EXPORT virtual void Position(Standard_Integer& theX1, Standard_Integer& theY1, Standard_Integer& theX2,
                                          Standard_Integer& theY2) const Standard_OVERRIDE;

    //! Return the window size in pixels.
    Standard_EXPORT virtual void Size(Standard_Integer& theWidth, Standard_Integer& theHeight) const Standard_OVERRIDE;
    ...
    virtual Standard_Real DevicePixelRatio() const Standard_OVERRIDE {
...
public:
    ...
    Standard_EXPORT virtual bool ProcessMessage(Aspect_WindowInputListener& theListener, int theEventType,
                                                const void* theEvent);
    ...
    //! @param[in] theEvent message to process
    //! @return TRUE if message has been processed
    Standard_EXPORT virtual bool ProcessMouseEvent(Aspect_WindowInputListener& theListener, int theEventType,
    ...
    //! @param[in] theEvent message to process
    //! @return TRUE if message has been processed
    Standard_EXPORT virtual bool ProcessWheelEvent(Aspect_WindowInputListener& theListener, int theEventType,
    ...
    //! @param[in] theEvent message to process
    //! @return TRUE if message has been processed
    Standard_EXPORT virtual bool ProcessTouchEvent(Aspect_WindowInputListener& theListener, int theEventType,
    ...
    //! @param[in] theEvent message to process
    //! @return TRUE if message has been processed
    Standard_EXPORT virtual bool ProcessKeyEvent(Aspect_WindowInputListener& theListener, int theEventType,
    ...
    //! @param[in] theEvent message to process
    //! @return TRUE if message has been processed
    Standard_EXPORT virtual bool ProcessUiEvent(Aspect_WindowInputListener& theListener, int theEventType,
    ...
    //! @param[in] theEvent message to process
    //! @return TRUE if message has been processed
    Standard_EXPORT virtual bool ProcessFocusEvent(Aspect_WindowInputListener& theListener, int theEventType,
