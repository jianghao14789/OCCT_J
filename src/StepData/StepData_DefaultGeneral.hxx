...
public:
    ...
    Standard_EXPORT void FillSharedCase(const Standard_Integer casenum, const Handle(Standard_Transient) & ent,
                                        Interface_EntityIterator& iter) const Standard_OVERRIDE;

    //! Specific Checking of an Entity <ent>
    Standard_EXPORT void CheckCase(const Standard_Integer casenum, const Handle(Standard_Transient) & ent,
    ...
    Standard_EXPORT void CopyCase(const Standard_Integer casenum, const Handle(Standard_Transient) & entfrom,
