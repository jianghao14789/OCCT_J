...
StepData_ESDescr::StepData_ESDescr(const Standard_CString name) : thenom(name) {}
...
void StepData_ESDescr::SetField(const Standard_Integer num, const Standard_CString name,
