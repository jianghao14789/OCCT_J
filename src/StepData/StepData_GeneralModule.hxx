...
public:
    ...
    Standard_EXPORT virtual void FillSharedCase(const Standard_Integer casenum, const Handle(Standard_Transient) & ent,
                                                Interface_EntityIterator& iter) const Standard_OVERRIDE = 0;

    //! Specific Checking of an Entity <ent>
    Standard_EXPORT virtual void CheckCase(const Standard_Integer casenum, const Handle(Standard_Transient) & ent,
    ...
    Standard_EXPORT virtual void CopyCase(const Standard_Integer casenum, const Handle(Standard_Transient) & entfrom,
