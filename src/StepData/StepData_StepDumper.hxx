...
public:
    ...
    Standard_EXPORT StepData_StepDumper(const Handle(StepData_StepModel) & amodel,
                                        const Handle(StepData_Protocol) & protocol, const Standard_Integer mode = 0);
    ...
    Standard_EXPORT Standard_Boolean Dump(Standard_OStream& S, const Handle(Standard_Transient) & ent,
    ...
    Standard_EXPORT Standard_Boolean Dump(Standard_OStream& S, const Standard_Integer num,
                                          const Standard_Integer level);
