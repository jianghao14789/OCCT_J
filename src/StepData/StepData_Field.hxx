...
public:
    ...
    Standard_EXPORT void SetList2(const Standard_Integer siz1, const Standard_Integer siz2,
                                  const Standard_Integer f1 = 1, const Standard_Integer f2 = 1);
    ...
    Standard_EXPORT void SetEnum(const Standard_Integer num, const Standard_Integer val,
    ...
    Standard_EXPORT Handle(Standard_Transient)
        Entity(const Standard_Integer n1 = 1, const Standard_Integer n2 = 1) const;
