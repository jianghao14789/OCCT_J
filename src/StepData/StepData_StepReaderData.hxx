...
public:
    ...
    Standard_EXPORT StepData_StepReaderData(const Standard_Integer nbheader, const Standard_Integer nbtotal,
    ...
    Standard_EXPORT void SetRecord(const Standard_Integer num, const Standard_CString ident,
    ...
    Standard_EXPORT void AddStepParam(const Standard_Integer num, const Standard_CString aval,
                                      const Interface_ParamType atype, const Standard_Integer nument = 0);
    ...
    Standard_EXPORT Standard_Integer SubListNumber(const Standard_Integer num, const Standard_Integer nump,
    ...
    Standard_EXPORT Standard_Boolean NamedForComplex(const Standard_CString name, const Standard_Integer num0,
    ...
    Standard_EXPORT Standard_Boolean NamedForComplex(const Standard_CString theName,
                                                     const Standard_CString theShortName, const Standard_Integer num0,
                                                     Standard_Integer& num, Handle(Interface_Check) & ach) const;
    ...
    Standard_EXPORT Standard_Boolean CheckNbParams(const Standard_Integer num, const Standard_Integer nbreq,
    ...
    //! for last parameter)
    Standard_EXPORT Standard_Boolean ReadSubList(const Standard_Integer num, const Standard_Integer nump,
    ...
    Standard_EXPORT Standard_Integer ReadSub(const Standard_Integer numsub, const Standard_CString mess,
    ...
    Standard_EXPORT Standard_Boolean ReadMember(const Standard_Integer num, const Standard_Integer nump,
                                                const Standard_CString mess, Handle(Interface_Check) & ach,
                                                Handle(StepData_SelectMember) & val) const;

    //! Safe variant for arbitrary type of argument
    template <class T>
    Standard_Boolean ReadMember(const Standard_Integer num, const Standard_Integer nump, const Standard_CString mess,
                                Handle(Interface_Check) & ach, Handle(T) & val) const {
    ...
    Standard_EXPORT Standard_Boolean ReadField(const Standard_Integer num, const Standard_Integer nump,
                                               const Standard_CString mess, Handle(Interface_Check) & ach,
                                               const Handle(StepData_PDescr) & descr, StepData_Field& fild) const;

    //! reads a list of fields controlled by an ESDescr
    Standard_EXPORT Standard_Boolean ReadList(const Standard_Integer num, Handle(Interface_Check) & ach,
                                              const Handle(StepData_ESDescr) & descr, StepData_FieldList& list) const;
    ...
    Standard_EXPORT Standard_Boolean ReadAny(const Standard_Integer num, const Standard_Integer nump,
                                             const Standard_CString mess, Handle(Interface_Check) & ach,
    ...
    Standard_EXPORT Standard_Boolean ReadXY(const Standard_Integer num, const Standard_Integer nump,
                                            const Standard_CString mess, Handle(Interface_Check) & ach,
    ...
    Standard_EXPORT Standard_Boolean ReadXYZ(const Standard_Integer num, const Standard_Integer nump,
                                             const Standard_CString mess, Handle(Interface_Check) & ach,
    ...
    Standard_EXPORT Standard_Boolean ReadReal(const Standard_Integer num, const Standard_Integer nump,
                                              const Standard_CString mess, Handle(Interface_Check) & ach,
    ...
    Standard_EXPORT Standard_Boolean ReadEntity(const Standard_Integer num, const Standard_Integer nump,
                                                const Standard_CString mess, Handle(Interface_Check) & ach,
    ...
    //! Safe variant for arbitrary type of argument
    template <class T>
    Standard_Boolean ReadEntity(const Standard_Integer num, const Standard_Integer nump, const Standard_CString mess,
                                Handle(Interface_Check) & ach, const Handle(Standard_Type) & atype,
                                Handle(T) & ent) const {
    ...
    Standard_EXPORT Standard_Boolean ReadInteger(const Standard_Integer num, const Standard_Integer nump,
                                                 const Standard_CString mess, Handle(Interface_Check) & ach,
    ...
    Standard_EXPORT Standard_Boolean ReadBoolean(const Standard_Integer num, const Standard_Integer nump,
                                                 const Standard_CString mess, Handle(Interface_Check) & ach,
    ...
    Standard_EXPORT Standard_Boolean ReadLogical(const Standard_Integer num, const Standard_Integer nump,
                                                 const Standard_CString mess, Handle(Interface_Check) & ach,
    ...
    Standard_EXPORT Standard_Boolean ReadString(const Standard_Integer num, const Standard_Integer nump,
                                                const Standard_CString mess, Handle(Interface_Check) & ach,
                                                Handle(TCollection_HAsciiString) & val) const;

    Standard_EXPORT Standard_Boolean ReadEnumParam(const Standard_Integer num, const Standard_Integer nump,
                                                   const Standard_CString mess, Handle(Interface_Check) & ach,
    ...
    Standard_EXPORT void FailEnumValue(const Standard_Integer num, const Standard_Integer nump,
    ...
    Standard_EXPORT Standard_Boolean ReadEnum(const Standard_Integer num, const Standard_Integer nump,
                                              const Standard_CString mess, Handle(Interface_Check) & ach,
    ...
    Standard_EXPORT Standard_Boolean ReadTypedParam(const Standard_Integer num, const Standard_Integer nump,
                                                    const Standard_Boolean mustbetyped, const Standard_CString mess,
                                                    Handle(Interface_Check) & ach, Standard_Integer& numr,
                                                    Standard_Integer& numrp, TCollection_AsciiString& typ) const;
    ...
    Standard_EXPORT Standard_Boolean CheckDerived(const Standard_Integer num, const Standard_Integer nump,
                                                  const Standard_CString mess, Handle(Interface_Check) & ach,
