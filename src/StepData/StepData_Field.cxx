...
void StepData_Field::SetInt(const Standard_Integer val) {
    ...
    if (thekind == KindInteger || thekind == KindBoolean || thekind == KindLogical || thekind == KindEnum) theint = val;
    //  else ?
}
...
void StepData_Field::SetList2(const Standard_Integer siz1, const Standard_Integer siz2, const Standard_Integer f1,
...
void StepData_Field::SetInt(const Standard_Integer num, const Standard_Integer val, const Standard_Integer kind) {
    DeclareAndCast(TColStd_HArray1OfInteger, hi, theany);
    if (!hi.IsNull()) {
        hi->SetValue(num, val);
        return;
...
void StepData_Field::SetEnum(const Standard_Integer num, const Standard_Integer val, const Standard_CString text) {
    DeclareAndCast(TColStd_HArray1OfTransient, ht, theany);
    if (ht.IsNull()) {
        SetInteger(num, val);
        return;
...
Standard_Integer StepData_Field::ItemKind(const Standard_Integer n1, const Standard_Integer n2) const {
...
Standard_CString StepData_Field::EnumText(const Standard_Integer n1, const Standard_Integer n2) const {
    return String(n1, n2);
}

Handle(Standard_Transient) StepData_Field::Entity(const Standard_Integer n1, const Standard_Integer n2) const {
