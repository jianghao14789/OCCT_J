...
public:
    ...
    Standard_EXPORT Handle(TCollection_HAsciiString)
        StringLabel(const Handle(Standard_Transient) & ent) const Standard_OVERRIDE;
    ...
    Standard_Boolean IsInitializedUnit() const {
        return myReadUnitIsInitialized;
    }
