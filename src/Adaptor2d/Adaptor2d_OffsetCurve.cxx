...
// purpose  :
//=======================================================================
Adaptor2d_OffsetCurve::Adaptor2d_OffsetCurve() : myOffset(0.0), myFirst(0.0), myLast(0.0) {}
...
Adaptor2d_OffsetCurve::Adaptor2d_OffsetCurve(const Handle(Adaptor2d_Curve2d) & theCurve)
    : myCurve(theCurve), myOffset(0.0), myFirst(0.0), myLast(0.0) {}
...
Adaptor2d_OffsetCurve::Adaptor2d_OffsetCurve(const Handle(Adaptor2d_Curve2d) & theCurve, const Standard_Real theOffset)
    : myCurve(theCurve), myOffset(theOffset), myFirst(theCurve->FirstParameter()), myLast(theCurve->LastParameter()) {}
...
Adaptor2d_OffsetCurve::Adaptor2d_OffsetCurve(const Handle(Adaptor2d_Curve2d) & theCurve, const Standard_Real theOffset,
                                             const Standard_Real theWFirst, const Standard_Real theWLast)
    : myCurve(theCurve), myOffset(theOffset), myFirst(theWFirst), myLast(theWLast) {}
...
void Adaptor2d_OffsetCurve::Load(const Standard_Real Offset, const Standard_Real WFirst, const Standard_Real WLast) {
    myOffset = Offset;
    myFirst = WFirst;
    myLast = WLast;
}
...
Handle(Adaptor2d_Curve2d) Adaptor2d_OffsetCurve::Trim(const Standard_Real First, const Standard_Real Last,
...
void Adaptor2d_OffsetCurve::D3(const Standard_Real U, gp_Pnt2d& P, gp_Vec2d& V1, gp_Vec2d& V2, gp_Vec2d& V3) const {
    if (myOffset != 0.) {
