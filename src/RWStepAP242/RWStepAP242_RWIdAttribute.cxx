...
void RWStepAP242_RWIdAttribute::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepAP242_RWIdAttribute::WriteStep(StepData_StepWriter& SW, const Handle(StepAP242_IdAttribute) & ent) const {
