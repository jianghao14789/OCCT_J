...
// purpose  :
//=======================================================================
void RWStepAP242_RWDraughtingModelItemAssociation::ReadStep(const Handle(StepData_StepReaderData) & data,
    ...
    data->ReadEntity(num, 4, "item_identified_representation_usage.used_representation", ach,
                     STANDARD_TYPE(StepRepr_Representation), aRepresentation);
    ...
    if (aType == Interface_ParamIdent) {
        data->ReadEntity(num, 5, "item_identified_representation_usage.identified_item", ach,
        ...
        for (Standard_Integer i = 1; i <= nbElements; i++) {
            if (data->ReadEntity(nbSub, i, "representation_item", ach, STANDARD_TYPE(StepRepr_RepresentationItem),
                                 anEnt))
...
// purpose  :
//=======================================================================
void RWStepAP242_RWDraughtingModelItemAssociation::WriteStep(StepData_StepWriter& SW,
                                                             const Handle(StepAP242_DraughtingModelItemAssociation) &
                                                                 ent) const {
    // Inherited fields of ItemIdentifiedRepresentationUsage
    SW.Send(ent->Name());
...
// purpose  :
//=======================================================================
void RWStepAP242_RWDraughtingModelItemAssociation::Share(const Handle(StepAP242_DraughtingModelItemAssociation) & ent,
