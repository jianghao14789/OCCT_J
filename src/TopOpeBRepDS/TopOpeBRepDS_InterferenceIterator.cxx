...
TopOpeBRepDS_InterferenceIterator::TopOpeBRepDS_InterferenceIterator()
    : myGKDef(Standard_False), myGDef(Standard_False), mySKDef(Standard_False), mySDef(Standard_False) {}
...
Standard_Boolean TopOpeBRepDS_InterferenceIterator::MatchInterference(const Handle(TopOpeBRepDS_Interference) &
                                                                      I) const {
