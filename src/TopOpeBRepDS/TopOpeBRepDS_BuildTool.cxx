...
TopOpeBRepDS_BuildTool::TopOpeBRepDS_BuildTool()
    : myCurveTool(TopOpeBRepTool_APPROX), myOverWrite(Standard_True), myTranslate(Standard_True) {}
...
TopOpeBRepDS_BuildTool::TopOpeBRepDS_BuildTool(const TopOpeBRepTool_OutCurveType O)
    : myCurveTool(O), myOverWrite(Standard_True), myTranslate(Standard_True) {}
...
TopOpeBRepDS_BuildTool::TopOpeBRepDS_BuildTool(const TopOpeBRepTool_GeomTool& GT)
    : myCurveTool(GT), myOverWrite(Standard_True), myTranslate(Standard_True) {}
...
void TopOpeBRepDS_BuildTool::MakeEdge(TopoDS_Shape& E, const TopOpeBRepDS_Curve& C,
...
void TopOpeBRepDS_BuildTool::MakeEdge(TopoDS_Shape& E, const Handle(Geom_Curve) & C, const Standard_Real Tol) const {
...
void TopOpeBRepDS_BuildTool::GetOrientedEdgeVertices(TopoDS_Edge& E, TopoDS_Vertex& Vmin, TopoDS_Vertex& Vmax,
...
void TopOpeBRepDS_BuildTool::UpdateEdgeCurveTol
    ...
    (const TopoDS_Face&, const TopoDS_Face&, TopoDS_Edge& E, const Handle(Geom_Curve) & C3Dnew,
     // const Standard_Real tol3d,
     const Standard_Real,
     // const Standard_Real tol2d1,
     const Standard_Real,
     // const Standard_Real tol2d2,
     const Standard_Real, Standard_Real& newtol, Standard_Real& newparmin, Standard_Real& newparmax) const
...
void TopOpeBRepDS_BuildTool::ApproxCurves(const TopOpeBRepDS_Curve& C, TopoDS_Edge& E, Standard_Integer& inewC,
    ...
    Standard_Boolean approxMade = myCurveTool.MakeCurves(parmin, parmax, C3D, PC1, PC2, F1, F2, C3Dnew, PC1new, PC2new,
    ...
    if (!approxMade) {
        ...
        UpdateEdgeCurveTol(F1, F2, E, C3Dnew, tolreached3d, tolreached2d, tolreached2d, newtol, newparmin, newparmax);
    }
...
// purpose  :
//=======================================================================
Standard_Boolean FUN_getUV(const Handle(Geom_Surface) surf, const Handle(Geom_Curve) C3D, const Standard_Real par3d,
                           Standard_Real& u0, Standard_Real& v0) {
    gp_Pnt P3d;
    C3D->D0(par3d, P3d);
...
Standard_Boolean FUN_reversePC(Handle(Geom2d_Curve) PCnew, const TopoDS_Face& F, const gp_Pnt& P3DC3D,
                               const Standard_Real par2d, const Standard_Real tol) {
    gp_Pnt2d P2D;
    PCnew->D0(par2d, P2D);
...
Standard_Boolean FUN_makeUisoLineOnSphe(const TopoDS_Face& F, // with geometry the spherical surface
                                        const Handle(Geom_Curve) C3D, Handle(Geom2d_Curve) PCnew,
                                        const Standard_Real tol3d) {
...
void TopOpeBRepDS_BuildTool::ComputePCurves(const TopOpeBRepDS_Curve& C, TopoDS_Edge& E, TopOpeBRepDS_Curve& newC,
                                            const Standard_Boolean comppc1, const Standard_Boolean comppc2,
    ...
    UpdateEdgeCurveTol(F1, F2, E, C3Dnew, tolreached3d, tolreached2d1, tolreached2d2, newtol, newparmin, newparmax);
...
void TopOpeBRepDS_BuildTool::PutPCurves(const TopOpeBRepDS_Curve& newC, TopoDS_Edge& E, const Standard_Boolean comppc1,
...
void TopOpeBRepDS_BuildTool::RecomputeCurves(const TopOpeBRepDS_Curve& C,
                                             ...
                                             const TopoDS_Edge&, TopoDS_Edge& E, Standard_Integer& inewC,
                                             const Handle(TopOpeBRepDS_HDataStructure) & HDS) const {
    const TopOpeBRepTool_GeomTool& GT = myCurveTool.GetGeomTool();
...
void TopOpeBRepDS_BuildTool::AddEdgeVertex(const TopoDS_Shape& Ein, TopoDS_Shape& Eou, const TopoDS_Shape& V) const {
    myBuilder.Add(Eou, V);
    TopoDS_Edge e1 = TopoDS::Edge(Ein);
    TopoDS_Edge e2 = TopoDS::Edge(Eou);
...
void TopOpeBRepDS_BuildTool::Parameter(const TopoDS_Shape& E, const TopoDS_Shape& V, const Standard_Real P) const {
...
void TopOpeBRepDS_BuildTool::Range(const TopoDS_Shape& E, const Standard_Real first, const Standard_Real last) const {
...
static Standard_Boolean Project(const Handle(Geom_Curve) & C, const TopoDS_Vertex& V, Standard_Real& p) {
...
void TopOpeBRepDS_BuildTool::Parameter(const TopOpeBRepDS_Curve& C, TopoDS_Shape& E, TopoDS_Shape& V) const {
...
void TopOpeBRepDS_BuildTool::Curve3D(TopoDS_Shape& E, const Handle(Geom_Curve) & C, const Standard_Real Tol) const {
...
void TopOpeBRepDS_BuildTool::TranslateOnPeriodic(TopoDS_Shape& F, TopoDS_Shape& E, Handle(Geom2d_Curve) & PC) const {
    ...
    if (newv) {
        if (UisoLineOnSphe) {
            ...
            if (!(pons.NbPoints() < 1)) pons.LowerDistanceParameters(u2, v2);
        } else
...
void TopOpeBRepDS_BuildTool::PCurve(TopoDS_Shape& F, TopoDS_Shape& E, const Handle(Geom2d_Curve) & PC) const {
    if (!PC.IsNull()) {
        ...
        if (tran) TranslateOnPeriodic(F, E, PCT);
...
void TopOpeBRepDS_BuildTool::PCurve(TopoDS_Shape& F, TopoDS_Shape& E, const TopOpeBRepDS_Curve& CDS,
