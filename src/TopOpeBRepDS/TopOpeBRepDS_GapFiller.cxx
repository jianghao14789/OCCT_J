...
TopOpeBRepDS_GapFiller::TopOpeBRepDS_GapFiller(const Handle(TopOpeBRepDS_HDataStructure) & HDS) : myHDS(HDS) {
...
void TopOpeBRepDS_GapFiller::FindAssociatedPoints(const Handle(TopOpeBRepDS_Interference) & I,
    ...
    //--------------------------------------------
    if (!LI.IsEmpty()) FilterByFace(F2, LI);

    //-------------------------------
    // Controle et Selection metrique
    //-------------------------------
    if (!LI.IsEmpty()) FilterByIncidentDistance(F2, I, LI);
...
void TopOpeBRepDS_GapFiller::AddPointsOnShape(const TopoDS_Shape& S, TopOpeBRepDS_ListOfInterference& LI) {
...
void TopOpeBRepDS_GapFiller::AddPointsOnConnexShape(const TopoDS_Shape&, const TopOpeBRepDS_ListOfInterference&) {}
...
static Standard_Boolean Normal(const Handle(TopOpeBRepDS_GapTool) & A, const Handle(TopOpeBRepDS_HDataStructure) & HDS,
                               const Handle(TopOpeBRepDS_Interference) & I, const TopoDS_Face& F, gp_Dir& D)
...
void TopOpeBRepDS_GapFiller::FilterByIncidentDistance(const TopoDS_Face& F, const Handle(TopOpeBRepDS_Interference) & I,
                                                      TopOpeBRepDS_ListOfInterference& LI) {
...
void TopOpeBRepDS_GapFiller::ReBuildGeom(const Handle(TopOpeBRepDS_Interference) & I, TColStd_MapOfInteger& View) {
