...
TCollection_AsciiString TopOpeBRepDS_Dumper::SPrintShape(const Standard_Integer IS) const {
    ...
    if (IS < 1 || IS > BDS.NbShapes()) return SS;
...
TCollection_AsciiString TopOpeBRepDS_Dumper::SPrintShapeRefOri(const TopoDS_Shape& S,
...
TCollection_AsciiString TopOpeBRepDS_Dumper::SPrintShapeRefOri(const TopTools_ListOfShape& L,
                                                               const TCollection_AsciiString& astr) const {
    TCollection_AsciiString SS;
    TopTools_ListIteratorOfListOfShape it(L);
    if (!it.More()) return SS;
    SS = SS + astr;
