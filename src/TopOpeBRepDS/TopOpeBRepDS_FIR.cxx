...
Standard_EXPORT Standard_Boolean FUN_Parameters(const gp_Pnt& Pnt, const TopoDS_Shape& F, Standard_Real& u,
                                                Standard_Real& v);
Standard_EXPORT Standard_Boolean FUN_edgeofface(const TopoDS_Shape& E, const TopoDS_Shape& F);

//------------------------------------------------------
Standard_Boolean FUN_isPonF(const TopOpeBRepDS_ListOfInterference& LIF, const gp_Pnt& P,
                            const TopOpeBRepDS_DataStructure& BDS, const TopoDS_Edge& E) {
...
//------------------------------------------------------
Standard_Boolean FUN_findPonF(const TopoDS_Edge& E, const TopOpeBRepDS_DataStructure& BDS,
                              const TopOpeBRepDS_ListOfInterference& LIF, gp_Pnt& P, Standard_Real& par) {
    ...
    for (; itI.More(); itI.Next()) {
        ...
        Handle(TopOpeBRepDS_Interference) & I = itI.Value();
...
// --------------------------------------------------------
static void FDS_ADDEDGE(const Standard_Boolean, const TCollection_AsciiString&, const Standard_Integer,
                        TopOpeBRepDS_FaceInterferenceTool& FITool, const TopoDS_Shape& FI, const TopoDS_Shape& F,
                        const TopoDS_Shape& Ecpx, const Standard_Boolean isEGsp,
...
void FUN_reduceEDGEgeometry1(TopOpeBRepDS_ListOfInterference& LI, const TopOpeBRepDS_DataStructure& BDS,
                             const Standard_Integer iFI, const Standard_Integer iEG, const TopoDS_Shape& EGsp,
    ...
    while (it1.More()) {
        ...
        while (it2.More()) {
            ...
            if (!isComplex) {
                ...
                //	TopOpeBRepDS_Transition T1 = I1->Transition(); TopAbs_Orientation O1 = T1.Orientation(TopAbs_IN); //
                //xpu :090498 	Standard_Boolean revT1 = toreverse && (M_FORWARD(O1) || M_REVERSED(O1));      // xpu
                //:090498 	if (revT1) I1->ChangeTransition() = T1.Complement();  //xpu :090498
            ...
            //      TopOpeBRepDS_Transition T2 = I2->Transition(); TopAbs_Orientation O2 = T2.Orientation(TopAbs_IN); //
            //      xpu :090498 Standard_Boolean revT2 = toreverse && (M_FORWARD(O2) || M_REVERSED(O2));       // xpu
            //      :090498 if (revT2) I2->ChangeTransition() = T2.Complement();  //xpu :090498
...
//------------------------------------------------------
void FUN_GmapS(TopOpeBRepDS_ListOfInterference& LI, const TopOpeBRepDS_DataStructure& BDS,
...
//------------------------------------------------------
void FUN_reduceEDGEgeometry(TopOpeBRepDS_ListOfInterference& LI, const TopOpeBRepDS_DataStructure& BDS,
                            const Standard_Integer iFI, const TopOpeBRepDS_DataMapOfShapeListOfShapeOn1State& MEsp) {
    if (!LI.Extent()) return;
        ...
        if (nExt == 1) {
            ...
            if (isEGsp) {
                ...
                for (; itlos.More(); itlos.Next()) {
                    ...
                    if (nLISFIN) LIout.Append(LISFIN);
                }
            } // isEGsp
            else {
...
// purpose  :
//=======================================================================
TopOpeBRepDS_FIR::TopOpeBRepDS_FIR(const Handle(TopOpeBRepDS_HDataStructure) & HDS) : myHDS(HDS) {}
...
// purpose  :
//=======================================================================
void TopOpeBRepDS_FIR::ProcessFaceInterferences(const Standard_Integer SIX,
                                                const TopOpeBRepDS_DataMapOfShapeListOfShapeOn1State& MEsp) {
    TopOpeBRepDS_DataStructure& BDS = myHDS->ChangeDS();
