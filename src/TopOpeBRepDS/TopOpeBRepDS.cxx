...
TCollection_AsciiString TopOpeBRepDS::SPrint(const TopOpeBRepDS_Kind k, const Standard_Integer i,
                                             const TCollection_AsciiString& S1, const TCollection_AsciiString& S2) {
...
Standard_OStream& TopOpeBRepDS::Print(const TopOpeBRepDS_Kind k, const Standard_Integer i, Standard_OStream& OS,
                                      const TCollection_AsciiString& S1, const TCollection_AsciiString& S2) {
