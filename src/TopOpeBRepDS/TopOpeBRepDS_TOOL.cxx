...
static void FDS_sortGb(const Handle(TopOpeBRepDS_HDataStructure) & HDS, const TopOpeBRepDS_ListOfInterference& LI,
                       TopOpeBRepDS_ListOfInterference& LIGb0, TopOpeBRepDS_ListOfInterference& LIGb1,
...
#define EXTERNAL (4)
#define CLOSING (5)
Standard_Integer TopOpeBRepDS_TOOL::EShareG(const Handle(TopOpeBRepDS_HDataStructure) & HDS, const TopoDS_Edge& E,
...
Standard_Boolean TopOpeBRepDS_TOOL::ShareG(const Handle(TopOpeBRepDS_HDataStructure) & HDS, const Standard_Integer i1,
...
Standard_Boolean TopOpeBRepDS_TOOL::GetEsd(const Handle(TopOpeBRepDS_HDataStructure) & HDS, const TopoDS_Shape& S,
                                           const Standard_Integer ie, Standard_Integer& iesd) {
