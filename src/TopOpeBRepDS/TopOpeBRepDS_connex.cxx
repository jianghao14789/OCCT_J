...
FDSCNX_EdgeConnexityShapeIndex(const TopoDS_Shape& E, const Handle(TopOpeBRepDS_HDataStructure) & HDS,
...
Standard_EXPORT const TopTools_ListOfShape&
FDSCNX_EdgeConnexitySameShape(const TopoDS_Shape& S, const Handle(TopOpeBRepDS_HDataStructure) & HDS) {
...
Standard_EXPORT void FDSCNX_Prepare(const TopoDS_Shape& /*S1*/, const TopoDS_Shape& /*S2*/,
...
Standard_EXPORT Standard_Boolean FDSCNX_HasConnexFace(const TopoDS_Shape& S,
                                                      const Handle(TopOpeBRepDS_HDataStructure) & HDS) {
    if (HDS.IsNull()) {
...
Standard_EXPORT void FDSCNX_FaceEdgeConnexFaces(const TopoDS_Shape& F, const TopoDS_Shape& E,
                                                const Handle(TopOpeBRepDS_HDataStructure) & HDS,
