...
void TopOpeBRepDS_EdgeInterferenceTool::Init(const TopoDS_Shape& E, const Handle(TopOpeBRepDS_Interference) & I) {
...
void TopOpeBRepDS_EdgeInterferenceTool::Add(const TopoDS_Shape& E, const TopoDS_Shape& V,
...
void TopOpeBRepDS_EdgeInterferenceTool::Add(const TopoDS_Shape& E,
                                            ...
                                            const TopOpeBRepDS_Point&, const Handle(TopOpeBRepDS_Interference) & I) {
    TopAbs_Orientation Eori = E.Orientation();
    if (Eori == TopAbs_INTERNAL || Eori == TopAbs_EXTERNAL) {
        return;
    }
