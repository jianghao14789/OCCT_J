...
Standard_EXPORT void FUN_scanloi(const TopOpeBRepDS_ListOfInterference& lI, TopOpeBRepDS_ListOfInterference& lFOR,
...
// NYIxpu251198 treating interferences IB1 !=IA1, IB2 != IA2
{
    ...
    Standard_Real tolE = BRep_Tool::Tolerance(E) * 1.e2; // nyitol
...
Standard_EXPORT Standard_Boolean FUN_ds_GetTr(
    ...
    const TopOpeBRepDS_DataStructure&, const Standard_Integer ISE,
    //				 const Standard_Integer G,
    const Standard_Integer, const TopOpeBRepDS_ListOfInterference& LIG, TopAbs_State& stb, Standard_Integer& isb,
    Standard_Integer& bdim, TopAbs_State& sta, Standard_Integer& isa, Standard_Integer& adim)
