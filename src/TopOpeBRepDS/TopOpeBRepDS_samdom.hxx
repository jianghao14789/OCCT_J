...
Standard_EXPORT void FDSSDM_s1s2makesordor(const TopTools_ListOfShape& L1, const TopTools_ListOfShape& L2,
                                           const TopoDS_Shape& S, TopTools_ListOfShape& LSO, TopTools_ListOfShape& LDO);
...
Standard_EXPORT void FDSSDM_copylist(const TopTools_ListOfShape& Lin, const Standard_Integer I1,
