...
public:
    ...
    virtual void GetCamera(Graphic3d_Mat4d& theProj, Graphic3d_Mat4d& theOrient,
    ...
    virtual void GetViewport(Standard_Real& theX, Standard_Real& theY, Standard_Real& theWidth,
