...
public:
    ...
    virtual void InsertVertex(const IVtk_IdType theShapeID, const IVtk_PointId thePointId,
    ...
    virtual void InsertLine(const IVtk_IdType theShapeID, const IVtk_PointId thePointId1,
                            const IVtk_PointId thePointId2, const IVtk_MeshType theMeshType = MT_Undefined) = 0;
    ...
    virtual void InsertLine(const IVtk_IdType theShapeID, const IVtk_PointIdList* thePointIds,
                            const IVtk_MeshType theMeshType = MT_Undefined) = 0;
    ...
    //! @param [in] theMeshType mesh type of the subshape (MT_Undefined by default)
    virtual void InsertTriangle(const IVtk_IdType theShapeID, const IVtk_PointId thePointId1,
