...
Handle(StepRepr_MeasureRepresentationItem) StepRepr_ReprItemAndMeasureWithUnit::GetMeasureRepresentationItem() const {
...
void StepRepr_ReprItemAndMeasureWithUnit::SetMeasureWithUnit(const Handle(StepBasic_MeasureWithUnit) & aMWU) {
    myMeasureWithUnit = aMWU;
}
...
Handle(StepRepr_RepresentationItem) StepRepr_ReprItemAndMeasureWithUnit::GetRepresentationItem() const {
