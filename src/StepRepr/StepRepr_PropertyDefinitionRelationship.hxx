...
public:
    ...
    Standard_EXPORT void SetRelatingPropertyDefinition(const Handle(StepRepr_PropertyDefinition) &
    ...
    Standard_EXPORT void SetRelatedPropertyDefinition(const Handle(StepRepr_PropertyDefinition) &
