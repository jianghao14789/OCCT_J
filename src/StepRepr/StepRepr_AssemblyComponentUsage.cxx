...
void StepRepr_AssemblyComponentUsage::Init(
    ...
    const Standard_Boolean hasReferenceDesignator, const Handle(TCollection_HAsciiString) & aReferenceDesignator) {
    StepRepr_ProductDefinitionUsage::Init(aProductDefinitionRelationship_Id, aProductDefinitionRelationship_Name,
...
void StepRepr_AssemblyComponentUsage::SetReferenceDesignator(const Handle(TCollection_HAsciiString) &
