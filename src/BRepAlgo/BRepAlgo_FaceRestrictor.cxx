...
void BRepAlgo_FaceRestrictor::Init(const TopoDS_Face& F, const Standard_Boolean Proj,
...
static Standard_Boolean ChangePCurve(TopoDS_Edge& E, const Handle(Geom_Surface) & S, TopLoc_Location& L) {
    BRep_Builder BB;
    ...
    if (!C2.IsNull()) BB.UpdateEdge(E, C2, S, L, Precision::Confusion());
    return (C2.IsNull());
}
...
static void ProjCurve3d(TopoDS_Edge& E, const Handle(Geom_Surface) & S, TopLoc_Location& L) {
    BRep_Builder BB;
    TopLoc_Location LE;
    Standard_Real f, l;
...
static Standard_Boolean IsInside(const TopoDS_Wire& wir, const TopoDS_Face& F, BRepTopAdaptor_FClass2d& /*FClass2d*/) {
    TopExp_Explorer exp;
...
static void Store(const TopoDS_Wire& W2, const TopoDS_Wire& W1, TopTools_DataMapOfShapeListOfShape& keyIsIn,
...
static void BuildFaceIn(TopoDS_Face& F, const TopoDS_Wire& W, TopTools_DataMapOfShapeListOfShape& KeyContains,
                        TopTools_DataMapOfShapeListOfShape& KeyIsIn, TopAbs_Orientation Orientation,
