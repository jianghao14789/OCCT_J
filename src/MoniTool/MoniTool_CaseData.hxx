...
public:
    ...
    Standard_EXPORT void AddData(const Handle(Standard_Transient) & val, const Standard_Integer kind,
    ...
    Standard_EXPORT void AddCPU(const Standard_Real lastCPU, const Standard_Real curCPU = 0,
                                const Standard_CString name = "");
    ...
    //! else it is currently measured CPU - lastCPU
    Standard_EXPORT Standard_Boolean LargeCPU(const Standard_Real maxCPU, const Standard_Real lastCPU,
    ...
    Standard_EXPORT Standard_Boolean GetData(const Standard_Integer nd, const Handle(Standard_Type) & type,
