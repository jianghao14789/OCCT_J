...
MoniTool_AttrList::MoniTool_AttrList(const MoniTool_AttrList& other) : theattrib(other.AttrList()) {}

//  ####    ATTRIBUTES    ####

// Integer -> IntVal, Real -> RealVal, CString -> HAsciiString

void MoniTool_AttrList::SetAttribute(const Standard_CString name, const Handle(Standard_Transient) & val) {
...
Standard_Boolean MoniTool_AttrList::GetAttribute(const Standard_CString name, const Handle(Standard_Type) & type,
...
MoniTool_ValueType MoniTool_AttrList::AttributeType(const Standard_CString name) const {
    ...
    if (atr->DynamicType() == STANDARD_TYPE(MoniTool_IntVal)) return MoniTool_ValueInteger;
    if (atr->DynamicType() == STANDARD_TYPE(MoniTool_RealVal)) return MoniTool_ValueReal;
    if (atr->DynamicType() == STANDARD_TYPE(TCollection_HAsciiString)) return MoniTool_ValueText;
...
Standard_Boolean MoniTool_AttrList::GetIntegerAttribute(const Standard_CString name, Standard_Integer& val) const {
...
Standard_Boolean MoniTool_AttrList::GetRealAttribute(const Standard_CString name, Standard_Real& val) const {
...
Standard_Boolean MoniTool_AttrList::GetStringAttribute(const Standard_CString name, Standard_CString& val) const {
    Handle(TCollection_HAsciiString) hval = Handle(TCollection_HAsciiString)::DownCast(Attribute(name));
    if (hval.IsNull()) {
        val = "";
        return Standard_False;
    }
...
void MoniTool_AttrList::GetAttributes(const MoniTool_AttrList& other, const Standard_CString fromname,
