...
public:
    ...
    LocOpe_PntFace() : myPar(0.0), myUPar(0.0), myVPar(0.0) {}

    LocOpe_PntFace(const gp_Pnt& P, const TopoDS_Face& F, const TopAbs_Orientation Or, const Standard_Real Param,
                   const Standard_Real UPar, const Standard_Real VPar)
