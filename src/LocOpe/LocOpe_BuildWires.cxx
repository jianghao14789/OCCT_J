...
static Standard_Integer FindFirstEdge(const TopTools_IndexedDataMapOfShapeListOfShape&, const TopTools_MapOfShape&);
...
LocOpe_BuildWires::LocOpe_BuildWires(const TopTools_ListOfShape& L, const Handle(LocOpe_WiresOnShape) & PW) {
    Perform(L, PW);
}
...
void LocOpe_BuildWires::Perform(const TopTools_ListOfShape& L, const Handle(LocOpe_WiresOnShape) & PW) {
