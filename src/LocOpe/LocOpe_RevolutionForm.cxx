...
LocOpe_RevolutionForm::LocOpe_RevolutionForm()
    : myAngle(0.0), myAngTra(0.0), myDone(Standard_False), myIsTrans(Standard_False) {}
...
void LocOpe_RevolutionForm::Perform(const TopoDS_Shape& Base, const gp_Ax1& Axis, const Standard_Real Angle) {
    myMap.Clear();
