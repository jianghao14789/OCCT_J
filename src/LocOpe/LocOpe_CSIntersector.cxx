...
static Standard_Boolean LocAfter(const LocOpe_SequenceOfPntFace&, const Standard_Real, const Standard_Real,
                                 TopAbs_Orientation&, Standard_Integer&, Standard_Integer&);

static Standard_Boolean LocBefore(const LocOpe_SequenceOfPntFace&, const Standard_Real, const Standard_Real,
                                  TopAbs_Orientation&, Standard_Integer&, Standard_Integer&);

static Standard_Boolean LocAfter(const LocOpe_SequenceOfPntFace&, const Standard_Integer, const Standard_Real,
                                 TopAbs_Orientation&, Standard_Integer&, Standard_Integer&);
...
const LocOpe_PntFace& LocOpe_CSIntersector::Point(const Standard_Integer I, const Standard_Integer Index) const {
    if (!myDone) {
        throw StdFail_NotDone();
    }
    if (I <= 0 || I > myNbelem) {
...
Standard_Boolean LocOpe_CSIntersector::LocalizeAfter(const Standard_Integer I, const Standard_Real From,
                                                     const Standard_Real Tol, TopAbs_Orientation& Or,
                                                     Standard_Integer& IndFrom, Standard_Integer& IndTo) const {
    if (!myDone) {
        throw StdFail_NotDone();
    }
    if (I <= 0 || I > myNbelem) {
...
Standard_Boolean LocOpe_CSIntersector::LocalizeBefore(const Standard_Integer I, const Standard_Real From,
                                                      const Standard_Real Tol, TopAbs_Orientation& Or,
                                                      Standard_Integer& IndFrom, Standard_Integer& IndTo) const {
    if (!myDone) {
        throw StdFail_NotDone();
...
Standard_Boolean LocOpe_CSIntersector::LocalizeAfter(const Standard_Integer I, const Standard_Integer FromInd,
                                                     const Standard_Real Tol, TopAbs_Orientation& Or,
                                                     Standard_Integer& IndFrom, Standard_Integer& IndTo) const {
    if (!myDone) {
        throw StdFail_NotDone();
...
Standard_Boolean LocOpe_CSIntersector::LocalizeBefore(const Standard_Integer I, const Standard_Integer FromInd,
                                                      const Standard_Real Tol, TopAbs_Orientation& Or,
                                                      Standard_Integer& IndFrom, Standard_Integer& IndTo) const {
    if (!myDone) {
        throw StdFail_NotDone();
...
static Standard_Boolean LocAfter(const LocOpe_SequenceOfPntFace& Spt, const Standard_Real From, const Standard_Real Tol,
                                 TopAbs_Orientation& Or, Standard_Integer& IndFrom, Standard_Integer& IndTo) {
...
static Standard_Boolean LocBefore(const LocOpe_SequenceOfPntFace& Spt, const Standard_Real From,
                                  const Standard_Real Tol, TopAbs_Orientation& Or, Standard_Integer& IndFrom,
...
static Standard_Boolean LocAfter(const LocOpe_SequenceOfPntFace& Spt, const Standard_Integer FromInd,
                                 const Standard_Real Tol, TopAbs_Orientation& Or, Standard_Integer& IndFrom,
                                 Standard_Integer& IndTo) {
...
static void AddPoints(IntCurvesFace_Intersector& theInt, LocOpe_SequenceOfPntFace& theSeq, const TopoDS_Face& theface) {
