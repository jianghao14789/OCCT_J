...
public:
    ...
    Standard_EXPORT IntAna_QuadQuadGeo(const gp_Pln& P1, const gp_Pln& P2, const Standard_Real TolAng,
    ...
    //! Tol is the tolerance used to determine if the planes
    //! are identical (only when they are parallel).
    Standard_EXPORT void Perform(const gp_Pln& P1, const gp_Pln& P2, const Standard_Real TolAng,
                                 const Standard_Real Tol);
    ...
    Standard_EXPORT IntAna_QuadQuadGeo(const gp_Pln& P, const gp_Cylinder& C, const Standard_Real Tolang,
                                       const Standard_Real Tol, const Standard_Real H = 0);
    ...
    //! H is the height of the cylinder <Cyl>. It is  used to check
    //! whether the plane and cylinder are parallel.
    Standard_EXPORT void Perform(const gp_Pln& P, const gp_Cylinder& C, const Standard_Real Tolang,
                                 const Standard_Real Tol, const Standard_Real H = 0);
    ...
    Standard_EXPORT IntAna_QuadQuadGeo(const gp_Pln& P, const gp_Cone& C, const Standard_Real Tolang,
                                       const Standard_Real Tol);
    ...
    //! Tol is the tolerance used to determine if the apex
    //! of the cone is in the plane.
    Standard_EXPORT void Perform(const gp_Pln& P, const gp_Cone& C, const Standard_Real Tolang,
                                 const Standard_Real Tol);
