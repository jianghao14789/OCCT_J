...
public:
    ...
    Standard_EXPORT IntAna_IntConicQuad(const gp_Lin& L, const gp_Pln& P, const Standard_Real Tolang,
                                        const Standard_Real Tol = 0, const Standard_Real Len = 0);
    ...
    Standard_EXPORT IntAna_IntConicQuad(const gp_Circ& C, const gp_Pln& P, const Standard_Real Tolang,
    ...
    //! vectors is null.
    //! Tol is used to determine if a distance is null.
    Standard_EXPORT void Perform(const gp_Circ& C, const gp_Pln& P, const Standard_Real Tolang,
                                 const Standard_Real Tol);
    ...
    //! vectors is null.
    //! Tol is used to determine if a distance is null.
    Standard_EXPORT IntAna_IntConicQuad(const gp_Elips& E, const gp_Pln& P, const Standard_Real Tolang,
                                        const Standard_Real Tol);
    ...
    //! vectors is null.
    //! Tol is used to determine if a distance is null.
    Standard_EXPORT void Perform(const gp_Elips& E, const gp_Pln& P, const Standard_Real Tolang,
                                 const Standard_Real Tol);
