...
class AxeOperator {
public:
    AxeOperator(const gp_Ax1& A1, const gp_Ax1& A2, const Standard_Real theEpsDistance = 1.e-14,
...
protected:
    Standard_Real Det33(const Standard_Real a11, const Standard_Real a12, const Standard_Real a13,
...
// purpose  :
//=======================================================================
AxeOperator::AxeOperator(const gp_Ax1& A1, const gp_Ax1& A2, const Standard_Real theEpsDistance,
                         const Standard_Real theEpsAxesPara)
    : Axe1(A1), Axe2(A2), myEPSILON_DISTANCE(theEpsDistance), myEPSILON_AXES_PARA(theEpsAxesPara) {
    //---------------------------------------------------------------------
    ...
    if (thedistance < myEPSILON_DISTANCE) {
        D33 = Det33(V1.X(), V1.Y(), V1.Z(), V2.X(), V2.Y(), V2.Z(), P1.X() - P2.X(), P1.Y() - P2.Y(), P1.Z() - P2.Z());
...
void AxeOperator::Distance(Standard_Real& dist, Standard_Real& Param1, Standard_Real& Param2) {
    ...
    if (D) {
        ...
        Param1 = Det33(O1O2.X(), U2.X(), N.X(), O1O2.Y(), U2.Y(), N.Y(), O1O2.Z(), U2.Z(), N.Z()) / (-D);
        //------------------------------------------------------------
...
IntAna_QuadQuadGeo::IntAna_QuadQuadGeo(void)
    : done(Standard_False), nbint(0), typeres(IntAna_Empty), pt1(0, 0, 0), pt2(0, 0, 0), pt3(0, 0, 0), pt4(0, 0, 0),
      param1(0), param2(0), param3(0), param4(0), param1bis(0), param2bis(0), myCommonGen(Standard_False),
      myPChar(0, 0, 0) {
    InitTolerances();
}
//=======================================================================
...
// purpose  : Pln  Pln
//=======================================================================
IntAna_QuadQuadGeo::IntAna_QuadQuadGeo(const gp_Pln& P1, const gp_Pln& P2, const Standard_Real TolAng,
...
// purpose  :
//=======================================================================
void IntAna_QuadQuadGeo::Perform(const gp_Pln& P1, const gp_Pln& P2, const Standard_Real TolAng,
                                 const Standard_Real Tol) {
...
//=======================================================================
IntAna_QuadQuadGeo::IntAna_QuadQuadGeo(const gp_Pln& P, const gp_Cylinder& Cl, const Standard_Real Tolang,
                                       const Standard_Real Tol, const Standard_Real H)
    : done(Standard_False), nbint(0), typeres(IntAna_Empty), pt1(0, 0, 0), pt2(0, 0, 0), pt3(0, 0, 0), pt4(0, 0, 0),
      param1(0), param2(0), param3(0), param4(0), param1bis(0), param2bis(0), myCommonGen(Standard_False),
      myPChar(0, 0, 0) {
    InitTolerances();
...
// purpose  :
//=======================================================================
void IntAna_QuadQuadGeo::Perform(const gp_Pln& P, const gp_Cylinder& Cl, const Standard_Real Tolang,
                                 const Standard_Real Tol, const Standard_Real H) {
    done = Standard_False;
    ...
    if (inter.IsParallel()) {
        ...
        if (Abs(Abs(dist) - radius) < Tol) {
            ...
            if (newparams) {
                ...
                gp_XYZ omega1(omegaXYZtrnsl.X() - distt * A, omegaXYZtrnsl.Y() - distt * B,
...
// purpose  : Pln Cone
//=======================================================================
IntAna_QuadQuadGeo::IntAna_QuadQuadGeo(const gp_Pln& P, const gp_Cone& Co, const Standard_Real Tolang,
                                       const Standard_Real Tol)
    : done(Standard_False), nbint(0), typeres(IntAna_Empty), pt1(0, 0, 0), pt2(0, 0, 0), pt3(0, 0, 0), pt4(0, 0, 0),
      param1(0), param2(0), param3(0), param4(0), param1bis(0), param2bis(0), myCommonGen(Standard_False),
      myPChar(0, 0, 0) {
...
// purpose  :
//=======================================================================
void IntAna_QuadQuadGeo::Perform(const gp_Pln& P, const gp_Cone& Co, const Standard_Real Tolang,
                                 const Standard_Real Tol) {
...
//=======================================================================
IntAna_QuadQuadGeo::IntAna_QuadQuadGeo(const gp_Cylinder& Cyl1, const gp_Cylinder& Cyl2, const Standard_Real Tol)
    : done(Standard_False), nbint(0), typeres(IntAna_Empty), pt1(0, 0, 0), pt2(0, 0, 0), pt3(0, 0, 0), pt4(0, 0, 0),
      param1(0), param2(0), param3(0), param4(0), param1bis(0), param2bis(0), myCommonGen(Standard_False),
      myPChar(0, 0, 0) {
    InitTolerances();
...
// purpose  :
//=======================================================================
void IntAna_QuadQuadGeo::Perform(const gp_Cylinder& Cyl1, const gp_Cylinder& Cyl2, const Standard_Real Tol) {
    done = Standard_True;
    //---------------------------- Parallel axes -------------------------
    AxeOperator A1A2(Cyl1.Axis(), Cyl2.Axis(), myEPSILON_CYLINDER_DELTA_DISTANCE, myEPSILON_AXES_PARA);
    ...
    if (A1A2.Parallel()) {
        if (DistA1A2 <= Tol) {
            ...
            // of the 1st cylinder
            P2.SetCoord(P2t.X() - ProjP2OnDirCyl1 * DirCyl.X(), P2t.Y() - ProjP2OnDirCyl1 * DirCyl.Y(),
            ...
            if (DistA1A2 > (R1pR2 + Tol)) {
                ...
                pt1.SetCoord(P1.X() + R1_R1pR2 * (P2.X() - P1.X()), P1.Y() + R1_R1pR2 * (P2.Y() - P1.Y()),
                ...
                */
                ...
                pt1.SetCoord(P1.X() + R1_RmR * (P2.X() - P1.X()), P1.Y() + R1_RmR * (P2.Y() - P1.Y()),
...
//=======================================================================
IntAna_QuadQuadGeo::IntAna_QuadQuadGeo(const gp_Cylinder& Cyl, const gp_Cone& Con, const Standard_Real Tol)
    : done(Standard_False), nbint(0), typeres(IntAna_Empty), pt1(0, 0, 0), pt2(0, 0, 0), pt3(0, 0, 0), pt4(0, 0, 0),
      param1(0), param2(0), param3(0), param4(0), param1bis(0), param2bis(0), myCommonGen(Standard_False),
      myPChar(0, 0, 0) {
    InitTolerances();
...
//=======================================================================
IntAna_QuadQuadGeo::IntAna_QuadQuadGeo(const gp_Cylinder& Cyl, const gp_Sphere& Sph, const Standard_Real Tol)
    : done(Standard_False), nbint(0), typeres(IntAna_Empty), pt1(0, 0, 0), pt2(0, 0, 0), pt3(0, 0, 0), pt4(0, 0, 0),
      param1(0), param2(0), param3(0), param4(0), param1bis(0), param2bis(0), myCommonGen(Standard_False),
      myPChar(0, 0, 0) {
    InitTolerances();
...
// purpose  : Cone - Cone
//=======================================================================
IntAna_QuadQuadGeo::IntAna_QuadQuadGeo(const gp_Cone& Con1, const gp_Cone& Con2, const Standard_Real Tol)
    : done(Standard_False), nbint(0), typeres(IntAna_Empty), pt1(0, 0, 0), pt2(0, 0, 0), pt3(0, 0, 0), pt4(0, 0, 0),
      param1(0), param2(0), param3(0), param4(0), param1bis(0), param2bis(0), myCommonGen(Standard_False),
      myPChar(0, 0, 0) {
    InitTolerances();
...
void IntAna_QuadQuadGeo::Perform(const gp_Cone& Con1, const gp_Cone& Con2, const Standard_Real Tol) {
    ...
    // 2
        ...
        gp_Vec O1_Proj_A2(O1O2n.X() - O1O2_DA1 * DA1.X(), O1O2n.Y() - O1O2_DA1 * DA1.Y(),
        ...
        gp_Pnt MO1O2(0.5 * (Con1.Apex().X() + Con2.Apex().X()), 0.5 * (Con1.Apex().Y() + Con2.Apex().Y()),
    ...
    // 3
        ...
        aQA1.SetCoord(aQApex1.X() + aD1 * aD3Ax1.X(), aQApex1.Y() + aD1 * aD3Ax1.Y(), aQApex1.Z() + aD1 * aD3Ax1.Z());
        //
        ...
        //
        aQA2.SetCoord(aQApex1.X() + aD2 * aD3Ax2.X(), aQApex1.Y() + aD2 * aD3Ax2.Y(), aQApex1.Z() + aD2 * aD3Ax2.Z());
        //
...
// purpose  : Sphere - Cone
//=======================================================================
IntAna_QuadQuadGeo::IntAna_QuadQuadGeo(const gp_Sphere& Sph, const gp_Cone& Con, const Standard_Real Tol)
    : done(Standard_False), nbint(0), typeres(IntAna_Empty), pt1(0, 0, 0), pt2(0, 0, 0), pt3(0, 0, 0), pt4(0, 0, 0),
      param1(0), param2(0), param3(0), param4(0), param1bis(0), param2bis(0), myCommonGen(Standard_False),
      myPChar(0, 0, 0) {
    InitTolerances();
...
void IntAna_QuadQuadGeo::Perform(const gp_Sphere& Sph, const gp_Cone& Con, const Standard_Real) {
    ...
    if ((A1A2.Intersect() && (Pt.Distance(A1A2.PtIntersect()) == 0.0)) || A1A2.Same()) {
        ...
        math_DirectPolynomialRoots Eq(1.0 + tgatga, 2.0 * tgatga * dApexSphCenter,
...
//=======================================================================
IntAna_QuadQuadGeo::IntAna_QuadQuadGeo(const gp_Sphere& Sph1, const gp_Sphere& Sph2, const Standard_Real Tol)
    : done(Standard_False), nbint(0), typeres(IntAna_Empty), pt1(0, 0, 0), pt2(0, 0, 0), pt3(0, 0, 0), pt4(0, 0, 0),
      param1(0), param2(0), param3(0), param4(0), param1bis(0), param2bis(0), myCommonGen(Standard_False),
      myPChar(0, 0, 0) {
    InitTolerances();
...
// purpose  :
//=======================================================================
void IntAna_QuadQuadGeo::Perform(const gp_Sphere& Sph1, const gp_Sphere& Sph2, const Standard_Real Tol) {
    done = Standard_True;
...
// purpose  : Plane - Torus
//=======================================================================
IntAna_QuadQuadGeo::IntAna_QuadQuadGeo(const gp_Pln& Pln, const gp_Torus& Tor, const Standard_Real Tol)
    : done(Standard_False), nbint(0), typeres(IntAna_Empty), pt1(0, 0, 0), pt2(0, 0, 0), pt3(0, 0, 0), pt4(0, 0, 0),
      param1(0), param2(0), param3(0), param4(0), param1bis(0), param2bis(0), myCommonGen(Standard_False),
      myPChar(0, 0, 0) {
    InitTolerances();
...
//=======================================================================
IntAna_QuadQuadGeo::IntAna_QuadQuadGeo(const gp_Cylinder& Cyl, const gp_Torus& Tor, const Standard_Real Tol)
    : done(Standard_False), nbint(0), typeres(IntAna_Empty), pt1(0, 0, 0), pt2(0, 0, 0), pt3(0, 0, 0), pt4(0, 0, 0),
      param1(0), param2(0), param3(0), param4(0), param1bis(0), param2bis(0), myCommonGen(Standard_False),
      myPChar(0, 0, 0) {
    InitTolerances();
...
// purpose  :
//=======================================================================
void IntAna_QuadQuadGeo::Perform(const gp_Cylinder& Cyl, const gp_Torus& Tor, const Standard_Real Tol) {
    done = Standard_True;
    //
    Standard_Real aRMin, aRMaj;
    //
    ...
    //
    if (!aTorAx.IsParallel(aCylAx, myEPSILON_AXES_PARA) || (aLin.Distance(aLocCyl) > myEPSILON_DISTANCE)) {
        typeres = IntAna_NoGeometricSolution;
        return;
    }
    //
...
// purpose  : Cone - Torus
//=======================================================================
IntAna_QuadQuadGeo::IntAna_QuadQuadGeo(const gp_Cone& Con, const gp_Torus& Tor, const Standard_Real Tol)
    : done(Standard_False), nbint(0), typeres(IntAna_Empty), pt1(0, 0, 0), pt2(0, 0, 0), pt3(0, 0, 0), pt4(0, 0, 0),
      param1(0), param2(0), param3(0), param4(0), param1bis(0), param2bis(0), myCommonGen(Standard_False),
      myPChar(0, 0, 0) {
    InitTolerances();
...
void IntAna_QuadQuadGeo::Perform(const gp_Cone& Con, const gp_Torus& Tor, const Standard_Real Tol) {
    ...
    //
    if (!aTorAx.IsParallel(aConAx, myEPSILON_AXES_PARA) || (aLin.Distance(aConApex) > myEPSILON_DISTANCE)) {
        typeres = IntAna_NoGeometricSolution;
        return;
    }
    //
...
//=======================================================================
IntAna_QuadQuadGeo::IntAna_QuadQuadGeo(const gp_Sphere& Sph, const gp_Torus& Tor, const Standard_Real Tol)
    : done(Standard_False), nbint(0), typeres(IntAna_Empty), pt1(0, 0, 0), pt2(0, 0, 0), pt3(0, 0, 0), pt4(0, 0, 0),
      param1(0), param2(0), param3(0), param4(0), param1bis(0), param2bis(0), myCommonGen(Standard_False),
      myPChar(0, 0, 0) {
    InitTolerances();
...
// purpose  : Torus - Torus
//=======================================================================
IntAna_QuadQuadGeo::IntAna_QuadQuadGeo(const gp_Torus& Tor1, const gp_Torus& Tor2, const Standard_Real Tol)
    : done(Standard_False), nbint(0), typeres(IntAna_Empty), pt1(0, 0, 0), pt2(0, 0, 0), pt3(0, 0, 0), pt4(0, 0, 0),
      param1(0), param2(0), param3(0), param4(0), param1bis(0), param2bis(0), myCommonGen(Standard_False),
      myPChar(0, 0, 0) {
    InitTolerances();
...
// purpose  :
//=======================================================================
void IntAna_QuadQuadGeo::Perform(const gp_Torus& Tor1, const gp_Torus& Tor2, const Standard_Real Tol) {
    done = Standard_True;
    //
