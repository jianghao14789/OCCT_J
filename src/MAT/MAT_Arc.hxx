...
public:
    Standard_EXPORT MAT_Arc(const Standard_Integer ArcIndex, const Standard_Integer GeomIndex,
    ...
    Standard_EXPORT void SetNeighbour(const MAT_Side aSide, const Handle(MAT_Node) & aNode,
