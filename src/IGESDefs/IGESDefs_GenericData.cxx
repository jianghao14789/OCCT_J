...
void IGESDefs_GenericData::Init(const Standard_Integer nbPropVal, const Handle(TCollection_HAsciiString) & aName,
    ...
    if (!allTypes.IsNull() && !allValues.IsNull() &&
        (allValues->Lower() != 1 || allTypes->Lower() != 1 || allTypes->Length() != allValues->Length()))
