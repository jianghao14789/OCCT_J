...
public:
    ...
    Standard_EXPORT gp_XYZ EvaluateDerivative(const gp_XY& point2d, const Standard_Integer iu,
    ...
    Standard_EXPORT void UVBox(Standard_Real& UMin, Standard_Real& UMax, Standard_Real& VMin,
...
protected:
private:
    Standard_EXPORT Standard_Real SolEm(const gp_XY& point2d, const Standard_Integer iu,
                                        const Standard_Integer iv) const;

    Standard_Real Polm(const gp_XY& point2d, const Standard_Integer iu, const Standard_Integer iv,
    ...
    Standard_EXPORT void fillXYZmatrix(math_Matrix& mat, const Standard_Integer i0, const Standard_Integer j0,
