...
Plate_GtoCConstraint::Plate_GtoCConstraint(const Plate_GtoCConstraint& ref) : myD1SurfInit(ref.myD1SurfInit) {
    pnt2d = ref.pnt2d;
...
Plate_GtoCConstraint::Plate_GtoCConstraint(const gp_XY& point2d, const Plate_D1& D1S, const Plate_D1& D1T,
                                           const Plate_D2& D2S, const Plate_D2& D2T, const Plate_D3& D3S,
                                           const Plate_D3& D3T)
    : myD1SurfInit(D1S) {
    pnt2d = point2d;
    nb_PPConstraints = 0;
    ...
    gp_XYZ Suuu =
        D3T.Duuu * (a * a * a) + D3T.Duuv * (3 * a * a * b) + D3T.Duvv * (3 * a * b * b) + D3T.Dvvv * (b * b * b);
    ...
    gp_XYZ Svvv =
        D3T.Duuu * (c * c * c) + D3T.Duuv * (3 * c * c * d) + D3T.Duvv * (3 * c * d * d) + D3T.Dvvv * (d * d * d);
