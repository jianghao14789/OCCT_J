...
public:
    ...
    WriteGeometry(Standard_OStream& OS,
                  const Message_ProgressRange& theProgress = Message_ProgressRange()) Standard_OVERRIDE;

    //! Reads the geometry of me from the  stream  <IS>.
    Standard_EXPORT virtual void
    ReadGeometry(Standard_IStream& IS,
                 const Message_ProgressRange& theProgress = Message_ProgressRange()) Standard_OVERRIDE;
    ...
    Standard_EXPORT virtual void ReadGeometry(const TopAbs_ShapeEnum T, Standard_IStream& IS,
    ...
    WritePolygonOnTriangulation(Standard_OStream& OS, const Standard_Boolean Compact = Standard_True,
                                const Message_ProgressRange& theProgress = Message_ProgressRange()) const;
...
private:
    ...
    NCollection_IndexedDataMap<Handle(Poly_Triangulation),
                               Standard_Boolean>
        myTriangulations; //!< Contains a boolean flag with information
