...
// purpose  :
//=======================================================================
BRepTools_GTrsfModification::BRepTools_GTrsfModification(const gp_GTrsf& T) : myGTrsf(T) {
...
Standard_Boolean BRepTools_GTrsfModification::NewSurface(const TopoDS_Face& F, Handle(Geom_Surface) & S,
...
Standard_Boolean BRepTools_GTrsfModification::NewCurve(const TopoDS_Edge& E, Handle(Geom_Curve) & C, TopLoc_Location& L,
                                                       Standard_Real& Tol) {
    Standard_Real f, l;
    gp_GTrsf gtrsf;
    gtrsf.SetVectorialPart(myGTrsf.VectorialPart());
...
Standard_Boolean BRepTools_GTrsfModification::NewPoint(const TopoDS_Vertex& V, gp_Pnt& P, Standard_Real& Tol) {
...
Standard_Boolean BRepTools_GTrsfModification::NewCurve2d(const TopoDS_Edge& E, const TopoDS_Face& F, const TopoDS_Edge&,
...
Standard_Boolean BRepTools_GTrsfModification::NewParameter(const TopoDS_Vertex& V, const TopoDS_Edge& E,
...
GeomAbs_Shape BRepTools_GTrsfModification::Continuity(const TopoDS_Edge& E, const TopoDS_Face& F1,
                                                      const TopoDS_Face& F2, const TopoDS_Edge&, const TopoDS_Face&,
                                                      const TopoDS_Face&) {
