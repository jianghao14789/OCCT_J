                ...
                for (; ite.More(); ite.Next()) {
                    ...
                    if (myBounds.Contains(E)) {
                        ...
                        if (NE.Orientation() == TopAbs_FORWARD) {
                            B.UpdateEdge(NE, BRep_Tool::CurveOnSurface(E, F, UFirst, ULast), F,
            ...
            for (; itf.More(); itf.Next()) {
                ...
                if (M.IsBound(E)) {
                    ...
                    if (!oldShell.IsSame(SH)) {
                        ...
                        if (MF(Shape).Orientation() == TopAbs_REVERSED) anOrien = TopAbs::Reverse(anOrien);
                        ...
                        for (; aexp.More(); aexp.Next()) {
                            ...
                            //		 itm.More(); ) {
                            if (!M.IsBound(aexp.Current())) continue;
                    ...
                    if (M(E).Orientation() == anOrien) SH.Orientable(Standard_False);

                    // remove the edge from M (no more a free edge)
                    M.UnBind(E);
                } else {
                    NewO = E.Orientation();
                    if (MF(Shape).Orientation() == TopAbs_REVERSED) NewO = TopAbs::Reverse(NewO);
                    if (!E.IsNull())
