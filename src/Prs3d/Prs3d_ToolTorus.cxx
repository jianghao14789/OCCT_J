...
// purpose  :
//=======================================================================
void Prs3d_ToolTorus::init(const Standard_Real theMajorRad, const Standard_Real theMinorRad,
                           const Standard_Real theAngle1, const Standard_Real theAngle2, const Standard_Real theAngle,
...
gp_Pnt Prs3d_ToolTorus::Vertex(const Standard_Real theU, const Standard_Real theV) const {
    ...
    return gp_Pnt((myMajorRadius + myMinorRadius * Cos(aV)) * Cos(aU),
                  (myMajorRadius + myMinorRadius * Cos(aV)) * Sin(aU), myMinorRadius * Sin(aV));
}
