...
public:
    ...
    Standard_EXPORT void Init(const StepVisual_CentralOrParallel aProjectionType,
                              ...
                              const Standard_Real aViewPlaneDistance, const Standard_Real aFrontPlaneDistance,
                              const Standard_Boolean aFrontPlaneClipping, const Standard_Real aBackPlaneDistance,
