...
void StepVisual_PresentationLayerAssignment::Init(const Handle(TCollection_HAsciiString) & aName,
...
void StepVisual_PresentationLayerAssignment::SetAssignedItems(const Handle(StepVisual_HArray1OfLayeredItem) &
                                                              aAssignedItems) {
    assignedItems = aAssignedItems;
}
