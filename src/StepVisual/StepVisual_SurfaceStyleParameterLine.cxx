...
void StepVisual_SurfaceStyleParameterLine::Init(const Handle(StepVisual_CurveStyle) & aStyleOfParameterLines,
                                                const Handle(StepVisual_HArray1OfDirectionCountSelect) &
                                                    aDirectionCounts) {
    // --- classe own fields ---
...
void StepVisual_SurfaceStyleParameterLine::SetStyleOfParameterLines(const Handle(StepVisual_CurveStyle) &
...
void StepVisual_SurfaceStyleParameterLine::SetDirectionCounts(const Handle(StepVisual_HArray1OfDirectionCountSelect) &
                                                              aDirectionCounts) {
    directionCounts = aDirectionCounts;
}
...
StepVisual_SurfaceStyleParameterLine::DirectionCountsValue(const Standard_Integer num) const {
