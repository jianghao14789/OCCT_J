...
static StepData_EnumTool tool(".DOT.", ".X.", ".PLUS.", ".ASTERISK.", ".RING.", ".SQUARE.", ".TRIANGLE.");
...
void StepVisual_MarkerMember::SetEnumText(const Standard_Integer /*val*/, const Standard_CString text) {
