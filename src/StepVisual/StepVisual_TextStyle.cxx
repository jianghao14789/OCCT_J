...
void StepVisual_TextStyle::Init(const Handle(TCollection_HAsciiString) & aName,
...
void StepVisual_TextStyle::SetCharacterAppearance(const Handle(StepVisual_TextStyleForDefinedFont) &
