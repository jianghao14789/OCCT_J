...
void IGESDimen_ToolPointDimension::ReadOwnParams(const Handle(IGESDimen_PointDimension) & ent,
    ...
    PR.ReadEntity(IR, PR.Current(), "Leader", STANDARD_TYPE(IGESDimen_LeaderArrow),
...
IGESData_DirChecker IGESDimen_ToolPointDimension::DirChecker(const Handle(IGESDimen_PointDimension) & /*ent*/) const {
