...
void IGESDimen_ToolFlagNote::WriteOwnParams(const Handle(IGESDimen_FlagNote) & ent, IGESData_IGESWriter& IW) const {
...
void IGESDimen_ToolFlagNote::OwnShared(const Handle(IGESDimen_FlagNote) & ent, Interface_EntityIterator& iter) const {
...
void IGESDimen_ToolFlagNote::OwnCopy(const Handle(IGESDimen_FlagNote) & another, const Handle(IGESDimen_FlagNote) & ent,
...
IGESData_DirChecker IGESDimen_ToolFlagNote::DirChecker(const Handle(IGESDimen_FlagNote) & /* ent */) const {
...
void IGESDimen_ToolFlagNote::OwnCheck(const Handle(IGESDimen_FlagNote) & /* ent */, const Interface_ShareTool&,
                                      Handle(Interface_Check) & /* ach */) const {}

void IGESDimen_ToolFlagNote::OwnDump(const Handle(IGESDimen_FlagNote) & ent, const IGESData_IGESDumper& dumper,
