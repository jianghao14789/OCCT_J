...
public:
    ...
    Standard_EXPORT void OwnCheck(const Handle(IGESDimen_WitnessLine) & ent, const Interface_ShareTool& shares,
                                  Handle(Interface_Check) & ach) const;

    //! Copies Specific Parameters
    Standard_EXPORT void OwnCopy(const Handle(IGESDimen_WitnessLine) & entfrom,
                                 const Handle(IGESDimen_WitnessLine) & entto, Interface_CopyTool& TC) const;

    //! Dump of Specific Parameters
    Standard_EXPORT void OwnDump(const Handle(IGESDimen_WitnessLine) & ent, const IGESData_IGESDumper& dumper,
