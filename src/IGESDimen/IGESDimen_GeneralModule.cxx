...
void IGESDimen_GeneralModule::OwnSharedCase(const Standard_Integer CN, const Handle(IGESData_IGESEntity) & ent,
...
IGESData_DirChecker IGESDimen_GeneralModule::DirChecker(const Standard_Integer CN,
...
void IGESDimen_GeneralModule::OwnCheckCase(const Standard_Integer CN, const Handle(IGESData_IGESEntity) & ent,
...
Standard_Boolean IGESDimen_GeneralModule::NewVoid(const Standard_Integer CN, Handle(Standard_Transient) & ent) const {
    switch (CN) {
        case 1:
...
void IGESDimen_GeneralModule::OwnCopyCase(const Standard_Integer CN, const Handle(IGESData_IGESEntity) & entfrom,
