...
void IGESDimen_ToolSectionedArea::ReadOwnParams(const Handle(IGESDimen_SectionedArea) & ent,
    ...
    if (st && nbislands > 0)
        PR.ReadEnts(IR, PR.CurrentList(nbislands), "Island curves", tempIslands); // szv#4:S4163:12Mar99 `st=` not
                                                                                  // needed
    /*
        {
...
IGESData_DirChecker IGESDimen_ToolSectionedArea::DirChecker(const Handle(IGESDimen_SectionedArea) & /* ent */) const {
...
void IGESDimen_ToolSectionedArea::OwnDump(const Handle(IGESDimen_SectionedArea) & ent,
    ...
    S << "IGESDimen_SectionedArea\n"
      << (ent->IsInverted() ? "Inverted Cross Hatches" : "Standard Cross Hatches") << " - Exterior curve : ";
