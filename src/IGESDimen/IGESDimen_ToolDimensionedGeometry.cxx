...
void IGESDimen_ToolDimensionedGeometry::ReadOwnParams(const Handle(IGESDimen_DimensionedGeometry) & ent,
    ...
    if (nbgeom > 0)
        PR.ReadEnts(IR, PR.CurrentList(nbgeom), "Geometry Entities",
...
void IGESDimen_ToolDimensionedGeometry::WriteOwnParams(const Handle(IGESDimen_DimensionedGeometry) & ent,
...
void IGESDimen_ToolDimensionedGeometry::OwnCopy(const Handle(IGESDimen_DimensionedGeometry) & another,
...
Standard_Boolean IGESDimen_ToolDimensionedGeometry::OwnCorrect(const Handle(IGESDimen_DimensionedGeometry) &
                                                               ent) const {
...
IGESData_DirChecker
IGESDimen_ToolDimensionedGeometry::DirChecker(const Handle(IGESDimen_DimensionedGeometry) & /* ent */) const {
