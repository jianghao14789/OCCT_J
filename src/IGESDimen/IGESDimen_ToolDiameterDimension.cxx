...
void IGESDimen_ToolDiameterDimension::ReadOwnParams(const Handle(IGESDimen_DiameterDimension) & ent,
    ...
    PR.ReadEntity(IR, PR.Current(), "Second Leader Entity", STANDARD_TYPE(IGESDimen_LeaderArrow), secondLeader,
...
IGESData_DirChecker
IGESDimen_ToolDiameterDimension::DirChecker(const Handle(IGESDimen_DiameterDimension) & /* ent */) const {
