...
Standard_Integer StepAP242_ItemIdentifiedRepresentationUsageDefinition::CaseNum(const Handle(Standard_Transient) &
                                                                                ent) const {
...
Handle(StepAP214_AppliedApprovalAssignment)
...
Handle(StepAP214_AppliedDateAssignment)
    StepAP242_ItemIdentifiedRepresentationUsageDefinition::AppliedDateAssignment() const {
    return GetCasted(StepAP214_AppliedDateAssignment, Value());
}

Handle(StepAP214_AppliedDocumentReference)
...
Handle(StepAP214_AppliedExternalIdentificationAssignment)
    StepAP242_ItemIdentifiedRepresentationUsageDefinition::AppliedExternalIdentificationAssignment() const {
    return GetCasted(StepAP214_AppliedExternalIdentificationAssignment, Value());
}

Handle(StepAP214_AppliedGroupAssignment)
...
Handle(StepAP214_AppliedPersonAndOrganizationAssignment)
    StepAP242_ItemIdentifiedRepresentationUsageDefinition::AppliedPersonAndOrganizationAssignment() const {
...
Handle(StepAP214_AppliedSecurityClassificationAssignment)
    StepAP242_ItemIdentifiedRepresentationUsageDefinition::AppliedSecurityClassificationAssignment() const {
...
Handle(StepDimTol_GeometricTolerance)
    StepAP242_ItemIdentifiedRepresentationUsageDefinition::GeometricTolerance() const {
