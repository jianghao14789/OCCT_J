...
public:
    ...
    static Handle(SelectMgr_SelectionImageFiller)
        CreateFiller(Image_PixMap& thePixMap, SelectMgr_ViewerSelector* theSelector,
...
public:
    ...
    SelectMgr_SelectionImageFiller(Image_PixMap& thePixMap, SelectMgr_ViewerSelector* theSelector)
        : myImage(&thePixMap), myMainSel(theSelector) {}
...
protected:
    ...
    void nextRandomPastelColor(Quantity_Color& theColor) {
        theColor = Quantity_Color(Standard_Real(myBullardGenerator.NextInt() % 256) / 255.0,
                                  ...
                                  Standard_Real(myBullardGenerator.NextInt() % 256) / 255.0, Quantity_TOC_sRGB);
    }
