...
public:
    ...
    struct SelectionRectangle {
        SelectionRectangle() : myMinPnt(gp_Pnt2d(RealLast(), RealLast())), myMaxPnt(gp_Pnt2d(RealLast(), RealLast())) {}
    ...
    virtual const gp_Pnt& GetNearPnt() const Standard_OVERRIDE {
        return myNearPickedPnt;
    }

    //! Returns projection of 2d mouse picked point or projection
    //! of center of 2d rectangle (for point and rectangular selection
    //! correspondingly) onto far view frustum plane
    virtual const gp_Pnt& GetFarPnt() const Standard_OVERRIDE {
        return myFarPickedPnt;
    }

    //! Returns view ray direction.
    virtual const gp_Dir& GetViewRayDirection() const Standard_OVERRIDE {
        return myViewRayDir;
    }
    ...
    GetPlanes(NCollection_Vector<SelectMgr_Vec4>& thePlaneEquations) const Standard_OVERRIDE;
...
protected:
    Standard_EXPORT void segmentSegmentDistance(const gp_Pnt& theSegPnt1, const gp_Pnt& theSegPnt2,
                                                SelectBasics_PickResult& thePickResult) const;

    Standard_EXPORT bool segmentPlaneIntersection(const gp_Vec& thePlane, const gp_Pnt& thePntOnPlane,
                                                  SelectBasics_PickResult& thePickResult) const;
