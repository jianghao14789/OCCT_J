...
//! In other words, each triangle vertex will be projected from 2d screen space to 3d world space onto near and far view
//! frustum planes. Thus, the projected triangles make up the bases of selecting frustum. When the set of such frustums
//! is created, the function determining selection iterates through triangular frustum set and searches for overlap with
//! any frustum.
...
public:
    ...
    Standard_EXPORT virtual Handle(SelectMgr_BaseIntersector)
        ScaleAndTransform(const Standard_Integer theScale, const gp_GTrsf& theTrsf,
                          const Handle(SelectMgr_FrustumBuilder) & theBuilder) const Standard_OVERRIDE;

public:
    Standard_EXPORT virtual Standard_Boolean
    OverlapsBox(const SelectMgr_Vec3& theMinPnt, const SelectMgr_Vec3& theMaxPnt,
...
private:
    ...
    Standard_EXPORT Standard_Boolean segmentTriangleIntersection(const gp_Pnt& theOrig, const gp_Vec& theDir,
                                                                 const gp_Pnt& theV1, const gp_Pnt& theV2,
                                                                 const gp_Pnt& theV3) const;
