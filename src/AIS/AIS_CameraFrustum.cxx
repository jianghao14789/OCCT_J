...
// purpose  :
//=======================================================================
AIS_CameraFrustum::AIS_CameraFrustum() : myPoints(0, Graphic3d_Camera::FrustumVerticesNB) {
...
void AIS_CameraFrustum::fillTriangles() {
    if (myTriangles.IsNull()) {
        ...
        myTriangles =
            new Graphic3d_ArrayOfTriangles(Graphic3d_Camera::FrustumVerticesNB, aPlaneTriangleVertsNb * aPlanesNb);
...
// purpose  :
//=======================================================================
void AIS_CameraFrustum::Compute(const Handle(PrsMgr_PresentationManager) &, const Handle(Prs3d_Presentation) & thePrs,
    ...
    switch (theMode) {
        ...
        Standard_FALLTHROUGH case AIS_WireFrame: {
            Handle(Graphic3d_Group) aGroup = thePrs->NewGroup();
    ...
    switch (theMode) {
        case SelectionMode_Edges: {
            ...
            for (Standard_Integer anIter = 1; anIter <= myBorders->EdgeNumber(); anIter += 2) {
                aSensitiveEntity->Add(new Select3D_SensitiveSegment(anOwner,
