...
//!
//! You can make use of classes of standard Interactive Objects for which all necessary methods have already been
//! programmed, or you can implement your own classes of Interactive Objects. Key interface methods to be implemented by
...
public:
    ...
    virtual AIS_KindOfInteractive Type() const {
        return AIS_KindOfInteractive_None;
    }
    ...
    //! The owner can be a shape for a set of sub-shapes or a sub-shape for sub-shapes which it is composed of, and
    //! takes the form of a transient.
...
public:
    ...
    Standard_DEPRECATED("Deprecated method, results might be undefined") Standard_EXPORT
...
protected:
    AIS_InteractiveContext*
        myCTXPtr; //!< pointer to Interactive Context, where object is currently displayed; @sa SetContext()
