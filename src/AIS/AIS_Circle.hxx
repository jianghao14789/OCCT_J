...
public:
    ...
    Standard_EXPORT AIS_Circle(const Handle(Geom_Circle) & theCircle, const Standard_Real theUStart,
    ...
    void SetCircle(const Handle(Geom_Circle) & theCircle) {
        myComponent = theCircle;
    }
