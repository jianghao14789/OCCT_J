...
public:
    ...
    static Standard_EXPORT Handle(TObj_Partition)
        Create(const TDF_Label& theLabel, const Standard_Boolean theSetName = Standard_True);
...
public:
    ...
    virtual Standard_EXPORT Standard_Boolean SetName(const Handle(TCollection_HExtendedString) &
                                                     theName) const Standard_OVERRIDE;
...
public:
    ...
    Standard_EXPORT Handle(TCollection_HExtendedString)
        GetNewName(const Standard_Boolean theIsToChangeCount = Standard_True);
...
protected:
    ...
    Standard_EXPORT virtual Standard_Boolean copyData(const Handle(TObj_Object) & theTargetObject) Standard_OVERRIDE;
