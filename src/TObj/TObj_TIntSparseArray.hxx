...
public:
    ...
    Standard_EXPORT void DeltaOnModification(const Handle(TDF_DeltaOnModification) & theDelta) Standard_OVERRIDE;
...
private:
    ...
    //! backup one value
    void backupValue(const Standard_Size theId, const Standard_Integer theCurrValue,
