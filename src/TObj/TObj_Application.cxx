...
Standard_Boolean TObj_Application::SaveDocument(const Handle(TDocStd_Document) & theSourceDoc,
    ...
    if (myIsError) SetError(aStatus, theTargetFile);
...
Standard_Boolean TObj_Application::LoadDocument(const TCollection_ExtendedString& theSourceFile,
    ...
    if (myIsError) SetError(aStatus, theSourceFile);
...
Standard_Boolean TObj_Application::LoadDocument(Standard_IStream& theIStream, Handle(TDocStd_Document) & theTargetDoc) {
    PCDM_ReaderStatus aStatus = PCDM_RS_ReaderException;
    {
        try {
...
void TObj_Application::ErrorMessage(const TCollection_ExtendedString& theMsg, const Message_Gravity theLevel) {
