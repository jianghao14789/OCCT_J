...
/*********************************************************************************/
/*********************************************************************************/
void LocalAnalysis_SurfaceContinuity::SurfC0(const GeomLProp_SLProps& Surf1, const GeomLProp_SLProps& Surf2) {
...
void LocalAnalysis_SurfaceContinuity::SurfG2(GeomLProp_SLProps& Surf1, GeomLProp_SLProps& Surf2) {
    ...
    if (Surf1.IsCurvatureDefined() && Surf2.IsCurvatureDefined()) {
        ...
        myGap = Abs(DETA) +
                sqrt(DZETA * DZETA * Cos(myAlpha) * Cos(myAlpha) + myZETA * myZETA * Sin(myAlpha) * Sin(myAlpha));
    } else {
        myIsDone = Standard_False;
        myErrorStatus = LocalAnalysis_CurvatureNotDefined;
    }
}
LocalAnalysis_SurfaceContinuity::LocalAnalysis_SurfaceContinuity(const Standard_Real EpsNul, const Standard_Real EpsC0,
                                                                 const Standard_Real EpsC1, const Standard_Real EpsC2,
                                                                 const Standard_Real EpsG1, const Standard_Real Percent,
                                                                 const Standard_Real Maxlen)
    : myContC0(0.0), myContC1U(0.0), myContC1V(0.0), myContC2U(0.0), myContC2V(0.0), myContG1(0.0), myLambda1U(0.0),
      myLambda2U(0.0), myLambda1V(0.0), myLambda2V(0.0), myETA1(0.0), myETA2(0.0), myETA(0.0), myZETA1(0.0),
      myZETA2(0.0), myZETA(0.0), myAlpha(0.0), myGap(0.0) {
    myepsnul = EpsNul;
    myepsC0 = EpsC0;
    myepsC1 = EpsC1;
    myepsC2 = EpsC2;
...
void LocalAnalysis_SurfaceContinuity::ComputeAnalysis(GeomLProp_SLProps& Surf1, GeomLProp_SLProps& Surf2,
...
LocalAnalysis_SurfaceContinuity::LocalAnalysis_SurfaceContinuity(
    const Handle(Geom_Surface) & Surf1, const Standard_Real u1, const Standard_Real v1,
    const Handle(Geom_Surface) & Surf2, const Standard_Real u2, const Standard_Real v2, const GeomAbs_Shape Ordre,
    const Standard_Real EpsNul, const Standard_Real EpsC0, const Standard_Real EpsC1, const Standard_Real EpsC2,
    const Standard_Real EpsG1, const Standard_Real Percent, const Standard_Real Maxlen)
    : myContC0(0.0), myContC1U(0.0), myContC1V(0.0), myContC2U(0.0), myContC2V(0.0), myContG1(0.0), myLambda1U(0.0),
      myLambda2U(0.0), myLambda1V(0.0), myLambda2V(0.0), myETA1(0.0), myETA2(0.0), myETA(0.0), myZETA1(0.0),
      myZETA2(0.0), myZETA(0.0), myAlpha(0.0), myGap(0.0) {
    myTypeCont = Ordre;
...
LocalAnalysis_SurfaceContinuity::LocalAnalysis_SurfaceContinuity(
    const Handle(Geom2d_Curve) & curv1, const Handle(Geom2d_Curve) & curv2, const Standard_Real U,
    const Handle(Geom_Surface) & Surf1, const Handle(Geom_Surface) & Surf2, const GeomAbs_Shape Ordre,
    const Standard_Real EpsNul, const Standard_Real EpsC0, const Standard_Real EpsC1, const Standard_Real EpsC2,
    const Standard_Real EpsG1, const Standard_Real Percent, const Standard_Real Maxlen)
    : myContC0(0.0), myContC1U(0.0), myContC1V(0.0), myContC2U(0.0), myContC2V(0.0), myContG1(0.0), myLambda1U(0.0),
      myLambda2U(0.0), myLambda1V(0.0), myLambda2V(0.0), myETA1(0.0), myETA2(0.0), myETA(0.0), myZETA1(0.0),
...
Standard_Boolean LocalAnalysis_SurfaceContinuity::IsG2() const {
    ...
    if (IsG1()) {
        if ((Abs(myETA) < EPSNL) && (Abs(myZETA) < EPSNL)) return Standard_True;
