...
public:
    ...
    Standard_EXPORT LocalAnalysis_CurveContinuity(const Handle(Geom_Curve) & Curv1, const Standard_Real u1,
                                                  ...
                                                  const Standard_Real EpsG2 = 0.001, const Standard_Real Percent = 0.01,
