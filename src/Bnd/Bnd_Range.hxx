...
public:
    ...
    Bnd_Range(const Standard_Real theMin, const Standard_Real theMax) : myFirst(theMin), myLast(theMax) {
        if (myLast < myFirst) throw Standard_ConstructionError("Last < First");
    }
    ...
    Standard_EXPORT void Split(const Standard_Real theVal, NCollection_List<Bnd_Range>& theList,
