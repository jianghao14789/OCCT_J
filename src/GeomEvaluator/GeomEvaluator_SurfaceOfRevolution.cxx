...
GeomEvaluator_SurfaceOfRevolution::GeomEvaluator_SurfaceOfRevolution(const Handle(Geom_Curve) & theBase,
                                                                     const gp_Dir& theRevolDir,
                                                                     const gp_Pnt& theRevolLoc)
    : GeomEvaluator_Surface(), myBaseCurve(theBase), myRotAxis(theRevolLoc, theRevolDir) {}

GeomEvaluator_SurfaceOfRevolution::GeomEvaluator_SurfaceOfRevolution(const Handle(Adaptor3d_Curve) & theBase,
                                                                     const gp_Dir& theRevolDir,
                                                                     const gp_Pnt& theRevolLoc)
    : GeomEvaluator_Surface(), myBaseAdaptor(theBase), myRotAxis(theRevolLoc, theRevolDir) {}

void GeomEvaluator_SurfaceOfRevolution::D0(const Standard_Real theU, const Standard_Real theV, gp_Pnt& theValue) const {
...
void GeomEvaluator_SurfaceOfRevolution::D1(const Standard_Real theU, const Standard_Real theV, gp_Pnt& theValue,
    ...
    if (theD1U.SquareMagnitude() < Precision::SquareConfusion()) theD1U.SetCoord(0.0, 0.0, 0.0);
...
void GeomEvaluator_SurfaceOfRevolution::D2(const Standard_Real theU, const Standard_Real theV, gp_Pnt& theValue,
...
void GeomEvaluator_SurfaceOfRevolution::D3(const Standard_Real theU, const Standard_Real theV, gp_Pnt& theValue,
                                           gp_Vec& theD1U, gp_Vec& theD1V, gp_Vec& theD2U, gp_Vec& theD2V,
...
gp_Vec GeomEvaluator_SurfaceOfRevolution::DN(const Standard_Real theU, const Standard_Real theV,
...
Handle(GeomEvaluator_Surface) GeomEvaluator_SurfaceOfRevolution::ShallowCopy() const {
    ...
    if (!myBaseAdaptor.IsNull()) {
        aCopy = new GeomEvaluator_SurfaceOfRevolution(myBaseAdaptor->ShallowCopy(), myRotAxis.Direction(),
                                                      myRotAxis.Location());
    } else {
        aCopy = new GeomEvaluator_SurfaceOfRevolution(myBaseCurve, myRotAxis.Direction(), myRotAxis.Location());
    }
