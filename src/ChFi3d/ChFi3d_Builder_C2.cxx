...
static void Reduce(const Standard_Real& p1, const Standard_Real& p2, Handle(GeomAdaptor_Surface) & hs1,
...

{
    ...
    TopoDS_Face FaCo;
    OkinterCC = ChFi3d_IsInFront(DStr, Corner1, Corner2, IFd1, IFd2, Sens1, Sens2, UIntPC1, UIntPC2, FaCo, SameSide,
    ...
    if (sameparam) {
        ...
        ChFi3d_ComputesIntPC(Fd1->Interference(IFaCo1), Fd2->Interference(IFaCo2), HS1, HS2, UIntPC1, UIntPC2);
        gp_Pnt2d UV;
        ...
        ChFi3d_ComputesIntPC(Fd1->Interference(IFaArc1), Fd2->Interference(IFaArc2), HS1, HS2, UIntArc1, UIntArc2);
        ...
        if (IFaCo1 == 1 && !ChFi3d_ComputeCurves(HS1, HS2, Pardeb, Parfin, Gc, PGc1, PGc2, tolesp, tol2d, tolreached)) {
#ifdef OCCT_DEBUG
            ...
            return done;
                   ...
                   !ChFi3d_ComputeCurves(HS1, HS2, Parfin, Pardeb, Gc, PGc1, PGc2, tolesp, tol2d, tolreached)) {
#ifdef OCCT_DEBUG
            std::cout << "failed to calculate bevel error interSS" << std::endl;
#endif
            done = Standard_False;
        ...
        ChFi3d_ComputesIntPC(SmaFD->Interference(IFaCoSma), BigFD->Interference(IFaCoBig), SmaHS, BigHS, UIntPCSma,
                             UIntPCBig);
        gp_Pnt2d UVi;
        ...
        if (isfirstSma) {
            ...
            if (UIntPCSma < temp) temp = UIntPCSma;
        ...
        if (!ChFi3d_ComputeCurves(SmaHS, BigHS, Pardeb, Parfin, Gc, PGc1, PGc2, tolesp, tol2d, tolreached)) {
#ifdef OCCT_DEBUG
        ...
        if (!ChFi3d_ComputeCurves(HF, BigHS, Pardeb, Parfin, Gc, PGc1, PGc2, tolesp, tol2d, tolreached)) {
#ifdef OCCT_DEBUG
