...
public:
    ...
    Standard_EXPORT static void D2(const Handle(Geom_Curve) & C, const Standard_Real U, gp_Pnt& P, gp_Vec& V1,
                                   gp_Vec& V2);

    //! Computes the point <P>, the first derivative <V1>, the
    //! second derivative <V2> and third derivative <V3> of
    //! parameter <U> on the curve <C>.
    Standard_EXPORT static void D3(const Handle(Geom_Curve) & C, const Standard_Real U, gp_Pnt& P, gp_Vec& V1,
                                   gp_Vec& V2, gp_Vec& V3);
