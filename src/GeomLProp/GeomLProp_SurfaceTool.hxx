...
public:
    ...
    //! Surface <S>.
    Standard_EXPORT static void Value(const Handle(Geom_Surface) & S, const Standard_Real U, const Standard_Real V,
                                      gp_Pnt& P);

    //! Computes the point <P> and first derivative <D1*> of
    //! parameter <U> and <V> on the Surface <S>.
    Standard_EXPORT static void D1(const Handle(Geom_Surface) & S, const Standard_Real U, const Standard_Real V,
    ...
    Standard_EXPORT static void D2(const Handle(Geom_Surface) & S, const Standard_Real U, const Standard_Real V,
                                   gp_Pnt& P, gp_Vec& D1U, gp_Vec& D1V, gp_Vec& D2U, gp_Vec& D2V, gp_Vec& DUV);

    Standard_EXPORT static gp_Vec DN(const Handle(Geom_Surface) & S, const Standard_Real U, const Standard_Real V,
    ...
    Standard_EXPORT static void Bounds(const Handle(Geom_Surface) & S, Standard_Real& U1, Standard_Real& V1,
