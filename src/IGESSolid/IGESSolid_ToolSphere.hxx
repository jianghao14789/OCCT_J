...
public:
    ...
    Standard_EXPORT void ReadOwnParams(const Handle(IGESSolid_Sphere) & ent, const Handle(IGESData_IGESReaderData) & IR,
    ...
    Standard_EXPORT void OwnCheck(const Handle(IGESSolid_Sphere) & ent, const Interface_ShareTool& shares,
                                  Handle(Interface_Check) & ach) const;

    //! Copies Specific Parameters
    Standard_EXPORT void OwnCopy(const Handle(IGESSolid_Sphere) & entfrom, const Handle(IGESSolid_Sphere) & entto,
                                 Interface_CopyTool& TC) const;

    //! Dump of Specific Parameters
    Standard_EXPORT void OwnDump(const Handle(IGESSolid_Sphere) & ent, const IGESData_IGESDumper& dumper,
                                 Standard_OStream& S, const Standard_Integer own) const;
