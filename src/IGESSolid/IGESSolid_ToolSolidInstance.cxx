...
IGESData_DirChecker IGESSolid_ToolSolidInstance::DirChecker(const Handle(IGESSolid_SolidInstance) & /*ent*/) const {
...
void IGESSolid_ToolSolidInstance::OwnCheck(const Handle(IGESSolid_SolidInstance) & /*ent*/, const Interface_ShareTool&,
