...
public:
    ...
    Standard_EXPORT void AddEdge(const Handle(IGESData_IGESEntity) & curve, const Standard_Integer vstart,
    ...
    Standard_EXPORT void Edge(const Standard_Integer num, Handle(IGESData_IGESEntity) & curve, Standard_Integer& vstart,
    ...
    Standard_EXPORT void MakeEdge(const Standard_Integer edgetype, const Standard_Integer edge3d,
