...
void IGESSolid_ToolSelectedComponent::ReadOwnParams(const Handle(IGESSolid_SelectedComponent) & ent,
    ...
    PR.ReadEntity(IR, PR.Current(), "Boolean Tree Entity", STANDARD_TYPE(IGESSolid_BooleanTree),
...
IGESData_DirChecker
IGESSolid_ToolSelectedComponent::DirChecker(const Handle(IGESSolid_SelectedComponent) & /* ent */) const {
