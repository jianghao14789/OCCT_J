...
public:
    ...
    Standard_EXPORT void ReadOwnParams(const Handle(IGESSolid_Torus) & ent, const Handle(IGESData_IGESReaderData) & IR,
    ...
    Standard_EXPORT void OwnCheck(const Handle(IGESSolid_Torus) & ent, const Interface_ShareTool& shares,
                                  Handle(Interface_Check) & ach) const;

    //! Copies Specific Parameters
    Standard_EXPORT void OwnCopy(const Handle(IGESSolid_Torus) & entfrom, const Handle(IGESSolid_Torus) & entto,
                                 Interface_CopyTool& TC) const;

    //! Dump of Specific Parameters
    Standard_EXPORT void OwnDump(const Handle(IGESSolid_Torus) & ent, const IGESData_IGESDumper& dumper,
