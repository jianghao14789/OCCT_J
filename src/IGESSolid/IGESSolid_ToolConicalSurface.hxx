...
public:
    ...
    Standard_EXPORT void OwnCheck(const Handle(IGESSolid_ConicalSurface) & ent, const Interface_ShareTool& shares,
                                  Handle(Interface_Check) & ach) const;

    //! Copies Specific Parameters
    Standard_EXPORT void OwnCopy(const Handle(IGESSolid_ConicalSurface) & entfrom,
                                 const Handle(IGESSolid_ConicalSurface) & entto, Interface_CopyTool& TC) const;

    //! Dump of Specific Parameters
    Standard_EXPORT void OwnDump(const Handle(IGESSolid_ConicalSurface) & ent, const IGESData_IGESDumper& dumper,
