...
void IGESSolid_GeneralModule::OwnSharedCase(const Standard_Integer CN, const Handle(IGESData_IGESEntity) & ent,
...
IGESData_DirChecker IGESSolid_GeneralModule::DirChecker(const Standard_Integer CN,
...
void IGESSolid_GeneralModule::OwnCheckCase(const Standard_Integer CN, const Handle(IGESData_IGESEntity) & ent,
...
Standard_Boolean IGESSolid_GeneralModule::NewVoid(const Standard_Integer CN, Handle(Standard_Transient) & ent) const {
    switch (CN) {
        case 1:
...
void IGESSolid_GeneralModule::OwnCopyCase(const Standard_Integer CN, const Handle(IGESData_IGESEntity) & entfrom,
