...
void IGESSolid_ToolCylindricalSurface::ReadOwnParams(const Handle(IGESSolid_CylindricalSurface) & ent,
...
void IGESSolid_ToolCylindricalSurface::WriteOwnParams(const Handle(IGESSolid_CylindricalSurface) & ent,
...
IGESData_DirChecker
IGESSolid_ToolCylindricalSurface::DirChecker(const Handle(IGESSolid_CylindricalSurface) & /*ent*/) const {
...
void IGESSolid_ToolCylindricalSurface::OwnCheck(const Handle(IGESSolid_CylindricalSurface) & ent,
    ...
    if (ent->Radius() <= 0.0) ach->AddFail("Radius : Value <= 0.0");
