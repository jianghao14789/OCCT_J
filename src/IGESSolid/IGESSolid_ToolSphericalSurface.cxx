...
IGESData_DirChecker
IGESSolid_ToolSphericalSurface::DirChecker(const Handle(IGESSolid_SphericalSurface) & /*ent*/) const {
...
void IGESSolid_ToolSphericalSurface::OwnCheck(const Handle(IGESSolid_SphericalSurface) & ent,
    ...
    if (ent->Axis().IsNull())
        if (ent->IsParametrised()) ach->AddFail("Parametrised Spherical Surface : no Axis is defined");
}
