...
// purpose  :
//=======================================================================
static Standard_Boolean CheckPoints(const TColgp_Array1OfPnt& PointArray, const Standard_Real Tolerance) {
    Standard_Integer ii;
...
// purpose  :
//=======================================================================
static Standard_Boolean CheckTangents(const TColgp_Array1OfVec& Tangents, const TColStd_Array1OfBoolean& TangentFlags,
...
// purpose  :
//=======================================================================
static void BuildParameters(const Standard_Boolean PeriodicFlag, const TColgp_Array1OfPnt& PointsArray,
...
static void BuildPeriodicTangent(const TColgp_Array1OfPnt& PointsArray, TColgp_Array1OfVec& TangentsArray,
    ...
    if (!TangentFlags.Value(1)) {
        ...
        PLib::EvalLagrange(ParametersArray.Value(1), 1, degree, 3, point_array[0], parameter_array[0],
                           eval_result[0][0]);
        for (ii = 1; ii <= 3; ii++) {
...
static void BuildTangents(const TColgp_Array1OfPnt& PointsArray, TColgp_Array1OfVec& TangentsArray,
                          TColStd_Array1OfBoolean& TangentFlags, const TColStd_Array1OfReal& ParametersArray) {
    Standard_Integer ii, degree;
    ...
    if (!TangentFlags.Value(TangentFlags.Upper())) {
        ...
        PLib::EvalLagrange(ParametersArray.Value(ParametersArray.Upper()), 1, degree, 3, point_array[0],
...
//
//=======================================================================
static void ScaleTangents(const TColgp_Array1OfPnt& PointsArray, TColgp_Array1OfVec& TangentsArray,
    ...
    for (ii = TangentFlags.Lower(); ii <= TangentFlags.Upper(); ii++) {
        if (TangentFlags.Value(ii)) {
            ...
            PLib::EvalLagrange(ParametersArray.Value(ii), 1, degree, 3, point_array[0], parameter_array[0],
                               eval_result[0][0]);
...
void GeomAPI_Interpolate::Load(const gp_Vec& InitialTangent, const gp_Vec& FinalTangent, const Standard_Boolean Scale) {
    Standard_Boolean result;
    myTangentRequest = Standard_True;
...
void GeomAPI_Interpolate::PerformPeriodic() {
    ...
    if (num_points == 2 && !myTangentRequest) {
        ...
        myCurve = new Geom_BSplineCurve(myPoints->Array1(), myParameters->Array1(), deg1_mults, degree, myPeriodic);
