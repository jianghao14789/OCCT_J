...
public:
    ...
    Standard_EXPORT GeomAPI_Interpolate(const Handle(TColgp_HArray1OfPnt) & Points, const Standard_Boolean PeriodicFlag,
    ...
    Standard_EXPORT void Load(const gp_Vec& InitialTangent, const gp_Vec& FinalTangent,
    ...
    Standard_EXPORT void Load(const TColgp_Array1OfVec& Tangents, const Handle(TColStd_HArray1OfBoolean) & TangentFlags,
                              const Standard_Boolean Scale = Standard_True);
