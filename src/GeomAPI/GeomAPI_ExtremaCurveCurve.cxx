...
GeomAPI_ExtremaCurveCurve::GeomAPI_ExtremaCurveCurve()
    : myIsDone(Standard_False), myIndex(0), myTotalExt(Standard_False), myIsInfinite(Standard_False), myTotalDist(0.0) {
...
void GeomAPI_ExtremaCurveCurve::Init(const Handle(Geom_Curve) & C1, const Handle(Geom_Curve) & C2,
                                     const Standard_Real U1min, const Standard_Real U1max, const Standard_Real U2min,
...
void GeomAPI_ExtremaCurveCurve::Parameters(const Standard_Integer Index, Standard_Real& U1, Standard_Real& U2) const {
...
Standard_Boolean GeomAPI_ExtremaCurveCurve::TotalLowerDistanceParameters(Standard_Real& U1, Standard_Real& U2) {
    if (!myTotalExt) {
