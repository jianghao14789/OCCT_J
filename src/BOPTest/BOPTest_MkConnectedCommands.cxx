...
void BOPTest::MkConnectedCommands(Draw_Interpretor& theCommands) {
    ...
    theCommands.Add("cperiodictwins",
...
// purpose  :
//=======================================================================
Standard_Integer MakeConnected(Draw_Interpretor& theDI, Standard_Integer theArgc, const char** theArgv) {
    if (theArgc < 3) {
    ...
    if (getMakeConnectedTool().HasErrors()) return 0;
...
// purpose  :
//=======================================================================
Standard_Integer MakePeriodic(Draw_Interpretor& theDI, Standard_Integer theArgc, const char** theArgv) {
    if (theArgc < 4) {
        theDI.PrintHelp(theArgv[0]);
        return 1;
    }
    ...
    for (Standard_Integer i = 2; i < theArgc;) {
        ...
        if (theArgc > i + 1) aPeriod = Draw::Atof(theArgv[++i]);
...
// purpose  :
//=======================================================================
Standard_Integer RepeatShape(Draw_Interpretor& theDI, Standard_Integer theArgc, const char** theArgv) {
    if (theArgc < 4) {
        theDI.PrintHelp(theArgv[0]);
        return 1;
    }
    ...
    for (Standard_Integer i = 2; i < theArgc; ++i) {
        ...
        if (theArgc > i + 1) aTimes = Draw::Atoi(theArgv[++i]);
...
// purpose  :
//=======================================================================
Standard_Integer MaterialsOn(Draw_Interpretor& theDI, Standard_Integer theArgc, const char** theArgv) {
    if (theArgc != 4) {
        theDI.PrintHelp(theArgv[0]);
        return 1;
    }
    ...
    const TopTools_ListOfShape& aLS = bPositive ? getMakeConnectedTool().MaterialsOnPositiveSide(aShape)
