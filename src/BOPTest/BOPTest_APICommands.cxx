...
Standard_Integer bapibop(Draw_Interpretor& di, Standard_Integer n, const char** a) {
    ...
    pBuilder->SimplifyResult(BOPTest_Objects::UnifyEdges(), BOPTest_Objects::UnifyFaces(), BOPTest_Objects::Angular());

    // Store the history of operation into the session
    if (BRepTest_Objects::IsHistoryNeeded()) BRepTest_Objects::SetHistory(pBuilder->History());
...
Standard_Integer bapibuild(Draw_Interpretor& di, Standard_Integer n, const char** a) {
    ...
    aBuilder.SimplifyResult(BOPTest_Objects::UnifyEdges(), BOPTest_Objects::UnifyFaces(), BOPTest_Objects::Angular());

    // Store the history of operation into the session
    if (BRepTest_Objects::IsHistoryNeeded()) BRepTest_Objects::SetHistory(aBuilder.History());
...
Standard_Integer bapisplit(Draw_Interpretor& di, Standard_Integer n, const char** a) {
    ...
    aSplitter.SimplifyResult(BOPTest_Objects::UnifyEdges(), BOPTest_Objects::UnifyFaces(), BOPTest_Objects::Angular());

    // Store the history of operation into the session
    if (BRepTest_Objects::IsHistoryNeeded()) BRepTest_Objects::SetHistory(aSplitter.History());
