...
void BOPTest::ObjCommands(Draw_Interpretor& theCommands) {
    ...
    theCommands.Add("baddcompound",
                    "Command for adding multiple objects for Boolean/GF/Split/Cells operations grouped in one object.\n"
                    "\t\tGiven object will be exploded on first level sub-shapes and each of these sub-shapes will act "
