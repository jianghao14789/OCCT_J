...
static Standard_Integer bopsmt(Draw_Interpretor& di, Standard_Integer n, const char** a, const BOPAlgo_Operation aOp);
//
static Standard_Integer bsmt(Draw_Interpretor& di, Standard_Integer n, const char** a, const BOPAlgo_Operation aOp);
//
...
// purpose  :
//=======================================================================
Standard_Integer bopsmt(Draw_Interpretor& di, Standard_Integer n, const char** a, const BOPAlgo_Operation aOp) {
    if (n < 2) {
        di << " use bopsmt r\n";
        return 0;
    }
    ...
    if (BRepTest_Objects::IsHistoryNeeded()) BRepTest_Objects::SetHistory(aBOP.History());
...
Standard_Integer bsection(Draw_Interpretor& di, Standard_Integer n, const char** a) {
    ...
    // Store the history of Section operation into the session
    if (BRepTest_Objects::IsHistoryNeeded()) BRepTest_Objects::SetHistory(aSec.History());
...
// purpose  :
//=======================================================================
Standard_Integer bsmt(Draw_Interpretor& di, Standard_Integer n, const char** a, const BOPAlgo_Operation aOp) {
    TopoDS_Shape aS1, aS2;
    TopTools_ListOfShape aLC;
    //
    if (n != 4) {
    ...
    // Store the history of Boolean operation into the session
    if (BRepTest_Objects::IsHistoryNeeded()) BRepTest_Objects::SetHistory(aBOP.PDS()->Arguments(), aBOP);
...
Standard_Integer mkvolume(Draw_Interpretor& di, Standard_Integer n, const char** a) {
    ...
    if (BRepTest_Objects::IsHistoryNeeded()) BRepTest_Objects::SetHistory(aLS, aMV);
