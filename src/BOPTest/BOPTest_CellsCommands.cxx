...
void BOPTest::CellsCommands(Draw_Interpretor& theCommands) {
    ...
    theCommands.Add("bcaddall", "Add all parts to result. Use: bcaddall r [-m material [-u]]", __FILE__, bcaddall, g);
    theCommands.Add("bcremoveall", "Remove all parts from result. Use: bcremoveall", __FILE__, bcremoveall, g);
    theCommands.Add("bcadd", "Add parts to result. Use: bcadd r s1 (0,1) s2 (0,1) ... [-m material [-u]]", __FILE__,
                    bcadd, g);
    theCommands.Add("bcremove", "Remove parts from result. Use: bcremove r s1 (0,1) s2 (0,1) ...", __FILE__, bcremove,
                    g);
    theCommands.Add("bcremoveint", "Remove internal boundaries. Use: bcremoveint r", __FILE__, bcremoveint, g);
...
Standard_Integer bcbuild(Draw_Interpretor& di, Standard_Integer n, const char** a) {
    ...
    if (BRepTest_Objects::IsHistoryNeeded()) BRepTest_Objects::SetHistory(aCBuilder.Arguments(), aCBuilder);
