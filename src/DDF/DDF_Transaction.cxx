...
// purpose  :
//=======================================================================
DDF_Transaction::DDF_Transaction() : myTransaction(TCollection_AsciiString()) {}
...
DDF_Transaction::DDF_Transaction(const Handle(TDF_Data) & aDF) : myTransaction(TCollection_AsciiString()) {
