...
//=======================================================================
Handle(ShapePersistent_Geom::Curve) ShapePersistent_Geom::Translate(const Handle(Geom_Curve) & theCurve,
...
//=======================================================================
Handle(ShapePersistent_Geom::Surface) ShapePersistent_Geom::Translate(const Handle(Geom_Surface) & theSurf,
                                                                      StdObjMgt_TransientPersistentMap& theMap) {
    Handle(Surface) aPS;
    if (!theSurf.IsNull()) {
        if (theMap.IsBound(theSurf))
            ...
            if (aST == STANDARD_TYPE(Geom_Plane)) {
                ...
                aPS =
                    ShapePersistent_Geom_Surface::Translate(Handle(Geom_CylindricalSurface)::DownCast(theSurf), theMap);
                ...
                aPS = ShapePersistent_Geom_Surface::Translate(Handle(Geom_SurfaceOfLinearExtrusion)::DownCast(theSurf),
                                                              theMap);
            } else if (aST == STANDARD_TYPE(Geom_SurfaceOfRevolution)) {
                aPS = ShapePersistent_Geom_Surface::Translate(Handle(Geom_SurfaceOfRevolution)::DownCast(theSurf),
                                                              theMap);
                ...
                aPS = ShapePersistent_Geom_Surface::Translate(Handle(Geom_RectangularTrimmedSurface)::DownCast(theSurf),
                                                              theMap);
