...
public:
    ...
    Standard_EXPORT virtual const IMeshData::IWireHandle& GetWire(const Standard_Integer theIndex) const = 0;
    ...
    Standard_Boolean IsValid() const {
        return (IsEqual(IMeshData_NoError) || IsEqual(IMeshData_ReMesh) || IsEqual(IMeshData_UnorientedWire));
    }
...
protected:
    ...
    IMeshData_Face(const TopoDS_Face& theFace) : IMeshData_TessellatedShape(theFace) {
