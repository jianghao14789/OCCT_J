...
public:
    ...
    //! Standard_Real Tol = ... ;
    //! AddSurface::Add ( S, Tol, B );
    Standard_EXPORT static void Add(const Adaptor3d_Surface& S, const Standard_Real UMin, const Standard_Real UMax,
    ...
    Standard_EXPORT static void AddOptimal(const Adaptor3d_Surface& S, const Standard_Real UMin,
    ...
    Standard_EXPORT static void AddGenSurf(const Adaptor3d_Surface& S, const Standard_Real UMin,
                                           const Standard_Real UMax, const Standard_Real VMin, const Standard_Real VMax,
                                           const Standard_Real Tol, Bnd_Box& B);
