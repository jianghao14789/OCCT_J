...
Standard_Boolean Interface_FileReaderTool::RecognizeByLib(const Standard_Integer num, Interface_GeneralLib& glib,
...
//   chaque interface definit son FileHeader avec ses methodes, appelees ici
{
    ...
    if (!thereports.IsNull()) {
        ...
        for (Standard_Integer nr = 1; nr <= thenbreps; nr++) {
            ...
            Handle(Interface_ReportEntity) rep = Handle(Interface_ReportEntity)::DownCast(thereports->Value(nr));
