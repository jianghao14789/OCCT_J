...
public:
    ...
    Standard_EXPORT Interface_Static(const Standard_CString family, const Standard_CString name,
    ...
    Standard_EXPORT static Standard_Boolean Init(const Standard_CString family, const Standard_CString name,
    ...
    Standard_EXPORT static Handle(TColStd_HSequenceOfHAsciiString)
