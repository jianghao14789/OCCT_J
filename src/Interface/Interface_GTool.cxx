...
void Interface_GTool::SetProtocol(const Handle(Interface_Protocol) & proto, const Standard_Boolean enforce) {
...
Standard_Boolean Interface_GTool::Select(const Handle(Standard_Transient) & ent, Handle(Interface_GeneralModule) & gmod,
                                         Standard_Integer& CN, const Standard_Boolean enforce) {
