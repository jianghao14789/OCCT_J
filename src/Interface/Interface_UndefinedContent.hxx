...
public:
    ...
    Standard_EXPORT Standard_Boolean ParamData(const Standard_Integer num, Interface_ParamType& ptype,
    ...
    Standard_EXPORT void SetLiteral(const Standard_Integer num, const Interface_ParamType ptype,
                                    const Handle(TCollection_HAsciiString) & val);

    //! Sets a new value for the Parameter <num>, to reference an
    //! Entity. To simply change the Entity, see the variant below
    Standard_EXPORT void SetEntity(const Standard_Integer num, const Interface_ParamType ptype,
