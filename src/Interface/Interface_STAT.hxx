...
public:
    ...
    //! when starting
    Standard_EXPORT void Internals(Handle(TCollection_HAsciiString) & tit, Standard_Real& total,
    ...
    //! weight, name)
    Standard_EXPORT void Phase(const Standard_Integer num, Standard_Integer& n0step, Standard_Integer& nbstep,
