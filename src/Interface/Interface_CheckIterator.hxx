...
public:
    ...
    Standard_EXPORT Interface_CheckIterator Extract(const Standard_CString mess, const Standard_Integer incl,
    ...
    Standard_EXPORT Standard_Boolean Remove(const Standard_CString mess, const Standard_Integer incl,
    ...
    Standard_EXPORT Handle(TColStd_HSequenceOfTransient)
        Checkeds(const Standard_Boolean failsonly, const Standard_Boolean global) const;
    ...
    //! Remark : Works apart from the iteration methods (no interference)
    Standard_EXPORT void Print(Standard_OStream& S, const Standard_Boolean failsonly,
    ...
    Standard_EXPORT void Print(Standard_OStream& S, const Handle(Interface_InterfaceModel) & model,
                               const Standard_Boolean failsonly, const Standard_Integer final = 0) const;
