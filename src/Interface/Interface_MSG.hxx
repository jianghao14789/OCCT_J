...
public:
    ...
    Standard_EXPORT Interface_MSG(const Standard_CString key, const Standard_Real r1,
    ...
    Standard_EXPORT static Standard_Real Intervalled(const Standard_Real val, const Standard_Integer order = 3,
    ...
    Standard_EXPORT static void TDate(const Standard_CString text, const Standard_Integer yy, const Standard_Integer mm,
    ...
    Standard_EXPORT static Standard_Boolean NDate(const Standard_CString text, Standard_Integer& yy,
                                                  Standard_Integer& mm, Standard_Integer& dd, Standard_Integer& hh,
                                                  Standard_Integer& mn, Standard_Integer& ss);
    ...
    Standard_EXPORT static void Print(Standard_OStream& S, const Standard_CString val, const Standard_Integer max,
