...
Standard_Boolean Interface_BitMap::SetFlagName(const Standard_Integer num, const Standard_CString name) {
    if (num < 1 || num > thenames->Length()) return Standard_False;
...
Standard_Boolean Interface_BitMap::Value(const Standard_Integer item, const Standard_Integer flag) const {
...
void Interface_BitMap::SetValue(const Standard_Integer item, const Standard_Boolean val,
...
Standard_Boolean Interface_BitMap::CTrue(const Standard_Integer item, const Standard_Integer flag) const {
    Standard_Integer numw = (thenbwords * flag) + (item >> 5);
    Standard_Integer numb = item & 31;
    Standard_Integer& val = theflags->ChangeValue(numw);
...
Standard_Boolean Interface_BitMap::CFalse(const Standard_Integer item, const Standard_Integer flag) const {
    Standard_Integer numw = (thenbwords * flag) + (item >> 5);
    Standard_Integer numb = item & 31;
    Standard_Integer& val = theflags->ChangeValue(numw);
    Standard_Integer res, mot = ~(1 << numb);
