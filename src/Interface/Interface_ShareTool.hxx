...
public:
    ...
    Standard_EXPORT Handle(Standard_Transient)
        TypedSharing(const Handle(Standard_Transient) & ent, const Handle(Standard_Type) & atype) const;
    ...
    Standard_EXPORT Interface_EntityIterator All(const Handle(Standard_Transient) & ent,
