...
public:
    ...
    Standard_EXPORT Standard_Boolean Complies(const Handle(TCollection_HAsciiString) & mess,
                                              const Standard_Integer incl, const Interface_CheckStatus status) const;
    ...
    Standard_EXPORT Standard_Boolean Remove(const Handle(TCollection_HAsciiString) & mess, const Standard_Integer incl,
    ...
    Standard_EXPORT void Print(Standard_OStream& S, const Standard_Integer level,
