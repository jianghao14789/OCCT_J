...
public:
    ...
    //! pages of characters
    Standard_EXPORT void AddParam(const Standard_Integer num, const Standard_CString aval,
    ...
    Standard_EXPORT void AddParam(const Standard_Integer num, const TCollection_AsciiString& aval,
                                  const Interface_ParamType atype, const Standard_Integer nument = 0);
    ...
    Standard_EXPORT void SetParam(const Standard_Integer num, const Standard_Integer nump,
    ...
    //! Error if none
    Standard_EXPORT const Handle(Standard_Transient) &
        ParamEntity(const Standard_Integer num, const Standard_Integer nump) const;
...
protected:
    ...
    Standard_EXPORT void ParamPosition(const Standard_Integer numpar, Standard_Integer& num,
