...
public:
    ...
    Interface_Category() : myGTool(new Interface_GTool) {
        Init();
    }

    //! Creates a Category with a given protocol
    Interface_Category(const Handle(Interface_Protocol) & theProtocol) : myGTool(new Interface_GTool(theProtocol)) {
        Init();
    }

    //! Creates a Category with a given GTool
    Interface_Category(const Handle(Interface_GTool) & theGTool) : myGTool(theGTool) {
        Init();
    }
