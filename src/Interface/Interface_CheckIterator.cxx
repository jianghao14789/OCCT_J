...
Interface_CheckIterator::Interface_CheckIterator(const Standard_CString name) : thename(name) {
    Clear();
}
...
Interface_CheckIterator Interface_CheckIterator::Extract(const Standard_CString mess, const Standard_Integer incl,
...
Standard_Boolean Interface_CheckIterator::Remove(const Standard_CString mess, const Standard_Integer incl,
...
void Interface_CheckIterator::Print(Standard_OStream& S, const Standard_Boolean failsonly,
...
void Interface_CheckIterator::Print(Standard_OStream& S, const Handle(Interface_InterfaceModel) & model,
                                    const Standard_Boolean failsonly, const Standard_Integer /*final*/) const {
