...
void Interface_FloatWriter::SetFormatForRange(const Standard_CString form, const Standard_Real R1,
...
void Interface_FloatWriter::Options(Standard_Boolean& zerosup, Standard_Boolean& range, Standard_Real& R1,
...
Standard_Integer Interface_FloatWriter::Write(const Standard_Real val, const Standard_CString text) const {
...
// purpose  :
//=======================================================================
Standard_Integer Interface_FloatWriter::Convert(const Standard_Real val, const Standard_CString text,
                                                const Standard_Boolean zsup, const Standard_Real R1,
                                                const Standard_Real R2, const Standard_CString mainform,
    ...
    if (zsup) {
        for (int i = 0; i < 16; i++) {
            ...
            if (text[i] == 'e' || text[i] == 'E') {
                ...
                if (lxp[1] == '+' && lxp[2] == '0' && lxp[3] == '0' && lxp[4] == '\0') lxp[0] = '\0';
