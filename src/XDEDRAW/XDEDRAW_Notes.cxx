...
static Standard_Integer noteCount(Draw_Interpretor& di, Standard_Integer argc, const char** argv) {
    ...
    di << aNotesTool->NbAnnotatedItems() << " " << aNotesTool->NbNotes() << " " << aNotesTool->NbOrphanNotes();
    return 0;
}
...
static Standard_Integer noteAnnotations(Draw_Interpretor& di, Standard_Integer argc, const char** argv) {
...
//=======================================================================
static const cmd XNoteCreateBalloon = {"XNoteCreateBalloon", 3,
                                       "XNoteCreateBalloon Doc comment [--user name] [--time stamp]"};
static Standard_Integer noteCreateBalloon(Draw_Interpretor& di, Standard_Integer argc, const char** argv) {
...
//=======================================================================
static const cmd XNoteCreateComment = {"XNoteCreateComment", 3,
                                       "XNoteCreateComment Doc comment [--user name] [--time stamp]"};
static Standard_Integer noteCreateComment(Draw_Interpretor& di, Standard_Integer argc, const char** argv) {
...
static const cmd XNoteCreateBinData = {
    "XNoteCreateBinData", 5,
    "XNoteCreateBinData Doc title <--file path | --data data> [--mime type] [--user name] [--time stamp]"};
static Standard_Integer noteCreateBinData(Draw_Interpretor& di, Standard_Integer argc, const char** argv) {
...
static Standard_Integer noteDeleteAll(Draw_Interpretor& di, Standard_Integer argc, const char** argv) {
...
static Standard_Integer noteDeleteOrphan(Draw_Interpretor& di, Standard_Integer argc, const char** argv) {
...
//=======================================================================
static const cmd XNoteAdd = {"XNoteAdd", 4, "XNoteAdd Doc note item [--attr guid | --subshape num]"};
...
//=======================================================================
static const cmd XNoteRemove = {"XNoteRemove", 4,
...
//=======================================================================
static const cmd XNoteRemoveAll = {"XNoteRemoveAll", 3,
                                   "XNoteRemoveAll Doc item [--attr guid] [--subshape num] [--del-orphan]"};
static Standard_Integer noteRemoveAll(Draw_Interpretor& di, Standard_Integer argc, const char** argv) {
...
//=======================================================================
static const cmd XNoteFindAnnotated = {"XNoteFindAnnotated", 3,
                                       "XNoteFindAnnotated Doc item [--attr guid | --subshape num]"};
static Standard_Integer noteFindAnnotated(Draw_Interpretor& di, Standard_Integer argc, const char** argv) {
...
//=======================================================================
static const cmd XNoteGetNotes = {"XNoteGetNotes", 3, "XNoteGetNotes Doc item [--attr guid | --subshape num]"};
...
static Standard_Integer noteTimestamp(Draw_Interpretor& di, Standard_Integer argc, const char** argv) {
...
static Standard_Integer noteIsRefOrphan(Draw_Interpretor& di, Standard_Integer argc, const char** argv) {
