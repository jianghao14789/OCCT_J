...
static Standard_Integer setView(Draw_Interpretor& di, Standard_Integer argc, const char** argv) {
    ...
    if (aShapes.Length() == 0 && aGDTs.Length() == 0) return 1;
...
static Standard_Integer setClippingPlanes(Draw_Interpretor& di, Standard_Integer argc, const char** argv) {
    ...
    for (Standard_Integer i = 3; i < argc; i++) {
        ...
        TDF_Tool::Label(aDoc->GetData(), argv[i], aLabel);
        if (aLabel.IsNull()) continue;
        if (aCPlaneTool->IsClippingPlane(aLabel)) aCPlanes.Append(aLabel);
    }

    if (aCPlanes.Length() == 0) return 1;
...
void XDEDRAW_Views::InitCommands(Draw_Interpretor& di) {
    ...
    di.Add("XSetView", "XSetView Doc shape_label1 ... shape_labelN gdt_label1 ... gdt_labelN", __FILE__, setView, g);

    di.Add("XRemoveView", "XRemoveView Doc ViewLabel", __FILE__, removeView, g);

    di.Add("XSetClippingPlanes", "XSetView Doc view_plane plane_label1 ... plane_labelN", __FILE__, setClippingPlanes,
           g);
    ...
    di.Add("XSetViewType", "XSetViewType Doc ViewLabel type (central/parallel/no_camera)", __FILE__, setType, g);

    di.Add("XGetViewType", "XGetViewType Doc ViewLabel", __FILE__, getType, g);

    di.Add("XSetViewProjectionPoint", "XSetViewProjectionPoint Doc ViewLabel x y z", __FILE__, setProjectionPoint, g);

    di.Add("XGetViewProjectionPoint", "XGetViewProjectionPoint Doc ViewLabel", __FILE__, getProjectionPoint, g);
    ...
    di.Add("XSetViewWindowSize", "XSetViewWindowSize Doc ViewLabel width height", __FILE__, setWindowSize, g);

    di.Add("XGetViewWindowSize", "XGetViewWindowSize Doc ViewLabel", __FILE__, getWindowSize, g);

    di.Add("XSetViewFrontPlaneDistance", "XSetViewFrontPlaneDistance Doc ViewLabel distance", __FILE__,
           setFrontPlaneDistance, g);

    di.Add("XUnsetViewFrontPlaneDistance", "XSetViewFrontPlaneDistance Doc ViewLabel", __FILE__,
           unsetFrontPlaneDistance, g);

    di.Add("XGetViewFrontPlaneDistance", "XGetViewFrontPlaneDistance Doc ViewLabel", __FILE__, getFrontPlaneDistance,
           g);

    di.Add("XSetViewBackPlaneDistance", "XSetViewBackPlaneDistance Doc ViewLabel distance", __FILE__,
           setBackPlaneDistance, g);

    di.Add("XUnsetViewBackPlaneDistance", "XUnsetViewBackPlaneDistance Doc ViewLabel", __FILE__, unsetBackPlaneDistance,
           g);

    di.Add("XGetViewBackPlaneDistance", "XGetViewBackPlaneDistance Doc ViewLabel", __FILE__, getBackPlaneDistance, g);
    ...
    di.Add("XGetViewVolumeSidesClipping", "XGetViewVolumeSidesClipping Doc ViewLabel", __FILE__,
           getViewVolumeSidesClipping, g);

    di.Add("XDumpView", "XDumpView Doc ViewLabel", __FILE__, dump, g);

    di.Add("XAddClippingPlane", "XAddClippingPlane Doc plane name capping[0/1]", __FILE__, addClippingPlane, g);

    di.Add("XGetClippingPlaneCapping", "XGetClippingPlaneCapping Doc ClippingPlane_Label", __FILE__,
           getClippingPlaneCapping, g);

    di.Add("XGetClippingPlane", "XGetClippingPlane Doc ClippingPlane_Label", __FILE__, getClippingPlane, g);

    di.Add("XRemoveClippingPlane", "XRemoveClippingPlane Doc ClippingPlane_Label", __FILE__, removeClippingPlane, g);
}
