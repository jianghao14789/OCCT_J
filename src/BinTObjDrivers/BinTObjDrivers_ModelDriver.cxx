...
BinTObjDrivers_ModelDriver::BinTObjDrivers_ModelDriver(const Handle(Message_Messenger) & theMessageDriver)
...
void BinTObjDrivers_ModelDriver::Paste(const Handle(TDF_Attribute) & theSource, BinObjMgt_Persistent& theTarget,
