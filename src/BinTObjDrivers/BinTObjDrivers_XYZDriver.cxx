...
BinTObjDrivers_XYZDriver::BinTObjDrivers_XYZDriver(const Handle(Message_Messenger) & theMessageDriver)
...
Standard_Boolean BinTObjDrivers_XYZDriver::Paste(const BinObjMgt_Persistent& theSource,
    ...
    if (!(theSource >> aX >> aY >> aZ)) return Standard_False;
...
void BinTObjDrivers_XYZDriver::Paste(const Handle(TDF_Attribute) & theSource, BinObjMgt_Persistent& theTarget,
