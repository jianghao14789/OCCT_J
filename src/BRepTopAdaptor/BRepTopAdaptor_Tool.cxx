...
BRepTopAdaptor_Tool::BRepTopAdaptor_Tool(const Handle(Adaptor3d_Surface) & surface, const Standard_Real /*Tol2d*/) {
    myTopolTool = new BRepTopAdaptor_TopolTool();
...
void BRepTopAdaptor_Tool::Init(const Handle(Adaptor3d_Surface) & surface, const Standard_Real /*Tol2d*/) {
    myTopolTool->Initialize(surface);
    myHSurface = surface;
    myloaded = Standard_True;
}
