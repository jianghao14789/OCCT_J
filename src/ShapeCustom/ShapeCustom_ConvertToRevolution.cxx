...
static Standard_Boolean IsToConvert(const Handle(Geom_Surface) & S, Handle(Geom_ElementarySurface) & ES) {
    ...
    return ES->IsKind(STANDARD_TYPE(Geom_SphericalSurface)) || ES->IsKind(STANDARD_TYPE(Geom_ToroidalSurface)) ||
           ES->IsKind(STANDARD_TYPE(Geom_CylindricalSurface)) || ES->IsKind(STANDARD_TYPE(Geom_ConicalSurface));
}
...
Standard_Boolean ShapeCustom_ConvertToRevolution::NewSurface(const TopoDS_Face& F, Handle(Geom_Surface) & S,
...
Standard_Boolean ShapeCustom_ConvertToRevolution::NewCurve(const TopoDS_Edge& E, Handle(Geom_Curve) & C,
                                                           TopLoc_Location& L, Standard_Real& Tol) {
...
Standard_Boolean ShapeCustom_ConvertToRevolution::NewPoint(const TopoDS_Vertex& /*V*/, gp_Pnt& /*P*/,
                                                           Standard_Real& /*Tol*/) {
...
Standard_Boolean ShapeCustom_ConvertToRevolution::NewCurve2d(const TopoDS_Edge& E, const TopoDS_Face& F,
...
Standard_Boolean ShapeCustom_ConvertToRevolution::NewParameter(const TopoDS_Vertex& /*V*/, const TopoDS_Edge& /*E*/,
...
GeomAbs_Shape ShapeCustom_ConvertToRevolution::Continuity(const TopoDS_Edge& E, const TopoDS_Face& F1,
