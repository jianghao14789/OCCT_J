...
Standard_Boolean ShapeCustom_DirectModification::NewSurface(const TopoDS_Face& F, Handle(Geom_Surface) & S,
...
Standard_Boolean ShapeCustom_DirectModification::NewCurve(const TopoDS_Edge& E, Handle(Geom_Curve) & C,
                                                          TopLoc_Location& L, Standard_Real& Tol) {
...
Standard_Boolean ShapeCustom_DirectModification::NewPoint(const TopoDS_Vertex& /*V*/, gp_Pnt& /*P*/,
                                                          Standard_Real& /*Tol*/) {
...
Standard_Boolean ShapeCustom_DirectModification::NewCurve2d(const TopoDS_Edge& E, const TopoDS_Face& F,
...
Standard_Boolean ShapeCustom_DirectModification::NewParameter(const TopoDS_Vertex& /*V*/, const TopoDS_Edge& /*E*/,
...
GeomAbs_Shape ShapeCustom_DirectModification::Continuity(const TopoDS_Edge& E, const TopoDS_Face& F1,
