...
// purpose  :
//=======================================================================
TDocStd_XLinkIterator::TDocStd_XLinkIterator() : myValue(NULL) {}
...
TDocStd_XLinkIterator::TDocStd_XLinkIterator(const Handle(TDocStd_Document) & DOC) : myValue(NULL) {
    Init(DOC);
}
...
void TDocStd_XLinkIterator::Init(const Handle(TDocStd_Document) & DOC) {
    ...
    if (DOC->GetData()->Root().FindAttribute(TDocStd_XLinkRoot::GetID(), xRefRoot)) myValue = xRefRoot->First();
}
