...
static Standard_Boolean local_FindTreatedEdgeOnVertex(const TopoDS_Edge& theEdge, const TopoDS_Vertex& theVertex);
...
Standard_EXPORT Handle(TopOpeBRepDS_Interference)
    MakeEPVInterference(const TopOpeBRepDS_Transition& T, // transition
...
Standard_EXPORT void FUN_GetdgData(TopOpeBRepDS_PDataStructure& pDS, const TopOpeBRep_LineInter& L,
    ...
    for (; itm.More(); itm.Next()) {
        ...
        TopoDS_Vertex vsd;
        if (hassd) vsd = TopoDS::Vertex(mapvvsd.Find(v));
...
FUN_putInterfonDegenEd(const TopOpeBRep_VPointInter& VP, const TopoDS_Face& F1, const TopoDS_Face& F2,
                       TopTools_DataMapOfShapeListOfShape& DataforDegenEd, // const but for copy &
                       Handle(TopOpeBRepDS_HDataStructure) & HDS, Standard_Integer& is, TopoDS_Edge& dgE,
                       ...
                       TopOpeBRepDS_Transition& Trans1, Standard_Real& param1, TopOpeBRepDS_Transition& Trans2,
                       Standard_Real& param2, TopoDS_Edge& OOEi, Standard_Real& paronOOEi, Standard_Boolean& hasOOEi,
...
Standard_Boolean
TopOpeBRep_FacesFiller::ProcessVPondgE(const TopOpeBRep_VPointInter& VP, const Standard_Integer ShapeIndex,
                                       ...
                                       Standard_Boolean& CPIfound, Handle(TopOpeBRepDS_Interference) & ICPI) // out
{
    ...
    TopoDS_Edge dgEd;
    Standard_Integer makeI = FUN_putInterfonDegenEd(VP, myF1, myF2, myDataforDegenEd, myHDS, rankdg, dgEd, Iiondg,
                                                    T1ondg, par1ondg, T2ondg, par2ondg, OOEi, parOOEi, hasOOEi, isT2d);
    if (makeI == NOI) {
        return Standard_False;
    }
    ...
    if ((makeI == MKI1) || (makeI == MKI12)) {
        ...
        */
        if (!isT2d) {
            Handle(TopOpeBRepDS_Interference) EVI1 = ::MakeEPVInterference(
                T1ondg, iFi, PVIndex, par1ondg, TopOpeBRepDS_VERTEX, TopOpeBRepDS_FACE, isvertex1);
    ...
    if ((makeI == MKI2) || (makeI == MKI12)) {
        ...
        */
        if (!isT2d) {
            Handle(TopOpeBRepDS_Interference) EVI2 = ::MakeEPVInterference(
                T2ondg, iFi, PVIndex, par2ondg, TopOpeBRepDS_VERTEX, TopOpeBRepDS_FACE, isvertex2);
