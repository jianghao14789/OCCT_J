...
// purpose  :
//=======================================================================
TopOpeBRep_DSFiller::TopOpeBRep_DSFiller() : myPShapeClassifier(NULL) {}
...
// purpose  :
//=======================================================================
Standard_Boolean BREP_UnfillSameDomain(const TopoDS_Shape& F1, const TopoDS_Shape& F2,
    ...
    if (((st1 == TopAbs_OUT) && (st2 == TopAbs_OUT)) || ((st1 == TopAbs_UNKNOWN) && (st2 == TopAbs_UNKNOWN))) {
...
// purpose  :
//=======================================================================
static Standard_Boolean FUN_shareNOG(const Handle(TopOpeBRepDS_HDataStructure) & HDS, const TopoDS_Shape& lFF1,
...
// purpose  :
//=======================================================================
void TopOpeBRep_DSFiller::Insert(const TopoDS_Shape& aS1, const TopoDS_Shape& aS2,
                                 const Handle(TopOpeBRepDS_HDataStructure) & HDS,
...
// purpose  :
//=======================================================================
void TopOpeBRep_DSFiller::InsertIntersection(const TopoDS_Shape& aS1, const TopoDS_Shape& aS2,
                                             const Handle(TopOpeBRepDS_HDataStructure) & HDS,
                                             const Standard_Boolean orientFORWARD) {
    FBOX_Prepare();
    ...
    TopTools_IndexedMapOfShape& aMapOfRejectedShapesObj = aDataStructure.ChangeMapOfRejectedShapesObj();
    TopTools_IndexedMapOfShape& aMapOfRejectedShapesTool = aDataStructure.ChangeMapOfRejectedShapesTool();
    ...
    if (!aMapOfSolids.IsEmpty()) myShapeIntersector.RejectedFaces(S1, S2, aListObj);

    aMapOfSolids.Clear();
    TopExp::MapShapes(S1, TopAbs_SOLID, aMapOfSolids);
    if (!aMapOfSolids.IsEmpty()) myShapeIntersector.RejectedFaces(S2, S1, aListTool);
...
#ifdef OCCT_DEBUG
    if (tkro) KRO_DSFILLER_TOTAL.Stop();
    if (tsiff) SIFF.End("DSFiller fin tsif ", std::cout);
#endif
#ifdef OCCT_DEBUG
...
void TopOpeBRep_DSFiller::Insert2d(const TopoDS_Shape& aS1, const TopoDS_Shape& aS2,
                                   const Handle(TopOpeBRepDS_HDataStructure) & HDS) {
...
void TopOpeBRep_DSFiller::InsertIntersection2d(const TopoDS_Shape& aS1, const TopoDS_Shape& aS2,
                                               const Handle(TopOpeBRepDS_HDataStructure) & HDS) {
    ...
    while (myShapeIntersector2d.MoreIntersection()) {
        ...
        if (unfill) {
            ...
            if (unfill) {
                ...
                if (!lFF1.IsNull() && !lFF2.IsNull()) BDS2.UnfillShapesSameDomain(lFF1, lFF2);
            }
        }
...
void TopOpeBRep_DSFiller::Insert1d(const TopoDS_Shape& aS1, const TopoDS_Shape& aS2, const TopoDS_Face& aF1,
                                   const TopoDS_Face& aF2, const Handle(TopOpeBRepDS_HDataStructure) & HDS,
                                   const Standard_Boolean orientFORWARD) {
...
Standard_Boolean TopOpeBRep_DSFiller::ClearShapeSameDomain(const TopoDS_Shape& aS1, const TopoDS_Shape& aS2,
                                                           const Handle(TopOpeBRepDS_HDataStructure) & HDS) {
    TopOpeBRepDS_DataStructure& DS = HDS->ChangeDS();
    const Standard_Boolean b = Standard_False;
    if (!CheckInsert(aS1, aS2)) return b;
