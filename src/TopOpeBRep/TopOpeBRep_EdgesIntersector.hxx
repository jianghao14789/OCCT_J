...
public:
    ...
    Standard_EXPORT void Perform(const TopoDS_Shape& E1, const TopoDS_Shape& E2,
    ...
    Standard_EXPORT void Dump(const TCollection_AsciiString& str, const Standard_Integer ie1 = 0,
    ...
    Standard_EXPORT virtual Standard_Boolean ReduceSegment(TopOpeBRep_Point2d& P1, TopOpeBRep_Point2d& P2,
