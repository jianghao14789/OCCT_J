...
TopOpeBRepDS_Transition TopOpeBRep_FacesFiller::GetEdgeTrans(const TopOpeBRep_VPointInter& VP,
                                                             ...
                                                             const Standard_Integer ShapeIndex, const TopoDS_Face& F) {
    ...
    if (SIedgeIndex != 0) {
        ...
        FDS_LOIinfsup(myHDS->DS(), edge, paredge, PVKind, PVIndex, myHDS->DS().ShapeInterferences(edge), par1, par2,
                      isonboundper);
    } else
...
void TopOpeBRep_FacesFiller::ProcessVPonclosingR(
    ...
    const TopoDS_Shape&, const Standard_Integer ShapeIndex, const TopOpeBRepDS_Transition& transEdge,
