...
Standard_EXPORT Standard_Integer TopOpeBRep_SettraceEEFF(const Standard_Boolean b, Standard_Integer n, char** a) {
    ...
    if (n == 0) TopOpeBRep_SettraceEEFF(b);
    return err;
}
...
Standard_EXPORT Standard_Boolean TopOpeBRep_GettraceEEFF(const Standard_Integer i1, const Standard_Integer i2,
...
Standard_EXPORT Standard_Integer TopOpeBRep_SettraceNVP(const Standard_Boolean b, Standard_Integer n, char** a) {
    ...
    if (n == 0) TopOpeBRep_SettraceNVP(b);
    return err;
}
...
Standard_EXPORT Standard_Boolean TopOpeBRep_GettraceNVP(Standard_Integer i1, Standard_Integer i2, Standard_Integer i3,
                                                        Standard_Integer i4, Standard_Integer i5) {
    char* t[5];
    t[0] = AS(i1);
    t[1] = AS(i2);
    t[2] = AS(i3);
...
Standard_EXPORT Standard_Integer TopOpeBRep_SettraceSHA(const Standard_Boolean b, Standard_Integer n, char** a) {
    ...
    if (n == 0) TopOpeBRep_SettraceSHA(b);
    return err;
}
