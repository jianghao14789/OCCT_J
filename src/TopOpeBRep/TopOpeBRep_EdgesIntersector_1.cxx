...
const IntRes2d_IntersectionSegment& TopOpeBRep_EdgesIntersector::Segment1() const {
    if (!IsPointOfSegment1()) throw Standard_Failure("TopOpeBRep_EdgesIntersector : Not a segment point");
...
// purpose  :
//=======================================================================
TopOpeBRepDS_Transition TopOpeBRep_EdgesIntersector::Transition1(const Standard_Integer Index,
...
Standard_Boolean TopOpeBRep_EdgesIntersector::IsVertex1(const Standard_Integer Index) {
    ...
    if (myIsVertexPointIndex == myPointIndex && myIsVertexIndex == Index) return myIsVertexValue;
...
const TopoDS_Shape& TopOpeBRep_EdgesIntersector::Vertex1(const Standard_Integer Index) {
    if (!IsVertex1(Index)) throw Standard_Failure("TopOpeBRep_EdgesIntersector : Vertex1");
