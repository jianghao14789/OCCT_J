...
Standard_EXPORT Standard_Boolean FUN_projPonL(const gp_Pnt& P, const TopOpeBRep_LineInter L,
                                              const TopOpeBRep_FacesFiller& FF, Standard_Real& paramL) {
...
// purpose  :
//=======================================================================
void TopOpeBRep_FacesFiller::Insert(const TopoDS_Shape& S1, const TopoDS_Shape& S2, TopOpeBRep_FacesIntersector& FACINT,
...
void TopOpeBRep_FacesFiller::VP_Position(TopOpeBRep_FacesIntersector&) {
    for (myFacesIntersector->InitLine(); myFacesIntersector->MoreLine(); myFacesIntersector->NextLine()) {
        TopOpeBRep_LineInter& L = myFacesIntersector->CurrentLine();
...
// purpose  :
//=======================================================================
Standard_Boolean TopOpeBRep_FacesFiller::PequalVPonR(const gp_Pnt& P3D, const Standard_Integer VPsi,
