...
public:
    ...
    Standard_EXPORT void Insert(const TopoDS_Shape& S1, const TopoDS_Shape& S2,
    ...
    //! S EXTERNAL,INTERNAL --> EXTERNAL,INTERNAL
    Standard_EXPORT void InsertIntersection(const TopoDS_Shape& S1, const TopoDS_Shape& S2,
                                            const Handle(TopOpeBRepDS_HDataStructure) & HDS,
                                            const Standard_Boolean orientFORWARD = Standard_True);
    ...
    Standard_EXPORT void Insert2d(const TopoDS_Shape& S1, const TopoDS_Shape& S2,
                                  const Handle(TopOpeBRepDS_HDataStructure) & HDS);

    //! S1, S2 set of tangent face
    //! lance les intersections 2d pour coder correctement
    //! les faces SameDomain.
    Standard_EXPORT void InsertIntersection2d(const TopoDS_Shape& S1, const TopoDS_Shape& S2,
                                              const Handle(TopOpeBRepDS_HDataStructure) & HDS);
    ...
    //! S FORWARD,REVERSED  --> FORWARD
    //! S EXTERNAL,INTERNAL --> EXTERNAL,INTERNAL
    Standard_EXPORT void Insert1d(const TopoDS_Shape& S1, const TopoDS_Shape& S2, const TopoDS_Face& F1,
                                  const TopoDS_Face& F2, const Handle(TopOpeBRepDS_HDataStructure) & HDS,
...
private:
    ...
    Standard_EXPORT Standard_Boolean ClearShapeSameDomain(const TopoDS_Shape& S1, const TopoDS_Shape& S2,
                                                          const Handle(TopOpeBRepDS_HDataStructure) & HDS);
