...
#ifdef OCCT_DEBUG
extern void FEINT_DUMPPOINTS(TopOpeBRep_FaceEdgeIntersector& FEINT, const TopOpeBRepDS_DataStructure& BDS);
#endif
...
void TopOpeBRep_FaceEdgeFiller::Insert(const TopoDS_Shape& F, const TopoDS_Shape& E,
    ...
    for (; FEINT.MorePoint(); FEINT.NextPoint()) {
        ...
        if (!isvertex) {
            ...
            // sur EE
            EPI = TopOpeBRepDS_InterferenceTool::MakeCurveInterference(TEE, TopOpeBRepDS_FACE, FFindex,
                                                                       TopOpeBRepDS_POINT, DSPindex, parE);
            ...
            // sur EE
            EPI = new TopOpeBRepDS_CurvePointInterference(TEE, TopOpeBRepDS_FACE, FFindex, TopOpeBRepDS_VERTEX, Vindex,
                                                          parE);
            StoreInterference(EPI, EIL2, BDS);
        }
...
Standard_Boolean TopOpeBRep_FaceEdgeFiller::ScanInterfList(TopOpeBRepDS_ListIteratorOfListOfInterference& IT,
...
Standard_Boolean TopOpeBRep_FaceEdgeFiller::GetGeometry(TopOpeBRepDS_ListIteratorOfListOfInterference& IT,
...
Standard_Boolean TopOpeBRep_FaceEdgeFiller::GetGeometry(const TopOpeBRepDS_ListOfInterference& L,
                                                        const TopOpeBRepDS_Point& DSP, Standard_Integer& G,
