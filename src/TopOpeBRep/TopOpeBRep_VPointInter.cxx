...
const TopoDS_Shape& TopOpeBRep_VPointInter::VertexOnS1() const {
    if (!myPPOI->IsVertexOnS1()) throw Standard_DomainError("TopOpeBRep_VPointInter::VertexOnS1");
...
const TopoDS_Shape& TopOpeBRep_VPointInter::VertexOnS2() const {
    if (!myPPOI->IsVertexOnS2()) throw Standard_DomainError("TopOpeBRep_VPointInter::VertexOnS2");
...
// purpose  :
//=======================================================================
Standard_OStream& TopOpeBRep_VPointInter::Dump(const Standard_Integer I, const TopoDS_Face& F,
...
//=======================================================================
#ifdef OCCT_DEBUG
Standard_OStream& TopOpeBRep_VPointInter::Dump(const TopoDS_Face& FF1, const TopoDS_Face& FF2,
                                               Standard_OStream& OS) const {
