...
void DsgPrs_DiameterPresentation::Add(const Handle(Prs3d_Presentation) & aPresentation,
                                      ...
                                      const DsgPrs_ArrowSide ArrowPrs, const Standard_Boolean IsDiamSymbol) {
    ...
    if (IsDiamSymbol) Text = TCollection_ExtendedString("\330  ") + aText; // VRO (2007-05-17) inserted a blank.
...
void DsgPrs_DiameterPresentation::Add(const Handle(Prs3d_Presentation) & aPresentation,
                                      const Handle(Prs3d_Drawer) & aDrawer, const TCollection_ExtendedString& aText,
                                      const gp_Pnt& AttachmentPoint, const gp_Circ& aCircle, const Standard_Real uFirst,
    ...
    // text
    TCollection_ExtendedString Text = aText;
    if (IsDiamSymbol) Text = TCollection_ExtendedString("\330 ") + Text; //  => \330 | \370?
