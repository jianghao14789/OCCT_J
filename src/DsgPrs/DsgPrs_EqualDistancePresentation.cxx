...
void DsgPrs_EqualDistancePresentation::Add(const Handle(Prs3d_Presentation) & aPresentation,
                                           const Handle(Prs3d_Drawer) & aDrawer, const gp_Pnt& Point1,
                                           const gp_Pnt& Point2, const gp_Pnt& Point3, const gp_Pnt& Point4,
    ...
    if (Dist > Precision::Confusion()) {
        ...
        if (SmallDist <= Precision::Confusion()) SmallDist = Dist;
        ...
        if (Vec1.SquareMagnitude() > Precision::Confusion() * Precision::Confusion()) {
            ...
            if (SmallDist <= Precision::Confusion()) SmallDist = Distance;
...
void DsgPrs_EqualDistancePresentation::AddInterval(const Handle(Prs3d_Presentation) & aPresentation,
                                                   const Handle(Prs3d_Drawer) & aDrawer, const gp_Pnt& aPoint1,
                                                   const gp_Pnt& aPoint2, const gp_Dir& aDirection,
                                                   const gp_Pnt& aPosition, const DsgPrs_ArrowSide anArrowSide,
                                                   gp_Pnt& aProj1, gp_Pnt& aProj2) {
...
//========================================================================
void DsgPrs_EqualDistancePresentation::AddIntervalBetweenTwoArcs(const Handle(Prs3d_Presentation) & aPresentation,
                                                                 const Handle(Prs3d_Drawer) & aDrawer,
                                                                 const gp_Circ& aCirc1, const gp_Circ& aCirc2,
                                                                 const gp_Pnt& aPoint1, const gp_Pnt& aPoint2,
                                                                 const gp_Pnt& aPoint3, const gp_Pnt& aPoint4,
    ...
    if (aPoint4.Distance(aPoint2) > Precision::Confusion()) {
        ...
        if (aPoint4.Distance(aCenter) < Precision::Confusion()) return;
