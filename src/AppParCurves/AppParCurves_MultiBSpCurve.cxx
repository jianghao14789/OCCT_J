...
// purpose  :
//=======================================================================
static Standard_Integer ComputeDegree(const TColStd_Array1OfInteger& mults, const Standard_Integer nbPoles) {
...
AppParCurves_MultiBSpCurve::AppParCurves_MultiBSpCurve() : myDegree(0) {}
...
AppParCurves_MultiBSpCurve::AppParCurves_MultiBSpCurve(const Standard_Integer NbPol)
    : AppParCurves_MultiCurve(NbPol), myDegree(0) {}
...
void AppParCurves_MultiBSpCurve::Value(const Standard_Integer CuIndex, const Standard_Real U, gp_Pnt& Pt) const {
    ...
    BSplCLib::D0(U, 0, myDegree, Standard_False, TabPoles, BSplCLib::NoWeights(), myknots->Array1(), &mymults->Array1(),
                 Pt);
}
...
void AppParCurves_MultiBSpCurve::Value(const Standard_Integer CuIndex, const Standard_Real U, gp_Pnt2d& Pt) const {
...
void AppParCurves_MultiBSpCurve::D1(const Standard_Integer CuIndex, const Standard_Real U, gp_Pnt& Pt,
                                    gp_Vec& V1) const {
    if (Dimension(CuIndex) != 3) {
        throw Standard_OutOfRange();
    }
    ...
    BSplCLib::D1(U, 0, myDegree, Standard_False, TabPoles, BSplCLib::NoWeights(), myknots->Array1(), &mymults->Array1(),
                 Pt, V1);
}
...
void AppParCurves_MultiBSpCurve::D2(const Standard_Integer CuIndex, const Standard_Real U, gp_Pnt& Pt, gp_Vec& V1,
                                    gp_Vec& V2) const {
    if (Dimension(CuIndex) != 3) {
        throw Standard_OutOfRange();
    }
    ...
    BSplCLib::D2(U, 0, myDegree, Standard_False, TabPoles, BSplCLib::NoWeights(), myknots->Array1(), &mymults->Array1(),
                 Pt, V1, V2);
}
...
void AppParCurves_MultiBSpCurve::D1(const Standard_Integer CuIndex, const Standard_Real U, gp_Pnt2d& Pt,
                                    gp_Vec2d& V1) const {
    if (Dimension(CuIndex) != 2) {
        throw Standard_OutOfRange();
    }
...
void AppParCurves_MultiBSpCurve::D2(const Standard_Integer CuIndex, const Standard_Real U, gp_Pnt2d& Pt, gp_Vec2d& V1,
                                    gp_Vec2d& V2) const {
    if (Dimension(CuIndex) != 2) {
        throw Standard_OutOfRange();
    }
