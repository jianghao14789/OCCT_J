...
public:
    ...
    Standard_EXPORT AppParCurves_MultiBSpCurve(const AppParCurves_MultiCurve& SC, const TColStd_Array1OfReal& Knots,
    ...
    Standard_EXPORT virtual void Value(const Standard_Integer CuIndex, const Standard_Real U,
