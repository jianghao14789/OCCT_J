...
void AppParCurves::BernsteinMatrix(const Standard_Integer NbPoles, const math_Vector& U, math_Matrix& A) {
...
void AppParCurves::Bernstein(const Standard_Integer NbPoles, const math_Vector& U, math_Matrix& A, math_Matrix& DA) {
...
void AppParCurves::SplineFunction(const Standard_Integer nbpoles, const Standard_Integer deg,
                                  const math_Vector& Parameters, const math_Vector& flatknots, math_Matrix& A,
                                  math_Matrix& DA, math_IntegerVector& index) {
