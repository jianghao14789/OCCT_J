...
AppParCurves_MultiPoint::AppParCurves_MultiPoint() : nbP(0), nbP2d(0) {}

AppParCurves_MultiPoint::AppParCurves_MultiPoint(const Standard_Integer NbPoles, const Standard_Integer NbPoles2d) {
    nbP = NbPoles;
    nbP2d = NbPoles2d;
    if (nbP != 0) {
...
AppParCurves_MultiPoint::AppParCurves_MultiPoint(const TColgp_Array1OfPnt& tabP, const TColgp_Array1OfPnt2d& tabP2d) {
    nbP = tabP.Length();
    nbP2d = tabP2d.Length();
...
void AppParCurves_MultiPoint::Transform(const Standard_Integer CuIndex, const Standard_Real x, const Standard_Real dx,
...
void AppParCurves_MultiPoint::Transform2d(const Standard_Integer CuIndex, const Standard_Real x, const Standard_Real dx,
...
void AppParCurves_MultiPoint::SetPoint(const Standard_Integer Index, const gp_Pnt& Point) {
    Standard_OutOfRange_Raise_if((Index <= 0) || (Index > nbP), "AppParCurves_MultiPoint::SetPoint() - wrong index");
    tabPoint->SetValue(Index, Point);
}

const gp_Pnt& AppParCurves_MultiPoint::Point(const Standard_Integer Index) const {
    Standard_OutOfRange_Raise_if((Index <= 0) || (Index > nbP), "AppParCurves_MultiPoint::Point() - wrong index");
