...
void AppParCurves_MultiCurve::SetValue(const Standard_Integer Index, const AppParCurves_MultiPoint& MPoint) {
...
void AppParCurves_MultiCurve::Curve(const Standard_Integer CuIndex, TColgp_Array1OfPnt& TabPnt) const {
    if ((CuIndex <= 0)) {
        throw Standard_OutOfRange();
    }
...
void AppParCurves_MultiCurve::Curve(const Standard_Integer CuIndex, TColgp_Array1OfPnt2d& TabPnt2d) const {
    if ((CuIndex <= 0)) {
        throw Standard_OutOfRange();
    }
    for (Standard_Integer i = 1; i <= tabPoint->Length(); i++) {
...
const gp_Pnt& AppParCurves_MultiCurve::Pole(const Standard_Integer CuIndex, const Standard_Integer Nieme) const {
...
const gp_Pnt2d& AppParCurves_MultiCurve::Pole2d(const Standard_Integer CuIndex, const Standard_Integer Nieme) const {
    if ((CuIndex <= 0) && Nieme <= 0) {
        throw Standard_OutOfRange();
    }
...
void AppParCurves_MultiCurve::Transform(const Standard_Integer CuIndex, const Standard_Real x, const Standard_Real dx,
                                        const Standard_Real y, const Standard_Real dy, const Standard_Real z,
...
void AppParCurves_MultiCurve::Transform2d(const Standard_Integer CuIndex, const Standard_Real x, const Standard_Real dx,
                                          const Standard_Real y, const Standard_Real dy) {
...
void AppParCurves_MultiCurve::Value(const Standard_Integer CuIndex, const Standard_Real U, gp_Pnt& Pt) const {
...
void AppParCurves_MultiCurve::Value(const Standard_Integer CuIndex, const Standard_Real U, gp_Pnt2d& Pt) const {
...
void AppParCurves_MultiCurve::D1(const Standard_Integer CuIndex, const Standard_Real U, gp_Pnt& Pt, gp_Vec& V1) const {
...
void AppParCurves_MultiCurve::D2(const Standard_Integer CuIndex, const Standard_Real U, gp_Pnt& Pt, gp_Vec& V1,
                                 gp_Vec& V2) const {
...
void AppParCurves_MultiCurve::D1(const Standard_Integer CuIndex, const Standard_Real U, gp_Pnt2d& Pt,
                                 gp_Vec2d& V1) const {
...
void AppParCurves_MultiCurve::D2(const Standard_Integer CuIndex, const Standard_Real U, gp_Pnt2d& Pt, gp_Vec2d& V1,
                                 gp_Vec2d& V2) const {
