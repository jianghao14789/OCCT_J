...
XmlMDataStd_UAttributeDriver::XmlMDataStd_UAttributeDriver(const Handle(Message_Messenger) & theMsgDriver)
...
// purpose  :
//=======================================================================
void XmlMDataStd_UAttributeDriver::Paste(const Handle(TDF_Attribute) & theSource, XmlObjMgt_Persistent& theTarget,
