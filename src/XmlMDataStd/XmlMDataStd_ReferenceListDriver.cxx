...
Standard_Boolean XmlMDataStd_ReferenceListDriver::Paste(const XmlObjMgt_Persistent& theSource,
    ...
    if (aLastInd > 0) {
        ...
        while (*aCurElement != anElement.getLastChild()) {
            ...
            if (anEntry.Length() > 0) TDF_Tool::Label(aReferenceList->Label().Data(), anEntry, tLab, Standard_True);
...
//=======================================================================
void XmlMDataStd_ReferenceListDriver::Paste(const Handle(TDF_Attribute) & theSource, XmlObjMgt_Persistent& theTarget,
