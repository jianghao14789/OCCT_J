...
void RWStepKinematics_RWKinematicPropertyMechanismRepresentation::ReadStep(
    ...
    theData->ReadEntity(theNum, 1, "property_definition_representation.definition", theArch,
    ...
    theData->ReadEntity(theNum, 2, "property_definition_representation.used_representation", theArch,
                        STANDARD_TYPE(StepRepr_Representation), aPropertyDefinitionRepresentation_UsedRepresentation);
    ...
    // Initialize entity
    theEnt->Init(aPropertyDefinitionRepresentation_Definition, aPropertyDefinitionRepresentation_UsedRepresentation,
                 aBase);
}
...
void RWStepKinematics_RWKinematicPropertyMechanismRepresentation::WriteStep(
    StepData_StepWriter& theSW, const Handle(StepKinematics_KinematicPropertyMechanismRepresentation) & theEnt) const {
