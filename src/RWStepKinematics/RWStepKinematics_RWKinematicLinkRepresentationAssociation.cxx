...
void RWStepKinematics_RWKinematicLinkRepresentationAssociation::ReadStep(
    ...
    if (theData->IsParamDefined(theNum, 2)) {
        theData->ReadString(theNum, 2, "representation_relationship.description", theArch,
    ...
    // Initialize entity
    theEnt->Init(aRepresentationRelationship_Name, aRepresentationRelationship_Description,
                 aRepresentationRelationship_Rep1.Representation(), aRepresentationRelationship_Rep2.Representation());
}
...
void RWStepKinematics_RWKinematicLinkRepresentationAssociation::WriteStep(
    StepData_StepWriter& theSW, const Handle(StepKinematics_KinematicLinkRepresentationAssociation) & theEnt) const {
