...
void RWStepKinematics_RWPlanarPairWithRange::ReadStep(const Handle(StepData_StepReaderData) & theData,
    ...
    theEnt->Init(aRepresentationItem_Name, aItemDefinedTransformation_Name, hasItemDefinedTransformation_Description,
                 ...
                 aLowOrderKinematicPair_RY, aLowOrderKinematicPair_RZ, hasLowerLimitActualRotation,
                 aLowerLimitActualRotation, hasUpperLimitActualRotation, aUpperLimitActualRotation,
                 hasLowerLimitActualTranslationX, aLowerLimitActualTranslationX, hasUpperLimitActualTranslationX,
                 aUpperLimitActualTranslationX, hasLowerLimitActualTranslationY, aLowerLimitActualTranslationY,
                 hasUpperLimitActualTranslationY, aUpperLimitActualTranslationY);
}
...
void RWStepKinematics_RWPlanarPairWithRange::WriteStep(StepData_StepWriter& theSW,
                                                       const Handle(StepKinematics_PlanarPairWithRange) &
                                                           theEnt) const {
