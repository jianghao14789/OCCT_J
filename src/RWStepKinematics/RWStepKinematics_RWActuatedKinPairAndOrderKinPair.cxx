...
void RWStepKinematics_RWActuatedKinPairAndOrderKinPair::ReadStep(
    const Handle(StepData_StepReaderData) & theData, const Standard_Integer num0, Handle(Interface_Check) & theArch,
    ...
    Handle(StepKinematics_ActuatedKinematicPair) anActuatedKinematicPair = new StepKinematics_ActuatedKinematicPair;
    ...
    if (theData->IsParamDefined(theNum, 2)) {
        theData->ReadString(theNum, 2, "item_defined_transformation.description", theArch,
    ...
    theData->ReadEntity(theNum, 3, "ITEM_DEFINED_TRANSFORMATION", theArch, STANDARD_TYPE(StepRepr_RepresentationItem),
                        aItemDefinedTransformation_TransformItem1);

    Handle(StepRepr_RepresentationItem) aItemDefinedTransformation_TransformItem2;
    theData->ReadEntity(theNum, 4, "ITEM_DEFINED_TRANSFORMATION", theArch, STANDARD_TYPE(StepRepr_RepresentationItem),
    ...
    theData->ReadEntity(theNum, 1, "kinematic_pair.joint", theArch, STANDARD_TYPE(StepKinematics_KinematicJoint),
    ...
    if (!strcmp(aPairSuperType, "LOW_ORDER_KINEMATIC_PAIR")) {
        ...
        aKinematicPair->Init(aRepresentationItem_Name, aItemDefinedTransformation_Name,
                             hasItemDefinedTransformation_Description, aItemDefinedTransformation_Description,
                             aItemDefinedTransformation_TransformItem1, aItemDefinedTransformation_TransformItem2,
                             aKinematicPair_Joint);
        theNum = theData->NextForComplex(theNum);
        ...
        if (!strcmp(aPairtype, "REVOLUTE_PAIR")) {
            ...
            if (theData->NamedForComplex("REVOLUTE_PAIR_WITH_RANGE", "RPWR", num0, theNum, theArch)) {
                if (theData->CheckNbParams(theNum, 2, theArch, "REVOLUTE_PAIR_WITH_RANGE")) {
                    ...
                    aLocalPair->Init(aRepresentationItem_Name, aItemDefinedTransformation_Name,
                                     hasItemDefinedTransformation_Description, aItemDefinedTransformation_Description,
                                     aItemDefinedTransformation_TransformItem1,
                                     aItemDefinedTransformation_TransformItem2, aKinematicPair_Joint,
                                     aLowOrderKinematicPair_TX, aLowOrderKinematicPair_TY, aLowOrderKinematicPair_TZ,
                                     aLowOrderKinematicPair_RX, aLowOrderKinematicPair_RY, aLowOrderKinematicPair_RZ,
                                     hasLowerLimitActualRotation, aLowerLimitActualRotation,
                                     hasUpperLimitActualRotation, aUpperLimitActualRotation);
            ...
            if (theData->NamedForComplex("CYLINDRICAL_PAIR_WITH_RANGE", "CPW0", num0, theNum, theArch)) {
                if (theData->CheckNbParams(theNum, 4, theArch, "CYLINDRICAL_PAIR_WITH_RANGE")) {
                    ...
                    if (theData->IsParamDefined(theNum, 1)) {
                        theData->ReadReal(theNum, 1, "lower_limit_actual_translation", theArch,
                    ...
                    if (theData->IsParamDefined(theNum, 2)) {
                        theData->ReadReal(theNum, 2, "upper_limit_actual_translation", theArch,
                    ...
                    // Initialize kinematic_pair
                    aLocalPair->Init(
                        aRepresentationItem_Name, aItemDefinedTransformation_Name,
                        hasItemDefinedTransformation_Description, aItemDefinedTransformation_Description,
                        aItemDefinedTransformation_TransformItem1, aItemDefinedTransformation_TransformItem2,
                        aKinematicPair_Joint, aLowOrderKinematicPair_TX, aLowOrderKinematicPair_TY,
                        aLowOrderKinematicPair_TZ, aLowOrderKinematicPair_RX, aLowOrderKinematicPair_RY,
                        aLowOrderKinematicPair_RZ, hasLowerLimitActualTranslation, aLowerLimitActualTranslation,
                        hasUpperLimitActualTranslation, aUpperLimitActualTranslation, hasLowerLimitActualRotation,
                        aLowerLimitActualRotation, hasUpperLimitActualRotation, aUpperLimitActualRotation);
            ...
            if (theData->NamedForComplex("SPHERICAL_PAIR_WITH_RANGE", "SPW0", num0, theNum, theArch)) {
                if (theData->CheckNbParams(theNum, 6, theArch, "SPHERICAL_PAIR_WITH_RANGE")) {
                    ...
                    aLocalPair->Init(aRepresentationItem_Name, aItemDefinedTransformation_Name,
                                     ...
                                     aLowOrderKinematicPair_TX, aLowOrderKinematicPair_TY, aLowOrderKinematicPair_TZ,
                                     aLowOrderKinematicPair_RX, aLowOrderKinematicPair_RY, aLowOrderKinematicPair_RZ,
                                     hasLowerLimitYaw, aLowerLimitYaw, hasUpperLimitYaw, aUpperLimitYaw,
                                     hasLowerLimitPitch, aLowerLimitPitch, hasUpperLimitPitch, aUpperLimitPitch,
                                     hasLowerLimitRoll, aLowerLimitRoll, hasUpperLimitRoll, aUpperLimitRoll);
            ...
            if (theData->NamedForComplex("PRISMATIC_PAIR_WITH_RANGE", "PPW0", num0, theNum, theArch)) {
                if (theData->CheckNbParams(theNum, 2, theArch, "PRISMATIC_PAIR_WITH_RANGE")) {
                    ...
                    aLocalPair->Init(aRepresentationItem_Name, aItemDefinedTransformation_Name,
                                     ...
                                     aLowOrderKinematicPair_TX, aLowOrderKinematicPair_TY, aLowOrderKinematicPair_TZ,
                                     aLowOrderKinematicPair_RX, aLowOrderKinematicPair_RY, aLowOrderKinematicPair_RZ,
                                     hasLowerLimitActualTranslation, aLowerLimitActualTranslation,
                                     hasUpperLimitActualTranslation, aUpperLimitActualTranslation);
            ...
            if (theData->NamedForComplex("UNIVERSAL_PAIR_WITH_RANGE", "UPWR", num0, theNum, theArch)) {
                if (theData->CheckNbParams(theNum, 4, theArch, "UNIVERSAL_PAIR_WITH_RANGE")) {
                    ...
                    aLocalPair->Init(aRepresentationItem_Name, aItemDefinedTransformation_Name,
                                     ...
                                     aLowOrderKinematicPair_TX, aLowOrderKinematicPair_TY, aLowOrderKinematicPair_TZ,
                                     aLowOrderKinematicPair_RX, aLowOrderKinematicPair_RY, aLowOrderKinematicPair_RZ,
                                     hasInputSkewAngle, aInputSkewAngle, hasLowerLimitFirstRotation,
                                     aLowerLimitFirstRotation, hasUpperLimitFirstRotation, aUpperLimitFirstRotation,
                                     hasLowerLimitSecondRotation, aLowerLimitSecondRotation,
                                     hasUpperLimitSecondRotation, aUpperLimitSecondRotation);
                } else // universal_pair_with_range hasn't params
                {
                    ...
                    aLocalPair->Init(aRepresentationItem_Name, aItemDefinedTransformation_Name,
                                     ...
                                     aLowOrderKinematicPair_TX, aLowOrderKinematicPair_TY, aLowOrderKinematicPair_TZ,
                                     aLowOrderKinematicPair_RX, aLowOrderKinematicPair_RY, aLowOrderKinematicPair_RZ,
                                     hasInputSkewAngle, aInputSkewAngle);
                }
            }
            ...
            if (theData->NamedForComplex("PLANAR_PAIR_WITH_RANGE", "PPWR", num0, theNum, theArch)) {
                if (theData->CheckNbParams(theNum, 6, theArch, "UNIVERSAL_PAIR_WITH_RANGE")) {
                    ...
                    if (theData->IsParamDefined(theNum, 3)) {
                        theData->ReadReal(theNum, 3, "lower_limit_actual_translation_x", theArch,
                    ...
                    if (theData->IsParamDefined(theNum, 4)) {
                        theData->ReadReal(theNum, 4, "upper_limit_actual_translation_x", theArch,
                    ...
                    if (theData->IsParamDefined(theNum, 5)) {
                        theData->ReadReal(theNum, 5, "lower_limit_actual_translation_y", theArch,
                    ...
                    if (theData->IsParamDefined(theNum, 6)) {
                        theData->ReadReal(theNum, 6, "upper_limit_actual_translation_y", theArch,
                    ...
                    aLocalPair->Init(
                        ...
                        aKinematicPair_Joint, aLowOrderKinematicPair_TX, aLowOrderKinematicPair_TY,
                        aLowOrderKinematicPair_TZ, aLowOrderKinematicPair_RX, aLowOrderKinematicPair_RY,
                        aLowOrderKinematicPair_RZ, hasLowerLimitActualRotation, aLowerLimitActualRotation,
                        hasUpperLimitActualRotation, aUpperLimitActualRotation, hasLowerLimitActualTranslationX,
                        aLowerLimitActualTranslationX, hasUpperLimitActualTranslationX, aUpperLimitActualTranslationX,
                        hasLowerLimitActualTranslationY, aLowerLimitActualTranslationY, hasUpperLimitActualTranslationY,
                        aUpperLimitActualTranslationY);
                } else // universal_pair_with_range hasn't params
                {
        ...
        if (!strcmp(aPairtype, "GEAR_PAIR")) {
            ...
            if (theData->NamedForComplex("GEAR_PAIR_WITH_RANGE", "GPWR", num0, theNum, theArch)) {
                if (theData->CheckNbParams(theNum, 2, theArch, "GEAR_PAIR_WITH_RANGE")) {
                    ...
                    if (theData->IsParamDefined(theNum, 1)) {
                        theData->ReadReal(theNum, 1, "lower_limit_actual_rotation1", theArch,
                    ...
                    if (theData->IsParamDefined(theNum, 2)) {
                        theData->ReadReal(theNum, 2, "upper_limit_actual_rotation1", theArch,
                    ...
                    aLocalPair->Init(
                        ...
                        hasItemDefinedTransformation_Description, aItemDefinedTransformation_Description,
                        aItemDefinedTransformation_TransformItem1, aItemDefinedTransformation_TransformItem2,
                        aKinematicPair_Joint, aGearPair_RadiusFirstLink, aGearPair_RadiusSecondLink, aGearPair_Bevel,
                        aGearPair_HelicalAngle, aGearPair_GearRatio, hasLowerLimitActualRotation1,
                        aLowerLimitActualRotation1, hasUpperLimitActualRotation1, aUpperLimitActualRotation1);
                ...
                } else // StepKinematics_GearPairWithRange hasn't params
                {
                    ...
                    aLocalPair->Init(aRepresentationItem_Name, aItemDefinedTransformation_Name,
                                     ...
                                     aItemDefinedTransformation_TransformItem1,
                                     aItemDefinedTransformation_TransformItem2, aKinematicPair_Joint,
                                     aGearPair_RadiusFirstLink, aGearPair_RadiusSecondLink, aGearPair_Bevel,
                                     aGearPair_HelicalAngle, aGearPair_GearRatio);
                }
            }
            ...
            theData->ReadReal(theNum, 1, "rack_and_pinion_pair.pinion_radius", theArch,
            ...
            if (theData->NamedForComplex("RACK_AND_PINION_PAIR_WITH_RANGE", "RAPPWR", num0, theNum, theArch)) {
                if (theData->CheckNbParams(theNum, 2, theArch, "RACK_AND_PINION_PAIR_WITH_RANGE")) {
                    ...
                    if (theData->IsParamDefined(theNum, 1)) {
                        theData->ReadReal(theNum, 1, "lower_limit_rack_displacement", theArch,
                    ...
                    if (theData->IsParamDefined(theNum, 2)) {
                        theData->ReadReal(theNum, 2, "upper_limit_rack_displacement", theArch,
                    ...
                    aLocalPair->Init(
                        ...
                        hasItemDefinedTransformation_Description, aItemDefinedTransformation_Description,
                        aItemDefinedTransformation_TransformItem1, aItemDefinedTransformation_TransformItem2,
                        aKinematicPair_Joint, aRackAndPinionPair_PinionRadius, hasLowerLimitRackDisplacement,
                        aLowerLimitRackDisplacement, hasUpperLimitRackDisplacement, aUpperLimitRackDisplacement);
            ...
            if (theData->NamedForComplex("SCREW_PAIR_WITH_RANGE", "SPWR", num0, theNum, theArch)) {
                if (theData->CheckNbParams(theNum, 2, theArch, "SCREW_PAIR_WITH_RANGE")) {
                    ...
                    aLocalPair->Init(aRepresentationItem_Name, aItemDefinedTransformation_Name,
                                     hasItemDefinedTransformation_Description, aItemDefinedTransformation_Description,
                                     aItemDefinedTransformation_TransformItem1,
                                     aItemDefinedTransformation_TransformItem2, aKinematicPair_Joint, aScrewPair_Pitch,
                                     hasLowerLimitActualRotation, aLowerLimitActualRotation,
                                     hasUpperLimitActualRotation, aUpperLimitActualRotation);
    ...
    } else // "HIGH_ORDER_KINEMATIC_PAIR"
    {
        ...
        if (!strcmp(aPairtype, "POINT_ON_PLANAR_CURVE_PAIR")) {
            ...
            theData->ReadEntity(theNum, 1, "point_on_planar_curve_pair.pair_curve", theArch,
                                STANDARD_TYPE(StepGeom_Curve), aPointOnPlanarCurvePair_PairCurve);

            Standard_Boolean aPointOnPlanarCurvePair_Orientation;
            theData->ReadBoolean(theNum, 2, "point_on_planar_curve_pair.orientation", theArch,
            ...
            if (theData->NamedForComplex("POINT_ON_PLANAR_CURVE_PAIR_WITH_RANGE", "POPCPW", num0, theNum, theArch)) {
                if (theData->CheckNbParams(theNum, 7, theArch, "POINT_ON_PLANAR_CURVE_PAIR_WITH_RANGE")) {
                    ...
                    theData->ReadEntity(theNum, 1, "range_on_pair_curve", theArch, STANDARD_TYPE(StepGeom_TrimmedCurve),
                                        aRangeOnPairCurve);
                    ...
                    aLocalPair->Init(
                        ...
                        hasItemDefinedTransformation_Description, aItemDefinedTransformation_Description,
                        aItemDefinedTransformation_TransformItem1, aItemDefinedTransformation_TransformItem2,
                        aKinematicPair_Joint, aPointOnPlanarCurvePair_PairCurve, aPointOnPlanarCurvePair_Orientation,
                        aRangeOnPairCurve, hasLowerLimitYaw, aLowerLimitYaw, hasUpperLimitYaw, aUpperLimitYaw,
                        hasLowerLimitPitch, aLowerLimitPitch, hasUpperLimitPitch, aUpperLimitPitch, hasLowerLimitRoll,
                        aLowerLimitRoll, hasUpperLimitRoll, aUpperLimitRoll);
            ...
            theData->ReadEntity(theNum, 1, "point_on_surface_pair.pair_surface", theArch,
                                STANDARD_TYPE(StepGeom_Surface), aPointOnSurfacePair_PairSurface);
            ...
            if (theData->NamedForComplex("POINT_ON_SURFACE_PAIR_WITH_RANGE ", "RAPPWR", num0, theNum, theArch)) {
                if (theData->CheckNbParams(theNum, 2, theArch, "POINT_ON_SURFACE_PAIR_WITH_RANGE ")) {
                    ...
                    theData->ReadEntity(theNum, 1, "range_on_pair_surface", theArch,
                                        STANDARD_TYPE(StepGeom_RectangularTrimmedSurface), aRangeOnPairSurface);
                    ...
                    aLocalPair->Init(aRepresentationItem_Name, aItemDefinedTransformation_Name,
                                     ...
                                     aItemDefinedTransformation_TransformItem1,
                                     aItemDefinedTransformation_TransformItem2, aKinematicPair_Joint,
                                     aPointOnSurfacePair_PairSurface, aRangeOnPairSurface, hasLowerLimitYaw,
                                     aLowerLimitYaw, hasUpperLimitYaw, aUpperLimitYaw, hasLowerLimitPitch,
                                     aLowerLimitPitch, hasUpperLimitPitch, aUpperLimitPitch, hasLowerLimitRoll,
                                     aLowerLimitRoll, hasUpperLimitRoll, aUpperLimitRoll);
            ...
            theData->ReadEntity(theNum, 1, "planar_curve_pair.curve1", theArch, STANDARD_TYPE(StepGeom_Curve),
                                aPlanarCurvePair_Curve1);

            Handle(StepGeom_Curve) aPlanarCurvePair_Curve2;
            theData->ReadEntity(theNum, 2, "planar_curve_pair.curve2", theArch, STANDARD_TYPE(StepGeom_Curve),
            ...
            if (theData->NamedForComplex("PLANAR_CURVE_PAIR_RANGE", "PCPR", num0, theNum, theArch)) {
                if (theData->CheckNbParams(theNum, 2, theArch, "PLANAR_CURVE_PAIR_RANGE")) {
                    ...
                    theData->ReadEntity(theNum, 1, "range_on_curve1", theArch, STANDARD_TYPE(StepGeom_TrimmedCurve),
                                        aRangeOnCurve1);

                    Handle(StepGeom_TrimmedCurve) aRangeOnCurve2;
                    theData->ReadEntity(theNum, 2, "range_on_curve2", theArch, STANDARD_TYPE(StepGeom_TrimmedCurve),
                                        aRangeOnCurve2);
                    ...
                    aLocalPair->Init(aRepresentationItem_Name, aItemDefinedTransformation_Name,
                                     ...
                                     aItemDefinedTransformation_TransformItem1,
                                     aItemDefinedTransformation_TransformItem2, aKinematicPair_Joint,
                                     aPlanarCurvePair_Curve1, aPlanarCurvePair_Curve2, aPlanarCurvePair_Orientation,
                                     aRangeOnCurve1, aRangeOnCurve2);
                } else // StepKinematics_ScrewPairWithRange hasn't params
                {
            ...
            theData->ReadEntity(theNum, 1, "surface_pair.surface1", theArch, STANDARD_TYPE(StepGeom_Surface),
                                aSurfacePair_Surface1);

            Handle(StepGeom_Surface) aSurfacePair_Surface2;
            theData->ReadEntity(theNum, 2, "surface_pair.surface2", theArch, STANDARD_TYPE(StepGeom_Surface),
            ...
            if (theData->NamedForComplex("SURFACE_PAIR_WITH_RANGE", "SPW1", num0, theNum, theArch)) {
                if (theData->CheckNbParams(theNum, 4, theArch, "SURFACE_PAIR_WITH_RANGE")) {
                    ...
                    theData->ReadEntity(theNum, 1, "range_on_surface1", theArch,
                                        STANDARD_TYPE(StepGeom_RectangularTrimmedSurface), aRangeOnSurface1);

                    Handle(StepGeom_RectangularTrimmedSurface) aRangeOnSurface2;
                    theData->ReadEntity(theNum, 2, "range_on_surface2", theArch,
                                        STANDARD_TYPE(StepGeom_RectangularTrimmedSurface), aRangeOnSurface2);
                    ...
                    aLocalPair->Init(aRepresentationItem_Name, aItemDefinedTransformation_Name,
                                     ...
                                     aItemDefinedTransformation_TransformItem1,
                                     aItemDefinedTransformation_TransformItem2, aKinematicPair_Joint,
                                     aSurfacePair_Surface1, aSurfacePair_Surface2, aSurfacePair_Orientation,
                                     aRangeOnSurface1, aRangeOnSurface2, hasLowerLimitActualRotation,
                                     aLowerLimitActualRotation, hasUpperLimitActualRotation, aUpperLimitActualRotation);
    ...
    anActuatedKinematicPair->Init(aRepresentationItem_Name, aItemDefinedTransformation_Name,
                                  hasItemDefinedTransformation_Description, aItemDefinedTransformation_Description,
                                  aItemDefinedTransformation_TransformItem1, aItemDefinedTransformation_TransformItem2,
                                  aKinematicPair_Joint, hasTX, aTX, hasTY, aTY, hasTZ, aTZ, hasRX, aRX, hasRY, aRY,
                                  hasRZ, aRZ);

    // Initialize kinematic_pair
    aKinematicPair->SetName(aRepresentationItem_Name);
    // Initialize entity
    theEnt->Init(aRepresentationItem_Name, aItemDefinedTransformation_Name, hasItemDefinedTransformation_Description,
                 aItemDefinedTransformation_Description, aItemDefinedTransformation_TransformItem1,
                 aItemDefinedTransformation_TransformItem2, aKinematicPair_Joint, anActuatedKinematicPair,
                 aKinematicPair);
}
...
void RWStepKinematics_RWActuatedKinPairAndOrderKinPair::WriteStep(
    StepData_StepWriter& theSW, const Handle(StepKinematics_ActuatedKinPairAndOrderKinPair) & theEnt) const {
        ...
        if (theEnt->GetOrderKinematicPair()->IsKind(STANDARD_TYPE(StepKinematics_RevolutePair))) {
            ...
            if (theEnt->GetOrderKinematicPair()->IsKind(STANDARD_TYPE(StepKinematics_CylindricalPairWithRange))) {
                Handle(StepKinematics_CylindricalPairWithRange) aCylindricalPairWithRange =
                    Handle(StepKinematics_CylindricalPairWithRange)::DownCast(theEnt->GetOrderKinematicPair());
            ...
            if (theEnt->GetOrderKinematicPair()->IsKind(STANDARD_TYPE(StepKinematics_SphericalPairWithPinAndRange))) {
                Handle(StepKinematics_SphericalPairWithPinAndRange) aSphericalPairWithPinAndRange =
                    Handle(StepKinematics_SphericalPairWithPinAndRange)::DownCast(theEnt->GetOrderKinematicPair());
        ...
        if (theEnt->GetOrderKinematicPair()->IsKind(STANDARD_TYPE(StepKinematics_GearPair))) {
            ...
            if (theEnt->GetOrderKinematicPair()->IsKind(STANDARD_TYPE(StepKinematics_RackAndPinionPairWithRange))) {
                Handle(StepKinematics_RackAndPinionPairWithRange) aRackAndPinionPairWithRange =
                    Handle(StepKinematics_RackAndPinionPairWithRange)::DownCast(theEnt->GetOrderKinematicPair());
        ...
        if (theEnt->GetOrderKinematicPair()->IsKind(STANDARD_TYPE(StepKinematics_ScrewPair))) {
            ...
            if (theEnt->GetOrderKinematicPair()->IsKind(
                ...
                Handle(StepKinematics_PointOnPlanarCurvePairWithRange) aPointOnPlanarCurvePairWithRange =
                    Handle(StepKinematics_PointOnPlanarCurvePairWithRange)::DownCast(theEnt->GetOrderKinematicPair());
                // Own fields of PointOnPlanarCurvePairWithRange
            ...
            if (theEnt->GetOrderKinematicPair()->IsKind(STANDARD_TYPE(StepKinematics_PointOnSurfacePairWithRange))) {
                Handle(StepKinematics_PointOnSurfacePairWithRange) aPointOnSurfacePairWithRange =
                    Handle(StepKinematics_PointOnSurfacePairWithRange)::DownCast(theEnt->GetOrderKinematicPair());
                // Own fields of PointOnSurfacePairWithRange
...
void RWStepKinematics_RWActuatedKinPairAndOrderKinPair::Share(
    const Handle(StepKinematics_ActuatedKinPairAndOrderKinPair) & theEnt, Interface_EntityIterator& iter) const {
