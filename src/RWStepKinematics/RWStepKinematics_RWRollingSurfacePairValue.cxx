...
void RWStepKinematics_RWRollingSurfacePairValue::ReadStep(const Handle(StepData_StepReaderData) & theData,
                                                          ...
                                                          const Handle(StepKinematics_RollingSurfacePairValue) &
                                                              theEnt) const {
    ...
    // Initialize entity
    theEnt->Init(aRepresentationItem_Name, aPairValue_AppliesToPair, aActualPointOnSurface, aActualRotation);
}
