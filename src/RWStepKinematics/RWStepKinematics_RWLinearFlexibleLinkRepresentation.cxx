...
void RWStepKinematics_RWLinearFlexibleLinkRepresentation::ReadStep(
    ...
    theData->ReadEntity(theNum, 4, "kinematic_link_representation.represented_link", theArch,
                        STANDARD_TYPE(StepKinematics_KinematicLink), aKinematicLinkRepresentation_RepresentedLink);
...
void RWStepKinematics_RWLinearFlexibleLinkRepresentation::WriteStep(
    StepData_StepWriter& theSW, const Handle(StepKinematics_LinearFlexibleLinkRepresentation) & theEnt) const {
...
void RWStepKinematics_RWLinearFlexibleLinkRepresentation::Share(
    const Handle(StepKinematics_LinearFlexibleLinkRepresentation) & theEnt, Interface_EntityIterator& iter) const {
