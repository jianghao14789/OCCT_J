...
void RWStepKinematics_RWProductDefinitionKinematics::ReadStep(const Handle(StepData_StepReaderData) & theData,
                                                              ...
                                                              const Handle(StepKinematics_ProductDefinitionKinematics) &
                                                                  theEnt) const {
    ...
    // Initialize entity
    theEnt->Init(aPropertyDefinition_Name, hasPropertyDefinition_Description, aPropertyDefinition_Description,
...
void RWStepKinematics_RWProductDefinitionKinematics::WriteStep(
    StepData_StepWriter& theSW, const Handle(StepKinematics_ProductDefinitionKinematics) & theEnt) const {
...
// purpose  :
//=======================================================================
void RWStepKinematics_RWProductDefinitionKinematics::Share(const Handle(StepKinematics_ProductDefinitionKinematics) &
                                                               theEnt,
