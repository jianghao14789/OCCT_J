...
void RWStepKinematics_RWLowOrderKinematicPairValue::ReadStep(const Handle(StepData_StepReaderData) & theData,
                                                             ...
                                                             const Handle(StepKinematics_LowOrderKinematicPairValue) &
                                                                 theEnt) const {
    ...
    // Initialize entity
    theEnt->Init(aRepresentationItem_Name, aPairValue_AppliesToPair, aActualTranslationX, aActualTranslationY,
                 aActualTranslationZ, aActualRotationX, aActualRotationY, aActualRotationZ);
}
...
// purpose  :
//=======================================================================
void RWStepKinematics_RWLowOrderKinematicPairValue::Share(const Handle(StepKinematics_LowOrderKinematicPairValue) &
                                                              theEnt,
