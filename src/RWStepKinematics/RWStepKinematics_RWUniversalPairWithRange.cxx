...
void RWStepKinematics_RWUniversalPairWithRange::ReadStep(const Handle(StepData_StepReaderData) & theData,
                                                         ...
                                                         const Handle(StepKinematics_UniversalPairWithRange) &
                                                             theEnt) const {
    ...
    theEnt->Init(aRepresentationItem_Name, aItemDefinedTransformation_Name, hasItemDefinedTransformation_Description,
                 ...
                 aLowOrderKinematicPair_RY, aLowOrderKinematicPair_RZ, hasUniversalPair_InputSkewAngle,
                 aUniversalPair_InputSkewAngle, hasLowerLimitFirstRotation, aLowerLimitFirstRotation,
                 hasUpperLimitFirstRotation, aUpperLimitFirstRotation, hasLowerLimitSecondRotation,
                 aLowerLimitSecondRotation, hasUpperLimitSecondRotation, aUpperLimitSecondRotation);
}
