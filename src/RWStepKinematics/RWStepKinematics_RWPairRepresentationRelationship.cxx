...
void RWStepKinematics_RWPairRepresentationRelationship::ReadStep(
    ...
    if (theData->IsParamDefined(theNum, 3)) {
        theData->ReadString(theNum, 3, "representation_relationship.description", theArch,
    ...
    theData->ReadEntity(theNum, 6, "representation_relationship_with_transformation.transformation_operator", theArch,
                        aRepresentationRelationshipWithTransformation_TransformationOperator);

    // Initialize entity
    theEnt->Init(aRepresentationItem_Name, aRepresentationRelationship_Name, hasRepresentationRelationship_Description,
                 aRepresentationRelationship_Description, aRepresentationRelationship_Rep1,
...
void RWStepKinematics_RWPairRepresentationRelationship::WriteStep(
    StepData_StepWriter& theSW, const Handle(StepKinematics_PairRepresentationRelationship) & theEnt) const {
...
void RWStepKinematics_RWPairRepresentationRelationship::Share(
    const Handle(StepKinematics_PairRepresentationRelationship) & theEnt, Interface_EntityIterator& iter) const {
