...
void RWStepKinematics_RWLowOrderKinematicPairWithRange::ReadStep(
    const Handle(StepData_StepReaderData) & theData, const Standard_Integer theNum, Handle(Interface_Check) & theArch,
    ...
    if (theData->IsParamDefined(theNum, 3)) {
        theData->ReadString(theNum, 3, "item_defined_transformation.description", theArch,
    ...
    theData->ReadEntity(theNum, 4, "item_defined_transformation.transform_item1", theArch,
                        STANDARD_TYPE(StepRepr_RepresentationItem), aItemDefinedTransformation_TransformItem1);

    Handle(StepRepr_RepresentationItem) aItemDefinedTransformation_TransformItem2;
    theData->ReadEntity(theNum, 5, "item_defined_transformation.transform_item2", theArch,
                        STANDARD_TYPE(StepRepr_RepresentationItem), aItemDefinedTransformation_TransformItem2);

    // Inherited fields of KinematicPair

    Handle(StepKinematics_KinematicJoint) aKinematicPair_Joint;
    theData->ReadEntity(theNum, 6, "kinematic_pair.joint", theArch, STANDARD_TYPE(StepKinematics_KinematicJoint),
    ...
    theEnt->Init(aRepresentationItem_Name, aItemDefinedTransformation_Name, hasItemDefinedTransformation_Description,
                 ...
                 aItemDefinedTransformation_TransformItem2, aKinematicPair_Joint, aLowOrderKinematicPair_TX,
                 aLowOrderKinematicPair_TY, aLowOrderKinematicPair_TZ, aLowOrderKinematicPair_RX,
                 aLowOrderKinematicPair_RY, aLowOrderKinematicPair_RZ, hasLowerLimitActualRotationX,
                 aLowerLimitActualRotationX, hasUpperLimitActualRotationX, aUpperLimitActualRotationX,
                 hasLowerLimitActualRotationY, aLowerLimitActualRotationY, hasUpperLimitActualRotationY,
                 aUpperLimitActualRotationY, hasLowerLimitActualRotationZ, aLowerLimitActualRotationZ,
                 hasUpperLimitActualRotationZ, aUpperLimitActualRotationZ, hasLowerLimitActualTranslationX,
                 ...
                 aUpperLimitActualTranslationY, hasLowerLimitActualTranslationZ, aLowerLimitActualTranslationZ,
                 hasUpperLimitActualTranslationZ, aUpperLimitActualTranslationZ);
}
...
void RWStepKinematics_RWLowOrderKinematicPairWithRange::WriteStep(
    StepData_StepWriter& theSW, const Handle(StepKinematics_LowOrderKinematicPairWithRange) & theEnt) const {
...
void RWStepKinematics_RWLowOrderKinematicPairWithRange::Share(
    const Handle(StepKinematics_LowOrderKinematicPairWithRange) & theEnt, Interface_EntityIterator& iter) const {
