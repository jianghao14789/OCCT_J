...
void RWStepKinematics_RWLinearFlexibleAndPinionPair::ReadStep(const Handle(StepData_StepReaderData) & theData,
                                                              ...
                                                              const Handle(StepKinematics_LinearFlexibleAndPinionPair) &
                                                                  theEnt) const {
    ...
    theEnt->Init(aRepresentationItem_Name, aItemDefinedTransformation_Name, hasItemDefinedTransformation_Description,
                 ...
                 aItemDefinedTransformation_TransformItem2, aKinematicPair_Joint, aPinionRadius);
}
...
void RWStepKinematics_RWLinearFlexibleAndPinionPair::WriteStep(
    StepData_StepWriter& theSW, const Handle(StepKinematics_LinearFlexibleAndPinionPair) & theEnt) const {
...
// purpose  :
//=======================================================================
void RWStepKinematics_RWLinearFlexibleAndPinionPair::Share(const Handle(StepKinematics_LinearFlexibleAndPinionPair) &
                                                               theEnt,
