...
void RWStepKinematics_RWCylindricalPairWithRange::ReadStep(const Handle(StepData_StepReaderData) & theData,
                                                           ...
                                                           const Handle(StepKinematics_CylindricalPairWithRange) &
                                                               theEnt) const {
    ...
    theEnt->Init(aRepresentationItem_Name, aItemDefinedTransformation_Name, hasItemDefinedTransformation_Description,
                 ...
                 aLowOrderKinematicPair_RY, aLowOrderKinematicPair_RZ, hasLowerLimitActualTranslation,
                 aLowerLimitActualTranslation, hasUpperLimitActualTranslation, aUpperLimitActualTranslation,
