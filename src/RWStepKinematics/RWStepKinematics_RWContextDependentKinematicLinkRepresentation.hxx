...
public:
    ...
    Standard_EXPORT void ReadStep(const Handle(StepData_StepReaderData) & theData, const Standard_Integer theNum,
                                  ...
                                  const Handle(StepKinematics_ContextDependentKinematicLinkRepresentation) &
                                      theEnt) const;
    ...
    Standard_EXPORT void Share(const Handle(StepKinematics_ContextDependentKinematicLinkRepresentation) & theEnt,
