...
void RWStepKinematics_RWContextDependentKinematicLinkRepresentation::ReadStep(
    ...
    theData->ReadEntity(theNum, 1, "representation_relation", theArch,
                        STANDARD_TYPE(StepKinematics_KinematicLinkRepresentationAssociation), aRepresentationRelation);

    Handle(StepKinematics_ProductDefinitionRelationshipKinematics) aRepresentedProductRelation;
    theData->ReadEntity(theNum, 2, "represented_product_relation", theArch,
