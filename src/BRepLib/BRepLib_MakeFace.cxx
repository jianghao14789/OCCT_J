...
// purpose  :
//=======================================================================
BRepLib_MakeFace::BRepLib_MakeFace() : myError(BRepLib_NoFace) {}
...
BRepLib_MakeFace::BRepLib_MakeFace(const gp_Pln& P, const Standard_Real UMin, const Standard_Real UMax,
...
BRepLib_MakeFace::BRepLib_MakeFace(const gp_Cylinder& C, const Standard_Real UMin, const Standard_Real UMax,
                                   const Standard_Real VMin, const Standard_Real VMax) {
    Handle(Geom_CylindricalSurface) GC = new Geom_CylindricalSurface(C);
...
BRepLib_MakeFace::BRepLib_MakeFace(const gp_Cone& C, const Standard_Real UMin, const Standard_Real UMax,
                                   const Standard_Real VMin, const Standard_Real VMax) {
    Handle(Geom_ConicalSurface) GC = new Geom_ConicalSurface(C);
    Init(GC, UMin, UMax, VMin, VMax, Precision::Confusion());
}
...
BRepLib_MakeFace::BRepLib_MakeFace(const gp_Sphere& S, const Standard_Real UMin, const Standard_Real UMax,
                                   const Standard_Real VMin, const Standard_Real VMax) {
    Handle(Geom_SphericalSurface) GS = new Geom_SphericalSurface(S);
...
BRepLib_MakeFace::BRepLib_MakeFace(const gp_Torus& T, const Standard_Real UMin, const Standard_Real UMax,
                                   const Standard_Real VMin, const Standard_Real VMax) {
    Handle(Geom_ToroidalSurface) GT = new Geom_ToroidalSurface(T);
...
BRepLib_MakeFace::BRepLib_MakeFace(const Handle(Geom_Surface) & S, const Standard_Real UMin, const Standard_Real UMax,
...

{
    ...
    //
    if (BRep_Tool::IsClosed(W)) CheckInside();
}
...
BRepLib_MakeFace::BRepLib_MakeFace(const gp_Pln& P, const TopoDS_Wire& W, const Standard_Boolean Inside) {
...
BRepLib_MakeFace::BRepLib_MakeFace(const gp_Cylinder& C, const TopoDS_Wire& W, const Standard_Boolean Inside) {
    Handle(Geom_CylindricalSurface) GC = new Geom_CylindricalSurface(C);
...
BRepLib_MakeFace::BRepLib_MakeFace(const gp_Cone& C, const TopoDS_Wire& W, const Standard_Boolean Inside) {
    Handle(Geom_ConicalSurface) GC = new Geom_ConicalSurface(C);
    Init(GC, Standard_False, Precision::Confusion());
    Add(W);
    if (Inside && BRep_Tool::IsClosed(W)) CheckInside();
...
BRepLib_MakeFace::BRepLib_MakeFace(const gp_Sphere& S, const TopoDS_Wire& W, const Standard_Boolean Inside) {
    Handle(Geom_SphericalSurface) GS = new Geom_SphericalSurface(S);
...
BRepLib_MakeFace::BRepLib_MakeFace(const gp_Torus& T, const TopoDS_Wire& W, const Standard_Boolean Inside) {
    Handle(Geom_ToroidalSurface) GT = new Geom_ToroidalSurface(T);
...
BRepLib_MakeFace::BRepLib_MakeFace(const Handle(Geom_Surface) & S, const TopoDS_Wire& W,
...
void BRepLib_MakeFace::Init(const Handle(Geom_Surface) & S, const Standard_Boolean Bound,
...
Standard_Boolean BRepLib_MakeFace::IsDegenerated(const Handle(Geom_Curve) & theCurve, const Standard_Real theMaxTol,
    ...
    if (Type == GeomAbs_Circle) {
        ...
        if (Circ.Radius() > theMaxTol) return Standard_False;
        ...
        for (Standard_Integer i = 2; i <= NbPoles; i++) {
            ...
            if (aPoleDist2 > aMaxTol2) return Standard_False;
            if (aPoleDist2 > aMaxPoleDist2) aMaxPoleDist2 = aPoleDist2;
        }
...
void BRepLib_MakeFace::Init(const Handle(Geom_Surface) & SS, const Standard_Real Um, const Standard_Real UM,
    ...
    // closed flag
    Standard_Boolean uclosed = S->IsUClosed() && Abs(UMin - umin) < epsilon && Abs(UMax - umax) < epsilon;

    Standard_Boolean vclosed = S->IsVClosed() && Abs(VMin - vmin) < epsilon && Abs(VMax - vmax) < epsilon;
    ...
    Standard_Real uminTol = Precision::Confusion(), umaxTol = Precision::Confusion(), vminTol = Precision::Confusion(),
