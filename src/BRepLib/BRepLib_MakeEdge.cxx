...
static Standard_Boolean Project(const Handle(Geom2d_Curve) & C, const Handle(Geom_Surface) & S, const TopoDS_Vertex& V,
                                Standard_Real& p) {
    gp_Pnt P = BRep_Tool::Pnt(V);
    Standard_Real Eps2 = BRep_Tool::Tolerance(V);
    Eps2 *= Eps2;
...
BRepLib_MakeEdge::BRepLib_MakeEdge() : myError(BRepLib_PointProjectionFailed) {}
...
BRepLib_MakeEdge::BRepLib_MakeEdge(const gp_Lin& L, const TopoDS_Vertex& V1, const TopoDS_Vertex& V2) {
    Handle(Geom_Line) GL = new Geom_Line(L);
    Init(GL, V1, V2);
}
...
BRepLib_MakeEdge::BRepLib_MakeEdge(const gp_Circ& C, const TopoDS_Vertex& V1, const TopoDS_Vertex& V2) {
    Handle(Geom_Circle) GC = new Geom_Circle(C);
    Init(GC, V1, V2);
}
...
BRepLib_MakeEdge::BRepLib_MakeEdge(const gp_Elips& E, const Standard_Real p1, const Standard_Real p2) {
    Handle(Geom_Ellipse) GE = new Geom_Ellipse(E);
    Init(GE, p1, p2);
}
...
BRepLib_MakeEdge::BRepLib_MakeEdge(const gp_Elips& E, const TopoDS_Vertex& V1, const TopoDS_Vertex& V2) {
    Handle(Geom_Ellipse) GE = new Geom_Ellipse(E);
    Init(GE, V1, V2);
}
...
BRepLib_MakeEdge::BRepLib_MakeEdge(const gp_Hypr& H, const TopoDS_Vertex& V1, const TopoDS_Vertex& V2) {
    Handle(Geom_Hyperbola) GH = new Geom_Hyperbola(H);
    Init(GH, V1, V2);
}
...
BRepLib_MakeEdge::BRepLib_MakeEdge(const gp_Parab& P, const Standard_Real p1, const Standard_Real p2) {
    Handle(Geom_Parabola) GP = new Geom_Parabola(P);
    Init(GP, p1, p2);
}
...
BRepLib_MakeEdge::BRepLib_MakeEdge(const gp_Parab& P, const TopoDS_Vertex& V1, const TopoDS_Vertex& V2) {
    Handle(Geom_Parabola) GP = new Geom_Parabola(P);
    Init(GP, V1, V2);
}
...
BRepLib_MakeEdge::BRepLib_MakeEdge(const Handle(Geom_Curve) & L, const Standard_Real p1, const Standard_Real p2) {
    Init(L, p1, p2);
}
...
BRepLib_MakeEdge::BRepLib_MakeEdge(const Handle(Geom_Curve) & L, const TopoDS_Vertex& V1, const TopoDS_Vertex& V2) {
    Init(L, V1, V2);
}
...
BRepLib_MakeEdge::BRepLib_MakeEdge(const Handle(Geom2d_Curve) & L, const Handle(Geom_Surface) & S, const gp_Pnt& P1,
                                   const gp_Pnt& P2) {
    Init(L, S, P1, P2);
}
...
BRepLib_MakeEdge::BRepLib_MakeEdge(const Handle(Geom2d_Curve) & L, const Handle(Geom_Surface) & S,
                                   const TopoDS_Vertex& V1, const TopoDS_Vertex& V2, const Standard_Real p1,
...
void BRepLib_MakeEdge::Init(const Handle(Geom_Curve) & C, const Standard_Real p1, const Standard_Real p2) {
    //  BRep_Builder B;
...
void BRepLib_MakeEdge::Init(const Handle(Geom_Curve) & C, const TopoDS_Vertex& V1, const TopoDS_Vertex& V2) {
...
void BRepLib_MakeEdge::Init(const Handle(Geom_Curve) & C, const gp_Pnt& P1, const gp_Pnt& P2, const Standard_Real p1,
                            const Standard_Real p2) {
    Standard_Real Tol = BRepLib::Precision();
    BRep_Builder B;
...
void BRepLib_MakeEdge::Init(const Handle(Geom_Curve) & CC, const TopoDS_Vertex& VV1, const TopoDS_Vertex& VV2,
    ...
    if (!p1inf && !p2inf) closed = (P1.Distance(P2) <= preci);
    ...
    if (closed) {
        if (V1.IsNull() && V2.IsNull()) {
            ...
            if (!V1.IsSame(V2)) {
                ...
                if (P1.Distance(PM) < preci) degenerated = Standard_True;
            }
        }
    }
...
void BRepLib_MakeEdge::Init(const Handle(Geom2d_Curve) & C, const Handle(Geom_Surface) & S, const Standard_Real p1,
                            const Standard_Real p2) {
    //  BRep_Builder B;
...
void BRepLib_MakeEdge::Init(const Handle(Geom2d_Curve) & C, const Handle(Geom_Surface) & S, const gp_Pnt& P1,
                            const gp_Pnt& P2) {
    Standard_Real Tol = BRepLib::Precision();
...
void BRepLib_MakeEdge::Init(const Handle(Geom2d_Curve) & C, const Handle(Geom_Surface) & S, const TopoDS_Vertex& V1,
...
void BRepLib_MakeEdge::Init(const Handle(Geom2d_Curve) & CC, const Handle(Geom_Surface) & S, const TopoDS_Vertex& VV1,
    ...
    if (reverse) E.Orientation(TopAbs_REVERSED);
