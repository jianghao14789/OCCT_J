...
BRepLib_MakePolygon::BRepLib_MakePolygon(const gp_Pnt& P1, const gp_Pnt& P2, const gp_Pnt& P3,
...
BRepLib_MakePolygon::BRepLib_MakePolygon(const gp_Pnt& P1, const gp_Pnt& P2, const gp_Pnt& P3, const gp_Pnt& P4,
                                         const Standard_Boolean Cl) {
    Add(P1);
    Add(P2);
    Add(P3);
...
BRepLib_MakePolygon::BRepLib_MakePolygon(const TopoDS_Vertex& V1, const TopoDS_Vertex& V2, const TopoDS_Vertex& V3,
                                         const Standard_Boolean Cl) {
    Add(V1);
    Add(V2);
    Add(V3);
...
BRepLib_MakePolygon::BRepLib_MakePolygon(const TopoDS_Vertex& V1, const TopoDS_Vertex& V2, const TopoDS_Vertex& V3,
                                         const TopoDS_Vertex& V4, const Standard_Boolean Cl) {
    Add(V1);
    Add(V2);
    Add(V3);
    Add(V4);
...
void BRepLib_MakePolygon::Close() {
    if (myFirstVertex.IsNull() || myLastVertex.IsNull()) return;

    // check not already closed
    if (myShape.Closed()) return;
