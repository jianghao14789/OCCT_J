...
void StepShape_MeasureQualification::Init(const Handle(TCollection_HAsciiString) & name,
...
void StepShape_MeasureQualification::SetDescription(const Handle(TCollection_HAsciiString) & description) {
    theDescription = description;
}
...
void StepShape_MeasureQualification::SetQualifiedMeasure(const Handle(StepBasic_MeasureWithUnit) & qualified_measure) {
    theQualifiedMeasure = qualified_measure;
}
...
void StepShape_MeasureQualification::SetQualifiers(const Handle(StepShape_HArray1OfValueQualifier) & qualifiers) {
    theQualifiers = qualifiers;
}

StepShape_ValueQualifier StepShape_MeasureQualification::QualifiersValue(const Standard_Integer num) const {
