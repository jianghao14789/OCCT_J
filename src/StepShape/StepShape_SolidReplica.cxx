...
void StepShape_SolidReplica::Init(const Handle(TCollection_HAsciiString) & aName,
...
void StepShape_SolidReplica::SetTransformation(const Handle(StepGeom_CartesianTransformationOperator3d) &
                                               aTransformation) {
    transformation = aTransformation;
}
