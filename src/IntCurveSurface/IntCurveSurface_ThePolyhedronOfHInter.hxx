...
public:
    ...
    Standard_EXPORT IntCurveSurface_ThePolyhedronOfHInter(const Handle(Adaptor3d_Surface) & Surface,
                                                          const Standard_Integer nbdU, const Standard_Integer nbdV,
...
protected:
    Standard_EXPORT void Init(const Handle(Adaptor3d_Surface) & Surface, const Standard_Real U1, const Standard_Real V1,
                              const Standard_Real U2, const Standard_Real V2);

    Standard_EXPORT void Init(const Handle(Adaptor3d_Surface) & Surface, const TColStd_Array1OfReal& Upars,
                              const TColStd_Array1OfReal& Vpars);
