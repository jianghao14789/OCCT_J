...
template <class TheKey1Type, class TheKey2Type, class Hasher1 = NCollection_DefaultHasher<TheKey1Type>,
...
public:
    ...
    public:
        ...
        DoubleMapNode(const TheKey1Type& theKey1, const TheKey2Type& theKey2, NCollection_ListNode* theNext1,
                      NCollection_ListNode* theNext2)
            : NCollection_TListNode<TheKey2Type>(theKey2, theNext1), myKey1(theKey1),
...
public:
    ...
    public:
        ...
        Iterator(void) {}
        //! Constructor
        Iterator(const NCollection_DoubleMap& theMap) : NCollection_BaseMap::Iterator(theMap) {}
...
public:
    ...
    NCollection_DoubleMap& Assign(const NCollection_DoubleMap& theOther) {
        ...
        if (anExt) {
            ...
            for (; anIter.More(); anIter.Next()) {
                ...
                DoubleMapNode* pNode = new (this->myAllocator) DoubleMapNode(aKey1, aKey2, myData1[iK1], myData2[iK2]);
                myData1[iK1] = pNode;
                myData2[iK2] = pNode;
                Increment();
            }
    ...
    void Bind(const TheKey1Type& theKey1, const TheKey2Type& theKey2) {
        ...
        while (pNode) {
            if (Hasher1::IsEqual(pNode->Key1(), theKey1)) throw Standard_MultiplyDefined("NCollection_DoubleMap:Bind");
            pNode = (DoubleMapNode*)pNode->Next();
        }
        pNode = (DoubleMapNode*)myData2[iK2];
        while (pNode) {
            if (Hasher2::IsEqual(pNode->Key2(), theKey2)) throw Standard_MultiplyDefined("NCollection_DoubleMap:Bind");
            pNode = (DoubleMapNode*)pNode->Next();
        }
    ...
    Standard_Boolean AreBound(const TheKey1Type& theKey1, const TheKey2Type& theKey2) const {
        ...
        while (pNode1) {
            if (Hasher1::IsEqual(pNode1->Key1(), theKey1)) break;
            pNode1 = (DoubleMapNode*)pNode1->Next();
        }
        if (pNode1 == NULL) return Standard_False;
        pNode2 = (DoubleMapNode*)myData2[iK2];
        while (pNode2) {
            if (Hasher2::IsEqual(pNode2->Key2(), theKey2)) break;
            pNode2 = (DoubleMapNode*)pNode2->Next();
        }
        if (pNode2 == NULL) return Standard_False;
    ...
    Standard_Boolean IsBound1(const TheKey1Type& theKey1) const {
        ...
        pNode1 = (DoubleMapNode*)myData1[iK1];
        while (pNode1) {
            if (Hasher1::IsEqual(pNode1->Key1(), theKey1)) return Standard_True;
            pNode1 = (DoubleMapNode*)pNode1->Next();
        }
    ...
    Standard_Boolean IsBound2(const TheKey2Type& theKey2) const {
        ...
        pNode2 = (DoubleMapNode*)myData2[iK2];
        while (pNode2) {
            if (Hasher2::IsEqual(pNode2->Key2(), theKey2)) return Standard_True;
    ...
    const TheKey2Type* Seek1(const TheKey1Type& theKey1) const {
        for (DoubleMapNode* aNode1 = !IsEmpty() ? (DoubleMapNode*)myData1[Hasher1::HashCode(theKey1, NbBuckets())]
                                                : NULL;
    ...
    const TheKey1Type* Seek2(const TheKey2Type& theKey2) const {
        for (DoubleMapNode* aNode2 = !IsEmpty() ? (DoubleMapNode*)myData2[Hasher2::HashCode(theKey2, NbBuckets())]
                                                : NULL;
