...
template <typename Element_t> class NCollection_Vec4 {
...
public:
    ...
    explicit NCollection_Vec4(const Element_t theX, const Element_t theY, const Element_t theZ, const Element_t theW) {
        v[0] = theX;
        v[1] = theY;
        v[2] = theZ;
        v[3] = theW;
    ...
    template <typename OtherElement_t> explicit NCollection_Vec4(const NCollection_Vec4<OtherElement_t>& theOtherVec4) {
    ...
    bool IsEqual(const NCollection_Vec4& theOther) const {
        return v[0] == theOther.v[0] && v[1] == theOther.v[1] && v[2] == theOther.v[2] && v[3] == theOther.v[3];
    }
    ...
    //! Compute per-component summary.
    friend NCollection_Vec4 operator+(const NCollection_Vec4& theLeft, const NCollection_Vec4& theRight) {
    ...
    NCollection_Vec4 cwiseMin(const NCollection_Vec4& theVec) const {
        return NCollection_Vec4(v[0] < theVec.v[0] ? v[0] : theVec.v[0], v[1] < theVec.v[1] ? v[1] : theVec.v[1],
                                v[2] < theVec.v[2] ? v[2] : theVec.v[2], v[3] < theVec.v[3] ? v[3] : theVec.v[3]);
    }
