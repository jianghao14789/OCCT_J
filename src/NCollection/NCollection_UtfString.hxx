...
template <typename Type> class NCollection_UtfString {
...
public: //! @name assign operators
    ...
    friend NCollection_UtfString operator+(const NCollection_UtfString& theLeft,
        ...
        strCopy((Standard_Byte*)aSumm.myString + theLeft.mySize, (const Standard_Byte*)theRight.myString,
                theRight.mySize);
        return aSumm;
    }
...
private: //! @name low-level methods
    ...
    void fromUnicodeImpl(const Type* theStringUtf, const Standard_Integer theLength,
    ...
    template <typename TypeFrom>
    void fromUnicodeImpl(typename opencascade::std::enable_if<!opencascade::std::is_same<Type, TypeFrom>::value,
    ...
    static void strCopy(Standard_Byte* theStrDst, const Standard_Byte* theStrSrc, const Standard_Integer theSizeBytes) {
        std::memcpy(theStrDst, theStrSrc, (Standard_Size)theSizeBytes);
    }

    //! Compare two Unicode strings per-byte.
    static bool strAreEqual(const Type* theString1, const Standard_Integer theSizeBytes1, const Type* theString2,
...
private:                     //! @name private fields
    ...
    Standard_Integer
        myLength; //!< length of the string in Unicode symbols (cached value, excluding NULL-termination symbol)
};
