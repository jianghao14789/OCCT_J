...
public:
    ...
    Standard_EXPORT void LoadReferences(const Handle(CDM_Document) & aDocument, const Handle(CDM_MetaData) & aMetaData,
...
private:
    ...
    Standard_EXPORT virtual Handle(CDM_MetaData)
        MetaData(CDM_MetaDataLookUpTable& theLookUpTable, const Standard_Boolean UseStorageConfiguration) const;
