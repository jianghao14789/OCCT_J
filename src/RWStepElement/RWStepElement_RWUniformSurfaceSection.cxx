...
void RWStepElement_RWUniformSurfaceSection::ReadStep(const Handle(StepData_StepReaderData) & data,
    ...
    data->ReadEntity(num, 3, "surface_section.non_structural_mass_offset", ach,
    ...
    // Initialize entity
    ent->Init(aSurfaceSection_Offset, aSurfaceSection_NonStructuralMass, aSurfaceSection_NonStructuralMassOffset,
              aThickness, aBendingThickness, aShearThickness);
}
