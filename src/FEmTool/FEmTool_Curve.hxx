...
public:
    Standard_EXPORT FEmTool_Curve(const Standard_Integer Dimension, const Standard_Integer NbElements,
                                  const Handle(PLib_Base) & TheBase, const Standard_Real Tolerance);
    ...
    Standard_EXPORT void ReduceDegree(const Standard_Integer IndexOfElement, const Standard_Real Tol,
