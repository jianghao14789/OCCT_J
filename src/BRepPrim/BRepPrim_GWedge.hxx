...
public:
    ...
    Standard_EXPORT BRepPrim_GWedge(const BRepPrim_Builder& B, const gp_Ax2& Axes, const Standard_Real dx,
    ...
    Standard_EXPORT BRepPrim_GWedge(const BRepPrim_Builder& B, const gp_Ax2& Axes, const Standard_Real xmin,
    ...
    //! direction.
    Standard_EXPORT Standard_Boolean HasVertex(const BRepPrim_Direction d1, const BRepPrim_Direction d2,
                                               const BRepPrim_Direction d3) const;

    //! Returns the Vertex of <me> located in <d1><d2><d3>
    //! direction.
    Standard_EXPORT const TopoDS_Vertex& Vertex(const BRepPrim_Direction d1, const BRepPrim_Direction d2,
