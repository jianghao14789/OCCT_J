...
BRepPrim_Builder::BRepPrim_Builder(const BRep_Builder& B) : myBuilder(B) {}
...
void BRepPrim_Builder::SetPCurve(TopoDS_Edge& E, const TopoDS_Face& F, const gp_Lin2d& L1, const gp_Lin2d& L2) const {
    TopoDS_Shape aLocalShape = E.Oriented(TopAbs_FORWARD);
    myBuilder.UpdateEdge(TopoDS::Edge(aLocalShape), new Geom2d_Line(L1), new Geom2d_Line(L2), F,
                         Precision::Confusion());
...
void BRepPrim_Builder::AddEdgeVertex(TopoDS_Edge& E, const TopoDS_Vertex& V, const Standard_Real P,
                                     const Standard_Boolean direct) const {
    TopoDS_Vertex VV = V;
    if (!direct) VV.Reverse();
    myBuilder.Add(E, VV);
...
void BRepPrim_Builder::AddEdgeVertex(TopoDS_Edge& E, const TopoDS_Vertex& V, const Standard_Real P1,
...
void BRepPrim_Builder::SetParameters(TopoDS_Edge& E, const TopoDS_Vertex&, const Standard_Real P1,
                                     const Standard_Real P2) const {
    myBuilder.Range(E, P1, P2);
}
...
void BRepPrim_Builder::AddWireEdge(TopoDS_Wire& W, const TopoDS_Edge& E, const Standard_Boolean direct) const {
    TopoDS_Edge EE = E;
    if (!direct) EE.Reverse();
    myBuilder.Add(W, EE);
}
