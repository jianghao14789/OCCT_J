...
void StepAP214_AutoDesignOrganizationAssignment::Init(const Handle(StepBasic_Organization) & aAssignedOrganization,
                                                      const Handle(StepBasic_OrganizationRole) & aRole,
                                                      const Handle(StepAP214_HArray1OfAutoDesignGeneralOrgItem) &
                                                          aItems) {
    // --- classe own fields ---
    items = aItems;
...
void StepAP214_AutoDesignOrganizationAssignment::SetItems(const Handle(StepAP214_HArray1OfAutoDesignGeneralOrgItem) &
                                                          aItems) {
    items = aItems;
}
...
StepAP214_AutoDesignOrganizationAssignment::ItemsValue(const Standard_Integer num) const {
