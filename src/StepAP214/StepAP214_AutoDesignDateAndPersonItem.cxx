...
Handle(StepAP214_AutoDesignOrganizationAssignment)
    StepAP214_AutoDesignDateAndPersonItem::AutoDesignOrganizationAssignment() const {
...
Handle(StepAP214_AutoDesignDocumentReference)
    StepAP214_AutoDesignDateAndPersonItem::AutoDesignDocumentReference() const {
    return GetCasted(StepAP214_AutoDesignDocumentReference, Value());
}

Handle(StepRepr_ExternallyDefinedRepresentation)
    StepAP214_AutoDesignDateAndPersonItem::ExternallyDefinedRepresentation() const {
    return GetCasted(StepRepr_ExternallyDefinedRepresentation, Value());
}

Handle(StepBasic_ProductDefinitionRelationship)
    StepAP214_AutoDesignDateAndPersonItem::ProductDefinitionRelationship() const {
    return GetCasted(StepBasic_ProductDefinitionRelationship, Value());
}

Handle(StepBasic_ProductDefinitionWithAssociatedDocuments)
