...
Handle(StepShape_AdvancedBrepShapeRepresentation)
    StepAP214_AutoDesignGroupedItem::AdvancedBrepShapeRepresentation() const {
...
Handle(StepShape_FacetedBrepShapeRepresentation)
    StepAP214_AutoDesignGroupedItem::FacetedBrepShapeRepresentation() const {
    return GetCasted(StepShape_FacetedBrepShapeRepresentation, Value());
}

Handle(StepShape_GeometricallyBoundedSurfaceShapeRepresentation)
...
Handle(StepShape_ManifoldSurfaceShapeRepresentation)
    StepAP214_AutoDesignGroupedItem::ManifoldSurfaceShapeRepresentation() const {
