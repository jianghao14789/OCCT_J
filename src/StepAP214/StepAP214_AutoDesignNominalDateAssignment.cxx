...
void StepAP214_AutoDesignNominalDateAssignment::Init(const Handle(StepBasic_Date) & aAssignedDate,
...
void StepAP214_AutoDesignNominalDateAssignment::SetItems(const Handle(StepAP214_HArray1OfAutoDesignDatedItem) &
                                                         aItems) {
    items = aItems;
}
