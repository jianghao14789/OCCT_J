...
// purpose  :
//=======================================================================
IntTools_FClass2d::IntTools_FClass2d(const TopoDS_Face& aFace, const Standard_Real TolUV) : Toluv(TolUV), Face(aFace) {
    Init(Face, Toluv);
}
//=======================================================================
// function : IsHole
...
void IntTools_FClass2d::Init(const TopoDS_Face& aFace, const Standard_Real TolUV) {
    ...
    for (; aExpF.More(); aExpF.Next()) {
        ...
        for (; aWExp.More(); aWExp.Next()) {
            ...
            if (Or == TopAbs_REVERSED) aV.Reverse();
        ...
        //
            ...
            if (SeqPnt2d.Length() > 3) {
                ...
                TabClass.Append((void*)new CSLib_Class2d(SeqPnt2d, FlecheU, FlecheV, Umin, Vmin, Umax, Vmax));
                //
...
// purpose  :
//=======================================================================
TopAbs_State IntTools_FClass2d::Perform(const gp_Pnt2d& _Puv, const Standard_Boolean RecadreOnPeriodic) const {
    Standard_Integer nbtabclass = TabClass.Length();
    if (nbtabclass == 0) {
        return TopAbs_IN;
    }
    ...
    for (;;) {
        ...
        if (bUseClassifier) {
            ...
            if (myFExplorer.get() == NULL) myFExplorer.reset(new BRepClass_FaceExplorer(Face));
        ...
        if (aStatus == TopAbs_IN || aStatus == TopAbs_ON) return aStatus;
...
// purpose  :
//=======================================================================
TopAbs_State IntTools_FClass2d::TestOnRestriction(const gp_Pnt2d& _Puv, const Standard_Real Tol,
    ...
    for (;;) {
        ...
        if (u > Umax || !IsUPer) {
            ...
            if (v > Vmax || !IsVPer) return aStatus;
        }
    } // for (;;)
}
//=======================================================================
