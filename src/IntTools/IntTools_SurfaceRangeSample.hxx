...
public:
    ...
    Standard_EXPORT IntTools_SurfaceRangeSample(const Standard_Integer theIndexU, const Standard_Integer theDepthU,
    ...
    Standard_EXPORT IntTools_Range GetRangeU(const Standard_Real theFirstU, const Standard_Real theLastU,
                                             const Standard_Integer theNbSampleU) const;

    Standard_EXPORT IntTools_Range GetRangeV(const Standard_Real theFirstV, const Standard_Real theLastV,
