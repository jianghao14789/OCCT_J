...
public:
    ...
    Standard_EXPORT IntTools_Curve(const Handle(Geom_Curve) & the3dCurve3d, const Handle(Geom2d_Curve) & the2dCurve1,
                                   const Handle(Geom2d_Curve) & the2dCurve2, const Standard_Real theTolerance = 0.0,
                                   const Standard_Real theTangentialTolerance = 0.0);

    //! Sets the curves
    void SetCurves(const Handle(Geom_Curve) & the3dCurve, const Handle(Geom2d_Curve) & the2dCurve1,
    ...
    Standard_EXPORT Standard_Boolean Bounds(Standard_Real& theFirst, Standard_Real& theLast, gp_Pnt& theFirstPnt,
