...
static void Analyse(const TColgp_Array2OfPnt& array2, Standard_Integer& theNbSamplesU, Standard_Integer& theNbSamplesV);
...
void IntTools_TopolTool::ComputeSamplePoints() {
    ...
    switch (typS) {
        ...
        case GeomAbs_Cone: {
            ...
            if (aRadius < aCircle.Radius()) aRadius = aCircle.Radius();
            Standard_Real aMaxAngle = M_PI * 0.5;
            Standard_Real aDeflection = 1.e-02;
...
// purpose  :
//=======================================================================
void Analyse(const TColgp_Array2OfPnt& array2, Standard_Integer& theNbSamplesU, Standard_Integer& theNbSamplesV) {
    gp_Vec Vi, Vip1;
...
void IntTools_TopolTool::SamplePnts(const Standard_Real theDefl, const Standard_Integer theNUmin,
