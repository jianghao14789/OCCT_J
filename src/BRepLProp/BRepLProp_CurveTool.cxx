...
void BRepLProp_CurveTool::D1(const BRepAdaptor_Curve& C, const Standard_Real U, gp_Pnt& P, gp_Vec& V1) {
    C.D1(U, P, V1);
}
...
void BRepLProp_CurveTool::D2(const BRepAdaptor_Curve& C, const Standard_Real U, gp_Pnt& P, gp_Vec& V1, gp_Vec& V2) {
    C.D2(U, P, V1, V2);
}
...
void BRepLProp_CurveTool::D3(const BRepAdaptor_Curve& C, const Standard_Real U, gp_Pnt& P, gp_Vec& V1, gp_Vec& V2,
                             gp_Vec& V3) {
    C.D3(U, P, V1, V2, V3);
}
