...
public:
    ...
    Image_CompressedPixMap()
        : myFaceBytes(0), myNbFaces(0), mySizeX(0), mySizeY(0), myBaseFormat(Image_Format_UNKNOWN),
          myFormat(Image_CompressedFormat_UNKNOWN), myIsCompleteMips(false) {}
