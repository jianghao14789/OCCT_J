...
//! - *.jpg, *.jpe, *.jpeg - JPEG/JIFF (Joint Photographic Experts Group) lossy format (compressed with quality losses).
//! YUV color space used (automatically converted from/to RGB).
...
public:
    ...
    Standard_EXPORT bool Load(const Standard_Byte* theData, Standard_Size theLength,
