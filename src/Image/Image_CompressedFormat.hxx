...
//! List of compressed pixel formats natively supported by various graphics hardware (e.g. for efficient decoding
//! on-the-fly). It is defined as extension of Image_Format.
