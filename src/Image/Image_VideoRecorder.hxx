...
struct Image_VideoParams {
    TCollection_AsciiString
        Format; //!< [optional]  video format (container), if empty - will be determined from the file name
    TCollection_AsciiString
        VideoCodec; //!< [optional]  codec identifier, if empty - default codec from file format will be used
    TCollection_AsciiString
        PixelFormat;         //!< [optional]  pixel format, if empty - default codec pixel format will be used
    ...
    Resource_DataMapOfAsciiStringAsciiString VideoCodecParams; //!< map of advanced video codec parameters
...
public:
    ...
    Standard_EXPORT Standard_Boolean Open(const char* theFileName, const Image_VideoParams& theParams);
