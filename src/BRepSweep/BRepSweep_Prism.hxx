...
public:
    ...
    Standard_EXPORT BRepSweep_Prism(const TopoDS_Shape& S, const gp_Vec& V,
    ...
    //! are attempted to be canonized in simple types
    Standard_EXPORT BRepSweep_Prism(const TopoDS_Shape& S, const gp_Dir& D, const Standard_Boolean Inf = Standard_True,
                                    const Standard_Boolean Copy = Standard_False,
                                    const Standard_Boolean Canonize = Standard_True);
