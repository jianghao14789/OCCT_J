...
BRepSweep_NumLinearRegularSweep::BRepSweep_NumLinearRegularSweep(const BRepSweep_Builder& aBuilder,
    ...
    :
      ...
      myBuilder(aBuilder), myGenShape(aGenShape), myDirWire(aDirShape),

      myGenShapeTool(aGenShape), myDirShapeTool(aDirShape),
...
TopoDS_Shape BRepSweep_NumLinearRegularSweep::Shape(const TopoDS_Shape& aGenS, const Sweep_NumShape& aDirS) {
    ...
    if (myShapes(iGenS, iDirS).ShapeType() == TopAbs_WIRE || myShapes(iGenS, iDirS).ShapeType() == TopAbs_SHELL)
...
TopoDS_Shape BRepSweep_NumLinearRegularSweep::LastShape() {
    ...
    if (myDirShapeTool.HasLastVertex()) {
        if (HasShape(myGenShape, myDirShapeTool.LastVertex())) result = Shape(myGenShape, myDirShapeTool.LastVertex());
    }
    return result;
}
...
TopoDS_Shape BRepSweep_NumLinearRegularSweep::FirstShape(const TopoDS_Shape& aGenS) {
    TopoDS_Shape result;
    if (myDirShapeTool.HasFirstVertex()) {
        if (HasShape(aGenS, myDirShapeTool.FirstVertex())) result = Shape(aGenS, myDirShapeTool.FirstVertex());
    }
    return result;
}
...
TopoDS_Shape BRepSweep_NumLinearRegularSweep::LastShape(const TopoDS_Shape& aGenS) {
    TopoDS_Shape result;
    if (myDirShapeTool.HasLastVertex()) {
        if (HasShape(aGenS, myDirShapeTool.LastVertex())) result = Shape(aGenS, myDirShapeTool.LastVertex());
    }
    return result;
}
