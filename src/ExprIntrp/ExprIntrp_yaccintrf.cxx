...
static Handle(Expr_GeneralExpression)
    ExprIntrp_StandardFunction(const TCollection_AsciiString& name, const Handle(Expr_GeneralExpression) & op) {
...
extern "C" void ExprIntrp_EndOfFuncDef() {
    ...
    Handle(Expr_NamedFunction) thefunc = new Expr_NamedFunction(ExprIntrp_funcdefname, theexp, internvars);
