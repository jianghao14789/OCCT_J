...
void OSD_Error::SetValue(const Standard_Integer errcode, const Standard_Integer from,
...
static ERROR_TABLE dirErrorTable[] = {
    ...
    {ERROR_FILE_NOT_FOUND, ERR_NOENT}, {ERROR_PATH_NOT_FOUND, ERR_NOENT},      {ERROR_INVALID_DRIVE, ERR_NOENT},
    {ERROR_NO_MORE_FILES, ERR_NOENT},  {ERROR_BAD_NETPATH, ERR_NOENT},         {ERROR_BAD_NET_NAME, ERR_NOENT},
    {ERROR_BAD_PATHNAME, ERR_NOENT},   {ERROR_FILENAME_EXCED_RANGE, ERR_NOENT}
...
static ERROR_TABLE fileNodeErrorTable[] = {
    ...
    {ERROR_INVALID_FUNCTION, ERR_FNINVAL}, {ERROR_INVALID_ACCESS, ERR_FNINVAL},
    {ERROR_INVALID_DATA, ERR_FNINVAL},     {ERROR_INVALID_PARAMETER, ERR_FNINVAL},
    {ERROR_INVALID_HANDLE, ERR_FNINVAL},   {ERROR_NEGATIVE_SEEK, ERR_FNINVAL},
    {ERROR_DISK_FULL, ERR_FNOSPC},         {ERROR_DIR_NOT_EMPTY, ERR_FNNOTEMPTY},
...
OSD_Error::OSD_Error() : myCode((OSD_WhoAmI)0), extCode(0) {
    Reset();
} // end constructor ( 1 )
