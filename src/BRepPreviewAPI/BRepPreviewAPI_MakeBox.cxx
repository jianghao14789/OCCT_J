...
void BRepPreviewAPI_MakeBox::Build(const Message_ProgressRange& /*theRange*/) {
    ...
    gp_Pnt aSecondPoint(anLocation.X() + myWedge.GetXMax(), anLocation.Y() + myWedge.GetYMax(),
...
// purpose  :
//=======================================================================
void BRepPreviewAPI_MakeBox::makeRectangle(const gp_Pnt& thePnt1, const gp_Pnt& thePnt2, const gp_Pnt& thePnt3,
