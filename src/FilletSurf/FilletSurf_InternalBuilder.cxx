...
static Standard_Boolean IntPlanEdge(Handle(BRepAdaptor_Curve) & Ed, const gp_Pln& P, Standard_Real& w,
...
static Standard_Boolean ComputeEdgeParameter(const Handle(ChFiDS_Spine) & Spine, const Standard_Integer ind,
                                             const Standard_Real pelsp, Standard_Real& ped, const Standard_Real tol3d) {
...
FilletSurf_InternalBuilder::FilletSurf_InternalBuilder(const TopoDS_Shape& S, const ChFi3d_FilletShape FShape,
                                                       const Standard_Real Ta, const Standard_Real Tapp3d,
...
Standard_Integer FilletSurf_InternalBuilder::Add(const TopTools_ListOfShape& E, const Standard_Real R) {
...
Standard_Boolean FilletSurf_InternalBuilder::PerformSurf(
    ...
    done = SimulData(Data, Guide, EmptyGuide, lin, S1, I1, S2, I2, Func, FInv, PFirst, MaxStep, Fleche, TolGuide, First,
...
void FilletSurf_InternalBuilder::PerformSurf(
    ChFiDS_SequenceOfSurfData&, const Handle(ChFiDS_ElSpine) &, const Handle(ChFiDS_Spine) &, const Standard_Integer,
    ...
    const Handle(BRepAdaptor_Surface) &, const Handle(Adaptor3d_TopolTool) &, const TopAbs_Orientation,
    const Standard_Real, const Standard_Real, const Standard_Real, Standard_Real&, Standard_Real&,
    const Standard_Boolean, const Standard_Boolean, const Standard_Boolean, const Standard_Boolean,
...
void FilletSurf_InternalBuilder::PerformSurf(
    ...
    const Handle(BRepAdaptor_Surface) &, const Handle(Adaptor3d_TopolTool) &, const TopAbs_Orientation,
    const Handle(BRepAdaptor_Surface) &, const Handle(Adaptor3d_TopolTool) &, const Handle(BRepAdaptor_Curve2d) &,
    const Handle(BRepAdaptor_Surface) &, const Handle(BRepAdaptor_Curve2d) &, Standard_Boolean&, const Standard_Real,
    const Standard_Real, const Standard_Real, Standard_Real&, Standard_Real&, const Standard_Boolean,
    const Standard_Boolean, const Standard_Boolean, const Standard_Boolean, const Standard_Boolean,
...
void FilletSurf_InternalBuilder::PerformSurf(
    ...
    Standard_Boolean&, const TopAbs_Orientation, const Standard_Real, const Standard_Real, const Standard_Real,
    Standard_Real&, Standard_Real&, const Standard_Boolean, const Standard_Boolean, const Standard_Boolean,
    const Standard_Boolean, const Standard_Boolean, const Standard_Boolean, const Standard_Boolean,
    const math_Vector&) {
    throw Standard_DomainError("BlendFunc_CSConstRad::Section : Not implemented");
}
...
const Handle(Geom_Curve) & FilletSurf_InternalBuilder::CurveOnFace1(const Standard_Integer Index) const {
    Standard_Integer icurv = myListStripe.First()->SetOfSurfData()->Value(Index)->InterferenceOnS1().LineIndex();
...
const Handle(Geom_Curve) & FilletSurf_InternalBuilder::CurveOnFace2(const Standard_Integer Index) const {
    Standard_Integer icurv = myListStripe.First()->SetOfSurfData()->Value(Index)->InterferenceOnS2().LineIndex();
    return myDS->Curve(icurv).Curve();
}
//=======================================================================
...
FilletSurf_StatusType FilletSurf_InternalBuilder::StartSectionStatus() const {
    ...
    Standard_Boolean isonedge1 = myListStripe.First()->SetOfSurfData()->Value(1)->VertexFirstOnS1().IsOnArc();
    Standard_Boolean isonedge2 = myListStripe.First()->SetOfSurfData()->Value(1)->VertexFirstOnS2().IsOnArc();
...
FilletSurf_StatusType FilletSurf_InternalBuilder::EndSectionStatus() const {
    Standard_Boolean isonedge1 = myListStripe.First()->SetOfSurfData()->Value(NbSurface())->VertexLastOnS1().IsOnArc();
    Standard_Boolean isonedge2 = myListStripe.First()->SetOfSurfData()->Value(NbSurface())->VertexLastOnS2().IsOnArc();
...
//=======================================================================
void FilletSurf_InternalBuilder::Section(const Standard_Integer IndexSurf, const Standard_Integer IndexSec,
