...
public:
    ...
    Standard_EXPORT FilletSurf_InternalBuilder(const TopoDS_Shape& S,
                                               ...
                                               const Standard_Real Ta = 1.0e-2, const Standard_Real Tapp3d = 1.0e-4,
    ...
    Standard_EXPORT void Section(const Standard_Integer IndexSurf, const Standard_Integer IndexSec,
...
protected:
    ...
    PerformSurf(ChFiDS_SequenceOfSurfData& SeqData, const Handle(ChFiDS_ElSpine) & Guide,
