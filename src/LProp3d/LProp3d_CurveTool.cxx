...
void LProp3d_CurveTool::D1(const Handle(Adaptor3d_Curve) & C, const Standard_Real U, gp_Pnt& P, gp_Vec& V1) {
    C->D1(U, P, V1);
}
...
void LProp3d_CurveTool::D2(const Handle(Adaptor3d_Curve) & C, const Standard_Real U, gp_Pnt& P, gp_Vec& V1,
                           gp_Vec& V2) {
    C->D2(U, P, V1, V2);
}
...
void LProp3d_CurveTool::D3(const Handle(Adaptor3d_Curve) & C, const Standard_Real U, gp_Pnt& P, gp_Vec& V1, gp_Vec& V2,
                           gp_Vec& V3) {
    C->D3(U, P, V1, V2, V3);
}
