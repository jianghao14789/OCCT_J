...
public:
    ...
    Standard_EXPORT Cocoa_Window(const Standard_CString theTitle, const Standard_Integer thePxLeft,
    ...
    InvalidateContent(const Handle(Aspect_DisplayConnection) & theDisp = NULL) Standard_OVERRIDE;
