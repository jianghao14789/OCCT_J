...
struct BSplCLib_CacheParams {
    ...
    BSplCLib_CacheParams(Standard_Integer theDegree, Standard_Boolean thePeriodic,
        ...
        : Degree(theDegree), IsPeriodic(thePeriodic),
          ...
          SpanIndexMin(theFlatKnots.Lower() + theDegree), SpanIndexMax(theFlatKnots.Upper() - theDegree - 1),
          SpanStart(0.), SpanLength(0.), SpanIndex(0) {}
    ...
    Standard_Boolean IsCacheValid(Standard_Real theParameter) const {
        ...
        return ((aDelta >= 0.0 || SpanIndex == SpanIndexMin) && (aDelta < SpanLength || SpanIndex == SpanIndexMax));
    }
    ...
    void LocateParameter(Standard_Real& theParameter, const TColStd_Array1OfReal& theFlatKnots) {
        SpanIndex = 0;
        BSplCLib::LocateParameter(Degree, theFlatKnots, BSplCLib::NoMults(), theParameter, IsPeriodic, SpanIndex,
                                  theParameter);
