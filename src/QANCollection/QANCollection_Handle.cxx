...
static Standard_Integer QAHandleOps(Draw_Interpretor& theDI, Standard_Integer /*theArgNb*/,
    ...
    CHECK(theDI, hTmpRefBase.get() == aCurve2.get(),
...
//=======================================================================
static Standard_Integer QAHandleBool(Draw_Interpretor& theDI, Standard_Integer /*theArgNb*/,
                                     const char** /*theArgVec*/) {
...
public:
    ...
    virtual Standard_Transient* CreateParent() const {
        return new Standard_Transient;
    }
    virtual Standard_Transient* Clone() const {
        return new Transient_Root;
    }
...
public:
    ...
    QATimer(Draw_Interpretor& theDI, Standard_CString theTitle, const TimeFormat theFormat,
            const Standard_Integer theNbIters = 1, const Standard_Boolean theToPrintFormat = Standard_False)
        : myDI(&theDI), myTitle(theTitle), myFormat(theFormat), myNbIters(theNbIters),
...
//=======================================================================
static Standard_Integer QAHandleInc(Draw_Interpretor& theDI, Standard_Integer theArgNb, const char** theArgVec) {
    if (theArgNb > 2) {
...
// purpose  :
//=======================================================================
static Standard_Integer QAHandleKind(Draw_Interpretor& /*theDI*/, Standard_Integer /*theArgNb*/,
                                     const char** /*theArgVec*/) {
...
#define QA_CHECK(theDesc, theExpr, theValue)                                                                           \
    ...
    QA_CHECK("Name == qaclass40_50       : ", TCollection_AsciiString("qaclass40_50") == aHandle->DynamicType()->Name(),
             true);
    ...
    QA_CHECK("IsClass(Standard_Transient): ",
             std::is_class<Standard_Transient>::value == !!STANDARD_TYPE(Standard_Transient)->IsClass(), true);
...
void QANCollection::CommandsHandle(Draw_Interpretor& theCommands) {
    ...
    theCommands.Add("QAHandleBool", "Test handle boolean operator", __FILE__, QAHandleBool, THE_GROUP);
