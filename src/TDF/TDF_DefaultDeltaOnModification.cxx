...
// purpose  :
//=======================================================================
TDF_DefaultDeltaOnModification::TDF_DefaultDeltaOnModification(const Handle(TDF_Attribute) & anAttribute)
...
void TDF_DefaultDeltaOnModification::Apply() {
    ...
    if (Label().FindAttribute(savAtt->ID(), refAtt)) refAtt->DeltaOnModification(this);
}
