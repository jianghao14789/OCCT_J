...
TDF_ChildIDIterator::TDF_ChildIDIterator(const TDF_Label& aLabel, const Standard_GUID& anID,
                                         const Standard_Boolean allLevels)
    : myID(anID), myItr(aLabel, allLevels) {
...
void TDF_ChildIDIterator::Initialize(const TDF_Label& aLabel, const Standard_GUID& anID,
                                     const Standard_Boolean allLevels) {
    myID = anID;
