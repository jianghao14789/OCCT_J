...
public:
    ...
    template <class T> Standard_Boolean FindAttribute(const Standard_GUID& theID, Handle(T) & theAttr) const {
    ...
    Standard_EXPORT Standard_Boolean FindAttribute(const Standard_GUID& anID, const Standard_Integer aTransaction,
                                                   Handle(TDF_Attribute) & anAttribute) const;
    ...
    Standard_EXPORT void ExtendedDump(Standard_OStream& anOS, const TDF_IDFilter& aFilter,
...
private:
    ...
    //! already one.
    Standard_EXPORT void AddToNode(const TDF_LabelNodePtr& toNode, const Handle(TDF_Attribute) & anAttribute,
    ...
    Standard_EXPORT void InternalDump(Standard_OStream& anOS, const TDF_IDFilter& aFilter,
                                      TDF_AttributeIndexedMap& aMap, const Standard_Boolean extended) const;
