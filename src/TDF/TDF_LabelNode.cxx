...
#endif
      myFirstChild(NULL), myLastFoundChild(NULL), // jfa 10.01.2003
...
TDF_LabelNode::TDF_LabelNode(const Standard_Integer aTag, TDF_LabelNode* aFather)
    : myFather(aFather), myBrother(NULL), myFirstChild(NULL), myLastFoundChild(NULL), // jfa 10.01.2003
      myTag(aTag), myFlags(0),
#ifdef KEEP_LOCAL_ROOT
      myData(NULL)
#endif
{
...
void TDF_LabelNode::AddAttribute(const Handle(TDF_Attribute) & afterAtt, const Handle(TDF_Attribute) & newAtt) {
...
void TDF_LabelNode::RemoveAttribute(const Handle(TDF_Attribute) & afterAtt, const Handle(TDF_Attribute) & oldAtt) {
