...
public:
    ...
    Standard_EXPORT TDF_ChildIDIterator(const TDF_Label& aLabel, const Standard_GUID& anID,
    ...
    //! label levels.
    Standard_EXPORT void Initialize(const TDF_Label& aLabel, const Standard_GUID& anID,
                                    const Standard_Boolean allLevels = Standard_False);
