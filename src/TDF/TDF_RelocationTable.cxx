...
void TDF_RelocationTable::SetRelocation(const TDF_Label& aSourceLabel, const TDF_Label& aTargetLabel) {
    if (!myLabelTable.IsBound(aSourceLabel)) myLabelTable.Bind(aSourceLabel, aTargetLabel);
}
...
Standard_Boolean TDF_RelocationTable::HasRelocation(const TDF_Label& aSourceLabel, TDF_Label& aTargetLabel) const {
...
void TDF_RelocationTable::SetRelocation(const Handle(TDF_Attribute) & aSourceAttribute,
    ...
    if (!myAttributeTable.IsBound(aSourceAttribute)) myAttributeTable.Bind(aSourceAttribute, aTargetAttribute);
}
...
void TDF_RelocationTable::SetTransientRelocation(const Handle(Standard_Transient) & aSourceTransient,
    ...
    if (!myTransientTable.Contains(aSourceTransient)) myTransientTable.Add(aSourceTransient, aTargetTransient);
}
...
Standard_OStream& TDF_RelocationTable::Dump(const Standard_Boolean dumpLabels, const Standard_Boolean dumpAttributes,
                                            const Standard_Boolean dumpTransients, Standard_OStream& anOS) const {
