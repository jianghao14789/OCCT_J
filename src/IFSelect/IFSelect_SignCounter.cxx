...
IFSelect_SignCounter::IFSelect_SignCounter(const Standard_Boolean withmap, const Standard_Boolean withlist)
    : IFSelect_SignatureList(withlist) {
    themapstat = withmap;
    thenbcomp1 = thenbcomp2 = theselmode = 0;
}

IFSelect_SignCounter::IFSelect_SignCounter(const Handle(IFSelect_Signature) & matcher, const Standard_Boolean withmap,
...
void IFSelect_SignCounter::AddFromSelection(const Handle(IFSelect_Selection) & sel, const Interface_Graph& G) {
...
Standard_Boolean IFSelect_SignCounter::ComputeSelected(const Interface_Graph& G, const Standard_Boolean forced) {
...
Handle(TCollection_HAsciiString) IFSelect_SignCounter::Sign(const Handle(Standard_Transient) & ent,
...
Standard_CString IFSelect_SignCounter::ComputedSign(const Handle(Standard_Transient) & ent, const Interface_Graph& G) {
