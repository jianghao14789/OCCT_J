...
public:
    ...
    Standard_EXPORT Standard_Boolean SetAppliedModifiers(const Standard_Integer num,
    ...
    Standard_EXPORT Interface_CheckIterator Copy(IFSelect_ShareOutResult& eval, const Handle(IFSelect_WorkLibrary) & WL,
    ...
    Standard_EXPORT Interface_CheckIterator Send(IFSelect_ShareOutResult& eval, const Handle(IFSelect_WorkLibrary) & WL,
                                                 const Handle(Interface_Protocol) & protocol);
    ...
    Standard_EXPORT Interface_CheckIterator SendAll(const Standard_CString filename, const Interface_Graph& G,
    ...
    //! Returns True if well done, False else
    Standard_EXPORT Interface_CheckIterator SendSelected(const Standard_CString filename, const Interface_Graph& G,
                                                         const Handle(IFSelect_WorkLibrary) & WL,
                                                         const Handle(Interface_Protocol) & protocol,
    ...
    Standard_EXPORT void CopiedRemaining(const Interface_Graph& G, const Handle(IFSelect_WorkLibrary) & WL,
...
protected:
    ...
    Standard_EXPORT void CopiedModel(const Interface_Graph& G, const Handle(IFSelect_WorkLibrary) & WL,
                                     const Handle(Interface_Protocol) & protocol,
                                     const Interface_EntityIterator& topcopy, const TCollection_AsciiString& filename,
