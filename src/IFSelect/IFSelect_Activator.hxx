...
public:
    ...
    Standard_EXPORT static void Adding(const Handle(IFSelect_Activator) & actor, const Standard_Integer number,
    ...
    Standard_EXPORT static Standard_Boolean Select(const Standard_CString command, Standard_Integer& number,
    ...
    Standard_EXPORT static Handle(TColStd_HSequenceOfAsciiString)
