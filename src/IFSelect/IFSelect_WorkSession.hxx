...
public:
    ...
    Standard_EXPORT Standard_Integer NextIdentForLabel(const Standard_CString label, const Standard_Integer id,
    ...
    Standard_EXPORT Handle(Standard_Transient)
        NewParamFromStatic(const Standard_CString statname, const Standard_CString name = "");
    ...
    Standard_EXPORT Handle(TColStd_HSequenceOfTransient)
        SelectionResultFromList(const Handle(IFSelect_Selection) & sel,
    ...
    Standard_EXPORT Standard_Boolean ComputeCounterFromList(const Handle(IFSelect_SignCounter) & counter,
    ...
    Standard_EXPORT Standard_Boolean ChangeModifierRank(const Standard_Boolean formodel, const Standard_Integer before,
    ...
    Standard_EXPORT Handle(Standard_Transient)
        UsesAppliedModifier(const Handle(IFSelect_GeneralModifier) & modif) const;
    ...
    Standard_EXPORT Handle(IFSelect_Transformer)
        NewTransformStandard(const Standard_Boolean copy, const Standard_CString name = "");
    ...
    //! Fills LastRunCheckList
    Standard_EXPORT IFSelect_ReturnStatus SendAll(const Standard_CString filename,
    ...
    //! Fills LastRunCheckList
    Standard_EXPORT IFSelect_ReturnStatus SendSelected(const Standard_CString filename,
                                                       const Handle(IFSelect_Selection) & sel,
                                                       const Standard_Boolean computegraph = Standard_False);
    ...
    Standard_EXPORT Handle(IFSelect_Selection)
        Source(const Handle(IFSelect_Selection) & sel, const Standard_Integer num = 1) const;
    ...
    Standard_EXPORT Handle(IFSelect_Selection)
        NewSelectPointed(const Handle(TColStd_HSequenceOfTransient) & list, const Standard_CString name);
    ...
    Standard_EXPORT Standard_Boolean SetSelectPointed(const Handle(IFSelect_Selection) & sel,
                                                      const Handle(TColStd_HSequenceOfTransient) & list,
    ...
    Standard_EXPORT Handle(TColStd_HSequenceOfTransient)
        GiveList(const Standard_CString first, const Standard_CString second = "") const;
    ...
    //! GiveList
    Standard_EXPORT Handle(TColStd_HSequenceOfTransient)
        GiveListFromList(const Standard_CString selname, const Handle(Standard_Transient) & ent) const;
    ...
    Standard_EXPORT Handle(TColStd_HSequenceOfTransient)
        GiveListCombined(const Handle(TColStd_HSequenceOfTransient) & l1,
                         const Handle(TColStd_HSequenceOfTransient) & l2, const Standard_Integer mode) const;
    ...
    Standard_EXPORT void DumpEntity(const Handle(Standard_Transient) & ent, const Standard_Integer level,
    ...
    Standard_EXPORT void PrintCheckList(Standard_OStream& S, const Interface_CheckIterator& checklist,
    ...
    Standard_EXPORT void PrintSignatureList(Standard_OStream& S, const Handle(IFSelect_SignatureList) & signlist,
    ...
    Standard_EXPORT void ListEntities(const Interface_EntityIterator& iter, const Standard_Integer mode,
                                      Standard_OStream& S) const;
