...
void IFSelect_ShareOut::AddModifier(const Handle(IFSelect_GeneralModifier) & modifier, const Standard_Integer atnum) {
    Standard_Boolean formodel = modifier->IsKind(STANDARD_TYPE(IFSelect_Modifier));
...
void IFSelect_ShareOut::AddModifier(const Handle(IFSelect_GeneralModifier) & modifier, const Standard_Integer dispnum,
...
void IFSelect_ShareOut::AddModif(const Handle(IFSelect_GeneralModifier) & modifier, const Standard_Boolean formodel,
                                 const Standard_Integer atnum) {
    if (formodel) {
...
Handle(IFSelect_GeneralModifier) IFSelect_ShareOut::GeneralModifier(const Standard_Boolean formodel,
...
Standard_Boolean IFSelect_ShareOut::RemoveModifier(const Standard_Boolean formodel, const Standard_Integer atnum) {
...
Standard_Boolean IFSelect_ShareOut::ChangeModifierRank(const Standard_Boolean formodel, const Standard_Integer before,
...
TCollection_AsciiString IFSelect_ShareOut::FileName(const Standard_Integer dnum, const Standard_Integer pnum,
