...
public:
    ...
    Standard_EXPORT void SetIntCase(const Standard_Boolean hasmin, const Standard_Integer valmin,
    ...
    Standard_EXPORT Standard_Boolean IsIntCase(Standard_Boolean& hasmin, Standard_Integer& valmin,
    ...
    Standard_EXPORT static Standard_Boolean MatchValue(const Standard_CString val, const TCollection_AsciiString& text,
