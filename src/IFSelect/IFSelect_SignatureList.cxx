...
void IFSelect_SignatureList::Init(
    const Standard_CString name, const NCollection_IndexedDataMap<TCollection_AsciiString, Standard_Integer>& theCount,
...
void IFSelect_SignatureList::PrintList(Standard_OStream& S, const Handle(Interface_InterfaceModel) & model,
    ...
    for (; iter.More(); iter.Next()) {
        ...
        if (nb > 5 && mod == IFSelect_ShortByItem) nc = 5;
