...
public:
    ...
    Standard_EXPORT virtual Handle(Standard_Transient)
        ListedEntity(const Standard_Integer num, const Handle(Standard_Transient) & ent) const = 0;
    ...
    Standard_EXPORT void FillResult(const Standard_Integer n1, const Standard_Integer n2,
