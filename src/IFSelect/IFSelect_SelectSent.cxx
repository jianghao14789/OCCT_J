...
IFSelect_SelectSent::IFSelect_SelectSent(const Standard_Integer sentcount, const Standard_Boolean atleast) {
    thecnt = sentcount;
    thelst = atleast;
}
...
Standard_Boolean IFSelect_SelectSent::Sort(const Standard_Integer, const Handle(Standard_Transient) &,
