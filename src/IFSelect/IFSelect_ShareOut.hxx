...
public:
    ...
    //! for a Dispatch
    Standard_EXPORT void AddModifier(const Handle(IFSelect_GeneralModifier) & modifier, const Standard_Integer dispnum,
    ...
    Standard_EXPORT void AddModif(const Handle(IFSelect_GeneralModifier) & modifier, const Standard_Boolean formodel,
    ...
    //! Model Modifiers if <formodel> is True, File Modifiers else
    Standard_EXPORT Handle(IFSelect_GeneralModifier)
        GeneralModifier(const Standard_Boolean formodel, const Standard_Integer num) const;
    ...
    Standard_EXPORT Standard_Boolean ChangeModifierRank(const Standard_Boolean formodel, const Standard_Integer befor,
    ...
    Standard_EXPORT TCollection_AsciiString FileName(const Standard_Integer dnum, const Standard_Integer pnum,
