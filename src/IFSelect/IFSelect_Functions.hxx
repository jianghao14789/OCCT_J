...
public:
    ...
    Standard_EXPORT static Handle(Standard_Transient)
        GiveEntity(const Handle(IFSelect_WorkSession) & WS, const Standard_CString name = "");
    ...
    Standard_EXPORT static Handle(TColStd_HSequenceOfTransient)
        GiveList(const Handle(IFSelect_WorkSession) & WS, const Standard_CString first = "",
    ...
    Standard_EXPORT static Handle(IFSelect_Dispatch)
        GiveDispatch(const Handle(IFSelect_WorkSession) & WS, const Standard_CString name,
