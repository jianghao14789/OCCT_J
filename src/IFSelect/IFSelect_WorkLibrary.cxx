...
Standard_Boolean IFSelect_WorkLibrary::CopyModel(const Handle(Interface_InterfaceModel) & /*original*/,
...
Standard_Integer IFSelect_WorkLibrary::ReadStream(const Standard_CString /*name*/, std::istream& /*istream*/,
