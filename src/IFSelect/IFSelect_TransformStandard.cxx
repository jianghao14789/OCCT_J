...
void IFSelect_TransformStandard::Copy(const Interface_Graph& G, Interface_CopyTool& TC,
...
void IFSelect_TransformStandard::StandardCopy(const Interface_Graph& G, Interface_CopyTool& TC,
                                              Handle(Interface_InterfaceModel) & newmod) const {
...
void IFSelect_TransformStandard::OnTheSpot(const Interface_Graph& G, Interface_CopyTool& TC,
                                           Handle(Interface_InterfaceModel) & newmod) const {
    Standard_Integer nb = G.Size();
    for (Standard_Integer i = 1; i <= nb; i++)
