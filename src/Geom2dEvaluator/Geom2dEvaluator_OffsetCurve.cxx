...
Geom2dEvaluator_OffsetCurve::Geom2dEvaluator_OffsetCurve(const Handle(Geom2d_Curve) & theBase,
    ...
    : Geom2dEvaluator_Curve(), myBaseCurve(theBase), myOffset(theOffset) {}

Geom2dEvaluator_OffsetCurve::Geom2dEvaluator_OffsetCurve(const Handle(Geom2dAdaptor_Curve) & theBase,
                                                         const Standard_Real theOffset)
    : Geom2dEvaluator_Curve(), myBaseAdaptor(theBase), myOffset(theOffset) {}
...
void Geom2dEvaluator_OffsetCurve::D1(const Standard_Real theU, gp_Pnt2d& theValue, gp_Vec2d& theD1) const {
    gp_Vec2d aD2;
    BaseD2(theU, theValue, theD1, aD2);
    Geom2dEvaluator::CalculateD1(theValue, theD1, aD2, myOffset);
}

void Geom2dEvaluator_OffsetCurve::D2(const Standard_Real theU, gp_Pnt2d& theValue, gp_Vec2d& theD1,
...
void Geom2dEvaluator_OffsetCurve::D3(const Standard_Real theU, gp_Pnt2d& theValue, gp_Vec2d& theD1, gp_Vec2d& theD2,
...
gp_Vec2d Geom2dEvaluator_OffsetCurve::DN(const Standard_Real theU, const Standard_Integer theDeriv) const {
...
void Geom2dEvaluator_OffsetCurve::BaseD1(const Standard_Real theU, gp_Pnt2d& theValue, gp_Vec2d& theD1) const {
    if (!myBaseAdaptor.IsNull())
...
void Geom2dEvaluator_OffsetCurve::BaseD2(const Standard_Real theU, gp_Pnt2d& theValue, gp_Vec2d& theD1,
                                         gp_Vec2d& theD2) const {
    if (!myBaseAdaptor.IsNull())
...
void Geom2dEvaluator_OffsetCurve::BaseD3(const Standard_Real theU, gp_Pnt2d& theValue, gp_Vec2d& theD1, gp_Vec2d& theD2,
                                         gp_Vec2d& theD3) const {
    if (!myBaseAdaptor.IsNull())
...
void Geom2dEvaluator_OffsetCurve::BaseD4(const Standard_Real theU, gp_Pnt2d& theValue, gp_Vec2d& theD1, gp_Vec2d& theD2,
                                         gp_Vec2d& theD3, gp_Vec2d& theD4) const {
    if (!myBaseAdaptor.IsNull()) {
        myBaseAdaptor->D3(theU, theValue, theD1, theD2, theD3);
...
gp_Vec2d Geom2dEvaluator_OffsetCurve::BaseDN(const Standard_Real theU, const Standard_Integer theDeriv) const {
    if (!myBaseAdaptor.IsNull()) return myBaseAdaptor->DN(theU, theDeriv);
    return myBaseCurve->DN(theU, theDeriv);
}

Standard_Boolean Geom2dEvaluator_OffsetCurve::AdjustDerivative(const Standard_Integer theMaxDerivative,
                                                               const Standard_Real theU, gp_Vec2d& theD1,
                                                               gp_Vec2d& theD2, gp_Vec2d& theD3,
