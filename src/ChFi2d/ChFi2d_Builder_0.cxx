...
gp_Pnt ComputePoint(const TopoDS_Vertex& V, const TopoDS_Edge& E, const Standard_Real D1, Standard_Real& Param1);
gp_Pnt ComputePoint(const TopoDS_Face& F, const Handle(Geom_Line) & L, const TopoDS_Edge& E, Standard_Real& Param);
...
TopoDS_Edge ChFi2d_Builder::AddChamfer(const TopoDS_Edge& E1, const TopoDS_Edge& E2, const Standard_Real D1,
    ...
    if (status == ChFi2d_IsDone || status == ChFi2d_FirstEdgeDegenerated || status == ChFi2d_LastEdgeDegenerated ||
...
TopoDS_Edge ChFi2d_Builder::AddChamfer(const TopoDS_Edge& E, const TopoDS_Vertex& V, const Standard_Real D,
...
void ChFi2d_Builder::ComputeChamfer(const TopoDS_Vertex& V, const TopoDS_Edge& E1, const TopoDS_Edge& E2,
...
void ChFi2d_Builder::ComputeChamfer(const TopoDS_Vertex& V, const TopoDS_Edge& E1, const Standard_Real D,
...
TopoDS_Edge ChFi2d_Builder::ModifyChamfer(const TopoDS_Edge& Chamfer, const TopoDS_Edge& /*E1*/, const TopoDS_Edge& E2,
...
TopoDS_Edge ChFi2d_Builder::ModifyChamfer(const TopoDS_Edge& Chamfer, const TopoDS_Edge& E, const Standard_Real D,
                                          const Standard_Real Ang) {
    TopoDS_Vertex aVertex = RemoveChamfer(Chamfer);
    TopoDS_Edge adjEdge1, adjEdge2;
    status = ChFi2d::FindConnectedEdges(newFace, aVertex, adjEdge1, adjEdge2);
...
// purpose  :
//=======================================================================
TopoDS_Edge ChFi2d_Builder::BuildChamferEdge(const TopoDS_Vertex& V, const TopoDS_Edge& AdjEdge1,
                                             const TopoDS_Edge& AdjEdge2, const Standard_Real D1,
                                             const Standard_Real D2, TopoDS_Vertex& NewExtr1, TopoDS_Vertex& NewExtr2) {
    TopoDS_Edge chamfer;
    if (D1 <= 0 || D2 <= 0) {
...
// purpose  :
//=======================================================================
TopoDS_Edge ChFi2d_Builder::BuildChamferEdge(const TopoDS_Vertex& V, const TopoDS_Edge& AdjEdge1, const Standard_Real D,
                                             const Standard_Real Ang, const TopoDS_Edge& AdjEdge2,
...
gp_Pnt ComputePoint(const TopoDS_Vertex& V, const TopoDS_Edge& E, const Standard_Real D, Standard_Real& Param) {
    // geometric support
...
gp_Pnt ComputePoint(const TopoDS_Face& F, const Handle(Geom_Line) & L, const TopoDS_Edge& E, Standard_Real& Param) {
    ...
    Geom2dInt_GInter Intersection(adaptorL, adaptorC, Precision::PIntersection(), Precision::PIntersection());
...
Standard_Boolean IsLineOrCircle(const TopoDS_Edge& E, const TopoDS_Face& F) {
    ...
    if (basisC->DynamicType() == STANDARD_TYPE(Geom2d_Circle) || basisC->DynamicType() == STANDARD_TYPE(Geom2d_Line)) {
