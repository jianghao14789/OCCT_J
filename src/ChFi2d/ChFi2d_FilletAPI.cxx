...
ChFi2d_FilletAPI::ChFi2d_FilletAPI(const TopoDS_Edge& theEdge1, const TopoDS_Edge& theEdge2, const gp_Pln& thePlane)
    : myIsAnalytical(Standard_False) {
...
void ChFi2d_FilletAPI::Init(const TopoDS_Wire& theWire, const gp_Pln& thePlane) {
    ...
    if (!E1.IsNull() && !E2.IsNull()) myIsAnalytical = IsAnalytical(E1, E2);
...
void ChFi2d_FilletAPI::Init(const TopoDS_Edge& theEdge1, const TopoDS_Edge& theEdge2, const gp_Pln& thePlane) {
    // Decide whether we may apply an analytical solution.
...
TopoDS_Edge ChFi2d_FilletAPI::Result(const gp_Pnt& thePoint, TopoDS_Edge& theEdge1, TopoDS_Edge& theEdge2,
...
Standard_Boolean ChFi2d_FilletAPI::IsAnalytical(const TopoDS_Edge& theEdge1, const TopoDS_Edge& theEdge2) {
