...
static Standard_Boolean IsIssuedFrom(const TopoDS_Edge& E, const TopTools_IndexedMapOfShape& Map,
...
void ChFi2d_Builder::Init(const TopoDS_Face& RefFace, const TopoDS_Face& ModFace) {
    ...
    while (ex.More()) {
        ...
        if (!refEdgesMap.Contains(currentEdge)) newEdges.Append(currentEdge);
        ex.Next();
    } // while (ex ...
...
//=======================================================================
Standard_Boolean IsIssuedFrom(const TopoDS_Edge& E, const TopTools_IndexedMapOfShape& Map, TopoDS_Edge& BasisEdge) {
    ...
    for (Standard_Integer i = 1; i <= Map.Extent(); i++) {
        ...
        if (c1 == c2 &&
            (((f1 > f2 && f1 < L2) || (L1 > f2 && L1 < L2)) || ((f1 > L2 && f1 < f2) || (L1 > L2 && L1 < f2)))) {
...
void ChFi2d_Builder::ComputeFillet(const TopoDS_Vertex& V, const TopoDS_Edge& E1, const TopoDS_Edge& E2,
...
void ChFi2d_Builder::BuildNewWire(const TopoDS_Edge& OldE1, const TopoDS_Edge& OldE2, const TopoDS_Edge& E1,
...
TopoDS_Edge ChFi2d_Builder::BuildNewEdge(const TopoDS_Edge& E1, const TopoDS_Vertex& OldExtr,
...
// purpose  :
//=======================================================================
void ChFi2d_Builder::UpDateHistory(const TopoDS_Edge& E1, const TopoDS_Edge& E2, const TopoDS_Edge& TrimE1,
                                   const TopoDS_Edge& TrimE2, const TopoDS_Edge& NewEdge, const Standard_Integer Id) {
...
// purpose  :
//=======================================================================
TopoDS_Edge ChFi2d_Builder::BuildFilletEdge(const TopoDS_Vertex& V, const TopoDS_Edge& AdjEdge1,
    ...
    Standard_Real Tol = Precision::Confusion();
    Geom2dGcc_Circ2d2TanRad Fillet(Geom2dGcc_QualifiedCurve(basisC1, Qual1), Geom2dGcc_QualifiedCurve(basisC2, Qual2),
                                   Radius, Tol);
    if (!Fillet.IsDone() || Fillet.NbSolutions() == 0) {
        ...
        while (nsol <= Fillet.NbSolutions()) {
            ...
            if (basisC1->DynamicType() == STANDARD_TYPE(Geom2d_Line)) {
                ...
                if ((basisC2->DynamicType() == STANDARD_TYPE(Geom2d_Circle)) &&
                    ...
                    //  cas param4<param3
                    inside = inside || (param4 < PPU2 && PPU2 < 2 * M_PI) || (0 <= PPU2 && PPU2 < param3 - 2 * M_PI);
                }
                if (inside && dist < dist1) {
                    numsol = nsol;
                    dist1 = dist;
        ...
        if ((O1 == TopAbs_FORWARD && OE1 == TopAbs_FORWARD) || (O1 == TopAbs_REVERSED && OE1 == TopAbs_REVERSED)) {
