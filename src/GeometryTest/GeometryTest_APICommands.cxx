...
static void showProjSolution(Draw_Interpretor& di, const Standard_Integer i, const gp_Pnt& P, const gp_Pnt& P1,
                             const Standard_Real U, const Standard_Real V, const Standard_Boolean isSurface) {
    char name[100];
...
static Standard_Integer proj(Draw_Interpretor& di, Standard_Integer n, const char** a) {
    ...
    if (n == 6 && a[5][0] == 't') aProjAlgo = Extrema_ExtAlgo_Tree;
...
void GeometryTest::APICommands(Draw_Interpretor& theCommands) {
    ...
    theCommands.Add("surfint", "surfint result surf nbupoint nbvpoint [uperiodic]", __FILE__, surfint);

    theCommands.Add("grilapp", "grilapp result nbupoint nbvpoint X0 dX Y0 dY z11 z12 .. z1nu ....  ", __FILE__,
                    grilapp);
