...
// Purpose  :
//===========================================================
static void ClearHighlightAndSelection(const Handle(ShapePipelineMap) & theMap, const Standard_Boolean doHighlighting,
...
vtkStandardNewMacro(IVtkDraw_Interactor)
    ...
    :
#ifdef _WIN32
      myWindowId(NULL), myMouseInWindow(0)
#else
...
#else
    Tcl_CreateFileHandler(ConnectionNumber(this->myDisplayId), TCL_READABLE, ProcessEvents, (ClientData)this);
#endif
    ...
    if (anActorCollection) {
        ...
        while (vtkActor* anActor = anActorCollection->GetNextActor()) {
            ...
            if (!myPipelines->IsBound(aShapeID)) {
                anOutput->SendWarning() << "Warning: there is no VTK pipeline registered for highlighted shape"
                                        << std::endl;
                continue;
            }
...
// Purpose  :
//===========================================================
void IVtkDraw_Interactor::OnMouseMove(HWND theHWnd, UINT theNFlags, Standard_Integer theX, Standard_Integer theY) {
    if (!this->Enabled) {
        return;
    }
    ...
    if (!this->myMouseInWindow && (theX >= 0 && theX < this->Size[0] && theY >= 0 && theY < this->Size[1])) {
    ...
    if (!(theNFlags & MK_LBUTTON)) this->MoveTo(theX, this->Size[1] - theY - 1);
...
// Purpose  :
//===========================================================
void IVtkDraw_Interactor::OnMouseWheelForward(HWND, UINT theNFlags, Standard_Integer theX, Standard_Integer theY) {
    if (!this->Enabled) {
        return;
    }
...
// Purpose  :
//===========================================================
void IVtkDraw_Interactor::OnMouseWheelBackward(HWND, UINT theNFlags, Standard_Integer theX, Standard_Integer theY) {
    if (!this->Enabled) {
        return;
    }
...
// Purpose  :
//===========================================================
void IVtkDraw_Interactor::OnLButtonDown(HWND theHWnd, UINT theNFlags, Standard_Integer theX, Standard_Integer theY,
    ...
    SetFocus(theHWnd);
    SetCapture(theHWnd);
    this->SetEventInformationFlipY(theX, theY, theNFlags & MK_CONTROL, theNFlags & MK_SHIFT, 0, theRepeat);
    this->SetAltKey(GetKeyState(VK_MENU) & (~1));
...
// Purpose  :
//===========================================================
void IVtkDraw_Interactor::OnLButtonUp(HWND, UINT theNFlags, Standard_Integer theX, Standard_Integer theY) {
    if (!this->Enabled) {
        return;
    }
...
// Purpose  :
//===========================================================
void IVtkDraw_Interactor::OnMButtonDown(HWND theHWnd, UINT theNFlags, Standard_Integer theX, Standard_Integer theY,
                                        Standard_Integer theRepeat) {
    if (!this->Enabled) {
        return;
    }
...
// Purpose  :
//===========================================================
void IVtkDraw_Interactor::OnMButtonUp(HWND, UINT theNFlags, Standard_Integer theX, Standard_Integer theY) {
    if (!this->Enabled) {
        return;
    }
    this->SetEventInformationFlipY(theX, theY, theNFlags & MK_CONTROL, theNFlags & MK_SHIFT);
...
// Purpose  :
//===========================================================
void IVtkDraw_Interactor::OnRButtonDown(HWND theHWnd, UINT theNFlags, Standard_Integer theX, Standard_Integer theY,
                                        Standard_Integer theRepeat) {
    if (!this->Enabled) {
        return;
    }
...
// Purpose  :
//===========================================================
void IVtkDraw_Interactor::OnRButtonUp(HWND, UINT theNFlags, Standard_Integer theX, Standard_Integer theY) {
    if (!this->Enabled) {
        return;
    }
    this->SetEventInformationFlipY(theX, theY, theNFlags & MK_CONTROL, theNFlags & MK_SHIFT);
...
// Purpose  :
//===========================================================
LRESULT CALLBACK ViewerWindowProc(HWND theHWnd, UINT theMsg, WPARAM theWParam, LPARAM theLParam,
...
void IVtkDraw_Interactor::GetMousePosition(Standard_Integer* theX, Standard_Integer* theY) {
    ...
    XQueryPointer(this->myDisplayId, this->myWindowId, &aRoot, &aChild, &aRoot_x, &aRoot_y, theX, theY, &aKeys);
}
    ...
    switch (anEvent.type) {
        ...
        case EnterNotify: {
            if (this->Enabled) {
                ...
                this->SetEventInformationFlipY(anEnterEvent->x, anEnterEvent->y,
        ...
        case LeaveNotify: {
            if (this->Enabled) {
                ...
                this->SetEventInformationFlipY(aLeaveEvent->x, aLeaveEvent->y, (aLeaveEvent->state & ControlMask) != 0,
        ...
        case MotionNotify: {
            ...
            this->SetEventInformationFlipY(aXp, aYp, aCtrl, aShift);
            this->SetAltKey(anAlt);
            if (!myIsLeftButtonPressed) MoveTo(aXp, this->Size[1] - aYp - 1);
            this->InvokeEvent(vtkCommand::MouseMoveEvent, NULL);
        } break;
    }
