...
ViewerTest_EventManager::ViewerTest_EventManager(const Handle(V3d_View) & theView,
    ...
    : myCtx(theCtx), myView(theView), myToPickPnt(Standard_False), myIsTmpContRedraw(Standard_False),
      myUpdateRequests(0) {
    ...
    addActionHotKeys(Aspect_VKey_NavSpeedIncrease, Aspect_VKey_Plus, Aspect_VKey_Plus | Aspect_VKeyFlags_SHIFT,
                     Aspect_VKey_Equal, Aspect_VKey_NumpadAdd, Aspect_VKey_NumpadAdd | Aspect_VKeyFlags_SHIFT);
...
// purpose  :
// =======================================================================
bool ViewerTest_EventManager::UpdateMouseClick(const Graphic3d_Vec2i& thePoint, Aspect_VKeyMouse theButton,
...
// purpose  :
//=======================================================================
bool ViewerTest_EventManager::UpdateMouseButtons(const Graphic3d_Vec2i& thePoint, Aspect_VKeyMouse theButtons,
...
// purpose  :
// =======================================================================
bool ViewerTest_EventManager::navigationKeyModifierSwitch(unsigned int theModifOld, unsigned int theModifNew,
                                                          double theTimeStamp) {
...
void ViewerTest_EventManager::ProcessKeyPress(Aspect_VKey theKey) {
    ...
    switch (theKey) {
        ...
        {
            myCtx->DefaultDrawer()->SetTypeOfHLR(
                myCtx->DefaultDrawer()->TypeOfHLR() == Prs3d_TOH_Algo ? Prs3d_TOH_PolyAlgo : Prs3d_TOH_Algo);
            if (myCtx->NbSelected() == 0) {
        ...
        case Aspect_VKey_NavSpeedIncrease: {
            // handle slide speed
            float aNewSpeed =
                theKey == Aspect_VKey_NavSpeedDecrease ? myWalkSpeedRelative * 0.5f : myWalkSpeedRelative * 2.0f;
...
EM_JS(void, occJSUpdateBoundingClientRect, (), { Module._myCanvasRect = Module.canvas.getBoundingClientRect(); });
