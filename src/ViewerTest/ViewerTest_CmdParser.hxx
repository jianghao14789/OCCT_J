...
public:
    ...
    bool HasOption(const std::string& theOptionName, std::size_t theMandatoryArgsNb = 0,
    ...
    //! @param isFatal the flag that controls printing of an error message
    //! @return true if an option was set, or false otherwise
    bool HasOption(ViewerTest_CommandOptionKey theOptionKey, std::size_t theMandatoryArgsNb = 0,
                   bool isFatal = Standard_False) const;
    ...
    //! @return true if an access was successful, or false otherwise
    bool Arg(ViewerTest_CommandOptionKey theOptionKey, Standard_Integer theArgumentIndex,
    ...
    //! @return true if an interpretation was successful, or false otherwise
    template <typename TheColor>
    bool ArgColor(ViewerTest_CommandOptionKey theOptionKey, Standard_Integer& theArgumentIndex,
