...
BRepToIGESBRep_Entity::BRepToIGESBRep_Entity() {
    Init();
    if (myEdgeList.IsNull()) myEdgeList = new IGESSolid_EdgeList;
    if (myVertexList.IsNull()) myVertexList = new IGESSolid_VertexList;
}
...
void BRepToIGESBRep_Entity::TransferEdgeList() {
    ...
    Handle(IGESSolid_HArray1OfVertexList) startVertexList = new IGESSolid_HArray1OfVertexList(1, nbedges);
    Handle(TColStd_HArray1OfInteger) startVertexIndex = new TColStd_HArray1OfInteger(1, nbedges);
    Handle(IGESSolid_HArray1OfVertexList) endVertexList = new IGESSolid_HArray1OfVertexList(1, nbedges);
...
// purpose  :
//=======================================================================
Handle(IGESData_IGESEntity) BRepToIGESBRep_Entity::TransferShape(const TopoDS_Shape& start,
...
Handle(IGESData_IGESEntity) BRepToIGESBRep_Entity::TransferEdge(const TopoDS_Edge& myedge, const TopoDS_Face& myface,
...
Handle(IGESSolid_Loop) BRepToIGESBRep_Entity::TransferWire(const TopoDS_Wire& mywire, const TopoDS_Face& myface,
                                                           const Standard_Real Length) {
    ...
    Handle(IGESBasic_HArray1OfHArray1OfInteger) isoflags = new IGESBasic_HArray1OfHArray1OfInteger(1, nbedges);
    Standard_Integer myisoflag;
    Handle(IGESData_HArray1OfIGESEntity) curve;
    Handle(IGESBasic_HArray1OfHArray1OfIGESEntity) curves = new IGESBasic_HArray1OfHArray1OfIGESEntity(1, nbedges);
    Handle(IGESData_IGESEntity) mycurve;
...
Handle(IGESSolid_Shell) BRepToIGESBRep_Entity ::TransferShell(const TopoDS_Shell& start,
    ...
    for (Ex.Init(start, TopAbs_FACE); Ex.More() && aPS.More(); Ex.Next(), aPS.Next()) {
        ...
        if (start.Orientation() == TopAbs_REVERSED)
            F.Reverse(); //: l4 abv 12 Jan 99: CTS22022-2: writing reversed shells
        if (F.IsNull()) {
