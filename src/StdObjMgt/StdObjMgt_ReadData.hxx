...
public:
    ...
    template <class Persistent> StdObjMgt_ReadData& operator>>(Handle(Persistent) & theTarget) {
    ...
    template <class Type> StdObjMgt_ReadData& ReadValue(Type& theValue) {
        *myDriver >> theValue;
        return *this;
    }
...
Standard_EXPORT StdObjMgt_ReadData& operator>>(StdObjMgt_ReadData& theReadData, Standard_GUID& theGUID);
