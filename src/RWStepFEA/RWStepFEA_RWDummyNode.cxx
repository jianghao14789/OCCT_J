...
void RWStepFEA_RWDummyNode::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                     Handle(Interface_Check) & ach, const Handle(StepFEA_DummyNode) & ent) const {
    ...
    data->ReadEntity(num, 4, "node_representation.model_ref", ach, STANDARD_TYPE(StepFEA_FeaModel),
...
void RWStepFEA_RWDummyNode::WriteStep(StepData_StepWriter& SW, const Handle(StepFEA_DummyNode) & ent) const {
...
void RWStepFEA_RWDummyNode::Share(const Handle(StepFEA_DummyNode) & ent, Interface_EntityIterator& iter) const {
