...
void RWStepFEA_RWCurve3dElementProperty::ReadStep(const Handle(StepData_StepReaderData) & data,
    ...
    if (data->ReadSubList(num, 3, "interval_definitions", ach, sub3)) {
        ...
        for (Standard_Integer i0 = 1; i0 <= nb0; i0++) {
            ...
            data->ReadEntity(num2, i0, "curve_element_interval", ach, STANDARD_TYPE(StepFEA_CurveElementInterval),
                             anIt0);
    ...
    if (data->ReadSubList(num, 4, "end_offsets", ach, sub4)) {
        ...
        for (Standard_Integer i0 = 1; i0 <= nb0; i0++) {
            ...
            data->ReadEntity(num2, i0, "curve_element_end_offset", ach, STANDARD_TYPE(StepFEA_CurveElementEndOffset),
                             anIt0);
    ...
    if (data->ReadSubList(num, 5, "end_releases", ach, sub5)) {
        ...
        for (Standard_Integer i0 = 1; i0 <= nb0; i0++) {
            ...
            data->ReadEntity(num2, i0, "curve_element_end_release", ach, STANDARD_TYPE(StepFEA_CurveElementEndRelease),
                             anIt0);
