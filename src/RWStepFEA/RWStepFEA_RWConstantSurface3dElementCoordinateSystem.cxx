...
void RWStepFEA_RWConstantSurface3dElementCoordinateSystem::WriteStep(
    StepData_StepWriter& SW, const Handle(StepFEA_ConstantSurface3dElementCoordinateSystem) & ent) const {
...
void RWStepFEA_RWConstantSurface3dElementCoordinateSystem::Share(
    const Handle(StepFEA_ConstantSurface3dElementCoordinateSystem) &, Interface_EntityIterator&) const {
    // Inherited fields of RepresentationItem
    // Own fields of ConstantSurface3dElementCoordinateSystem
}
