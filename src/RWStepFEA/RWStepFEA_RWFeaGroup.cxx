...
void RWStepFEA_RWFeaGroup::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepFEA_RWFeaGroup::WriteStep(StepData_StepWriter& SW, const Handle(StepFEA_FeaGroup) & ent) const {
...
void RWStepFEA_RWFeaGroup::Share(const Handle(StepFEA_FeaGroup) & ent, Interface_EntityIterator& iter) const {
