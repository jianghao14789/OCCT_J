...
void RWStepFEA_RWGeometricNode::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepFEA_RWGeometricNode::WriteStep(StepData_StepWriter& SW, const Handle(StepFEA_GeometricNode) & ent) const {
...
void RWStepFEA_RWGeometricNode::Share(const Handle(StepFEA_GeometricNode) & ent, Interface_EntityIterator& iter) const {
