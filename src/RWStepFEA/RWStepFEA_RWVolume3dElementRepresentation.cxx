...
void RWStepFEA_RWVolume3dElementRepresentation::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                         ...
                                                         const Handle(StepFEA_Volume3dElementRepresentation) &
                                                             ent) const {
    ...
    data->ReadEntity(num, 6, "element_descriptor", ach, STANDARD_TYPE(StepElement_Volume3dElementDescriptor),
                     aElementDescriptor);
    ...
    ent->Init(aRepresentation_Name, aRepresentation_Items, aRepresentation_ContextOfItems,
              aElementRepresentation_NodeList, aModelRef, aElementDescriptor, aMaterial);
}
