...
void RWStepFEA_RWNodeGroup::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                     Handle(Interface_Check) & ach, const Handle(StepFEA_NodeGroup) & ent) const {
...
void RWStepFEA_RWNodeGroup::WriteStep(StepData_StepWriter& SW, const Handle(StepFEA_NodeGroup) & ent) const {
...
void RWStepFEA_RWNodeGroup::Share(const Handle(StepFEA_NodeGroup) & ent, Interface_EntityIterator& iter) const {
