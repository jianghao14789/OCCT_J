...
void RWStepFEA_RWNodeDefinition::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepFEA_RWNodeDefinition::WriteStep(StepData_StepWriter& SW, const Handle(StepFEA_NodeDefinition) & ent) const {
