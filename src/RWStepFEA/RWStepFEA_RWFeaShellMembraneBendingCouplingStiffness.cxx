...
void RWStepFEA_RWFeaShellMembraneBendingCouplingStiffness::WriteStep(
    StepData_StepWriter& SW, const Handle(StepFEA_FeaShellMembraneBendingCouplingStiffness) & ent) const {
...
void RWStepFEA_RWFeaShellMembraneBendingCouplingStiffness::Share(
    const Handle(StepFEA_FeaShellMembraneBendingCouplingStiffness) & ent, Interface_EntityIterator& iter) const {
