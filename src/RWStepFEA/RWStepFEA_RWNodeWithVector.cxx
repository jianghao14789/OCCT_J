...
void RWStepFEA_RWNodeWithVector::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepFEA_RWNodeWithVector::WriteStep(StepData_StepWriter& SW, const Handle(StepFEA_NodeWithVector) & ent) const {
