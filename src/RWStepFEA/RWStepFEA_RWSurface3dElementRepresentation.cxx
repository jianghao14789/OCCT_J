...
void RWStepFEA_RWSurface3dElementRepresentation::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                          ...
                                                          const Handle(StepFEA_Surface3dElementRepresentation) &
                                                              ent) const {
    ...
    data->ReadEntity(num, 6, "element_descriptor", ach, STANDARD_TYPE(StepElement_Surface3dElementDescriptor),
                     aElementDescriptor);
    ...
    ent->Init(aRepresentation_Name, aRepresentation_Items, aRepresentation_ContextOfItems,
              aElementRepresentation_NodeList, aModelRef, aElementDescriptor, aProperty, aMaterial);
}
