...
void RWStepFEA_RWNodeSet::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                   Handle(Interface_Check) & ach, const Handle(StepFEA_NodeSet) & ent) const {
...
void RWStepFEA_RWNodeSet::WriteStep(StepData_StepWriter& SW, const Handle(StepFEA_NodeSet) & ent) const {
...
void RWStepFEA_RWNodeSet::Share(const Handle(StepFEA_NodeSet) & ent, Interface_EntityIterator& iter) const {
