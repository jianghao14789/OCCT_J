...
void RWStepFEA_RWParametricCurve3dElementCoordinateSystem::ReadStep(
    ...
    data->ReadEntity(num, 2, "direction", ach, STANDARD_TYPE(StepFEA_ParametricCurve3dElementCoordinateDirection),
                     aDirection);
...
void RWStepFEA_RWParametricCurve3dElementCoordinateSystem::WriteStep(
    StepData_StepWriter& SW, const Handle(StepFEA_ParametricCurve3dElementCoordinateSystem) & ent) const {
...
void RWStepFEA_RWParametricCurve3dElementCoordinateSystem::Share(
    const Handle(StepFEA_ParametricCurve3dElementCoordinateSystem) & ent, Interface_EntityIterator& iter) const {
