...
void RWStepFEA_RWArbitraryVolume3dElementCoordinateSystem::WriteStep(
    StepData_StepWriter& SW, const Handle(StepFEA_ArbitraryVolume3dElementCoordinateSystem) & ent) const {
...
void RWStepFEA_RWArbitraryVolume3dElementCoordinateSystem::Share(
    const Handle(StepFEA_ArbitraryVolume3dElementCoordinateSystem) & ent, Interface_EntityIterator& iter) const {
