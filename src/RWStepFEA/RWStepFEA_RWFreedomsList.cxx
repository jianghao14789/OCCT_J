...
void RWStepFEA_RWFreedomsList::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                        Handle(Interface_Check) & ach, const Handle(StepFEA_FreedomsList) & ent) const {
...
void RWStepFEA_RWFreedomsList::WriteStep(StepData_StepWriter& SW, const Handle(StepFEA_FreedomsList) & ent) const {
...
void RWStepFEA_RWFreedomsList::Share(const Handle(StepFEA_FreedomsList) & ent, Interface_EntityIterator& iter) const {
