...
void RWStepFEA_RWAlignedSurface3dElementCoordinateSystem::WriteStep(
    StepData_StepWriter& SW, const Handle(StepFEA_AlignedSurface3dElementCoordinateSystem) & ent) const {
...
void RWStepFEA_RWAlignedSurface3dElementCoordinateSystem::Share(
    const Handle(StepFEA_AlignedSurface3dElementCoordinateSystem) & ent, Interface_EntityIterator& iter) const {
