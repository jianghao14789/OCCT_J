...
void RWStepFEA_RWFeaModel3d::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
    ...
    // Initialize entity
    ent->Init(aRepresentation_Name, aRepresentation_Items, aRepresentation_ContextOfItems, aFeaModel_CreatingSoftware,
              aFeaModel_IntendedAnalysisCode, aFeaModel_Description, aFeaModel_AnalysisType);
}
...
void RWStepFEA_RWFeaModel3d::WriteStep(StepData_StepWriter& SW, const Handle(StepFEA_FeaModel3d) & ent) const {
...
void RWStepFEA_RWFeaModel3d::Share(const Handle(StepFEA_FeaModel3d) & ent, Interface_EntityIterator& iter) const {
