...
void RWStepFEA_RWParametricCurve3dElementCoordinateDirection::WriteStep(
    StepData_StepWriter& SW, const Handle(StepFEA_ParametricCurve3dElementCoordinateDirection) & ent) const {
...
void RWStepFEA_RWParametricCurve3dElementCoordinateDirection::Share(
    const Handle(StepFEA_ParametricCurve3dElementCoordinateDirection) & ent, Interface_EntityIterator& iter) const {
