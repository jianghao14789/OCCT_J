...
void RWStepFEA_RWElementGroup::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                        Handle(Interface_Check) & ach, const Handle(StepFEA_ElementGroup) & ent) const {
    ...
    if (data->ReadSubList(num, 4, "elements", ach, sub4)) {
        ...
        for (Standard_Integer i0 = 1; i0 <= nb0; i0++) {
            ...
            data->ReadEntity(num2, i0, "element_representation", ach, STANDARD_TYPE(StepFEA_ElementRepresentation),
                             anIt0);
...
void RWStepFEA_RWElementGroup::WriteStep(StepData_StepWriter& SW, const Handle(StepFEA_ElementGroup) & ent) const {
...
void RWStepFEA_RWElementGroup::Share(const Handle(StepFEA_ElementGroup) & ent, Interface_EntityIterator& iter) const {
