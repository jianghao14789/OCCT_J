...
// purpose  :
//=======================================================================
PrsDim_ConcentricRelation::PrsDim_ConcentricRelation(const TopoDS_Shape& aFShape, const TopoDS_Shape& aSShape,
...
void PrsDim_ConcentricRelation::ComputeSelection(const Handle(SelectMgr_Selection) & aSelection,
    ...
    seg = new Select3D_SensitiveSegment(own, otherPnt, myPnt);
    aSelection->Add(seg);
    ...
    seg = new Select3D_SensitiveSegment(own, FPnt, SPnt);
    aSelection->Add(seg);
}
