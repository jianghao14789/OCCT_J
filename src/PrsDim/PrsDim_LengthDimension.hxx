...
public:
    ...
    Standard_EXPORT PrsDim_LengthDimension(const TopoDS_Face& theFirstFace, const TopoDS_Face& theSecondFace);
    ...
    Standard_EXPORT PrsDim_LengthDimension(const gp_Pnt& theFirstPoint, const gp_Pnt& theSecondPoint,
    ...
    //! @param thePlane [in] the plane to orient dimension.
    Standard_EXPORT PrsDim_LengthDimension(const TopoDS_Shape& theFirstShape, const TopoDS_Shape& theSecondShape,
                                           const gp_Pln& thePlane);
...
public:
    ...
    //! @param theFirstShape [in] the first shape.
    //! @param theSecondShape [in] the second shape.
    Standard_EXPORT void SetMeasuredShapes(const TopoDS_Shape& theFirstShape, const TopoDS_Shape& theSecondShape);
...
protected:
    ...
    Standard_EXPORT virtual void ComputeFlyoutSelection(const Handle(SelectMgr_Selection) & theSelection,
                                                        const Handle(SelectMgr_EntityOwner) &
                                                            theEntityOwner) Standard_OVERRIDE;

protected:
    //! Checks that distance between two points is valid.
    //! @param theFirstPoint [in] the first point.
    //! @param theSecondPoint [in] the second point.
    Standard_EXPORT Standard_Boolean IsValidPoints(const gp_Pnt& theFirstPoint, const gp_Pnt& theSecondPoint) const;

    Standard_EXPORT Standard_Boolean InitTwoEdgesLength(const TopoDS_Edge& theFirstEdge,
                                                        const TopoDS_Edge& theSecondEdge, gp_Dir& theEdgeDir);
    ...
    Standard_EXPORT Standard_Boolean InitEdgeVertexLength(const TopoDS_Edge& theEdge, const TopoDS_Vertex& theVertex,
                                                          gp_Dir& theEdgeDir, Standard_Boolean isInfinite);
    ...
    //! @param theEdgeDir [out] is the direction on the edge to build automatic plane.
    Standard_EXPORT Standard_Boolean InitEdgeFaceLength(const TopoDS_Edge& theEdge, const TopoDS_Face& theFace,
                                                        gp_Dir& theEdgeDir);
    ...
    Standard_EXPORT Standard_Boolean InitTwoShapesPoints(const TopoDS_Shape& theFirstShape,
                                                         const TopoDS_Shape& theSecondShape, gp_Pln& theComputedPlane,
