...
PrsDim_LengthDimension::PrsDim_LengthDimension()
    : PrsDim_Dimension(PrsDim_KOD_LENGTH), myHasCustomDirection(Standard_False) {
    SetFlyout(15.0);
}
...
//=======================================================================
PrsDim_LengthDimension::PrsDim_LengthDimension(const TopoDS_Face& theFirstFace, const TopoDS_Face& theSecondFace)
    : PrsDim_Dimension(PrsDim_KOD_LENGTH), myHasCustomDirection(Standard_False) {
...
//=======================================================================
PrsDim_LengthDimension::PrsDim_LengthDimension(const TopoDS_Face& theFace, const TopoDS_Edge& theEdge)
    : PrsDim_Dimension(PrsDim_KOD_LENGTH), myHasCustomDirection(Standard_False) {
...
//=======================================================================
PrsDim_LengthDimension::PrsDim_LengthDimension(const gp_Pnt& theFirstPoint, const gp_Pnt& theSecondPoint,
...
// purpose  : Dimension between two shape
//=======================================================================
PrsDim_LengthDimension::PrsDim_LengthDimension(const TopoDS_Shape& theFirstShape, const TopoDS_Shape& theSecondShape,
                                               const gp_Pln& thePlane)
    : PrsDim_Dimension(PrsDim_KOD_LENGTH), myHasCustomDirection(Standard_False) {
...
// purpose  :
//=======================================================================
void PrsDim_LengthDimension::SetMeasuredGeometry(const gp_Pnt& theFirstPoint, const gp_Pnt& theSecondPoint,
                                                 const gp_Pln& thePlane) {
...
// purpose  :
//=======================================================================
void PrsDim_LengthDimension::SetMeasuredGeometry(const TopoDS_Face& theFirstFace, const TopoDS_Face& theSecondFace) {
...
// purpose  :
//=======================================================================
void PrsDim_LengthDimension::SetMeasuredGeometry(const TopoDS_Face& theFace, const TopoDS_Edge& theEdge) {
...
Standard_Real PrsDim_LengthDimension::ComputeValue() const {
    ...
    if (!myHasCustomDirection) return myFirstPoint.Distance(mySecondPoint);
...
void PrsDim_LengthDimension::ComputeFlyoutLinePoints(const gp_Pnt& theFirstPoint, const gp_Pnt& theSecondPoint,
    ...
    theLineBegPoint =
        ElCLib::Value(ElCLib::Parameter(aLine1, theFirstPoint) + GetFlyout() + aTargetProjectedToFlyout, aLine1);
...
Standard_Boolean PrsDim_LengthDimension::InitTwoEdgesLength(const TopoDS_Edge& theFirstEdge,
                                                            const TopoDS_Edge& theSecondEdge, gp_Dir& theDirAttach) {
    ...
    if (!PrsDim::ComputeGeometry(theFirstEdge, theSecondEdge, aFirstCurve, aSecondCurve, aPoint11, aPoint12, aPoint21,
                                 aPoint22, isFirstInfinite, isSecondInfinite)) {
        return Standard_False;
    }
...
Standard_Boolean PrsDim_LengthDimension::InitEdgeVertexLength(const TopoDS_Edge& theEdge,
                                                              const TopoDS_Vertex& theVertex, gp_Dir& theEdgeDir,
...
// purpose  :
//=======================================================================
Standard_Boolean PrsDim_LengthDimension::InitEdgeFaceLength(const TopoDS_Edge& theEdge, const TopoDS_Face& theFace,
                                                            gp_Dir& theEdgeDir) {
    theEdgeDir = gp::DX();
...
Standard_Boolean PrsDim_LengthDimension::InitTwoShapesPoints(const TopoDS_Shape& theFirstShape,
    ...
    switch (theFirstShape.ShapeType()) {
        case TopAbs_FACE: {
            ...
            PrsDim::InitFaceLength(TopoDS::Face(theFirstShape), aFirstPlane, aFirstSurface, aFirstSurfKind,
                                   aFirstOffset);
            ...
            if (theSecondShape.ShapeType() == TopAbs_FACE) {
                ...
                PrsDim::InitFaceLength(aSecondFace, aSecondPlane, aSecondSurface, aSecondSurfKind, aSecondOffset);
                ...
                } else // curvilinear faces
                {
                    ...
                    GeomAPI_ExtremaSurfaceSurface anExtrema(aFirstSurface, aSecondSurface, aU1Min, aU1Max, aV1Min,
                                                            aV1Max, aU2Min, aU2Max, aV2Min, aV2Max);
                ...
                isSuccess = InitEdgeFaceLength(TopoDS::Edge(theSecondShape), TopoDS::Face(theFirstShape), aDirAttach);
        ...
        case TopAbs_EDGE: {
            if (theSecondShape.ShapeType() == TopAbs_VERTEX) {
                ...
                isSuccess = InitEdgeVertexLength(TopoDS::Edge(theFirstShape), TopoDS::Vertex(theSecondShape),
                ...
                isSuccess = InitTwoEdgesLength(TopoDS::Edge(theFirstShape), TopoDS::Edge(theSecondShape), aDirAttach);
                ...
                myGeometryType = GeometryType_EdgeFace;
                isSuccess = InitEdgeFaceLength(TopoDS::Edge(theFirstShape), TopoDS::Face(theSecondShape), aDirAttach);
        ...
        case TopAbs_VERTEX: {
            if (theSecondShape.ShapeType() == TopAbs_VERTEX) {
                ...
                myGeometryType = GeometryType_EdgeVertex;
                isSuccess = InitEdgeVertexLength(TopoDS::Edge(theSecondShape), TopoDS::Vertex(theFirstShape),
                                                 aDirAttach, isInfinite);
                if (isSuccess) {
                    theComputedPlane = ComputePlane(aDirAttach);
                    theIsPlaneComputed = Standard_True;
...
void PrsDim_LengthDimension::SetDirection(const gp_Dir& theDirection, const Standard_Boolean theUseDirection) {
    ...
    if (myHasCustomDirection) myDirection = theDirection;
}
