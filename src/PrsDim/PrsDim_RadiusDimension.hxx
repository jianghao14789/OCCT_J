...
public:
    ...
    Standard_EXPORT void SetMeasuredGeometry(const gp_Circ& theCircle, const gp_Pnt& theAnchorPoint,
    ...
    //! @param theAnchorPoint [in] the point to attach the dimension lines, should be on the circle
    //! @param theHasAnchor   [in] should be set TRUE if theAnchorPoint should be used
    Standard_EXPORT void SetMeasuredGeometry(const TopoDS_Shape& theShape, const gp_Pnt& theAnchorPoint,
                                             const Standard_Boolean theHasAnchor = Standard_True);
...
protected:
    ...
    Standard_EXPORT Standard_Boolean IsValidAnchor(const gp_Circ& theCircle, const gp_Pnt& thePnt) const;
