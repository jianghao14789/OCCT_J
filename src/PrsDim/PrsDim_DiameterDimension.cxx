...
// purpose  :
//=======================================================================
PrsDim_DiameterDimension::PrsDim_DiameterDimension(const gp_Circ& theCircle) : PrsDim_Dimension(PrsDim_KOD_DIAMETER) {
...
// purpose  :
//=======================================================================
PrsDim_DiameterDimension::PrsDim_DiameterDimension(const TopoDS_Shape& theShape, const gp_Pln& thePlane)
    : PrsDim_Dimension(PrsDim_KOD_DIAMETER) {
    SetCustomPlane(thePlane);
    SetMeasuredGeometry(theShape);
    SetSpecialSymbol(THE_DIAMETER_SYMBOL);
...
void PrsDim_DiameterDimension::SetMeasuredGeometry(const TopoDS_Shape& theShape) {
    ...
    myAnchorPoint = gp::Origin();
    myIsGeometryValid =
        InitCircularDimension(theShape, myCircle, aDummyPnt, isClosed) && IsValidCircle(myCircle) && isClosed;
...
void PrsDim_DiameterDimension::ComputeAnchorPoint() {
    ...
    myAnchorPoint = (gp_Vec(aDir) * gp_Vec(myCircle.Position().Direction()) > 0.0) ? aFirstPoint : aSecondPoint;
}
...
// purpose  :
//=======================================================================
Standard_Boolean PrsDim_DiameterDimension::IsValidAnchor(const gp_Circ& theCircle, const gp_Pnt& theAnchor) const {
