...
//=======================================================================
PrsDim_PerpendicularRelation::PrsDim_PerpendicularRelation(const TopoDS_Shape& aFShape, const TopoDS_Shape& aSShape,
...
// purpose  :
//=======================================================================
void PrsDim_PerpendicularRelation::ComputeTwoFacesPerpendicular(const Handle(Prs3d_Presentation) & /*aPresentation*/) {}
...
void PrsDim_PerpendicularRelation::ComputeTwoEdgesPerpendicular(const Handle(Prs3d_Presentation) & aPresentation) {
    ...
    DsgPrs_PerpenPresentation::Add(aPresentation, myDrawer, myFAttach, mySAttach, p1, p2, myPosition, interOut1,
                                   interOut2);
