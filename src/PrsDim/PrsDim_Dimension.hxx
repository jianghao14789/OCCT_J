...
protected:
    ...
    Standard_EXPORT void DrawArrow(const Handle(Prs3d_Presentation) & thePresentation, const gp_Pnt& theLocation,
    ...
    Standard_EXPORT void drawText(const Handle(Prs3d_Presentation) & thePresentation, const gp_Pnt& theTextPos,
    ...
    Standard_EXPORT void ComputeLinearFlyouts(const Handle(SelectMgr_Selection) & theSelection,
                                              ...
                                              const gp_Pnt& theFirstPoint, const gp_Pnt& theSecondPoint);
    ...
    Standard_EXPORT Standard_Boolean InitCircularDimension(const TopoDS_Shape& theShape, gp_Circ& theCircle,
    ...
    Standard_EXPORT void PointsForArrow(const gp_Pnt& thePeakPnt, const gp_Dir& theDirection, const gp_Dir& thePlane,
    ...
    Standard_EXPORT gp_Pnt GetTextPositionForLinear(const gp_Pnt& theFirstPoint, const gp_Pnt& theSecondPoint,
    ...
    Standard_EXPORT void FitTextAlignmentForLinear(const gp_Pnt& theFirstPoint, const gp_Pnt& theSecondPoint,
    ...
    Standard_EXPORT Standard_Boolean AdjustParametersForLinear(const gp_Pnt& theTextPos, const gp_Pnt& theFirstPoint,
                                                               const gp_Pnt& theSecondPoint,
...
protected: //! @name Static auxilliary methods for geometry extraction
    ...
    static Standard_Boolean CircleFromPlanarFace(const TopoDS_Face& theFace, Handle(Geom_Curve) & theCurve,
    ...
    //! @param theSecondPoint [out] the point of the last parameter of the circlular curve
    //! @return TRUE in case of successful circle extraction.
    static Standard_Boolean CircleFromEdge(const TopoDS_Edge& theEdge, gp_Circ& theCircle, gp_Pnt& theFirstPoint,
                                           gp_Pnt& theLastPoint);
...
protected: //! @name Behavior to implement
    ...
    virtual Standard_Boolean CheckPlane(const gp_Pln& /*thePlane*/) const {
