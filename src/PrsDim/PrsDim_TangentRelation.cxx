...
// purpose  :
//=======================================================================
PrsDim_TangentRelation::PrsDim_TangentRelation(const TopoDS_Shape& aFShape, const TopoDS_Shape& aSShape,
                                               const Handle(Geom_Plane) & aPlane, const Standard_Integer anExternRef)
...
// purpose  :
//=======================================================================
void PrsDim_TangentRelation::ComputeSelection(const Handle(SelectMgr_Selection) & aSelection, const Standard_Integer) {
    gp_Vec vec(myDir);
...
// purpose  :
//=======================================================================
void PrsDim_TangentRelation::ComputeTwoFacesTangent(const Handle(Prs3d_Presentation) & /*aPresentation*/) {}
...
// purpose  :
//=======================================================================
static Standard_Boolean ComputeTangencyPoint(const Handle(Geom_Curve) & GC1, const Handle(Geom_Curve) & GC2,
                                             gp_Pnt& aPoint) {
...
void PrsDim_TangentRelation::ComputeTwoEdgesTangent(const Handle(Prs3d_Presentation) & aPresentation) {
    ...
    if (!PrsDim::ComputeGeometry(TopoDS::Edge(myFShape), TopoDS::Edge(mySShape), myExtShape, copy1, copy2, ptat11,
    ...
    switch (typArg) {
        case 12: // circle line
        {
            ...
            if (!isInfinite1) {
                ...
                if (copy1Length < myLength) myLength = copy1Length / 3.;
            }
        } break;
        case 21: // circle line
        {
            ...
            if (!isInfinite2) {
                ...
                if (copy2Length < myLength) myLength = copy2Length / 3.;
            }
        } break;
        // jfa 19/10/2000 begin
