...
public:
    ...
    Standard_EXPORT PrsDim_MaxRadiusDimension(const TopoDS_Shape& aShape, const Standard_Real aVal,
    ...
    Standard_EXPORT PrsDim_MaxRadiusDimension(const TopoDS_Shape& aShape, const Standard_Real aVal,
                                              ...
                                              const DsgPrs_ArrowSide aSymbolPrs, const Standard_Real anArrowSize = 0.0);
