...
public:
    ...
    BRepGProp_MeshProps(const BRepGProp_MeshObjType theType) : myType(theType) {}
    ...
    Standard_EXPORT void Perform(const Handle(Poly_Triangulation) & theMesh, const TopLoc_Location& theLoc,
                                 const TopAbs_Orientation theOri);

    Standard_EXPORT void Perform(const Handle(Poly_Triangulation) & theMesh, const TopAbs_Orientation theOri);
    ...
    Standard_EXPORT static void CalculateProps(const gp_Pnt& p1, const gp_Pnt& p2, const gp_Pnt& p3, const gp_Pnt& Apex,
