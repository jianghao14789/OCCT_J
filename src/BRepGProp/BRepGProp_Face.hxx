...
public:
    ...
    Standard_EXPORT void GetUKnots(const Standard_Real theUMin, const Standard_Real theUMax,
    ...
    Standard_EXPORT void GetTKnots(const Standard_Real theTMin, const Standard_Real theTMax,
