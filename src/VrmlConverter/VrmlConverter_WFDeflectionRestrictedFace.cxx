...
void VrmlConverter_WFDeflectionRestrictedFace::Add(Standard_OStream& anOStream,
                                                   ...
                                                   const Standard_Real Deflection, const Standard_Integer NBUiso,
...
void VrmlConverter_WFDeflectionRestrictedFace::Add(Standard_OStream& anOStream,
    ...
    VrmlConverter_WFDeflectionRestrictedFace::Add(anOStream, aFace, Standard_True, Standard_True, Deflection, finu,
                                                  finv, aDrawer);
}
...
void VrmlConverter_WFDeflectionRestrictedFace::AddUIso(Standard_OStream& anOStream,
    ...
    Standard_Integer finu = aDrawer->UIsoAspect()->Number();
    Standard_Integer finv = aDrawer->VIsoAspect()->Number();
    VrmlConverter_WFDeflectionRestrictedFace::Add(anOStream, aFace, Standard_True, Standard_False, Deflection, finu,
                                                  finv, aDrawer);
}
...
void VrmlConverter_WFDeflectionRestrictedFace::AddVIso(Standard_OStream& anOStream,
    ...
    Standard_Integer finu = aDrawer->UIsoAspect()->Number();
    Standard_Integer finv = aDrawer->VIsoAspect()->Number();
    VrmlConverter_WFDeflectionRestrictedFace::Add(anOStream, aFace, Standard_False, Standard_True, Deflection, finu,
                                                  finv, aDrawer);
}
