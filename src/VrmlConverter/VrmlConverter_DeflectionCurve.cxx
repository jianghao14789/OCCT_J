...
// purpose:
//==================================================================
static void PrintPoints(Handle(TColgp_HArray1OfVec) & aHAV1, Handle(TColStd_HArray1OfInteger) & aHAI1,
                        const Handle(VrmlConverter_Drawer) & aDrawer, Standard_OStream& anOStream) {
...
// purpose:
//==================================================================
static void DrawCurve(Adaptor3d_Curve& aCurve, const Standard_Real TheDeflection, const Standard_Real U1,
...
static Standard_Real GetDeflection(const Adaptor3d_Curve& aCurve, const Standard_Real U1, const Standard_Real U2,
    ...
    if (aDrawer->TypeOfDeflection() == Aspect_TOD_RELATIVE) // TOD_RELATIVE, TOD_ABSOLUTE
    {
        ...
        if (!(box.IsOpenXmin() || box.IsOpenXmax() || box.IsOpenYmin() || box.IsOpenYmax() || box.IsOpenZmin() ||
              box.IsOpenZmax())) {
            diagonal =
                Sqrt((Xmax - Xmin) * (Xmax - Xmin) + (Ymax - Ymin) * (Ymax - Ymin) + (Zmax - Zmin) * (Zmax - Zmin));
...
// purpose: 1
//==================================================================
void VrmlConverter_DeflectionCurve::Add(Standard_OStream& anOStream, Adaptor3d_Curve& aCurve,
                                        const Handle(VrmlConverter_Drawer) & aDrawer) {
...
// purpose: 2
//==================================================================
void VrmlConverter_DeflectionCurve::Add(Standard_OStream& anOStream, Adaptor3d_Curve& aCurve, const Standard_Real U1,
                                        const Standard_Real U2, const Handle(VrmlConverter_Drawer) & aDrawer) {
    Standard_Real V1 = U1;
    Standard_Real V2 = U2;
...
void VrmlConverter_DeflectionCurve::Add(Standard_OStream& anOStream, Adaptor3d_Curve& aCurve,
                                        const Standard_Real aDeflection, const Handle(VrmlConverter_Drawer) & aDrawer) {
    Standard_Real aLimit = aDrawer->MaximalParameterValue();
    Standard_Real V1, V2;
    FindLimits(aCurve, aLimit, V1, V2);
...
void VrmlConverter_DeflectionCurve::Add(Standard_OStream& anOStream, Adaptor3d_Curve& aCurve, const Standard_Real U1,
                                        const Standard_Real U2, const Standard_Real aDeflection) {
    Handle(VrmlConverter_Drawer) aDrawer = new VrmlConverter_Drawer;
    Handle(VrmlConverter_LineAspect) la = new VrmlConverter_LineAspect;
    aDrawer->SetLineAspect(la);
...
void VrmlConverter_DeflectionCurve::Add(Standard_OStream& anOStream, const Adaptor3d_Curve& aCurve,
                                        const Handle(TColStd_HArray1OfReal) & aParams, const Standard_Integer aNbNodes,
                                        const Handle(VrmlConverter_Drawer) & aDrawer) {
