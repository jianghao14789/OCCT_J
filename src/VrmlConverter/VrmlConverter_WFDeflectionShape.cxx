...
// purpose
//=========================================================================
void VrmlConverter_WFDeflectionShape::Add(Standard_OStream& anOStream, const TopoDS_Shape& aShape,
                ...
                if (Tool.Neighbours() == 0) {
                    if (Tool.HasCurve()) {
                        ...
                        if (!aPT.IsNull() && !aT.IsNull() && aPT->HasParameters())
                            VrmlConverter_DeflectionCurve::Add(anOStream, C, aPT->Parameters(), aPT->NbNodes(),
                                                               aDrawer);
                        else
