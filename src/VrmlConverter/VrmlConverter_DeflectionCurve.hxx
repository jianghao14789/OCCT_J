...
public:
    ...
    Standard_EXPORT static void Add(Standard_OStream& anOStream, Adaptor3d_Curve& aCurve,
    ...
    //! U1 and U2.
    Standard_EXPORT static void Add(Standard_OStream& anOStream, Adaptor3d_Curve& aCurve, const Standard_Real U1,
    ...
    Standard_EXPORT static void Add(Standard_OStream& anOStream, const Adaptor3d_Curve& aCurve,
