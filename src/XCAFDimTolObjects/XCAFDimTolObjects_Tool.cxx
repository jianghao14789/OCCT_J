...
void XCAFDimTolObjects_Tool::GetGeomTolerances(
    ...
    XCAFDimTolObjects_DatumObjectSequence& theDatumSequence, XCAFDimTolObjects_DataMapOfToleranceDatum& theMap) const {
...
Standard_Boolean
XCAFDimTolObjects_Tool::GetRefDimensions(const TopoDS_Shape& theShape,
                                         XCAFDimTolObjects_DimensionObjectSequence& theDimensionObjectSequence) const {
    theDimensionObjectSequence.Clear();
    TDF_Label aShapeL;
...
Standard_Boolean XCAFDimTolObjects_Tool::GetRefGeomTolerances(
    const TopoDS_Shape& theShape, XCAFDimTolObjects_GeomToleranceObjectSequence& theGeomToleranceObjectSequence,
    XCAFDimTolObjects_DatumObjectSequence& theDatumSequence, XCAFDimTolObjects_DataMapOfToleranceDatum& theMap) const {
    theGeomToleranceObjectSequence.Clear();
    TDF_Label aShapeL;
    myDimTolTool->ShapeTool()->Search(theShape, aShapeL);
