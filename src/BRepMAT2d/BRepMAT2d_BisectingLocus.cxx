...
static void CutSketch(MAT2d_SequenceOfSequenceOfGeometry& Figure, MAT2d_DataMapOfBiIntInteger& NbSect);

//=============================================================================
// function : BRepMAT2d_BisectingLocus
// purpose  : Constructeur vide.
//=============================================================================
BRepMAT2d_BisectingLocus::BRepMAT2d_BisectingLocus() : isDone(Standard_False), nbContours(0) {}
...
//           <anExplo>.
//=============================================================================
void BRepMAT2d_BisectingLocus::Compute(BRepMAT2d_Explorer& anExplo, const Standard_Integer IndexLine,
                                       const MAT_Side aSide, const GeomAbs_JoinType aJoinType,
    ...
    theGraph->Perform(TheMAT.SemiInfinite(), TheRoots, theTool.NumberOfItems(), TheMAT.NumberOfBisectors());
...
// purpose  :
//=============================================================================
void BRepMAT2d_BisectingLocus::RenumerationAndFusion(const Standard_Integer ILine, const Standard_Integer LengthLine,
    ...
    for (i = 1; i <= LengthLine; i++) {
        ...
        for (j = 2; j <= S.Length(); j++) {
            theGraph->FusionOfBasicElts(IndFirst, S.Value(j), MergeArc1, GeomIndexArc1, GeomIndexArc2, MergeArc2,
                                        GeomIndexArc3, GeomIndexArc4);
            if (MergeArc1) {
...
//
//=============================================================================
Bisector_Bisec BRepMAT2d_BisectingLocus::GeomBis(const Handle(MAT_Arc) & anArc, Standard_Boolean& Reverse) const {
    ...
    if (Bis->FirstParameter() <= -Precision::Infinite()) {
        ...
        if (PNode.SquareDistance(PF) > PNode.SquareDistance(PL)) Reverse = Standard_True;
    }
