...
public:
    ...
    Standard_EXPORT Geom2dAdaptor_Curve(const Handle(Geom2d_Curve) & C, const Standard_Real UFirst,
    ...
    virtual GeomAbs_CurveType GetType() const Standard_OVERRIDE {
        return myTypeCurve;
    }
...
private:
    ...
    Standard_Boolean IsBoundary(const Standard_Real theU, Standard_Integer& theSpanStart,
