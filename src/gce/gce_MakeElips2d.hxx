...
public:
    ...
    Standard_EXPORT gce_MakeElips2d(const gp_Ax2d& MajorAxis, const Standard_Real MajorRadius,
    ...
    //! the status is "InvertRadius" if MajorRadius < MinorRadius or
    //! "NegativeRadius" if MinorRadius < 0.0
    Standard_EXPORT gce_MakeElips2d(const gp_Ax22d& A, const Standard_Real MajorRadius,
