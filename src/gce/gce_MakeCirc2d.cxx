...
gce_MakeCirc2d::gce_MakeCirc2d(const gp_Pnt2d& P1, const gp_Pnt2d& P2, const gp_Pnt2d& P3) {
    ...
    if ((dist1 < gp::Resolution()) && (dist2 < gp::Resolution()) && (dist3 < gp::Resolution())) {
        ...
        if (dist1 >= RealEpsilon()) {
            L1 = gp_Lin2d(gp_Pnt2d((P1.XY() + P2.XY()) / 2.0), gp_Dir2d(P1.Y() - P2.Y(), P2.X() - P1.X()));
        }
        if (dist2 >= RealEpsilon()) {
            L2 = gp_Lin2d(gp_Pnt2d((P1.XY() + P3.XY()) / 2.0), gp_Dir2d(P1.Y() - P3.Y(), P3.X() - P1.X()));
        }
        if (dist2 <= RealEpsilon()) {
...
gce_MakeCirc2d::gce_MakeCirc2d(const gp_Ax2d& XAxis, const Standard_Real Radius, const Standard_Boolean Sense) {
    if (Radius >= 0.) {
...
gce_MakeCirc2d::gce_MakeCirc2d(const gp_Pnt2d& Center, const Standard_Real Radius, const Standard_Boolean Sense) {
    if (Radius >= 0.) {
...
gce_MakeCirc2d::gce_MakeCirc2d(const gp_Pnt2d& Center, const gp_Pnt2d& Point, const Standard_Boolean Sense) {
