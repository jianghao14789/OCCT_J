...
gce_MakeParab2d::gce_MakeParab2d(const gp_Ax2d& MirrorAxis, const Standard_Real Focal, const Standard_Boolean Sense) {
    if (Focal < 0.0) {
        TheError = gce_NullFocusLength;
    } else {
...
gce_MakeParab2d::gce_MakeParab2d(const gp_Pnt2d& S, const gp_Pnt2d& Center, const Standard_Boolean Sense) {
