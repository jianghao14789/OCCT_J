...
public:
    ...
    Standard_EXPORT gce_MakeParab2d(const gp_Ax2d& MirrorAxis, const Standard_Real Focal,
    ...
    Standard_EXPORT gce_MakeParab2d(const gp_Pnt2d& S1, const gp_Pnt2d& Center,
                                    const Standard_Boolean Sense = Standard_True);
