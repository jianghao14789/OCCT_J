...
gce_MakeElips2d::gce_MakeElips2d(const gp_Ax2d& MajorAxis, const Standard_Real MajorRadius,
...
gce_MakeElips2d::gce_MakeElips2d(const gp_Ax22d& A, const Standard_Real MajorRadius, const Standard_Real MinorRadius) {
    if (MajorRadius < 0.0) {
        TheError = gce_NegativeRadius;
    } else if (MajorRadius < MinorRadius) {
        TheError = gce_InvertRadius;
