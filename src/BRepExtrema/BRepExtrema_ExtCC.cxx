...
void BRepExtrema_ExtCC::Initialize(const TopoDS_Edge& E2) {
    if (!BRep_Tool::IsGeometric(E2)) return; // protect against non-geometric type (e.g. polygon)
    Standard_Real V1, V2;
...
void BRepExtrema_ExtCC::Perform(const TopoDS_Edge& E1) {
    if (!BRep_Tool::IsGeometric(E1)) return; // protect against non-geometric type (e.g. polygon)
    Standard_Real U1, U2;
...
void BRepExtrema_ExtCC::TrimmedSquareDistances(Standard_Real& dist11, Standard_Real& dist12, Standard_Real& dist21,
                                               Standard_Real& dist22, gp_Pnt& pnt11, gp_Pnt& pnt12, gp_Pnt& pnt21,
                                               gp_Pnt& pnt22) const {
