...
public:
    ...
    const TColStd_PackedMapOfInteger& OverlapTriangles1() const {
        return myOverlapTriangles1;
    }

    //! Returns set of overlapped triangles from the 2nd shape (for debug).
    const TColStd_PackedMapOfInteger& OverlapTriangles2() const {
        return myOverlapTriangles2;
    }
#endif
...
public: //! @name Reject/Accept implementations
    ...
    Standard_EXPORT virtual Standard_Boolean RejectNode(const BVH_Vec3d& theCornerMin1, const BVH_Vec3d& theCornerMax1,
...
protected:
    ...
    void intersectTrianglesToler(const Standard_Integer theTrgIdx1, const Standard_Integer theTrgIdx2,
