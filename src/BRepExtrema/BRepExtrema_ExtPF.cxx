...
void BRepExtrema_ExtPF::Initialize(const TopoDS_Face& TheFace, const Extrema_ExtFlag TheFlag,
    ...
    if (mySurf.GetType() == GeomAbs_OtherSurface) return; // protect against non-geometric type (e.g. triangulation)
