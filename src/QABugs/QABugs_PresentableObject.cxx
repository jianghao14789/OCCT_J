...
void QABugs_PresentableObject::Compute(const Handle(PrsMgr_PresentationManager) &,
    ...
    Handle(Graphic3d_ArrayOfTriangles) aPrims = new Graphic3d_ArrayOfTriangles(6, 0,
                                                                               theMode == 1,   // normals
...
void QABugs_PresentableObject::ComputeSelection(const Handle(SelectMgr_Selection) &, const Standard_Integer) {}
