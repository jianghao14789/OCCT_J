...
const Standard_Real Glob_Poles[Glob_NbPoles][3] = {{60000, 31.937047503393231, 799.36226142892554},
...
const Standard_Integer Glob_Mults[Glob_NbKnots] = {15, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 15};
...
static Standard_Integer OCC862(Draw_Interpretor& di, Standard_Integer argc, const char** argv) {
    ...
    if (Ex.Extrema().IsParallel()) {
        ...
        if (nbEx) {
            ...
            di << "Info: Minimal points are (" << P1.X() << "," << P1.Y() << "," << P1.Z() << "), (" << P2.X() << ","
               << P2.Y() << "," << P2.Z() << ")\n";
