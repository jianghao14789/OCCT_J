...
static Standard_Integer OCC895(Draw_Interpretor& di, Standard_Integer argc, const char** argv) {
    ...
    gp_Ax2 axis1 = reverse ? gp_Ax2(center1, gp::DY(), gp::DZ()) : gp_Ax2(center1, -gp::DY(), gp::DX());
    if (Abs(angle) > gp::Resolution()) axis1.Rotate(gp_Ax1(center1, gp::DZ()), angle * M_PI / 180.0);
