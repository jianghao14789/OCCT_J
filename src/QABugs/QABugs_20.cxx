...
//=======================================================================
static Standard_Integer SurfaceGenOCC26675_1(Draw_Interpretor& theDI, Standard_Integer theNArg,
    ...
    ////
    {
        ...
        aPoles.ChangeValue(1, 10) =
            gp_Pnt(+100.39144092265354000000, +2.90083845616186050000, -81.24644132200651800000);
        ...
        aPoles.ChangeValue(1, 23) =
            gp_Pnt(+19.61576136171939000000, +2.91409991934468550000, -101.25602945077115000000);
        aWeights.ChangeValue(1, 24) = +1.03024450452679140000;
        aPoles.ChangeValue(1, 24) =
            gp_Pnt(+12.68754355991407800000, +2.91445385083459700000, -101.92122234436175000000);
        ...
        aPoles.ChangeValue(1, 28) =
            gp_Pnt(-15.13423127055194300000, +2.91485459458572780000, -102.68922293042964000000);
        aWeights.ChangeValue(1, 29) = +1.03024788619868260000;
        aPoles.ChangeValue(1, 29) =
            gp_Pnt(-22.08674002008992700000, +2.91470803482494080000, -102.40724441194320000000);
        aWeights.ChangeValue(1, 30) = +1.03024126030624540000;
        aPoles.ChangeValue(1, 30) =
            gp_Pnt(-35.96556766132121700000, +2.91420996731856930000, -101.46503408514069000000);
        aWeights.ChangeValue(1, 31) = +1.03023657011944230000;
        aPoles.ChangeValue(1, 31) =
            gp_Pnt(-42.89191729472150200000, +2.91385737699769360000, -100.80479886745856000000);
        ...
        aPoles.ChangeValue(1, 42) =
            gp_Pnt(-102.40886646020824000000, +2.90550570939860810000, -87.36427556081821400000);
        aWeights.ChangeValue(1, 43) = +1.03011531537676040000;
        aPoles.ChangeValue(1, 43) =
            gp_Pnt(-105.45979824903711000000, +2.90473220450791560000, -86.30363650725728100000);
        aWeights.ChangeValue(1, 44) = +1.03009266486593140000;
        aPoles.ChangeValue(1, 44) =
            gp_Pnt(-111.76765655411073000000, +2.90302557752729130000, -84.02084620865503000000);
        aWeights.ChangeValue(1, 45) = +1.03007954250893910000;
        aPoles.ChangeValue(1, 45) =
            gp_Pnt(-115.02237879255169000000, +2.90203661863772000000, -82.79254553120374300000);
        aWeights.ChangeValue(1, 46) = +1.03006700046846360000;
        aPoles.ChangeValue(1, 46) =
            gp_Pnt(-118.26033551796380000000, +2.90109123094133370000, -81.51987347500843800000);
        aWeights.ChangeValue(1, 47) = +1.03005153385518430000;
        aPoles.ChangeValue(1, 47) =
            gp_Pnt(-121.48081153033489000000, +2.89992503429592440000, -80.20310945547186100000);
        aWeights.ChangeValue(1, 48) = +1.03003663316288070000;
        aPoles.ChangeValue(1, 48) =
            gp_Pnt(-124.68310204708784000000, +2.89880123910694910000, -78.84252385592422700000);
        aWeights.ChangeValue(1, 49) = +1.03002002524051230000;
        aPoles.ChangeValue(1, 49) =
            gp_Pnt(-127.86649232671233000000, +2.89754829341323060000, -77.43842231968982000000);
        aWeights.ChangeValue(1, 50) = +1.03000192732161230000;
        aPoles.ChangeValue(1, 50) =
            gp_Pnt(-131.03028254956638000000, +2.89618247462029290000, -75.99111259804850200000);
        aWeights.ChangeValue(1, 51) = +1.02996526567113600000;
        aPoles.ChangeValue(1, 51) =
            gp_Pnt(-137.09281139094972000000, +2.89341459629042360000, -73.11712223836046600000);
        aWeights.ChangeValue(1, 52) = +1.02994403451589630000;
        aPoles.ChangeValue(1, 52) =
            gp_Pnt(-139.99435839258939000000, +2.89181101472158900000, -71.69634981883045600000);
        aWeights.ChangeValue(1, 53) = +1.02992866105538440000;
        aPoles.ChangeValue(1, 53) =
            gp_Pnt(-142.87784656482347000000, +2.89064973421052680000, -70.23882874204873900000);
        aWeights.ChangeValue(1, 54) = +1.02989968743283590000;
        aPoles.ChangeValue(1, 54) =
            gp_Pnt(-145.74271824362268000000, +2.88845983550875030000, -68.74489127449217600000);
        aWeights.ChangeValue(1, 55) = +1.02988222474524970000;
        aPoles.ChangeValue(1, 55) =
            gp_Pnt(-148.58838121276386000000, +2.88713941077432070000, -67.21475112846350400000);
        aWeights.ChangeValue(1, 56) = +1.02985386954408620000;
        aPoles.ChangeValue(1, 56) =
            gp_Pnt(-151.41432118416620000000, +2.88499463682574180000, -65.64875099202183200000);
        aWeights.ChangeValue(1, 57) = +1.02982704006090460000;
        aPoles.ChangeValue(1, 57) =
            gp_Pnt(-154.21993049579214000000, +2.88296397171855910000, -64.04717955157212800000);
        aWeights.ChangeValue(1, 58) = +1.02976639514278400000;
        aPoles.ChangeValue(1, 58) =
            gp_Pnt(-160.00375832753414000000, +2.87837140815595260000, -60.64735416015690100000);
        aWeights.ChangeValue(1, 59) = +1.02972545417711370000;
        aPoles.ChangeValue(1, 59) =
            gp_Pnt(-162.97914403387477000000, +2.87526824819569480000, -58.84445149944087200000);
        aWeights.ChangeValue(1, 60) = +1.02970377642253300000;
        aPoles.ChangeValue(1, 60) =
            gp_Pnt(-165.92810584856278000000, +2.87362619373759860000, -56.99783055334398100000);
        aWeights.ChangeValue(1, 61) = +1.02963665582001740000;
        aPoles.ChangeValue(1, 61) =
            gp_Pnt(-168.85438185317770000000, +2.86853152516479340000, -55.11698298198095400000);
        aWeights.ChangeValue(1, 62) = +1.02961756328192160000;
        aPoles.ChangeValue(1, 62) =
            gp_Pnt(-171.75125340157436000000, +2.86708271055963240000, -53.19057330425229700000);
        aWeights.ChangeValue(1, 63) = +1.02954937293527580000;
        aPoles.ChangeValue(1, 63) =
            gp_Pnt(-174.62251681022158000000, +2.86190007017706360000, -51.22700225930964300000);
        aWeights.ChangeValue(1, 64) = +1.02950097342691520000;
        aPoles.ChangeValue(1, 64) =
            gp_Pnt(-177.46620192435449000000, +2.85821732043423180000, -49.22415777229338100000);
        aWeights.ChangeValue(1, 65) = +1.02943612532291810000;
        aPoles.ChangeValue(1, 65) =
            gp_Pnt(-180.28206426096281000000, +2.85327724467687100000, -47.18300981722491400000);
        aWeights.ChangeValue(1, 66) = +1.02937840445786000000;
        aPoles.ChangeValue(1, 66) =
            gp_Pnt(-182.89713737694305000000, +2.84888100315162470000, -45.28741010449485300000);
        aWeights.ChangeValue(1, 67) = +1.02929786839840220000;
        aPoles.ChangeValue(1, 67) =
            gp_Pnt(-185.48808576506855000000, +2.84272935508061810000, -43.35897595091199000000);
        aWeights.ChangeValue(1, 68) = +1.02927785532845030000;
        aPoles.ChangeValue(1, 68) =
            gp_Pnt(-188.05509745668041000000, +2.84122612975151250000, -41.39706700987362400000);
        aWeights.ChangeValue(1, 69) = +1.02909457173363930000;
        aPoles.ChangeValue(1, 69) =
            gp_Pnt(-190.59634219852757000000, +2.82717082550985440000, -39.40453806610211300000);
        aWeights.ChangeValue(1, 70) = +1.02915656102508410000;
        aPoles.ChangeValue(1, 70) =
            gp_Pnt(-193.11296933822229000000, +2.83195841118334000000, -37.37763511391345600000);
        aWeights.ChangeValue(1, 71) = +1.02891246603941110000;
        aPoles.ChangeValue(1, 71) =
            gp_Pnt(-195.60305999702362000000, +2.81322479805689340000, -35.32107774203857500000);
        aWeights.ChangeValue(1, 72) = +1.02884001996307940000;
        aPoles.ChangeValue(1, 72) =
            gp_Pnt(-198.06589030811097000000, +2.80764438138268390000, -33.23208121127716900000);
        aWeights.ChangeValue(1, 73) = +1.02870418206103250000;
        aPoles.ChangeValue(1, 73) =
            gp_Pnt(-200.50111697620073000000, +2.79717360924099090000, -31.11182660391394400000);
        aWeights.ChangeValue(1, 74) = +1.02860417892814660000;
        aPoles.ChangeValue(1, 74) =
            gp_Pnt(-202.93720652839650000000, +2.78949733525485710000, -28.99085629216911300000);
        aWeights.ChangeValue(1, 75) = +1.02826579045547110000;
        aPoles.ChangeValue(1, 75) =
            gp_Pnt(-205.34394850673777000000, +2.76315604312090550000, -26.83940109433629200000);
        aWeights.ChangeValue(1, 76) = +1.02871793966742330000;
        aPoles.ChangeValue(1, 76) =
            gp_Pnt(-207.72575255584553000000, +2.79855565223875710000, -24.65500081264426800000);
        aWeights.ChangeValue(1, 77) = +1.02728787827176630000;
        aPoles.ChangeValue(1, 77) =
            gp_Pnt(-210.07706367406874000000, +2.68725363743552850000, -22.43634910730148800000);
        aWeights.ChangeValue(1, 78) = +1.02767535385809120000;
        aPoles.ChangeValue(1, 78) =
            gp_Pnt(-212.39605978578481000000, +2.71705476277515070000, -20.20562112100595800000);
        aWeights.ChangeValue(1, 79) = +1.02745809923169020000;
        aPoles.ChangeValue(1, 79) =
            gp_Pnt(-214.68098626410506000000, +2.69985190382785320000, -17.91605900374278100000);
        aWeights.ChangeValue(1, 80) = +1.02725110106359850000;
        aPoles.ChangeValue(1, 80) =
            gp_Pnt(-216.94385389331507000000, +2.68435107488514250000, -15.61289037092123000000);
        aWeights.ChangeValue(1, 81) = +1.02619749797986360000;
        aPoles.ChangeValue(1, 81) =
            gp_Pnt(-219.16685583874414000000, +2.59983520096898510000, -13.28583956380401400000);
        ...
        aPoles.ChangeValue(2, 10) =
            gp_Pnt(+100.40113044627800000000, +2.11683214779396200000, -81.27049552555527600000);
        ...
        aPoles.ChangeValue(2, 23) =
            gp_Pnt(+19.61796125907087400000, +2.12763915883061920000, -101.27845724558523000000);
        aWeights.ChangeValue(2, 24) = +1.00967399859793750000;
        aPoles.ChangeValue(2, 24) =
            gp_Pnt(+12.68919279606528900000, +2.12792777824197280000, -101.94361028295506000000);
        ...
        aPoles.ChangeValue(2, 28) =
            gp_Pnt(-15.13466558037753100000, +2.12825458864942170000, -102.71156371647888000000);
        aWeights.ChangeValue(2, 29) = +1.00967503459672270000;
        aPoles.ChangeValue(2, 29) =
            gp_Pnt(-22.08770764998126900000, +2.12813506662251010000, -102.42960214757312000000);
        aWeights.ChangeValue(2, 30) = +1.00967300468446490000;
        aPoles.ChangeValue(2, 30) =
            gp_Pnt(-35.96760988752987500000, +2.12772890088942160000, -101.48744752427969000000);
        aWeights.ChangeValue(2, 31) = +1.00967156777535580000;
        aPoles.ChangeValue(2, 31) =
            gp_Pnt(-42.89448004815705000000, +2.12744138030294440000, -100.82725372327035000000);
        ...
        aPoles.ChangeValue(2, 42) =
            gp_Pnt(-102.41672784011750000000, +2.12063397196916760000, -87.38773038403248000000);
        aWeights.ChangeValue(2, 43) = +1.00963441262388320000;
        aPoles.ChangeValue(2, 43) =
            gp_Pnt(-105.46799849165807000000, +2.12000379050942020000, -86.32718371153289600000);
        aWeights.ChangeValue(2, 44) = +1.00962747055142050000;
        aPoles.ChangeValue(2, 44) =
            gp_Pnt(-111.77654530973133000000, +2.11861352771318150000, -84.04460889409097000000);
        aWeights.ChangeValue(2, 45) = +1.00962344856326270000;
        aPoles.ChangeValue(2, 45) =
            gp_Pnt(-115.03162075269803000000, +2.11780798556167320000, -82.81644583890866300000);
        aWeights.ChangeValue(2, 46) = +1.00961960432211730000;
        aPoles.ChangeValue(2, 46) =
            gp_Pnt(-118.26993104545312000000, +2.11703799459344700000, -81.54389579486141300000);
        aWeights.ChangeValue(2, 47) = +1.00961486342011010000;
        aPoles.ChangeValue(2, 47) =
            gp_Pnt(-121.49080060905077000000, +2.11608829135299810000, -80.22729418526657200000);
        aWeights.ChangeValue(2, 48) = +1.00961029578343630000;
        aPoles.ChangeValue(2, 48) =
            gp_Pnt(-124.69348951442340000000, +2.11517321690879800000, -78.86685283462101400000);
        aWeights.ChangeValue(2, 49) = +1.00960520454014850000;
        aPoles.ChangeValue(2, 49) =
            gp_Pnt(-127.87731027004676000000, +2.11415312105035590000, -77.46291256687052900000);
        aWeights.ChangeValue(2, 50) = +1.00959965618773250000;
        aPoles.ChangeValue(2, 50) =
            gp_Pnt(-131.04156234039974000000, +2.11304129636208420000, -76.01577573259778800000);
        aWeights.ChangeValue(2, 51) = +1.00958841592243690000;
        aPoles.ChangeValue(2, 51) =
            gp_Pnt(-137.10496896782513000000, +2.11078854745601690000, -73.14215015354327000000);
        aWeights.ChangeValue(2, 52) = +1.00958190609540830000;
        aPoles.ChangeValue(2, 52) =
            gp_Pnt(-140.00695092509352000000, +2.10948365684345340000, -71.72161996530125800000);
        aWeights.ChangeValue(2, 53) = +1.00957719225994170000;
        aPoles.ChangeValue(2, 53) =
            gp_Pnt(-142.89082065884315000000, +2.10853873486620720000, -70.26423921243410600000);
        aWeights.ChangeValue(2, 54) = +1.00956830737110970000;
        aPoles.ChangeValue(2, 54) =
            gp_Pnt(-145.75622246387837000000, +2.10675729535240960000, -68.77065477701791000000);
        aWeights.ChangeValue(2, 55) = +1.00956295195561060000;
        aPoles.ChangeValue(2, 55) =
            gp_Pnt(-148.60233584192389000000, +2.10568335609513650000, -67.24065593702246700000);
        aWeights.ChangeValue(2, 56) = +1.00955425555818930000;
        aPoles.ChangeValue(2, 56) =
            gp_Pnt(-151.42883073983140000000, +2.10393921590561070000, -65.67497260857376800000);
        aWeights.ChangeValue(2, 57) = +1.00954602613011150000;
        aPoles.ChangeValue(2, 57) =
            gp_Pnt(-154.23502547473331000000, +2.10228833319884910000, -64.07366145615235100000);
        aWeights.ChangeValue(2, 58) = +1.00952742278729300000;
        aPoles.ChangeValue(2, 58) =
            gp_Pnt(-160.02004322449872000000, +2.09855561509982950000, -60.67448614970191300000);
        aWeights.ChangeValue(2, 59) = +1.00951486183164940000;
        aPoles.ChangeValue(2, 59) =
            gp_Pnt(-162.99613088380306000000, +2.09603444654779600000, -58.87207545484513800000);
        aWeights.ChangeValue(2, 60) = +1.00950821186194630000;
        aPoles.ChangeValue(2, 60) =
            gp_Pnt(-165.94554723216726000000, +2.09470002788322150000, -57.02566663092176900000);
        aWeights.ChangeValue(2, 61) = +1.00948761363819010000;
        aPoles.ChangeValue(2, 61) =
            gp_Pnt(-168.87287521283019000000, +2.09056345777511910000, -55.14566924440539700000);
        aWeights.ChangeValue(2, 62) = +1.00948175483840210000;
        aPoles.ChangeValue(2, 62) =
            gp_Pnt(-171.77025983587509000000, +2.08938700649796160000, -53.21936605947655600000);
        aWeights.ChangeValue(2, 63) = +1.00946082358399410000;
        aPoles.ChangeValue(2, 63) =
            gp_Pnt(-174.64262250370552000000, +2.08518149324171190000, -51.25662423685646700000);
        aWeights.ChangeValue(2, 64) = +1.00944596410269540000;
        aPoles.ChangeValue(2, 64) =
            gp_Pnt(-177.48726621628353000000, +2.08219461660139650000, -49.25423871740036900000);
        aWeights.ChangeValue(2, 65) = +1.00942605045267530000;
        aPoles.ChangeValue(2, 65) =
            gp_Pnt(-180.30433731845508000000, +2.07819005191471670000, -47.21374002625280800000);
        aWeights.ChangeValue(2, 66) = +1.00940832657289500000;
        aPoles.ChangeValue(2, 66) =
            gp_Pnt(-182.92026834009920000000, +2.07462614892136180000, -45.31887901738367200000);
        aWeights.ChangeValue(2, 67) = +1.00938358350026620000;
        aPoles.ChangeValue(2, 67) =
            gp_Pnt(-185.51252638985017000000, +2.06964535925843180000, -43.39137009339865600000);
        aWeights.ChangeValue(2, 68) = +1.00937745534293180000;
        aPoles.ChangeValue(2, 68) =
            gp_Pnt(-188.07970214515959000000, +2.06841969296490240000, -41.42984981640538000000);
        aWeights.ChangeValue(2, 69) = +1.00932110415642830000;
        aPoles.ChangeValue(2, 69) =
            gp_Pnt(-190.62397551723822000000, +2.05705915800362950000, -39.43932945784815300000);
        aWeights.ChangeValue(2, 70) = +1.00934018958961060000;
        aPoles.ChangeValue(2, 70) =
            gp_Pnt(-193.13969442040633000000, +2.06091733419064350000, -37.41169132931209200000);
        aWeights.ChangeValue(2, 71) = +1.00926513417552190000;
        aPoles.ChangeValue(2, 71) =
            gp_Pnt(-195.63329272671066000000, +2.04578165519120160000, -35.35822241980492500000);
        aWeights.ChangeValue(2, 72) = +1.00924284324010150000;
        aPoles.ChangeValue(2, 72) =
            gp_Pnt(-198.09761820165846000000, +2.04128022217386820000, -33.26975126412686700000);
        aWeights.ChangeValue(2, 73) = +1.00920104311988150000;
        aPoles.ChangeValue(2, 73) =
            gp_Pnt(-200.53514329838038000000, +2.03283693524956680000, -31.15087616958502200000);
        aWeights.ChangeValue(2, 74) = +1.00917029694372660000;
        aPoles.ChangeValue(2, 74) =
            gp_Pnt(-202.97255799662608000000, +2.02663657044316060000, -29.03126127135719200000);
        aWeights.ChangeValue(2, 75) = +1.00906597799637380000;
        aPoles.ChangeValue(2, 75) =
            gp_Pnt(-205.38430250588374000000, +2.00548607046822540000, -26.88375382824776200000);
        aWeights.ChangeValue(2, 76) = +1.00920552993214340000;
        aPoles.ChangeValue(2, 76) =
            gp_Pnt(-207.76049754988114000000, +2.03384304897263670000, -24.69318019977189100000);
        aWeights.ChangeValue(2, 77) = +1.00876475817298510000;
        aPoles.ChangeValue(2, 77) =
            gp_Pnt(-210.12674832523484000000, +1.94448851661030540000, -22.49703905023471500000);
        aWeights.ChangeValue(2, 78) = +1.00888387250469380000;
        aPoles.ChangeValue(2, 78) =
            gp_Pnt(-212.44800842772909000000, +1.96852329008748410000, -20.25405344977475500000);
        aWeights.ChangeValue(2, 79) = +1.00881670070680670000;
        aPoles.ChangeValue(2, 79) =
            gp_Pnt(-214.73260668420895000000, +1.95481624964232450000, -17.97008076073228700000);
        aWeights.ChangeValue(2, 80) = +1.00875338528797620000;
        aPoles.ChangeValue(2, 80) =
            gp_Pnt(-216.99878954601004000000, +1.94217039944868790000, -15.66960286452947800000);
        aWeights.ChangeValue(2, 81) = +1.00842683370719490000;
        aPoles.ChangeValue(2, 81) =
            gp_Pnt(-219.23765241170187000000, +1.87520469423183880000, -13.35291936652889800000);
        ...
        aPoles.ChangeValue(3, 10) =
            gp_Pnt(+100.50232486897988000000, +1.36042346207845170000, -81.51999289835789900000);
        ...
        aPoles.ChangeValue(3, 23) =
            gp_Pnt(+19.64441706716387900000, +1.36791861440644060000, -101.54459131896159000000);
        aWeights.ChangeValue(3, 24) = +0.99799940935225717000;
        aPoles.ChangeValue(3, 24) =
            gp_Pnt(+12.70928858254282900000, +1.36811887624638580000, -102.21030492597274000000);
        ...
        aPoles.ChangeValue(3, 28) =
            gp_Pnt(-15.14003926915473600000, +1.36834564548690430000, -102.97890429403182000000);
        aWeights.ChangeValue(3, 29) = +0.99799918910460783000;
        aPoles.ChangeValue(3, 29) =
            gp_Pnt(-22.09945300681867100000, +1.36826271027814080000, -102.69670494840925000000);
        aWeights.ChangeValue(3, 30) = +0.99799962065035785000;
        aPoles.ChangeValue(3, 30) =
            gp_Pnt(-35.99208002634647800000, +1.36798088374117890000, -101.75375562004130000000);
        aWeights.ChangeValue(3, 31) = +0.99799992612548816000;
        aPoles.ChangeValue(3, 31) =
            gp_Pnt(-42.92529183965938000000, +1.36778138671521220000, -101.09300634269859000000);
        aWeights.ChangeValue(3, 32) = +0.99800032324181509000;
        aPoles.ChangeValue(3, 32) =
            gp_Pnt(-49.83946240643516700000, +1.36752203923507090000, -100.24338136864999000000);
        ...
        aPoles.ChangeValue(3, 42) =
            gp_Pnt(-102.50248760972849000000, +1.36305944519955100000, -87.64226061031386900000);
        aWeights.ChangeValue(3, 43) = +0.99800782429726853000;
        aPoles.ChangeValue(3, 43) =
            gp_Pnt(-105.55661203062589000000, +1.36262246213878830000, -86.58083524789229600000);
        aWeights.ChangeValue(3, 44) = +0.99800929984388531000;
        aPoles.ChangeValue(3, 44) =
            gp_Pnt(-111.87105232543304000000, +1.36165848631400000000, -84.29637819122412200000);
        aWeights.ChangeValue(3, 45) = +0.99801015470554688000;
        aPoles.ChangeValue(3, 45) =
            gp_Pnt(-115.12916723990907000000, +1.36109998387148300000, -83.06721412498791300000);
        aWeights.ChangeValue(3, 46) = +0.99801097177629106000;
        aPoles.ChangeValue(3, 46) =
            gp_Pnt(-118.37050305702043000000, +1.36056615831231790000, -81.79361556056927900000);
        aWeights.ChangeValue(3, 47) = +0.99801197939908182000;
        aPoles.ChangeValue(3, 47) =
            gp_Pnt(-121.59440429164877000000, +1.35990780214188640000, -80.47594855348815200000);
        aWeights.ChangeValue(3, 48) = +0.99801295017732938000;
        aPoles.ChangeValue(3, 48) =
            gp_Pnt(-124.80011198391350000000, +1.35927349774917520000, -79.11439339164216700000);
        aWeights.ChangeValue(3, 49) = +0.99801403220993246000;
        aPoles.ChangeValue(3, 49) =
            gp_Pnt(-127.98695272451793000000, +1.35856646260703170000, -77.70931006235629500000);
        aWeights.ChangeValue(3, 50) = +0.99801521135673477000;
        aPoles.ChangeValue(3, 50) =
            gp_Pnt(-131.15422466608416000000, +1.35779592883408770000, -76.26099835790641600000);
        aWeights.ChangeValue(3, 51) = +0.99801760008173268000;
        aPoles.ChangeValue(3, 51) =
            gp_Pnt(-137.22341426940562000000, +1.35623488186342090000, -73.38505097675174200000);
        aWeights.ChangeValue(3, 52) = +0.99801898347031770000;
        aPoles.ChangeValue(3, 52) =
            gp_Pnt(-140.12817143218851000000, +1.35533077140178190000, -71.96340636458091900000);
        aWeights.ChangeValue(3, 53) = +0.99801998518653323000;
        aPoles.ChangeValue(3, 53) =
            gp_Pnt(-143.01477271081365000000, +1.35467609324036100000, -70.50482384325539400000);
        aWeights.ChangeValue(3, 54) = +0.99802187318341851000;
        aPoles.ChangeValue(3, 54) =
            gp_Pnt(-145.88296929650440000000, +1.35344206211285110000, -69.01011970904052400000);
        aWeights.ChangeValue(3, 55) = +0.99802301113749214000;
        aPoles.ChangeValue(3, 55) =
            gp_Pnt(-148.73181832948791000000, +1.35269822187277230000, -67.47885556090747600000);
        aWeights.ChangeValue(3, 56) = +0.99802485896116799000;
        aPoles.ChangeValue(3, 56) =
            gp_Pnt(-151.56108889838526000000, +1.35149030610332030000, -65.91196867904423600000);
        aWeights.ChangeValue(3, 57) = +0.99802660746081140000;
        aPoles.ChangeValue(3, 57) =
            gp_Pnt(-154.37005843077941000000, +1.35034719652907540000, -64.30939181125272300000);
        aWeights.ChangeValue(3, 58) = +0.99803055992501810000;
        aPoles.ChangeValue(3, 58) =
            gp_Pnt(-160.16078498432634000000, +1.34776300585323040000, -60.90758294114521500000);
        aWeights.ChangeValue(3, 59) = +0.99803322842151521000;
        aPoles.ChangeValue(3, 59) =
            gp_Pnt(-163.13986451909619000000, +1.34601805132734250000, -59.10384793755353900000);
        aWeights.ChangeValue(3, 60) = +0.99803464125751229000;
        aPoles.ChangeValue(3, 60) =
            gp_Pnt(-166.09208359425281000000, +1.34509430571165490000, -57.25595351707911400000);
        aWeights.ChangeValue(3, 61) = +0.99803901668572381000;
        aPoles.ChangeValue(3, 61) =
            gp_Pnt(-169.02259847263389000000, +1.34223252516315280000, -55.37471701865561600000);
        aWeights.ChangeValue(3, 62) = +0.99804026123487555000;
        aPoles.ChangeValue(3, 62) =
            gp_Pnt(-171.92274649713781000000, +1.34141857200850120000, -53.44681670722970100000);
        aWeights.ChangeValue(3, 63) = +0.99804470691034153000;
        aPoles.ChangeValue(3, 63) =
            gp_Pnt(-174.79824691248783000000, +1.33851025764084610000, -51.48277226031661500000);
        aWeights.ChangeValue(3, 64) = +0.99804786265209489000;
        aPoles.ChangeValue(3, 64) =
            gp_Pnt(-177.64589658566118000000, +1.33644541377468110000, -49.47887210970986900000);
        aWeights.ChangeValue(3, 65) = +0.99805209132461004000;
        aPoles.ChangeValue(3, 65) =
            gp_Pnt(-180.46609411219177000000, +1.33367801102763010000, -47.43691639460438100000);
        aWeights.ChangeValue(3, 66) = +0.99805585511720041000;
        aPoles.ChangeValue(3, 66) =
            gp_Pnt(-183.08478109176986000000, +1.33121501172845690000, -45.54077967192022000000);
        aWeights.ChangeValue(3, 67) = +0.99806110806405779000;
        aPoles.ChangeValue(3, 67) =
            gp_Pnt(-185.68001727848417000000, +1.32777577033982250000, -43.61205685047624300000);
        aWeights.ChangeValue(3, 68) = +0.99806241123000117000;
        aPoles.ChangeValue(3, 68) =
            gp_Pnt(-188.24953622256075000000, +1.32692526187276720000, -41.64902509374122300000);
        aWeights.ChangeValue(3, 69) = +0.99807437025077705000;
        aPoles.ChangeValue(3, 69) =
            gp_Pnt(-190.79766796840426000000, +1.31909012471800140000, -39.65777616520052400000);
        aWeights.ChangeValue(3, 70) = +0.99807032269259688000;
        aPoles.ChangeValue(3, 70) =
            gp_Pnt(-193.31511620328166000000, +1.32174544077043810000, -37.62798636408343400000);
        aWeights.ChangeValue(3, 71) = +0.99808625039380772000;
        aPoles.ChangeValue(3, 71) =
            gp_Pnt(-195.81278252670535000000, +1.31130937814640340000, -35.57429171163009600000);
        aWeights.ChangeValue(3, 72) = +0.99809097922828749000;
        aPoles.ChangeValue(3, 72) =
            gp_Pnt(-198.28008499427182000000, +1.30820906528388470000, -33.48422839734306700000);
        aWeights.ChangeValue(3, 73) = +0.99809984631895698000;
        aPoles.ChangeValue(3, 73) =
            gp_Pnt(-200.72099421295775000000, +1.30239515227575060000, -31.36416391357070300000);
        aWeights.ChangeValue(3, 74) = +0.99810637147759285000;
        aPoles.ChangeValue(3, 74) =
            gp_Pnt(-203.16127009409345000000, +1.29812048781277520000, -29.24337154392900800000);
        aWeights.ChangeValue(3, 75) = +0.99812847998895315000;
        aPoles.ChangeValue(3, 75) =
            gp_Pnt(-205.57777363915829000000, +1.28359951668439790000, -27.09591401257074100000);
        aWeights.ChangeValue(3, 76) = +0.99809892249848597000;
        aPoles.ChangeValue(3, 76) =
            gp_Pnt(-207.95321979211485000000, +1.30303533816127510000, -24.90029856221717000000);
        aWeights.ChangeValue(3, 77) = +0.99819234539248169000;
        aPoles.ChangeValue(3, 77) =
            gp_Pnt(-210.32920376311637000000, +1.24168994973372330000, -22.71372419603407900000);
        aWeights.ChangeValue(3, 78) = +0.99816706733577565000;
        aPoles.ChangeValue(3, 78) =
            gp_Pnt(-212.65404345030839000000, +1.25824740351837460000, -20.46200135460381000000);
        aWeights.ChangeValue(3, 79) = +0.99818127776964660000;
        aPoles.ChangeValue(3, 79) =
            gp_Pnt(-214.94032188963598000000, +1.24888524402456480000, -18.17894168737611000000);
        aWeights.ChangeValue(3, 80) = +0.99819475509197664000;
        aPoles.ChangeValue(3, 80) =
            gp_Pnt(-217.21049138159862000000, +1.24010538580557930000, -15.87773552075580100000);
        aWeights.ChangeValue(3, 81) = +0.99826376750414003000;
        aPoles.ChangeValue(3, 81) =
            gp_Pnt(-219.45963474898130000000, +1.19454909379966280000, -13.56324778739743800000);
        ...
        aPoles.ChangeValue(4, 10) =
            gp_Pnt(+100.68683453164211000000, +0.71310380757531833000, -81.97476109354066400000);
        ...
        aPoles.ChangeValue(4, 22) =
            gp_Pnt(+33.54014335198198900000, +0.71694072618465221000, -100.32190824729783000000);
        aWeights.ChangeValue(4, 23) = +0.99417291266204433000;
        aPoles.ChangeValue(4, 23) =
            gp_Pnt(+19.69298272358705000000, +0.71723033475882103000, -102.03287833894613000000);
        aWeights.ChangeValue(4, 24) = +0.99417203636017570000;
        aPoles.ChangeValue(4, 24) =
            gp_Pnt(+12.74619890889187300000, +0.71734062296661449000, -102.69970663658552000000);
        ...
        aPoles.ChangeValue(4, 28) =
            gp_Pnt(-15.14991535484593800000, +0.71746551227361877000, -103.46959139663633000000);
        aWeights.ChangeValue(4, 29) = +0.99417140696519068000;
        aPoles.ChangeValue(4, 29) =
            gp_Pnt(-22.12102296425817400000, +0.71741983693815459000, -103.18691926012113000000);
        aWeights.ChangeValue(4, 30) = +0.99417264018315676000;
        aPoles.ChangeValue(4, 30) =
            gp_Pnt(-36.03699423807252300000, +0.71726462804712465000, -102.24239043165372000000);
        aWeights.ChangeValue(4, 31) = +0.99417351313460955000;
        aPoles.ChangeValue(4, 31) =
            gp_Pnt(-42.98185258768797500000, +0.71715476185170723000, -101.58053487832193000000);
        aWeights.ChangeValue(4, 32) = +0.99417464796983568000;
        aPoles.ChangeValue(4, 32) =
            gp_Pnt(-49.90763755490115700000, +0.71701193671091712000, -100.72948788576410000000);
        ...
        aPoles.ChangeValue(4, 42) =
            gp_Pnt(-102.65920271683186000000, +0.71455480723882170000, -88.10727415073346000000);
        aWeights.ChangeValue(4, 43) = +0.99419608444209617000;
        aPoles.ChangeValue(4, 43) =
            gp_Pnt(-105.71846722422283000000, +0.71431424921765596000, -87.04407147601585800000);
        aWeights.ChangeValue(4, 44) = +0.99420030141669824000;
        aPoles.ChangeValue(4, 44) =
            gp_Pnt(-112.04353021881408000000, +0.71378360593609291000, -84.75579106017932000000);
        aWeights.ChangeValue(4, 45) = +0.99420274455295243000;
        aPoles.ChangeValue(4, 45) =
            gp_Pnt(-115.30712351688430000000, +0.71347617951477893000, -83.52457168950516600000);
        aWeights.ChangeValue(4, 46) = +0.99420507969516914000;
        aPoles.ChangeValue(4, 46) =
            gp_Pnt(-118.55391065270935000000, +0.71318234625457844000, -82.24884224143599500000);
        aWeights.ChangeValue(4, 47) = +0.99420795946419460000;
        aPoles.ChangeValue(4, 47) =
            gp_Pnt(-121.78323693095153000000, +0.71281998990170370000, -80.92897147787398600000);
        aWeights.ChangeValue(4, 48) = +0.99421073394729520000;
        aPoles.ChangeValue(4, 48) =
            gp_Pnt(-124.99434061394447000000, +0.71247088780699119000, -79.56513754354314500000);
        aWeights.ChangeValue(4, 49) = +0.99421382643715051000;
        aPoles.ChangeValue(4, 49) =
            gp_Pnt(-128.18654935306802000000, +0.71208178090166396000, -78.15770189412481300000);
        aWeights.ChangeValue(4, 50) = +0.99421719652005114000;
        aPoles.ChangeValue(4, 50) =
            gp_Pnt(-131.35915951555538000000, +0.71165775668839981000, -76.70696466864815500000);
        aWeights.ChangeValue(4, 51) = +0.99422402375653052000;
        aPoles.ChangeValue(4, 51) =
            gp_Pnt(-137.43857370930490000000, +0.71079877890710363000, -73.82620311743470200000);
        aWeights.ChangeValue(4, 52) = +0.99422797768691740000;
        aPoles.ChangeValue(4, 52) =
            gp_Pnt(-140.34822128390073000000, +0.71030132584778982000, -72.40218284379008700000);
        aWeights.ChangeValue(4, 53) = +0.99423084075610579000;
        aPoles.ChangeValue(4, 53) =
            gp_Pnt(-143.23968120103163000000, +0.70994112075449667000, -70.94115847846593700000);
        aWeights.ChangeValue(4, 54) = +0.99423623706224973000;
        aPoles.ChangeValue(4, 54) =
            gp_Pnt(-146.11271315064005000000, +0.70926223398833632000, -69.44395856663618400000);
        aWeights.ChangeValue(4, 55) = +0.99423948964319253000;
        aPoles.ChangeValue(4, 55) =
            gp_Pnt(-148.96636467875118000000, +0.70885305306993507000, -67.91012785943519200000);
        aWeights.ChangeValue(4, 56) = +0.99424477127021760000;
        aPoles.ChangeValue(4, 56) =
            gp_Pnt(-151.80041102174371000000, +0.70818863107582075000, -66.34061951491401000000);
        aWeights.ChangeValue(4, 57) = +0.99424976912431906000;
        aPoles.ChangeValue(4, 57) =
            gp_Pnt(-154.61412826195317000000, +0.70755993553172780000, -64.73535576374381200000);
        aWeights.ChangeValue(4, 58) = +0.99426106692542415000;
        aPoles.ChangeValue(4, 58) =
            gp_Pnt(-160.41462700323274000000, +0.70613881146866808000, -61.32785485541679500000);
        aWeights.ChangeValue(4, 59) = +0.99426869485276259000;
        aPoles.ChangeValue(4, 59) =
            gp_Pnt(-163.39874797129167000000, +0.70517937516238605000, -59.52109641918814000000);
        aWeights.ChangeValue(4, 60) = +0.99427273335051769000;
        aPoles.ChangeValue(4, 60) =
            gp_Pnt(-166.35588428707737000000, +0.70467140031138198000, -57.67014968010805400000);
        aWeights.ChangeValue(4, 61) = +0.99428524121150996000;
        aPoles.ChangeValue(4, 61) =
            gp_Pnt(-169.29147402675417000000, +0.70309833118760823000, -55.78569706052214600000);
        aWeights.ChangeValue(4, 62) = +0.99428879891231192000;
        aPoles.ChangeValue(4, 62) =
            gp_Pnt(-172.19641321622018000000, +0.70265088960130029000, -53.85463096447261900000);
        aWeights.ChangeValue(4, 63) = +0.99430150819260854000;
        aPoles.ChangeValue(4, 63) =
            gp_Pnt(-175.07684836851479000000, +0.70105264832187786000, -51.88726956537038900000);
        aWeights.ChangeValue(4, 64) = +0.99431053021705873000;
        aPoles.ChangeValue(4, 64) =
            gp_Pnt(-177.92932492963632000000, +0.69991818857623234000, -49.88000737868681300000);
        aWeights.ChangeValue(4, 65) = +0.99432262020918794000;
        aPoles.ChangeValue(4, 65) =
            gp_Pnt(-180.75433885652521000000, +0.69839807993520564000, -47.83460859504128800000);
        aWeights.ChangeValue(4, 66) = +0.99433338093448842000;
        aPoles.ChangeValue(4, 66) =
            gp_Pnt(-183.37745173242254000000, +0.69704510882650861000, -45.93530736698277700000);
        aWeights.ChangeValue(4, 67) = +0.99434840096468768000;
        aPoles.ChangeValue(4, 67) =
            gp_Pnt(-185.97711214268182000000, +0.69515696483250133000, -44.00334265992864100000);
        aWeights.ChangeValue(4, 68) = +0.99435212441487342000;
        aPoles.ChangeValue(4, 68) =
            gp_Pnt(-188.55092060214918000000, +0.69468843290184534000, -42.03706245316480100000);
        aWeights.ChangeValue(4, 69) = +0.99438632495837886000;
        aPoles.ChangeValue(4, 69) =
            gp_Pnt(-191.10351948864678000000, +0.69039032514405918000, -40.04240176159244400000);
        aWeights.ChangeValue(4, 70) = +0.99437474610357146000;
        aPoles.ChangeValue(4, 70) =
            gp_Pnt(-193.62512272227769000000, +0.69184483548244469000, -38.00925246210125900000);
        aWeights.ChangeValue(4, 71) = +0.99442029730057158000;
        aPoles.ChangeValue(4, 71) =
            gp_Pnt(-196.12715745709386000000, +0.68612074693666814000, -35.95207510226987300000);
        aWeights.ChangeValue(4, 72) = +0.99443382321708784000;
        aPoles.ChangeValue(4, 72) =
            gp_Pnt(-198.59871781224271000000, +0.68442148883790921000, -33.85842837168388500000);
        aWeights.ChangeValue(4, 73) = +0.99445918644353237000;
        aPoles.ChangeValue(4, 73) =
            gp_Pnt(-201.04387700918369000000, +0.68123533540985159000, -31.73471330438436400000);
        aWeights.ChangeValue(4, 74) = +0.99447784672499884000;
        aPoles.ChangeValue(4, 74) =
            gp_Pnt(-203.48830197003542000000, +0.67889067518118906000, -29.61036197082074800000);
        aWeights.ChangeValue(4, 75) = +0.99454111417144087000;
        aPoles.ChangeValue(4, 75) =
            gp_Pnt(-205.90905874701556000000, +0.67094847421818948000, -27.45911353863423800000);
        aWeights.ChangeValue(4, 76) = +0.99445650432969468000;
        aPoles.ChangeValue(4, 76) =
            gp_Pnt(-208.28851122415659000000, +0.68156618053615436000, -25.25989914496455000000);
        aWeights.ChangeValue(4, 77) = +0.99472383917628937000;
        aPoles.ChangeValue(4, 77) =
            gp_Pnt(-210.66819860636727000000, +0.64801004101885640000, -23.06997485052475800000);
        aWeights.ChangeValue(4, 78) = +0.99465154011060308000;
        aPoles.ChangeValue(4, 78) =
            gp_Pnt(-212.99829629837927000000, +0.65709020698928045000, -20.81293704958459000000);
        aWeights.ChangeValue(4, 79) = +0.99469225299704522000;
        aPoles.ChangeValue(4, 79) =
            gp_Pnt(-215.28778722004142000000, +0.65198647566642243000, -18.52648999480212300000);
        aWeights.ChangeValue(4, 80) = +0.99473072608314816000;
        aPoles.ChangeValue(4, 80) =
            gp_Pnt(-217.56233176434088000000, +0.64714607636795729000, -16.22125679272672700000);
        aWeights.ChangeValue(4, 81) = +0.99492849872148770000;
        aPoles.ChangeValue(4, 81) =
            gp_Pnt(-219.81591407133737000000, +0.62237708094437050000, -13.90082269618381800000);
        ...
        aPoles.ChangeValue(5, 10) =
            gp_Pnt(+100.93622072836907000000, +0.24405568433254640000, -82.58935804874866400000);
        ...
        aPoles.ChangeValue(5, 22) =
            gp_Pnt(+33.63739034141031700000, +0.24540449418574758000, -100.97932209286283000000);
        aWeights.ChangeValue(5, 23) = +0.99799971600020576000;
        aPoles.ChangeValue(5, 23) =
            gp_Pnt(+19.75877904385457000000, +0.24550631764576064000, -102.69427034587730000000);
        aWeights.ChangeValue(5, 24) = +0.99799940935225595000;
        aPoles.ChangeValue(5, 24) =
            gp_Pnt(+12.79621461719473900000, +0.24554509442498113000, -103.36264862290150000000);
        ...
        aPoles.ChangeValue(5, 28) =
            gp_Pnt(-15.16330109337111900000, +0.24558900548798951000, -104.13432123956672000000);
        aWeights.ChangeValue(5, 29) = +0.99799918910460916000;
        aPoles.ChangeValue(5, 29) =
            gp_Pnt(-22.15024989420349800000, +0.24557294601509544000, -103.85099166853988000000);
        aWeights.ChangeValue(5, 30) = +0.99799962065035952000;
        aPoles.ChangeValue(5, 30) =
            gp_Pnt(-36.09784025928350100000, +0.24551837507724711000, -102.90426687944763000000);
        aWeights.ChangeValue(5, 31) = +0.99799992612548860000;
        aPoles.ChangeValue(5, 31) =
            gp_Pnt(-43.05848024708384300000, +0.24547974681812620000, -102.24087223758063000000);
        aWeights.ChangeValue(5, 32) = +0.99800032324181287000;
        aPoles.ChangeValue(5, 32) =
            gp_Pnt(-50.00000136683811300000, +0.24542953068576923000, -101.38784584473753000000);
        aWeights.ChangeValue(5, 33) = +0.99800081646744143000;
        aPoles.ChangeValue(5, 33) =
            gp_Pnt(-56.91647304260395400000, +0.24536716218422927000, -100.34581179308852000000);
        ...
        aPoles.ChangeValue(5, 42) =
            gp_Pnt(-102.87118348036965000000, +0.24456571523016235000, -88.73621911304020700000);
        aWeights.ChangeValue(5, 43) = +0.99800782429726465000;
        aPoles.ChangeValue(5, 43) =
            gp_Pnt(-105.93736515171811000000, +0.24448115520035879000, -87.67053246863201800000);
        aWeights.ChangeValue(5, 44) = +0.99800929984371112000;
        aPoles.ChangeValue(5, 44) =
            gp_Pnt(-112.27672847568951000000, +0.24429462970498794000, -85.37690123862388700000);
        aWeights.ChangeValue(5, 45) = +0.99801015470633669000;
        aPoles.ChangeValue(5, 45) =
            gp_Pnt(-115.54769755356581000000, +0.24418656943131900000, -84.14279592325505100000);
        aWeights.ChangeValue(5, 46) = +0.99801097177455889000;
        aPoles.ChangeValue(5, 46) =
            gp_Pnt(-118.80182311076892000000, +0.24408328894344730000, -82.86408351153079400000);
        aWeights.ChangeValue(5, 47) = +0.99801197940129383000;
        aPoles.ChangeValue(5, 47) =
            gp_Pnt(-122.03843417449148000000, +0.24395592759703674000, -81.54111184389478200000);
        aWeights.ChangeValue(5, 48) = +0.99801295017559344000;
        aPoles.ChangeValue(5, 48) =
            gp_Pnt(-125.25678060282321000000, +0.24383322797751039000, -80.17408187890907800000);
        aWeights.ChangeValue(5, 49) = +0.99801403221073270000;
        aPoles.ChangeValue(5, 49) =
            gp_Pnt(-128.45617956663568000000, +0.24369647262362162000, -78.76334161483092100000);
        aWeights.ChangeValue(5, 50) = +0.99801521135655380000;
        aPoles.ChangeValue(5, 50) =
            gp_Pnt(-131.63592529803751000000, +0.24354745092247693000, -77.30919404502431300000);
        aWeights.ChangeValue(5, 51) = +0.99801760008187401000;
        aPoles.ChangeValue(5, 51) =
            gp_Pnt(-137.72900951211963000000, +0.24324557860805471000, -74.42165429070698200000);
        aWeights.ChangeValue(5, 52) = +0.99801898346970708000;
        aPoles.ChangeValue(5, 52) =
            gp_Pnt(-140.64518873661288000000, +0.24307076523393223000, -72.99426192178911800000);
        aWeights.ChangeValue(5, 53) = +0.99801998518786039000;
        aPoles.ChangeValue(5, 53) =
            gp_Pnt(-143.54316005505726000000, +0.24294418386170585000, -71.52981926220020600000);
        aWeights.ChangeValue(5, 54) = +0.99802187318168345000;
        aPoles.ChangeValue(5, 54) =
            gp_Pnt(-146.42260629144496000000, +0.24270562978064991000, -70.02903356238938700000);
        aWeights.ChangeValue(5, 55) = +0.99802301113888081000;
        aPoles.ChangeValue(5, 55) =
            gp_Pnt(-149.28266198929455000000, +0.24256185427332766000, -68.49161271016626500000);
        aWeights.ChangeValue(5, 56) = +0.99802485896051119000;
        aPoles.ChangeValue(5, 56) =
            gp_Pnt(-152.12302992679020000000, +0.24232840183433180000, -66.91836178765569800000);
        aWeights.ChangeValue(5, 57) = +0.99802660746095961000;
        aPoles.ChangeValue(5, 57) =
            gp_Pnt(-154.94301695331424000000, +0.24210751871096883000, -65.30929034698890200000);
        aWeights.ChangeValue(5, 58) = +0.99803055992501044000;
        aPoles.ChangeValue(5, 58) =
            gp_Pnt(-160.75642720778953000000, +0.24160825342055195000, -61.89368007550259400000);
        aWeights.ChangeValue(5, 59) = +0.99803322842160846000;
        aPoles.ChangeValue(5, 59) =
            gp_Pnt(-163.74717060555361000000, +0.24127121961594802000, -60.08255013672670200000);
        aWeights.ChangeValue(5, 60) = +0.99803464125717123000;
        aPoles.ChangeValue(5, 60) =
            gp_Pnt(-166.71086689375946000000, +0.24109275824918924000, -58.22731479955884700000);
        aWeights.ChangeValue(5, 61) = +0.99803901668628470000;
        aPoles.ChangeValue(5, 61) =
            gp_Pnt(-169.65297207222594000000, +0.24054025241076704000, -56.33806928337021700000);
        aWeights.ChangeValue(5, 62) = +0.99804026123435818000;
        aPoles.ChangeValue(5, 62) =
            gp_Pnt(-172.56427255537395000000, +0.24038308942389072000, -54.40260496408483000000);
        aWeights.ChangeValue(5, 63) = +0.99804470691060532000;
        aPoles.ChangeValue(5, 63) =
            gp_Pnt(-175.45101016300779000000, +0.23982181928534163000, -52.43032166263763100000);
        aWeights.ChangeValue(5, 64) = +0.99804786265202527000;
        aPoles.ChangeValue(5, 64) =
            gp_Pnt(-178.30970270493245000000, +0.23942347201733374000, -50.41823769283568900000);
        aWeights.ChangeValue(5, 65) = +0.99805209132460959000;
        aPoles.ChangeValue(5, 65) =
            gp_Pnt(-181.14080917168710000000, +0.23888978094458979000, -48.36782293133622100000);
        aWeights.ChangeValue(5, 66) = +0.99805585511722006000;
        aPoles.ChangeValue(5, 66) =
            gp_Pnt(-183.76963089028271000000, +0.23841474156011525000, -46.46384963887197700000);
        aWeights.ChangeValue(5, 67) = +0.99806110806389992000;
        aPoles.ChangeValue(5, 67) =
            gp_Pnt(-186.37480135254410000000, +0.23775204017864099000, -44.52702607060874100000);
        aWeights.ChangeValue(5, 68) = +0.99806241123039841000;
        aPoles.ChangeValue(5, 68) =
            gp_Pnt(-188.95443339023049000000, +0.23758721013871806000, -42.55611011320790700000);
        aWeights.ChangeValue(5, 69) = +0.99807437025022461000;
        aPoles.ChangeValue(5, 69) =
            gp_Pnt(-191.51185439080101000000, +0.23607937004601673000, -40.55588840407725800000);
        aWeights.ChangeValue(5, 70) = +0.99807032269304363000;
        aPoles.ChangeValue(5, 70) =
            gp_Pnt(-194.03956238778505000000, +0.23658914396266717000, -38.51843887702921200000);
        aWeights.ChangeValue(5, 71) = +0.99808625039358922000;
        aPoles.ChangeValue(5, 71) =
            gp_Pnt(-196.54607703546344000000, +0.23458111537982981000, -36.45513422497234800000);
        aWeights.ChangeValue(5, 72) = +0.99809097922833689000;
        aPoles.ChangeValue(5, 72) =
            gp_Pnt(-199.02284030117690000000, +0.23398526561785285000, -34.35633603568415100000);
        aWeights.ChangeValue(5, 73) = +0.99809984631895676000;
        aPoles.ChangeValue(5, 73) =
            gp_Pnt(-201.47284391020807000000, +0.23286808083306546000, -32.22700780168109700000);
        aWeights.ChangeValue(5, 74) = +0.99810637147739267000;
        aPoles.ChangeValue(5, 74) =
            gp_Pnt(-203.92239692899503000000, +0.23204542949601353000, -30.09717639714928000000);
        aWeights.ChangeValue(5, 75) = +0.99812847998973830000;
        aPoles.ChangeValue(5, 75) =
            gp_Pnt(-206.34684289021220000000, +0.22926391512904498000, -27.93902362306789300000);
        aWeights.ChangeValue(5, 76) = +0.99809892249694432000;
        aPoles.ChangeValue(5, 76) =
            gp_Pnt(-208.73420674519565000000, +0.23297935369059405000, -25.73750919512989600000);
        aWeights.ChangeValue(5, 77) = +0.99819234539430379000;
        aPoles.ChangeValue(5, 77) =
            gp_Pnt(-211.11258262007470000000, +0.22122441504945897000, -23.53328220960779800000);
        aWeights.ChangeValue(5, 78) = +0.99816706733442118000;
        aPoles.ChangeValue(5, 78) =
            gp_Pnt(-213.44890831521380000000, +0.22441150695403267000, -21.27426418813643800000);
        aWeights.ChangeValue(5, 79) = +0.99818127777024523000;
        aPoles.ChangeValue(5, 79) =
            gp_Pnt(-215.74298068197336000000, +0.22262736656649654000, -18.98075706196405200000);
        aWeights.ChangeValue(5, 80) = +0.99819475509184485000;
        aPoles.ChangeValue(5, 80) =
            gp_Pnt(-218.02209738817496000000, +0.22092240555297402000, -16.66880151580776100000);
        aWeights.ChangeValue(5, 81) = +0.99826376750413803000;
        aPoles.ChangeValue(5, 81) =
            gp_Pnt(-220.27506837008727000000, +0.21227676902692139000, -14.33587171753685400000);
        ...
        aPoles.ChangeValue(6, 10) =
            gp_Pnt(+101.22387341781818000000, -0.00000000000003253030, -83.29820264563102200000);
        ...
        aPoles.ChangeValue(6, 21) =
            gp_Pnt(+40.68431826182812500000, +0.00000000000000415229, -100.68882169811890000000);
        aWeights.ChangeValue(6, 22) = +1.00966876842241240000;
        aPoles.ChangeValue(6, 22) =
            gp_Pnt(+33.74965652868991100000, +0.00000000000000595055, -101.73819405254569000000);
        aWeights.ChangeValue(6, 23) = +1.00967255617655690000;
        aPoles.ChangeValue(6, 23) =
            gp_Pnt(+19.83474481990451800000, +0.00000000000000626687, -103.45778313292877000000);
        aWeights.ChangeValue(6, 24) = +1.00967399859793900000;
        aPoles.ChangeValue(6, 24) =
            gp_Pnt(+12.85396744583563800000, +0.00000000000000961706, -104.12796934503771000000);
        ...
        aPoles.ChangeValue(6, 28) =
            gp_Pnt(-15.17875958769639600000, +0.00000000000001381871, -104.90172793642448000000);
        aWeights.ChangeValue(6, 29) = +1.00967503459672230000;
        aPoles.ChangeValue(6, 29) =
            gp_Pnt(-22.18399638815323600000, +0.00000000000001119232, -104.61763141615558000000);
        aWeights.ChangeValue(6, 30) = +1.00967300468446440000;
        aPoles.ChangeValue(6, 30) =
            gp_Pnt(-36.16808769247344200000, +0.00000000000001926896, -103.66834538209933000000);
        aWeights.ChangeValue(6, 31) = +1.00967156777535520000;
        aPoles.ChangeValue(6, 31) =
            gp_Pnt(-43.14695215605046700000, +0.00000000000002086710, -103.00315490229345000000);
        aWeights.ChangeValue(6, 32) = +1.00966969979090850000;
        aPoles.ChangeValue(6, 32) =
            gp_Pnt(-50.10664482445217500000, +0.00000000000002115378, -102.14781821392242000000);
        aWeights.ChangeValue(6, 33) = +1.00966737970297340000;
        aPoles.ChangeValue(6, 33) =
            gp_Pnt(-57.04121502398449900000, +0.00000000000002158031, -101.10296070558179000000);
        ...
        aPoles.ChangeValue(6, 41) =
            gp_Pnt(-100.02825520717420000000, +0.00000000000003564727, -90.49147079864104600000);
        aWeights.ChangeValue(6, 42) = +1.00963755960468200000;
        aPoles.ChangeValue(6, 42) =
            gp_Pnt(-103.11576472135789000000, +0.00000000000003493709, -89.46184640324143800000);
        aWeights.ChangeValue(6, 43) = +1.00963441262388120000;
        aPoles.ChangeValue(6, 43) =
            gp_Pnt(-106.18990874397944000000, +0.00000000000003257692, -88.39325742978746800000);
        aWeights.ChangeValue(6, 44) = +1.00962747055172470000;
        aPoles.ChangeValue(6, 44) =
            gp_Pnt(-112.54574015681582000000, +0.00000000000006160655, -86.09336936272072200000);
        aWeights.ChangeValue(6, 45) = +1.00962344856191890000;
        aPoles.ChangeValue(6, 45) =
            gp_Pnt(-115.82520602454126000000, -0.00000000000003931317, -84.85588414554271700000);
        aWeights.ChangeValue(6, 46) = +1.00961960432502520000;
        aPoles.ChangeValue(6, 46) =
            gp_Pnt(-119.08778487668772000000, +0.00000000000016494845, -83.57368219250022900000);
        aWeights.ChangeValue(6, 47) = +1.00961486341637220000;
        aPoles.ChangeValue(6, 47) =
            gp_Pnt(-122.33277704237545000000, -0.00000000000006102663, -82.24707666574315100000);
        aWeights.ChangeValue(6, 48) = +1.00961029578642010000;
        aPoles.ChangeValue(6, 48) =
            gp_Pnt(-125.55945424028559000000, +0.00000000000005443726, -80.87630621413205700000);
        aWeights.ChangeValue(6, 49) = +1.00960520453872830000;
        aPoles.ChangeValue(6, 49) =
            gp_Pnt(-128.76711471386264000000, +0.00000000000006731284, -79.46169679871513800000);
        aWeights.ChangeValue(6, 50) = +1.00959965618806670000;
        aPoles.ChangeValue(6, 50) =
            gp_Pnt(-131.95505034236234000000, +0.00000000000001744703, -78.00355594499717400000);
        aWeights.ChangeValue(6, 51) = +1.00958841592259230000;
        aPoles.ChangeValue(6, 51) =
            gp_Pnt(-138.06383173526737000000, +0.00000000000005091738, -75.10807262033468100000);
        aWeights.ChangeValue(6, 52) = +1.00958190609477040000;
        aPoles.ChangeValue(6, 52) =
            gp_Pnt(-140.98751167669514000000, +0.00000000000001249767, -73.67671445695528100000);
        aWeights.ChangeValue(6, 53) = +1.00957719226123470000;
        aPoles.ChangeValue(6, 53) =
            gp_Pnt(-143.89297197091258000000, +0.00000000000004304958, -72.20827197874005800000);
        aWeights.ChangeValue(6, 54) = +1.00956830736954160000;
        aPoles.ChangeValue(6, 54) =
            gp_Pnt(-146.77976177895343000000, +0.00000000000014315600, -70.70325097869228200000);
        aWeights.ChangeValue(6, 55) = +1.00956295195680430000;
        aPoles.ChangeValue(6, 55) =
            gp_Pnt(-149.64716302220674000000, -0.00000000000013374459, -69.16163316263994400000);
        aWeights.ChangeValue(6, 56) = +1.00955425555763600000;
        aPoles.ChangeValue(6, 56) =
            gp_Pnt(-152.49476001470052000000, +0.00000000000014982315, -67.58397318476696100000);
        aWeights.ChangeValue(6, 57) = +1.00954602613024340000;
        aPoles.ChangeValue(6, 57) =
            gp_Pnt(-155.32190503332637000000, -0.00000000000000021066, -65.97043121899140800000);
        aWeights.ChangeValue(6, 58) = +1.00952742278739690000;
        aPoles.ChangeValue(6, 58) =
            gp_Pnt(-161.15007234465017000000, -0.00000000000001992904, -62.54527347940126700000);
        aWeights.ChangeValue(6, 59) = +1.00951486183122910000;
        aPoles.ChangeValue(6, 59) =
            gp_Pnt(-164.14837014605524000000, +0.00000000000023572067, -60.72896647597298900000);
        aWeights.ChangeValue(6, 60) = +1.00950821186278380000;
        aPoles.ChangeValue(6, 60) =
            gp_Pnt(-167.11960531963629000000, -0.00000000000028988207, -58.86870049528032900000);
        aWeights.ChangeValue(6, 61) = +1.00948761363721440000;
        aPoles.ChangeValue(6, 61) =
            gp_Pnt(-170.06906478280905000000, +0.00000000000040689923, -56.97372124744497800000);
        aWeights.ChangeValue(6, 62) = +1.00948175483910860000;
        aPoles.ChangeValue(6, 62) =
            gp_Pnt(-172.98765254825670000000, -0.00000000000024250881, -55.03312548926784600000);
        aWeights.ChangeValue(6, 63) = +1.00946082358368820000;
        aPoles.ChangeValue(6, 63) =
            gp_Pnt(-175.88148729884773000000, +0.00000000000015443744, -53.05496328096450000000);
        aWeights.ChangeValue(6, 64) = +1.00944596410276510000;
        aPoles.ChangeValue(6, 64) =
            gp_Pnt(-178.74719668858941000000, +0.00000000000002184305, -51.03719587787818300000);
        aWeights.ChangeValue(6, 65) = +1.00942605045267690000;
        aPoles.ChangeValue(6, 65) =
            gp_Pnt(-181.58512029181043000000, +0.00000000000003863576, -48.98084041218928800000);
        aWeights.ChangeValue(6, 66) = +1.00940832657292460000;
        aPoles.ChangeValue(6, 66) =
            gp_Pnt(-184.22041885135505000000, +0.00000000000012642202, -47.07128183802177500000);
        aWeights.ChangeValue(6, 67) = +1.00938358350016230000;
        aPoles.ChangeValue(6, 67) =
            gp_Pnt(-186.83172267077580000000, -0.00000000000026075896, -45.12863792869809700000);
        aWeights.ChangeValue(6, 68) = +1.00937745534316470000;
        aPoles.ChangeValue(6, 68) =
            gp_Pnt(-189.41814135962036000000, +0.00000000000050815389, -43.15221363464823400000);
        aWeights.ChangeValue(6, 69) = +1.00932110415609880000;
        aPoles.ChangeValue(6, 69) =
            gp_Pnt(-191.98049421722968000000, -0.00000000000036869153, -41.14519558079494000000);
        aWeights.ChangeValue(6, 70) = +1.00934018958992230000;
        aPoles.ChangeValue(6, 70) =
            gp_Pnt(-194.51554398045388000000, +0.00000000000024701945, -39.10283303403318900000);
        aWeights.ChangeValue(6, 71) = +1.00926513417534820000;
        aPoles.ChangeValue(6, 71) =
            gp_Pnt(-197.02654362639632000000, +0.00000000000002378284, -37.03182458375535900000);
        aWeights.ChangeValue(6, 72) = +1.00924284324015100000;
        aPoles.ChangeValue(6, 72) =
            gp_Pnt(-199.50902604112426000000, +0.00000000000001468063, -34.92696457232537500000);
        aWeights.ChangeValue(6, 73) = +1.00920104311988210000;
        aPoles.ChangeValue(6, 73) =
            gp_Pnt(-201.96417476016930000000, +0.00000000000004485301, -32.79087292323346500000);
        aWeights.ChangeValue(6, 74) = +1.00917029694376930000;
        aPoles.ChangeValue(6, 74) =
            gp_Pnt(-204.41947086956830000000, +0.00000000000007013856, -30.65436716589900700000);
        aWeights.ChangeValue(6, 75) = +1.00906597799622610000;
        aPoles.ChangeValue(6, 75) =
            gp_Pnt(-206.84718146821811000000, -0.00000000000006381675, -28.48746943619916600000);
        aWeights.ChangeValue(6, 76) = +1.00920552993238920000;
        aPoles.ChangeValue(6, 76) =
            gp_Pnt(-209.24487385523256000000, +0.00000000000020688933, -26.28443183778934900000);
        aWeights.ChangeValue(6, 77) = +1.00876475817276390000;
        aPoles.ChangeValue(6, 77) =
            gp_Pnt(-211.61934752962611000000, -0.00000000000012087895, -24.05869960942788700000);
        aWeights.ChangeValue(6, 78) = +1.00888387250480620000;
        aPoles.ChangeValue(6, 78) =
            gp_Pnt(-213.96155431166437000000, +0.00000000000019025578, -21.80066237623914200000);
        aWeights.ChangeValue(6, 79) = +1.00881670070678450000;
        aPoles.ChangeValue(6, 79) =
            gp_Pnt(-216.26151615033589000000, -0.00000000000009572292, -19.49741392382435400000);
        aWeights.ChangeValue(6, 80) = +1.00875338528797620000;
        aPoles.ChangeValue(6, 80) =
            gp_Pnt(-218.54531424806936000000, +0.00000000000008182630, -17.17704407009146500000);
        aWeights.ChangeValue(6, 81) = +1.00842683370719580000;
        aPoles.ChangeValue(6, 81) =
            gp_Pnt(-220.79435406720884000000, +0.00000000000004973799, -14.82789528118522200000);
        ...
        aPoles.ChangeValue(7, 10) =
            gp_Pnt(+101.51889932580750000000, +0.00000000000000793496, -84.02514647707548100000);
        ...
        aPoles.ChangeValue(7, 20) =
            gp_Pnt(+47.74179355100338300000, +0.00000000000000683493, -100.22257163394704000000);
        aWeights.ChangeValue(7, 21) = +1.03021974942385920000;
        aPoles.ChangeValue(7, 21) =
            gp_Pnt(+40.81806392732334400000, +0.00000000000000945638, -101.46427420633951000000);
        aWeights.ChangeValue(7, 22) = +1.03022743299486530000;
        aPoles.ChangeValue(7, 22) =
            gp_Pnt(+33.86482072309787100000, +0.00000000000001239365, -102.51656369616552000000);
        aWeights.ChangeValue(7, 23) = +1.03023979631718960000;
        aPoles.ChangeValue(7, 23) =
            gp_Pnt(+19.91267581058432200000, +0.00000000000001269021, -104.24092170462040000000);
        aWeights.ChangeValue(7, 24) = +1.03024450452679180000;
        aPoles.ChangeValue(7, 24) =
            gp_Pnt(+12.91322103073442500000, +0.00000000000001310657, -104.91296575233191000000);
        ...
        aPoles.ChangeValue(7, 28) =
            gp_Pnt(-15.19462185431612500000, +0.00000000000001673746, -105.68886888131540000000);
        aWeights.ChangeValue(7, 29) = +1.03024788619868390000;
        aPoles.ChangeValue(7, 29) =
            gp_Pnt(-22.21861718693262200000, +0.00000000000001767135, -105.40398398356824000000);
        aWeights.ChangeValue(7, 30) = +1.03024126030624560000;
        aPoles.ChangeValue(7, 30) =
            gp_Pnt(-36.24014829916134100000, +0.00000000000002019891, -104.45206611492652000000);
        aWeights.ChangeValue(7, 31) = +1.03023657011944200000;
        aPoles.ChangeValue(7, 31) =
            gp_Pnt(-43.23771519136024500000, +0.00000000000002161068, -103.78502949380328000000);
        aWeights.ChangeValue(7, 32) = +1.03023047292900840000;
        aPoles.ChangeValue(7, 32) =
            gp_Pnt(-50.21605719916001900000, +0.00000000000002249329, -102.92731708926736000000);
        aWeights.ChangeValue(7, 33) = +1.03022290017099440000;
        aPoles.ChangeValue(7, 33) =
            gp_Pnt(-57.16920057960702200000, +0.00000000000002320995, -101.87955571848956000000);
        aWeights.ChangeValue(7, 34) = +1.03021374148842140000;
        aPoles.ChangeValue(7, 34) =
            gp_Pnt(-64.09120253994868200000, +0.00000000000002399266, -100.64259867222304000000);
        ...
        aPoles.ChangeValue(7, 41) =
            gp_Pnt(-100.27090735629974000000, +0.00000000000002960449, -91.23854430518403500000);
        aWeights.ChangeValue(7, 42) = +1.03012558369857450000;
        aPoles.ChangeValue(7, 42) =
            gp_Pnt(-103.36662387191370000000, +0.00000000000003044224, -90.20604688574815100000);
        aWeights.ChangeValue(7, 43) = +1.03011531537676040000;
        aPoles.ChangeValue(7, 43) =
            gp_Pnt(-106.44892584135401000000, +0.00000000000003112785, -89.13447646370049400000);
        aWeights.ChangeValue(7, 44) = +1.03009266486582220000;
        aPoles.ChangeValue(7, 44) =
            gp_Pnt(-112.82164316087234000000, +0.00000000000002877514, -86.82815610446842000000);
        aWeights.ChangeValue(7, 45) = +1.03007954250937140000;
        aPoles.ChangeValue(7, 45) =
            gp_Pnt(-116.10982863064515000000, +0.00000000000005217709, -85.58719260568324200000);
        aWeights.ChangeValue(7, 46) = +1.03006700046765860000;
        aPoles.ChangeValue(7, 46) =
            gp_Pnt(-119.38108228759732000000, -0.00000000000000364635, -84.30140001571530200000);
        aWeights.ChangeValue(7, 47) = +1.03005153385603830000;
        aPoles.ChangeValue(7, 47) =
            gp_Pnt(-122.63466837574235000000, +0.00000000000007773224, -82.97105629274108200000);
        aWeights.ChangeValue(7, 48) = +1.03003663316235050000;
        aPoles.ChangeValue(7, 48) =
            gp_Pnt(-125.86988610286646000000, +0.00000000000000501775, -81.59643931580511400000);
        aWeights.ChangeValue(7, 49) = +1.03002002524069390000;
        aPoles.ChangeValue(7, 49) =
            gp_Pnt(-129.08600965998806000000, +0.00000000000004872530, -80.17785297868806500000);
        aWeights.ChangeValue(7, 50) = +1.03000192732158440000;
        aPoles.ChangeValue(7, 50) =
            gp_Pnt(-132.28232849510800000000, +0.00000000000003627431, -78.71561001568775900000);
        aWeights.ChangeValue(7, 51) = +1.02996526567106140000;
        aPoles.ChangeValue(7, 51) =
            gp_Pnt(-138.40719443250111000000, +0.00000000000004030865, -75.81195871455292900000);
        aWeights.ChangeValue(7, 52) = +1.02994403451619650000;
        aPoles.ChangeValue(7, 52) =
            gp_Pnt(-141.33856968181306000000, +0.00000000000003444592, -74.37651555974527200000);
        aWeights.ChangeValue(7, 53) = +1.02992866105480000000;
        aPoles.ChangeValue(7, 53) =
            gp_Pnt(-144.25171811139330000000, +0.00000000000003429445, -72.90395453557894700000);
        aWeights.ChangeValue(7, 54) = +1.02989968743351530000;
        aPoles.ChangeValue(7, 54) =
            gp_Pnt(-147.14603336223070000000, +0.00000000000004355038, -71.39457006641885100000);
        aWeights.ChangeValue(7, 55) = +1.02988222474475720000;
        aPoles.ChangeValue(7, 55) =
            gp_Pnt(-150.02095857157173000000, +0.00000000000003217269, -69.84863841933133700000);
        aWeights.ChangeValue(7, 56) = +1.02985386954430420000;
        aPoles.ChangeValue(7, 56) =
            gp_Pnt(-152.87595706513403000000, +0.00000000000003648661, -68.26644064265008200000);
        aWeights.ChangeValue(7, 57) = +1.02982704006085530000;
        aPoles.ChangeValue(7, 57) =
            gp_Pnt(-155.71041601974636000000, +0.00000000000003591181, -66.64830754728993200000);
        aWeights.ChangeValue(7, 58) = +1.02976639514271140000;
        aPoles.ChangeValue(7, 58) =
            gp_Pnt(-161.55369960091491000000, +0.00000000000003646415, -63.21332070345936700000);
        aWeights.ChangeValue(7, 59) = +1.02972545417744080000;
        aPoles.ChangeValue(7, 59) =
            gp_Pnt(-164.55974256681068000000, +0.00000000000003294676, -61.39167299907511900000);
        aWeights.ChangeValue(7, 60) = +1.02970377642180270000;
        aPoles.ChangeValue(7, 60) =
            gp_Pnt(-167.53873683551103000000, +0.00000000000002190344, -59.52621075357659900000);
        aWeights.ChangeValue(7, 61) = +1.02963665582099750000;
        aPoles.ChangeValue(7, 61) =
            gp_Pnt(-170.49570646978711000000, +0.00000000000009010479, -57.62531748377598000000);
        aWeights.ChangeValue(7, 62) = +1.02961756328110620000;
        aPoles.ChangeValue(7, 62) =
            gp_Pnt(-173.42176702363508000000, -0.00000000000003499440, -55.67944052993496500000);
        aWeights.ChangeValue(7, 63) = +1.02954937293567860000;
        aPoles.ChangeValue(7, 63) =
            gp_Pnt(-176.32284460610933000000, +0.00000000000007636921, -53.69521656711459900000);
        aWeights.ChangeValue(7, 64) = +1.02950097342681770000;
        aPoles.ChangeValue(7, 64) =
            gp_Pnt(-179.19569709355173000000, +0.00000000000003273955, -51.67161593723249500000);
        aWeights.ChangeValue(7, 65) = +1.02943612532291810000;
        aPoles.ChangeValue(7, 65) =
            gp_Pnt(-182.04053139917158000000, +0.00000000000003996803, -49.60917258111981500000);
        aWeights.ChangeValue(7, 66) = +1.02937840445762090000;
        aPoles.ChangeValue(7, 66) =
            gp_Pnt(-184.68250151172640000000, +0.00000000000004112926, -47.69381589112448700000);
        aWeights.ChangeValue(7, 67) = +1.02929786839945800000;
        aPoles.ChangeValue(7, 67) =
            gp_Pnt(-187.30004443981446000000, +0.00000000000003629801, -45.74517623046489900000);
        aWeights.ChangeValue(7, 68) = +1.02927785532615720000;
        aPoles.ChangeValue(7, 68) =
            gp_Pnt(-189.89358418563035000000, +0.00000000000003708012, -43.76295173174737800000);
        aWeights.ChangeValue(7, 69) = +1.02909457173661250000;
        aPoles.ChangeValue(7, 69) =
            gp_Pnt(-192.46070903458983000000, +0.00000000000005500515, -41.74904085552218200000);
        aWeights.ChangeValue(7, 70) = +1.02915656102268340000;
        aPoles.ChangeValue(7, 70) =
            gp_Pnt(-195.00353322314638000000, +0.00000000000002645256, -39.70148425813464900000);
        aWeights.ChangeValue(7, 71) = +1.02891246604057510000;
        aPoles.ChangeValue(7, 71) =
            gp_Pnt(-197.51895024482548000000, +0.00000000000005006422, -37.62251287581096900000);
        aWeights.ChangeValue(7, 72) = +1.02884001996279940000;
        aPoles.ChangeValue(7, 72) =
            gp_Pnt(-200.00717902020989000000, +0.00000000000003866246, -35.51147139839754600000);
        aWeights.ChangeValue(7, 73) = +1.02870418206103280000;
        aPoles.ChangeValue(7, 73) =
            gp_Pnt(-202.46745722827831000000, +0.00000000000003996803, -33.36845405838467800000);
        aWeights.ChangeValue(7, 74) = +1.02860417892808040000;
        aPoles.ChangeValue(7, 74) =
            gp_Pnt(-204.92874075079348000000, +0.00000000000003952569, -31.22492832365916000000);
        aWeights.ChangeValue(7, 75) = +1.02826579045574770000;
        aPoles.ChangeValue(7, 75) =
            gp_Pnt(-207.35951843182116000000, +0.00000000000002864861, -29.04902036970887700000);
        aWeights.ChangeValue(7, 76) = +1.02871793966685040000;
        aPoles.ChangeValue(7, 76) =
            gp_Pnt(-209.76815931164757000000, +0.00000000000007786791, -26.84449461829588300000);
        aWeights.ChangeValue(7, 77) = +1.02728787827248790000;
        aPoles.ChangeValue(7, 77) =
            gp_Pnt(-212.13952611955784000000, -0.00000000000002645359, -24.59453985262025100000);
        aWeights.ChangeValue(7, 78) = +1.02767535385751650000;
        aPoles.ChangeValue(7, 78) =
            gp_Pnt(-214.48523983715771000000, +0.00000000000011316462, -22.34028621398329100000);
        aWeights.ChangeValue(7, 79) = +1.02745809923196680000;
        aPoles.ChangeValue(7, 79) =
            gp_Pnt(-216.79261871005519000000, -0.00000000000002978790, -20.02558452892611700000);
        aWeights.ChangeValue(7, 80) = +1.02725110106353260000;
        aPoles.ChangeValue(7, 80) =
            gp_Pnt(-219.08116944862113000000, +0.00000000000005732296, -17.69632354506026700000);
...
enum AllocTestStatus { NotApplicable = 0x1, OUMCatchOK = 0x2, OUMCatchFail = 0x4 };
...
static Standard_Integer OCC27021(Draw_Interpretor& theDI, Standard_Integer theNArg, const char** theArgVal) {
    if (theNArg != 2) {
...
static Standard_Integer OCC27235(Draw_Interpretor& theDI, Standard_Integer n, const char** a) {
    ...
    for (Standard_Integer i = 1; i <= aGDTs.Length(); i++) {
        ...
        if (!aGDTs.Value(i).FindAttribute(XCAFDoc_Dimension::GetID(), aDimAttr)) continue;
        Handle(XCAFDimTolObjects_DimensionObject) anObject = aDimAttr->GetObject();
        if (anObject.IsNull()) continue;
        TopoDS_Shape aShape = anObject->GetPresentation();
        if (!aShape.IsNull()) B.Add(aPresentations, aShape);
    }
    ...
    for (Standard_Integer i = 1; i <= aGDTs.Length(); i++) {
        ...
        if (!aGDTs.Value(i).FindAttribute(XCAFDoc_GeomTolerance::GetID(), aGTAttr)) continue;
    ...
    for (Standard_Integer i = 1; i <= aLabels.Length(); i++) {
        ...
        if (aDimTolTool->GetRefDatumLabel(aLabels.Value(i), aDatL)) {
            for (Standard_Integer j = aDatL.Lower(); j <= aDatL.Upper(); j++) {
                ...
                if (!aDatL.Value(j).FindAttribute(XCAFDoc_Datum::GetID(), aDat)) continue;
...
// purpose :
//=======================================================================
static Standard_Integer OCC26930(Draw_Interpretor& theDI, Standard_Integer theNArg, const char** theArgVal) {
    if (theNArg != 5) {
...
// purpose :
//=======================================================================
static Standard_Integer OCC27466(Draw_Interpretor& theDI, Standard_Integer theNArg, const char** theArgVal) {
    if (theNArg != 4) {
    ...
    gp_Pnt aPnt;
    if (!DrawTrSurf::GetPoint(theArgVal[2], aPnt)) return 1;
    gp_Pnt2d aUV;
    if (!DrawTrSurf::GetPoint2d(theArgVal[3], aUV)) return 1;
...
//========================================================================
static void OCC26747_CheckParabola(Draw_Interpretor& theDI, const char* theName,
    ...
    theDI << "A = " << aF[0] << ", B = " << aF[1] << ", C = " << aF[2] << ", D = " << aF[3] << ", E = " << aF[4]
          << ", F = " << aF[5] << "\n";
...
//========================================================================
static Standard_Integer OCC26747_1(Draw_Interpretor& theDI, Standard_Integer theNArg, const char** theArgVal) {
    if (theNArg < 2) {
...
// purpose  : Creates a 2D-parabola for testing
//=======================================================================
static Standard_Integer OCC26747_2(Draw_Interpretor& theDI, Standard_Integer theNArg, const char** theArgVal) {
    if (theNArg < 2) {
...
// purpose  : Creates a 2D-parabola for testing
//=======================================================================
static Standard_Integer OCC26747_3(Draw_Interpretor& theDI, Standard_Integer theNArg, const char** theArgVal) {
    if (theNArg < 2) {
        theDI << "Use: OCC26747_2 result\n";
        return 1;
    }
...
static Standard_Integer OCC27357(Draw_Interpretor& theDI, Standard_Integer, const char**) {
    ...
    for (int i = 0; i < nP; i++) {
        ...
        try {
            ...
            Geom2dGcc_Circ2d2TanOn aCircleBuilder(qualifiedC1, qualifiedC2, Geom2dAdaptor_Curve(normalLine), 1e-9, g1,
                                                  g1, g3);
...
// purpose :
//=======================================================================
static Standard_Integer OCC26270(Draw_Interpretor& theDI, Standard_Integer theNArg, const char** theArgVal) {
    if (theNArg != 3) {
...
static Standard_Integer OCC27875(Draw_Interpretor& theDI, Standard_Integer theNArg, const char** theArgVal) {
    if (theNArg < 2) {
...
static Standard_Integer OCC27884(Draw_Interpretor& theDI, Standard_Integer theArgNb, const char** theArgVec) {
    if (theArgNb != 4) {
        return 0;
    }
...
static Standard_Integer OCC28389(Draw_Interpretor& di, Standard_Integer argc, const char** argv) {
    if (argc < 20) {
        di << "Use: OCC28389 Doc label nb_shapes nb_GDT nb_planes name type pp_x pp_y pp_z vd_x vd_y vd_z ud_x ud_y "
              "ud_z zoom width height";
        return 1;
    }
    ...
    if (aSequence.Length() != nbShapes) isOK = Standard_False;
    aSequence.Clear();
    aViewTool->GetRefGDTLabel(aLabel, aSequence);
    if (aSequence.Length() != nbGDTs) isOK = Standard_False;
    aSequence.Clear();
    aViewTool->GetRefClippingPlaneLabel(aLabel, aSequence);
    if (aSequence.Length() != nbPlanes) isOK = Standard_False;
    if (!isOK) {
    ...
    if (fabs(anObj->WindowHorizontalSize() - Draw::Atof(argv[18])) > Precision::Confusion()) isOK = Standard_False;
    if (fabs(anObj->WindowVerticalSize() - Draw::Atof(argv[19])) > Precision::Confusion()) isOK = Standard_False;
    if (!isOK) {
...
#define QCOMPARE(val1, val2) di << "Checking " #val1 " == " #val2 << ((val1) == (val2) ? ": OK\n" : ": Error\n")
...
// purpose  :
//=======================================================================
static Standard_Integer OCC29430(Draw_Interpretor& theDI, Standard_Integer /*theNArg*/, const char** theArgVal) {
    const Standard_Real r45 = M_PI / 4.0, r225 = 3.0 * M_PI / 4.0;

    GC_MakeArcOfCircle arcMaker(
        gp_Circ(gp_Ax2(gp_Pnt(0.0, 0.0, 0.0), gp_Dir(0.0, 0.0, 1.0), gp_Dir(1.0, 0.0, 0.0)), 1.0), r45, r225,
        Standard_True);
...
static Standard_Integer OCC30391(Draw_Interpretor& theDI, Standard_Integer theNArg, const char** theArgV) {
    if (theNArg < 7) {
    ...
    TopoDS_Face Result;
    BRepOffset_Tool::EnLargeFace(aFace, Result, Standard_True, Standard_True, Standard_True, Standard_True,
                                 Standard_True, 1, aLenBeforeUfirst, aLenAfterUlast, aLenBeforeVfirst, aLenAfterVlast);
...
static Standard_Integer OCC29195(Draw_Interpretor&, Standard_Integer theArgC, const char** theArgV) {
    if (theArgC < 2) {
        std::cout << "\nOCC29195 [nbRep] doc1.cbf doc1.xml doc1.std outDoc1.cbf outDoc1.xml doc2.cbf doc2.xml doc2.std "
                     "outDoc2.cbf outDoc2.xml ...], where:";
...
public:
    ...
    CurveEvaluator(const Handle(Adaptor3d_Curve) & C) : myCurve(C) {
        myNbPnt = 1;
        myNbPnt2d = 0;
    }
    ...
    Standard_Boolean Value(const Standard_Real theT, NCollection_Array1<gp_Pnt2d>& /*thePnt2d*/,
                           NCollection_Array1<gp_Pnt>& thePnt) const {
        thePnt(1) = myCurve->Value(theT);
        return Standard_True;
    }

    Standard_Boolean D1(const Standard_Real theT, NCollection_Array1<gp_Vec2d>& /*theVec2d*/,
...
static Standard_Integer OCC30708_1(Draw_Interpretor& di, Standard_Integer, const char**) {
    ...
    if (it.More()) di << "Incorrect Iterator initialization: method More() returns true on null shape\n";
...
static Standard_Integer OCC30869(Draw_Interpretor& theDI, Standard_Integer theArgc, const char** theArgv) {
    ...
    if (aVFirst.SquareMagnitude() > gp::Resolution()) aVFirst.Normalize();
    if (aVLast.SquareMagnitude() > gp::Resolution()) aVLast.Normalize();

    theDI << aFirst << ": point " << aPFirst.X() << " " << aPFirst.Y() << " " << aPFirst.Z() << ", tangent "
          << aVFirst.X() << " " << aVFirst.Y() << " " << aVFirst.Z() << "\n";

    theDI << aLast << ": point " << aPLast.X() << " " << aPLast.Y() << " " << aPLast.Z() << ", tangent " << aVLast.X()
          << " " << aVLast.Y() << " " << aVLast.Z() << "\n";
...
static Standard_Integer OCC30990(Draw_Interpretor& theDI, Standard_Integer theNArg, const char** theArgV) {
    ...
    const Handle(Geom_BSplineSurface) aSurf = Handle(Geom_BSplineSurface)::DownCast(DrawTrSurf::GetSurface(theArgV[1]));
    if (aSurf.IsNull()) {
...
static Standard_Integer OCC31320(Draw_Interpretor& di, Standard_Integer argc, const char** argv) {
    ...
    if (!aLabel.IsNull() && aLabel.FindAttribute(TObj_TModel::GetID(), aModelAttr)) aModel = aModelAttr->Model();
...
public:
    QABugs_XdeLoader(const Handle(TDocStd_Application) & theXdeApp, const Handle(TDocStd_Document) & theXdeDoc,
                     const TCollection_AsciiString& theFilePath)
        : OSD_Thread(performThread), myXdeApp(theXdeApp), myXdeDoc(theXdeDoc), myFilePath(theFilePath) {}
...
//=======================================================================
static Standard_Integer OCC31785(Draw_Interpretor& theDI, Standard_Integer theNbArgs, const char** theArgVec) {
    if (theNbArgs != 2) {
...
void QABugs::Commands_20(Draw_Interpretor& theCommands) {
    ...
    theCommands.Add("OCC29289", "OCC29289 : searching trigonometric root by Newton iterations", __FILE__, OCC29289,
                    group);
    ...
    theCommands.Add("OCC29925", "OCC29925: check safety of character classification functions", __FILE__, OCC29925,
                    group);
    theCommands.Add("OCC29807", "OCC29807 surface1 surface2 u1 v1 u2 v2", __FILE__, OCC29807, group);
    theCommands.Add("OCC29311", "OCC29311 shape counter nbiter: check performance of OBB calculation", __FILE__,
                    OCC29311, group);
    theCommands.Add("OCC30391", "OCC30391 result face LenBeforeUfirst LenAfterUlast LenBeforeVfirst LenAfterVlast",
                    __FILE__, OCC30391, group);
    ...
    theCommands.Add("OCC30708_1", "Tests initialization of the TopoDS_Iterator with null shape", __FILE__, OCC30708_1,
                    group);

    theCommands.Add("OCC30708_2", "Tests initialization of the BRepLib_MakeWire with null shape", __FILE__, OCC30708_2,
                    group);
    ...
    theCommands.Add("OCC31320",
                    "OCC31320 DocName ObjName : tests remove of the children GetFather method if father is removed",
                    __FILE__, OCC31320, group);

    theCommands.Add("OCC31785", "OCC31785 file.xbf : test reading XBF file in another thread", __FILE__, OCC31785,
                    group);

    theCommands.Add("QANullifyShape", "Nullify shape. Usage: QANullifyShape shape", __FILE__, QANullifyShape, group);

    theCommands.Add("OCC29406", "Tests the case when newly set axis for gp_Ax3 is parallel to one of current axis",
                    __FILE__, OCC29406, group);

    theCommands.Add("OCC32744", "Tests avoid Endless loop in GCPnts_UniformDeflection", __FILE__, OCC32744, group);
