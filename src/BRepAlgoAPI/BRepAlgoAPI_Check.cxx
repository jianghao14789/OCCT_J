...
BRepAlgoAPI_Check::BRepAlgoAPI_Check()
    : BOPAlgo_Options(), myTestSE(Standard_True), myTestSI(Standard_True), myOperation(BOPAlgo_UNKNOWN) {}

//=======================================================================
// function : BRepAlgoAPI_Check
// purpose  :
//=======================================================================
BRepAlgoAPI_Check::BRepAlgoAPI_Check(const TopoDS_Shape& theS, const Standard_Boolean bTestSE,
                                     const Standard_Boolean bTestSI, const Message_ProgressRange& theRange)
    : BOPAlgo_Options(), myS1(theS), myTestSE(bTestSE), myTestSI(bTestSI), myOperation(BOPAlgo_UNKNOWN) {
    Perform(theRange);
}
...
// purpose  :
//=======================================================================
BRepAlgoAPI_Check::BRepAlgoAPI_Check(const TopoDS_Shape& theS1, const TopoDS_Shape& theS2,
                                     const BOPAlgo_Operation theOp, const Standard_Boolean bTestSE,
                                     const Standard_Boolean bTestSI, const Message_ProgressRange& theRange)
    : BOPAlgo_Options(), myS1(theS1), myS2(theS2), myTestSE(bTestSE), myTestSI(bTestSI), myOperation(theOp) {
    Perform(theRange);
}
