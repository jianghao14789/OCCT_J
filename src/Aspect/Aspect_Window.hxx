...
public:
    ...
    //! Modifies the window gradient background.
    Standard_EXPORT void SetBackground(const Quantity_Color& theFirstColor, const Quantity_Color& theSecondColor,
    ...
    virtual void InvalidateContent(const Handle(Aspect_DisplayConnection) & theDisp) {
        (void)theDisp;
    }
