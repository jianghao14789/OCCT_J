...
public:
    ...
    Standard_EXPORT void KeyFromAxis(Aspect_VKey theNegative, Aspect_VKey thePositive, double theTime,
                                     double thePressure);
    ...
    //! @return TRUE if key was in pressed state
    Standard_EXPORT bool HoldDuration(Aspect_VKey theKey, double theTime, double& theDuration, double& thePressure);
