...
Aspect_CircularGrid::Aspect_CircularGrid(const Standard_Real aRadiusStep, const Standard_Integer aDivisionNumber,
                                         const Standard_Real anXOrigin, const Standard_Real anYOrigin,
                                         const Standard_Real aRotationAngle)
    : Aspect_Grid(anXOrigin, anYOrigin, aRotationAngle), myRadiusStep(aRadiusStep), myDivisionNumber(aDivisionNumber) {}
...
void Aspect_CircularGrid::SetGridValues(const Standard_Real theXOrigin, const Standard_Real theYOrigin,
...
void Aspect_CircularGrid::Compute(const Standard_Real X, const Standard_Real Y, Standard_Real& gridX,
