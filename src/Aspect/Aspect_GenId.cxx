...
Aspect_GenId::Aspect_GenId()
    : myFreeCount(INT_MAX / 2 + 1), myLength(INT_MAX / 2 + 1), myLowerBound(0), myUpperBound(INT_MAX / 2) {
    //
}
...
Aspect_GenId::Aspect_GenId(const Standard_Integer theLow, const Standard_Integer theUpper)
    : myFreeCount(theUpper - theLow + 1), myLength(theUpper - theLow + 1), myLowerBound(theLow),
