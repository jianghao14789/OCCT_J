...
Aspect_Grid::Aspect_Grid(const Standard_Real theXOrigin, const Standard_Real theYOrigin, const Standard_Real theAngle,
                         const Quantity_Color& theColor, const Quantity_Color& theTenthColor)
    : myRotationAngle(theAngle), myXOrigin(theXOrigin), myYOrigin(theYOrigin), myColor(theColor),
      myTenthColor(theTenthColor), myIsActive(Standard_False), myDrawMode(Aspect_GDM_Lines) {
    //
}
...
void Aspect_Grid::Hit(const Standard_Real theX, const Standard_Real theY, Standard_Real& theGridX,
