...
public:
    ...
    virtual bool SubmitEye(void* theTexture, Aspect_GraphicsLibrary theGraphicsLib, Aspect_ColorSpace theColorSpace,
                           Aspect_Eye theEye) = 0;
    ...
    const Handle(Aspect_XRAction) &
        GenericAction(Aspect_XRTrackedDeviceRole theDevice, Aspect_XRGenericAction theAction) const {
...
protected:
    NCollection_Array1<Handle(Aspect_XRAction)> myRoleActions[Aspect_XRTrackedDeviceRole_NB]; //!< generic actions
