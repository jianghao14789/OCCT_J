...
public:
    ...
    //! X,Y.
    Standard_EXPORT void Hit(const Standard_Real X, const Standard_Real Y, Standard_Real& gridX,
...
protected:
    ...
    Standard_EXPORT Aspect_Grid(const Standard_Real theXOrigin = 0.0, const Standard_Real theYOrigin = 0.0,
