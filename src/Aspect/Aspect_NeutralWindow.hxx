...
public:
    ...
    //! Set native handles.
    //! @return true if definition has been changed
    Standard_EXPORT Standard_Boolean SetNativeHandles(Aspect_Drawable theWindow, Aspect_Drawable theParentWindow,
    ...
    //! Set the window position.
    //! @return true if position has been changed
    Standard_EXPORT Standard_Boolean SetPosition(Standard_Integer theX1, Standard_Integer theY1, Standard_Integer theX2,
    ...
    Standard_EXPORT Standard_Boolean SetSize(const Standard_Integer theWidth, const Standard_Integer theHeight);
