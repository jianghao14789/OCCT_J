...
public:
    ...
    Standard_EXPORT Handle(Geom2d_BSplineCurve)
        Curve2dFromTwo1d(const Standard_Integer Index1d, const Standard_Integer Index2d) const;
    ...
    //! if the Approx is not Done
    Standard_EXPORT Handle(Geom2d_BSplineCurve)
        Curve2d(const Standard_Integer Index1d, const Standard_Integer Index2d) const;
    ...
    Standard_EXPORT Handle(Geom_BSplineCurve)
        Curve(const Standard_Integer Index1D, const Standard_Integer Index3D) const;
