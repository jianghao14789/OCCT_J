...
static Standard_Boolean Controle(const TColgp_Array1OfPnt& P, const gp_Pln& Plan, const Standard_Real Tol) {
    Standard_Integer ii;
...
static Standard_Boolean Controle(const TColgp_Array1OfPnt& Poles, const Standard_Real Tol,
                                 const Handle(Geom_Surface) & S, gp_Pln& Plan) {
...
static Standard_Boolean Controle(const Handle(Geom_Curve) & C, const gp_Pln& Plan, const Standard_Real Tol) {
    Standard_Boolean B = Standard_True;
...
GeomLib_IsPlanarSurface::GeomLib_IsPlanarSurface(const Handle(Geom_Surface) & S, const Standard_Real Tol)

{
    ...
    switch (Type) {
        ...
        case GeomAbs_BSplineSurface: {
            Standard_Integer ii, jj, kk, NbU = AS.NbUPoles(), NbV = AS.NbVPoles();
