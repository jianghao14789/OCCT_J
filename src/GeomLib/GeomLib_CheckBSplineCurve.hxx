...
public:
    ...
    Standard_EXPORT GeomLib_CheckBSplineCurve(const Handle(Geom_BSplineCurve) & Curve, const Standard_Real Tolerance,
    ...
    Standard_EXPORT Handle(Geom_BSplineCurve)
        FixedTangent(const Standard_Boolean FirstFlag, const Standard_Boolean LastFlag);

protected:
private:
    void FixTangentOnCurve(Handle(Geom_BSplineCurve) & theCurve, const Standard_Boolean FirstFlag,
