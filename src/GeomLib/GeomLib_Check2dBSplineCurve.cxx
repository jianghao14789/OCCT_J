    ...
    if ((!myCurve->IsPeriodic()) && num_poles >= 4) {
        ...
        for (ii = 3; ii <= num_poles; ii++) {
            ...
            if (tangent_magnitude > myTolerance && vector_magnitude > myTolerance) {
                ...
                if (Abs(CrossProd) > CrossProdTol) break;
...
void GeomLib_Check2dBSplineCurve::NeedTangentFix(Standard_Boolean& FirstFlag, Standard_Boolean& LastFlag) const {
...
void GeomLib_Check2dBSplineCurve::FixTangent(const Standard_Boolean FirstFlag, const Standard_Boolean LastFlag) {
