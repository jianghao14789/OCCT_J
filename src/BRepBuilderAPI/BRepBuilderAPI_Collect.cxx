...
static void BuildBack(const TopTools_DataMapOfShapeListOfShape& M1, TopTools_DataMapOfShapeShape& BM1) {
...
static void Replace(TopTools_ListOfShape& L, const TopoDS_Shape Old, const TopTools_ListOfShape& New) {
    //-----------------------------------
...
static void StoreImage(TopTools_DataMapOfShapeListOfShape& MG, const TopoDS_Shape& S,
                       const TopTools_DataMapOfShapeShape& MGBack, const TopTools_ListOfShape& LI) {
    if (!LI.IsEmpty()) {
        if (MGBack.IsBound(S)) {
...
static void Update(TopTools_DataMapOfShapeListOfShape& Mod, TopTools_DataMapOfShapeListOfShape& Gen,
                   const TopTools_DataMapOfShapeShape& ModBack, const TopTools_DataMapOfShapeShape& GenBack,
                   const TopoDS_Shape& SI, BRepBuilderAPI_MakeShape& MKS, const TopAbs_ShapeEnum ShapeType) {
