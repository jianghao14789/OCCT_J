...
BRepBuilderAPI_MakeShell::BRepBuilderAPI_MakeShell(const Handle(Geom_Surface) & S, const Standard_Boolean Segment)
...
BRepBuilderAPI_MakeShell::BRepBuilderAPI_MakeShell(const Handle(Geom_Surface) & S, const Standard_Real UMin,
                                                   const Standard_Real UMax, const Standard_Real VMin,
                                                   const Standard_Real VMax, const Standard_Boolean Segment)
...
void BRepBuilderAPI_MakeShell::Init(const Handle(Geom_Surface) & S, const Standard_Real UMin, const Standard_Real UMax,
