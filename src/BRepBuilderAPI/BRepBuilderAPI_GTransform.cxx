...
// purpose  :
//=======================================================================
BRepBuilderAPI_GTransform::BRepBuilderAPI_GTransform(const gp_GTrsf& T) : myGTrsf(T) {
...
BRepBuilderAPI_GTransform::BRepBuilderAPI_GTransform(const TopoDS_Shape& S, const gp_GTrsf& T,
...
void BRepBuilderAPI_GTransform::Perform(const TopoDS_Shape& S, const Standard_Boolean Copy) {
    ...
    Handle(BRepTools_GTrsfModification) theModif = Handle(BRepTools_GTrsfModification)::DownCast(myModification);
...
TopoDS_Shape BRepBuilderAPI_GTransform::ModifiedShape(const TopoDS_Shape& S) const {
    ...
    if (aMapModif.IsBound(S)) {
        ...
        if (aNbShapes > 0) aShape = aListModShape.First();
    }
