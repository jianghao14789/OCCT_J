...
public:
    ...
    Standard_EXPORT void SetRadius(const Standard_Real R1, const Standard_Real R2, const Standard_Integer IC,
    ...
    Standard_EXPORT void SetRadius(const Handle(Law_Function) & L, const Standard_Integer IC,
                                   const Standard_Integer IinC);
    ...
    Standard_EXPORT void SetRadius(const TColgp_Array1OfPnt2d& UandR, const Standard_Integer IC,
                                   const Standard_Integer IinC);
    ...
    Standard_EXPORT Standard_Boolean GetBounds(const Standard_Integer IC, const TopoDS_Edge& E, Standard_Real& F,
                                               Standard_Real& L);
    ...
    Standard_EXPORT Handle(ChFiDS_SecHArray1)
        Sect(const Standard_Integer IC, const Standard_Integer IS) const Standard_OVERRIDE;
