...
void BRepFilletAPI_MakeChamfer::SetDist(const Standard_Real Dis, const Standard_Integer IC, const TopoDS_Face& F) {
...
void BRepFilletAPI_MakeChamfer::Add(const Standard_Real Dis1, const Standard_Real Dis2, const TopoDS_Edge& E,
                                    const TopoDS_Face& F) {
...
void BRepFilletAPI_MakeChamfer::SetDists(const Standard_Real Dis1, const Standard_Real Dis2, const Standard_Integer IC,
                                         const TopoDS_Face& F) {
...
void BRepFilletAPI_MakeChamfer::Dists(const Standard_Integer IC, Standard_Real& Dis1, Standard_Real& Dis2) const {
...
void BRepFilletAPI_MakeChamfer::AddDA(const Standard_Real Dis, const Standard_Real Angle, const TopoDS_Edge& E,
                                      const TopoDS_Face& F) {
...
void BRepFilletAPI_MakeChamfer::SetDistAngle(const Standard_Real Dis, const Standard_Real Angle,
                                             const Standard_Integer IC, const TopoDS_Face& F) {
...
void BRepFilletAPI_MakeChamfer::GetDistAngle(const Standard_Integer IC, Standard_Real& Dis,
...
const TopoDS_Edge& BRepFilletAPI_MakeChamfer::Edge(const Standard_Integer I, const Standard_Integer J) const {
    const Handle(ChFiDS_Spine) & Spine = myBuilder.Value(I);
...
Standard_Real BRepFilletAPI_MakeChamfer::Abscissa(const Standard_Integer IC, const TopoDS_Vertex& V) const {
...
Standard_Real BRepFilletAPI_MakeChamfer::RelativeAbscissa(const Standard_Integer IC, const TopoDS_Vertex& V) const {
...
Handle(ChFiDS_SecHArray1) BRepFilletAPI_MakeChamfer::Sect(const Standard_Integer IC, const Standard_Integer IS) const {
