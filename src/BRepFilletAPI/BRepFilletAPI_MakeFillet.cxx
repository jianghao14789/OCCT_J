...
// purpose  :
//=======================================================================
BRepFilletAPI_MakeFillet::BRepFilletAPI_MakeFillet(const TopoDS_Shape& S, const ChFi3d_FilletShape FShape)
    : myBuilder(S, FShape) {}
...
void BRepFilletAPI_MakeFillet::SetParams(const Standard_Real Tang, const Standard_Real Tesp, const Standard_Real T2d,
...
void BRepFilletAPI_MakeFillet::SetContinuity(const GeomAbs_Shape InternalContinuity, const Standard_Real AngleTol) {
...
void BRepFilletAPI_MakeFillet::Add(const Standard_Real Radius, const TopoDS_Edge& E) {
    ...
    if (IC) SetRadius(Radius, IC, IinC);
}
...
void BRepFilletAPI_MakeFillet::Add(const Standard_Real R1, const Standard_Real R2, const TopoDS_Edge& E) {
    myBuilder.Add(E);
    Standard_Integer IinC;
    Standard_Integer IC = myBuilder.Contains(E, IinC);
    if (IC) SetRadius(R1, R2, IC, IinC);
}
...
void BRepFilletAPI_MakeFillet::SetRadius(const Standard_Real Radius, const Standard_Integer IC,
...
void BRepFilletAPI_MakeFillet::SetRadius(const Standard_Real R1, const Standard_Real R2, const Standard_Integer IC,
                                         const Standard_Integer IinC) {
    Standard_Real r1, r2;
...
void BRepFilletAPI_MakeFillet::SetRadius(const Handle(Law_Function) & L, const Standard_Integer IC,
                                         const Standard_Integer IinC) {
...
void BRepFilletAPI_MakeFillet::SetRadius(const TColgp_Array1OfPnt2d& UandR, const Standard_Integer IC,
                                         const Standard_Integer IinC) {
    if (UandR.Length() == 1)
...
Standard_Boolean BRepFilletAPI_MakeFillet::IsConstant(const Standard_Integer IC, const TopoDS_Edge& E) {
...
void BRepFilletAPI_MakeFillet::SetRadius(const Standard_Real Radius, const Standard_Integer IC, const TopoDS_Edge& E) {
...
Standard_Boolean BRepFilletAPI_MakeFillet::GetBounds(const Standard_Integer IC, const TopoDS_Edge& E, Standard_Real& F,
                                                     Standard_Real& L) {
...
Handle(Law_Function) BRepFilletAPI_MakeFillet::GetLaw(const Standard_Integer IC, const TopoDS_Edge& E) {
...
void BRepFilletAPI_MakeFillet::SetLaw(const Standard_Integer IC, const TopoDS_Edge& E, const Handle(Law_Function) & L) {
...
const TopoDS_Edge& BRepFilletAPI_MakeFillet::Edge(const Standard_Integer I, const Standard_Integer J) const {
    const Handle(ChFiDS_Spine) & Spine = myBuilder.Value(I);
...
Standard_Real BRepFilletAPI_MakeFillet::Abscissa(const Standard_Integer IC, const TopoDS_Vertex& V) const {
...
Standard_Real BRepFilletAPI_MakeFillet::RelativeAbscissa(const Standard_Integer IC, const TopoDS_Vertex& V) const {
...
Handle(ChFiDS_SecHArray1) BRepFilletAPI_MakeFillet::Sect(const Standard_Integer IC, const Standard_Integer IS) const {
