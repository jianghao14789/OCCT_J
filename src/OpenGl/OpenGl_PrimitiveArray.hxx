...
public:
    ...
    virtual Standard_Boolean IsFillDrawMode() const Standard_OVERRIDE {
        return myIsFillType;
    }
...
private:
    ...
    void drawArray(const Handle(OpenGl_Workspace) & theWorkspace, const Graphic3d_Vec4* theFaceColors,
