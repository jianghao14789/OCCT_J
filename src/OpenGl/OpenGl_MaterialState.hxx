...
public:
    ...
    void Set(const OpenGl_Material& theMat, const float theAlphaCutoff, const bool theToDistinguish,
    ...
    const OpenGl_Material& Material() const {
        return myMaterial;
    }
