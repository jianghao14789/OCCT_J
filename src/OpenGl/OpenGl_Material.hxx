...
struct OpenGl_Material {
    ...
    //! Initialize material
    void Init(const OpenGl_Context& theCtx, const Graphic3d_MaterialAspect& theFront,
    ...
    const OpenGl_Vec4* PackedCommon() const {
        return reinterpret_cast<const OpenGl_Vec4*>(Common);
    }
    ...
    const OpenGl_Vec4* PackedPbr() const {
        return reinterpret_cast<const OpenGl_Vec4*>(Pbr);
    }
...
private:
    //! Initialize material
    void init(const OpenGl_Context& theCtx, const Graphic3d_MaterialAspect& theMat, const Quantity_Color& theColor,
