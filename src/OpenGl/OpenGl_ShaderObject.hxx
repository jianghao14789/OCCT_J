...
public:
    ...
    Standard_EXPORT Standard_Boolean LoadAndCompile(const Handle(OpenGl_Context) & theCtx,
                                                    ...
                                                    const TCollection_AsciiString& theSource, bool theIsVerbose = true,
                                                    bool theToPrintSource = true);

    //! Print source code of this shader object to messenger.
    Standard_EXPORT void DumpSourceCode(const Handle(OpenGl_Context) & theCtx, const TCollection_AsciiString& theId,
...
public:
    ...
    //! timestamp than myDumpDate, shader  will be recompiled and TRUE will be returned.
