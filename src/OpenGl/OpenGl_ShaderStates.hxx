...
public:
    ...
    bool HasShadowMaps() const {
        return myToCastShadows && !myShadowMaps.IsNull();
    }
...
private:
    ...
    Standard_Integer mySpecIBLMapLevels; //!< Number of mipmap levels used in specular IBL map (0 by default or in case
                                         //!< of using non-PBR shading model)
