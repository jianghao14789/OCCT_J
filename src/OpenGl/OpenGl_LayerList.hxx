...
public:
    ...
    Standard_Integer NbImmediateStructures() const {
        return myImmediateNbStructures;
    }
    ...
    Standard_EXPORT void AddStructure(const OpenGl_Structure* theStruct, const Graphic3d_ZLayerId theLayerId,
    ...
    //! in default z layer
    Standard_EXPORT void ChangeLayer(const OpenGl_Structure* theStructure, const Graphic3d_ZLayerId theOldLayerId,
                                     const Graphic3d_ZLayerId theNewLayerId);

    //! Changes structure priority within its ZLayer
    Standard_EXPORT void ChangePriority(const OpenGl_Structure* theStructure, const Graphic3d_ZLayerId theLayerId,
    ...
    Standard_EXPORT void Render(const Handle(OpenGl_Workspace) & theWorkspace,
                                const Standard_Boolean theToDrawImmediate, const OpenGl_LayerFilter theLayersToProcess,
    ...
    Standard_Size ModificationStateOfRaytracable() const {
        return myModifStateOfRaytraceable;
    }
...
protected:
    ...
    public:
        ...
        iterator Origin() const {
            return myStackSpace.IsEmpty() ? iterator() : myStackSpace.begin();
        }
