...
// =======================================================================
OpenGl_ShaderObject::OpenGl_ShaderObject(GLenum theType) : myType(theType), myShaderID(NO_SHADER) {
    //
}
...
Standard_Boolean OpenGl_ShaderObject::LoadAndCompile(const Handle(OpenGl_Context) & theCtx,
                                                     ...
                                                     const TCollection_AsciiString& theSource, bool theIsVerbose,
    ...
    if (!LoadSource(theCtx, theSource)) {
        ...
        theCtx->PushMessage(GL_DEBUG_SOURCE_APPLICATION, GL_DEBUG_TYPE_ERROR, 0, GL_DEBUG_SEVERITY_HIGH,
                            TCollection_AsciiString("Error! Failed to set ") + getShaderTypeString(myType) + " [" +
                                theId + "] source");
        return false;
    }
    ...
    if (!Compile(theCtx)) {
        ...
        theCtx->PushMessage(GL_DEBUG_SOURCE_APPLICATION, GL_DEBUG_TYPE_ERROR, 0, GL_DEBUG_SEVERITY_HIGH,
                            TCollection_AsciiString("Failed to compile ") + getShaderTypeString(myType) + " [" + theId +
                                "]. Compilation log:\n" + aLog);
        return false;
...
// purpose  :
// =======================================================================
void OpenGl_ShaderObject::DumpSourceCode(const Handle(OpenGl_Context) & theCtx, const TCollection_AsciiString& theId,
...
static void insertSubString(TCollection_AsciiString& theString, const char& thePattern,
...
static bool dumpShaderSource(const TCollection_AsciiString& theFileName, const TCollection_AsciiString& theSource,
                             bool theToBeautify) {
...
static bool restoreShaderSource(TCollection_AsciiString& theSource, const TCollection_AsciiString& theFileName) {
    OSD_File aFile(theFileName);
