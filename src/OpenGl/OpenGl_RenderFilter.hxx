...
enum OpenGl_RenderFilter {
    ...
    OpenGl_RenderFilter_OpaqueOnly = 0x001, //!< render only opaque elements and any non-filling elements   (conflicts
                                            //!< with OpenGl_RenderFilter_TransparentOnly)
    OpenGl_RenderFilter_TransparentOnly = 0x002, //!< render only semitransparent elements and OpenGl_AspectFace
                                                 //!< (conflicts with OpenGl_RenderFilter_OpaqueOnly)
