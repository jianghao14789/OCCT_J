...
public:
    ...
    //! @param theMode  - array mode (GL_VERTEX_ARRAY, GL_NORMAL_ARRAY, GL_COLOR_ARRAY, GL_INDEX_ARRAY,
...
public: //! @name advanced methods
    ...
    Standard_EXPORT static void bindAttribute(const Handle(OpenGl_Context) & theGlCtx,
                                              const Graphic3d_TypeOfAttribute theMode, const Standard_Integer theNbComp,
