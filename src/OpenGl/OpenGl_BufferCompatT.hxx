...
template <class BaseBufferT> class OpenGl_BufferCompatT : public BaseBufferT {
...
public:
    ...
    //! Return TRUE.
    virtual bool IsVirtual() const Standard_OVERRIDE {
        return true;
    }
...
public: //! @name advanced methods
    ...
    inline bool initLink(const Handle(NCollection_Buffer) & theData, const unsigned int theComponentsNb,
                         const Standard_Integer theElemsNb, const unsigned int theDataType);

    //! Initialize buffer with new data (data will be copied).
    inline virtual bool init(const Handle(OpenGl_Context) & theGlCtx, const unsigned int theComponentsNb,
    ...
    inline virtual bool subData(const Handle(OpenGl_Context) & theGlCtx, const Standard_Integer theElemFrom,
    ...
    inline virtual bool getSubData(const Handle(OpenGl_Context) & theGlCtx, const Standard_Integer theElemFrom,
...
// purpose  :
// =======================================================================
template <class BaseBufferT> bool OpenGl_BufferCompatT<BaseBufferT>::Create(const Handle(OpenGl_Context) &) {
...
// purpose  :
// =======================================================================
template <class BaseBufferT> void OpenGl_BufferCompatT<BaseBufferT>::Release(OpenGl_Context*) {
    if (BaseBufferT::myBufferId == OpenGl_Buffer::NO_BUFFER) {
        return;
    }
...
bool OpenGl_BufferCompatT<BaseBufferT>::initLink(const Handle(NCollection_Buffer) & theData,
                                                 const unsigned int theComponentsNb, const Standard_Integer theElemsNb,
...
// =======================================================================
template <class BaseBufferT>
bool OpenGl_BufferCompatT<BaseBufferT>::init(const Handle(OpenGl_Context) & theCtx, const unsigned int theComponentsNb,
                                             const Standard_Integer theElemsNb, const void* theData,
...
// =======================================================================
template <class BaseBufferT>
bool OpenGl_BufferCompatT<BaseBufferT>::subData(const Handle(OpenGl_Context) &, const Standard_Integer theElemFrom,
                                                const Standard_Integer theElemsNb, const void* theData,
                                                const unsigned int theDataType) {
...
// =======================================================================
template <class BaseBufferT>
bool OpenGl_BufferCompatT<BaseBufferT>::getSubData(const Handle(OpenGl_Context) &, const Standard_Integer theElemFrom,
                                                   const Standard_Integer theElemsNb, void* theData,
                                                   const unsigned int theDataType) {
    if (!BaseBufferT::IsValid() || BaseBufferT::myDataType != theDataType || theElemFrom < 0 ||
