...
OpenGl_Aspects::OpenGl_Aspects()
    : myAspect(new Graphic3d_Aspects()), myShadingModel(Graphic3d_TypeOfShadingModel_Unlit) {
    ...
    myShadingModel =
        theAspect->ShadingModel() != Graphic3d_TypeOfShadingModel_Unlit &&
                (aMat.ReflectionMode(Graphic3d_TOR_AMBIENT) || aMat.ReflectionMode(Graphic3d_TOR_DIFFUSE) ||
                 aMat.ReflectionMode(Graphic3d_TOR_SPECULAR) || aMat.ReflectionMode(Graphic3d_TOR_EMISSION))
