...
public:
    ...
    Standard_EXPORT void SetGradientParameters(const Quantity_Color& theColor1, const Quantity_Color& theColor2,
...
protected:
    ...
    mutable Standard_Boolean
        myToUpdate; //!< Shows if array parameters were changed and data (myAttribs storage) is to be updated
};
