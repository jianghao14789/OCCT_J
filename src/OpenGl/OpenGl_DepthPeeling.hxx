...
public:
    ...
    const Handle(OpenGl_FrameBuffer) * DepthPeelFbosOit() const {
        return myDepthPeelFbosOit;
    }
    ...
    const Handle(OpenGl_FrameBuffer) & BlendBackFboOit() const {
        return myBlendBackFboOit;
    }
