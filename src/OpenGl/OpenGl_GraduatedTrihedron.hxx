...
private:
    ...
    public:
        Axis(const Graphic3d_GraduatedTrihedron::AxisAspect& theAspect = Graphic3d_GraduatedTrihedron::AxisAspect(),
        ...
        void InitArrow(const Handle(OpenGl_Context) & theContext, const Standard_ShortReal theLength,
...
private:
    ...
    Standard_ShortReal getNormal(const Handle(OpenGl_Context) & theContext, OpenGl_Vec3& theNormal) const;
    ...
    Standard_ShortReal getDistanceToCorner(const OpenGl_Vec3& theNormal, const OpenGl_Vec3& theCenter,
                                           const Standard_ShortReal theX, const Standard_ShortReal theY,
    ...
    Standard_ExtCharacter getGridAxes(const Standard_ShortReal theCorners[8], GridAxes& theGridAxes) const;
    ...
    void renderLine(const OpenGl_PrimitiveArray& theLine, const Handle(OpenGl_Workspace) & theWorkspace,
                    const OpenGl_Mat4& theMat, const Standard_ShortReal theXt, const Standard_ShortReal theYt,
    ...
    //! @param theMat [in] theMat that contains base transformation and is used for applying
    //!        translation and rotation
    void renderGridPlane(const Handle(OpenGl_Workspace) & theWorkspace, const Standard_Integer& theIndex,
                         const GridAxes& theGridAxes, OpenGl_Mat4& theMat) const;
    ...
    //! @param theMat [in] theMat that contains base transformation and is used for applying
    //!        translation and rotation
    void renderAxis(const Handle(OpenGl_Workspace) & theWorkspace, const Standard_Integer& theIndex,
    ...
    void renderTickmarkLabels(const Handle(OpenGl_Workspace) & theWorkspace, const OpenGl_Mat4& theMat,
