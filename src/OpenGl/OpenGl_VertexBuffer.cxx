...
void OpenGl_VertexBuffer::bindAttribute(const Handle(OpenGl_Context) & theCtx,
                                        const Graphic3d_TypeOfAttribute theAttribute, const Standard_Integer theNbComp,
    ...
    theCtx->core20fwd->glVertexAttribPointer(theAttribute, theNbComp, theDataType, theDataType != GL_FLOAT, theStride,
                                             theOffset);
}
...
// purpose  :
// =======================================================================
void OpenGl_VertexBuffer::bindFixed(const Handle(OpenGl_Context) & theCtx, const Graphic3d_TypeOfAttribute theMode,
                                    const Standard_Integer theNbComp, const unsigned int theDataType,
                                    const Standard_Integer theStride, const void* theOffset) {
    switch (theMode) {
...
// purpose  :
// =======================================================================
void OpenGl_VertexBuffer::unbindFixed(const Handle(OpenGl_Context) & theCtx, const Graphic3d_TypeOfAttribute theMode) {
    switch (theMode) {
        case Graphic3d_TOA_POS:
