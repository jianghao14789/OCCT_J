...
OpenGl_Flipper::OpenGl_Flipper(const gp_Ax2& theReferenceSystem)
    : OpenGl_Element(), myReferenceOrigin((Standard_ShortReal)theReferenceSystem.Location().X(),
      ...
      myReferenceZ((Standard_ShortReal)theReferenceSystem.Axis().Direction().X(),
                   ...
                   (Standard_ShortReal)theReferenceSystem.Axis().Direction().Z(), 1.0f),
