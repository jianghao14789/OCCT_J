...
public:
    ...
    Standard_EXPORT GeomConvert_ApproxSurface(const Handle(Geom_Surface) & Surf, const Standard_Real Tol3d,
    ...
    //! allowed in the resulting BSpline curve
    //! -   the index of precision PrecisCode.
    Standard_EXPORT GeomConvert_ApproxSurface(const Handle(Adaptor3d_Surface) & Surf, const Standard_Real Tol3d,
                                              const GeomAbs_Shape UContinuity, const GeomAbs_Shape VContinuity,
                                              const Standard_Integer MaxDegU, const Standard_Integer MaxDegV,
                                              const Standard_Integer MaxSegments, const Standard_Integer PrecisCode);
...
private:
    ...
    Standard_EXPORT void Approximate(const Handle(Adaptor3d_Surface) & theSurf, const Standard_Real theTol3d,
                                     ...
                                     const Standard_Integer theMaxSegments, const Standard_Integer thePrecisCode);
