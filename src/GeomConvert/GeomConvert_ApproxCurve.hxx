...
public:
    ...
    Standard_EXPORT GeomConvert_ApproxCurve(const Handle(Geom_Curve) & Curve, const Standard_Real Tol3d,
    ...
    //! -      the highest degree MaxDeg which the
    //! polynomial defining the BSpline curve may have.
    Standard_EXPORT GeomConvert_ApproxCurve(const Handle(Adaptor3d_Curve) & Curve, const Standard_Real Tol3d,
                                            const GeomAbs_Shape Order, const Standard_Integer MaxSegments,
                                            const Standard_Integer MaxDegree);
...
private:
    ...
    Standard_EXPORT void Approximate(const Handle(Adaptor3d_Curve) & theCurve, const Standard_Real theTol3d,
