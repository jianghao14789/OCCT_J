...
//=======================================================================
Standard_Boolean ChFiKPart_MakeRotule(TopOpeBRepDS_DataStructure& DStr, const Handle(ChFiDS_SurfData) & Data,
                                      const gp_Pln& pl, const gp_Pln& pl1, const gp_Pln& pl2,
                                      const TopAbs_Orientation opl, const TopAbs_Orientation opl1,
                                      const TopAbs_Orientation opl2, const Standard_Real r,
    ...
    gp_Dir2d dy2d(ppos.YDirection().Dot(pl.Position().XDirection()), ppos.YDirection().Dot(pl.Position().YDirection()));
    ...
    Data->ChangeInterferenceOnS1().SetInterference(ChFiKPart_IndexCurveInDS(GC, DStr), trans, GC2d, GL2d);
    ...
    Data->ChangeInterferenceOnS2().SetInterference(ChFiKPart_IndexCurveInDS(bid, DStr), trans, bid2d, GL2dcoin);
