...
Standard_Boolean ChFiKPart_MakeChamfer(TopOpeBRepDS_DataStructure& DStr, const Handle(ChFiDS_SurfData) & Data,
                                       const ChFiDS_ChamfMode theMode, const gp_Pln& Pln, const gp_Cone& Con,
    ...
    IsResol =
        ChFiKPart_MakeChAsym(DStr, Data, Pln, Con, fu, lu, Or1, Or2, Dis2, angle, Spine, First, Ofpl, plandab, DisOnP);
