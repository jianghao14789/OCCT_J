...
// purpose  :
//=======================================================================
Standard_Boolean Extrema_GlobOptFuncCQuadric::checkInputData(const math_Vector& X, Standard_Real& ct) {
    ct = X(X.Lower());
...
// purpose  : Constructor
//=======================================================================
Extrema_GlobOptFuncCQuadric::Extrema_GlobOptFuncCQuadric(const Adaptor3d_Curve* C, const Adaptor3d_Surface* S)
    : myC(C) {
...
// purpose  : Constructor
//=======================================================================
Extrema_GlobOptFuncCQuadric::Extrema_GlobOptFuncCQuadric(const Adaptor3d_Curve* C) : myC(C) {
    myTf = myC->FirstParameter();
    myTl = myC->LastParameter();
}
//=======================================================================
...
// purpose  : Constructor
//=======================================================================
Extrema_GlobOptFuncCQuadric::Extrema_GlobOptFuncCQuadric(const Adaptor3d_Curve* C, const Standard_Real theTf,
...
// purpose  :
//=======================================================================
void Extrema_GlobOptFuncCQuadric::LoadQuad(const Adaptor3d_Surface* S, const Standard_Real theUf,
                                           const Standard_Real theUl, const Standard_Real theVf,
    ...
    if (myS->IsUPeriodic()) {
        ...
        if (myUf > aTMax || myUf < -Precision::PConfusion() || Abs(myUl - myUf) > aTMax) {
            ElCLib::AdjustPeriodic(0., 2. * M_PI, Min(Abs(myUl - myUf) / 2, Precision::PConfusion()), myUf, myUl);
        }
    }
    if (myS->IsVPeriodic()) {
        Standard_Real aTMax = 2. * M_PI + Precision::PConfusion();
        if (myVf > aTMax || myVf < -Precision::PConfusion() || Abs(myVl - myVf) > aTMax) {
            ElCLib::AdjustPeriodic(0., 2. * M_PI, Min(Abs(myVl - myVf) / 2, Precision::PConfusion()), myVf, myVl);
        }
    }
...
Standard_Boolean Extrema_GlobOptFuncCQuadric::Value(const math_Vector& X, Standard_Real& F) {
    Standard_Real ct;
    if (!checkInputData(X, ct)) return Standard_False;
...
// purpose  :
//=======================================================================
void Extrema_GlobOptFuncCQuadric::QuadricParameters(const math_Vector& theCT, math_Vector& theUV) const {
    Standard_Real u, v;
    //
