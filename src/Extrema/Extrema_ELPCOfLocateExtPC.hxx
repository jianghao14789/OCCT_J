...
public:
    ...
    Standard_EXPORT Extrema_ELPCOfLocateExtPC(const gp_Pnt& P, const Adaptor3d_Curve& C, const Standard_Real Uinf,
    ...
    //! if n is the number of iterations,
    //! the algorithm stops when abs(F(Un)-F(Un-1)) < Tol.
    Standard_EXPORT Extrema_ELPCOfLocateExtPC(const gp_Pnt& P, const Adaptor3d_Curve& C,
                                              const Standard_Real TolF = 1.0e-10);

    //! initializes the fields of the algorithm.
    Standard_EXPORT void Initialize(const Adaptor3d_Curve& C, const Standard_Real Uinf, const Standard_Real Usup,
                                    const Standard_Real TolF = 1.0e-10);
    ...
    Standard_EXPORT void TrimmedSquareDistances(Standard_Real& dist1, Standard_Real& dist2, gp_Pnt& P1,
                                                gp_Pnt& P2) const;

protected:
    Standard_EXPORT void IntervalPerform(const gp_Pnt& P);

    Standard_EXPORT void AddSol(const Standard_Real theU, const gp_Pnt& theP, const Standard_Real theSqDist,
