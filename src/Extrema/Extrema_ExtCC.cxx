...
Extrema_ExtCC::Extrema_ExtCC(const Standard_Real TolC1, const Standard_Real TolC2)
    : myIsFindSingleSolution(Standard_False), myDone(Standard_False), myIsParallel(Standard_False) {
    myC[0] = 0;
    myC[1] = 0;
...
Extrema_ExtCC::Extrema_ExtCC(const Adaptor3d_Curve& C1, const Adaptor3d_Curve& C2, const Standard_Real U1,
                             const Standard_Real U2, const Standard_Real V1, const Standard_Real V2,
                             const Standard_Real TolC1, const Standard_Real TolC2)
    : myIsFindSingleSolution(Standard_False), myECC(C1, C2, U1, U2, V1, V2), myDone(Standard_False) {
    SetCurve(1, C1, U1, U2);
    SetCurve(2, C2, V1, V2);
...
Extrema_ExtCC::Extrema_ExtCC(const Adaptor3d_Curve& C1, const Adaptor3d_Curve& C2, const Standard_Real TolC1,
                             const Standard_Real TolC2)
    : myIsFindSingleSolution(Standard_False), myECC(C1, C2), myDone(Standard_False) {
...
// purpose  :
//=======================================================================
void Extrema_ExtCC::Initialize(const Adaptor3d_Curve& C1, const Adaptor3d_Curve& C2, const Standard_Real TolC1,
                               const Standard_Real TolC2) {
...
// purpose  :
//=======================================================================
void Extrema_ExtCC::Initialize(const Adaptor3d_Curve& C1, const Adaptor3d_Curve& C2, const Standard_Real U1,
                               const Standard_Real U2, const Standard_Real V1, const Standard_Real V2,
                               const Standard_Real TolC1, const Standard_Real TolC2) {
    // myECC will be re-initialized by Perform()
    myDone = Standard_False;
...
void Extrema_ExtCC::SetCurve(const Standard_Integer theRank, const Adaptor3d_Curve& C) {
    Standard_OutOfRange_Raise_if(theRank < 1 || theRank > 2, "Extrema_ExtCC::SetCurve()") Standard_Integer anInd =
        theRank - 1;
    myC[anInd] = &C;
}
...
void Extrema_ExtCC::SetCurve(const Standard_Integer theRank, const Adaptor3d_Curve& C, const Standard_Real Uinf,
...
void Extrema_ExtCC::SetRange(const Standard_Integer theRank, const Standard_Real Uinf, const Standard_Real Usup) {
    Standard_OutOfRange_Raise_if(theRank < 1 || theRank > 2, "Extrema_ExtCC::SetRange()") Standard_Integer anInd =
        theRank - 1;
    myInf[anInd] = Uinf;
    mySup[anInd] = Usup;
}
...
void Extrema_ExtCC::SetTolerance(const Standard_Integer theRank, const Standard_Real theTol) {
    Standard_OutOfRange_Raise_if(theRank < 1 || theRank > 2, "Extrema_ExtCC::SetTolerance()") Standard_Integer anInd =
        theRank - 1;
    myTol[anInd] = theTol;
}
...
void Extrema_ExtCC::Perform() {
    ...
    if ((type1 == GeomAbs_Line && type2 <= GeomAbs_Parabola) || (type2 == GeomAbs_Line && type1 <= GeomAbs_Parabola)) {
...
void Extrema_ExtCC::TrimmedSquareDistances(Standard_Real& dist11, Standard_Real& dist12, Standard_Real& dist21,
                                           Standard_Real& dist22, gp_Pnt& P11, gp_Pnt& P12, gp_Pnt& P21,
                                           gp_Pnt& P22) const {
...
// purpose  :
//=======================================================================
void Extrema_ExtCC::PrepareParallelResult(const Standard_Real theUt11, const Standard_Real theUt12,
                                          const Standard_Real theUt21, const Standard_Real theUt22,
                                          const Standard_Real theSqDist) {
    if (!myIsParallel) return;
    ...
    if (aType1 != aType2) {
        ...
        const gp_Pnt aPonC =
            !isReversed ? Extrema_CurveTool::Value(*myC[0], theUt11) : Extrema_CurveTool::Value(*myC[1], theUt21);

        const gp_Lin aL = myC[!isReversed ? 1 : 0]->Line();
        const Extrema_ExtPElC ExtPLin(aPonC, aL, Precision::Confusion(), !isReversed ? theUt21 : theUt11,
    ...
    if (aType1 == GeomAbs_Line) {
        ...
        const Standard_Real isFirstInfinite = (Precision::IsInfinite(theUt11) && Precision::IsInfinite(theUt12));
        const Standard_Real isLastInfinite = (Precision::IsInfinite(theUt21) && Precision::IsInfinite(theUt22));
        ...
        Standard_Real aPar1 = ElCLib::InPeriod(ElCLib::Parameter(aWorkCirc, aP11), theUt21, theUt21 + aPeriod);
        ...
        Standard_Real aPar2 = ElCLib::InPeriod(ElCLib::Parameter(aWorkCirc, aP12), theUt21, theUt21 + aPeriod);
        ...
        for (Standard_Integer i = 0; i < 3; i++) {
            ...
            if (aRng.Delta() > Precision::Confusion()) {
                ...
                Extrema_ExtPElC ExtPCir(aPCirc2, Extrema_CurveTool::Circle(*myC[0]), Precision::Confusion(), theUt11,
                                        theUt12);
...
void Extrema_ExtCC::PrepareResults(const Extrema_ExtElC& AlgExt, const Standard_Boolean theIsInverse,
                                   const Standard_Real Ut11, const Standard_Real Ut12, const Standard_Real Ut21,
    ...
    if (myDone) {
        ...
        if (myIsParallel) {
            ...
            for (i = 1; i <= NbExt; i++) {
                ...
                if ((U >= Ut11 - RealEpsilon()) && (U <= Ut12 + RealEpsilon()) && (U2 >= Ut21 - RealEpsilon()) &&
                    (U2 <= Ut22 + RealEpsilon())) {
...
void Extrema_ExtCC::PrepareResults(const Extrema_ECC& AlgExt, const Standard_Real Ut11, const Standard_Real Ut12,
                                   const Standard_Real Ut21, const Standard_Real Ut22) {
    Standard_Integer i, NbExt;
    Standard_Real Val, U, U2;
    Extrema_POnCurv P1, P2;
