...
public:
    ...
    Standard_EXPORT Extrema_ExtPExtS(const gp_Pnt& P, const Handle(GeomAdaptor_SurfaceOfLinearExtrusion) & S,
    ...
    Standard_EXPORT void Initialize(const Handle(GeomAdaptor_SurfaceOfLinearExtrusion) & S, const Standard_Real Uinf,
...
protected:
private:
    Standard_EXPORT void MakePreciser(Standard_Real& U, const gp_Pnt& P, const Standard_Boolean isMin,
