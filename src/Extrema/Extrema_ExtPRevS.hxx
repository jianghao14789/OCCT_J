...
public:
    ...
    Standard_EXPORT Extrema_ExtPRevS(const gp_Pnt& P, const Handle(GeomAdaptor_SurfaceOfRevolution) & S,
    ...
    Standard_EXPORT void Initialize(const Handle(GeomAdaptor_SurfaceOfRevolution) & S, const Standard_Real Umin,
