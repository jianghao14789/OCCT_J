...
public:
    ...
    Standard_EXPORT Extrema_EPCOfELPCOfLocateExtPC(const gp_Pnt& P, const Adaptor3d_Curve& C,
    ...
    Standard_EXPORT void Initialize(const Adaptor3d_Curve& C, const Standard_Integer NbU, const Standard_Real TolU,
                                    const Standard_Real TolF);

    //! sets the fields of the algorithm.
    Standard_EXPORT void Initialize(const Adaptor3d_Curve& C, const Standard_Integer NbU, const Standard_Real Umin,
