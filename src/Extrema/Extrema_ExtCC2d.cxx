...
Extrema_ExtCC2d::Extrema_ExtCC2d()
    : myIsFindSingleSolution(Standard_False), myDone(Standard_False), myIsPar(Standard_False), mynbext(0),
      inverse(Standard_False), myv1(0.0), myv2(0.0), mytolc1(0.0), mytolc2(0.0), mydist11(0.0), mydist12(0.0),
      mydist21(0.0), mydist22(0.0) {}

Extrema_ExtCC2d::Extrema_ExtCC2d(const Adaptor2d_Curve2d& C1, const Adaptor2d_Curve2d& C2, const Standard_Real TolC1,
...
Extrema_ExtCC2d::Extrema_ExtCC2d(const Adaptor2d_Curve2d& C1, const Adaptor2d_Curve2d& C2, const Standard_Real U1,
...
void Extrema_ExtCC2d::Initialize(const Adaptor2d_Curve2d& C2, const Standard_Real V1, const Standard_Real V2,
                                 const Standard_Real TolC1, const Standard_Real TolC2) {
    myC = &C2;
    myv1 = V1;
    myv2 = V2;
...
void Extrema_ExtCC2d::Perform(const Adaptor2d_Curve2d& C1, const Standard_Real U1, const Standard_Real U2) {
    mypoints.Clear();
    mySqDist.Clear();
...
void Extrema_ExtCC2d::Points(const Standard_Integer N, Extrema_POnCurv2d& P1, Extrema_POnCurv2d& P2) const {
    if (!myDone) throw StdFail_NotDone();
    if ((N <= 0) || (N > mynbext)) throw Standard_OutOfRange();
...
void Extrema_ExtCC2d::TrimmedSquareDistances(Standard_Real& dist11, Standard_Real& dist12, Standard_Real& dist21,
                                             Standard_Real& dist22, gp_Pnt2d& P11, gp_Pnt2d& P12, gp_Pnt2d& P21,
                                             gp_Pnt2d& P22) const {
    dist11 = mydist11;
    dist12 = mydist12;
    dist21 = mydist21;
...
void Extrema_ExtCC2d::Results(const Extrema_ExtElC2d& AlgExt, const Standard_Real Ut11, const Standard_Real Ut12,
                              const Standard_Real Ut21, const Standard_Real Ut22, const Standard_Real Period1,
...
void Extrema_ExtCC2d::Results(const Extrema_ECC2d& AlgExt, const Standard_Real Ut11, const Standard_Real Ut12,
                              const Standard_Real Ut21, const Standard_Real Ut22, const Standard_Real Period1,
                              const Standard_Real Period2) {
    Standard_Integer i, NbExt;
    Standard_Real Val, U, U2;
