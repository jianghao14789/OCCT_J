...
XmlMNaming_Shape1::XmlMNaming_Shape1(XmlObjMgt_Document& theDoc)
    : myTShapeID(0), myLocID(0), myOrientation(TopAbs_FORWARD) {
...
XmlMNaming_Shape1::XmlMNaming_Shape1(const XmlObjMgt_Element& theEl)
    : myElement(theEl), myTShapeID(0), myLocID(0), myOrientation(TopAbs_FORWARD) {
    if (myElement != NULL) {
        ...
        switch (*aPtr) {
            ...
            case 'e':
                ...
                break;
            default:
                throw Standard_DomainError("XmlMNaming_Shape1; orientation value without enum term equivalence");
        }
...
// purpose  :
//=======================================================================
void XmlMNaming_Shape1::SetShape(const Standard_Integer theID, const Standard_Integer theLocID,
    ...
    if (theLocID > 0) Element().setAttribute(::LocationString(), theLocID);
}
