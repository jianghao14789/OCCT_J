...
void StepGeom_RectangularCompositeSurface::Init(const Handle(TCollection_HAsciiString) & aName,
...
Handle(StepGeom_SurfacePatch) StepGeom_RectangularCompositeSurface::SegmentsValue(const Standard_Integer num1,
