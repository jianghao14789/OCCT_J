...
void StepGeom_CurveReplica::Init(const Handle(TCollection_HAsciiString) & aName,
...
void StepGeom_CurveReplica::SetTransformation(const Handle(StepGeom_CartesianTransformationOperator) &
                                              aTransformation) {
    transformation = aTransformation;
}
