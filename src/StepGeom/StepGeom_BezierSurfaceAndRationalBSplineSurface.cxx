...
void StepGeom_BezierSurfaceAndRationalBSplineSurface::Init(
    ...
    bezierSurface->Init(aName, aUDegree, aVDegree, aControlPointsList, aSurfaceForm, aUClosed, aVClosed,
                        aSelfIntersect);
...
void StepGeom_BezierSurfaceAndRationalBSplineSurface::SetBezierSurface(const Handle(StepGeom_BezierSurface) &
                                                                       aBezierSurface) {
    bezierSurface = aBezierSurface;
}
...
Handle(StepGeom_RationalBSplineSurface)
    StepGeom_BezierSurfaceAndRationalBSplineSurface::RationalBSplineSurface() const {
...
void StepGeom_BezierSurfaceAndRationalBSplineSurface::SetWeightsData(const Handle(TColStd_HArray2OfReal) &
                                                                     aWeightsData) {
...
Standard_Real StepGeom_BezierSurfaceAndRationalBSplineSurface::WeightsDataValue(const Standard_Integer num1,
