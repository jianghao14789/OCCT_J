...
void StepGeom_SurfaceReplica::Init(const Handle(TCollection_HAsciiString) & aName,
...
void StepGeom_SurfaceReplica::SetTransformation(const Handle(StepGeom_CartesianTransformationOperator3d) &
                                                aTransformation) {
    transformation = aTransformation;
}
