...
void StepGeom_BSplineCurveWithKnots::Init(const Handle(TCollection_HAsciiString) & aName,
...
void StepGeom_BSplineCurveWithKnots::SetKnotMultiplicities(const Handle(TColStd_HArray1OfInteger) &
                                                           aKnotMultiplicities) {
    knotMultiplicities = aKnotMultiplicities;
}
