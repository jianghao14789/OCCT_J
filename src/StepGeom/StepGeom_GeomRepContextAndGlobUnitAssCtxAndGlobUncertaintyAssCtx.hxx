...
public:
    ...
    Standard_EXPORT void SetGeometricRepresentationContext(const Handle(StepGeom_GeometricRepresentationContext) &
    ...
    Standard_EXPORT void SetGlobalUnitAssignedContext(const Handle(StepRepr_GlobalUnitAssignedContext) &
                                                      aGlobalUnitAssignedContext);

    Standard_EXPORT Handle(StepRepr_GlobalUnitAssignedContext) GlobalUnitAssignedContext() const;

    Standard_EXPORT void SetGlobalUncertaintyAssignedContext(const Handle(StepRepr_GlobalUncertaintyAssignedContext) &
