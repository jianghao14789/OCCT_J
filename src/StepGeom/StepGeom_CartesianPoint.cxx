...
void StepGeom_CartesianPoint::Init2D(const Handle(TCollection_HAsciiString) & aName, const Standard_Real X,
...
void StepGeom_CartesianPoint::Init3D(const Handle(TCollection_HAsciiString) & aName, const Standard_Real X,
