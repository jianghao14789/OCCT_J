...
void StepGeom_BSplineSurfaceWithKnotsAndRationalBSplineSurface::Init(
    const Handle(TCollection_HAsciiString) & aName, const Standard_Integer aUDegree, const Standard_Integer aVDegree,
    const Handle(StepGeom_HArray2OfCartesianPoint) & aControlPointsList, const StepGeom_BSplineSurfaceForm aSurfaceForm,
    const StepData_Logical aUClosed, const StepData_Logical aVClosed, const StepData_Logical aSelfIntersect,
    ...
    StepGeom_BSplineSurface::Init(aName, aUDegree, aVDegree, aControlPointsList, aSurfaceForm, aUClosed, aVClosed,
                                  aSelfIntersect);
}
...
void StepGeom_BSplineSurfaceWithKnotsAndRationalBSplineSurface::Init(
    ...
    const Handle(TColStd_HArray1OfInteger) & aVMultiplicities, const Handle(TColStd_HArray1OfReal) & aUKnots,
    const Handle(TColStd_HArray1OfReal) & aVKnots, const StepGeom_KnotType aKnotSpec,
    ...
    bSplineSurfaceWithKnots->Init(aName, aUDegree, aVDegree, aControlPointsList, aSurfaceForm, aUClosed, aVClosed,
                                  aSelfIntersect, aUMultiplicities, aVMultiplicities, aUKnots, aVKnots, aKnotSpec);

    // --- ANDOR component fields ---

    rationalBSplineSurface = new StepGeom_RationalBSplineSurface();
    rationalBSplineSurface->Init(aName, aUDegree, aVDegree, aControlPointsList, aSurfaceForm, aUClosed, aVClosed,
                                 aSelfIntersect, aWeightsData);
}
...
Standard_Integer
StepGeom_BSplineSurfaceWithKnotsAndRationalBSplineSurface::UMultiplicitiesValue(const Standard_Integer num) const {
...
Standard_Integer
StepGeom_BSplineSurfaceWithKnotsAndRationalBSplineSurface::VMultiplicitiesValue(const Standard_Integer num) const {
...
void StepGeom_BSplineSurfaceWithKnotsAndRationalBSplineSurface::SetUKnots(const Handle(TColStd_HArray1OfReal) &
                                                                          aUKnots) {
...
void StepGeom_BSplineSurfaceWithKnotsAndRationalBSplineSurface::SetVKnots(const Handle(TColStd_HArray1OfReal) &
                                                                          aVKnots) {
...
void StepGeom_BSplineSurfaceWithKnotsAndRationalBSplineSurface::SetWeightsData(const Handle(TColStd_HArray2OfReal) &
                                                                               aWeightsData) {
...
Standard_Real
StepGeom_BSplineSurfaceWithKnotsAndRationalBSplineSurface::WeightsDataValue(const Standard_Integer num1,
