...
void StepGeom_QuasiUniformSurfaceAndRationalBSplineSurface::Init(
    ...
    quasiUniformSurface->Init(aName, aUDegree, aVDegree, aControlPointsList, aSurfaceForm, aUClosed, aVClosed,
                              aSelfIntersect);
...
Handle(StepGeom_QuasiUniformSurface)
    StepGeom_QuasiUniformSurfaceAndRationalBSplineSurface::QuasiUniformSurface() const {
...
Handle(StepGeom_RationalBSplineSurface)
    StepGeom_QuasiUniformSurfaceAndRationalBSplineSurface::RationalBSplineSurface() const {
...
void StepGeom_QuasiUniformSurfaceAndRationalBSplineSurface::SetWeightsData(const Handle(TColStd_HArray2OfReal) &
                                                                           aWeightsData) {
...
Standard_Real
StepGeom_QuasiUniformSurfaceAndRationalBSplineSurface::WeightsDataValue(const Standard_Integer num1,
