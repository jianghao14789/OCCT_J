...
void StepGeom_BSplineCurveWithKnotsAndRationalBSplineCurve::Init(
    const Handle(TCollection_HAsciiString) & aName, const Standard_Integer aDegree,
    const Handle(StepGeom_HArray1OfCartesianPoint) & aControlPointsList, const StepGeom_BSplineCurveForm aCurveForm,
    const StepData_Logical aClosedCurve, const StepData_Logical aSelfIntersect,
...
void StepGeom_BSplineCurveWithKnotsAndRationalBSplineCurve::Init(
    ...
    const Handle(StepGeom_HArray1OfCartesianPoint) & aControlPointsList, const StepGeom_BSplineCurveForm aCurveForm,
    const StepData_Logical aClosedCurve, const StepData_Logical aSelfIntersect,
    const Handle(TColStd_HArray1OfInteger) & aKnotMultiplicities, const Handle(TColStd_HArray1OfReal) & aKnots,
    const StepGeom_KnotType aKnotSpec, const Handle(TColStd_HArray1OfReal) & aWeightsData) {
    // --- classe inherited fields ---
    ...
    bSplineCurveWithKnots->Init(aName, aDegree, aControlPointsList, aCurveForm, aClosedCurve, aSelfIntersect,
                                aKnotMultiplicities, aKnots, aKnotSpec);

    // --- ANDOR component fields ---

    rationalBSplineCurve = new StepGeom_RationalBSplineCurve();
    rationalBSplineCurve->Init(aName, aDegree, aControlPointsList, aCurveForm, aClosedCurve, aSelfIntersect,
                               aWeightsData);
}
...
Handle(StepGeom_BSplineCurveWithKnots)
    StepGeom_BSplineCurveWithKnotsAndRationalBSplineCurve::BSplineCurveWithKnots() const {
...
Handle(StepGeom_RationalBSplineCurve)
    StepGeom_BSplineCurveWithKnotsAndRationalBSplineCurve::RationalBSplineCurve() const {
...
Standard_Integer
StepGeom_BSplineCurveWithKnotsAndRationalBSplineCurve::KnotMultiplicitiesValue(const Standard_Integer num) const {
...
void StepGeom_BSplineCurveWithKnotsAndRationalBSplineCurve::SetWeightsData(const Handle(TColStd_HArray1OfReal) &
                                                                           aWeightsData) {
...
Standard_Real
StepGeom_BSplineCurveWithKnotsAndRationalBSplineCurve::WeightsDataValue(const Standard_Integer num) const {
