...
void StepGeom_SurfaceCurve::Init(const Handle(TCollection_HAsciiString) & aName,
...
void StepGeom_SurfaceCurve::SetAssociatedGeometry(const Handle(StepGeom_HArray1OfPcurveOrSurface) &
                                                  aAssociatedGeometry) {
    associatedGeometry = aAssociatedGeometry;
}
