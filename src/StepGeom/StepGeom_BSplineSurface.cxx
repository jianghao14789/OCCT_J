...
void StepGeom_BSplineSurface::Init(const Handle(TCollection_HAsciiString) & aName, const Standard_Integer aUDegree,
...
void StepGeom_BSplineSurface::SetControlPointsList(const Handle(StepGeom_HArray2OfCartesianPoint) &
                                                   aControlPointsList) {
    controlPointsList = aControlPointsList;
}
...
Handle(StepGeom_CartesianPoint) StepGeom_BSplineSurface::ControlPointsListValue(const Standard_Integer num1,
