...
void StepGeom_UniformSurfaceAndRationalBSplineSurface::Init(
    ...
    uniformSurface->Init(aName, aUDegree, aVDegree, aControlPointsList, aSurfaceForm, aUClosed, aVClosed,
                         aSelfIntersect);
}

void StepGeom_UniformSurfaceAndRationalBSplineSurface::SetUniformSurface(const Handle(StepGeom_UniformSurface) &
                                                                         aUniformSurface) {
    uniformSurface = aUniformSurface;
}
...
Handle(StepGeom_RationalBSplineSurface)
    StepGeom_UniformSurfaceAndRationalBSplineSurface::RationalBSplineSurface() const {
    return rationalBSplineSurface;
}

//--- Specific Methods for AND classe field access ---

void StepGeom_UniformSurfaceAndRationalBSplineSurface::SetWeightsData(const Handle(TColStd_HArray2OfReal) &
                                                                      aWeightsData) {
...
Standard_Real StepGeom_UniformSurfaceAndRationalBSplineSurface::WeightsDataValue(const Standard_Integer num1,
