...
public:
    ...
    Standard_EXPORT void Init(const Handle(TCollection_HAsciiString) & aContextIdentifier,
                              ...
                              const Handle(StepRepr_ParametricRepresentationContext) &
    ...
    Standard_EXPORT void SetParametricRepresentationContext(const Handle(StepRepr_ParametricRepresentationContext) &
                                                            aParametricRepresentationContext);
