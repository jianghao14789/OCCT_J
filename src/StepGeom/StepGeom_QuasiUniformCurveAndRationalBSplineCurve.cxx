...
void StepGeom_QuasiUniformCurveAndRationalBSplineCurve::SetQuasiUniformCurve(const Handle(StepGeom_QuasiUniformCurve) &
                                                                             aQuasiUniformCurve) {
    quasiUniformCurve = aQuasiUniformCurve;
}
...
void StepGeom_QuasiUniformCurveAndRationalBSplineCurve::SetWeightsData(const Handle(TColStd_HArray1OfReal) &
                                                                       aWeightsData) {
