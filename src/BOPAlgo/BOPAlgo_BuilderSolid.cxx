...
// purpose  :
//=======================================================================
BOPAlgo_BuilderSolid::BOPAlgo_BuilderSolid() : BOPAlgo_BuilderArea() {}
//=======================================================================
// function :
// purpose  :
//=======================================================================
...
void BOPAlgo_BuilderSolid::PerformAreas(const Message_ProgressRange& theRange) {
    ...
    for (; aItLS.More(); aItLS.Next(), aPSH.Next()) {
        ...
        for (; aItLI.More(); aItLI.Next()) {
            ...
            if (!IsInside(aHole, aSolid, myContext)) continue;
    ...
    for (i = 1; i <= aNbH; ++i) {
        ...
        if (!pLHoles) pLHoles = &aSolidHolesMap(aSolidHolesMap.Add(aSolid, TopTools_ListOfShape()));
...
void BOPAlgo_BuilderSolid::PerformInternalShapes(const Message_ProgressRange& theRange) {
    ...
    BOPAlgo_Tools::ClassifyFaces(aLFaces, myAreas, myRunParallel, myContext, aMSLF, myBoxes,
                                 TopTools_DataMapOfShapeListOfShape(), aMainScope.Next());
    ...
    for (i = 1; i <= aNbF; ++i) {
        ...
        if (!aMFDone.Contains(aF)) aMFUnUsed.Add(aF);
    }
...
// purpose  :
//=======================================================================
Standard_Boolean IsInside(const TopoDS_Shape& theS1, const TopoDS_Shape& theS2, Handle(IntTools_Context) & theContext) {
    TopExp_Explorer aExp;
    TopAbs_State aState;
    //
    TopoDS_Solid* pS2 = (TopoDS_Solid*)&theS2;
    ...
    if (!aExp.More()) {
        ...
        aState = BOPTools_AlgoTools::ComputeState(aF, *pS2, Precision::Confusion(), aBounds, theContext);
    }
...
// purpose  :
//=======================================================================
Standard_Boolean IsGrowthShell(const TopoDS_Shape& theShell, const TopTools_IndexedMapOfShape& theMHF) {
    if (theMHF.Extent()) {
        TopoDS_Iterator aIt(theShell);
        for (; aIt.More(); aIt.Next()) {
            if (theMHF.Contains(aIt.Value())) return Standard_True;
        }
    }
