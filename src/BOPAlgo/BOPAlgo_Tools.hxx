...
public:
    ...
    template <class theType, class theTypeHasher>
    static void FillMap(const theType& n1, const theType& n2,
    ...
    Standard_EXPORT static void FillMap(const Handle(BOPDS_PaveBlock) & thePB1, const Standard_Integer theF,
    ...
    PerformCommonBlocks(BOPDS_IndexedDataMapOfPaveBlockListOfPaveBlock& theMBlocks,
                        const Handle(NCollection_BaseAllocator) & theAllocator, BOPDS_PDS& theDS,
                        const Handle(IntTools_Context) & theContext = Handle(IntTools_Context)());

    //! Create Common Blocks on faces using the PB->Faces connection map <theMBlocks>.
    Standard_EXPORT static void
    PerformCommonBlocks(const BOPDS_IndexedDataMapOfPaveBlockListOfInteger& theMBlocks,
                        const Handle(NCollection_BaseAllocator) & theAllocator, BOPDS_PDS& pDS,
                        const Handle(IntTools_Context) & theContext = Handle(IntTools_Context)());

    Standard_EXPORT static Standard_Real ComputeToleranceOfCB(const Handle(BOPDS_CommonBlock) & theCB,
    ...
    Standard_EXPORT static Standard_Integer EdgesToWires(const TopoDS_Shape& theEdges, TopoDS_Shape& theWires,
    ...
    Standard_EXPORT static Standard_Boolean WiresToFaces(const TopoDS_Shape& theWires, TopoDS_Shape& theFaces,
                                                         const Standard_Real theAngTol = 1.e-8);
    ...
    Standard_EXPORT static void
    ClassifyFaces(const TopTools_ListOfShape& theFaces, const TopTools_ListOfShape& theSolids,
    ...
    Standard_EXPORT static Standard_Boolean TrsfToPoint(const Bnd_Box& theBox1, const Bnd_Box& theBox2,
                                                        gp_Trsf& theTrsf,
