...
void BOPAlgo_Builder::FillIn3DParts(TopTools_DataMapOfShapeShape& theDraftSolids,
    ...
    for (i = 0; i < aNbS; ++i) {
        ...
        if (pLSIm) {
            ...
            for (; aItLSIm.More(); aItLSIm.Next()) {
                ...
                if (aMFence.Add(aSIm)) aLFaces.Append(aSIm);
            }
        } else {
            aLFaces.Append(aS);
    ...
    BOPAlgo_Tools::ClassifyFaces(aLFaces, aLSolids, myRunParallel, myContext, anInParts, aShapeBoxMap, aSolidsIF,
                                 aPS.Next());
...
// purpose  :
//=======================================================================
void BOPAlgo_Builder::BuildDraftSolid(const TopoDS_Shape& theSolid, TopoDS_Shape& theDraftSolid,
                ...
                for (; aItS.More(); aItS.Next()) {
                    ...
                    if (myShapesSD.IsBound(aFx)) {
                        ...
                        if (aOrF == TopAbs_INTERNAL) {
                            ...
                            bToReverse = BOPTools_AlgoTools::IsSplitToReverseWithWarn(aFx, aF, myContext, myReport);
                            if (bToReverse) {
                                aFx.Reverse();
                            }
                            //
...
void BOPAlgo_Builder::BuildSplitSolids(TopTools_DataMapOfShapeShape& theDraftSolids,
    ...
    for (i = 0; i < aNbS; ++i) {
        ...
        const TopoDS_Shape& aS = aSI.Shape();
        const TopoDS_Solid& aSolid = (*(TopoDS_Solid*)(&aS));
        if (!theDraftSolids.IsBound(aS)) continue;
