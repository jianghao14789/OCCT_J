...
//
static Standard_Integer NbCommonItemsInMap(const TopTools_MapOfShape& theM1, const TopTools_MapOfShape& theM2);
//
static void MapFacesToBuildSolids(const TopoDS_Shape& theSol, TopTools_IndexedDataMapOfShapeListOfShape& theMFS);

//=======================================================================
// function :
// purpose  :
//=======================================================================
BOPAlgo_BOP::BOPAlgo_BOP() : BOPAlgo_ToolsProvider() {
    Clear();
}
//=======================================================================
// function :
// purpose  :
//=======================================================================
BOPAlgo_BOP::BOPAlgo_BOP(const Handle(NCollection_BaseAllocator) & theAllocator) : BOPAlgo_ToolsProvider(theAllocator) {
    Clear();
}
//=======================================================================
// function : ~
...
void BOPAlgo_BOP::CheckData() {
    ...
    for (i = 0; i < 2; ++i) {
        ...
        for (j = 0; aItLS.More(); aItLS.Next(), ++j) {
            ...
            if (iDMin < iDimMin[i]) iDimMin[i] = iDMin;
            if (iDMax > iDimMax[i]) iDimMax[i] = iDMax;
...
void BOPAlgo_BOP::BuildShape(const Message_ProgressRange& theRange) {
    ...
    for (; aItLS.More(); aItLS.Next()) {
        ...
        if (myImages.IsBound(aS)) {
            ...
            for (; aItLSIm.More(); aItLSIm.Next()) {
                const TopoDS_Shape& aSIm = aItLSIm.Value();
                if (aMSRC.Contains(aSIm) && aMSResult.Add(aSIm)) aBB.Add(aResult, aSIm);
            }
...
Standard_Boolean BOPAlgo_BOP::CheckArgsForOpenSolid() {
    ...
    TopTools_MapOfShape aFailedSolids;
    {
        ...
        for (Message_ListOfAlert::Iterator aIt(aList); aIt.More(); aIt.Next()) {
            ...
            if (aType != STANDARD_TYPE(BOPAlgo_AlertSolidBuilderUnusedFaces)) continue;
    ...
    for (Standard_Integer i = 0; i < aNbS; ++i) {
        const BOPDS_ShapeInfo& aSI = myDS->ShapeInfo(i);
        if (aSI.ShapeType() != TopAbs_SOLID) continue;
        ...
        for (TopoDS_Iterator itSh(aSolid); itSh.More(); itSh.Next()) {
            ...
            if (aSh.ShapeType() != TopAbs_SHELL) continue;
...
//=======================================================================
Standard_Integer NbCommonItemsInMap(const TopTools_MapOfShape& theM1, const TopTools_MapOfShape& theM2) {
...
//=======================================================================
void MapFacesToBuildSolids(const TopoDS_Shape& theSol, TopTools_IndexedDataMapOfShapeListOfShape& theMFS) {
