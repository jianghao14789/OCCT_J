    ...
    virtual void Perform() {
        ...
        try {
            ...
            if (aC2d.IsNull()) {
                ...
                if (iErr) BOPTools_AlgoTools2D::BuildPCurveForEdgeOnFace(aCopyE, myF, myContext);
                    ...
                    if (!myNonDestructive || !bCB) {
                        if (bCB) {
                            ...
                            for (; it.More(); it.Next()) {
                                ...
                                if (myDS->PaveBlocks(nE).Extent() == 1) break;
                            }
                            if (it.More()) {
...
void BOPAlgo_PaveFiller::MakePCurves(const Message_ProgressRange& theRange) {
    Message_ProgressScope aPSOuter(theRange, NULL, 1);
    if (myAvoidBuildPCurve || (!mySectionAttribute.PCurveOnS1() && !mySectionAttribute.PCurveOnS2())) return;
    ...
    for (i = 0; i < aNb; ++i) {
        ...
        if (aMPC.HasErrors()) {
            ...
            if (!aNewPC.IsNull()) BRep_Builder().UpdateEdge(aMPC.Edge(), aNewPC, aMPC.Face(), aMPC.GetNewTolerance());
        }
    }
}
//=======================================================================
