...
public: //! @name discrete faces
    ...
    Standard_EXPORT virtual const IMeshData::IFaceHandle&
    GetFace(const Standard_Integer theIndex) const Standard_OVERRIDE;
...
public: //! @name discrete edges
    ...
    Standard_EXPORT virtual const IMeshData::IEdgeHandle&
    GetEdge(const Standard_Integer theIndex) const Standard_OVERRIDE;
