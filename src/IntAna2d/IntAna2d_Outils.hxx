...
public:
    MyDirectPolynomialRoots(const Standard_Real A4, const Standard_Real A3, const Standard_Real A2,
...
Standard_Boolean Points_Confondus(const Standard_Real xa, const Standard_Real ya, const Standard_Real xb,
