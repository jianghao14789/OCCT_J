...
public:
    ...
    Standard_EXPORT void SetMagnify(const Handle(Aspect_Window) & theWindow, const Handle(V3d_View) & thePreviousView,
                                    const Standard_Integer theX1, const Standard_Integer theY1,
                                    const Standard_Integer theX2, const Standard_Integer theY2);
...
public:
    ...
    Standard_EXPORT void SetBackgroundColor(const Quantity_TypeOfColor theType, const Standard_Real theV1,
    ...
    SetBgGradientColors(const Quantity_Color& theColor1, const Quantity_Color& theColor2,
    ...
    Standard_EXPORT void
    SetBgGradientStyle(const Aspect_GradientFillMethod theMethod = Aspect_GradientFillMethod_Horizontal,
                       const Standard_Boolean theToUpdate = Standard_False);
...
public:
    ...
    //! Start = Standard_True
    Standard_EXPORT void Rotate(const V3d_TypeOfAxe Axe, const Standard_Real Angle, const Standard_Real X,
    ...
    //! respect to the initial position expressed by
    //! Start = Standard_True
    Standard_EXPORT void Rotate(const V3d_TypeOfAxe Axe, const Standard_Real Angle,
                                const Standard_Boolean Start = Standard_True);
    ...
    Standard_EXPORT void Move(const Standard_Real Dx, const Standard_Real Dy, const Standard_Real Dz,
                              const Standard_Boolean Start = Standard_True);
    ...
    //! Start = Standard_True.
    Standard_EXPORT void Move(const V3d_TypeOfAxe Axe, const Standard_Real Length,
                              const Standard_Boolean Start = Standard_True);
    ...
    //! Start = Standard_True
    Standard_EXPORT void Translate(const Standard_Real Dx, const Standard_Real Dy, const Standard_Real Dz,
                                   const Standard_Boolean Start = Standard_True);
    ...
    //! expressed by Start = Standard_True
    Standard_EXPORT void Translate(const V3d_TypeOfAxe Axe, const Standard_Real Length,
                                   const Standard_Boolean Start = Standard_True);
    ...
    Standard_EXPORT void Place(const Standard_Integer theXp, const Standard_Integer theYp,
    ...
    //! Start = Standard_True
    Standard_EXPORT void Turn(const Standard_Real Ax, const Standard_Real Ay, const Standard_Real Az,
                              const Standard_Boolean Start = Standard_True);
    ...
    //! Start = Standard_True
    Standard_EXPORT void Turn(const V3d_TypeOfAxe Axe, const Standard_Real Angle,
                              const Standard_Boolean Start = Standard_True);
    ...
    Standard_EXPORT void Panning(const Standard_Real theDXv, const Standard_Real theDYv,
                                 const Standard_Real theZoomFactor = 1,
    ...
    //! @param theMargin [in] the margin coefficient for view borders.
    //! @param theToUpdate [in] flag to perform view update.
    Standard_EXPORT void FitAll(const Bnd_Box& theBox, const Standard_Real theMargin = 0.01,
                                const Standard_Boolean theToUpdate = Standard_True);
    ...
    Standard_EXPORT void FitAll(const Standard_Real theMinXv, const Standard_Real theMinYv,
                                const Standard_Real theMaxXv, const Standard_Real theMaxYv);
    ...
    Standard_EXPORT void WindowFit(const Standard_Integer theMinXp, const Standard_Integer theMinYp,
    ...
    Standard_EXPORT void Convert(const Standard_Integer Xp, const Standard_Integer Yp, Standard_Real& Xv,
    ...
    Standard_EXPORT void Convert(const Standard_Real Xv, const Standard_Real Yv, Standard_Integer& Xp,
    ...
    Standard_EXPORT void Convert(const Standard_Integer Xp, const Standard_Integer Yp, Standard_Real& X,
                                 Standard_Real& Y, Standard_Real& Z) const;
    ...
    Standard_EXPORT void ConvertWithProj(const Standard_Integer Xp, const Standard_Integer Yp, Standard_Real& X,
                                         Standard_Real& Y, Standard_Real& Z, Standard_Real& Vx, Standard_Real& Vy,
    ...
    Standard_EXPORT void ConvertToGrid(const Standard_Integer Xp, const Standard_Integer Yp, Standard_Real& Xg,
                                       Standard_Real& Yg, Standard_Real& Zg) const;
    ...
    //! relative to theZ.
    Standard_EXPORT void Project(const Standard_Real theX, const Standard_Real theY, const Standard_Real theZ,
    ...
    Standard_EXPORT void BackgroundColor(const Quantity_TypeOfColor Type, Standard_Real& V1, Standard_Real& V2,
    ...
    Standard_EXPORT void ProjReferenceAxe(const Standard_Integer Xpix, const Standard_Integer Ypix, Standard_Real& XP,
    ...
    //! Performs update of view.
    Standard_EXPORT void Pan(const Standard_Integer theDXp, const Standard_Integer theDYp,
                             const Standard_Real theZoomFactor = 1, const Standard_Boolean theToStart = Standard_True);
    ...
    Standard_EXPORT void Zoom(const Standard_Integer theXp1, const Standard_Integer theYp1,
                              const Standard_Integer theXp2, const Standard_Integer theYp2);
    ...
    Standard_EXPORT void ZoomAtPoint(const Standard_Integer theMouseStartX, const Standard_Integer theMouseStartY,
    ...
    //! outside this area.
    Standard_EXPORT void StartRotation(const Standard_Integer X, const Standard_Integer Y,
    ...
    //! idem than WindowFit
    void WindowFitAll(const Standard_Integer Xmin, const Standard_Integer Ymin, const Standard_Integer Xmax,
    ...
    //! @param theMargin [in] the margin coefficient for view borders
    //! @param theResolution [in] the minimum size of projection of bounding box in Xv or Yv direction when it
    //! considered to be a thin plane or point (without a volume);
    //!                           in this case only the center of camera is adjusted
    //! @param theToEnlargeIfLine [in] when TRUE - in cases when the whole bounding box projected into thin line going
    //! along Z-axis of screen,
    //!                                the view plane is enlarged such thatwe see the whole line on rotation, otherwise
    //!                                only the center of camera is adjusted.
    //! @return TRUE if the fit all operation can be done
    Standard_EXPORT Standard_Boolean FitMinMax(const Handle(Graphic3d_Camera) & theCamera, const Bnd_Box& theBox,
                                               const Standard_Real theMargin, const Standard_Real theResolution = 0.0,
    ...
    Standard_EXPORT Standard_Boolean Dump(const Standard_CString theFile,
    ...
    //! Internally this method calls Redraw() with an offscreen render buffer of requested target size (theWidth x
    //! theHeight), so that there is no need resizing a window control for making a dump of different size.
    Standard_EXPORT Standard_Boolean ToPixMap(Image_PixMap& theImage, const V3d_ImageDumpOptions& theParams);
    ...
    Standard_Boolean ToPixMap(Image_PixMap& theImage, const Standard_Integer theWidth, const Standard_Integer theHeight,
                              const Graphic3d_BufferType& theBufferType = Graphic3d_BT_RGB,
    ...
    Standard_EXPORT void
    SetBackFacingModel(const Graphic3d_TypeOfBackfacingModel theModel = Graphic3d_TypeOfBackfacingModel_Auto);
    ...
    void SetFrustumCulling(Standard_Boolean theMode) {
        ChangeRenderingParams().FrustumCullingState =
            theMode ? Graphic3d_RenderingParams::FrustumCulling_On : Graphic3d_RenderingParams::FrustumCulling_Off;
    }
...
public: //! @name deprecated methods
    ...
    Standard_DEPRECATED("Deprecated method - ActiveLights() should be used instead") Standard_EXPORT Standard_Boolean
        IfMoreLights() const;

    //! initializes an iteration on the active Lights.
    Standard_DEPRECATED("Deprecated method - ActiveLights() should be used instead") void InitActiveLights() {
        myActiveLightsIterator.Initialize(myActiveLights);
    }

    //! returns true if there are more active Light(s) to return.
    Standard_DEPRECATED("Deprecated method - ActiveLights() should be used instead") Standard_Boolean
        MoreActiveLights() const {
        return myActiveLightsIterator.More();
    }

    //! Go to the next active Light (if there is not, ActiveLight will raise an exception)
    Standard_DEPRECATED("Deprecated method - ActiveLights() should be used instead") void NextActiveLights() {
        myActiveLightsIterator.Next();
    }

    Standard_DEPRECATED("Deprecated method - ActiveLights() should be used instead") const Handle(V3d_Light) &
        ActiveLight() const {
...
protected:
    ...
    Standard_EXPORT void Scale(const Handle(Graphic3d_Camera) & theCamera, const Standard_Real theSizeXv,
                               const Standard_Real theSizeYv) const;

    Standard_EXPORT void Translate(const Handle(Graphic3d_Camera) & theCamera, const Standard_Real theDXv,
...
private:
    ...
    Standard_EXPORT static Standard_Boolean screenAxis(const gp_Dir& theVpn, const gp_Dir& theVup, gp_Vec& theXaxe,
                                                       gp_Vec& theYaxe, gp_Vec& theZaxe);
    ...
    Standard_EXPORT Standard_Integer MinMax(Standard_Real& Umin, Standard_Real& Vmin, Standard_Real& Umax,
                                            Standard_Real& Vmax) const;

    //! Returns the objects number and the box encompassing
    //! the objects contained in the view
    Standard_EXPORT Standard_Integer MinMax(Standard_Real& Xmin, Standard_Real& Ymin, Standard_Real& Zmin,
                                            Standard_Real& Xmax, Standard_Real& Ymax, Standard_Real& Zmax) const;
