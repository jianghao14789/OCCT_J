...
public:
    Standard_EXPORT V3d_RectangularGrid(const V3d_ViewerPointer& aViewer, const Quantity_Color& aColor,
    ...
    Standard_EXPORT void SetGraphicValues(const Standard_Real XSize, const Standard_Real YSize,
