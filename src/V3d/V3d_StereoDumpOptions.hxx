...
enum V3d_StereoDumpOptions {
    ...
    V3d_SDO_BLENDED    //!< dump blended pair specific to the active device output Graphic3d_StereoMode (result will be
                       //!< undefined for modes like Graphic3d_StereoMode_QuadBuffer)
};
