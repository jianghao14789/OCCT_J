...
public:
    ...
    Standard_EXPORT TopoDS_Vertex CombineVertex(const TopoDS_Vertex& V1, const TopoDS_Vertex& V2,
    ...
    Standard_EXPORT TopoDS_Vertex CombineVertex(const gp_Pnt& pnt1, const gp_Pnt& pnt2, const Standard_Real tol1,
                                                const Standard_Real tol2, const Standard_Real tolFactor = 1.0001) const;
