...
public:
    struct FaceIndices {
        ...
        FaceIndices() : Index(0), Min(0), Max(0) {}
    ...
    struct Box {
        ...
        //! The default constructor.
        Box() : XMin(0.0), YMin(0.0), ZMin(0.0), XMax(0.0), YMax(0.0), ZMax(0.0) {}

        //! The initializing constructor.
        Box(const Standard_Real& theXMin, const Standard_Real& theYMin, const Standard_Real& theZMin,
            const Standard_Real& theXMax, const Standard_Real& theYMax, const Standard_Real& theZMax)
            : XMin(theXMin), YMin(theYMin), ZMin(theZMin), XMax(theXMax), YMax(theYMax), ZMax(theZMax) {}
    };
    ...
    Standard_EXPORT void HideByPolyData(const HLRAlgo_BiPoint::PointsT& thePoints, Triangle& theTriangle,
...
private:
    //! evident.
    void hideByOneTriangle(const HLRAlgo_BiPoint::PointsT& thePoints, Triangle& theTriangle,
