...
public:
    ...
    Standard_EXPORT void UpdateLinks(HLRAlgo_Array1OfTData& theTData, HLRAlgo_Array1OfPISeg& thePISeg,
    ...
    Standard_EXPORT void UpdateLinks(const Standard_Integer theIp1, const Standard_Integer theIp2,
                                     const Standard_Integer theIp3, HLRAlgo_Array1OfTData*& theTData1,
                                     HLRAlgo_Array1OfTData*& theTData2, HLRAlgo_Array1OfPISeg*& thePISeg1,
                                     HLRAlgo_Array1OfPISeg*& thePISeg2, HLRAlgo_Array1OfPINod*& thePINod1,
    ...
    Standard_EXPORT void IncPINod(HLRAlgo_Array1OfPINod*& thePINod1, HLRAlgo_Array1OfPINod*& thePINod2);
