...
HLRAlgo_BiPoint::HLRAlgo_BiPoint(const Standard_Real X1, const Standard_Real Y1, const Standard_Real Z1,
                                 ...
                                 const Standard_Integer Index, const Standard_Boolean reg1, const Standard_Boolean regn,
    ...
    myIndices.FaceConex1 = myIndices.Face1Pt1 = myIndices.Face1Pt2 = myIndices.FaceConex2 = myIndices.Face2Pt1 =
        myIndices.Face2Pt2 = 0;
...
HLRAlgo_BiPoint::HLRAlgo_BiPoint(const Standard_Real X1, const Standard_Real Y1, const Standard_Real Z1,
                                 ...
                                 const Standard_Real XT1, const Standard_Real YT1, const Standard_Real ZT1,
                                 const Standard_Real XT2, const Standard_Real YT2, const Standard_Real ZT2,
                                 const Standard_Integer Index, const Standard_Integer i1, const Standard_Integer i1p1,
                                 const Standard_Integer i1p2, const Standard_Boolean reg1, const Standard_Boolean regn,
                                 const Standard_Boolean outl, const Standard_Boolean intl) {
    myPoints.Pnt1.SetCoord(X1, Y1, Z1);
    myPoints.Pnt2.SetCoord(X2, Y2, Z2);
    myPoints.PntP1.SetCoord(XT1, YT1, ZT1);
...
HLRAlgo_BiPoint::HLRAlgo_BiPoint(const Standard_Real X1, const Standard_Real Y1, const Standard_Real Z1,
                                 ...
                                 const Standard_Real XT2, const Standard_Real YT2, const Standard_Real ZT2,
                                 const Standard_Integer Index, const Standard_Integer i1, const Standard_Integer i1p1,
                                 const Standard_Integer i1p2, const Standard_Integer flag) {
    myPoints.Pnt1.SetCoord(X1, Y1, Z1);
    myPoints.Pnt2.SetCoord(X2, Y2, Z2);
    myPoints.PntP1.SetCoord(XT1, YT1, ZT1);
    myPoints.PntP2.SetCoord(XT2, YT2, ZT2);
...
HLRAlgo_BiPoint::HLRAlgo_BiPoint(const Standard_Real X1, const Standard_Real Y1, const Standard_Real Z1,
                                 ...
                                 const Standard_Real XT2, const Standard_Real YT2, const Standard_Real ZT2,
                                 const Standard_Integer Index, const Standard_Integer i1, const Standard_Integer i1p1,
                                 const Standard_Integer i1p2, const Standard_Integer i2, const Standard_Integer i2p1,
                                 const Standard_Integer i2p2, const Standard_Boolean reg1, const Standard_Boolean regn,
                                 const Standard_Boolean outl, const Standard_Boolean intl) {
    myPoints.Pnt1.SetCoord(X1, Y1, Z1);
    myPoints.Pnt2.SetCoord(X2, Y2, Z2);
    myPoints.PntP1.SetCoord(XT1, YT1, ZT1);
...
HLRAlgo_BiPoint::HLRAlgo_BiPoint(const Standard_Real X1, const Standard_Real Y1, const Standard_Real Z1,
                                 ...
                                 const Standard_Integer Index, const Standard_Integer i1, const Standard_Integer i1p1,
                                 const Standard_Integer i1p2, const Standard_Integer i2, const Standard_Integer i2p1,
                                 const Standard_Integer i2p2, const Standard_Integer flag) {
    myPoints.Pnt1.SetCoord(X1, Y1, Z1);
    myPoints.Pnt2.SetCoord(X2, Y2, Z2);
    myPoints.PntP1.SetCoord(XT1, YT1, ZT1);
    myPoints.PntP2.SetCoord(XT2, YT2, ZT2);
