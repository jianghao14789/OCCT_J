...
public:
    ...
    const NCollection_Array1<Handle(HLRAlgo_PolyShellData)>& PolyShell() const {
        return myHShell;
    }

    NCollection_Array1<Handle(HLRAlgo_PolyShellData)>& ChangePolyShell() {
        return myHShell;
    }
    ...
    Standard_EXPORT HLRAlgo_BiPoint::PointsT& Hide(HLRAlgo_EdgeStatus& status, Standard_Integer& Index,
                                                   Standard_Boolean& reg1, Standard_Boolean& regn,
    ...
    //! process hiding between <Pt1> and <Pt2>.
    Standard_EXPORT HLRAlgo_BiPoint::PointsT& Show(Standard_Integer& Index, Standard_Boolean& reg1,
