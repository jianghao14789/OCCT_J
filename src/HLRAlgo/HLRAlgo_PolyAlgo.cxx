...
HLRAlgo_PolyAlgo::HLRAlgo_PolyAlgo() : myNbrShell(0), myCurShell(0), myFound(Standard_False) {
...
// purpose  :
//=======================================================================
HLRAlgo_BiPoint::PointsT& HLRAlgo_PolyAlgo::Hide(HLRAlgo_EdgeStatus& theStatus, Standard_Integer& theIndex,
    ...
    theStatus =
        HLRAlgo_EdgeStatus(0.0, (Standard_ShortReal)myTriangle.TolParam, 1.0, (Standard_ShortReal)myTriangle.TolParam);
...
HLRAlgo_BiPoint::PointsT& HLRAlgo_PolyAlgo::Show(Standard_Integer& Index, Standard_Boolean& reg1,
