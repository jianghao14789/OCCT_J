...
class StdLPersistent_Dependency {
    template <class AttribClass> class instance : public StdObjMgt_Attribute<AttribClass> {
    public:
...
template <> inline Standard_CString StdLPersistent_Dependency::instance<TDataStd_Expression>::PName() const {
    return "PDataStd_Expression";
}

template <> inline Standard_CString StdLPersistent_Dependency::instance<TDataStd_Relation>::PName() const {
