...
class StdLPersistent_HString {
    template <class StringClass, typename CharType> class instance : public StdObjMgt_Persistent {
    public:
        ...
        //! Get the value.
        const Handle(StringClass) & Value() const {
            return myValue;
        }
...
public:
    ...
    public:
        ...
        inline Standard_CString PName() const {
            return "PCollection_HAsciiString";
        }
    };
    ...
    public:
        ...
        inline Standard_CString PName() const {
            return "PCollection_HExtendedString";
        }
    };
};
