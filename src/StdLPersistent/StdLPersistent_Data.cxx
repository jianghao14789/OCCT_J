...
public:
    ...
    Parser(const TColStd_HArray1OfInteger& theLabels, const StdLPersistent_HArray1OfPersistent& theAttributes)
        : myLabelsIter(theLabels), myAttribIter(theAttributes) {}
...
Handle(TDF_Data) StdLPersistent_Data::Import() const {
    if (myLabels.IsNull() || myAttributes.IsNull()) return NULL;
    ...
    for (; anAttribIter.More(); anAttribIter.Next()) {
        ...
        if (aPAttrib) aPAttrib->ImportAttribute();
    }
