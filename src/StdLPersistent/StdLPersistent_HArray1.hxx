...
class StdLPersistent_HArray1 {
    ...
    protected:
        ...
        virtual void createArray(const Standard_Integer theLowerBound, const Standard_Integer theUpperBound) = 0;

        virtual void readValue(StdObjMgt_ReadData& theReadData, const Standard_Integer theIndex) = 0;
        virtual void writeValue(StdObjMgt_WriteData& theWriteData, const Standard_Integer theIndex) const = 0;
    };
...
protected:
    ...
    public:
        virtual Standard_CString PName() const {
            Standard_NullValue_Raise_if(!myPName, "StdLPersistent_HArray1::named_instance::PName - name not set");
            return myPName;
        }
...
template <> inline Standard_CString StdLPersistent_HArray1::instance<TColStd_HArray1OfInteger>::PNameT() const {
    return "PColStd_HArray1OfInteger";
}

template <> inline Standard_CString StdLPersistent_HArray1::instance<TColStd_HArray1OfReal>::PNameT() const {
    return "PColStd_HArray1OfReal";
}

template <> inline Standard_CString StdLPersistent_HArray1::instance<TColStd_HArray1OfByte>::PNameT() const {
...
inline StdObjMgt_WriteData& operator>>(StdObjMgt_WriteData& theWriteData, const Standard_Byte& theByte) {
