...
TDataStd_DeltaOnModificationOfRealArray::TDataStd_DeltaOnModificationOfRealArray(const Handle(TDataStd_RealArray) &
                                                                                 OldAtt)
    ...
    if (Label().FindAttribute(OldAtt->ID(), CurrAtt)) {
        ...
        Arr2 = CurrAtt->Array();
#ifdef OCCT_DEBUG
        if (Arr1.IsNull()) std::cout << "DeltaOnModificationOfRealArray:: Old Array is Null" << std::endl;
        if (Arr2.IsNull()) std::cout << "DeltaOnModificationOfRealArray:: Current Array is Null" << std::endl;
#endif
