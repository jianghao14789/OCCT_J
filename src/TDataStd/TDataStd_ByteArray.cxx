...
//=======================================================================
TDataStd_ByteArray::TDataStd_ByteArray() : myIsDelta(Standard_False), myID(GetID()) {}

//=======================================================================
// function : SetAttr
// purpose  : Implements Set functionality
//=======================================================================
static Handle(TDataStd_ByteArray)
...
// purpose  :
//=======================================================================
Handle(TDataStd_ByteArray) TDataStd_ByteArray::Set(const TDF_Label& label, const Standard_Integer lower,
...
//=======================================================================
Handle(TDataStd_ByteArray) TDataStd_ByteArray::Set(const TDF_Label& label, const Standard_GUID& theGuid,
...
void TDataStd_ByteArray::SetValue(const Standard_Integer index, const Standard_Byte value) {
    ...
    if (value == myValue->Value(index)) return;
    Backup();
...
void TDataStd_ByteArray::ChangeArray(const Handle(TColStd_HArray1OfByte) & newArray,
    ...
    if (myValue.IsNull() || !aDimEqual) myValue = new TColStd_HArray1OfByte(aLower, anUpper);
...
// purpose  :
//=======================================================================
void TDataStd_ByteArray::Paste(const Handle(TDF_Attribute) & Into, const Handle(TDF_RelocationTable) &) const {
    if (!myValue.IsNull()) {
...
Handle(TDF_DeltaOnModification) TDataStd_ByteArray::DeltaOnModification(const Handle(TDF_Attribute) &
                                                                        OldAttribute) const {
    if (myIsDelta)
