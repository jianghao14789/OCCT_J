...
//=======================================================================
Handle(TDataStd_ExtStringArray)
...
TDataStd_ExtStringArray::TDataStd_ExtStringArray() : myIsDelta(Standard_False), myID(GetID()) {}
...
Handle(TDataStd_ExtStringArray) TDataStd_ExtStringArray::Set(const TDF_Label& label, const Standard_Integer lower,
...
Handle(TDataStd_ExtStringArray) TDataStd_ExtStringArray::Set(const TDF_Label& label, const Standard_GUID& theGuid,
...
void TDataStd_ExtStringArray::ChangeArray(const Handle(TColStd_HArray1OfExtendedString) & newArray,
    ...
    if (myValue.IsNull() || !aDimEqual) myValue = new TColStd_HArray1OfExtendedString(aLower, anUpper);
...
void TDataStd_ExtStringArray::Paste(const Handle(TDF_Attribute) & Into, const Handle(TDF_RelocationTable) &) const {
    if (!myValue.IsNull()) {
...
Handle(TDF_DeltaOnModification) TDataStd_ExtStringArray::DeltaOnModification(const Handle(TDF_Attribute) &
                                                                             OldAttribute) const {
    if (myIsDelta)
