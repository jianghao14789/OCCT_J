...
//=======================================================================
static Handle(TDataStd_IntegerArray)
    SetAttr(const TDF_Label& label, const Standard_Integer lower, const Standard_Integer upper,
            const Standard_Boolean isDelta, const Standard_GUID& theGuid) {
...
TDataStd_IntegerArray::TDataStd_IntegerArray() : myIsDelta(Standard_False), myID(GetID()) {}
...
Handle(TDataStd_IntegerArray) TDataStd_IntegerArray::Set(const TDF_Label& label, const Standard_Integer lower,
                                                         const Standard_Integer upper, const Standard_Boolean isDelta)
...
Handle(TDataStd_IntegerArray) TDataStd_IntegerArray::Set(const TDF_Label& label, const Standard_GUID& theGuid,
...
void TDataStd_IntegerArray::SetValue(const Standard_Integer index, const Standard_Integer value) {
    ...
    if (myValue->Value(index) == value) return;
    Backup();
...
void TDataStd_IntegerArray::ChangeArray(const Handle(TColStd_HArray1OfInteger) & newArray,
    ...
    if (myValue.IsNull() || !aDimEqual) myValue = new TColStd_HArray1OfInteger(aLower, anUpper);
...
void TDataStd_IntegerArray::Paste(const Handle(TDF_Attribute) & Into, const Handle(TDF_RelocationTable) &) const {
...
Handle(TDF_DeltaOnModification) TDataStd_IntegerArray::DeltaOnModification(const Handle(TDF_Attribute) &
                                                                           OldAttribute) const {
    if (myIsDelta)
