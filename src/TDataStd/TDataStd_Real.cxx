...
//=======================================================================
static Handle(TDataStd_Real) SetAttr(const TDF_Label& label, const Standard_Real V, const Standard_GUID& theGuid) {
...
Handle(TDataStd_Real) TDataStd_Real::Set(const TDF_Label& L, const Standard_GUID& theGuid, const Standard_Real V) {
...
TDataStd_Real::TDataStd_Real() : myValue(RealFirst()), myDimension(TDataStd_SCALAR), myID(GetID()) {}
...
void TDataStd_Real::Paste(const Handle(TDF_Attribute) & Into, const Handle(TDF_RelocationTable) & /*RT*/) const {
