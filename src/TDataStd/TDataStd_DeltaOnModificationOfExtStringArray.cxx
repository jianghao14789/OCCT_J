    ...
    if (Label().FindAttribute(OldAtt->ID(), CurrAtt)) {
        {
            ...
            Arr2 = CurrAtt->Array();
#ifdef OCCT_DEBUG
            if (Arr1.IsNull()) std::cout << "DeltaOnModificationOfExtStringArray:: Old IntArray is Null" << std::endl;
            if (Arr2.IsNull())
...
void TDataStd_DeltaOnModificationOfExtStringArray::Apply() {
    ...
    if (aCase == 1)
        ...
        Handle(TColStd_HArray1OfExtendedString) strArr = new TColStd_HArray1OfExtendedString(aStrArr->Lower(), myUp1);
        ...
        Handle(TColStd_HArray1OfExtendedString) strArr = new TColStd_HArray1OfExtendedString(low, myUp1);
