...
public:
    ...
    WriteInfo(Standard_OStream& theOStream, const Standard_Integer nbObj, const TCollection_AsciiString& dbVersion,
              ...
              const TColStd_SequenceOfAsciiString& userInfo, const Standard_Boolean theOnlyCount = Standard_False);

    //! 写入文件信息段
    Standard_EXPORT void WriteInfo(const Standard_Integer nbObj, const TCollection_AsciiString& dbVersion,
                                   const TCollection_AsciiString& date, const TCollection_AsciiString& schemaName,
                                   const TCollection_AsciiString& schemaVersion,
                                   const TCollection_ExtendedString& appName, const TCollection_AsciiString& appVersion,
    ...
    //! 读取文件信息段内容
    Standard_EXPORT void ReadInfo(Standard_Integer& nbObj, TCollection_AsciiString& dbVersion,
    ...
    Standard_EXPORT static void ReadTypeInformations(Standard_IStream& theIStream, Standard_Integer& typeNum,
    ...
    Standard_EXPORT void WriteRoot(const TCollection_AsciiString& rootName, const Standard_Integer aRef,
    ...
    //! 读取单个根对象信息
    Standard_EXPORT void ReadRoot(TCollection_AsciiString& rootName, Standard_Integer& aRef,
                                  TCollection_AsciiString& aType) Standard_OVERRIDE;

    Standard_EXPORT static void ReadRoot(Standard_IStream& theIStream, TCollection_AsciiString& rootName,
                                         Standard_Integer& aRef, TCollection_AsciiString& aType);
    ...
    Standard_EXPORT static void ReadReferenceType(Standard_IStream& theIStream, Standard_Integer& reference,
    ...
    //! 静态函数：写入整数到流
    Standard_EXPORT static Standard_Integer PutInteger(Standard_OStream& theOStream, const Standard_Integer aValue,
                                                       const Standard_Boolean theOnlyCount = Standard_False);
...
public:
    ...
    static Standard_Integer InverseInt(const Standard_Integer theValue) {
        return (0 | ((theValue & 0x000000ff) << 24) | ((theValue & 0x0000ff00) << 8) | ((theValue & 0x00ff0000) >> 8) |
    ...
    //! 静态函数：向流中写入文件头
    Standard_EXPORT static Standard_Integer WriteHeader(Standard_OStream& theOStream, const FSD_FileHeader& theHeader,
                                                        const Standard_Boolean theOnlyCount = Standard_False);
