...
void RWStepDimTol_RWGeoTolAndGeoTolWthDatRefAndGeoTolWthMaxTol::WriteStep(
    StepData_StepWriter& SW, const Handle(StepDimTol_GeoTolAndGeoTolWthDatRefAndGeoTolWthMaxTol) & ent) const {
...
void RWStepDimTol_RWGeoTolAndGeoTolWthDatRefAndGeoTolWthMaxTol::Share(
    const Handle(StepDimTol_GeoTolAndGeoTolWthDatRefAndGeoTolWthMaxTol) & ent, Interface_EntityIterator& iter) const {
    // Own fields of GeometricTolerance
