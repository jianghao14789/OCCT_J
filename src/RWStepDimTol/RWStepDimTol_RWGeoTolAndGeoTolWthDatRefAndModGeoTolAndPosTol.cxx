...
void RWStepDimTol_RWGeoTolAndGeoTolWthDatRefAndModGeoTolAndPosTol::ReadStep(
    ...
    // Initialize entity
    Handle(StepDimTol_GeometricToleranceWithDatumReference) GTWDR = new StepDimTol_GeometricToleranceWithDatumReference;
...
void RWStepDimTol_RWGeoTolAndGeoTolWthDatRefAndModGeoTolAndPosTol::WriteStep(
    StepData_StepWriter& SW, const Handle(StepDimTol_GeoTolAndGeoTolWthDatRefAndModGeoTolAndPosTol) & ent) const {
