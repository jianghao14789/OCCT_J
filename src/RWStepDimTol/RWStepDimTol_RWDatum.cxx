...
void RWStepDimTol_RWDatum::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                    Handle(Interface_Check) & ach, const Handle(StepDimTol_Datum) & ent) const {
...
void RWStepDimTol_RWDatum::WriteStep(StepData_StepWriter& SW, const Handle(StepDimTol_Datum) & ent) const {
...
void RWStepDimTol_RWDatum::Share(const Handle(StepDimTol_Datum) & ent, Interface_EntityIterator& iter) const {
