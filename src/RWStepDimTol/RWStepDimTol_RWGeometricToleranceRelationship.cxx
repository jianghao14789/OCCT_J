...
void RWStepDimTol_RWGeometricToleranceRelationship::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                             ...
                                                             const Handle(StepDimTol_GeometricToleranceRelationship) &
                                                                 ent) const {
    ...
    data->ReadEntity(num, 3, "relating_geometric_tolerance", ach, STANDARD_TYPE(StepDimTol_GeometricTolerance),
                     aRelatingGeometricTolerance);

    Handle(StepDimTol_GeometricTolerance) aRelatedGeometricTolerance;
    data->ReadEntity(num, 4, "related_geometric_tolerance", ach, STANDARD_TYPE(StepDimTol_GeometricTolerance),
