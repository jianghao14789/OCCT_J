...
void RWStepDimTol_RWGeoTolAndGeoTolWthDatRef::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepDimTol_RWGeoTolAndGeoTolWthDatRef::WriteStep(StepData_StepWriter& SW,
                                                        const Handle(StepDimTol_GeoTolAndGeoTolWthDatRef) & ent) const {
...
void RWStepDimTol_RWGeoTolAndGeoTolWthDatRef::Share(const Handle(StepDimTol_GeoTolAndGeoTolWthDatRef) & ent,
