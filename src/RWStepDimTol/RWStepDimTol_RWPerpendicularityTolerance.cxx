...
void RWStepDimTol_RWPerpendicularityTolerance::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                        ...
                                                        const Handle(StepDimTol_PerpendicularityTolerance) &
                                                            ent) const {
    ...
    ent->Init(aGeometricTolerance_Name, aGeometricTolerance_Description, aGeometricTolerance_Magnitude,
              aGeometricTolerance_TolerancedShapeAspect, aGeometricToleranceWithDatumReference_DatumSystem);
}
...
void RWStepDimTol_RWPerpendicularityTolerance::WriteStep(StepData_StepWriter& SW,
    ...
    for (Standard_Integer i4 = 1;
         i4 <= ent->StepDimTol_GeometricToleranceWithDatumReference::DatumSystemAP242()->Length(); i4++) {
...
void RWStepDimTol_RWPerpendicularityTolerance::Share(const Handle(StepDimTol_PerpendicularityTolerance) & ent,
    ...
    for (Standard_Integer i3 = 1;
         i3 <= ent->StepDimTol_GeometricToleranceWithDatumReference::DatumSystemAP242()->Length(); i3++) {
        StepDimTol_DatumSystemOrReference Var0 =
