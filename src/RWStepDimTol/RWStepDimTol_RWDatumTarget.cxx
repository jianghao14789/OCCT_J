...
void RWStepDimTol_RWDatumTarget::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepDimTol_RWDatumTarget::WriteStep(StepData_StepWriter& SW, const Handle(StepDimTol_DatumTarget) & ent) const {
