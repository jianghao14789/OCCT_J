...
void RWStepDimTol_RWDatumReferenceModifierWithValue::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                              const Standard_Integer num, Handle(Interface_Check) & ach,
                                                              const Handle(StepDimTol_DatumReferenceModifierWithValue) &
                                                                  ent) const {
...
void RWStepDimTol_RWDatumReferenceModifierWithValue::WriteStep(
    StepData_StepWriter& SW, const Handle(StepDimTol_DatumReferenceModifierWithValue) & ent) const {
    // own fields of DatumReferenceModifierWithValue
