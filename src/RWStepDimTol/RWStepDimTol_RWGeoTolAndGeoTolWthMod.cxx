...
void RWStepDimTol_RWGeoTolAndGeoTolWthMod::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepDimTol_RWGeoTolAndGeoTolWthMod::WriteStep(StepData_StepWriter& SW,
                                                     const Handle(StepDimTol_GeoTolAndGeoTolWthMod) & ent) const {
...
void RWStepDimTol_RWGeoTolAndGeoTolWthMod::Share(const Handle(StepDimTol_GeoTolAndGeoTolWthMod) & ent,
