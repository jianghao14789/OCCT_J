...
void RWStepDimTol_RWGeometricToleranceWithDatumReference::ReadStep(
    ...
    data->ReadEntity(num, 4, "geometric_tolerance.toleranced_shape_aspect", ach,
    ...
    // Initialize entity
    ent->Init(aGeometricTolerance_Name, aGeometricTolerance_Description, aGeometricTolerance_Magnitude,
              aGeometricTolerance_TolerancedShapeAspect, aDatumSystem);
}
...
void RWStepDimTol_RWGeometricToleranceWithDatumReference::WriteStep(
    StepData_StepWriter& SW, const Handle(StepDimTol_GeometricToleranceWithDatumReference) & ent) const {
...
void RWStepDimTol_RWGeometricToleranceWithDatumReference::Share(
    const Handle(StepDimTol_GeometricToleranceWithDatumReference) & ent, Interface_EntityIterator& iter) const {
