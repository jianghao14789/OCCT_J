...
void RWStepDimTol_RWGeoTolAndGeoTolWthMaxTol::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepDimTol_RWGeoTolAndGeoTolWthMaxTol::WriteStep(StepData_StepWriter& SW,
                                                        const Handle(StepDimTol_GeoTolAndGeoTolWthMaxTol) & ent) const {
...
void RWStepDimTol_RWGeoTolAndGeoTolWthMaxTol::Share(const Handle(StepDimTol_GeoTolAndGeoTolWthMaxTol) & ent,
