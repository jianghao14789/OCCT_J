...
void RWStepDimTol_RWGeometricToleranceWithMaximumTolerance::ReadStep(
    ...
    data->ReadEntity(num, 6, "maximum_upper_tolerance", ach, STANDARD_TYPE(StepBasic_LengthMeasureWithUnit),
                     aMaximumUpperTolerance);

    // Initialize entity
    ent->Init(aName, aDescription, aMagnitude, aTolerancedShapeAspect, aModifiers, aMaximumUpperTolerance);
}
...
void RWStepDimTol_RWGeometricToleranceWithMaximumTolerance::WriteStep(
    StepData_StepWriter& SW, const Handle(StepDimTol_GeometricToleranceWithMaximumTolerance) & ent) const {
...
void RWStepDimTol_RWGeometricToleranceWithMaximumTolerance::Share(
    const Handle(StepDimTol_GeometricToleranceWithMaximumTolerance) & ent, Interface_EntityIterator& iter) const {
