...
void RWStepDimTol_RWGeoTolAndGeoTolWthDatRefAndGeoTolWthMod::WriteStep(
    StepData_StepWriter& SW, const Handle(StepDimTol_GeoTolAndGeoTolWthDatRefAndGeoTolWthMod) & ent) const {
...
void RWStepDimTol_RWGeoTolAndGeoTolWthDatRefAndGeoTolWthMod::Share(
    const Handle(StepDimTol_GeoTolAndGeoTolWthDatRefAndGeoTolWthMod) & ent, Interface_EntityIterator& iter) const {
    // Own fields of GeometricTolerance
