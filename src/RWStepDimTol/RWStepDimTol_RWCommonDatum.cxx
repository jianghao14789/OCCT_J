...
void RWStepDimTol_RWCommonDatum::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
    ...
    data->ReadEntity(num, 3, "shape_aspect.of_shape", ach, STANDARD_TYPE(StepRepr_ProductDefinitionShape),
    ...
    data->ReadEntity(num, 7, "shape_aspect.of_shape", ach, STANDARD_TYPE(StepRepr_ProductDefinitionShape),
                     aDatum_OfShape);
    ...
    // Initialize entity
    ent->Init(aShapeAspect_Name, aShapeAspect_Description, aShapeAspect_OfShape, aShapeAspect_ProductDefinitional,
              aDatum_Name, aDatum_Description, aDatum_OfShape, aDatum_ProductDefinitional, aDatum_Identification);
}
...
void RWStepDimTol_RWCommonDatum::WriteStep(StepData_StepWriter& SW, const Handle(StepDimTol_CommonDatum) & ent) const {
