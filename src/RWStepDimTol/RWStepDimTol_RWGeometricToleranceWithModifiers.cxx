...
void RWStepDimTol_RWGeometricToleranceWithModifiers::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                              const Standard_Integer num, Handle(Interface_Check) & ach,
                                                              const Handle(StepDimTol_GeometricToleranceWithModifiers) &
                                                                  ent) const {
...
void RWStepDimTol_RWGeometricToleranceWithModifiers::WriteStep(
    StepData_StepWriter& SW, const Handle(StepDimTol_GeometricToleranceWithModifiers) & ent) const {
...
void RWStepDimTol_RWGeometricToleranceWithModifiers::Share(const Handle(StepDimTol_GeometricToleranceWithModifiers) &
                                                               ent,
