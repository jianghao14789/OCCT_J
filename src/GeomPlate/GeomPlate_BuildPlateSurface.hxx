...
public:
    ...
    Standard_EXPORT GeomPlate_BuildPlateSurface(const Handle(TColStd_HArray1OfInteger) & NPoints,
                                                ...
                                                const Standard_Integer Degree, const Standard_Integer NbIter = 3,
    ...
    Standard_EXPORT GeomPlate_BuildPlateSurface(const Handle(Geom_Surface) & Surf, const Standard_Integer Degree = 3,
                                                const Standard_Integer NbPtsOnCur = 10,
                                                const Standard_Integer NbIter = 3, const Standard_Real Tol2d = 0.00001,
                                                const Standard_Real Tol3d = 0.0001, const Standard_Real TolAng = 0.01,
    ...
    Standard_EXPORT void Disc3dContour(const Standard_Integer nbp, const Standard_Integer iordre,
...
private:
    ...
    Standard_EXPORT void EcartContraintesMil(const Standard_Integer c, Handle(TColStd_HArray1OfReal) & d,
                                             Handle(TColStd_HArray1OfReal) & an, Handle(TColStd_HArray1OfReal) & courb);
