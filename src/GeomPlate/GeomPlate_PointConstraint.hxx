...
public:
    ...
    Standard_EXPORT GeomPlate_PointConstraint(const gp_Pnt& Pt, const Standard_Integer Order,
    ...
    Standard_EXPORT GeomPlate_PointConstraint(const Standard_Real U, const Standard_Real V,
                                              const Handle(Geom_Surface) & Surf, const Standard_Integer Order,
                                              const Standard_Real TolDist = 0.0001, const Standard_Real TolAng = 0.01,
