...
//---------------------------------------------------------
GeomPlate_PointConstraint::GeomPlate_PointConstraint(const gp_Pnt& Pt, const Standard_Integer Order,
                                                     const Standard_Real TolDist)
    : myOrder(Order), myLProp(2, TolDist), myPoint(Pt), myU(0.0), myV(0.0), myTolDist(TolDist), myTolAng(0.0),
      myTolCurv(0.0), hasPnt2dOnSurf(Standard_False) {
...
//---------------------------------------------------------
GeomPlate_PointConstraint::GeomPlate_PointConstraint(const Standard_Real U, const Standard_Real V,
                                                     const Handle(Geom_Surface) & Surf, const Standard_Integer Order,
                                                     const Standard_Real TolDist, const Standard_Real TolAng,
                                                     const Standard_Real TolCurv)
    : myOrder(Order), myLProp(2, TolDist), mySurf(Surf), myU(U), myV(V), myTolDist(TolDist), myTolAng(TolAng),
      myTolCurv(TolCurv), hasPnt2dOnSurf(Standard_False)
...
//------------------------------------------------------------
GeomLProp_SLProps&
GeomPlate_PointConstraint::LPropSurf() { // if (myFrontiere.IsNull())
                                         //  throw Standard_Failure("GeomPlate_CurveConstraint.cxx : Curve must be on a
                                         //  Surface");
