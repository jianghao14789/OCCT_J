...
GeomPlate_Surface::GeomPlate_Surface(const Handle(Geom_Surface) & Surfinit, const Plate_Plate& Surfinter)
    : mySurfinter(Surfinter), mySurfinit(Surfinit), myUmin(0.0), myUmax(0.0), myVmin(0.0), myVmax(0.0) {}
...
Standard_Real
GeomPlate_Surface::UReversedParameter(const Standard_Real U) const { // throw Standard_Failure("UReversedParameter");
    return (-U);
}
...
void GeomPlate_Surface::VReverse() { // throw Standard_Failure("VReverse");
}
...
Standard_Real
GeomPlate_Surface::VReversedParameter(const Standard_Real V) const { // throw Standard_Failure("VReversedParameter");
    return (-V);
}
...
void GeomPlate_Surface::TransformParameters(Standard_Real&, Standard_Real&,
                                            const gp_Trsf&) const { // throw Standard_Failure("TransformParameters");
}
...
gp_GTrsf2d GeomPlate_Surface::ParametricTransformation(
    const gp_Trsf&) const { // throw Standard_Failure("ParametricTransformation");
    return gp_GTrsf2d();
}
...
Standard_Boolean GeomPlate_Surface::IsUClosed() const { // throw Standard_Failure("IsUClosed(");
    // return 1;
    return 0;
}
...
Standard_Boolean GeomPlate_Surface::IsVClosed() const { // throw Standard_Failure("IsVClosed(");
    // return 1;
    return 0;
}
...
Handle(Geom_Curve) GeomPlate_Surface::UIso(const Standard_Real) const { // throw Standard_Failure("UIso");
...
Handle(Geom_Curve) GeomPlate_Surface::VIso(const Standard_Real) const { // throw Standard_Failure("VIso");
    return Handle(Geom_Curve)();
}
...
GeomAbs_Shape GeomPlate_Surface::Continuity() const { // throw Standard_Failure("Continuity()");
...
void GeomPlate_Surface::D2(const Standard_Real U, const Standard_Real V, gp_Pnt& P, gp_Vec& D1U, gp_Vec& D1V,
...
// void GeomPlate_Surface::D3(const Standard_Real U, const Standard_Real V, gp_Pnt& P, gp_Vec& D1U, gp_Vec& D1V, gp_Vec&
// D2U, gp_Vec& D2V, gp_Vec& D2UV, gp_Vec& D3U, gp_Vec& D3V, gp_Vec& D3UUV, gp_Vec& D3UVV) const
void GeomPlate_Surface::D3(const Standard_Real, const Standard_Real, gp_Pnt&, gp_Vec&, gp_Vec&, gp_Vec&, gp_Vec&,
...
// gp_Vec GeomPlate_Surface::DN(const Standard_Real U, const Standard_Real V, const Standard_Integer Nu, const
// Standard_Integer Nv) const
gp_Vec GeomPlate_Surface::DN(const Standard_Real, const Standard_Real, const Standard_Integer,
...
void GeomPlate_Surface::Transform(const gp_Trsf&) { // throw Standard_Failure("Transform");
}
...
void GeomPlate_Surface::SetBounds(const Standard_Real Umin, const Standard_Real Umax, const Standard_Real Vmin,
