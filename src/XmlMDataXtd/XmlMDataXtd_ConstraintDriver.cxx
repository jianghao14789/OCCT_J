...
// purpose  : Constructor
//=======================================================================
XmlMDataXtd_ConstraintDriver::XmlMDataXtd_ConstraintDriver(const Handle(Message_Messenger) & theMsgDriver)
...
//=======================================================================
Standard_Boolean XmlMDataXtd_ConstraintDriver::Paste(const XmlObjMgt_Persistent& theSource,
    ...
    if (aDOMStr != NULL) {
        if (!aDOMStr.GetInteger(aNb)) {
            aMsgString = TCollection_ExtendedString("XmlMDataXtd_ConstraintDriver: "
    ...
    if (aDOMStr != NULL) {
        if (!aDOMStr.GetInteger(aNb)) {
            aMsgString =
                TCollection_ExtendedString("XmlMDataXtd_ConstraintDriver: Cannot retrieve reference on Plane from \"") +
                aDOMStr + "\"";
            myMessageDriver->Send(aMsgString, Message_Fail);
            return Standard_False;
        }
...
//=======================================================================
void XmlMDataXtd_ConstraintDriver::Paste(const Handle(TDF_Attribute) & theSource, XmlObjMgt_Persistent& theTarget,
