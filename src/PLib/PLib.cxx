...
void PLib::SetPoles(const TColgp_Array1OfPnt2d& Poles, const TColStd_Array1OfReal& Weights, TColStd_Array1OfReal& FP) {
    Standard_Integer j = FP.Lower();
    Standard_Integer PLower = Poles.Lower();
    Standard_Integer PUpper = Poles.Upper();
...
void PLib::GetPoles(const TColStd_Array1OfReal& FP, TColgp_Array1OfPnt2d& Poles, TColStd_Array1OfReal& Weights) {
    Standard_Integer j = FP.Lower();
    Standard_Integer PLower = Poles.Lower();
    Standard_Integer PUpper = Poles.Upper();
...
void PLib::SetPoles(const TColgp_Array1OfPnt& Poles, const TColStd_Array1OfReal& Weights, TColStd_Array1OfReal& FP) {
    Standard_Integer j = FP.Lower();
    Standard_Integer PLower = Poles.Lower();
    Standard_Integer PUpper = Poles.Upper();
...
void PLib::GetPoles(const TColStd_Array1OfReal& FP, TColgp_Array1OfPnt& Poles, TColStd_Array1OfReal& Weights) {
    Standard_Integer j = FP.Lower();
    Standard_Integer PLower = Poles.Lower();
    Standard_Integer PUpper = Poles.Upper();
...
public:
    //! Main constructor
    BinomAllocator(const Standard_Integer theMaxBinom) : myBinom(NULL), myMaxBinom(theMaxBinom) {
...
void PLib::RationalDerivative(const Standard_Integer Degree, const Standard_Integer DerivativeRequest,
                              const Standard_Integer Dimension, Standard_Real& Ders, Standard_Real& RDers,
...
void PLib::RationalDerivatives(const Standard_Integer DerivativeRequest, const Standard_Integer Dimension,
...
template <int dim> inline void eval_step1(double* poly, double par, double* coef) {
    eval_step1<dim - 1>(poly, par, coef);
    poly[dim] = poly[dim] * par + coef[dim];
}

// recursion end
template <> inline void eval_step1<-1>(double*, double, double*) {}

// recursive template for evaluating second derivative
template <int dim> inline void eval_step2(double* poly, double par, double* coef) {
    eval_step2<dim - 1>(poly, par, coef);
    poly[dim] = poly[dim] * par + coef[dim] * 2.;
}

// recursion end
template <> inline void eval_step2<-1>(double*, double, double*) {}

// evaluation of only value
template <int dim> inline void eval_poly0(double* aRes, double* aCoeffs, int Degree, double Par) {
...
template <int dim> inline void eval_poly1(double* aRes, double* aCoeffs, int Degree, double Par) {
    Standard_Real* aRes0 = aRes;
...
template <int dim> inline void eval_poly2(double* aRes, double* aCoeffs, int Degree, double Par) {
    Standard_Real* aRes0 = aRes;
    Standard_Real* aRes1 = aRes + dim;
...
void PLib::EvalPolynomial(const Standard_Real Par, const Standard_Integer DerivativeRequest,
                          const Standard_Integer Degree, const Standard_Integer Dimension,
                          Standard_Real& PolynomialCoeff, Standard_Real& Results)
//
...
void PLib::NoDerivativeEvalPolynomial(const Standard_Real Par, const Standard_Integer Degree,
                                      const Standard_Integer Dimension, const Standard_Integer DegreeDimension,
                                      Standard_Real& PolynomialCoeff, Standard_Real& Results) {
...
void PLib::EvalPoly2Var(const Standard_Real UParameter, const Standard_Real VParameter,
                        const Standard_Integer UDerivativeRequest, const Standard_Integer VDerivativeRequest,
                        const Standard_Integer UDegree, const Standard_Integer VDegree,
                        const Standard_Integer Dimension, Standard_Real& PolynomialCoeff, Standard_Real& Results)
//
// the polynomial coefficients are assumed to be stored as follows :
//                                                      0 0
...
Standard_Integer PLib::EvalLagrange(const Standard_Real Parameter, const Standard_Integer DerivativeRequest,
                                    const Standard_Integer Degree, const Standard_Integer Dimension,
                                    Standard_Real& Values, Standard_Real& Parameters, Standard_Real& Results) {
    //
...
Standard_Integer PLib::EvalCubicHermite(const Standard_Real Parameter, const Standard_Integer DerivativeRequest,
                                        const Standard_Integer Dimension, Standard_Real& Values,
                                        Standard_Real& Derivatives, Standard_Real& theParameters,
    ...
    for (ii = 0, jj = Dimension, kk = 2 * Dimension, pp = 3 * Dimension; ii < Dimension; ii++, jj++, kk++, pp++) {
        divided_differences_array[ii] = PointsArray[ii];
...
Standard_Boolean PLib::HermiteCoefficients(const Standard_Real FirstParameter, const Standard_Real LastParameter,
                                           const Standard_Integer FirstOrder, const Standard_Integer LastOrder,
...
void PLib::CoefficientsPoles(const TColgp_Array1OfPnt& Coefs, const TColStd_Array1OfReal* WCoefs,
                             TColgp_Array1OfPnt& Poles, TColStd_Array1OfReal* Weights) {
...
void PLib::CoefficientsPoles(const TColgp_Array1OfPnt2d& Coefs, const TColStd_Array1OfReal* WCoefs,
...
void PLib::CoefficientsPoles(const TColStd_Array1OfReal& Coefs, const TColStd_Array1OfReal* WCoefs,
                             TColStd_Array1OfReal& Poles, TColStd_Array1OfReal* Weights) {
...
void PLib::CoefficientsPoles(const Standard_Integer dim, const TColStd_Array1OfReal& Coefs,
                             const TColStd_Array1OfReal* WCoefs, TColStd_Array1OfReal& Poles,
...
void PLib::Trimming(const Standard_Real U1, const Standard_Real U2, TColgp_Array1OfPnt& Coefs,
...
void PLib::Trimming(const Standard_Real U1, const Standard_Real U2, TColgp_Array1OfPnt2d& Coefs,
                    TColStd_Array1OfReal* WCoefs) {
...
void PLib::Trimming(const Standard_Real U1, const Standard_Real U2, TColStd_Array1OfReal& Coefs,
                    TColStd_Array1OfReal* WCoefs) {
...
void PLib::Trimming(const Standard_Real U1, const Standard_Real U2, const Standard_Integer dim,
                    TColStd_Array1OfReal& Coefs, TColStd_Array1OfReal* WCoefs) {
    ...
    if (rat) {
        if (len != WCoefs->Length()) throw Standard_Failure("PLib::Trimming : nbcoefs/dim != nbweights !!!");
        upw = WCoefs->Upper();
    }
    len--;
...
void PLib::CoefficientsPoles(const TColgp_Array2OfPnt& Coefs, const TColStd_Array2OfReal* WCoefs,
...
void PLib::UTrimming(const Standard_Real U1, const Standard_Real U2, TColgp_Array2OfPnt& Coeffs,
...
void PLib::VTrimming(const Standard_Real V1, const Standard_Real V2, TColgp_Array2OfPnt& Coeffs,
                     TColStd_Array2OfReal* WCoeffs) {
    Standard_Boolean rat = WCoeffs != NULL;
    Standard_Integer lr = Coeffs.LowerRow();
    Standard_Integer ur = Coeffs.UpperRow();
...
Standard_Boolean PLib::HermiteInterpolate(const Standard_Integer Dimension, const Standard_Real FirstParameter,
                                          const Standard_Real LastParameter, const Standard_Integer FirstOrder,
                                          const Standard_Integer LastOrder, const TColStd_Array2OfReal& FirstConstr,
                                          const TColStd_Array2OfReal& LastConstr, TColStd_Array1OfReal& Coefficients) {
...
void PLib::JacobiParameters(const GeomAbs_Shape ConstraintOrder, const Standard_Integer MaxDegree,
                            const Standard_Integer Code, Standard_Integer& NbGaussPoints,
    ...
    const Standard_Integer NDEG8 = 8, NDEG10 = 10, NDEG15 = 15, NDEG20 = 20, NDEG25 = 25, NDEG30 = 30, NDEG40 = 40,
                           NDEG50 = 50, NDEG61 = 61;
    ...
    if (MaxDegree < 2 * NivConstr + 1) throw Standard_ConstructionError("Invalid MaxDegree");
...
void PLib::EvalLength(const Standard_Integer Degree, const Standard_Integer Dimension, Standard_Real& PolynomialCoeff,
                      const Standard_Real U1, const Standard_Real U2, Standard_Real& Length) {
...
void PLib::EvalLength(const Standard_Integer Degree, const Standard_Integer Dimension, Standard_Real& PolynomialCoeff,
                      const Standard_Real U1, const Standard_Real U2, const Standard_Real Tol, Standard_Real& Length,
                      Standard_Real& Error) {
    Standard_Integer i;
