...
//  ============================================================================
StepToTopoDS_TranslateVertexLoop::StepToTopoDS_TranslateVertexLoop() : myError(StepToTopoDS_TranslateVertexLoopOther) {}
...
StepToTopoDS_TranslateVertexLoop::StepToTopoDS_TranslateVertexLoop(const Handle(StepShape_VertexLoop) & VL,
                                                                   StepToTopoDS_Tool& T, StepToTopoDS_NMTool& NMTool) {
    Init(VL, T, NMTool);
}
...
void StepToTopoDS_TranslateVertexLoop::Init(const Handle(StepShape_VertexLoop) & VL, StepToTopoDS_Tool& aTool,
