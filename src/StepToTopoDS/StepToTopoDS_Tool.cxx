...
StepToTopoDS_Tool::StepToTopoDS_Tool()
    : myComputePC(Standard_False), myNbC0Surf(0), myNbC1Surf(0), myNbC2Surf(0), myNbC0Cur2(0), myNbC1Cur2(0),
      myNbC2Cur2(0), myNbC0Cur3(0), myNbC1Cur3(0), myNbC2Cur3(0) {}
...
void StepToTopoDS_Tool::Init(const StepToTopoDS_DataMapOfTRI& Map, const Handle(Transfer_TransientProcess) & TP) {
