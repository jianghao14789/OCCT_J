...
//  ============================================================================
StepToTopoDS_TranslateVertex::StepToTopoDS_TranslateVertex() : myError(StepToTopoDS_TranslateVertexOther) {
    done = Standard_False;
}
...
void StepToTopoDS_TranslateVertex::Init(const Handle(StepShape_Vertex) & aVertex, StepToTopoDS_Tool& aTool,
                                        StepToTopoDS_NMTool& NMTool) {
    if (aVertex.IsNull()) {
    ...
    if (!aTool.IsBound(aVertex)) {
        ...
        if (NMTool.IsActive()) {
            ...
            if (NMTool.IsIDEASCase() && !aVName.IsNull() && !aVName->IsEmpty()) NMTool.Bind(aVName->String(), V);
        }
