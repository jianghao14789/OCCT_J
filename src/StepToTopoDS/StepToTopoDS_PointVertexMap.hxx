...
typedef NCollection_DataMap<Handle(StepGeom_CartesianPoint), TopoDS_Vertex, StepToTopoDS_CartesianPointHasher>
    StepToTopoDS_PointVertexMap;
typedef NCollection_DataMap<Handle(StepGeom_CartesianPoint), TopoDS_Vertex, StepToTopoDS_CartesianPointHasher>::Iterator
