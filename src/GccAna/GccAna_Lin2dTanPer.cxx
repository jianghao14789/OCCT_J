...
GccAna_Lin2dTanPer::GccAna_Lin2dTanPer(const GccEnt_QualifiedCirc& Qualified1, const gp_Lin2d& TheLin)
...
GccAna_Lin2dTanPer::GccAna_Lin2dTanPer(const GccEnt_QualifiedCirc& Qualified1, const gp_Circ2d& TheCircle)
    : linsol(1, 2), qualifier1(1, 2), pnttg1sol(1, 2), pntint2sol(1, 2), par1sol(1, 2), par2sol(1, 2), pararg1(1, 2),
      pararg2(1, 2) {
...
void GccAna_Lin2dTanPer::WhichQualifier(const Standard_Integer Index, GccEnt_Position& Qualif1) const {
    if (!WellDone) {
        throw StdFail_NotDone();
    }
    if (Index <= 0 || Index > NbrSol) {
...
void GccAna_Lin2dTanPer::Tangency1(const Standard_Integer Index, Standard_Real& ParSol, Standard_Real& ParArg,
                                   gp_Pnt2d& Pnt) const {
    if (!WellDone) {
        throw StdFail_NotDone();
...
void GccAna_Lin2dTanPer::Intersection2(const Standard_Integer Index, Standard_Real& ParSol, Standard_Real& ParArg,
