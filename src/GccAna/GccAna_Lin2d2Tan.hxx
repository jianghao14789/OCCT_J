...
public:
    ...
    Standard_EXPORT GccAna_Lin2d2Tan(const gp_Pnt2d& ThePoint1, const gp_Pnt2d& ThePoint2,
    ...
    //! the tolerance.
    Standard_EXPORT GccAna_Lin2d2Tan(const GccEnt_QualifiedCirc& Qualified1, const gp_Pnt2d& ThePoint,
                                     const Standard_Real Tolerance);
    ...
    //! Exception BadQualifier is raised in the case of
    //! EnclosedCirc
    Standard_EXPORT GccAna_Lin2d2Tan(const GccEnt_QualifiedCirc& Qualified1, const GccEnt_QualifiedCirc& Qualified2,
                                     const Standard_Real Tolerance);
