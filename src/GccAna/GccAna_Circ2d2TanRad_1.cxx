...
GccAna_Circ2d2TanRad::GccAna_Circ2d2TanRad(const GccEnt_QualifiedCirc& Qualified1,
                                           const GccEnt_QualifiedLin& Qualified2, const Standard_Real Radius,
        ...
        if (distance - dist > Tol) {
            ...
            if (Qualified2.IsEnclosed()) {
                ...
                if (distance - R1 > Tol) {
                    ...
                    if (((-ydir * (cxloc - lxloc) + xdir * (cyloc - lyloc) < 0.0) && (Radius * 2.0 > R1 - distance)) ||
                        (Abs(distance - R1) < Tol) ||
                        ((-ydir * (cxloc - lxloc) + xdir * (cyloc - lyloc) > 0.0) &&
                         (Radius * 2.0 > (R1 + distance + Tol)))) {
                        cote = 1.0;
            ...
            if (((-ydir * (cxloc - lxloc) + xdir * (cyloc - lyloc) < 0.0) && (distance > R1 + Tol)) ||
                ...
                if ((-ydir * (cxloc - lxloc) + xdir * (cyloc - lyloc) < 0.0) && (distance > R1)) {
                    cote = 1.0;
                    nbsol = 2;
                } else if ((-ydir * (cxloc - lxloc) + xdir * (cyloc - lyloc) > 0.0) && (distance > R1 + 2.0 * Radius)) {
                    cote = -1.0;
                    nbsol = 2;
                } else {
                    ncote1 = 1;
...
//              ======================================
                                ...
                                pnttg2sol(NbrSol) = gp_Pnt2d(Center.XY() + cote2(jcote2) * Radius * gp_XY(ydir, -xdir));
                            }
                        }
                        WellDone = Standard_True;
                    }
