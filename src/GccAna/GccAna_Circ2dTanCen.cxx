...
//========================================================================
GccAna_Circ2dTanCen::GccAna_Circ2dTanCen(const GccEnt_QualifiedCirc& Qualified1, const gp_Pnt2d& Pcenter,
    ...
    :
      ...
      cirsol(1, 2), qualifier1(1, 2), TheSame1(1, 2), pnttg1sol(1, 2), par1sol(1, 2), pararg1(1, 2) {
...
GccAna_Circ2dTanCen::GccAna_Circ2dTanCen(const gp_Lin2d& Linetan, const gp_Pnt2d& Pcenter)
    :
      ...
      cirsol(1, 1), qualifier1(1, 1), TheSame1(1, 1), pnttg1sol(1, 1), par1sol(1, 1), pararg1(1, 1) {
...
void GccAna_Circ2dTanCen::WhichQualifier(const Standard_Integer Index, GccEnt_Position& Qualif1) const {
    if (!WellDone) {
...
void GccAna_Circ2dTanCen::Tangency1(const Standard_Integer Index, Standard_Real& ParSol, Standard_Real& ParArg,
