...
//=========================================================================
GccAna_Circ2d2TanOn::GccAna_Circ2d2TanOn(const GccEnt_QualifiedCirc& Qualified1, const gp_Pnt2d& Point2,
    ...
    if (Qualified1.IsEnclosed() && Abs(R1 - dist - dp2l) <= Tol) {
        ...
        WellDone = Standard_True;
               ...
               (Abs(dist - dp2l) <= Tol || Abs(R1 - dist - dp2l) <= Tol || Abs(R1 + dist - dp2l) <= Tol)) {
        WellDone = Standard_True;
    }
    if (WellDone) {
        NbrSol++;
