...
//=========================================================================
GccAna_Circ2d3Tan::GccAna_Circ2d3Tan(const GccEnt_QualifiedLin& Qualified1, const gp_Pnt2d& Point2,
            ...
            if ((!Intp.IsEmpty()) && (!Intp.ParallelElements()) && (!Intp.IdenticalElements())) {
                for (Standard_Integer j = 1; j <= Intp.NbPoints(); j++) {
                    ...
                    Standard_Real difference =
                        (((origin1.X() - Center.X()) * (-dir1.Y())) + ((origin1.Y() - Center.Y()) * (dir1.X())));
                    if ((Qualified1.IsEnclosed() && difference <= 0) || (Qualified1.IsOutside() && difference >= 0) ||
