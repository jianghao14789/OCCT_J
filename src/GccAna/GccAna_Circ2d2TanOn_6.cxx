...
//  possible locations of centers of all circles tangent to C1 and C2. + We intersect these bissectrices with circle
//  OnCirc which gives us   + points among which we choose the solutions.   + The choice is made basing in Qualifiers of
//  C1 and C2.  +
//=========================================================================
GccAna_Circ2d2TanOn::GccAna_Circ2d2TanOn(const GccEnt_QualifiedCirc& Qualified1, const GccEnt_QualifiedCirc& Qualified2,
    ...
    : cirsol(1, 8), qualifier1(1, 8), qualifier2(1, 8), TheSame1(1, 8), TheSame2(1, 8), pnttg1sol(1, 8),
      pnttg2sol(1, 8), pntcen(1, 8), par1sol(1, 8), par2sol(1, 8), pararg1(1, 8), pararg2(1, 8), parcen3(1, 8) {
    TheSame1.Init(0);
    TheSame2.Init(0);
