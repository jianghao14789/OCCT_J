...
//  all possibles locations of centers of all circles tangent to C1 and L2+ + We intersect these bissectrices with
//  straight line OnLine which gives   + us points among which we'll choose the solutions.   + The choices are made
//  basing on Qualifiers of C1 and L2.  +
//=========================================================================
GccAna_Circ2d2TanOn::GccAna_Circ2d2TanOn(const GccEnt_QualifiedCirc& Qualified1, const GccEnt_QualifiedLin& Qualified2,
    ...
    if (OnLine.Distance(pinterm) > Tolerance) {
        pinterm = gp_Pnt2d(center1.XY() + distcl * gp_XY(-OnLine.Direction().Y(), OnLine.Direction().X()));
    }
