...
//=======================================================================
GccAna_Circ2d3Tan::GccAna_Circ2d3Tan(const GccEnt_QualifiedCirc& Qualified1, const gp_Pnt2d& Point2,
                        ...
                        if (ok) {
                            ...
                            if (Center.Distance(center1) <= Tolerance && Abs(Radius(nbsol3) - R1) <= Tolerance) {
                                ...
                                if (qualifier1(NbrSol) == GccEnt_enclosed)
                                    dc.Reverse(); // if tangent circle is inside the source circle, moving to edge of
                                                  // source circle
