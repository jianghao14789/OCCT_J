...
GccAna_Circ2d3Tan::GccAna_Circ2d3Tan(const GccEnt_QualifiedCirc& Qualified1, const GccEnt_QualifiedCirc& Qualified2,
    ...
    :
      ...
      cirsol(1, MaxSol), qualifier1(1, MaxSol), qualifier2(1, MaxSol), qualifier3(1, MaxSol), TheSame1(1, MaxSol),
      TheSame2(1, MaxSol), TheSame3(1, MaxSol), pnttg1sol(1, MaxSol), pnttg2sol(1, MaxSol), pnttg3sol(1, MaxSol),
      par1sol(1, MaxSol), par2sol(1, MaxSol), par3sol(1, MaxSol), pararg1(1, MaxSol), pararg2(1, MaxSol),
      pararg3(1, MaxSol) {
                                ...
                                for (Standard_Integer k1 = 1; k1 <= nbsol3; k1++) {
                                    ...
                                    if (Center.Distance(center1) <= Tolerance && Abs(Radius(k1) - R1) <= Tolerance) {
                                        ...
                                        if (qualifier1(NbrSol) == GccEnt_enclosed)
                                            dc.Reverse(); // if tangent circle is inside the source circle, moving to
                                                          // edge of source circle
