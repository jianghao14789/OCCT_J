...
// purpose  :
//=======================================================================
TopOpeBRepBuild_WireEdgeSet::TopOpeBRepBuild_WireEdgeSet(const TopoDS_Shape& F, const Standard_Address /*A*/)
...
//=======================================================================
const TopTools_ListOfShape& TopOpeBRepBuild_WireEdgeSet::MakeNeighboursList(const TopoDS_Shape& Earg,
    ...
    if (nclosing) {
        ...
        if (newn >= 2) {
            ...
            while (lclo.More()) {
                ...
                Standard_Boolean t2 = ((cross > 0) && oVE == TopAbs_REVERSED) || ((cross < 0) && oVE == TopAbs_FORWARD);
...
// purpose  :
//=======================================================================
Standard_Boolean TopOpeBRepBuild_WireEdgeSet::VertexConnectsEdges(const TopoDS_Shape& V, const TopoDS_Shape& E1,
                                                                  const TopoDS_Shape& E2, TopAbs_Orientation& o1,
...
// purpose  :
//=======================================================================
Standard_Boolean TopOpeBRepBuild_WireEdgeSet::VertexConnectsEdgesClosing(const TopoDS_Shape& V, const TopoDS_Shape& E1,
...
// purpose  :
//=======================================================================
void TopOpeBRepBuild_WireEdgeSet::IsUVISO(const TopoDS_Edge& E, const TopoDS_Face& F, Standard_Boolean& uiso,
...
//=======================================================================
#ifdef DRAW
TCollection_AsciiString TopOpeBRepBuild_WireEdgeSet::SNameVEE(const TopoDS_Shape& VV, const TopoDS_Shape& EE1,
...
#else
TCollection_AsciiString TopOpeBRepBuild_WireEdgeSet::SNameVEE(const TopoDS_Shape&, const TopoDS_Shape&,
...
//=======================================================================
#ifdef DRAW
TCollection_AsciiString TopOpeBRepBuild_WireEdgeSet::SName(const TopoDS_Shape& S, const TCollection_AsciiString& sb,
                                                           const TCollection_AsciiString& sa) const
#else
TCollection_AsciiString TopOpeBRepBuild_WireEdgeSet::SName(const TopoDS_Shape&, const TCollection_AsciiString& sb,
...
//=======================================================================
#ifdef DRAW
TCollection_AsciiString TopOpeBRepBuild_WireEdgeSet::SNameori(const TopoDS_Shape& S, const TCollection_AsciiString& sb,
                                                              const TCollection_AsciiString& sa) const
#else
TCollection_AsciiString TopOpeBRepBuild_WireEdgeSet::SNameori(const TopoDS_Shape&, const TCollection_AsciiString& sb,
                                                              const TCollection_AsciiString&) const
#endif
{
    TCollection_AsciiString str = sb;
...
TCollection_AsciiString TopOpeBRepBuild_WireEdgeSet::SName(const TopTools_ListOfShape& L,
                                                           ...
                                                           const TCollection_AsciiString& sa) const
#else
TCollection_AsciiString TopOpeBRepBuild_WireEdgeSet::SName(const TopTools_ListOfShape&, const TCollection_AsciiString&,
                                                           const TCollection_AsciiString&) const
#endif
{
    TCollection_AsciiString str;
