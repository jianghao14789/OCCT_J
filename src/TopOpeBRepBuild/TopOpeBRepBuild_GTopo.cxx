...
TopOpeBRepBuild_GTopo::TopOpeBRepBuild_GTopo(const Standard_Boolean ii, const Standard_Boolean in,
                                             const Standard_Boolean io, const Standard_Boolean ni,
                                             const Standard_Boolean nn, const Standard_Boolean no,
                                             const Standard_Boolean oi, const Standard_Boolean on,
                                             const Standard_Boolean oo, const TopAbs_ShapeEnum t1,
                                             const TopAbs_ShapeEnum t2, const TopOpeBRepDS_Config C1,
...
void TopOpeBRepBuild_GTopo::Reset() {
    ...
    mycases[0][0] = mycases[0][1] = mycases[0][2] = mycases[1][0] = mycases[1][1] = mycases[1][2] = mycases[2][0] =
        mycases[2][1] = mycases[2][2] = Standard_False;
...
void TopOpeBRepBuild_GTopo::Set(const Standard_Boolean ii, const Standard_Boolean in, const Standard_Boolean io,
...
Standard_Boolean TopOpeBRepBuild_GTopo::Value(const Standard_Integer i1, const Standard_Integer i2) const {
...
void TopOpeBRepBuild_GTopo::ChangeValue(const Standard_Integer i1, const Standard_Integer i2,
...
void TopOpeBRepBuild_GTopo::ChangeValue(const TopAbs_State s1, const TopAbs_State s2, const Standard_Boolean b) {
    Standard_Integer i1 = GIndex(s1);
    Standard_Integer i2 = GIndex(s2);
    mycases[i1][i2] = b;
}
...
void TopOpeBRepBuild_GTopo::Index(const Standard_Integer II, Standard_Integer& i1, Standard_Integer& i2) const {
    switch (II) {
        case 0:
            i1 = 0;
            i2 = 0;
...
void TopOpeBRepBuild_GTopo::DumpVal(Standard_OStream& OS, const TopAbs_State s1, const TopAbs_State s2) const {
    OS << Value(s1, s2);
}
...
void TopOpeBRepBuild_GTopo::DumpSSB(Standard_OStream& OS, const TopAbs_State s1, const TopAbs_State s2,
                                    const Standard_Boolean b) {
    TopAbs::Print(s1, OS);
    OS << " ";
    TopAbs::Print(s2, OS);
