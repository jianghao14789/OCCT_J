...
void TopOpeBRepBuild_Builder::MergeShapes(const TopoDS_Shape& S1, const TopAbs_State ToBuild1, const TopoDS_Shape& S2,
...
void TopOpeBRepBuild_Builder::MergeSolids(const TopoDS_Shape& S1, const TopAbs_State ToBuild1, const TopoDS_Shape& S2,
                                          const TopAbs_State ToBuild2) {
...
void TopOpeBRepBuild_Builder::MakeFaces(const TopoDS_Shape& aFace, TopOpeBRepBuild_FaceBuilder& FABU,
...
void TopOpeBRepBuild_Builder::MakeEdges(const TopoDS_Shape& anEdge, TopOpeBRepBuild_EdgeBuilder& EDBU,
                                        TopTools_ListOfShape& L) {
#ifdef OCCT_DEBUG
    Standard_Integer iE;
    ...
    for (TopOpeBRepTool_ShapeExplorer ex(anEdge, TopAbs_VERTEX); ex.More(); ex.Next())
        nvertex++;
