...
Standard_EXPORT void FUNKP_KPmakefaces(const TopOpeBRepBuild_Builder& BU, const TopoDS_Shape& Fac1,
                                       const TopTools_ListOfShape& LF2, const TopAbs_State Stfac1,
                                       const TopAbs_State Stfac2, const Standard_Boolean R1, const Standard_Boolean R2,
...
Standard_EXPORT void FUNKP_KPmakefaces(const TopOpeBRepBuild_Builder& BU, const TopoDS_Shape& Fac1,
                                       const TopTools_ListOfShape& LF2, const TopAbs_State Stfac1,
                                       const TopAbs_State /*Stfac2*/, const Standard_Boolean R1,
                                       const Standard_Boolean R2, TopTools_ListOfShape& Lres) {
...
TopoDS_Shape TopOpeBRepBuild_Builder::KPmakeface(const TopoDS_Shape& Fac1, const TopTools_ListOfShape& LF2,
                                                 const TopAbs_State Stfac1, const TopAbs_State /*Stfac2*/,
                                                 const Standard_Boolean R1, const Standard_Boolean R2) {
...
Standard_Boolean TopOpeBRepBuild_Builder::KPiskolesh(const TopoDS_Shape& Sarg, TopTools_ListOfShape& lShsd,
