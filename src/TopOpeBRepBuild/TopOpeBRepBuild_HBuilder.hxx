...
public:
    ...
    Standard_EXPORT void Perform(const Handle(TopOpeBRepDS_HDataStructure) & HDS, const TopoDS_Shape& S1,
    ...
    Standard_EXPORT Standard_Boolean EdgeCurveAncestors(const TopoDS_Shape& E, TopoDS_Shape& F1, TopoDS_Shape& F2,
                                                        Standard_Integer& IC);
    ...
    Standard_EXPORT Standard_Boolean EdgeSectionAncestors(const TopoDS_Shape& E, TopTools_ListOfShape& LF1,
