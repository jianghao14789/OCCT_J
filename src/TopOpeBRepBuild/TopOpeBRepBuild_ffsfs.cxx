...
Standard_EXPORT void FUNBUILD_ANCESTORRANKPREPARE(TopOpeBRepBuild_Builder& B, const TopTools_ListOfShape& LF1,
                                                  const TopTools_ListOfShape& LF2, const TopOpeBRepDS_Config c1,
                                                  const TopOpeBRepDS_Config c2);
Standard_EXPORT void FUNBUILD_ANCESTORRANKGET(TopOpeBRepBuild_Builder& B, const TopoDS_Shape& f, Standard_Boolean& of1,
...
static Standard_Integer FUN_getAncestorFsp(TopOpeBRepBuild_Builder& B, TopOpeBRepTool_ShapeClassifier& SC,
                                           const TopTools_ListOfShape& LF, const TopoDS_Shape& fsp,
                                           Standard_Boolean& p3ddef, gp_Pnt& p3d);
static Standard_Integer FUN_getAncestorFsp(TopOpeBRepBuild_Builder& B, TopOpeBRepTool_ShapeClassifier& SC,
                                           const TopTools_ListOfShape& LF1, const TopTools_ListOfShape& LF2,
                                           const TopoDS_Shape& fsp);
#ifdef OCCT_DEBUG
// static void FUN_getAncestorFsp(const Handle(TopOpeBRepDS_HDataStructure)& HDS,TopOpeBRepTool_ShapeClassifier&
// SC,const TopTools_ListOfShape& LF1,const TopTools_ListOfShape& LF2,const TopTools_ListOfShape& spFOR,
...
static Standard_Integer FUN_getAncestorFsp(TopOpeBRepBuild_Builder& B, TopOpeBRepTool_ShapeClassifier& SC,
    ...
    if (ison1 || unk) ianc1 = FUN_getAncestorFsp(B, SC, LF1, fsp, p3ddef, p3d);
    if (ison1) return ianc1;

    if (ison2 || unk) ianc2 = FUN_getAncestorFsp(B, SC, LF2, fsp, p3ddef, p3d);
...
// purpose  :
//=======================================================================
void TopOpeBRepBuild_Builder::GFillFaceSFS(const TopoDS_Shape& FOR, const TopTools_ListOfShape& LSO2,
                                           const TopOpeBRepBuild_GTopo& Gin, TopOpeBRepBuild_ShellFaceSet& SFS) {
    ...
    if (tosplit && tomerge) {
        ...
        if (makemerge) {
            ...
            if (dodo) {
                ...
                FUNBUILD_ANCESTORRANKPREPARE(*this, LF1, LF2, TopOpeBRepDS_SAMEORIENTED, TopOpeBRepDS_SAMEORIENTED);
                if (hsd) FUN_getAncestorFsp((*this), myShapeClassifier, LF1, LF2, FOR, GLOBAL_SplitAnc); // xpu280598
            ...
            if (dodo) {
                ...
                GLOBAL_revownsplfacori = Standard_True;
                FUNBUILD_ANCESTORRANKPREPARE(*this, LF1, LF2, TopOpeBRepDS_SAMEORIENTED, TopOpeBRepDS_DIFFORIENTED);
                if (hsd) FUN_getAncestorFsp((*this), myShapeClassifier, LF1, LF2, FOR, GLOBAL_SplitAnc); // xpu280598
...
//	Standard_Integer nlfr1 = GLOBAL_lfr1->Extent();
                ...
                TopOpeBRepBuild_FuseFace fufa;
                TopTools_ListOfShape ldum;
                Standard_Integer addinternal = 1; // disparition
