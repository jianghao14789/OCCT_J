...
static TopAbs_State ClassifyEdgeToSolidByOnePoint(const TopoDS_Edge& E, TopOpeBRepTool_ShapeClassifier& SC);
...
// purpose  :
//=======================================================================
void TopOpeBRepBuild_Builder1::PerformShapeWithStates(const TopoDS_Shape& anObj, const TopoDS_Shape& aReference) {
    ...
    for (i = 1; i <= nS; i++) {
        ...
        if (aMapOfShapeWithState.Contains(aShell))
            ...
            TopOpeBRepBuild_Tools::FindStateThroughVertex(aShell, myShapeClassifier, aMapOfShapeWithState,
                                                          theUnkStateVer);
            continue;
        }
            ...
            TopOpeBRepBuild_Tools::PropagateState(aSplFacesState, aFacesToRestMap, TopAbs_EDGE, TopAbs_FACE,
                                                  myShapeClassifier, aMapOfShapeWithState, anUnkStateEdge);
    ...
    for (i = 1; i <= nF; i++) {
        ...
        for (j = 1; j <= nW; j++) {
            ...
            if (!myDataStructure->HasShape(aWire)) {
                ...
                TopOpeBRepBuild_Tools::FindStateThroughVertex(aWire, myShapeClassifier, aMapOfShapeWithState,
                                                              theUnkStateVer);
                continue;
            }
...
void TopOpeBRepBuild_Builder1::StatusEdgesToSplit(const TopoDS_Shape& anObj,
    ...
    if (nE)
        ...
        TopOpeBRepBuild_Tools::PropagateState(aSplEdgesState, anEdgesToRestMap, TopAbs_VERTEX, TopAbs_EDGE,
                                              myShapeClassifier, aMapOfShapeWithState, theUnkStateVer);
}
...
// purpose  :
//=======================================================================
void TopOpeBRepBuild_Builder1::SplitEdge(const TopoDS_Shape& anEdge, TopTools_ListOfShape& aLNew,
                                         TopOpeBRepDS_DataMapOfShapeState& aDataMapOfShapeState) {
