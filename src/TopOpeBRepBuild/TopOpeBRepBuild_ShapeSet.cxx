...
//=======================================================================
const TopTools_ListOfShape& TopOpeBRepBuild_ShapeSet::MakeNeighboursList(const TopoDS_Shape& /*Earg*/,
...
#ifdef OCCT_DEBUG
void TopOpeBRepBuild_ShapeSet::DumpCheck(Standard_OStream& OS, const TCollection_AsciiString& str,
                                         const TopoDS_Shape& S, const Standard_Boolean chk
#else
void TopOpeBRepBuild_ShapeSet::DumpCheck(Standard_OStream&, const TCollection_AsciiString&, const TopoDS_Shape&,
...
void TopOpeBRepBuild_ShapeSet::DumpSS() {
    ...
    if (!MoreStartElements()) std::cout << 0;
    std::cout << std::endl;
...
//=======================================================================
#ifdef DRAW
TCollection_AsciiString TopOpeBRepBuild_ShapeSet::SName(const TopoDS_Shape& /*S*/, const TCollection_AsciiString& sb,
...
#else
TCollection_AsciiString TopOpeBRepBuild_ShapeSet::SName(const TopoDS_Shape&, const TCollection_AsciiString&,
...
//=======================================================================
#ifdef DRAW
TCollection_AsciiString TopOpeBRepBuild_ShapeSet::SNameori(const TopoDS_Shape& S, const TCollection_AsciiString& sb,
                                                           const TCollection_AsciiString& sa) const {
    TCollection_AsciiString str;
    str = sb + SName(S);
...
#else
TCollection_AsciiString TopOpeBRepBuild_ShapeSet::SNameori(const TopoDS_Shape&, const TCollection_AsciiString&,
                                                           const TCollection_AsciiString&) const {
    TCollection_AsciiString str;
    return str;
}
...
#else
TCollection_AsciiString TopOpeBRepBuild_ShapeSet::SName(const TopTools_ListOfShape&, const TCollection_AsciiString&,
                                                        const TCollection_AsciiString&) const {
    TCollection_AsciiString str;
    return str;
}
