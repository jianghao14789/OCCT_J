...
public:
    ...
    Standard_EXPORT TopOpeBRepBuild_GTopo(const Standard_Boolean II, const Standard_Boolean IN,
    ...
    Standard_EXPORT void Set(const Standard_Boolean II, const Standard_Boolean IN, const Standard_Boolean IO,
    ...
    Standard_EXPORT static void DumpSSB(Standard_OStream& OS, const TopAbs_State s1, const TopAbs_State s2,
