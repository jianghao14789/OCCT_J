...
void TopOpeBRepBuild_AreaBuilder::InitAreaBuilder(TopOpeBRepBuild_LoopSet& LS, TopOpeBRepBuild_LoopClassifier& LC,
                                                  const Standard_Boolean ForceClass) {
    TopAbs_State state;
...
void TopOpeBRepBuild_AreaBuilder::REM_Loop_FROM_LISTOFLoop(TopOpeBRepBuild_ListIteratorOfListOfLoop& ITA,
