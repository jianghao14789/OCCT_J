...
Vrml_OrthographicCamera::Vrml_OrthographicCamera() : myFocalDistance(5), myHeight(2) {
...
Vrml_OrthographicCamera::Vrml_OrthographicCamera(const gp_Vec& aPosition, const Vrml_SFRotation& aOrientation,
                                                 const Standard_Real aFocalDistance, const Standard_Real aHeight) {
