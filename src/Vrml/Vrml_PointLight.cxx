...
Vrml_PointLight::Vrml_PointLight()
    : myOnOff(Standard_True), myIntensity(1), myColor(Quantity_NOC_WHITE), myLocation(0, 0, 1) {
    //
}

Vrml_PointLight::Vrml_PointLight(const Standard_Boolean aOnOff, const Standard_Real aIntensity,
                                 const Quantity_Color& aColor, const gp_Vec& aLocation) {
