...
Vrml_DirectionalLight::Vrml_DirectionalLight()
    : myOnOff(Standard_True), myIntensity(1), myColor(Quantity_NOC_WHITE), myDirection(0, 0, -1) {
    //
}

Vrml_DirectionalLight::Vrml_DirectionalLight(const Standard_Boolean aOnOff, const Standard_Real aIntensity,
                                             const Quantity_Color& aColor, const gp_Vec& aDirection) {
    myOnOff = aOnOff;
