...
void RWStepBasic_RWNamedUnit::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                       Handle(Interface_Check) & ach, const Handle(StepBasic_NamedUnit) & ent) const {
...
void RWStepBasic_RWNamedUnit::WriteStep(StepData_StepWriter& SW, const Handle(StepBasic_NamedUnit) & ent) const {
