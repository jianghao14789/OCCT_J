...
void RWStepBasic_RWProductType::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepBasic_RWProductType::WriteStep(StepData_StepWriter& SW, const Handle(StepBasic_ProductType) & ent) const {
