...
void RWStepBasic_RWLengthUnit::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepBasic_RWLengthUnit::WriteStep(StepData_StepWriter& SW, const Handle(StepBasic_LengthUnit) & ent) const {
