...
void RWStepBasic_RWProductDefinitionReferenceWithLocalRepresentation::ReadStep(
    ...
    data->ReadEntity(num, 5, "frame_of_reference", ach, STANDARD_TYPE(StepBasic_ProductDefinitionContext),
                     aFrameOfReference);
...
void RWStepBasic_RWProductDefinitionReferenceWithLocalRepresentation::WriteStep(
    StepData_StepWriter& SW, const Handle(StepBasic_ProductDefinitionReferenceWithLocalRepresentation) & ent) const {
    // Own field : source
    SW.Send(ent->Source());
