...
void RWStepBasic_RWActionMethod::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepBasic_RWActionMethod::WriteStep(StepData_StepWriter& SW, const Handle(StepBasic_ActionMethod) & ent) const {
...
void RWStepBasic_RWActionMethod::Share(const Handle(StepBasic_ActionMethod) &, Interface_EntityIterator&) const {
    // Own fields of ActionMethod
}
