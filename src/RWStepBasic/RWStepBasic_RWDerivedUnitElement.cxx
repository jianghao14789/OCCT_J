...
void RWStepBasic_RWDerivedUnitElement::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepBasic_RWDerivedUnitElement::WriteStep(StepData_StepWriter& SW,
                                                 const Handle(StepBasic_DerivedUnitElement) & ent) const {
