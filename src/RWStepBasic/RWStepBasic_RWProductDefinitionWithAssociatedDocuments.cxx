...
void RWStepBasic_RWProductDefinitionWithAssociatedDocuments::ReadStep(
    ...
    data->ReadEntity(num, 4, "frame_of_reference", ach, STANDARD_TYPE(StepBasic_ProductDefinitionContext),
                     aFrameOfReference);
...
void RWStepBasic_RWProductDefinitionWithAssociatedDocuments::WriteStep(
    StepData_StepWriter& SW, const Handle(StepBasic_ProductDefinitionWithAssociatedDocuments) & ent) const {
...
void RWStepBasic_RWProductDefinitionWithAssociatedDocuments::Share(
    const Handle(StepBasic_ProductDefinitionWithAssociatedDocuments) & ent, Interface_EntityIterator& iter) const {
