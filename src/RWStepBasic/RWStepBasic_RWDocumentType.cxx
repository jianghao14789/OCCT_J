...
void RWStepBasic_RWDocumentType::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepBasic_RWDocumentType::WriteStep(StepData_StepWriter& SW, const Handle(StepBasic_DocumentType) & ent) const {
