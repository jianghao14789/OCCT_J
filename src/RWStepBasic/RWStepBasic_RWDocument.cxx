...
void RWStepBasic_RWDocument::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepBasic_RWDocument::WriteStep(StepData_StepWriter& SW, const Handle(StepBasic_Document) & ent) const {
...
void RWStepBasic_RWDocument::Share(const Handle(StepBasic_Document) & ent, Interface_EntityIterator& iter) const {
