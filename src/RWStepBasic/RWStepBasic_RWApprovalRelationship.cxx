...
void RWStepBasic_RWApprovalRelationship::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepBasic_RWApprovalRelationship::WriteStep(StepData_StepWriter& SW,
                                                   const Handle(StepBasic_ApprovalRelationship) & ent) const {
