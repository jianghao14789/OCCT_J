...
void RWStepBasic_RWProduct::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                     Handle(Interface_Check) & ach, const Handle(StepBasic_Product) & ent) const {
...
void RWStepBasic_RWProduct::WriteStep(StepData_StepWriter& SW, const Handle(StepBasic_Product) & ent) const {
