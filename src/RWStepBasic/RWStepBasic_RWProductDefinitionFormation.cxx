...
void RWStepBasic_RWProductDefinitionFormation::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepBasic_RWProductDefinitionFormation::WriteStep(StepData_StepWriter& SW,
                                                         const Handle(StepBasic_ProductDefinitionFormation) &
                                                             ent) const {
...
void RWStepBasic_RWProductDefinitionFormation::Share(const Handle(StepBasic_ProductDefinitionFormation) & ent,
