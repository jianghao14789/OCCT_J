...
void RWStepBasic_RWDerivedUnit::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepBasic_RWDerivedUnit::WriteStep(StepData_StepWriter& SW, const Handle(StepBasic_DerivedUnit) & ent) const {
