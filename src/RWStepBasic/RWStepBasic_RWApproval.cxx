...
void RWStepBasic_RWApproval::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                      Handle(Interface_Check) & ach, const Handle(StepBasic_Approval) & ent) const {
...
void RWStepBasic_RWApproval::WriteStep(StepData_StepWriter& SW, const Handle(StepBasic_Approval) & ent) const {
