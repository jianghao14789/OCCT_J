...
void RWStepBasic_RWApplicationContextElement::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepBasic_RWApplicationContextElement::WriteStep(StepData_StepWriter& SW,
                                                        const Handle(StepBasic_ApplicationContextElement) & ent) const {
...
void RWStepBasic_RWApplicationContextElement::Share(const Handle(StepBasic_ApplicationContextElement) & ent,
