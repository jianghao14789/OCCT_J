...
void RWStepBasic_RWSecurityClassification::ReadStep(const Handle(StepData_StepReaderData) & data,
    ...
    data->ReadEntity(num, 3, "security_level", ach, STANDARD_TYPE(StepBasic_SecurityClassificationLevel),
                     aSecurityLevel);
...
void RWStepBasic_RWSecurityClassification::WriteStep(StepData_StepWriter& SW,
                                                     const Handle(StepBasic_SecurityClassification) & ent) const {
...
void RWStepBasic_RWSecurityClassification::Share(const Handle(StepBasic_SecurityClassification) & ent,
