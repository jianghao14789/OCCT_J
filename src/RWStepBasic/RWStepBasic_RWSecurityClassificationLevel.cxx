...
void RWStepBasic_RWSecurityClassificationLevel::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepBasic_RWSecurityClassificationLevel::WriteStep(StepData_StepWriter& SW,
                                                          const Handle(StepBasic_SecurityClassificationLevel) &
                                                              ent) const {
