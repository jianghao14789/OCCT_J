...
void RWStepBasic_RWNameAssignment::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepBasic_RWNameAssignment::Share(const Handle(StepBasic_NameAssignment) &, Interface_EntityIterator&) const {
    // Own fields of NameAssignment
}
