...
void RWStepBasic_RWAction::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                    Handle(Interface_Check) & ach, const Handle(StepBasic_Action) & ent) const {
...
void RWStepBasic_RWAction::WriteStep(StepData_StepWriter& SW, const Handle(StepBasic_Action) & ent) const {
...
void RWStepBasic_RWAction::Share(const Handle(StepBasic_Action) & ent, Interface_EntityIterator& iter) const {
