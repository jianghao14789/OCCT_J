...
void RWStepBasic_RWConversionBasedUnitAndVolumeUnit::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                              ...
                                                              const Handle(StepBasic_ConversionBasedUnitAndVolumeUnit) &
                                                                  ent) const {
...
void RWStepBasic_RWConversionBasedUnitAndVolumeUnit::WriteStep(
    StepData_StepWriter& SW, const Handle(StepBasic_ConversionBasedUnitAndVolumeUnit) & ent) const {
...
void RWStepBasic_RWConversionBasedUnitAndVolumeUnit::Share(const Handle(StepBasic_ConversionBasedUnitAndVolumeUnit) &
                                                               ent,
