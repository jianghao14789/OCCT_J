...
void RWStepBasic_RWDocumentRelationship::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepBasic_RWDocumentRelationship::WriteStep(StepData_StepWriter& SW,
                                                   const Handle(StepBasic_DocumentRelationship) & ent) const {
