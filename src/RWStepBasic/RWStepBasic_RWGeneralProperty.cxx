...
void RWStepBasic_RWGeneralProperty::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepBasic_RWGeneralProperty::Share(const Handle(StepBasic_GeneralProperty) &, Interface_EntityIterator&) const {
    // Own fields of GeneralProperty
}
