...
void RWStepBasic_RWApplicationContext::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepBasic_RWApplicationContext::WriteStep(StepData_StepWriter& SW,
                                                 const Handle(StepBasic_ApplicationContext) & ent) const {
