...
void RWStepBasic_RWPersonalAddress::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
    ...
    ent->Init(hasAinternalLocation, aInternalLocation, hasAstreetNumber, aStreetNumber, hasAstreet, aStreet,
              ...
              hasAelectronicMailAddress, aElectronicMailAddress, hasAtelexNumber, aTelexNumber, aPeople, aDescription);
}
