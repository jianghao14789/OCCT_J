...
void RWStepBasic_RWEulerAngles::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepBasic_RWEulerAngles::WriteStep(StepData_StepWriter& SW, const Handle(StepBasic_EulerAngles) & ent) const {
...
void RWStepBasic_RWEulerAngles::Share(const Handle(StepBasic_EulerAngles) &, Interface_EntityIterator&) const {
    // Own fields of EulerAngles
}
