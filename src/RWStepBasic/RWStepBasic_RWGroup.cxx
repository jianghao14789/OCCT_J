...
void RWStepBasic_RWGroup::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepBasic_RWGroup::WriteStep(StepData_StepWriter& SW, const Handle(StepBasic_Group) & ent) const {
