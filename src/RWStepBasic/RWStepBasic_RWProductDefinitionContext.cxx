...
void RWStepBasic_RWProductDefinitionContext::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepBasic_RWProductDefinitionContext::WriteStep(StepData_StepWriter& SW,
                                                       const Handle(StepBasic_ProductDefinitionContext) & ent) const {
...
void RWStepBasic_RWProductDefinitionContext::Share(const Handle(StepBasic_ProductDefinitionContext) & ent,
