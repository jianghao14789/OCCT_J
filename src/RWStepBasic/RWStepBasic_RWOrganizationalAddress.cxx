...
void RWStepBasic_RWOrganizationalAddress::ReadStep(const Handle(StepData_StepReaderData) & data,
    ...
    ent->Init(hasAinternalLocation, aInternalLocation, hasAstreetNumber, aStreetNumber, hasAstreet, aStreet,
              ...
              hasAelectronicMailAddress, aElectronicMailAddress, hasAtelexNumber, aTelexNumber, aOrganizations,
              aDescription);
}

void RWStepBasic_RWOrganizationalAddress::WriteStep(StepData_StepWriter& SW,
                                                    const Handle(StepBasic_OrganizationalAddress) & ent) const {
