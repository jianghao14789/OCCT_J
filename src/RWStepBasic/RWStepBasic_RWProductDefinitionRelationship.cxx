...
void RWStepBasic_RWProductDefinitionRelationship::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                           ...
                                                           const Handle(StepBasic_ProductDefinitionRelationship) &
                                                               ent) const {
    ...
    // Initialize entity
    ent->Init(aId, aName, hasDescription, aDescription, aRelatingProductDefinition, aRelatedProductDefinition);
}
