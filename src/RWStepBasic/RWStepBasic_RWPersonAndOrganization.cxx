...
void RWStepBasic_RWPersonAndOrganization::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepBasic_RWPersonAndOrganization::WriteStep(StepData_StepWriter& SW,
                                                    const Handle(StepBasic_PersonAndOrganization) & ent) const {
