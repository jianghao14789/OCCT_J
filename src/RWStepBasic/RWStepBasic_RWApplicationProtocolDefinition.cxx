...
void RWStepBasic_RWApplicationProtocolDefinition::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepBasic_RWApplicationProtocolDefinition::WriteStep(StepData_StepWriter& SW,
                                                            const Handle(StepBasic_ApplicationProtocolDefinition) &
                                                                ent) const {
...
void RWStepBasic_RWApplicationProtocolDefinition::Share(const Handle(StepBasic_ApplicationProtocolDefinition) & ent,
