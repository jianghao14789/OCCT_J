...
void RWStepBasic_RWDateAndTime::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepBasic_RWDateAndTime::WriteStep(StepData_StepWriter& SW, const Handle(StepBasic_DateAndTime) & ent) const {
