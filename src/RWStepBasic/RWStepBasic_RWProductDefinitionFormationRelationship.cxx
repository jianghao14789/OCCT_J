...
void RWStepBasic_RWProductDefinitionFormationRelationship::ReadStep(
    ...
    data->ReadEntity(num, 4, "relating_product_definition_formation", ach,
                     STANDARD_TYPE(StepBasic_ProductDefinitionFormation), aRelatingProductDefinitionFormation);

    Handle(StepBasic_ProductDefinitionFormation) aRelatedProductDefinitionFormation;
    data->ReadEntity(num, 5, "related_product_definition_formation", ach,
                     STANDARD_TYPE(StepBasic_ProductDefinitionFormation), aRelatedProductDefinitionFormation);

    // Initialize entity
    ent->Init(aId, aName, aDescription, aRelatingProductDefinitionFormation, aRelatedProductDefinitionFormation);
}
...
void RWStepBasic_RWProductDefinitionFormationRelationship::WriteStep(
    StepData_StepWriter& SW, const Handle(StepBasic_ProductDefinitionFormationRelationship) & ent) const {
...
void RWStepBasic_RWProductDefinitionFormationRelationship::Share(
    const Handle(StepBasic_ProductDefinitionFormationRelationship) & ent, Interface_EntityIterator& iter) const {
