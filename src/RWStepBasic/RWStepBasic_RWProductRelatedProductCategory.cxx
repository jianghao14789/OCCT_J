...
void RWStepBasic_RWProductRelatedProductCategory::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                           const Standard_Integer num, Handle(Interface_Check) & ach,
                                                           const Handle(StepBasic_ProductRelatedProductCategory) &
                                                               ent) const {
...
void RWStepBasic_RWProductRelatedProductCategory::WriteStep(StepData_StepWriter& SW,
                                                            const Handle(StepBasic_ProductRelatedProductCategory) &
                                                                ent) const {
...
void RWStepBasic_RWProductRelatedProductCategory::Share(const Handle(StepBasic_ProductRelatedProductCategory) & ent,
