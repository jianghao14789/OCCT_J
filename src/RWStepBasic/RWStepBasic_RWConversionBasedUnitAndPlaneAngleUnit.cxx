...
// sln 09.10.2001. BUC61003. Correction of looking for items of complex entity in case of them  do not saticfy to
// alphabetical order
...
void RWStepBasic_RWConversionBasedUnitAndPlaneAngleUnit::ReadStep(
    ...
    // sln 09.10.2001. BUC61003. Correction of looking for items of complex entity in case of them  do not saticfy to
    // alphabetical order CONVERSION_BASED_UNIT
...
void RWStepBasic_RWConversionBasedUnitAndPlaneAngleUnit::WriteStep(
    StepData_StepWriter& SW, const Handle(StepBasic_ConversionBasedUnitAndPlaneAngleUnit) & ent) const {
...
void RWStepBasic_RWConversionBasedUnitAndPlaneAngleUnit::Share(
    const Handle(StepBasic_ConversionBasedUnitAndPlaneAngleUnit) & ent, Interface_EntityIterator& iter) const {
