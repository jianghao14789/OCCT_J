...
void RWStepBasic_RWOrdinalDate::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepBasic_RWOrdinalDate::WriteStep(StepData_StepWriter& SW, const Handle(StepBasic_OrdinalDate) & ent) const {
