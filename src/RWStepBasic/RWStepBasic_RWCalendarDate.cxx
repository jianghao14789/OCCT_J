...
void RWStepBasic_RWCalendarDate::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepBasic_RWCalendarDate::WriteStep(StepData_StepWriter& SW, const Handle(StepBasic_CalendarDate) & ent) const {
