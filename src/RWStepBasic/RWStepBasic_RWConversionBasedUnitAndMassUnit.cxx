...
void RWStepBasic_RWConversionBasedUnitAndMassUnit::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                            const Standard_Integer num0, Handle(Interface_Check) & ach,
                                                            const Handle(StepBasic_ConversionBasedUnitAndMassUnit) &
                                                                ent) const {
...
void RWStepBasic_RWConversionBasedUnitAndMassUnit::WriteStep(StepData_StepWriter& SW,
                                                             const Handle(StepBasic_ConversionBasedUnitAndMassUnit) &
                                                                 ent) const {
    // --- Instance of plex component ConversionBasedUnit ---
...
void RWStepBasic_RWConversionBasedUnitAndMassUnit::Share(const Handle(StepBasic_ConversionBasedUnitAndMassUnit) & ent,
