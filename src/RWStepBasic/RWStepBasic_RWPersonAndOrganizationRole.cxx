...
void RWStepBasic_RWPersonAndOrganizationRole::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepBasic_RWPersonAndOrganizationRole::WriteStep(StepData_StepWriter& SW,
                                                        const Handle(StepBasic_PersonAndOrganizationRole) & ent) const {
