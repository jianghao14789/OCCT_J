...
void RWStepBasic_RWOrganization::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepBasic_RWOrganization::WriteStep(StepData_StepWriter& SW, const Handle(StepBasic_Organization) & ent) const {
