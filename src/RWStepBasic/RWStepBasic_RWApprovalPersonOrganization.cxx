...
void RWStepBasic_RWApprovalPersonOrganization::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                        const Standard_Integer num, Handle(Interface_Check) & ach,
                                                        const Handle(StepBasic_ApprovalPersonOrganization) &
                                                            ent) const {
...
void RWStepBasic_RWApprovalPersonOrganization::WriteStep(StepData_StepWriter& SW,
                                                         const Handle(StepBasic_ApprovalPersonOrganization) &
                                                             ent) const {
...
void RWStepBasic_RWApprovalPersonOrganization::Share(const Handle(StepBasic_ApprovalPersonOrganization) & ent,
