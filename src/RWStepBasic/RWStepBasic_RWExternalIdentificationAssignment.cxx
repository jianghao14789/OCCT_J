...
void RWStepBasic_RWExternalIdentificationAssignment::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                              ...
                                                              const Handle(StepBasic_ExternalIdentificationAssignment) &
                                                                  ent) const {
...
void RWStepBasic_RWExternalIdentificationAssignment::WriteStep(
    StepData_StepWriter& SW, const Handle(StepBasic_ExternalIdentificationAssignment) & ent) const {
...
void RWStepBasic_RWExternalIdentificationAssignment::Share(const Handle(StepBasic_ExternalIdentificationAssignment) &
                                                               ent,
