...
Contap_ArcFunction::Contap_ArcFunction() : myMean(1.), myType(Contap_ContourStd), myDir(0., 0., 1.), myCosAng(0.0) {}
...
Standard_Boolean Contap_ArcFunction::Values(const Standard_Real U, Standard_Real& F, Standard_Real& D) {
    gp_Pnt2d pt2d;
    gp_Vec2d d2d;
    Standard_Real dfu = 0., dfv = 0.;
    // gp_Vec d1u,d1v,d2u,d2v,d2uv;
...
Standard_Integer Contap_ArcFunction::NbSamples() const {
    return Max(Max(Contap_HContTool::NbSamplesU(mySurf, 0., 0.), Contap_HContTool::NbSamplesV(mySurf, 0., 0.)),
