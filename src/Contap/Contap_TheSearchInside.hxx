...
public:
    ...
    Standard_EXPORT Contap_TheSearchInside(Contap_SurfFunction& F, const Handle(Adaptor3d_Surface) & Surf,
                                           const Handle(Adaptor3d_TopolTool) & T, const Standard_Real Epsilon);

    Standard_EXPORT void Perform(Contap_SurfFunction& F, const Handle(Adaptor3d_Surface) & Surf,
                                 const Handle(Adaptor3d_TopolTool) & T, const Standard_Real Epsilon);
