...
public:
    ...
    Standard_EXPORT static void Swap(const Handle(Media_Frame) & theFrame1, const Handle(Media_Frame) & theFrame2);
...
public:
    ...
    Graphic3d_Vec2i Size() const {
        return Graphic3d_Vec2i(SizeX(), SizeY());
    }
