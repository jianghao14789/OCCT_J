...
Media_PlayerContext::Media_PlayerContext(Media_IFrameQueue* theFrameQueue)
    : myFrameQueue(theFrameQueue), myThread(doThreadWrapper), myWakeEvent(false), myNextEvent(false), myDuration(0.0),
      myToForceRgb(true), myToShutDown(false), mySeekTo(0.0), myPlayEvent(Media_PlayerEvent_NONE) {
    myThread.Run(this);
...
bool Media_PlayerContext::DumpFirstFrame(const TCollection_AsciiString& theSrcVideo,
                                         ...
                                         TCollection_AsciiString& theMediaInfo, int theMaxSize) {
...
// Purpose  :
//================================================================
void Media_PlayerContext::SetInput(const TCollection_AsciiString& theInputPath, Standard_Boolean theToWait) {
    {
...
// Purpose  :
//================================================================
void Media_PlayerContext::PlaybackState(Standard_Boolean& theIsPaused, Standard_Real& theProgress,
...
// Purpose  :
//================================================================
void Media_PlayerContext::PlayPause(Standard_Boolean& theIsPaused, Standard_Real& theProgress,
                                    Standard_Real& theDuration) {
    Standard_Mutex::Sentry aLock(myMutex);
    theProgress = myTimer.ElapsedTime();
    theDuration = myDuration;
...
bool Media_PlayerContext::receiveFrame(const Handle(Media_Frame) & theFrame,
    ...
    if (anOcctFmt != Image_Format_UNKNOWN) {
        ...
        return true;
             ...
             (myFrameTmp->Format() == AV_PIX_FMT_YUV420P || myFrameTmp->Format() == AV_PIX_FMT_YUVJ420P)) {
        Media_Frame::Swap(theFrame, myFrameTmp);
        return true;
    }
#endif
