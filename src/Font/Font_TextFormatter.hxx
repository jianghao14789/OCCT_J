...
public:
    ...
    Standard_DEPRECATED("BottomLeft should be used instead") const NCollection_Vec2<Standard_ShortReal>& TopLeft(
    ...
    //! @param bounding box.
    Standard_EXPORT Standard_Boolean GlyphBoundingBox(const Standard_Integer theIndex, Font_Rect& theBndBox) const;
...
protected: //! @name class auxiliary methods
    ...
    Standard_EXPORT void newLine(const Standard_Integer theLastRect, const Standard_ShortReal theMaxLineWidth);
