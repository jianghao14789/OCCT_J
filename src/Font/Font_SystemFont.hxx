...
public:
    ...
    Standard_EXPORT void SetFontPath(Font_FontAspect theAspect, const TCollection_AsciiString& thePath,
    ...
    const TCollection_AsciiString& FontPathAny(Font_FontAspect theAspect, bool& theToSynthesizeItalic,
    ...
    void SetSingleStrokeFont(Standard_Boolean theIsSingleLine) {
        myIsSingleLine = theIsSingleLine;
    }
