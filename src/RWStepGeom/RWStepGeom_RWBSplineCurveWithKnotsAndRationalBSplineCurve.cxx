...
void RWStepGeom_RWBSplineCurveWithKnotsAndRationalBSplineCurve::ReadStep(
    ...
    if (data->ReadSubList(num, 2, "knots", ach, nsub7)) {
        ...
        for (Standard_Integer i7 = 1; i7 <= nb7; i7++) {
            ...
            if (data->ReadReal(nsub7, i7, "knots", ach, aKnotsItem)) aKnots->SetValue(i7, aKnotsItem);
        }
    }
    ...
    ent->Init(aName, aDegree, aControlPointsList, aCurveForm, aClosedCurve, aSelfIntersect, aKnotMultiplicities, aKnots,
              aKnotSpec, aWeightsData);
}

void RWStepGeom_RWBSplineCurveWithKnotsAndRationalBSplineCurve::WriteStep(
    StepData_StepWriter& SW, const Handle(StepGeom_BSplineCurveWithKnotsAndRationalBSplineCurve) & ent) const {
...
void RWStepGeom_RWBSplineCurveWithKnotsAndRationalBSplineCurve::Share(
    const Handle(StepGeom_BSplineCurveWithKnotsAndRationalBSplineCurve) & ent, Interface_EntityIterator& iter) const {
...
void RWStepGeom_RWBSplineCurveWithKnotsAndRationalBSplineCurve::Check(
    const Handle(StepGeom_BSplineCurveWithKnotsAndRationalBSplineCurve) & ent, const Interface_ShareTool& aShto,
