...
void RWStepGeom_RWBoundaryCurve::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepGeom_RWBoundaryCurve::WriteStep(StepData_StepWriter& SW, const Handle(StepGeom_BoundaryCurve) & ent) const {
