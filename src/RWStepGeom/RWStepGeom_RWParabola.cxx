...
void RWStepGeom_RWParabola::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                     Handle(Interface_Check) & ach, const Handle(StepGeom_Parabola) & ent) const {
...
void RWStepGeom_RWParabola::WriteStep(StepData_StepWriter& SW, const Handle(StepGeom_Parabola) & ent) const {
