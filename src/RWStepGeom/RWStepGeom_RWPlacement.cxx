...
void RWStepGeom_RWPlacement::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                      Handle(Interface_Check) & ach, const Handle(StepGeom_Placement) & ent) const {
...
void RWStepGeom_RWPlacement::WriteStep(StepData_StepWriter& SW, const Handle(StepGeom_Placement) & ent) const {
