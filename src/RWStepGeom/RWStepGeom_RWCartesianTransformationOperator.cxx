...
void RWStepGeom_RWCartesianTransformationOperator::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                            const Standard_Integer num, Handle(Interface_Check) & ach,
                                                            const Handle(StepGeom_CartesianTransformationOperator) &
                                                                ent) const {
...
void RWStepGeom_RWCartesianTransformationOperator::WriteStep(StepData_StepWriter& SW,
                                                             const Handle(StepGeom_CartesianTransformationOperator) &
                                                                 ent) const {
...
void RWStepGeom_RWCartesianTransformationOperator::Share(const Handle(StepGeom_CartesianTransformationOperator) & ent,
