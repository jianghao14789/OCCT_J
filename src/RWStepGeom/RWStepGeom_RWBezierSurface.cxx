...
void RWStepGeom_RWBezierSurface::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepGeom_RWBezierSurface::WriteStep(StepData_StepWriter& SW, const Handle(StepGeom_BezierSurface) & ent) const {
