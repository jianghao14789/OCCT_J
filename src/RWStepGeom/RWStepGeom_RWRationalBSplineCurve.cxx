...
void RWStepGeom_RWRationalBSplineCurve::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepGeom_RWRationalBSplineCurve::WriteStep(StepData_StepWriter& SW,
                                                  const Handle(StepGeom_RationalBSplineCurve) & ent) const {
