...
void RWStepGeom_RWPointOnCurve::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepGeom_RWPointOnCurve::WriteStep(StepData_StepWriter& SW, const Handle(StepGeom_PointOnCurve) & ent) const {
