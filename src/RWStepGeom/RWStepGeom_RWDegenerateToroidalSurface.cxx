...
void RWStepGeom_RWDegenerateToroidalSurface::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepGeom_RWDegenerateToroidalSurface::WriteStep(StepData_StepWriter& SW,
                                                       const Handle(StepGeom_DegenerateToroidalSurface) & ent) const {
...
void RWStepGeom_RWDegenerateToroidalSurface::Share(const Handle(StepGeom_DegenerateToroidalSurface) & ent,
