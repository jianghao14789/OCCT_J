...
void RWStepGeom_RWUniformCurveAndRationalBSplineCurve::WriteStep(
    StepData_StepWriter& SW, const Handle(StepGeom_UniformCurveAndRationalBSplineCurve) & ent) const {
...
void RWStepGeom_RWUniformCurveAndRationalBSplineCurve::Share(
    const Handle(StepGeom_UniformCurveAndRationalBSplineCurve) & ent, Interface_EntityIterator& iter) const {
