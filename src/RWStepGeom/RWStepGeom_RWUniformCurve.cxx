...
void RWStepGeom_RWUniformCurve::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepGeom_RWUniformCurve::WriteStep(StepData_StepWriter& SW, const Handle(StepGeom_UniformCurve) & ent) const {
