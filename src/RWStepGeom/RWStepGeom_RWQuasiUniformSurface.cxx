...
void RWStepGeom_RWQuasiUniformSurface::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepGeom_RWQuasiUniformSurface::WriteStep(StepData_StepWriter& SW,
                                                 const Handle(StepGeom_QuasiUniformSurface) & ent) const {
