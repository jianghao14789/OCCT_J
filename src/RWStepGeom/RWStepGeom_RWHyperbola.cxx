...
void RWStepGeom_RWHyperbola::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                      Handle(Interface_Check) & ach, const Handle(StepGeom_Hyperbola) & ent) const {
...
void RWStepGeom_RWHyperbola::WriteStep(StepData_StepWriter& SW, const Handle(StepGeom_Hyperbola) & ent) const {
