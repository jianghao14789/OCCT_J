...
void RWStepGeom_RWCircle::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepGeom_RWCircle::WriteStep(StepData_StepWriter& SW, const Handle(StepGeom_Circle) & ent) const {
