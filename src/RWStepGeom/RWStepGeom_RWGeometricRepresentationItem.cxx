...
void RWStepGeom_RWGeometricRepresentationItem::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                        const Standard_Integer num, Handle(Interface_Check) & ach,
                                                        const Handle(StepGeom_GeometricRepresentationItem) &
                                                            ent) const {
...
void RWStepGeom_RWGeometricRepresentationItem::WriteStep(StepData_StepWriter& SW,
                                                         const Handle(StepGeom_GeometricRepresentationItem) &
                                                             ent) const {
