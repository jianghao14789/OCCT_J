...
void RWStepGeom_RWBezierSurfaceAndRationalBSplineSurface::WriteStep(
    StepData_StepWriter& SW, const Handle(StepGeom_BezierSurfaceAndRationalBSplineSurface) & ent) const {
...
void RWStepGeom_RWBezierSurfaceAndRationalBSplineSurface::Share(
    const Handle(StepGeom_BezierSurfaceAndRationalBSplineSurface) & ent, Interface_EntityIterator& iter) const {
