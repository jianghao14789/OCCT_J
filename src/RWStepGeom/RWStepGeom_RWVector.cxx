...
void RWStepGeom_RWVector::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepGeom_RWVector::WriteStep(StepData_StepWriter& SW, const Handle(StepGeom_Vector) & ent) const {
...
void RWStepGeom_RWVector::Check(const Handle(StepGeom_Vector) & ent, const Interface_ShareTool&,
