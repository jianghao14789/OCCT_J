...
void RWStepGeom_RWRectangularTrimmedSurface::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepGeom_RWRectangularTrimmedSurface::WriteStep(StepData_StepWriter& SW,
                                                       const Handle(StepGeom_RectangularTrimmedSurface) & ent) const {
...
void RWStepGeom_RWRectangularTrimmedSurface::Share(const Handle(StepGeom_RectangularTrimmedSurface) & ent,
