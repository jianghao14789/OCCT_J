...
void RWStepGeom_RWUniformSurfaceAndRationalBSplineSurface::WriteStep(
    StepData_StepWriter& SW, const Handle(StepGeom_UniformSurfaceAndRationalBSplineSurface) & ent) const {
...
void RWStepGeom_RWUniformSurfaceAndRationalBSplineSurface::Share(
    const Handle(StepGeom_UniformSurfaceAndRationalBSplineSurface) & ent, Interface_EntityIterator& iter) const {
