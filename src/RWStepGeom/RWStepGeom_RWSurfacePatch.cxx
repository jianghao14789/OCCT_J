...
void RWStepGeom_RWSurfacePatch::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepGeom_RWSurfacePatch::WriteStep(StepData_StepWriter& SW, const Handle(StepGeom_SurfacePatch) & ent) const {
