...
void RWStepGeom_RWSweptSurface::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepGeom_RWSweptSurface::WriteStep(StepData_StepWriter& SW, const Handle(StepGeom_SweptSurface) & ent) const {
