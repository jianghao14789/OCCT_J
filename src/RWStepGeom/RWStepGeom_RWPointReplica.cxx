...
void RWStepGeom_RWPointReplica::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepGeom_RWPointReplica::WriteStep(StepData_StepWriter& SW, const Handle(StepGeom_PointReplica) & ent) const {
