...
void RWStepGeom_RWBezierCurve::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                        Handle(Interface_Check) & ach, const Handle(StepGeom_BezierCurve) & ent) const {
...
void RWStepGeom_RWBezierCurve::WriteStep(StepData_StepWriter& SW, const Handle(StepGeom_BezierCurve) & ent) const {
