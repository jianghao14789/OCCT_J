...
void RWStepGeom_RWQuasiUniformCurveAndRationalBSplineCurve::WriteStep(
    StepData_StepWriter& SW, const Handle(StepGeom_QuasiUniformCurveAndRationalBSplineCurve) & ent) const {
...
void RWStepGeom_RWQuasiUniformCurveAndRationalBSplineCurve::Share(
    const Handle(StepGeom_QuasiUniformCurveAndRationalBSplineCurve) & ent, Interface_EntityIterator& iter) const {
