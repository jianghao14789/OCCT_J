...
public:
    ...
    Standard_EXPORT void Share(const Handle(StepGeom_RationalBSplineSurface) & ent,
                               Interface_EntityIterator& iter) const;

    Standard_EXPORT void Check(const Handle(StepGeom_RationalBSplineSurface) & ent, const Interface_ShareTool& shares,
