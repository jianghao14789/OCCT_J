...
void RWStepGeom_RWBSplineCurveWithKnots::ReadStep(const Handle(StepData_StepReaderData) & data,
    ...
    if (data->ReadSubList(num, 3, "control_points_list", ach, nsub3)) {
        ...
        if (nb3 < 1)
            ...
            for (Standard_Integer i3 = 1; i3 <= nb3; i3++) {
                ...
                if (data->ReadEntity(nsub3, i3, "cartesian_point", ach, STANDARD_TYPE(StepGeom_CartesianPoint), anent3))
    ...
    if (data->ReadSubList(num, 8, "knots", ach, nsub8)) {
        ...
        for (Standard_Integer i8 = 1; i8 <= nb8; i8++) {
            ...
            if (data->ReadReal(nsub8, i8, "knots", ach, aKnotsItem)) aKnots->SetValue(i8, aKnotsItem);
        }
    }
...
void RWStepGeom_RWBSplineCurveWithKnots::WriteStep(StepData_StepWriter& SW,
                                                   const Handle(StepGeom_BSplineCurveWithKnots) & ent) const {
