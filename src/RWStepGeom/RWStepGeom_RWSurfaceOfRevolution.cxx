...
void RWStepGeom_RWSurfaceOfRevolution::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepGeom_RWSurfaceOfRevolution::WriteStep(StepData_StepWriter& SW,
                                                 const Handle(StepGeom_SurfaceOfRevolution) & ent) const {
