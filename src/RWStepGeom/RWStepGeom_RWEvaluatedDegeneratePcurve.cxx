...
void RWStepGeom_RWEvaluatedDegeneratePcurve::ReadStep(const Handle(StepData_StepReaderData) & data,
    ...
    data->ReadEntity(num, 3, "reference_to_curve", ach, STANDARD_TYPE(StepRepr_DefinitionalRepresentation),
                     aReferenceToCurve);
...
void RWStepGeom_RWEvaluatedDegeneratePcurve::WriteStep(StepData_StepWriter& SW,
                                                       const Handle(StepGeom_EvaluatedDegeneratePcurve) & ent) const {
...
void RWStepGeom_RWEvaluatedDegeneratePcurve::Share(const Handle(StepGeom_EvaluatedDegeneratePcurve) & ent,
