...
void RWStepGeom_RWQuasiUniformSurfaceAndRationalBSplineSurface::WriteStep(
    StepData_StepWriter& SW, const Handle(StepGeom_QuasiUniformSurfaceAndRationalBSplineSurface) & ent) const {
...
void RWStepGeom_RWQuasiUniformSurfaceAndRationalBSplineSurface::Share(
    const Handle(StepGeom_QuasiUniformSurfaceAndRationalBSplineSurface) & ent, Interface_EntityIterator& iter) const {
