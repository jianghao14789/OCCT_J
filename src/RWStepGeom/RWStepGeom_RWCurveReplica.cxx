...
void RWStepGeom_RWCurveReplica::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
    ...
    data->ReadEntity(num, 3, "transformation", ach, STANDARD_TYPE(StepGeom_CartesianTransformationOperator),
                     aTransformation);
...
void RWStepGeom_RWCurveReplica::WriteStep(StepData_StepWriter& SW, const Handle(StepGeom_CurveReplica) & ent) const {
