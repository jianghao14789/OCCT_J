...
void RWStepGeom_RWTrimmedCurve::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
    ...
    if (data->ReadSubList(num, 3, "trim_1", ach, nsub3)) {
        ...
        for (Standard_Integer i3 = 1; i3 <= nb3; i3++) {
            ...
            if (data->ReadEntity(nsub3, i3, "trim_1", ach, aTrim1Item)) aTrim1->SetValue(i3, aTrim1Item);
        }
    }
    ...
    if (data->ReadSubList(num, 4, "trim_2", ach, nsub4)) {
        ...
        for (Standard_Integer i4 = 1; i4 <= nb4; i4++) {
            ...
            if (data->ReadEntity(nsub4, i4, "trim_2", ach, aTrim2Item)) aTrim2->SetValue(i4, aTrim2Item);
        }
    }
...
void RWStepGeom_RWTrimmedCurve::WriteStep(StepData_StepWriter& SW, const Handle(StepGeom_TrimmedCurve) & ent) const {
