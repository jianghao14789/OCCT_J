...
void RWStepGeom_RWCylindricalSurface::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepGeom_RWCylindricalSurface::WriteStep(StepData_StepWriter& SW,
                                                const Handle(StepGeom_CylindricalSurface) & ent) const {
