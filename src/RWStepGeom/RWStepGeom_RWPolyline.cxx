...
void RWStepGeom_RWPolyline::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                     Handle(Interface_Check) & ach, const Handle(StepGeom_Polyline) & ent) const {
...
void RWStepGeom_RWPolyline::WriteStep(StepData_StepWriter& SW, const Handle(StepGeom_Polyline) & ent) const {
