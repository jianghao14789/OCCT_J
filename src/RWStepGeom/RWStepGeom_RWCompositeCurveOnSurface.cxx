...
void RWStepGeom_RWCompositeCurveOnSurface::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepGeom_RWCompositeCurveOnSurface::WriteStep(StepData_StepWriter& SW,
                                                     const Handle(StepGeom_CompositeCurveOnSurface) & ent) const {
...
void RWStepGeom_RWCompositeCurveOnSurface::Share(const Handle(StepGeom_CompositeCurveOnSurface) & ent,
