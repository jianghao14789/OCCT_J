...
void RWStepGeom_RWRationalBSplineSurface::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepGeom_RWRationalBSplineSurface::WriteStep(StepData_StepWriter& SW,
                                                    const Handle(StepGeom_RationalBSplineSurface) & ent) const {
