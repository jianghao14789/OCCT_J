...
void RWStepGeom_RWBSplineCurve::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepGeom_RWBSplineCurve::WriteStep(StepData_StepWriter& SW, const Handle(StepGeom_BSplineCurve) & ent) const {
