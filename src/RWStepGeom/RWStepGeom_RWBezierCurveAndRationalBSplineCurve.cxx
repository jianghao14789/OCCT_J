...
void RWStepGeom_RWBezierCurveAndRationalBSplineCurve::WriteStep(
    StepData_StepWriter& SW, const Handle(StepGeom_BezierCurveAndRationalBSplineCurve) & ent) const {
...
void RWStepGeom_RWBezierCurveAndRationalBSplineCurve::Share(const Handle(StepGeom_BezierCurveAndRationalBSplineCurve) &
                                                                ent,
