...
void RWStepGeom_RWSeamCurve::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                      Handle(Interface_Check) & ach, const Handle(StepGeom_SeamCurve) & ent) const {
...
void RWStepGeom_RWSeamCurve::WriteStep(StepData_StepWriter& SW, const Handle(StepGeom_SeamCurve) & ent) const {
