...
void RWStepGeom_RWOffsetSurface::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepGeom_RWOffsetSurface::WriteStep(StepData_StepWriter& SW, const Handle(StepGeom_OffsetSurface) & ent) const {
