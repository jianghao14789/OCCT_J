...
void RWStepGeom_RWDirection::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepGeom_RWDirection::WriteStep(StepData_StepWriter& SW, const Handle(StepGeom_Direction) & ent) const {
...
void RWStepGeom_RWDirection::Check(const Handle(StepGeom_Direction) & ent, const Interface_ShareTool&,
