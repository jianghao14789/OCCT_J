...
void RWStepGeom_RWPcurve::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                   Handle(Interface_Check) & ach, const Handle(StepGeom_Pcurve) & ent) const {
...
void RWStepGeom_RWPcurve::WriteStep(StepData_StepWriter& SW, const Handle(StepGeom_Pcurve) & ent) const {
