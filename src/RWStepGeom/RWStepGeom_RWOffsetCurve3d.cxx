...
void RWStepGeom_RWOffsetCurve3d::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepGeom_RWOffsetCurve3d::WriteStep(StepData_StepWriter& SW, const Handle(StepGeom_OffsetCurve3d) & ent) const {
