...
public:
    ...
    Standard_EXPORT static Standard_Real Length(const Adaptor3d_Curve& C, const Standard_Real U1,
                                                const Standard_Real U2);

    //! Computes the length of the Curve <C> between <U1> and <U2>.
    Standard_EXPORT static Standard_Real Length(const Adaptor2d_Curve2d& C, const Standard_Real U1,
                                                const Standard_Real U2);
    ...
    Standard_EXPORT CPnts_AbscissaPoint(const Adaptor3d_Curve& C, const Standard_Real Abscissa, const Standard_Real U0,
    ...
    //! <Resolution> is the error allowed in the computation.
    //! The computed point can be outside of the curve 's bounds.
    Standard_EXPORT CPnts_AbscissaPoint(const Adaptor2d_Curve2d& C, const Standard_Real Abscissa,
    ...
    //! The computed point can be outside of the curve 's bounds.
    Standard_EXPORT CPnts_AbscissaPoint(const Adaptor2d_Curve2d& C, const Standard_Real Abscissa,
                                        const Standard_Real U0, const Standard_Real Ui, const Standard_Real Resolution);
    ...
    Standard_EXPORT void Perform(const Standard_Real Abscissa, const Standard_Real U0, const Standard_Real Ui,
                                 const Standard_Real Resolution);
    ...
    //! is measured and Ui is the starting value for the iterative
    //! process (should be close to the final solution).
    Standard_EXPORT void AdvPerform(const Standard_Real Abscissa, const Standard_Real U0, const Standard_Real Ui,
                                    const Standard_Real Resolution);
