...
static inline void D23d(const Standard_Address C, const Standard_Real U, gp_Pnt& P, gp_Vec& V1, gp_Vec& V2) {
    ((Adaptor3d_Curve*)C)->D2(U, P, V1, V2);
}

static void D22d(const Standard_Address C, const Standard_Real U, gp_Pnt& PP, gp_Vec& VV1, gp_Vec& VV2) {
    gp_Pnt2d P;
    gp_Vec2d V1, V2;
        ...
        if (myControl && (myNbPoints == 1)) {
            ...
            if (myLastParam - Un1 < 0.33 * (myLastParam - myFirstParam)) {
                ...
                if (NormD1 < myDeflection) {
                    ...
                    if ((VV.CrossMagnitude(gp_Vec(P2, P)) / NormD1 < myDeflection) && (Un1 >= myLastParam - myDwmax)) {
                        // point n is removed
                        myParams[1] = myLastParam;
                        myPoints[1] = P1;
                    } else {
...
CPnts_UniformDeflection::CPnts_UniformDeflection()
    : myDone(Standard_False), my3d(Standard_False), myFinish(Standard_False), myTolCur(0.0), myControl(Standard_False),
      myIPoint(0), myNbPoints(0), myDwmax(0.0), myDeflection(0.0), myFirstParam(0.0), myLastParam(0.0), myDu(0.0) {
...
CPnts_UniformDeflection::CPnts_UniformDeflection(const Adaptor3d_Curve& C, const Standard_Real Deflection,
                                                 const Standard_Real Resolution, const Standard_Boolean WithControl) {
...
CPnts_UniformDeflection::CPnts_UniformDeflection(const Adaptor2d_Curve2d& C, const Standard_Real Deflection,
                                                 const Standard_Real Resolution, const Standard_Boolean WithControl) {
    Initialize(C, Deflection, Resolution, WithControl);
}
...
void CPnts_UniformDeflection::Initialize(const Adaptor3d_Curve& C, const Standard_Real Deflection,
                                         const Standard_Real Resolution, const Standard_Boolean WithControl) {
...
void CPnts_UniformDeflection::Initialize(const Adaptor2d_Curve2d& C, const Standard_Real Deflection,
                                         const Standard_Real Resolution, const Standard_Boolean WithControl) {
    Initialize(C, Deflection, C.FirstParameter(), C.LastParameter(), Resolution, WithControl);
}
...
void CPnts_UniformDeflection::Initialize(const Adaptor3d_Curve& C, const Standard_Real Deflection,
                                         const Standard_Real U1, const Standard_Real U2, const Standard_Real Resolution,
