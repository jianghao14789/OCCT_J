...
public:
    ...
    TopoDS_Shape(T2&& theOther,
        ...
        : myTShape(std::forward<T2>(theOther).myTShape), myLocation(std::forward<T2>(theOther).myLocation),
    ...
    void Modified(Standard_Boolean theIsModified) {
        myTShape->Modified(theIsModified);
    }
    ...
    void Orientable(const Standard_Boolean theIsOrientable) {
        myTShape->Orientable(theIsOrientable);
    }
    ...
    void Infinite(Standard_Boolean theIsInfinite) {
        myTShape->Infinite(theIsInfinite);
    }
    ...
    Standard_Integer NbChildren() const {
        return myTShape.IsNull() ? 0 : myTShape->NbChildren();
    }
    ...
    Standard_Boolean IsEqual(const TopoDS_Shape& theOther) const {
        return myTShape == theOther.myTShape && myLocation == theOther.myLocation && myOrient == theOther.myOrient;
    }
