...
// purpose  :
//=======================================================================
TopoDS_AlertAttribute::TopoDS_AlertAttribute(const TopoDS_Shape& theShape, const TCollection_AsciiString& theName)
...
// purpose  :
//=======================================================================
void TopoDS_AlertAttribute::Send(const Handle(Message_Messenger) & theMessenger, const TopoDS_Shape& theShape) {
    for (Message_SequenceOfPrinters::Iterator aPrinterIter(theMessenger->Printers()); aPrinterIter.More();
         aPrinterIter.Next()) {
