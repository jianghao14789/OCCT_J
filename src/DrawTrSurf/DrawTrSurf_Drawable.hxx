...
public:
    ...
    Standard_EXPORT void DrawIsoCurveOn(Adaptor3d_IsoCurve& C, const GeomAbs_IsoType T, const Standard_Real P,
                                        const Standard_Real F, const Standard_Real L, Draw_Display& D) const;
...
protected:
    ...
    Standard_EXPORT DrawTrSurf_Drawable(const Standard_Integer discret, const Standard_Real deflection = 0.01,
