...
DrawTrSurf_Drawable::DrawTrSurf_Drawable(
    ...
    : myDrawMode(DrawMode), myDiscret(discret), myDeflection(deflection) {}
...
//=======================================================================
static void PlotCurve(Draw_Display& aDisplay, const Adaptor3d_Curve& C, Standard_Real& theFirstParam,
                      Standard_Real theHalfStep, const gp_Pnt& theFirstPnt, const gp_Pnt& theLastPnt) {
...
void DrawTrSurf_Drawable::DrawIsoCurveOn(Adaptor3d_IsoCurve& C, const GeomAbs_IsoType T, const Standard_Real P,
                                         const Standard_Real F, const Standard_Real L, Draw_Display& dis) const {
    C.Load(T, P, F, L);
