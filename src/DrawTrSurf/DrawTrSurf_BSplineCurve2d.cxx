...
void DrawTrSurf_BSplineCurve2d::DrawOn(Draw_Display& dis) const {
    ...
    if (drawPoles) {
        ...
        if (C->IsPeriodic()) dis.DrawTo(CPoles(1));
    }
...
void DrawTrSurf_BSplineCurve2d::FindPole(const Standard_Real X, const Standard_Real Y, const Draw_Display& D,
...
void DrawTrSurf_BSplineCurve2d::FindKnot(const Standard_Real X, const Standard_Real Y, const Draw_Display& D,
...
Handle(Draw_Drawable3D) DrawTrSurf_BSplineCurve2d::Copy() const {
    Handle(DrawTrSurf_BSplineCurve2d) DC =
        new DrawTrSurf_BSplineCurve2d(Handle(Geom2d_BSplineCurve)::DownCast(curv->Copy()), look, polesLook, knotsLook,
                                      knotsForm, knotsDim, drawPoles, drawKnots, GetDiscretisation());
...
Handle(Draw_Drawable3D) DrawTrSurf_BSplineCurve2d::Restore(Standard_IStream& theStream) {
    ...
    Handle(DrawTrSurf_BSplineCurve2d) aDrawCurve = new DrawTrSurf_BSplineCurve2d(
