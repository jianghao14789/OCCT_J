...
static Handle(DrawTrSurf_Drawable) GetDrawable(Standard_CString& Name) {
    ...
    if (!D.IsNull()) Dr = Handle(DrawTrSurf_Drawable)::DownCast(D);
    return Dr;
}
...
static Handle(DrawTrSurf_Surface) GetSurface(Standard_CString& Name) {
    ...
    if (!D.IsNull()) Dr = Handle(DrawTrSurf_Surface)::DownCast(D);
    return Dr;
}
...
static Handle(DrawTrSurf_BezierSurface) GetBezierSurface(Standard_CString& Name) {
    ...
    if (!D.IsNull()) Dr = Handle(DrawTrSurf_BezierSurface)::DownCast(D);
    return Dr;
}
...
static Handle(DrawTrSurf_BSplineSurface) GetBSplineSurface(Standard_CString& Name) {
    ...
    if (!D.IsNull()) Dr = Handle(DrawTrSurf_BSplineSurface)::DownCast(D);
    return Dr;
}
...
static Handle(DrawTrSurf_BezierCurve) GetBezierCurve(Standard_CString& Name) {
    ...
    if (!D.IsNull()) Dr = Handle(DrawTrSurf_BezierCurve)::DownCast(D);
    return Dr;
}
...
static Handle(DrawTrSurf_BSplineCurve) GetBSplineCurve(Standard_CString& Name) {
    ...
    if (!D.IsNull()) Dr = Handle(DrawTrSurf_BSplineCurve)::DownCast(D);
    return Dr;
}
...
static Handle(DrawTrSurf_BezierCurve2d) GetBezierCurve2d(Standard_CString& Name) {
    ...
    if (!D.IsNull()) Dr = Handle(DrawTrSurf_BezierCurve2d)::DownCast(D);
    return Dr;
}
...
static Handle(DrawTrSurf_BSplineCurve2d) GetBSplineCurve2d(Standard_CString& Name) {
    ...
    if (!D.IsNull()) Dr = Handle(DrawTrSurf_BSplineCurve2d)::DownCast(D);
    return Dr;
}
...
//=======================================================================
void DrawTrSurf::Set(const Standard_CString theName, const Handle(Geom_Geometry) & theGeometry,
    ...
    if (Handle(Geom_BezierCurve) aGeomBezierCurve = Handle(Geom_BezierCurve)::DownCast(theGeometry)) {
        aDrawable =
            new DrawTrSurf_BezierCurve(aGeomBezierCurve, aParams.CurvColor, aParams.PolesColor, aParams.IsShowPoles,
        ...
        aDrawable =
            new DrawTrSurf_BSplineCurve(aGeomBSplineCurve, aParams.CurvColor, aParams.PolesColor, aParams.KnotsColor,
                                        aParams.KnotsMarker, aParams.KnotsSize, aParams.IsShowPoles,
                                        aParams.IsShowKnots, aParams.Discret, aParams.Deflection, aParams.DrawMode);
    } else if (Handle(Geom_Curve) aCurve = Handle(Geom_Curve)::DownCast(theGeometry)) {
        aDrawable = new DrawTrSurf_Curve(aCurve, aParams.CurvColor, aParams.Discret, aParams.Deflection,
                                         aParams.DrawMode, isSenseMarker);
    } else if (Handle(Geom_BezierSurface) aBezSurf = Handle(Geom_BezierSurface)::DownCast(theGeometry)) {
        aDrawable = new DrawTrSurf_BezierSurface(aBezSurf, aParams.NbUIsos, aParams.NbVIsos, aParams.BoundsColor,
                                                 aParams.IsosColor, aParams.PolesColor, aParams.IsShowPoles,
                                                 aParams.Discret, aParams.Deflection, aParams.DrawMode);
    } else if (Handle(Geom_BSplineSurface) aBSplineSurf = Handle(Geom_BSplineSurface)::DownCast(theGeometry)) {
        if (!aParams.NeedKnotsIsos) {
            aDrawable = new DrawTrSurf_BSplineSurface(
                aBSplineSurf, aParams.NbUIsos, aParams.NbVIsos, aParams.BoundsColor, aParams.IsosColor,
                aParams.PolesColor, aParams.KnotsColor, aParams.KnotsMarker, aParams.KnotsSize, aParams.IsShowPoles,
                aParams.IsShowKnots, aParams.Discret, aParams.Deflection, aParams.DrawMode);
        } else {
            aDrawable = new DrawTrSurf_BSplineSurface(aBSplineSurf, aParams.BoundsColor, aParams.IsosColor,
                                                      aParams.PolesColor, aParams.KnotsColor, aParams.KnotsMarker,
                                                      aParams.KnotsSize, aParams.IsShowPoles, aParams.IsShowKnots,
                                                      aParams.Discret, aParams.Deflection, aParams.DrawMode);
        }
    } else if (Handle(Geom_Surface) aSurface = Handle(Geom_Surface)::DownCast(theGeometry)) {
        aDrawable = new DrawTrSurf_Surface(aSurface, aParams.NbUIsos, aParams.NbVIsos, aParams.BoundsColor,
                                           aParams.IsosColor, aParams.Discret, aParams.Deflection, aParams.DrawMode);
    }
...
//=======================================================================
void DrawTrSurf::Set(const Standard_CString theName, const Handle(Geom2d_Curve) & theCurve,
                     const Standard_Boolean isSenseMarker) {
    DrawTrSurf_Params& aParams = DrawTrSurf::Parameters();
    Handle(DrawTrSurf_Drawable) aDrawable;
    if (Handle(Geom2d_BezierCurve) aBezierCurve = Handle(Geom2d_BezierCurve)::DownCast(theCurve)) {
        aDrawable = new DrawTrSurf_BezierCurve2d(aBezierCurve, aParams.CurvColor, aParams.PolesColor,
        ...
        aDrawable = new DrawTrSurf_BSplineCurve2d(aBSplineCurve, aParams.CurvColor, aParams.PolesColor,
                                                  aParams.KnotsColor, aParams.KnotsMarker, aParams.KnotsSize,
...
Handle(Geom_BSplineSurface) DrawTrSurf::GetBSplineSurface(Standard_CString& Name) {
    Handle(DrawTrSurf_BSplineSurface) D = Handle(DrawTrSurf_BSplineSurface)::DownCast(Draw::Get(Name));
    if (D.IsNull())
...
static Draw_Color recognizeColor(const char* theColorStr, const Draw_Color& theDefaultColor) {
    ...
    if (!strcasecmp(theColorStr, "white")) aResult = Draw_blanc;
    if (!strcasecmp(theColorStr, "red")) aResult = Draw_rouge;
    if (!strcasecmp(theColorStr, "green")) aResult = Draw_vert;
    if (!strcasecmp(theColorStr, "blue")) aResult = Draw_bleu;
    if (!strcasecmp(theColorStr, "cyan")) aResult = Draw_cyan;
    if (!strcasecmp(theColorStr, "golden")) aResult = Draw_or;
    if (!strcasecmp(theColorStr, "magenta")) aResult = Draw_magenta;
    if (!strcasecmp(theColorStr, "brown")) aResult = Draw_marron;
    if (!strcasecmp(theColorStr, "orange")) aResult = Draw_orange;
    if (!strcasecmp(theColorStr, "pink")) aResult = Draw_rose;
    if (!strcasecmp(theColorStr, "salmon")) aResult = Draw_saumon;
    if (!strcasecmp(theColorStr, "violet")) aResult = Draw_violet;
    if (!strcasecmp(theColorStr, "yellow")) aResult = Draw_jaune;
    if (!strcasecmp(theColorStr, "darkgreen")) aResult = Draw_kaki;
    if (!strcasecmp(theColorStr, "coral")) aResult = Draw_corail;
...
static Draw_MarkerShape recognizeMarker(const char* theMarkerStr, const Draw_MarkerShape& theDefaultMarker) {
    Draw_MarkerShape aResult = theDefaultMarker;

    if (!strcasecmp(theMarkerStr, "square")) aResult = Draw_Square;
    if (!strcasecmp(theMarkerStr, "diamond")) aResult = Draw_Losange;
    if (!strcasecmp(theMarkerStr, "x")) aResult = Draw_X;
    if (!strcasecmp(theMarkerStr, "plus")) aResult = Draw_Plus;
    if (!strcasecmp(theMarkerStr, "circle")) aResult = Draw_Circle;
    if (!strcasecmp(theMarkerStr, "circle_zoom")) aResult = Draw_CircleZoom;
