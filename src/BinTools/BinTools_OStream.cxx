...
// purpose  :
//=======================================================================
BinTools_OStream::BinTools_OStream(Standard_OStream& theStream) : myStream(&theStream), myPosition(theStream.tellp()) {}
...
// purpose  :
//=======================================================================
void BinTools_OStream::PutBools(const Standard_Boolean theValue1, const Standard_Boolean theValue2,
