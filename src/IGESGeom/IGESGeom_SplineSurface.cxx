...
void IGESGeom_SplineSurface::Init(const Standard_Integer aBoundaryType, const Standard_Integer aPatchType,
...
Handle(TColStd_HArray1OfReal) IGESGeom_SplineSurface::XPolynomial(const Standard_Integer Index1,
                                                                  const Standard_Integer Index2) const {
    return (theXCoeffs->Value(Index1, Index2));
}

Handle(TColStd_HArray1OfReal) IGESGeom_SplineSurface::YPolynomial(const Standard_Integer Index1,
                                                                  const Standard_Integer Index2) const {
    return (theYCoeffs->Value(Index1, Index2));
}

Handle(TColStd_HArray1OfReal) IGESGeom_SplineSurface::ZPolynomial(const Standard_Integer Index1,
                                                                  const Standard_Integer Index2) const {
