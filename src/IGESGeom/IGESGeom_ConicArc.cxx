...
void IGESGeom_ConicArc::Init(const Standard_Real A, const Standard_Real B, const Standard_Real C, const Standard_Real D,
                             const Standard_Real E, const Standard_Real F, const Standard_Real ZT, const gp_XY& aStart,
                             const gp_XY& anEnd) {
    theA = A;
    theB = B;
    theC = C;
...
void IGESGeom_ConicArc::Equation(Standard_Real& A, Standard_Real& B, Standard_Real& C, Standard_Real& D,
...
Standard_Integer IGESGeom_ConicArc::ComputedFormNumber() const {
    ...
    Standard_Real Q1 = theA * (theC * theF - theE * theE / 4.) + theB / 2. * (theE * theD / 4. - theB * theF / 2.) +
...
void IGESGeom_ConicArc::TransformedDefinition(gp_Pnt& Center, gp_Dir& MainAxis, Standard_Real& Rmin,
...
void IGESGeom_ConicArc::ComputedDefinition(Standard_Real& Xcen, Standard_Real& Ycen, Standard_Real& Xax,
                                           Standard_Real& Yax, Standard_Real& Rmin, Standard_Real& Rmax) const {
