...
public:
    ...
    Standard_EXPORT void Init(const Standard_Real A, const Standard_Real B, const Standard_Real C,
                              const Standard_Real D, const Handle(IGESData_IGESEntity) & aCurve, const gp_XYZ& attach,
    ...
    Standard_EXPORT void TransformedEquation(Standard_Real& A, Standard_Real& B, Standard_Real& C,
