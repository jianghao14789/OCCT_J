...
void IGESGeom_SplineCurve::Init(
    const Standard_Integer aType, const Standard_Integer aDegree, const Standard_Integer nbDimensions,
    const Handle(TColStd_HArray1OfReal) & allBreakPoints, const Handle(TColStd_HArray2OfReal) & allXPolynomials,
    const Handle(TColStd_HArray2OfReal) & allYPolynomials, const Handle(TColStd_HArray2OfReal) & allZPolynomials,
    const Handle(TColStd_HArray1OfReal) & allXvalues, const Handle(TColStd_HArray1OfReal) & allYvalues,
    ...
    if (allBreakPoints->Lower() != 1 || allXvalues->Lower() != 1 || allYvalues->Lower() != 1 ||
        allZvalues->Lower() != 1 || allXPolynomials->LowerCol() != 1 || allXPolynomials->LowerRow() != 1 ||
        allYPolynomials->LowerCol() != 1 || allYPolynomials->LowerRow() != 1 || allZPolynomials->LowerCol() != 1 ||
...
void IGESGeom_SplineCurve::XCoordPolynomial(const Standard_Integer Index, Standard_Real& AX, Standard_Real& BX,
                                            Standard_Real& CX, Standard_Real& DX) const {
...
void IGESGeom_SplineCurve::YCoordPolynomial(const Standard_Integer Index, Standard_Real& AY, Standard_Real& BY,
                                            Standard_Real& CY, Standard_Real& DY) const {
...
void IGESGeom_SplineCurve::ZCoordPolynomial(const Standard_Integer Index, Standard_Real& AZ, Standard_Real& BZ,
                                            Standard_Real& CZ, Standard_Real& DZ) const {
...
void IGESGeom_SplineCurve::XValues(Standard_Real& TPX0, Standard_Real& TPX1, Standard_Real& TPX2,
...
void IGESGeom_SplineCurve::YValues(Standard_Real& TPY0, Standard_Real& TPY1, Standard_Real& TPY2,
...
void IGESGeom_SplineCurve::ZValues(Standard_Real& TPZ0, Standard_Real& TPZ1, Standard_Real& TPZ2,
