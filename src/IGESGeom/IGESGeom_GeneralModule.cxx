...
void IGESGeom_GeneralModule::OwnSharedCase(const Standard_Integer CN, const Handle(IGESData_IGESEntity) & ent,
...
void IGESGeom_GeneralModule::OwnCheckCase(const Standard_Integer CN, const Handle(IGESData_IGESEntity) & ent,
...
Standard_Boolean IGESGeom_GeneralModule::NewVoid(const Standard_Integer CN, Handle(Standard_Transient) & ent) const {
    switch (CN) {
        case 1:
...
void IGESGeom_GeneralModule::OwnCopyCase(const Standard_Integer CN, const Handle(IGESData_IGESEntity) & entfrom,
