...
void IGESGeom_Plane::Init(const Standard_Real A, const Standard_Real B, const Standard_Real C, const Standard_Real D,
                          const Handle(IGESData_IGESEntity) & aCurve, const gp_XYZ& attach, const Standard_Real aSize) {
    theA = A;
    theB = B;
    theC = C;
    theD = D;
...
void IGESGeom_Plane::Equation(Standard_Real& A, Standard_Real& B, Standard_Real& C, Standard_Real& D) const {
    A = theA;
    B = theB;
    C = theC;
    D = theD;
...
void IGESGeom_Plane::TransformedEquation(Standard_Real& A, Standard_Real& B, Standard_Real& C, Standard_Real& D) const {
