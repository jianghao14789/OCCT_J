...
void IGESGeom_Boundary::Init(const Standard_Integer aType, const Standard_Integer aPreference,
...
Handle(IGESData_HArray1OfIGESEntity) IGESGeom_Boundary::ParameterCurves(const Standard_Integer Index) const {
