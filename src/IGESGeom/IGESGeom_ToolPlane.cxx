...
void IGESGeom_ToolPlane::ReadOwnParams(const Handle(IGESGeom_Plane) & ent, const Handle(IGESData_IGESReaderData) & IR,
...
void IGESGeom_ToolPlane::WriteOwnParams(const Handle(IGESGeom_Plane) & ent, IGESData_IGESWriter& IW) const {
...
void IGESGeom_ToolPlane::OwnShared(const Handle(IGESGeom_Plane) & ent, Interface_EntityIterator& iter) const {
...
void IGESGeom_ToolPlane::OwnCopy(const Handle(IGESGeom_Plane) & another, const Handle(IGESGeom_Plane) & ent,
...
void IGESGeom_ToolPlane::OwnCheck(const Handle(IGESGeom_Plane) & ent, const Interface_ShareTool&,
...
void IGESGeom_ToolPlane::OwnDump(const Handle(IGESGeom_Plane) & ent, const IGESData_IGESDumper& dumper,
