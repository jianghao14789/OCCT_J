...
public:
    ...
    Standard_EXPORT void Init(const Handle(IGESData_IGESEntity) & aBaseCurve, const Standard_Integer anOffsetType,
                              ...
                              const Standard_Real arcLength1, const Standard_Real offDistance2,
                              const Standard_Real arcLength2, const gp_XYZ& aNormalVec,
