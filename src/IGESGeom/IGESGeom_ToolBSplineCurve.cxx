...
void IGESGeom_ToolBSplineCurve::ReadOwnParams(const Handle(IGESGeom_BSplineCurve) & ent,
    ...
    */
    ...
    ent->Init(anIndex, aDegree, aPlanar, aClosed, aPolynomial, aPeriodic, allKnots, allWeights, allPoles, aUmin, aUmax,
              aNorm);
}
...
IGESData_DirChecker IGESGeom_ToolBSplineCurve::DirChecker(const Handle(IGESGeom_BSplineCurve) & /* ent */) const {
...
void IGESGeom_ToolBSplineCurve::OwnCheck(const Handle(IGESGeom_BSplineCurve) & ent, const Interface_ShareTool&,
...
void IGESGeom_ToolBSplineCurve::OwnDump(const Handle(IGESGeom_BSplineCurve) & ent,
    ...
    S << "BSplineCurve from IGESGeom\n"
      ...
      << (ent->IsClosed() ? "Closed" : "Open") << "  " << (ent->IsPeriodic() ? "Periodic" : "NonPeriodic")
      << "  " // #54 rln 24.12.98 CCI60005
