...
public:
    ...
    Init(const Standard_Integer aType, const Standard_Integer aDegree, const Standard_Integer nbDimensions,
    ...
    Standard_EXPORT void XCoordPolynomial(const Standard_Integer Index, Standard_Real& AX, Standard_Real& BX,
                                          Standard_Real& CX, Standard_Real& DX) const;

    //! returns Y coordinate polynomial for segment referred to by Index
    //! raises exception if Index <= 0 or Index > NbSegments()
    Standard_EXPORT void YCoordPolynomial(const Standard_Integer Index, Standard_Real& AY, Standard_Real& BY,
                                          Standard_Real& CY, Standard_Real& DY) const;

    //! returns Z coordinate polynomial for segment referred to by Index
    //! raises exception if Index <= 0 or Index > NbSegments()
    Standard_EXPORT void ZCoordPolynomial(const Standard_Integer Index, Standard_Real& AZ, Standard_Real& BZ,
    ...
    Standard_EXPORT void XValues(Standard_Real& TPX0, Standard_Real& TPX1, Standard_Real& TPX2,
    ...
    Standard_EXPORT void YValues(Standard_Real& TPY0, Standard_Real& TPY1, Standard_Real& TPY2,
    ...
    Standard_EXPORT void ZValues(Standard_Real& TPZ0, Standard_Real& TPZ1, Standard_Real& TPZ2,
