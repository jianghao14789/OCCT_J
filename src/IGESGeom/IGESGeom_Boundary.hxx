...
public:
    ...
    Standard_EXPORT void Init(const Standard_Integer aType, const Standard_Integer aPreference,
    ...
    Standard_EXPORT Handle(IGESData_IGESEntity)
        ParameterCurve(const Standard_Integer Index, const Standard_Integer Num) const;
