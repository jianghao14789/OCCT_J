...
void IGESGeom_ToolSurfaceOfRevolution::ReadOwnParams(const Handle(IGESGeom_SurfaceOfRevolution) & ent,
    ...
    if (!PR.ReadEntity(IR, PR.Current(), aStatus, STANDARD_TYPE(IGESGeom_Line),
                       anAxis)) { // szv#4:S4163:12Mar99 `st=` not needed
...
void IGESGeom_ToolSurfaceOfRevolution::WriteOwnParams(const Handle(IGESGeom_SurfaceOfRevolution) & ent,
...
IGESData_DirChecker
IGESGeom_ToolSurfaceOfRevolution::DirChecker(const Handle(IGESGeom_SurfaceOfRevolution) & /*ent*/) const {
