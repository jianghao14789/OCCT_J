...
void IGESGeom_ToolSplineCurve::ReadOwnParams(const Handle(IGESGeom_SplineCurve) & ent,
    ...
    */
    ...
    if (allBreakPoints.IsNull() || allXPolynomials.IsNull() || allYPolynomials.IsNull() || allZPolynomials.IsNull())
        ...
        ent->Init(aType, aDegree, nbDimensions, allBreakPoints, allXPolynomials, allYPolynomials, allZPolynomials,
                  allXvalues, allYvalues, allZvalues);
    }
}

void IGESGeom_ToolSplineCurve::WriteOwnParams(const Handle(IGESGeom_SplineCurve) & ent, IGESData_IGESWriter& IW) const {
...
IGESData_DirChecker IGESGeom_ToolSplineCurve::DirChecker(const Handle(IGESGeom_SplineCurve) & /* ent */) const {
...
void IGESGeom_ToolSplineCurve::OwnCheck(const Handle(IGESGeom_SplineCurve) & ent, const Interface_ShareTool&,
