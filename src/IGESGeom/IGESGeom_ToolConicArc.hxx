...
public:
    ...
    Standard_EXPORT void OwnCheck(const Handle(IGESGeom_ConicArc) & ent, const Interface_ShareTool& shares,
                                  Handle(Interface_Check) & ach) const;

    //! Copies Specific Parameters
    Standard_EXPORT void OwnCopy(const Handle(IGESGeom_ConicArc) & entfrom, const Handle(IGESGeom_ConicArc) & entto,
                                 Interface_CopyTool& TC) const;

    //! Dump of Specific Parameters
    Standard_EXPORT void OwnDump(const Handle(IGESGeom_ConicArc) & ent, const IGESData_IGESDumper& dumper,
