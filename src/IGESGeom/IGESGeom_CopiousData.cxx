...
void IGESGeom_CopiousData::Init(const Standard_Integer aDataType, const Standard_Real aZPlane,
                                const Handle(TColStd_HArray1OfReal) & allData) {
    // PTV OCC386 crach application while reading So5771b.igs
    if (allData.IsNull()) throw Standard_NullObject("IGESGeom_CopiousData : Init with null data");
...
Standard_Real IGESGeom_CopiousData::Data(const Standard_Integer nump, const Standard_Integer numdata) const {
