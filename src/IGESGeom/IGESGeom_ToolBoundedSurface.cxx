...
void IGESGeom_ToolBoundedSurface::OwnCopy(const Handle(IGESGeom_BoundedSurface) & another,
                                          const Handle(IGESGeom_BoundedSurface) & ent, Interface_CopyTool& TC) const {
    Standard_Integer i, num;
...
IGESData_DirChecker IGESGeom_ToolBoundedSurface::DirChecker(const Handle(IGESGeom_BoundedSurface) & /* ent */) const {
...
void IGESGeom_ToolBoundedSurface::OwnCheck(const Handle(IGESGeom_BoundedSurface) & ent, const Interface_ShareTool&,
