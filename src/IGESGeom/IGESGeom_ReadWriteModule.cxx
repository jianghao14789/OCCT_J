...
Standard_Integer IGESGeom_ReadWriteModule::CaseIGES(const Standard_Integer typenum,
    ...
    switch (typenum) {
        ...
        case 104:
            return 7;
        case 106:
            if (formnum < 20 || formnum > 40) return 8;
            break;
        case 108:
            return 15;
        case 110:
...
void IGESGeom_ReadWriteModule::ReadOwnParams(const Standard_Integer CN, const Handle(IGESData_IGESEntity) & ent,
...
void IGESGeom_ReadWriteModule::WriteOwnParams(const Standard_Integer CN, const Handle(IGESData_IGESEntity) & ent,
