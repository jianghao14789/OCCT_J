...
void IGESGeom_ToolTransformationMatrix::ReadOwnParams(const Handle(IGESGeom_TransformationMatrix) & ent,
...
void IGESGeom_ToolTransformationMatrix::WriteOwnParams(const Handle(IGESGeom_TransformationMatrix) & ent,
...
void IGESGeom_ToolTransformationMatrix::OwnShared(const Handle(IGESGeom_TransformationMatrix) & /*ent*/,
...
void IGESGeom_ToolTransformationMatrix::OwnCopy(const Handle(IGESGeom_TransformationMatrix) & another,
...
Standard_Boolean IGESGeom_ToolTransformationMatrix::OwnCorrect(const Handle(IGESGeom_TransformationMatrix) &
                                                               ent) const {
...
IGESData_DirChecker
IGESGeom_ToolTransformationMatrix::DirChecker(const Handle(IGESGeom_TransformationMatrix) & /*ent*/) const {
...
void IGESGeom_ToolTransformationMatrix::OwnDump(const Handle(IGESGeom_TransformationMatrix) & ent,
    ...
    S << "IGESGeom_TransformationMatrix\n"
      << "| R11, R12, R13, T1 |       " << ent->Data(1, 1) << ", " << ent->Data(1, 2) << ", " << ent->Data(1, 3) << ", "
      << ent->Data(1, 4) << "\n"
      << "| R21, R22, R23, T2 |       " << ent->Data(2, 1) << ", " << ent->Data(2, 2) << ", " << ent->Data(2, 3) << ", "
      << ent->Data(2, 4) << "\n"
      << "| R31, R32, R33, T3 |       " << ent->Data(3, 1) << ", " << ent->Data(3, 2) << ", " << ent->Data(3, 3) << ", "
      << ent->Data(3, 4) << "\n";
