...
public:
    ...
    Standard_EXPORT void Init(const Standard_Real A, const Standard_Real B, const Standard_Real C,
                              const Standard_Real D, const Standard_Real E, const Standard_Real F,
                              const Standard_Real ZT, const gp_XY& aStart, const gp_XY& anEnd);
    ...
    Standard_EXPORT void Equation(Standard_Real& A, Standard_Real& B, Standard_Real& C, Standard_Real& D,
    ...
    Standard_EXPORT void TransformedDefinition(gp_Pnt& Center, gp_Dir& MainAxis, Standard_Real& rmin,
    ...
    Standard_EXPORT void ComputedDefinition(Standard_Real& Xcen, Standard_Real& Ycen, Standard_Real& Xax,
