...
Standard_Boolean TFunction_Scope::AddFunction(const TDF_Label& L) {
    if (myFunctions.IsBound2(L)) return Standard_False;
...
Standard_Boolean TFunction_Scope::RemoveFunction(const Standard_Integer ID) {
    if (!myFunctions.IsBound1(ID)) return Standard_False;
...
void TFunction_Scope::Paste(const Handle(TDF_Attribute) & /*into*/, const Handle(TDF_RelocationTable) & /*RT*/) const {
