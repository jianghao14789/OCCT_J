...
public:
    ...
    //! Constructor
    IntPolyh_Triangle()
        : myHasIntersection(Standard_False), myIsIntersectionPossible(Standard_True), myIsDegenerated(Standard_False),
          myDeflection(0.0) {
        myPoints[0] = -1;
        myPoints[1] = -1;
        myPoints[2] = -1;
    ...
    //! Constructor
    IntPolyh_Triangle(const Standard_Integer thePoint1, const Standard_Integer thePoint2,
    ...
    Standard_EXPORT void MiddleRefinement(const Standard_Integer theTriangleNumber,
                                          const Handle(Adaptor3d_Surface) & theSurface, IntPolyh_ArrayOfPoints& TPoints,
                                          IntPolyh_ArrayOfTriangles& TTriangles, IntPolyh_ArrayOfEdges& TEdges);

    //! Splits the current triangle and new triangles until the refinement
    //! criterion is not achieved
    Standard_EXPORT void MultipleMiddleRefinement(const Standard_Real theRefineCriterion, const Bnd_Box& theBox,
    ...
    Standard_EXPORT void LinkEdges2Triangle(const IntPolyh_ArrayOfEdges& TEdges, const Standard_Integer theEdge1,
    ...
    Standard_EXPORT void SetEdgeAndOrientation(const IntPolyh_Edge& theEdge, const Standard_Integer theEdgeIndex);
