...
void HLRTopoBRep_FaceIsoLiner::Perform(const Standard_Integer FI, const TopoDS_Face& F, HLRTopoBRep_Data& DS,
    ...
    if (StepU > Confusion) {
        ...
        for (IIso = 1; IIso <= nbIsos; IIso++) {
            ...
            Hatcher.Trim(IndH);
            if (Hatcher.TrimDone(IndH) && !Hatcher.TrimFailed(IndH)) Hatcher.ComputeDomains(IndH);
            ...
            if (NbDom > 0) {
                ...
                for (Standard_Integer IDom = 1; IDom <= NbDom; IDom++) {
                    ...
                    Standard_Real U21 = Dom.HasSecondPoint() ? Dom.SecondPoint().Parameter() : VMax + Infinite;
                    IsoLine->D0(U11, P);
                    ...
                    if (Dom.HasFirstPoint()) { // Iso U - Premier point
                        ...
                        for (Standard_Integer IPntE = 1; IPntE <= PntH.NbPoints(); IPntE++) {
                            ...
                            V1U = HLRTopoBRep_FaceIsoLiner::MakeVertex(TopoDS::Edge(SH(PntE.Index())), P1,
                                                                       PntE.Parameter(), Tolerance, DS);
                    ...
                    if (Dom.HasSecondPoint()) { // Iso U - Deuxieme point
                        ...
                        for (Standard_Integer IPntE = 1; IPntE <= PntH.NbPoints(); IPntE++) {
                            const HatchGen_PointOnElement& PntE = PntH.Point(IPntE);
                            V2U = HLRTopoBRep_FaceIsoLiner::MakeVertex(TopoDS::Edge(SH(PntE.Index())), P2,
                                                                       PntE.Parameter(), Tolerance, DS);
        ...
        for (IIso = 1; IIso <= nbIsos; IIso++) {
            ...
            if (NbDom > 0) {
                ...
                for (Standard_Integer IDom = 1; IDom <= NbDom; IDom++) {
                    ...
                    Standard_Real U22 = Dom.HasSecondPoint() ? Dom.SecondPoint().Parameter() : VMax + Infinite;
                    IsoLine->D0(U12, P);
                    Surface.D0(P.X(), P.Y(), P1);
                    IsoLine->D0(U22, P);
                    Surface.D0(P.X(), P.Y(), P2);
                    if (Dom.HasFirstPoint()) { // Iso V - Premier point
                        ...
                        for (Standard_Integer IPntE = 1; IPntE <= PntH.NbPoints(); IPntE++) {
                            const HatchGen_PointOnElement& PntE = PntH.Point(IPntE);
                            V1V = HLRTopoBRep_FaceIsoLiner::MakeVertex(TopoDS::Edge(SH(PntE.Index())), P1,
                                                                       PntE.Parameter(), Tolerance, DS);
                    ...
                    if (Dom.HasSecondPoint()) { // Iso V - Deuxieme point
                        ...
                        for (Standard_Integer IPntE = 1; IPntE <= PntH.NbPoints(); IPntE++) {
                            const HatchGen_PointOnElement& PntE = PntH.Point(IPntE);
                            V2V = HLRTopoBRep_FaceIsoLiner::MakeVertex(TopoDS::Edge(SH(PntE.Index())), P2,
                                                                       PntE.Parameter(), Tolerance, DS);
...
TopoDS_Vertex HLRTopoBRep_FaceIsoLiner::MakeVertex(const TopoDS_Edge& E, const gp_Pnt& P, const Standard_Real Par,
                                                   const Standard_Real Tol, HLRTopoBRep_Data& DS) {
    TopoDS_Vertex V, VF, VL;
    BRep_Builder B;
    TopExp::Vertices(E, VF, VL);
    if (P.IsEqual(BRep_Tool::Pnt(VF), BRep_Tool::Tolerance(VF))) return VF;
    if (P.IsEqual(BRep_Tool::Pnt(VL), BRep_Tool::Tolerance(VL))) return VL;
...
void HLRTopoBRep_FaceIsoLiner::MakeIsoLine(const TopoDS_Face& F, const Handle(Geom2d_Line) & Iso, TopoDS_Vertex& V1,
                                           TopoDS_Vertex& V2, const Standard_Real U1, const Standard_Real U2,
                                           const Standard_Real Tol, HLRTopoBRep_Data& DS) {
    BRep_Builder B;
    TopoDS_Edge E;
