...
public:
    ...
    Standard_EXPORT static void Insert(const TopoDS_Shape& S, Contap_Contour& FO, HLRTopoBRep_Data& DS,
...
private:
    ...
    Standard_EXPORT static TopoDS_Vertex MakeVertex(const Contap_Point& P, const Standard_Real tol,
                                                    HLRTopoBRep_Data& DS);

    //! Insert a vertex    from an internal   intersection
    //! point <P> on restriction <E>  and store it in  the
    //! data structure <DS>.
    Standard_EXPORT static void InsertVertex(const Contap_Point& P, const Standard_Real tol, const TopoDS_Edge& E,
                                             HLRTopoBRep_Data& DS);
