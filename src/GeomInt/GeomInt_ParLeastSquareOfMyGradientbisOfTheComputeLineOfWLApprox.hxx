...
public:
    ...
    Standard_EXPORT GeomInt_ParLeastSquareOfMyGradientbisOfTheComputeLineOfWLApprox(
        const GeomInt_TheMultiLineOfWLApprox& SSP, const Standard_Integer FirstPoint, const Standard_Integer LastPoint,
    ...
    //! parameter, only the vector B changes).
    Standard_EXPORT GeomInt_ParLeastSquareOfMyGradientbisOfTheComputeLineOfWLApprox(
        const GeomInt_TheMultiLineOfWLApprox& SSP, const TColStd_Array1OfReal& Knots,
        const TColStd_Array1OfInteger& Mults, const Standard_Integer FirstPoint, const Standard_Integer LastPoint,
        const AppParCurves_Constraint FirstCons, const AppParCurves_Constraint LastCons, const math_Vector& Parameters,
        const Standard_Integer NbPol);
...
protected:
    ...
    Standard_EXPORT void Init(const GeomInt_TheMultiLineOfWLApprox& SSP, const Standard_Integer FirstPoint,
    ...
    Standard_EXPORT void Affect(const GeomInt_TheMultiLineOfWLApprox& SSP, const Standard_Integer Index,
