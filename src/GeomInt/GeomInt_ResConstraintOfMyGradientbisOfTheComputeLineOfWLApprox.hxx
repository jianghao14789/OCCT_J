...
public:
    ...
    Standard_EXPORT GeomInt_ResConstraintOfMyGradientbisOfTheComputeLineOfWLApprox(
        const GeomInt_TheMultiLineOfWLApprox& SSP, AppParCurves_MultiCurve& SCurv, const Standard_Integer FirstPoint,
...
protected:
    ...
    Standard_EXPORT Standard_Integer NbConstraints(const GeomInt_TheMultiLineOfWLApprox& SSP,
