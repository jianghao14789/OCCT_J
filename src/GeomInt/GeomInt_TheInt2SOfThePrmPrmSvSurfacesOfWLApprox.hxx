...
public:
    ...
    Standard_EXPORT GeomInt_TheInt2SOfThePrmPrmSvSurfacesOfWLApprox(const TColStd_Array1OfReal& Param,
    ...
    //! }
    Standard_EXPORT GeomInt_TheInt2SOfThePrmPrmSvSurfacesOfWLApprox(const Handle(Adaptor3d_Surface) & S1,
                                                                    const Handle(Adaptor3d_Surface) & S2,
                                                                    const Standard_Real TolTangency);
