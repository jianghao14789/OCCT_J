...
public:
    ...
    Standard_EXPORT Bisector_FunctionInter(const Handle(Geom2d_Curve) & C, const Handle(Bisector_Curve) & Bis1,
                                           const Handle(Bisector_Curve) & Bis2);

    Standard_EXPORT void Perform(const Handle(Geom2d_Curve) & C, const Handle(Bisector_Curve) & Bis1,
                                 const Handle(Bisector_Curve) & Bis2);
