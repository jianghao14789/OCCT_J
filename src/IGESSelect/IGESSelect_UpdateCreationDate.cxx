...
IGESSelect_UpdateCreationDate::IGESSelect_UpdateCreationDate() : IGESSelect_ModelModifier(Standard_False) {}

void IGESSelect_UpdateCreationDate::Performing(IFSelect_ContextModif& ctx, const Handle(IGESData_IGESModel) & target,
    ...
    if (annee < 2000)
        ...
        GS.SetDate(IGESData_GlobalSection::NewDateString(annee, mois, jour, heure, minute, seconde, -1));
