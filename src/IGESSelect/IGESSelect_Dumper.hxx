...
public:
    ...
    Standard_EXPORT Standard_Boolean WriteOwn(IFSelect_SessionFile& file,
    ...
    Standard_EXPORT Standard_Boolean ReadOwn(IFSelect_SessionFile& file, const TCollection_AsciiString& type,
