...
Standard_Boolean IGESSelect_SelectPCurves::Explore(const Standard_Integer level, const Handle(Standard_Transient) & ent,
    ...
    if ((igt >= 100 && igt <= 106) || igt == 110 || igt == 112 || igt == 116 || igt == 126 || igt == 130)
        return Standard_True;
