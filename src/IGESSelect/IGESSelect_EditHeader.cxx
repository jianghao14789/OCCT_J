    ...
    for (Standard_Integer i = 1; i <= 13; i++) {
        ...
        switch (i) {
            ...
            case 2:
                ...
                break;
            case 3:
                if (uncar != '0' && uncar != '1') return Standard_False;
                break;
            case 4:
                if (uncar < '0' || uncar > '9') return Standard_False;
                ...
                break;
            case 5:
                if (uncar < '0' || uncar > '3') return Standard_False;
                break;
            case 6:
                if (uncar < '0' || uncar > '9') return Standard_False;
                ...
                break;
            case 7:
                if (uncar != '.') return Standard_False;
                break;
            case 8:
                if (uncar < '0' || uncar > '2') return Standard_False;
                break;
            case 9:
                if (uncar < '0' || uncar > '9') return Standard_False;
                if (dizheur == '2' && (uncar < '0' || uncar > '3'))
                    return Standard_False; // szv#4:S4163:12Mar99 extra break
                break;
            case 10:
                if (uncar < '0' || uncar > '5') return Standard_False;
                break;
            case 11:
                if (uncar < '0' || uncar > '9') return Standard_False;
                break;
...
IGESSelect_EditHeader::IGESSelect_EditHeader() : IFSelect_Editor(30) {
...
Handle(TCollection_HAsciiString) IGESSelect_EditHeader::StringValue(const Handle(IFSelect_EditForm) & /*form*/,
...
Standard_Boolean IGESSelect_EditHeader::Load(const Handle(IFSelect_EditForm) & form,
    ...
    form->LoadValue(26, new TCollection_HAsciiString(IGESData_BasicEditor::IGESVersionName(GS.IGESVersion())));
    form->LoadValue(27, new TCollection_HAsciiString(GS.DraftingStandard()));
    form->LoadValue(28, new TCollection_HAsciiString(IGESData_BasicEditor::DraftingName(GS.DraftingStandard())));
...
Standard_Boolean IGESSelect_EditHeader::Update(const Handle(IFSelect_EditForm) & form, const Standard_Integer num,
