...
Standard_Boolean IGESSelect_SplineToBSpline::Perform(const Interface_Graph& G, const Handle(Interface_Protocol) &,
...
TCollection_AsciiString IGESSelect_SplineToBSpline::Label() const {
    if (thetryc2)
        return TCollection_AsciiString("Convert Spline Forms to BSpline, trying to recover C1-C2 continuity");
    else
