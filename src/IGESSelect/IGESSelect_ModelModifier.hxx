...
public:
    ...
    //! Performing
    Standard_EXPORT void Perform(IFSelect_ContextModif& ctx, const Handle(Interface_InterfaceModel) & target,
    ...
    //! requires Protocol.
    Standard_EXPORT virtual void PerformProtocol(IFSelect_ContextModif& ctx, const Handle(IGESData_IGESModel) & target,
                                                 const Handle(IGESData_Protocol) & proto, Interface_CopyTool& TC) const;
    ...
    //! by the linker)
    Standard_EXPORT virtual void Performing(IFSelect_ContextModif& ctx, const Handle(IGESData_IGESModel) & target,
