...
IGESSelect_WorkLibrary::IGESSelect_WorkLibrary(const Standard_Boolean modefnes) : themodefnes(modefnes) {
    IGESSolid::Init();
    IGESAppli::Init();
    IGESDefs::Init();
...
Standard_Integer IGESSelect_WorkLibrary::ReadFile(const Standard_CString name, Handle(Interface_InterfaceModel) & model,
