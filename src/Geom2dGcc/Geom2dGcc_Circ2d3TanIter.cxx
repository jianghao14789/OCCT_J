            ...
            if (dot1 <= Tol && dot2 <= Tol && dot3 <= Tol) {
                ...
                if (Qualified1.IsUnqualified() || (Qualified1.IsEnclosing() && Angle1 <= 0.) ||
                    ...
                    if (Qualified2.IsUnqualified() || (Qualified2.IsEnclosing() && Angle1 <= 0.) ||
                        (Qualified2.IsOutside() && Angle1 >= 0) || (Qualified2.IsEnclosed() && Angle1 <= 0.)) {
                        Angle1 = Vec3.Angle(Tan3);
                        if (Qualified3.IsUnqualified() || (Qualified3.IsEnclosing() && Angle1 <= 0.) ||
                            (Qualified3.IsOutside() && Angle1 >= 0) || (Qualified3.IsEnclosed() && Angle1 <= 0.)) {
...
Geom2dGcc_Circ2d3TanIter::Geom2dGcc_Circ2d3TanIter(const Geom2dGcc_QCurve& Qualified1,
                                                   const Geom2dGcc_QCurve& Qualified2, const gp_Pnt2d& Point3,
...
Geom2dGcc_Circ2d3TanIter::Geom2dGcc_Circ2d3TanIter(const Geom2dGcc_QCurve& Qualified1, const gp_Pnt2d& Point2,
...
void Geom2dGcc_Circ2d3TanIter::WhichQualifier(GccEnt_Position& Qualif1, GccEnt_Position& Qualif2,
...
void Geom2dGcc_Circ2d3TanIter::Tangency1(Standard_Real& ParSol, Standard_Real& ParArg, gp_Pnt2d& PntSol) const {
    if (!WellDone) {
        throw StdFail_NotDone();
    } else {
        if (TheSame1 == 0) {
...
void Geom2dGcc_Circ2d3TanIter::Tangency2(Standard_Real& ParSol, Standard_Real& ParArg, gp_Pnt2d& PntSol) const {
    if (!WellDone) {
        throw StdFail_NotDone();
    } else {
        ParSol = par2sol;
...
void Geom2dGcc_Circ2d3TanIter::Tangency3(Standard_Real& ParSol, Standard_Real& ParArg, gp_Pnt2d& PntSol) const {
    if (!WellDone) {
        throw StdFail_NotDone();
    } else {
        ParSol = par3sol;
...
Standard_Boolean Geom2dGcc_Circ2d3TanIter::IsTheSame2() const {
    ...
    if (TheSame3 == 0) return Standard_False;
