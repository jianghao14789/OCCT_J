...
Geom2dGcc_Lin2dTanObl::Geom2dGcc_Lin2dTanObl(const Geom2dGcc_QualifiedCurve& Qualified1, const gp_Lin2d& TheLine,
                                             const Standard_Real TolAng, const Standard_Real Angle)
    : Paral2(Standard_False), linsol(1, 2), qualifier1(1, 2), pnttg1sol(1, 2), pntint2sol(1, 2), par1sol(1, 2),
      par2sol(1, 2), pararg1(1, 2), pararg2(1, 2) {
    ...
    if (Type1 == GeomAbs_Circle) {
        ...
        for (i = 0; i <= aNbSamples && NbrSol < 2; i++) {
            ...
            if (Lin.IsDone()) {
                if (Add(NbrSol + 1, Lin, TolAng, C1)) NbrSol++;
            }
...
void Geom2dGcc_Lin2dTanObl::WhichQualifier(const Standard_Integer Index, GccEnt_Position& Qualif1) const {
    if (!WellDone) {
...
void Geom2dGcc_Lin2dTanObl::Tangency1(const Standard_Integer Index, Standard_Real& ParSol, Standard_Real& ParArg,
...
void Geom2dGcc_Lin2dTanObl::Intersection2(const Standard_Integer Index, Standard_Real& ParSol, Standard_Real& ParArg,
                                          gp_Pnt2d& PntSol) const {
    if (!WellDone) {
        throw StdFail_NotDone();
    } else if (Index <= 0 || Index > NbrSol) {
...
Standard_Boolean Geom2dGcc_Lin2dTanObl::Add(const Standard_Integer theIndex, const Geom2dGcc_Lin2dTanOblIter& theLin,
