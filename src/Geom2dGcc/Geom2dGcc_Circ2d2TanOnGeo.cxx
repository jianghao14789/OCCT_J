...
Geom2dGcc_Circ2d2TanOnGeo::Geom2dGcc_Circ2d2TanOnGeo(const GccEnt_QualifiedCirc& Qualified1,
                                                     ...
                                                     const Geom2dAdaptor_Curve& OnCurv, const Standard_Real Tolerance)
    : cirsol(1, aNbSolMAX), qualifier1(1, aNbSolMAX), qualifier2(1, aNbSolMAX), TheSame1(1, aNbSolMAX),
      TheSame2(1, aNbSolMAX), pnttg1sol(1, aNbSolMAX), pnttg2sol(1, aNbSolMAX), pntcen(1, aNbSolMAX),
      par1sol(1, aNbSolMAX), par2sol(1, aNbSolMAX), pararg1(1, aNbSolMAX), pararg2(1, aNbSolMAX),
      parcen3(1, aNbSolMAX) {
        ...
        for (Standard_Integer i = 1; i <= nbsolution; i++) {
            ...
            switch (type) {
                case GccInt_Cir: {
                    ...
                    IntRes2d_Domain D1(ElCLib::Value(0., Circ), 0., Tol1, ElCLib::Value(2. * M_PI, Circ), 2. * M_PI,
                                       Tol2);
                ...
                case GccInt_Ell: {
                    ...
                    IntRes2d_Domain D1(ElCLib::Value(0., Elips), 0., Tol1, ElCLib::Value(2. * M_PI, Elips), 2. * M_PI,
                                       Tol2);
                    D1.SetEquivalentParameters(0., 2. * M_PI);
                ...
                case GccInt_Hpr: {
                    ...
                    IntRes2d_Domain D1(ElCLib::Value(-4., Hypr), -4., Tol1, ElCLib::Value(4., Hypr), 4., Tol2);
        ...
        for (Standard_Integer i = 1; i <= nbsolution; i++) {
            ...
            switch (type) {
                ...
                case GccInt_Par: {
                    ...
                    IntRes2d_Domain D1(ElCLib::Value(-40, Parab), -40, Tol1, ElCLib::Value(40, Parab), 40, Tol1);
...
Geom2dGcc_Circ2d2TanOnGeo::Geom2dGcc_Circ2d2TanOnGeo(const GccEnt_QualifiedCirc& Qualified1, const gp_Pnt2d& Point2,
                                                     const Geom2dAdaptor_Curve& OnCurv, const Standard_Real Tolerance)
    : cirsol(1, aNbSolMAX), qualifier1(1, aNbSolMAX), qualifier2(1, aNbSolMAX), TheSame1(1, aNbSolMAX),
      TheSame2(1, aNbSolMAX), pnttg1sol(1, aNbSolMAX), pnttg2sol(1, aNbSolMAX), pntcen(1, aNbSolMAX),
      par1sol(1, aNbSolMAX), par2sol(1, aNbSolMAX), pararg1(1, aNbSolMAX), pararg2(1, aNbSolMAX),
...
Geom2dGcc_Circ2d2TanOnGeo::Geom2dGcc_Circ2d2TanOnGeo(const GccEnt_QualifiedLin& Qualified1, const gp_Pnt2d& Point2,
                                                     const Geom2dAdaptor_Curve& OnCurv, const Standard_Real Tolerance)
    : cirsol(1, aNbSolMAX), qualifier1(1, aNbSolMAX), qualifier2(1, aNbSolMAX), TheSame1(1, aNbSolMAX),
      TheSame2(1, aNbSolMAX), pnttg1sol(1, aNbSolMAX), pnttg2sol(1, aNbSolMAX), pntcen(1, aNbSolMAX),
      par1sol(1, aNbSolMAX), par2sol(1, aNbSolMAX), pararg1(1, aNbSolMAX), pararg2(1, aNbSolMAX),
        ...
        if (Intp.IsDone()) {
            if ((!Intp.IsEmpty())) {
                for (Standard_Integer j = 1; j <= Intp.NbPoints() && NbrSol < aNbSolMAX; j++) {
                    ...
                    Standard_Boolean ok = Standard_False;
                    if (Qualified1.IsEnclosed()) {
                        if ((((origin1.X() - Center.X()) * (-dir1.Y())) + ((origin1.Y() - Center.Y()) * (dir1.X()))) <=
                            0) {
                            ok = Standard_True;
                        }
                    } else if (Qualified1.IsOutside()) {
...
Geom2dGcc_Circ2d2TanOnGeo::Geom2dGcc_Circ2d2TanOnGeo(const gp_Pnt2d& Point1, const gp_Pnt2d& Point2,
                                                     const Geom2dAdaptor_Curve& OnCurv, const Standard_Real Tolerance)
    : cirsol(1, aNbSolMAX), qualifier1(1, aNbSolMAX), qualifier2(1, aNbSolMAX), TheSame1(1, aNbSolMAX),
      TheSame2(1, aNbSolMAX), pnttg1sol(1, aNbSolMAX), pnttg2sol(1, aNbSolMAX), pntcen(1, aNbSolMAX),
      par1sol(1, aNbSolMAX), par2sol(1, aNbSolMAX), pararg1(1, aNbSolMAX), pararg2(1, aNbSolMAX),
...
void Geom2dGcc_Circ2d2TanOnGeo::WhichQualifier(const Standard_Integer Index, GccEnt_Position& Qualif1,
...
void Geom2dGcc_Circ2d2TanOnGeo::Tangency1(const Standard_Integer Index, Standard_Real& ParSol, Standard_Real& ParArg,
...
void Geom2dGcc_Circ2d2TanOnGeo::Tangency2(const Standard_Integer Index, Standard_Real& ParSol, Standard_Real& ParArg,
                                          gp_Pnt2d& PntSol) const {
    if (!WellDone) {
        throw StdFail_NotDone();
    } else if (Index <= 0 || Index > NbrSol) {
...
void Geom2dGcc_Circ2d2TanOnGeo::CenterOn3(const Standard_Integer Index, Standard_Real& ParArg, gp_Pnt2d& PntSol) const {
    if (!WellDone) {
        throw StdFail_NotDone();
    } else if (Index <= 0 || Index > NbrSol) {
        throw Standard_OutOfRange();
