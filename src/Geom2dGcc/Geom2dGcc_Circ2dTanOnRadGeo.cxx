...
//                   - de rayon Radius.                                   +
//=========================================================================
Geom2dGcc_Circ2dTanOnRadGeo::Geom2dGcc_Circ2dTanOnRadGeo(const Geom2dGcc_QCurve& Qualified1, const gp_Lin2d& OnLine,
    ...
    :
      ...
      cirsol(1, aNbSolMAX), qualifier1(1, aNbSolMAX), TheSame1(1, aNbSolMAX), pnttg1sol(1, aNbSolMAX),
      pntcen3(1, aNbSolMAX), par1sol(1, aNbSolMAX), pararg1(1, aNbSolMAX), parcen3(1, aNbSolMAX) {
...
Geom2dGcc_Circ2dTanOnRadGeo::Geom2dGcc_Circ2dTanOnRadGeo(const Geom2dGcc_QCurve& Qualified1, const gp_Circ2d& OnCirc,
                                                         const Standard_Real Radius, const Standard_Real Tolerance)
    :
    ...
    if (Radius < 0.0) {
        ...
        IntRes2d_Domain D1(ElCLib::Value(0., OnCirc), 0., Tol, ElCLib::Value(2. * M_PI, OnCirc), 2. * M_PI, Tol);
...
Geom2dGcc_Circ2dTanOnRadGeo::Geom2dGcc_Circ2dTanOnRadGeo(const GccEnt_QualifiedCirc& Qualified1,
                                                         const Geom2dAdaptor_Curve& OnCurv, const Standard_Real Radius,
...
Geom2dGcc_Circ2dTanOnRadGeo::Geom2dGcc_Circ2dTanOnRadGeo(const Geom2dGcc_QCurve& Qualified1,
    ...
    if (Radius < 0.0) {
        ...
        for (Standard_Integer jcote1 = 1; jcote1 <= nbrcote1; jcote1++) {
            ...
            IntRes2d_Domain D1(C1.Value(firstparam), firstparam, Tol, C1.Value(lastparam), lastparam, Tol);
...
Geom2dGcc_Circ2dTanOnRadGeo::Geom2dGcc_Circ2dTanOnRadGeo(const gp_Pnt2d& Point1, const Geom2dAdaptor_Curve& OnCurv,
                                                         const Standard_Real Radius, const Standard_Real Tolerance)
    :
...
void Geom2dGcc_Circ2dTanOnRadGeo::Tangency1(const Standard_Integer Index, Standard_Real& ParSol, Standard_Real& ParArg,
...
void Geom2dGcc_Circ2dTanOnRadGeo::CenterOn3(const Standard_Integer Index, Standard_Real& ParArg,
                                            gp_Pnt2d& PntSol) const {
    if (!WellDone) {
        throw StdFail_NotDone();
    } else if (Index <= 0 || Index > NbrSol) {
