...
Geom2dGcc_Circ2d2TanOn::Geom2dGcc_Circ2d2TanOn(const Geom2dGcc_QualifiedCurve& Qualified1,
                                               ...
                                               const Geom2dAdaptor_Curve& OnCurve, const Standard_Real Tolerance,
                                               const Standard_Real Param1, const Standard_Real Param2,
                                               const Standard_Real ParamOn)
    : WellDone(Standard_False), cirsol(1, 8), qualifier1(1, 8), qualifier2(1, 8), TheSame1(1, 8), TheSame2(1, 8),
      pnttg1sol(1, 8), pnttg2sol(1, 8), pntcen(1, 8), par1sol(1, 8), par2sol(1, 8), pararg1(1, 8), pararg2(1, 8),
      parcen3(1, 8) {
    ...
    if ((Type1 == GeomAbs_Line || Type1 == GeomAbs_Circle) && (Type2 == GeomAbs_Line || Type2 == GeomAbs_Circle)) {
            ...
            if (Type1 == GeomAbs_Circle) {
                ...
                if (Type2 == GeomAbs_Circle) {
                    ...
                    if (Type3 == GeomAbs_Circle) {
                        ...
                        GccAna_Circ2d2TanOn CircAna(Qc1, GccEnt_QualifiedCirc(c2, Qualified2.Qualifier()),
                    ...
                    if (Type3 == GeomAbs_Circle) {
                        Handle(Geom2d_Circle) CCon = Handle(Geom2d_Circle)::DownCast(Con);
                        GccAna_Circ2d2TanOn CircAna(Qc1, GccEnt_QualifiedLin(l2, Qualified2.Qualifier()),
                                                    CCon->Circ2d(), Tolerance);
                        WellDone = CircAna.IsDone();
                        if (WellDone) {
                            NbrSol = CircAna.NbSolutions();
                        ...
                        Handle(Geom2d_Line) LLon = Handle(Geom2d_Line)::DownCast(Con);
                        GccAna_Circ2d2TanOn CircAna(Qc1, GccEnt_QualifiedLin(l2, Qualified2.Qualifier()), LLon->Lin2d(),
                                                    Tolerance);
                        WellDone = CircAna.IsDone();
                        if (WellDone) {
                            NbrSol = CircAna.NbSolutions();
                ...
                if (Type2 == GeomAbs_Circle) {
                    ...
                    if (Type3 == GeomAbs_Circle) {
                        Handle(Geom2d_Circle) CCon = Handle(Geom2d_Circle)::DownCast(Con);
                        GccAna_Circ2d2TanOn CircAna(GccEnt_QualifiedCirc(c2, Qualified2.Qualifier()), Ql1,
                                                    CCon->Circ2d(), Tolerance);
                        WellDone = CircAna.IsDone();
                        if (WellDone) {
                            NbrSol = CircAna.NbSolutions();
                    ...
                    if (Type3 == GeomAbs_Circle) {
                        Handle(Geom2d_Circle) CCon = Handle(Geom2d_Circle)::DownCast(Con);
                        GccAna_Circ2d2TanOn CircAna(Ql1, GccEnt_QualifiedLin(l2, Qualified2.Qualifier()),
                                                    CCon->Circ2d(), Tolerance);
                        WellDone = CircAna.IsDone();
                        if (WellDone) {
                            NbrSol = CircAna.NbSolutions();
                        ...
                        Handle(Geom2d_Line) LLon = Handle(Geom2d_Line)::DownCast(Con);
                        GccAna_Circ2d2TanOn CircAna(Ql1, GccEnt_QualifiedLin(l2, Qualified2.Qualifier()), LLon->Lin2d(),
                                                    Tolerance);
                        WellDone = CircAna.IsDone();
                        if (WellDone) {
                            NbrSol = CircAna.NbSolutions();
        ...
        if ((Type3 == GeomAbs_Circle || Type3 == GeomAbs_Line)) {
            if (Type3 == GeomAbs_Circle) {
                Handle(Geom2d_Circle) CCon = Handle(Geom2d_Circle)::DownCast(Con);
                Geom2dGcc_Circ2d2TanOnIter Circ(Qc1, Qc2, CCon->Circ2d(), Param1, Param2, ParamOn, Tolerance);
                ...
                Handle(Geom2d_Line) LLon = Handle(Geom2d_Line)::DownCast(Con);
                Geom2dGcc_Circ2d2TanOnIter Circ(Qc1, Qc2, LLon->Lin2d(), Param1, Param2, ParamOn, Tolerance);
                WellDone = Circ.IsDone();
                if (WellDone) {
                    NbrSol = 1;
                    cirsol(1) = Circ.ThisSolution();
...
Geom2dGcc_Circ2d2TanOn::Geom2dGcc_Circ2d2TanOn(const Geom2dGcc_QualifiedCurve& Qualified1,
                                               const Handle(Geom2d_Point) & Point, const Geom2dAdaptor_Curve& OnCurve,
    ...
    if (Type1 == GeomAbs_Line || Type1 == GeomAbs_Circle) {
        ...
        if ((Type3 == GeomAbs_Circle || Type3 == GeomAbs_Line)) {
            if (Type3 == GeomAbs_Circle) {
                Handle(Geom2d_Circle) CCon = Handle(Geom2d_Circle)::DownCast(Con);
                Geom2dGcc_Circ2d2TanOnIter Circ(Qc1, Point->Pnt2d(), CCon->Circ2d(), Param1, ParamOn, Tolerance);
                WellDone = Circ.IsDone();
                if (WellDone) {
                    NbrSol = 1;
                    cirsol(1) = Circ.ThisSolution();
                ...
                Handle(Geom2d_Line) LLon = Handle(Geom2d_Line)::DownCast(Con);
                Geom2dGcc_Circ2d2TanOnIter Circ(Qc1, Point->Pnt2d(), LLon->Lin2d(), Param1, ParamOn, Tolerance);
                WellDone = Circ.IsDone();
                if (WellDone) {
                    NbrSol = 1;
                    cirsol(1) = Circ.ThisSolution();
...
Geom2dGcc_Circ2d2TanOn::Geom2dGcc_Circ2d2TanOn(const Handle(Geom2d_Point) & Point1, const Handle(Geom2d_Point) & Point2,
                                               const Geom2dAdaptor_Curve& OnCurve, const Standard_Real Tolerance)
    : WellDone(Standard_False), cirsol(1, 8), qualifier1(1, 8), qualifier2(1, 8), TheSame1(1, 8), TheSame2(1, 8),
      pnttg1sol(1, 8), pnttg2sol(1, 8), pntcen(1, 8), par1sol(1, 8), par2sol(1, 8), pararg1(1, 8), pararg2(1, 8),
      parcen3(1, 8) {
...
void Geom2dGcc_Circ2d2TanOn::WhichQualifier(const Standard_Integer Index, GccEnt_Position& Qualif1,
...
void Geom2dGcc_Circ2d2TanOn::Tangency1(const Standard_Integer Index, Standard_Real& ParSol, Standard_Real& ParArg,
...
void Geom2dGcc_Circ2d2TanOn::Tangency2(const Standard_Integer Index, Standard_Real& ParSol, Standard_Real& ParArg,
                                       gp_Pnt2d& PntSol) const {
    if (!WellDone) {
        throw StdFail_NotDone();
    } else if (Index <= 0 || Index > NbrSol) {
...
void Geom2dGcc_Circ2d2TanOn::CenterOn3(const Standard_Integer Index, Standard_Real& ParArg, gp_Pnt2d& PntSol) const {
    if (!WellDone) {
        throw StdFail_NotDone();
    } else if (Index <= 0 || Index > NbrSol) {
        throw Standard_OutOfRange();
