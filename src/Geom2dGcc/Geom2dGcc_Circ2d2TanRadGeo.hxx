...
public:
    ...
    //! a radius of Radius.
    //! It raises NegativeValue if Radius is lower than zero.
    Standard_EXPORT Geom2dGcc_Circ2d2TanRadGeo(const Geom2dGcc_QCurve& Qualified1, const Geom2dGcc_QCurve& Qualified2,
    ...
    //! with a radius of Radius.
    //! It raises NegativeValue if Radius is lower than zero.
    Standard_EXPORT Geom2dGcc_Circ2d2TanRadGeo(const Geom2dGcc_QCurve& Qualified1, const gp_Pnt2d& Point2,
                                               const Standard_Real Radius, const Standard_Real Tolerance);
