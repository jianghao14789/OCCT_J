...
static Standard_Integer NormalizedIds(const Standard_Integer aId, const Standard_Integer aDiv);

//=======================================================================
// function :
// purpose  :
//=======================================================================
BOPTools_Set::BOPTools_Set() : myAllocator(NCollection_BaseAllocator::CommonBaseAllocator()), myShapes(myAllocator) {
    myNbShapes = 0;
    mySum = 0;
    myUpper = 432123;
}
...
BOPTools_Set::BOPTools_Set(const Handle(NCollection_BaseAllocator) & theAllocator)
    : myAllocator(theAllocator), myShapes(myAllocator) {
    myNbShapes = 0;
    mySum = 0;
    myUpper = 432123;
}
...
BOPTools_Set::BOPTools_Set(const BOPTools_Set& theOther)
    : myAllocator(theOther.myAllocator), myShape(theOther.myShape), myNbShapes(theOther.myNbShapes),
      mySum(theOther.mySum), myUpper(theOther.myUpper) {
...
// purpose :
//=======================================================================
Standard_Integer NormalizedIds(const Standard_Integer aId, const Standard_Integer aDiv) {
