...
public: //! @name Intersection of the vertices
    ...
    Standard_EXPORT static Standard_Integer ComputeVV(const TopoDS_Vertex& theV, const gp_Pnt& theP,
    ...
    Standard_EXPORT static Standard_Integer ComputeVV(const TopoDS_Vertex& theV1, const TopoDS_Vertex& theV2,
...
public: //! @name Vertices construction
    ...
    Standard_EXPORT static void MakeNewVertex(const TopoDS_Vertex& aV1, const TopoDS_Vertex& aV2,
                                              TopoDS_Vertex& aNewVertex);

    //! Make a vertex in place of intersection between two edges
    //! <aE1, aE2> with parameters <aP1, aP2>
    Standard_EXPORT static void MakeNewVertex(const TopoDS_Edge& aE1, const Standard_Real aP1, const TopoDS_Edge& aE2,
                                              const Standard_Real aP2, TopoDS_Vertex& aNewVertex);

    //! Make a vertex in place of intersection between the edge <aE1>
    //! with parameter <aP1> and the face <aF2>
    Standard_EXPORT static void MakeNewVertex(const TopoDS_Edge& aE1, const Standard_Real aP1, const TopoDS_Face& aF2,
                                              TopoDS_Vertex& aNewVertex);
...
public: //! @name Updating the vertex
    ...
    //! the curve <aIC>
    Standard_EXPORT static void UpdateVertex(const IntTools_Curve& aIC, const Standard_Real aT,
...
public: //! @name Edge construction
    ...
    Standard_EXPORT static void MakeEdge(const IntTools_Curve& theCurve, const TopoDS_Vertex& theV1,
                                         const Standard_Real theT1, const TopoDS_Vertex& theV2,
                                         const Standard_Real theT2, const Standard_Real theTolR3D, TopoDS_Edge& theE);
    ...
    Standard_EXPORT static void MakeSplitEdge(const TopoDS_Edge& aE1, const TopoDS_Vertex& aV1, const Standard_Real aP1,
                                              const TopoDS_Vertex& aV2, const Standard_Real aP2, TopoDS_Edge& aNewEdge);

    //! Make the edge from 3D-Curve <aIC>  and two vertices <aV1,aV2>
    //! at parameters <aP1,aP2>
    Standard_EXPORT static void MakeSectEdge(const IntTools_Curve& aIC, const TopoDS_Vertex& aV1,
                                             const Standard_Real aP1, const TopoDS_Vertex& aV2, const Standard_Real aP2,
...
public: //! @name Point/Edge/Face classification relatively solid
    ...
    //! Returns 3-D state.
    Standard_EXPORT static TopAbs_State ComputeState(const gp_Pnt& thePoint, const TopoDS_Solid& theSolid,
    ...
    //! theContext- cahed geometrical tools
    //! Returns 3-D state.
    Standard_EXPORT static TopAbs_State ComputeState(const TopoDS_Vertex& theVertex, const TopoDS_Solid& theSolid,
                                                     const Standard_Real theTol,
                                                     const Handle(IntTools_Context) & theContext);
    ...
    //! theContext- cahed geometrical tools
    //! Returns 3-D state.
    Standard_EXPORT static TopAbs_State ComputeState(const TopoDS_Edge& theEdge, const TopoDS_Solid& theSolid,
                                                     const Standard_Real theTol,
                                                     const Handle(IntTools_Context) & theContext);
    ...
    //! theContext- cahed geometrical tools
    //! Returns 3-D state.
    Standard_EXPORT static TopAbs_State ComputeState(const TopoDS_Face& theFace, const TopoDS_Solid& theSolid,
                                                     const Standard_Real theTol,
    ...
    Standard_EXPORT static TopAbs_State ComputeStateByOnePoint(const TopoDS_Shape& theShape,
                                                               const TopoDS_Solid& theSolid, const Standard_Real theTol,
                                                               const Handle(IntTools_Context) & theContext);
...
public: //! @name Face classification relatively solid
    ...
    Standard_EXPORT static Standard_Boolean GetFaceOff(const TopoDS_Edge& theEdge, const TopoDS_Face& theFace,
                                                       BOPTools_ListOfCoupleOfShape& theLCEF, TopoDS_Face& theFaceOff,
                                                       const Handle(IntTools_Context) & theContext);
    ...
    Standard_EXPORT static Standard_Integer IsInternalFace(const TopoDS_Face& theFace, const TopoDS_Edge& theEdge,
    ...
    //! theTol - value of precision of computation
    //! theContext- cahed geometrical tools
    Standard_EXPORT static Standard_Boolean IsInternalFace(const TopoDS_Face& theFace, const TopoDS_Solid& theSolid,
...
public: //! @name PCurve construction
    ...
    Standard_EXPORT static void MakePCurve(const TopoDS_Edge& theE, const TopoDS_Face& theF1, const TopoDS_Face& theF2,
                                           const IntTools_Curve& theCurve, const Standard_Boolean thePC1,
...
public: //! @name Wire classification relatively face
    ...
    Standard_EXPORT static Standard_Boolean IsHole(const TopoDS_Shape& theW, const TopoDS_Shape& theF);
...
public: //! @name Choosing correct orientation for the split shape
    ...
    Standard_EXPORT static Standard_Boolean IsSplitToReverse(const TopoDS_Shape& theSplit, const TopoDS_Shape& theShape,
                                                             const Handle(IntTools_Context) & theContext,
    ...
    //! @param theContext [in] cached geometrical tools
    //! @param theError [out] Error Status of the operation
    Standard_EXPORT static Standard_Boolean IsSplitToReverse(const TopoDS_Face& theSplit, const TopoDS_Face& theShape,
                                                             const Handle(IntTools_Context) & theContext,
                                                             Standard_Integer* theError = NULL);
    ...
    //! @param theContext [in] cached geometrical tools
    //! @param theError [out] Error Status of the operation
    Standard_EXPORT static Standard_Boolean IsSplitToReverse(const TopoDS_Edge& theSplit, const TopoDS_Edge& theShape,
                                                             const Handle(IntTools_Context) & theContext,
                                                             Standard_Integer* theError = NULL);
...
public: //! @name Making connexity blocks
    ...
    //! the treatment
    Standard_EXPORT static void MakeConnexityBlock(TopTools_ListOfShape& theLS, TopTools_IndexedMapOfShape& theMapAvoid,
    ...
    Standard_EXPORT static void MakeConnexityBlocks(const TopoDS_Shape& theS, const TopAbs_ShapeEnum theConnectionType,
...
public: //! Checking if the faces are coinciding
    ...
    Standard_EXPORT static Standard_Boolean AreFacesSameDomain(const TopoDS_Face& theF1, const TopoDS_Face& theF2,
                                                               const Handle(IntTools_Context) & theContext,
                                                               const Standard_Real theFuzz = Precision::Confusion());
...
public: //! @name Looking for the edge in the face
    ...
    //! edge founded
    Standard_EXPORT static Standard_Boolean GetEdgeOff(const TopoDS_Edge& theEdge, const TopoDS_Face& theFace,
    ...
    Standard_EXPORT static Standard_Boolean GetEdgeOnFace(const TopoDS_Edge& theEdge, const TopoDS_Face& theFace,
...
public: //! @name Correction of the edges range
    ...
    Standard_EXPORT static void CorrectRange(const TopoDS_Edge& aE1, const TopoDS_Edge& aE2, const IntTools_Range& aSR,
                                             IntTools_Range& aNewSR);

    //! Correct shrunk range <aSR> taking into account 3D-curve
    //! resolution and corresponding tolerance values of <aE>, <aF>
    Standard_EXPORT static void CorrectRange(const TopoDS_Edge& aE, const TopoDS_Face& aF, const IntTools_Range& aSR,
                                             IntTools_Range& aNewSR);
...
public: //! @name Edge/Face Deviation computation
    ...
    Standard_EXPORT static Standard_Boolean ComputeTolerance(const TopoDS_Face& theFace, const TopoDS_Edge& theEdge,
                                                             Standard_Real& theMaxDist, Standard_Real& theMaxPar);
...
public: //! @name Other methods
    ...
    Standard_EXPORT static Standard_Boolean IsBlockInOnFace(const IntTools_Range& aShR, const TopoDS_Face& aF,
                                                            const TopoDS_Edge& aE,
                                                            const Handle(IntTools_Context) & aContext);

    //! Returns the min and max dimensions of the shape <theS>.
    Standard_EXPORT static void Dimensions(const TopoDS_Shape& theS, Standard_Integer& theDMin,
    ...
    Standard_EXPORT static void TreatCompound(const TopoDS_Shape& theS, TopTools_ListOfShape& theList,
