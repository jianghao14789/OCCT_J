...
class BOPTools_Parallel {
    template <class TypeSolverVector> class Functor {
    public:
        //! Constructor.
    ...
    template <class TypeSolverVector, class TypeContext> class ContextFunctor {
        ...
        struct Hasher {
            ...
            static Standard_Integer HashCode(const Standard_ThreadId theThreadId,
                                             const Standard_Integer theUpperBound) {
                return ::HashCode(theThreadId, theUpperBound);
            }

            static Standard_Boolean IsEqual(const Standard_ThreadId theKey1, const Standard_ThreadId theKey2) {
    ...
    template <class TypeSolverVector, class TypeContext> class ContextFunctor2 {
    public:
        //! Constructor
        ...
        //! Binds main thread context
        void SetContext(const opencascade::handle<TypeContext>& theContext) {
            myContextArray.ChangeLast() =
                theContext; // OSD_ThreadPool::Launcher::UpperThreadIndex() is reserved for a main thread
        }
