...
class BOPTools_BoxSelector
    : public BVH_Traverse<Standard_Real, Dimension, BVH_BoxSet<Standard_Real, Dimension, Standard_Integer>,
                          Standard_Boolean> {
public:
...
public: //! @name Rejection/Acceptance rules
    ...
    virtual Standard_Boolean RejectNode(const BVH_VecNd& theCMin, const BVH_VecNd& theCMax,
