...
void RWStepAP214_RWAutoDesignDocumentReference::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                         const Standard_Integer num, Handle(Interface_Check) & ach,
                                                         const Handle(StepAP214_AutoDesignDocumentReference) &
                                                             ent) const {
...
void RWStepAP214_RWAutoDesignDocumentReference::WriteStep(StepData_StepWriter& SW,
                                                          const Handle(StepAP214_AutoDesignDocumentReference) &
                                                              ent) const {
...
void RWStepAP214_RWAutoDesignDocumentReference::Share(const Handle(StepAP214_AutoDesignDocumentReference) & ent,
