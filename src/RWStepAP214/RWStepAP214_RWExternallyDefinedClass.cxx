...
void RWStepAP214_RWExternallyDefinedClass::ReadStep(const Handle(StepData_StepReaderData) & data,
    ...
    data->ReadEntity(num, 4, "externally_defined_item.source", ach, STANDARD_TYPE(StepBasic_ExternalSource),
                     aExternallyDefinedItem_Source);

    // Initialize entity
    ent->Init(aGroup_Name, hasGroup_Description, aGroup_Description, aExternallyDefinedItem_ItemId,
              aExternallyDefinedItem_Source);
}
