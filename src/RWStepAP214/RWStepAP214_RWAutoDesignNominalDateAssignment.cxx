...
void RWStepAP214_RWAutoDesignNominalDateAssignment::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                             const Standard_Integer num, Handle(Interface_Check) & ach,
                                                             const Handle(StepAP214_AutoDesignNominalDateAssignment) &
                                                                 ent) const {
...
void RWStepAP214_RWAutoDesignNominalDateAssignment::WriteStep(StepData_StepWriter& SW,
                                                              const Handle(StepAP214_AutoDesignNominalDateAssignment) &
                                                                  ent) const {
...
void RWStepAP214_RWAutoDesignNominalDateAssignment::Share(const Handle(StepAP214_AutoDesignNominalDateAssignment) & ent,
