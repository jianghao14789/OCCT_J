...
void RWStepAP214_RWAppliedExternalIdentificationAssignment::ReadStep(
    ...
    data->ReadEntity(num, 2, "identification_assignment.role", ach, STANDARD_TYPE(StepBasic_IdentificationRole),
    ...
    data->ReadEntity(num, 3, "external_identification_assignment.source", ach, STANDARD_TYPE(StepBasic_ExternalSource),
    ...
    // Initialize entity
    ent->Init(aIdentificationAssignment_AssignedId, aIdentificationAssignment_Role,
              aExternalIdentificationAssignment_Source, aItems);
}
...
void RWStepAP214_RWAppliedExternalIdentificationAssignment::WriteStep(
    StepData_StepWriter& SW, const Handle(StepAP214_AppliedExternalIdentificationAssignment) & ent) const {
...
void RWStepAP214_RWAppliedExternalIdentificationAssignment::Share(
    const Handle(StepAP214_AppliedExternalIdentificationAssignment) & ent, Interface_EntityIterator& iter) const {
