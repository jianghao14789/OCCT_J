...
void RWStepAP214_RWAppliedDateAndTimeAssignment::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                          const Standard_Integer num, Handle(Interface_Check) & ach,
                                                          const Handle(StepAP214_AppliedDateAndTimeAssignment) &
                                                              ent) const {
...
void RWStepAP214_RWAppliedDateAndTimeAssignment::WriteStep(StepData_StepWriter& SW,
                                                           const Handle(StepAP214_AppliedDateAndTimeAssignment) &
                                                               ent) const {
...
void RWStepAP214_RWAppliedDateAndTimeAssignment::Share(const Handle(StepAP214_AppliedDateAndTimeAssignment) & ent,
