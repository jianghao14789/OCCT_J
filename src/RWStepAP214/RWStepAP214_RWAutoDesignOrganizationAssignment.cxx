...
void RWStepAP214_RWAutoDesignOrganizationAssignment::ReadStep(const Handle(StepData_StepReaderData) & data,
    ...
    data->ReadEntity(num, 1, "assigned_organization", ach, STANDARD_TYPE(StepBasic_Organization),
...
void RWStepAP214_RWAutoDesignOrganizationAssignment::WriteStep(
    StepData_StepWriter& SW, const Handle(StepAP214_AutoDesignOrganizationAssignment) & ent) const {
...
void RWStepAP214_RWAutoDesignOrganizationAssignment::Share(const Handle(StepAP214_AutoDesignOrganizationAssignment) &
                                                               ent,
