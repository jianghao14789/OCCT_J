...
void RWStepAP214_RWAutoDesignNominalDateAndTimeAssignment::WriteStep(
    StepData_StepWriter& SW, const Handle(StepAP214_AutoDesignNominalDateAndTimeAssignment) & ent) const {
...
void RWStepAP214_RWAutoDesignNominalDateAndTimeAssignment::Share(
    const Handle(StepAP214_AutoDesignNominalDateAndTimeAssignment) & ent, Interface_EntityIterator& iter) const {
