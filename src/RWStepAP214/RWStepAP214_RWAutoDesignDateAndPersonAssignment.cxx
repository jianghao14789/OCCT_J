...
void RWStepAP214_RWAutoDesignDateAndPersonAssignment::ReadStep(
    ...
    data->ReadEntity(num, 1, "assigned_person_and_organization", ach, STANDARD_TYPE(StepBasic_PersonAndOrganization),
...
void RWStepAP214_RWAutoDesignDateAndPersonAssignment::WriteStep(
    StepData_StepWriter& SW, const Handle(StepAP214_AutoDesignDateAndPersonAssignment) & ent) const {
...
void RWStepAP214_RWAutoDesignDateAndPersonAssignment::Share(const Handle(StepAP214_AutoDesignDateAndPersonAssignment) &
                                                                ent,
