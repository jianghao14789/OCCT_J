...
void RWStepAP214_RWAutoDesignPresentedItem::ReadStep(const Handle(StepData_StepReaderData) & data,
    ...
    if (data->ReadSubList(num, 1, "items", ach, nsub1)) {
        ...
        for (Standard_Integer i1 = 1; i1 <= nb1; i1++) {
            Standard_Boolean stat1 = data->ReadEntity(nsub1, i1, "auto_design_displayed_item", ach, anent1);
...
void RWStepAP214_RWAutoDesignPresentedItem::WriteStep(StepData_StepWriter& SW,
                                                      const Handle(StepAP214_AutoDesignPresentedItem) & ent) const {
...
void RWStepAP214_RWAutoDesignPresentedItem::Share(const Handle(StepAP214_AutoDesignPresentedItem) & ent,
