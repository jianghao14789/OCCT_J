...
void RWStepAP214_RWExternallyDefinedGeneralProperty::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                              ...
                                                              const Handle(StepAP214_ExternallyDefinedGeneralProperty) &
                                                                  ent) const {
    ...
    data->ReadEntity(num, 5, "externally_defined_item.source", ach, STANDARD_TYPE(StepBasic_ExternalSource),
                     aExternallyDefinedItem_Source);

    // Initialize entity
    ent->Init(aGeneralProperty_Id, aGeneralProperty_Name, hasGeneralProperty_Description, aGeneralProperty_Description,
              aExternallyDefinedItem_ItemId, aExternallyDefinedItem_Source);
}
...
void RWStepAP214_RWExternallyDefinedGeneralProperty::WriteStep(
    StepData_StepWriter& SW, const Handle(StepAP214_ExternallyDefinedGeneralProperty) & ent) const {
...
void RWStepAP214_RWExternallyDefinedGeneralProperty::Share(const Handle(StepAP214_ExternallyDefinedGeneralProperty) &
                                                               ent,
