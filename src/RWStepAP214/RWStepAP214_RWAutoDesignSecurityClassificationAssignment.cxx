...
void RWStepAP214_RWAutoDesignSecurityClassificationAssignment::ReadStep(
    ...
    data->ReadEntity(num, 1, "assigned_security_classification", ach, STANDARD_TYPE(StepBasic_SecurityClassification),
    ...
    if (data->ReadSubList(num, 2, "items", ach, nsub2)) {
        ...
        for (Standard_Integer i2 = 1; i2 <= nb2; i2++) {
            Standard_Boolean stat2 = data->ReadEntity(nsub2, i2, "auto_design_security_classified_item", ach,
                                                      STANDARD_TYPE(StepBasic_Approval), anent2);
...
void RWStepAP214_RWAutoDesignSecurityClassificationAssignment::WriteStep(
    StepData_StepWriter& SW, const Handle(StepAP214_AutoDesignSecurityClassificationAssignment) & ent) const {
...
void RWStepAP214_RWAutoDesignSecurityClassificationAssignment::Share(
    const Handle(StepAP214_AutoDesignSecurityClassificationAssignment) & ent, Interface_EntityIterator& iter) const {
