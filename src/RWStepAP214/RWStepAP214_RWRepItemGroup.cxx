...
void RWStepAP214_RWRepItemGroup::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepAP214_RWRepItemGroup::WriteStep(StepData_StepWriter& SW, const Handle(StepAP214_RepItemGroup) & ent) const {
...
void RWStepAP214_RWRepItemGroup::Share(const Handle(StepAP214_RepItemGroup) &, Interface_EntityIterator&) const {
    // Inherited fields of Group
    // Inherited fields of RepresentationItem
}
