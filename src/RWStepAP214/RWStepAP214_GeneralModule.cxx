...
void RWStepAP214_GeneralModule::FillSharedCase(const Standard_Integer CN, const Handle(Standard_Transient) & ent,
                                               Interface_EntityIterator& iter) const {
    switch (CN) {
...
void RWStepAP214_GeneralModule::CheckCase(const Standard_Integer CN, const Handle(Standard_Transient) & ent,
...
void RWStepAP214_GeneralModule::CopyCase(const Standard_Integer /*CN*/, const Handle(Standard_Transient) & /*entfrom*/,
...
Standard_Boolean RWStepAP214_GeneralModule::NewVoid(const Standard_Integer CN, Handle(Standard_Transient) & ent) const {
...
Standard_Integer RWStepAP214_GeneralModule::CategoryNumber(const Standard_Integer CN,
                                                           const Handle(Standard_Transient) & /*ent*/,
...
Handle(TCollection_HAsciiString) RWStepAP214_GeneralModule::Name(const Standard_Integer /*CN*/,
                                                                 const Handle(Standard_Transient) & /*ent*/,
