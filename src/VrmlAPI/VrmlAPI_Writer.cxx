...
Standard_Boolean VrmlAPI_Writer::Write(const TopoDS_Shape& aShape, const Standard_CString aFile,
...
Standard_Boolean VrmlAPI_Writer::write_v1(const TopoDS_Shape& aShape, const Standard_CString aFile) const {
    ...
    if (myRepresentation == VrmlAPI_BothRepresentation)
        Vrml::CommentWriter(" This file contents both Shaded and Wire Frame representation of selected Shape ",
                            *anOutFile);
...
// purpose  :
//=======================================================================
Standard_Boolean VrmlAPI_Writer::WriteDoc(const Handle(TDocStd_Document) & theDoc, const Standard_CString theFile,
