...
public:
    //! constructor
    MeshTest_CheckTopology(const TopoDS_Shape& theShape) : myShape(theShape) {}
    ...
    Standard_EXPORT void GetFreeLink(const Standard_Integer theFaceIndex, const Standard_Integer theLinkIndex,
    ...
    Standard_EXPORT void GetCrossFaceError(const Standard_Integer theIndex, Standard_Integer& theFace1,
    ...
    void GetFreeNodeNum(const Standard_Integer theIndex, Standard_Integer& theFaceNum,
    ...
    //! this face.
    void GetSmallTriangle(const Standard_Integer theIndex, Standard_Integer& theFaceNum,
                          Standard_Integer& theNodeNum) const {
