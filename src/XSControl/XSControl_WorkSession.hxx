...
public:
    ...
    SetAllContext(const NCollection_DataMap<TCollection_AsciiString, Handle(Standard_Transient)>& theContext);
    ...
    Standard_EXPORT Standard_Boolean PrintTransferStatus(const Standard_Integer theNum, const Standard_Boolean theWri,
    ...
    Standard_EXPORT Handle(Standard_Transient)
        Result(const Handle(Standard_Transient) & theEnt, const Standard_Integer theMode) const;
    ...
    Standard_EXPORT Standard_Integer TransferReadOne(
        const Handle(Standard_Transient) & theEnts, const Message_ProgressRange& theProgress = Message_ProgressRange());
    ...
    TransferWriteShape(const TopoDS_Shape& theShape, const Standard_Boolean theCompGraph = Standard_True,
