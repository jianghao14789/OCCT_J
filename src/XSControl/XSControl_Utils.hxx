...
public:
    ...
    Standard_EXPORT Handle(Standard_Transient)
        TraValue(const Handle(Standard_Transient) & list, const Standard_Integer num) const;
    ...
    Standard_EXPORT Standard_CString DateString(const Standard_Integer yy, const Standard_Integer mm,
                                                const Standard_Integer dd, const Standard_Integer hh,
                                                const Standard_Integer mn, const Standard_Integer ss) const;

    Standard_EXPORT void DateValues(const Standard_CString text, Standard_Integer& yy, Standard_Integer& mm,
    ...
    //! Default is a HShape
    Standard_EXPORT Handle(Standard_Transient)
        ShapeBinder(const TopoDS_Shape& shape, const Standard_Boolean hs = Standard_True) const;
    ...
    Standard_EXPORT Handle(Standard_Transient)
        SeqToArr(const Handle(Standard_Transient) & seq, const Standard_Integer first = 1) const;
