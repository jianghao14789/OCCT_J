...
public:
    ...
    Standard_EXPORT Handle(TColStd_HSequenceOfTransient)
        GiveList(const Standard_CString first = "", const Standard_CString second = "");
    ...
    Standard_EXPORT Handle(TColStd_HSequenceOfTransient)
        GiveList(const Standard_CString first, const Handle(Standard_Transient) & ent);
    ...
    TransferOneRoot(const Standard_Integer num = 1, const Message_ProgressRange& theProgress = Message_ProgressRange());
    ...
    Standard_EXPORT void PrintCheckLoad(Standard_OStream& theStream, const Standard_Boolean failsonly,
    ...
    Standard_EXPORT void PrintCheckTransfer(Standard_OStream& theStream, const Standard_Boolean failsonly,
                                            const IFSelect_PrintCount mode) const;
    ...
    Standard_EXPORT void PrintStatsTransfer(Standard_OStream& theStream, const Standard_Integer what,
                                            const Standard_Integer mode = 0) const;

    //! Gives statistics about Transfer
    Standard_EXPORT void GetStatsTransfer(const Handle(TColStd_HSequenceOfTransient) & list, Standard_Integer& nbMapped,
