...
void StepBasic_ApprovalPersonOrganization::Init(const StepBasic_PersonOrganizationSelect& aPersonOrganization,
...
void StepBasic_ApprovalPersonOrganization::SetAuthorizedApproval(const Handle(StepBasic_Approval) &
                                                                 aAuthorizedApproval) {
    authorizedApproval = aAuthorizedApproval;
}
