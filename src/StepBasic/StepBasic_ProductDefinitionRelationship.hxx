...
public:
    ...
    Standard_EXPORT void SetRelatingProductDefinition(const Handle(StepBasic_ProductDefinition) &
                                                      RelatingProductDefinition);

    //! Set field RelatingProductDefinition in AP242
    Standard_EXPORT void
    SetRelatingProductDefinition(const StepBasic_ProductDefinitionOrReference& RelatingProductDefinition);
    ...
    Standard_EXPORT void SetRelatedProductDefinition(const Handle(StepBasic_ProductDefinition) &
                                                     RelatedProductDefinition);

    //! Set field RelatedProductDefinition in AP242
    Standard_EXPORT void
    SetRelatedProductDefinition(const StepBasic_ProductDefinitionOrReference& RelatedProductDefinition);
