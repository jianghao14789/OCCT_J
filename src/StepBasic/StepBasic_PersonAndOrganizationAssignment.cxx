...
void StepBasic_PersonAndOrganizationAssignment::Init(const Handle(StepBasic_PersonAndOrganization) &
...
Handle(StepBasic_PersonAndOrganization)
    StepBasic_PersonAndOrganizationAssignment::AssignedPersonAndOrganization() const {
