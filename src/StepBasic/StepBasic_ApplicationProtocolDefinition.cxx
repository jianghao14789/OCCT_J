...
void StepBasic_ApplicationProtocolDefinition::Init(const Handle(TCollection_HAsciiString) & aStatus,
...
Handle(TCollection_HAsciiString)
    StepBasic_ApplicationProtocolDefinition::ApplicationInterpretedModelSchemaName() const {
...
void StepBasic_ApplicationProtocolDefinition::SetApplication(const Handle(StepBasic_ApplicationContext) &
                                                             aApplication) {
    application = aApplication;
}
