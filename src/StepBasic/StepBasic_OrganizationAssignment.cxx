...
void StepBasic_OrganizationAssignment::Init(const Handle(StepBasic_Organization) & aAssignedOrganization,
...
void StepBasic_OrganizationAssignment::SetAssignedOrganization(const Handle(StepBasic_Organization) &
