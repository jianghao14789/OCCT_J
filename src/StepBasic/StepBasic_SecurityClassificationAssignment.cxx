...
void StepBasic_SecurityClassificationAssignment::Init(const Handle(StepBasic_SecurityClassification) &
...
Handle(StepBasic_SecurityClassification)
    StepBasic_SecurityClassificationAssignment::AssignedSecurityClassification() const {
