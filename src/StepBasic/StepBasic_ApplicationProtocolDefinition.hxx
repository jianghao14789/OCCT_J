...
public:
    ...
    Standard_EXPORT void Init(const Handle(TCollection_HAsciiString) & aStatus,
    ...
    Standard_EXPORT void SetApplicationInterpretedModelSchemaName(const Handle(TCollection_HAsciiString) &
