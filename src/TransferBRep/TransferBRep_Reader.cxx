...
TransferBRep_Reader::TransferBRep_Reader() : theDone(Standard_False), theFilest(0), theNewpr(Standard_False) {
...
Standard_Boolean TransferBRep_Reader::Transfer(const Standard_Integer num, const Message_ProgressRange& theProgress) {
...
void TransferBRep_Reader::TransferList(const Handle(TColStd_HSequenceOfTransient) & list,
    ...
    if (theProc->TraceLevel() > 1) sout << "--  Transfer(Read-List) : " << nb << " Items" << std::endl;
