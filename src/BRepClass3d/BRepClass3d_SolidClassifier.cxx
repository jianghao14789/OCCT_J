...
BRepClass3d_SolidClassifier::BRepClass3d_SolidClassifier(const TopoDS_Shape& S)
    : aSolidLoaded(Standard_True), explorer(S), isaholeinspace(Standard_False) {
#if LBRCOMPT
    STAT.NbConstrShape++;
#endif
#if MARCHEPASSIUNESEULEFACE
...
BRepClass3d_SolidClassifier::BRepClass3d_SolidClassifier(const TopoDS_Shape& S, const gp_Pnt& P,
