...
public:
    BRepClass3d_BndBoxTreeSelectorLine(const TopTools_IndexedMapOfShape& theMapOfShape)
        : BRepClass3d_BndBoxTreeSelectorLine::Selector(), myMapOfShape(theMapOfShape), myIsValid(Standard_True) {}
    ...
    void GetEdgeParam(const Standard_Integer i, TopoDS_Edge& theOutE, Standard_Real& theOutParam,
