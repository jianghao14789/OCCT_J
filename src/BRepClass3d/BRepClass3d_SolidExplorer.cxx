...
//=======================================================================
Standard_Boolean BRepClass3d_SolidExplorer::FindAPointInTheFace(const TopoDS_Face& _face, gp_Pnt& APoint_,
...
Standard_Boolean BRepClass3d_SolidExplorer::FindAPointInTheFace(const TopoDS_Face& _face, gp_Pnt& APoint_,
                                                                Standard_Real& u_, Standard_Real& v_,
                                                                Standard_Real& param_, gp_Vec& theVecD1U,
                                                                gp_Vec& theVecD1V) {
    ...
    for (faceexplorer.Init(face, TopAbs_EDGE); faceexplorer.More(); faceexplorer.Next()) {
        ...
        while (APointExist) {
            ...
            if (StateOfResultingPoint != TopAbs_IN) return Standard_False;

            BRepAdaptor_Surface s;
            s.Initialize(face, Standard_False);
            s.D1(u_, v_, APoint_, theVecD1U, theVecD1V);

            if (theVecD1U.CrossMagnitude(theVecD1V) > gp::Resolution()) return Standard_True;

            if (ParamInit < Precision::PConfusion()) return Standard_False;
        }
    }
...
Standard_Boolean BRepClass3d_SolidExplorer::PointInTheFace(const TopoDS_Face& Face, gp_Pnt& APoint_, Standard_Real& u_,
                                                           Standard_Real& v_, Standard_Real& param_,
                                                           Standard_Integer& IndexPoint,
                                                           const Handle(BRepAdaptor_Surface) & surf,
                                                           const Standard_Real U1, const Standard_Real V1,
                                                           const Standard_Real U2, const Standard_Real V2) const {
    gp_Vec aVecD1U, aVecD1V;
    return PointInTheFace(Face, APoint_, u_, v_, param_, IndexPoint, surf, U1, V1, U2, V2, aVecD1U, aVecD1V);
}
...
Standard_Boolean BRepClass3d_SolidExplorer::PointInTheFace(const TopoDS_Face& Face, gp_Pnt& APoint_, Standard_Real& u_,
                                                           ...
                                                           gp_Vec& theVecD1U, gp_Vec& theVecD1V) const {
    ...
    return BRepClass3d_SolidExplorer ::FindAPointInTheFace(Face, APoint_, u_, v_, param_, theVecD1U, theVecD1V);
}
...
//=======================================================================
static void LimitInfiniteUV(Standard_Real& U1, Standard_Real& V1, Standard_Real& U2, Standard_Real& V2) {
    Standard_Boolean infU1 = Precision::IsNegativeInfinite(U1), infV1 = Precision::IsNegativeInfinite(V1),
...
// purpose  :
//=======================================================================
static Standard_Integer IsInfiniteUV(Standard_Real& U1, Standard_Real& V1, Standard_Real& U2, Standard_Real& V2) {
    Standard_Integer aVal = 0;

    if (Precision::IsInfinite(U1)) aVal |= 1;

    if (Precision::IsInfinite(V1)) aVal |= 2;

    if (Precision::IsInfinite(U2)) aVal |= 4;

    if (Precision::IsInfinite(V2)) aVal |= 8;
...
//           and so on.
//=======================================================================
Standard_Integer BRepClass3d_SolidExplorer::OtherSegment(const gp_Pnt& P, gp_Lin& L, Standard_Real& _Par) {
    ...
    for (;;) {
        ...
        for (; faceexplorer.More(); faceexplorer.Next()) {
            ...
            if (aTestInvert) {
                ...
                if (aClass.PerformInfinitePoint() == TopAbs_IN) {
                    ...
                    if (myMapOfInter.IsBound(face)) {
                        ...
                        void* ptr = (void*)(new IntCurvesFace_Intersector(face, Precision::Confusion(), aRestr,
                                                                          Standard_False));
            ...
            do {
                if (PointInTheFace(face, APoint, _u, _v, myParamOnEdge, ++IndexPoint, surf, U1, V1, U2, V2, aVecD1U,
                                   aVecD1V)) {
                    ++NbPointsOK;
                    gp_Vec V(P, APoint);
                    Par = V.Magnitude();
...
Standard_Boolean BRepClass3d_SolidExplorer::PointInTheFace(const TopoDS_Face& _face, gp_Pnt& APoint_, Standard_Real& u_,
                                                           Standard_Real& v_, Standard_Real& param_,
...
Standard_Boolean BRepClass3d_SolidExplorer::FindAPointInTheFace(const TopoDS_Face& _face, Standard_Real& u_,
                                                                Standard_Real& v_) {
    gp_Pnt APoint;
...
BRepClass3d_SolidExplorer::BRepClass3d_SolidExplorer() : myReject(Standard_True), myFirstFace(0), myParamOnEdge(0.0) {}
...
void BRepClass3d_SolidExplorer::DumpSegment(const gp_Pnt&, const gp_Lin&, const Standard_Real,
