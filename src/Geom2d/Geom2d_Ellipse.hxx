...
public:
    ...
    Standard_EXPORT Geom2d_Ellipse(const gp_Ax2d& MajorAxis, const Standard_Real MajorRadius,
    ...
    //! - MajorRadius is less than MinorRadius, or
    //! - MinorRadius is less than 0.
    Standard_EXPORT Geom2d_Ellipse(const gp_Ax22d& Axis, const Standard_Real MajorRadius,
