...
public:
    ...
    Standard_EXPORT Geom2d_Hyperbola(const gp_Ax2d& MajorAxis, const Standard_Real MajorRadius,
    ...
    //! the minor radius is on the "YAxis" of the hyperbola.
    //! Raised if MajorRadius < 0.0 or if MinorRadius < 0.0
    Standard_EXPORT Geom2d_Hyperbola(const gp_Ax22d& Axis, const Standard_Real MajorRadius,
