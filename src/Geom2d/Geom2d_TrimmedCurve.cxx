...
Geom2d_TrimmedCurve::Geom2d_TrimmedCurve(const Handle(Geom2d_Curve) & C, const Standard_Real U1, const Standard_Real U2,
...
void Geom2d_TrimmedCurve::SetTrim(const Standard_Real U1, const Standard_Real U2, const Standard_Boolean Sense,
                                  const Standard_Boolean theAdjustPeriodic) {
    Standard_Boolean sameSense = Standard_True;
    if (U1 == U2) throw Standard_ConstructionError("Geom2d_TrimmedCurve::U1 == U2");
...
Standard_Real Geom2d_TrimmedCurve::TransformedParameter(const Standard_Real U, const gp_Trsf2d& T) const {
