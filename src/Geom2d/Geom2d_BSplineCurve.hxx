...
public:
    ...
    Standard_EXPORT Geom2d_BSplineCurve(const TColgp_Array1OfPnt2d& Poles, const TColStd_Array1OfReal& Knots,
    ...
    //!
    //! Poles.Length() == Sum(Mults(i)) except the first or last
    Standard_EXPORT Geom2d_BSplineCurve(const TColgp_Array1OfPnt2d& Poles, const TColStd_Array1OfReal& Weights,
    ...
    Standard_EXPORT void IncreaseMultiplicity(const Standard_Integer I1, const Standard_Integer I2,
    ...
    Standard_EXPORT void IncrementMultiplicity(const Standard_Integer I1, const Standard_Integer I2,
                                               const Standard_Integer M);
    ...
    //! this BSpline curve.
    Standard_EXPORT void InsertKnot(const Standard_Real U, const Standard_Integer M = 1,
    ...
    //! - The multiplicity of a knot is limited to the degree of
    //! this BSpline curve.
    Standard_EXPORT void InsertKnots(const TColStd_Array1OfReal& Knots, const TColStd_Array1OfInteger& Mults,
                                     const Standard_Real ParametricTolerance = 0.0,
    ...
    //! bounds of the knots table.
    Standard_EXPORT Standard_Boolean RemoveKnot(const Standard_Integer Index, const Standard_Integer M,
    ...
    Standard_EXPORT void InsertPoleAfter(const Standard_Integer Index, const gp_Pnt2d& P,
    ...
    //! Weight <= 0.0
    //! Raised if Index is not in the range [1, Number of Poles]
    Standard_EXPORT void InsertPoleBefore(const Standard_Integer Index, const gp_Pnt2d& P,
                                          const Standard_Real Weight = 1.0);
    ...
    Standard_EXPORT void MovePoint(const Standard_Real U, const gp_Pnt2d& P, const Standard_Integer Index1,
    ...
    Standard_EXPORT void MovePointAndTangent(const Standard_Real U, const gp_Pnt2d& P, const gp_Vec2d& Tangent,
    ...
    Standard_EXPORT Standard_Boolean IsG1(const Standard_Real theTf, const Standard_Real theTl,
    ...
    Standard_EXPORT gp_Pnt2d LocalValue(const Standard_Real U, const Standard_Integer FromK1,
                                        const Standard_Integer ToK2) const;

    //! Raised if FromK1 = ToK2.
    Standard_EXPORT void LocalD0(const Standard_Real U, const Standard_Integer FromK1, const Standard_Integer ToK2,
                                 gp_Pnt2d& P) const;

    //! Raised if the local continuity of the curve is not C1
    //! between the knot K1 and the knot K2.
    //! Raised if FromK1 = ToK2.
    Standard_EXPORT void LocalD1(const Standard_Real U, const Standard_Integer FromK1, const Standard_Integer ToK2,
                                 gp_Pnt2d& P, gp_Vec2d& V1) const;

    //! Raised if the local continuity of the curve is not C2
    //! between the knot K1 and the knot K2.
    //! Raised if FromK1 = ToK2.
    Standard_EXPORT void LocalD2(const Standard_Real U, const Standard_Integer FromK1, const Standard_Integer ToK2,
                                 gp_Pnt2d& P, gp_Vec2d& V1, gp_Vec2d& V2) const;

    //! Raised if the local continuity of the curve is not C3
    //! between the knot K1 and the knot K2.
    //! Raised if FromK1 = ToK2.
    Standard_EXPORT void LocalD3(const Standard_Real U, const Standard_Integer FromK1, const Standard_Integer ToK2,
    ...
    //! Raised if FromK1 = ToK2.
    //! Raised if N < 1.
    Standard_EXPORT gp_Vec2d LocalDN(const Standard_Real U, const Standard_Integer FromK1, const Standard_Integer ToK2,
