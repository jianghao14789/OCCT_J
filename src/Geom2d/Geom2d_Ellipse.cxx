...
Geom2d_Ellipse::Geom2d_Ellipse(const Ax2d& MajorAxis, const Standard_Real MajorRadius, const Standard_Real MinorRadius,
...
Geom2d_Ellipse::Geom2d_Ellipse(const gp_Ax22d& Axis, const Standard_Real MajorRadius, const Standard_Real MinorRadius)
    : majorRadius(MajorRadius), minorRadius(MinorRadius) {
    if (MajorRadius < MinorRadius || MinorRadius < 0.0) {
        throw Standard_ConstructionError();
    }
...
Pnt2d Geom2d_Ellipse::Focus1() const {
    ...
    return Pnt2d(pos.Location().X() + C * pos.XDirection().X(), pos.Location().Y() + C * pos.XDirection().Y());
}
