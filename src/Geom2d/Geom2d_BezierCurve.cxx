...
Geom2d_BezierCurve::Geom2d_BezierCurve(const TColgp_Array1OfPnt2d& Poles, const TColStd_Array1OfReal& Weights)
...
void Geom2d_BezierCurve::InsertPoleAfter(const Standard_Integer Index, const gp_Pnt2d& P, const Standard_Real Weight) {
    Standard_Integer nbpoles = NbPoles();

    Standard_ConstructionError_Raise_if(nbpoles >= Geom2d_BezierCurve::MaxDegree() || Weight <= gp::Resolution(),
...
void Geom2d_BezierCurve::InsertPoleBefore(const Standard_Integer Index, const gp_Pnt2d& P, const Standard_Real Weight) {
...
void Geom2d_BezierCurve::SetPole(const Standard_Integer Index, const gp_Pnt2d& P, const Standard_Real Weight) {
    SetPole(Index, P);
...
void Geom2d_BezierCurve::D3(const Standard_Real U, gp_Pnt2d& P, gp_Vec2d& V1, gp_Vec2d& V2, gp_Vec2d& V3) const {
...
Standard_Real Geom2d_BezierCurve::Weight(const Standard_Integer Index) const {
    Standard_OutOfRange_Raise_if(Index < 1 || Index > weights->Length(), "Geom2d_BezierCurve::Weight");
    if (IsRational())
