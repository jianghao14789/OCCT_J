...
Geom2d_OffsetCurve::Geom2d_OffsetCurve(const Handle(Geom2d_Curve) & theCurve, const Standard_Real theOffset,
...
void Geom2d_OffsetCurve::SetBasisCurve(const Handle(Geom2d_Curve) & C, const Standard_Boolean isNotCheckC0) {
    ...
    if (isC0 && aCheckingCurve->IsKind(STANDARD_TYPE(Geom2d_BSplineCurve))) {
        ...
        if (isC0) throw Standard_ConstructionError("Offset on C0 curve");
    }
    //
    if (isTrimmed) {
...
void Geom2d_OffsetCurve::D2(const Standard_Real theU, gp_Pnt2d& theP, gp_Vec2d& theV1, gp_Vec2d& theV2) const {
...
void Geom2d_OffsetCurve::D3(const Standard_Real theU, gp_Pnt2d& theP, gp_Vec2d& theV1, gp_Vec2d& theV2,
...
Standard_Real Geom2d_OffsetCurve::TransformedParameter(const Standard_Real U, const gp_Trsf2d& T) const {
