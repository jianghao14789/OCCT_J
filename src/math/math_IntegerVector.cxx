...
math_IntegerVector::math_IntegerVector(const Standard_Integer theFirst, const Standard_Integer theLast)
    : myLocArray(theLast - theFirst + 1), Array(myLocArray[0], theFirst, theLast) {
    //
}
...
math_IntegerVector::math_IntegerVector(const Standard_Integer* theTab, const Standard_Integer theFirst,
...
void math_IntegerVector::Set(const Standard_Integer theI1, const Standard_Integer theI2,
                             const math_IntegerVector& theV) {
    Standard_DimensionError_Raise_if(
        (theI1 < Lower()) || (theI2 > Upper()) || (theI1 > theI2) || (theI2 - theI1 + 1 != theV.Length()), " ");
...
math_IntegerVector math_IntegerVector::Slice(const Standard_Integer theI1, const Standard_Integer theI2) const {
    Standard_DimensionError_Raise_if((theI1 < Lower()) || (theI1 > Upper()) || (theI2 < Lower()) || (theI2 > Upper()),
                                     " ");
...
void math_IntegerVector::Subtract(const math_IntegerVector& theLeft, const math_IntegerVector& theRight) {
    Standard_DimensionError_Raise_if((Length() != theRight.Length()) || (theRight.Length() != theLeft.Length()), " ");
