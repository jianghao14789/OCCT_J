...
math_Vector::math_Vector(const Standard_Integer theLower, const Standard_Integer theUpper)
    : myLocArray(theUpper - theLower + 1), Array(myLocArray[0], theLower, theUpper) {
    //
}
...
math_Vector::math_Vector(const Standard_Real* theTab, const Standard_Integer theLower, const Standard_Integer theUpper)
    : Array(*theTab, theLower, theUpper) {
    Standard_RangeError_Raise_if((theLower > theUpper), "math_Vector() - invalid dimensions");
}

math_Vector::math_Vector(const gp_XY& theOther) : myLocArray(2), Array(myLocArray[0], 1, 2) {
    Array(1) = theOther.X();
    Array(2) = theOther.Y();
}

math_Vector::math_Vector(const gp_XYZ& theOther) : myLocArray(3), Array(myLocArray[0], 1, 3) {
    Array(1) = theOther.X();
    Array(2) = theOther.Y();
    Array(3) = theOther.Z();
}
...
math_Vector::math_Vector(const math_Vector& theOther)
    : myLocArray(theOther.Length()), Array(myLocArray[0], theOther.Lower(), theOther.Upper()) {
...
void math_Vector::Set(const Standard_Integer theI1, const Standard_Integer theI2, const math_Vector& theV) {
...
void math_Vector::Normalize() {
    ...
    Standard_NullValue_Raise_if((Result <= RealEpsilon()), "math_Vector::Normalize() - vector has zero norm");
    for (Standard_Integer Index = Lower(); Index <= Upper(); Index++) {
...
void math_Vector::Divide(const Standard_Real theRight) {
    Standard_DivideByZero_Raise_if(Abs(theRight) <= RealEpsilon(), "math_Vector::Divide() - devisor is zero");
...
math_Vector math_Vector::Divided(const Standard_Real theRight) const {
    Standard_DivideByZero_Raise_if(Abs(theRight) <= RealEpsilon(), "math_Vector::Divided() - devisor is zero");
...
void math_Vector::Multiply(const math_Matrix& theLeft, const math_Vector& theRight) {
    Standard_DimensionError_Raise_if((Length() != theLeft.RowNumber()) || (theLeft.ColNumber() != theRight.Length()),
...
void math_Vector::Multiply(const math_Vector& theLeft, const math_Matrix& theRight) {
    Standard_DimensionError_Raise_if((Length() != theRight.ColNumber()) || (theLeft.Length() != theRight.RowNumber()),
                                     "math_Vector::Multiply() - input matrix and/or vector have wrong dimensions");
...
void math_Vector::TMultiply(const math_Matrix& theTLeft, const math_Vector& theRight) {
    Standard_DimensionError_Raise_if((Length() != theTLeft.ColNumber()) || (theTLeft.RowNumber() != theRight.Length()),
...
void math_Vector::TMultiply(const math_Vector& theLeft, const math_Matrix& theTRight) {
    Standard_DimensionError_Raise_if((Length() != theTRight.RowNumber()) || (theLeft.Length() != theTRight.ColNumber()),
                                     "math_Vector::TMultiply() - input matrix and/or vector have wrong dimensions");
