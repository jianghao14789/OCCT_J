...
void math::GaussPoints(const Standard_Integer Index, math_Vector& GPoint) {
    ...
    for (i = 1; i <= ind; i++) {
        ...
        if ((i + ind) <= Index) GPoint(i + ind) = -GPoint(i);
    }
}
...
void math::GaussWeights(const Standard_Integer Index, math_Vector& GWeight) {
    ...
    for (i = 1; i <= ind; i++) {
        ...
        if ((i + ind) <= Index) GWeight(i + ind) = GWeight(i);
    }
}
...
Standard_Boolean math::OrderedGaussPointsAndWeights(const Standard_Integer Index, math_Vector& Points,
                                                    math_Vector& Weights) {
    ...
    if (Index <= 61) {
        ...
        if (!PWcomputer.IsDone()) return Standard_False;
