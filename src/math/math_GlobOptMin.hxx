...
public:
    ...
    Standard_EXPORT math_GlobOptMin(math_MultipleVarFunction* theFunc, const math_Vector& theLowerBorder,
                                    const math_Vector& theUpperBorder, const Standard_Real theC = 9,
    ...
    //! @param theDiscretizationTol - parameter space discretization tolerance.
    //! @param theSameTol - functional value space indifference tolerance.
    Standard_EXPORT void SetGlobalParams(math_MultipleVarFunction* theFunc, const math_Vector& theLowerBorder,
                                         const math_Vector& theUpperBorder, const Standard_Real theC = 9,
                                         const Standard_Real theDiscretizationTol = 1.0e-2,
                                         const Standard_Real theSameTol = 1.0e-7);
    ...
    //! @param theDiscretizationTol - parameter space discretization tolerance.
    //! @param theSameTol - functional value space indifference tolerance.
    Standard_EXPORT void SetTol(const Standard_Real theDiscretizationTol, const Standard_Real theSameTol);
    ...
    inline Standard_Integer GetContinuity() const {
        return myCont;
    }
    ...
    inline Standard_Real GetFunctionalMinimalValue() const {
    ...
    inline Standard_Boolean GetLipConstState() const {
        return myIsConstLocked;
    }
    ...
    inline Standard_Real GetF() const {
        return myF;
    }

    //! Return count of global extremas.
    inline Standard_Integer NbExtrema() const {
        return mySolCount;
    }
...
private:
    ...
    public:
        ...
        void Shift(const Point& thePnt, const NCollection_Array1<Standard_Real>& theTol, Point& theLowPnt,
