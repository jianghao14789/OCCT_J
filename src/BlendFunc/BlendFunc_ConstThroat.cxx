...
BlendFunc_ConstThroat::BlendFunc_ConstThroat(const Handle(Adaptor3d_Surface) & S1, const Handle(Adaptor3d_Surface) & S2,
                                             const Handle(Adaptor3d_Curve) & C)
    : BlendFunc_GenChamfer(S1, S2, C), istangent(Standard_False), param(0.0), Throat(0.0), normtg(0.0), theD(0.0) {}
...
void BlendFunc_ConstThroat::Set(const Standard_Real aThroat, const Standard_Real, const Standard_Integer Choix) {
    Throat = aThroat;
    choix = Choix;
}
...
const gp_Vec& BlendFunc_ConstThroat::TangentOnS1() const {
    if (istangent) throw Standard_DomainError("BlendFunc_ConstThroat::TangentOnS1");
    return tg1;
}
...
const gp_Vec& BlendFunc_ConstThroat::TangentOnS2() const {
    if (istangent) throw Standard_DomainError("BlendFunc_ConstThroat::TangentOnS2");
    return tg2;
}
...
const gp_Vec2d& BlendFunc_ConstThroat::Tangent2dOnS1() const {
    if (istangent) throw Standard_DomainError("BlendFunc_ConstThroat::Tangent2dOnS1");
    return tg12d;
}
...
const gp_Vec2d& BlendFunc_ConstThroat::Tangent2dOnS2() const {
    if (istangent) throw Standard_DomainError("BlendFunc_ConstThroat::Tangent2dOnS2");
    return tg22d;
}
...
void BlendFunc_ConstThroat::Tangent(const Standard_Real U1, const Standard_Real V1, const Standard_Real U2,
