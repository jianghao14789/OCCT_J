...
BlendFunc_CSCircular::BlendFunc_CSCircular(const Handle(Adaptor3d_Surface) & S, const Handle(Adaptor3d_Curve) & C,
                                           const Handle(Adaptor3d_Curve) & CGuide, const Handle(Law_Function) & L)
...
const gp_Vec& BlendFunc_CSCircular::TangentOnS() const {
    if (istangent) throw Standard_DomainError("BlendFunc_CSCircular::TangentOnS");
    return tgs;
}
...
const gp_Vec& BlendFunc_CSCircular::TangentOnC() const {
    if (istangent) throw Standard_DomainError("BlendFunc_CSCircular::TangentOnC");
    return tgc;
}
...
const gp_Vec2d& BlendFunc_CSCircular::Tangent2d() const {
    if (istangent) throw Standard_DomainError("BlendFunc_CSCircular::Tangent2d");
    return tg2d;
}
...
void BlendFunc_CSCircular::Tangent(const Standard_Real U, const Standard_Real V, gp_Vec& TgS, gp_Vec& NmS) const {
    gp_Pnt bid;
    gp_Vec d1u, d1v, ns;
...
void BlendFunc_CSCircular::Section(const Standard_Real Param, const Standard_Real U, const Standard_Real V,
...
Standard_Boolean BlendFunc_CSCircular::Section(const Blend_Point& P, TColgp_Array1OfPnt& Poles,
                                               ...
                                               TColStd_Array1OfReal& DWeigths, TColStd_Array1OfReal& D2Weigths) {
    return Blend_CSFunction::Section(P, Poles, DPoles, D2Poles, Poles2d, DPoles2d, D2Poles2d, Weigths, DWeigths,
                                     D2Weigths);
}
...
Standard_Boolean BlendFunc_CSCircular::GetSection(const Standard_Real Param, const Standard_Real U,
...
void BlendFunc_CSCircular::GetShape(Standard_Integer& NbPoles, Standard_Integer& NbKnots, Standard_Integer& Degree,
...
//=======================================================================
void BlendFunc_CSCircular::GetTolerance(const Standard_Real BoundTol, const Standard_Real SurfTol,
...
void BlendFunc_CSCircular::Section(const Blend_Point& P, TColgp_Array1OfPnt& Poles, TColgp_Array1OfPnt2d& Poles2d,
...
void BlendFunc_CSCircular::Resolution(const Standard_Integer, const Standard_Real Tol, Standard_Real& TolU,
