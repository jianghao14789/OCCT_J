...
// purpose  :
//=======================================================================
void BlendFunc::GetShape(const BlendFunc_SectionShape SShape, const Standard_Real MaxAng, Standard_Integer& NbPoles,
                         Standard_Integer& NbKnots, Standard_Integer& Degree, Convert_ParameterisationType& TConv) {
    switch (SShape) {
...
void BlendFunc::GetMinimalWeights(const BlendFunc_SectionShape SShape, const Convert_ParameterisationType TConv,
                                  const Standard_Real MinAng, const Standard_Real MaxAng, TColStd_Array1OfReal& Weights)
...
Standard_Boolean BlendFunc::ComputeNormal(const Handle(Adaptor3d_Surface) & Surf, const gp_Pnt2d& p2d, gp_Vec& Normal) {
    ...
    CSLib::Normal(MaxOrder, DerNUV, Standard_Real(1.e-9), U, V, Umin, Umax, Vmin, Vmax, stat, thenormal, OrderU,
                  OrderV);
...
Standard_Boolean BlendFunc::ComputeDNormal(const Handle(Adaptor3d_Surface) & Surf, const gp_Pnt2d& p2d, gp_Vec& Normal,
