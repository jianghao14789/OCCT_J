...
// purpose  :
//=======================================================================
BlendFunc_Corde::BlendFunc_Corde(const Handle(Adaptor3d_Surface) & S, const Handle(Adaptor3d_Curve) & CG)
    : surf(S), guide(CG), dis(0.0), normtg(0.0), theD(0.0), istangent(Standard_False) {}
...
const gp_Vec& BlendFunc_Corde::TangentOnS() const {
    if (istangent) throw Standard_DomainError("BlendFunc_Corde::TangentOnS");
    return tgs;
}
...
const gp_Vec2d& BlendFunc_Corde::Tangent2dOnS() const {
    if (istangent) throw Standard_DomainError("BlendFunc_Corde::Tangent2dOnS");
    return tg2d;
}
