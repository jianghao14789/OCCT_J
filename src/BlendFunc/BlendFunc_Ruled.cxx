...
BlendFunc_Ruled::BlendFunc_Ruled(const Handle(Adaptor3d_Surface) & S1, const Handle(Adaptor3d_Surface) & S2,
                                 const Handle(Adaptor3d_Curve) & C)
    :

      surf1(S1), surf2(S2), curv(C), istangent(Standard_True), normtg(0.0), theD(0.0), distmin(RealLast()) {}
...
Standard_Boolean BlendFunc_Ruled::IsSolution(const math_Vector& Sol, const Standard_Real Tol) {
    ...
    if (Abs(valsol(1)) <= Tol && Abs(valsol(2)) <= Tol && Abs(valsol(3)) <= Tol && Abs(valsol(4)) <= Tol) {
        ...
        temp.SetLinearForm((dnplan.Dot(ns) - grosterme * ndotns) / norm, nplan, ndotns / norm, dnplan, grosterme / norm,
                           ns);
...
Standard_Boolean BlendFunc_Ruled::Derivatives(const math_Vector& X, math_Matrix& D) {
    ...
    resul.SetLinearForm(-(grosterme * ndotns1 - nplan.Dot(temp)) / norm1, nplan, grosterme / norm1, ns1, -1. / norm1,
                        temp);
    ...
    resul.SetLinearForm(-(grosterme * ndotns2 - nplan.Dot(temp)) / norm2, nplan, grosterme / norm2, ns2, -1. / norm2,
                        temp);
...
void BlendFunc_Ruled::Tangent(const Standard_Real U1, const Standard_Real V1, const Standard_Real U2,
...
const gp_Vec& BlendFunc_Ruled::TangentOnS1() const {
    if (istangent) throw Standard_DomainError("BlendFunc_Ruled::TangentOnS1");
    return tg1;
}

const gp_Vec& BlendFunc_Ruled::TangentOnS2() const {
    if (istangent) throw Standard_DomainError("BlendFunc_Ruled::TangentOnS2");
    return tg2;
}
const gp_Vec2d& BlendFunc_Ruled::Tangent2dOnS1() const {
    if (istangent) throw Standard_DomainError("BlendFunc_Ruled::Tangent2dOnS1");
    return tg12d;
}

const gp_Vec2d& BlendFunc_Ruled::Tangent2dOnS2() const {
    if (istangent) throw Standard_DomainError("BlendFunc_Ruled::Tangent2dOnS2");
    return tg22d;
}

Standard_Boolean BlendFunc_Ruled::GetSection(const Standard_Real Param, const Standard_Real U1, const Standard_Real V1,
                                             const Standard_Real U2, const Standard_Real V2, TColgp_Array1OfPnt& tabP,
...
// purpose  :
//=======================================================================
void BlendFunc_Ruled::GetShape(Standard_Integer& NbPoles, Standard_Integer& NbKnots, Standard_Integer& Degree,
...
//=======================================================================
void BlendFunc_Ruled::GetTolerance(const Standard_Real BoundTol, const Standard_Real, const Standard_Real,
...
Standard_Boolean BlendFunc_Ruled::Section(const Blend_Point& /*P*/, TColgp_Array1OfPnt& /*Poles*/,
...
Standard_Boolean BlendFunc_Ruled::Section(const Blend_Point& P, TColgp_Array1OfPnt& Poles, TColgp_Array1OfVec& DPoles,
                                          TColgp_Array1OfPnt2d& Poles2d, TColgp_Array1OfVec2d& DPoles2d,
...
void BlendFunc_Ruled::Section(const Blend_Point& P, TColgp_Array1OfPnt& Poles, TColgp_Array1OfPnt2d& Poles2d,
...
void BlendFunc_Ruled::Resolution(const Standard_Integer IC2d, const Standard_Real Tol, Standard_Real& TolU,
