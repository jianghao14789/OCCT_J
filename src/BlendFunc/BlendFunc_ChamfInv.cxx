...
BlendFunc_ChamfInv::BlendFunc_ChamfInv(const Handle(Adaptor3d_Surface) & S1, const Handle(Adaptor3d_Surface) & S2,
                                       const Handle(Adaptor3d_Curve) & C)
    : BlendFunc_GenChamfInv(S1, S2, C), corde1(surf1, curv), corde2(surf2, curv) {}
...
void BlendFunc_ChamfInv::Set(const Standard_Real Dist1, const Standard_Real Dist2, const Standard_Integer Choix) {
