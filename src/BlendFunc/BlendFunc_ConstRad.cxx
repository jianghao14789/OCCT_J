...
BlendFunc_ConstRad::BlendFunc_ConstRad(const Handle(Adaptor3d_Surface) & S1, const Handle(Adaptor3d_Surface) & S2,
                                       const Handle(Adaptor3d_Curve) & C)
    : surf1(S1), surf2(S2), curv(C), tcurv(C), istangent(Standard_True), param(0.0), ray1(0.0), ray2(0.0), choix(0),
      xval(1, 4), E(1, 4), DEDX(1, 4, 1, 4), DEDT(1, 4), D2EDX2(4, 4, 4), D2EDXDT(1, 4, 1, 4), D2EDT2(1, 4),
      maxang(RealFirst()), minang(RealLast()), distmin(RealLast()), mySShape(BlendFunc_Rational) {
...
Standard_Boolean BlendFunc_ConstRad::ComputeValues(const math_Vector& X, const Standard_Integer Order,
                                                   const Standard_Boolean byParam, const Standard_Real Param) {
    ...
    E(1) = (nplan.X() * (pts1.X() + pts2.X()) + nplan.Y() * (pts1.Y() + pts2.Y()) + nplan.Z() * (pts1.Z() + pts2.Z())) /
               2 +
           theD;
    ...
    if (Order >= 1) {
        ...
        dndu1.SetLinearForm(grosterme * ndotns1 + invnorm1 * nplan.Dot(dns1u1), nplan, -grosterme, nsurf1, -invnorm1,
                            dns1u1);
        ...
        dndv1.SetLinearForm(grosterme * ndotns1 + invnorm1 * nplan.Dot(dns1v1), nplan, -grosterme, nsurf1, -invnorm1,
                            dns1v1);
        ...
        dndu2.SetLinearForm(grosterme * ndotns2 + invnorm2 * nplan.Dot(dns1u2), nplan, -grosterme, nsurf2, -invnorm2,
                            dns1u2);
        ...
        dndv2.SetLinearForm(grosterme * ndotns2 + invnorm2 * nplan.Dot(dns1v2), nplan, -grosterme, nsurf2, -invnorm2,
                            dns1v2);
        ...
        if (byParam) {
            ...
            dn1w.SetLinearForm((dnplan.Dot(nsurf1) - grosterme * ndotns1) * invnorm1, nplan, ndotns1 * invnorm1, dnplan,
                               grosterme * invnorm1, nsurf1);

            // Derivee from n2 in relation to w
            grosterme = ncrossns2.Dot(dnplan.Crossed(nsurf2)) * invnorm2 * invnorm2;
            dn2w.SetLinearForm((dnplan.Dot(nsurf2) - grosterme * ndotns2) * invnorm2, nplan, ndotns2 * invnorm2, dnplan,
        ...
        if (Order == 2) {
            ...
            d2ndu1.SetLinearForm(invnorm1 * p2 + smallterm * p1, nplan, -smallterm, dns1u1, -invnorm1, d2ns1u1);
            d2ndu1 += temp;
            ...
            DSecn = (nplan.Crossed(dns1v1)).Dot(nplan.Crossed(dns1u1)) + ncrossns1.Dot(nplan.Crossed(d2ns1uv1));
            ...
            d2nduv1.SetLinearForm(invnorm1 * nplan.Dot(d2ns1uv1) + uterm * p2 + vterm * p1, nplan, -uterm, dns1v1,
                                  -vterm, dns1u1);
            ...
            temp.SetLinearForm(grosterme * ndotns1, nplan, -grosterme, nsurf1);
            d2ndv1.SetLinearForm(invnorm1 * p2 + smallterm * p1, nplan, -smallterm, dns1v1, -invnorm1, d2ns1v1);
            d2ndv1 += temp;
            ...
            d2ndu2.SetLinearForm(invnorm2 * p2 + smallterm * p1, nplan, -smallterm, dns1u2, -invnorm2, d2ns1u2);
            d2ndu2 += temp;
            ...
            DSecn = (nplan.Crossed(dns1v2)).Dot(nplan.Crossed(dns1u2)) + ncrossns2.Dot(nplan.Crossed(d2ns1uv2));
            grosterme = (3 * uterm * vterm * carre - DSecn) * cube;
            uterm *= -cube; // and only now
            vterm *= -cube;
            ...
            d2nduv2.SetLinearForm(invnorm2 * nplan.Dot(d2ns1uv2) + uterm * p2 + vterm * p1, nplan, -uterm, dns1v2,
                                  -vterm, dns1u2);
            ...
            temp.SetLinearForm(grosterme * ndotns2, nplan, -grosterme, nsurf2);
            d2ndv2.SetLinearForm(invnorm2 * p2 + smallterm * p1, nplan, -smallterm, dns1v2, -invnorm2, d2ns1v2);
            d2ndv2 += temp;
            ...
            if (byParam) {
                ...
                // Derived from the norm
                uterm = ncrossns1.Dot(nplan.Crossed(dns1u1));
                DSecn = (nplan.Crossed(dns1u1)).Dot(dnplan.Crossed(nsurf1)) + ncrossns1.Dot(dnplan.Crossed(dns1u1));
                ...
                d2ndtu1.SetLinearForm(invnorm1 * p12 + smallterm * p2 + uterm * p1 + grosterme * ndotns1, nplan,
                                      invnorm1 * p2 + uterm * ndotns1, dnplan, -smallterm, dns1u1);
                ...
                DSecn = (nplan.Crossed(dns1v1)).Dot(dnplan.Crossed(nsurf1)) + ncrossns1.Dot(dnplan.Crossed(dns1v1));
                grosterme = (3 * uterm * tterm * carre - DSecn) * cube;
                uterm *= -cube;
                ...
                d2ndtv1.SetLinearForm(invnorm1 * p12 + uterm * p1 + smallterm * p2 + grosterme * ndotns1, nplan,
                                      invnorm1 * p2 + uterm * ndotns1, dnplan, -smallterm, dns1v1);
                ...
                // Derived from the norm
                uterm = ncrossns2.Dot(nplan.Crossed(dns1u2));
                DSecn = (nplan.Crossed(dns1u2)).Dot(dnplan.Crossed(nsurf2)) + ncrossns2.Dot(dnplan.Crossed(dns1u2));
                grosterme = (3 * uterm * tterm * carre - DSecn) * cube;
                uterm *= -cube;
                ...
                d2ndtu2.SetLinearForm(invnorm2 * p12 + smallterm * p2 + uterm * p1 + grosterme * ndotns2, nplan,
                                      invnorm2 * p2 + uterm * ndotns2, dnplan, -smallterm, dns1u2);
                ...
                DSecn = (nplan.Crossed(dns1v2)).Dot(dnplan.Crossed(nsurf2)) + ncrossns2.Dot(dnplan.Crossed(dns1v2));
                grosterme = (3 * uterm * tterm * carre - DSecn) * cube;
                uterm *= -cube;
                ...
                d2ndtv2.SetLinearForm(invnorm2 * p12 + smallterm * p2 + uterm * p1 + grosterme * ndotns2, nplan,
                                      invnorm2 * p2 + uterm * ndotns2, dnplan, -smallterm, dns1v2);
                ...
                temp.SetLinearForm(grosterme * ndotns1, nplan, -grosterme, nsurf1);
                d2n1w.SetLinearForm(smallterm * p1 + invnorm1 * p2, nplan, smallterm * ndotns1 + 2 * invnorm1 * p1,
                                    dnplan, ndotns1 * invnorm1, d2nplan);
                d2n1w += temp;
                ...
                temp.SetLinearForm(grosterme * ndotns2, nplan, -grosterme, nsurf2);
                d2n2w.SetLinearForm(smallterm * p1 + invnorm2 * p2, nplan, smallterm * ndotns2 + 2 * invnorm2 * p1,
                                    dnplan, ndotns2 * invnorm2, d2nplan);
                d2n2w += temp;
...
const gp_Vec& BlendFunc_ConstRad::TangentOnS1() const {
    if (istangent) throw Standard_DomainError("BlendFunc_ConstRad::TangentOnS1");
    return tg1;
}
...
const gp_Vec& BlendFunc_ConstRad::TangentOnS2() const {
    if (istangent) throw Standard_DomainError("BlendFunc_ConstRad::TangentOnS2");
    return tg2;
}
...
const gp_Vec2d& BlendFunc_ConstRad::Tangent2dOnS1() const {
    if (istangent) throw Standard_DomainError("BlendFunc_ConstRad::Tangent2dOnS1");
    return tg12d;
}
...
const gp_Vec2d& BlendFunc_ConstRad::Tangent2dOnS2() const {
    if (istangent) throw Standard_DomainError("BlendFunc_ConstRad::Tangent2dOnS2");
    return tg22d;
}
...
void BlendFunc_ConstRad::Tangent(const Standard_Real U1, const Standard_Real V1, const Standard_Real U2,
...
Standard_Boolean BlendFunc_ConstRad::TwistOnS1() const {
    if (istangent) throw Standard_DomainError("BlendFunc_ConstRad::TwistOnS1");
...
Standard_Boolean BlendFunc_ConstRad::TwistOnS2() const {
    if (istangent) throw Standard_DomainError("BlendFunc_ConstRad::TwistOnS2");
...
void BlendFunc_ConstRad::Section(const Standard_Real Param, const Standard_Real U1, const Standard_Real V1,
                                 const Standard_Real U2, const Standard_Real V2, Standard_Real& Pdeb,
                                 Standard_Real& Pfin, gp_Circ& C) {
    gp_Pnt Center;
    gp_Vec ns1, np;
...
void BlendFunc_ConstRad::GetShape(Standard_Integer& NbPoles, Standard_Integer& NbKnots, Standard_Integer& Degree,
...
//=======================================================================
void BlendFunc_ConstRad::GetTolerance(const Standard_Real BoundTol, const Standard_Real SurfTol,
                                      const Standard_Real AngleTol, math_Vector& Tol3d, math_Vector& Tol1d) const {
...
void BlendFunc_ConstRad::Section(const Blend_Point& P, TColgp_Array1OfPnt& Poles, TColgp_Array1OfPnt2d& Poles2d,
...
Standard_Boolean BlendFunc_ConstRad::Section(const Blend_Point& P, TColgp_Array1OfPnt& Poles,
                                             TColgp_Array1OfVec& DPoles, TColgp_Array1OfPnt2d& Poles2d,
                                             TColgp_Array1OfVec2d& DPoles2d, TColStd_Array1OfReal& Weights,
    ...
    if (!istgt) {
        return GeomFill::GetCircle(myTConv, ns1, ns2, dnorm1w, dnorm2w, np, dnp, pts1, pts2, tg1, tg2, Abs(ray1), 0,
...
Standard_Boolean BlendFunc_ConstRad::Section(const Blend_Point& P, TColgp_Array1OfPnt& Poles,
                                             ...
                                             TColgp_Array1OfVec2d& D2Poles2d, TColStd_Array1OfReal& Weights,
                                             TColStd_Array1OfReal& DWeights, TColStd_Array1OfReal& D2Weights) {
    ...
    */
    ...
    if (!istgt) {
        ...
        temp.SetLinearForm(sol(1) * sol(1), d2ndu1, 2 * sol(1) * sol(2), d2nduv1, sol(2) * sol(2), d2ndv1);
        ...
        temp.SetLinearForm(sol(3) * sol(3), d2ndu2, 2 * sol(3) * sol(4), d2nduv2, sol(4) * sol(4), d2ndv2);
    ...
    if (!istgt) {
        return GeomFill::GetCircle(myTConv, ns1, ns2, dnorm1w, dnorm2w, d2norm1w, d2norm2w, np, dnp, d2np, pts1, pts2,
                                   tg1, tg2, dtg1, dtg2, Abs(ray1), 0, 0, Center, tgc, dtgc, Poles, DPoles, D2Poles,
...
void BlendFunc_ConstRad::Resolution(const Standard_Integer IC2d, const Standard_Real Tol, Standard_Real& TolU,
