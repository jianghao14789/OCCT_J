...
public:
    ...
    Standard_EXPORT BlendFunc_ConstRad(const Handle(Adaptor3d_Surface) & S1, const Handle(Adaptor3d_Surface) & S2,
    ...
    Standard_EXPORT void Section(const Standard_Real Param, const Standard_Real U1, const Standard_Real V1,
...
protected:
private:
    Standard_EXPORT Standard_Boolean ComputeValues(const math_Vector& X, const Standard_Integer Order,
