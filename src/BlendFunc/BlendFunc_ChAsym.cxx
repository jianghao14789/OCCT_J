...
// purpose  :
//=======================================================================
BlendFunc_ChAsym::BlendFunc_ChAsym(const Handle(Adaptor3d_Surface) & S1, const Handle(Adaptor3d_Surface) & S2,
                                   const Handle(Adaptor3d_Curve) & C)
    : surf1(S1), surf2(S2), curv(C), tcurv(C), param(0), dist1(RealLast()), angle(RealLast()), tgang(RealLast()),
      FX(1, 4), DX(1, 4, 1, 4), istangent(Standard_True), choix(0), distmin(RealLast()) {}
...
// purpose  :
//=======================================================================
Standard_Boolean BlendFunc_ChAsym::ComputeValues(const math_Vector& X, const Standard_Integer DegF,
...
const gp_Vec& BlendFunc_ChAsym::TangentOnS1() const {
    if (istangent) throw Standard_DomainError("BlendFunc_ChAsym::TangentOnS1");
    return tg1;
}
...
const gp_Vec2d& BlendFunc_ChAsym::Tangent2dOnS1() const {
    if (istangent) throw Standard_DomainError("BlendFunc_ChAsym::Tangent2dOnS1");
    return tg12d;
}
...
const gp_Vec& BlendFunc_ChAsym::TangentOnS2() const {
    if (istangent) throw Standard_DomainError("BlendFunc_ChAsym::TangentOnS2");
    return tg2;
}
...
const gp_Vec2d& BlendFunc_ChAsym::Tangent2dOnS2() const {
    if (istangent) throw Standard_DomainError("BlendFunc_ChAsym::Tangent2dOnS2");
    return tg22d;
}
...
Standard_Boolean BlendFunc_ChAsym::TwistOnS1() const {
    if (istangent) throw Standard_DomainError("BlendFunc_ChAsym::TwistOnS1");
...
Standard_Boolean BlendFunc_ChAsym::TwistOnS2() const {
    if (istangent) throw Standard_DomainError("BlendFunc_ChAsym::TwistOnS2");
...
void BlendFunc_ChAsym::Tangent(const Standard_Real U1, const Standard_Real V1, const Standard_Real U2,
...
void BlendFunc_ChAsym::Section(const Standard_Real /*Param*/, const Standard_Real U1, const Standard_Real V1,
                               const Standard_Real U2, const Standard_Real V2, Standard_Real& Pdeb, Standard_Real& Pfin,
                               gp_Lin& C) {
...
void BlendFunc_ChAsym::GetShape(Standard_Integer& NbPoles, Standard_Integer& NbKnots, Standard_Integer& Degree,
...
//=======================================================================
void BlendFunc_ChAsym::GetTolerance(const Standard_Real BoundTol, const Standard_Real, const Standard_Real,
                                    math_Vector& Tol3d, math_Vector&) const {
    Tol3d.Init(BoundTol);
}
...
void BlendFunc_ChAsym::Section(const Blend_Point& P, TColgp_Array1OfPnt& Poles, TColgp_Array1OfPnt2d& Poles2d,
...
Standard_Boolean BlendFunc_ChAsym::Section(const Blend_Point& P, TColgp_Array1OfPnt& Poles, TColgp_Array1OfVec& DPoles,
...
Standard_Boolean BlendFunc_ChAsym::Section(const Blend_Point& /*P*/, TColgp_Array1OfPnt& /*Poles*/,
...
// purpose  :
//=======================================================================
void BlendFunc_ChAsym::Resolution(const Standard_Integer IC2d, const Standard_Real Tol, Standard_Real& TolU,
...
// purpose  :
//=======================================================================
void BlendFunc_ChAsym::Set(const Standard_Real Dist1, const Standard_Real Angle, const Standard_Integer Choix) {
    dist1 = Abs(Dist1);
    angle = Angle;
    tgang = Tan(Angle);
    choix = Choix;
