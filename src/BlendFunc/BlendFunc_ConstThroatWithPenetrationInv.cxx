...
BlendFunc_ConstThroatWithPenetrationInv::BlendFunc_ConstThroatWithPenetrationInv(const Handle(Adaptor3d_Surface) & S1,
...
Standard_Boolean BlendFunc_ConstThroatWithPenetrationInv::IsSolution(const math_Vector& Sol, const Standard_Real Tol) {
...
Standard_Boolean BlendFunc_ConstThroatWithPenetrationInv::Value(const math_Vector& X, math_Vector& F) {
    gp_Pnt2d p2d;
    gp_Vec2d v2d;
...
Standard_Boolean BlendFunc_ConstThroatWithPenetrationInv::Derivatives(const math_Vector& X, math_Matrix& D) {
