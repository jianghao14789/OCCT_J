...
public:
    ...
    Standard_EXPORT BlendFunc_Tensor(const Standard_Integer NbRow, const Standard_Integer NbCol,
    ...
    const Standard_Real& operator()(const Standard_Integer Row, const Standard_Integer Col,
                                    const Standard_Integer Mat) const {
