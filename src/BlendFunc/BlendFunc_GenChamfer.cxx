...
// purpose  :
//=======================================================================
BlendFunc_GenChamfer::BlendFunc_GenChamfer(const Handle(Adaptor3d_Surface) & S1, const Handle(Adaptor3d_Surface) & S2,
                                           const Handle(Adaptor3d_Curve) & CG)
    : surf1(S1), surf2(S2), curv(CG), choix(0), tol(0.0), distmin(RealLast()) {}
...
void BlendFunc_GenChamfer::Section(const Standard_Real /*Param*/, const Standard_Real U1, const Standard_Real V1,
                                   const Standard_Real U2, const Standard_Real V2, Standard_Real& Pdeb,
                                   Standard_Real& Pfin, gp_Lin& C) {
...
void BlendFunc_GenChamfer::GetShape(Standard_Integer& NbPoles, Standard_Integer& NbKnots, Standard_Integer& Degree,
...
//=======================================================================
void BlendFunc_GenChamfer::GetTolerance(const Standard_Real BoundTol, const Standard_Real, const Standard_Real,
...
Standard_Boolean BlendFunc_GenChamfer::Section(const Blend_Point& /*P*/, TColgp_Array1OfPnt& /*Poles*/,
...
void BlendFunc_GenChamfer::Section(const Blend_Point& P, TColgp_Array1OfPnt& Poles, TColgp_Array1OfPnt2d& Poles2d,
...
void BlendFunc_GenChamfer::Resolution(const Standard_Integer IC2d, const Standard_Real Tol, Standard_Real& TolU,
