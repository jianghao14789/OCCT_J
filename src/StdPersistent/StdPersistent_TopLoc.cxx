...
//=======================================================================
void StdPersistent_TopLoc::ItemLocation::PChildren(StdObjMgt_Persistent::SequenceOfPersistent& theChildren) const {
...
//=======================================================================
Handle(StdPersistent_TopLoc::ItemLocation) StdPersistent_TopLoc::Translate(const TopLoc_Location& theLoc,
...
//=======================================================================
Handle(StdPersistent_TopLoc::Datum3D) StdPersistent_TopLoc::Translate(const Handle(TopLoc_Datum3D) & theDatum,
                                                                      StdObjMgt_TransientPersistentMap& theMap) {
