...
class StdPersistent_DataXtd {
    ...
    public:
        template <class AttribClass> struct Instance : instance<AttribClass> {};
    };
...
template <> inline Standard_CString StdLPersistent_Void::instance<TDataXtd_Shape>::PName() const {
    return "PDataXtd_Shape";
}

template <> inline Standard_CString StdLPersistent_Void::instance<TDataXtd_Point>::PName() const {
    return "PDataXtd_Point";
}

template <> inline Standard_CString StdLPersistent_Void::instance<TDataXtd_Axis>::PName() const {
    return "PDataXtd_Axis";
}

template <> inline Standard_CString StdLPersistent_Void::instance<TDataXtd_Plane>::PName() const {
    return "PDataXtd_Plane";
}

template <> inline Standard_CString StdLPersistent_Void::instance<TDataXtd_Placement>::PName() const {
...
template <> template <> inline Standard_CString StdObjMgt_Attribute<TDataXtd_Position>::Simple<gp_Pnt>::PName() const {
