...
public:
    ...
    public:
        ...
        inline void Read(StdObjMgt_ReadData& theReadData) {
            theReadData >> myIsDisplayed >> myDriverGUID >> myTransparency >> myColor >> myMaterial >> myWidth;
        }
        //! Write persistent data to a file.
        inline void Write(StdObjMgt_WriteData& theWriteData) const {
            theWriteData << myIsDisplayed << myDriverGUID << myTransparency << myColor << myMaterial << myWidth;
        }
        ...
        inline Standard_CString PName() const {
            return "PPrsStd_AISPresentation";
        }
    ...
    public:
        ...
        //! Returns persistent type name
        inline Standard_CString PName() const {
            return "PPrsStd_AISPresentation_1";
        }
