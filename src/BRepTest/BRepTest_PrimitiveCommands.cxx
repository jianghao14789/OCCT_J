...
static Standard_Integer wedge(Draw_Interpretor&, Standard_Integer n, const char** a) {
    ...
    if (n == 15 || n == 18) {
        ...
        if (n == 15) {
            S = BRepPrimAPI_MakeWedge(Axis, Draw::Atof(a[11]), Draw::Atof(a[12]), Draw::Atof(a[13]), Draw::Atof(a[14]));
        } else {
            S = BRepPrimAPI_MakeWedge(Axis, Draw::Atof(a[11]), Draw::Atof(a[12]), Draw::Atof(a[13]), Draw::Atof(a[14]),
                                      Draw::Atof(a[15]), Draw::Atof(a[16]), Draw::Atof(a[17]));
        }
    } else if (n == 6) {
        S = BRepPrimAPI_MakeWedge(Draw::Atof(a[2]), Draw::Atof(a[3]), Draw::Atof(a[4]), Draw::Atof(a[5]));
    } else if (n == 9) {
        S = BRepPrimAPI_MakeWedge(Draw::Atof(a[2]), Draw::Atof(a[3]), Draw::Atof(a[4]), Draw::Atof(a[5]),
                                  Draw::Atof(a[6]), Draw::Atof(a[7]), Draw::Atof(a[8]));
    } else
        return 1;
...
static Standard_Integer sphere(Draw_Interpretor&, Standard_Integer n, const char** a) {
    ...
    if (n == 3) {
        ...
        S = BRepPrimAPI_MakeSphere(P->Pln().Position().Ax2(), Draw::Atof(a[3]), Draw::Atof(a[4]) * (M_PI / 180.0),
                                   Draw::Atof(a[5]) * (M_PI / 180.0), Draw::Atof(a[6]) * (M_PI / 180.0));
    } else
        return 1;
...
void BRepTest::PrimitiveCommands(Draw_Interpretor& theCommands) {
    ...
    theCommands.Add("wedge", "wedge name [Ox Oy Oz Zx Zy Zz Xx Xy Xz] dx dy dz ltx / xmin zmin xmax zmax", __FILE__,
                    wedge, g);
