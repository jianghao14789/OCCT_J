...
// purpose  :
//=======================================================================
Law_Constant::Law_Constant() : radius(0.0), first(0.0), last(0.0) {}
...
void Law_Constant::Set(const Standard_Real Radius, const Standard_Real PFirst, const Standard_Real PLast) {
    radius = Radius;
    first = PFirst;
    last = PLast;
}
...
Handle(Law_Function) Law_Constant::Trim(const Standard_Real PFirst, const Standard_Real PLast,
