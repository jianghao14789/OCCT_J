...
Law_Linear::Law_Linear() : valdeb(0.0), valfin(0.0), pdeb(0.0), pfin(0.0) {}

void Law_Linear::Set(const Standard_Real Pdeb, const Standard_Real Valdeb, const Standard_Real Pfin,
...
Handle(Law_Function) Law_Linear::Trim(const Standard_Real PFirst, const Standard_Real PLast,
