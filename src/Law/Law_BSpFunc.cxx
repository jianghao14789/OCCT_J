...
Law_BSpFunc::Law_BSpFunc() : first(0.0), last(0.0) {}

//=======================================================================
// function : Law_BSpFunc
// purpose  :
//=======================================================================
Law_BSpFunc::Law_BSpFunc(const Handle(Law_BSpline) & C, const Standard_Real First, const Standard_Real Last)
    ...
    if (S > Continuity()) {
        ...
        switch (S) {
            ...
            case GeomAbs_CN: {
                ...
                BSplCLib::LocateParameter(curv->Degree(), TK, TM, first, curv->IsPeriodic(), 1, Nb, Index1, newFirst);
                BSplCLib::LocateParameter(curv->Degree(), TK, TM, last, curv->IsPeriodic(), 1, Nb, Index2, newLast);
                if (Abs(newFirst - TK(Index1 + 1)) < Precision::PConfusion()) Index1++;
                if (newLast - TK(Index2) > Precision::PConfusion()) Index2++;
...
Handle(Law_Function) Law_BSpFunc::Trim(const Standard_Real PFirst, const Standard_Real PLast,
