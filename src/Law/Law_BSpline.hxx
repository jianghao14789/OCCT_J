...
public:
    ...
    Standard_EXPORT Law_BSpline(const TColStd_Array1OfReal& Poles, const TColStd_Array1OfReal& Knots,
    ...
    Standard_EXPORT Law_BSpline(const TColStd_Array1OfReal& Poles, const TColStd_Array1OfReal& Weights,
    ...
    Standard_EXPORT void D3(const Standard_Real U, Standard_Real& P, Standard_Real& V1, Standard_Real& V2,
    ...
    Standard_EXPORT Standard_Real LocalValue(const Standard_Real U, const Standard_Integer FromK1,
    ...
    Standard_EXPORT Standard_Real LocalDN(const Standard_Real U, const Standard_Integer FromK1,
                                          const Standard_Integer ToK2, const Standard_Integer N) const;
    ...
    Standard_EXPORT void MovePointAndTangent(const Standard_Real U, const Standard_Real NewValue,
                                             const Standard_Real Derivative, const Standard_Real Tolerance,
