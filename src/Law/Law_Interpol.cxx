...
static void Law_draw1dcurve(const Handle(Law_BSpline) & bs, const gp_Vec2d& tra, const Standard_Real scal) {
...
static void Law_draw1dcurve(const TColStd_Array1OfReal& pol, const TColStd_Array1OfReal& knots,
                            const TColStd_Array1OfInteger& mults, const Standard_Integer deg, const gp_Vec2d& tra,
...
void Law_Interpol::SetInRelative(const TColgp_Array1OfPnt2d& ParAndRad, const Standard_Real Ud, const Standard_Real Uf,
...
void Law_Interpol::Set(const TColgp_Array1OfPnt2d& ParAndRad, const Standard_Real Dd, const Standard_Real Df,
                       const Standard_Boolean Periodic) {
    Standard_Integer l = ParAndRad.Lower();
    Standard_Integer nbp = ParAndRad.Length();
...
void Law_Interpol::SetInRelative(const TColgp_Array1OfPnt2d& ParAndRad, const Standard_Real Ud, const Standard_Real Uf,
                                 const Standard_Real Dd, const Standard_Real Df, const Standard_Boolean Periodic) {
    Standard_Integer l = ParAndRad.Lower(), u = ParAndRad.Upper();
    Standard_Real wd = ParAndRad(l).X(), wf = ParAndRad(u).X();
    Standard_Integer nbp = ParAndRad.Length();
    Handle(TColStd_HArray1OfReal) par = new TColStd_HArray1OfReal(1, nbp);
