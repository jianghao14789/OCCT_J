...
protected:
    ...
    Standard_EXPORT virtual void addFaceInfo(const RWMesh_FaceIterator& theFace, Standard_Integer& theNbNodes,
    ...
    Standard_EXPORT virtual bool writeShape(RWObj_ObjWriterContext& theWriter, RWObj_ObjMaterialMap& theMatMgr,
    ...
    //! @param theFace    [in] current face
    //! @return FALSE on writing file error
    Standard_EXPORT virtual bool writeNormals(RWObj_ObjWriterContext& theWriter, Message_LazyProgressScope& thePSentry,
                                              const RWMesh_FaceIterator& theFace);
    ...
    //! @param theFace    [in] current face
    //! @return FALSE on writing file error
    Standard_EXPORT virtual bool writeIndices(RWObj_ObjWriterContext& theWriter, Message_LazyProgressScope& thePSentry,
                                              const RWMesh_FaceIterator& theFace);
