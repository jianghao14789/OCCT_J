...
// Purpose  :
//================================================================
RWObj_CafReader::RWObj_CafReader() : myIsSinglePrecision(Standard_False) {
...
// Purpose  :
//================================================================
void RWObj_CafReader::BindNamedShape(const TopoDS_Shape& theShape, const TCollection_AsciiString& theName,
                                     const RWObj_Material* theMaterial, const Standard_Boolean theIsRootShape) {
    if (theShape.IsNull()) {
        return;
    }
...
Standard_Boolean RWObj_CafReader::performMesh(const TCollection_AsciiString& theFile,
    ...
    for (NCollection_IndexedMap<TCollection_AsciiString>::Iterator aFileIter(aCtx->ExternalFiles()); aFileIter.More();
         aFileIter.Next()) {
