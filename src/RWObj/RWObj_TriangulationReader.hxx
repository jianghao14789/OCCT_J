...
public:
    ...
    virtual void BindNamedShape(const TopoDS_Shape& theShape, const TCollection_AsciiString& theName,
                                const RWObj_Material* theMaterial, const Standard_Boolean theIsRootShape) = 0;
};
...
protected:
    ...
    //! Ignore normal.
    virtual void setNodeNormal(const Standard_Integer theIndex, const Graphic3d_Vec3& theNormal) Standard_OVERRIDE {
        myNormals.SetValue(theIndex - 1, theNormal);
    }

    //! Ignore texture coordinates.
    virtual void setNodeUV(const Standard_Integer theIndex, const Graphic3d_Vec2& theUV) Standard_OVERRIDE {
...
protected:
    ...
    Standard_EXPORT Standard_Boolean addSubShape(TopoDS_Shape& theParent, const TopoDS_Shape& theSubShape,
