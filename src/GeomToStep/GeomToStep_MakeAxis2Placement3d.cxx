...
static Handle(StepGeom_Axis2Placement3d)
    MakeAxis2Placement3d(const gp_Pnt& O, const gp_Dir& D, const gp_Dir& X, const Standard_CString nom) {
...
GeomToStep_MakeAxis2Placement3d::GeomToStep_MakeAxis2Placement3d() {
    ...
    Handle(StepGeom_Axis2Placement3d) Axe = MakeAxis2Placement3d(A.Location(), A.Direction(), A.XDirection(), "");
...
GeomToStep_MakeAxis2Placement3d::GeomToStep_MakeAxis2Placement3d(const Handle(Geom_Axis2Placement) & Axis2) {
    gp_Ax2 A;
    A = Axis2->Ax2();
