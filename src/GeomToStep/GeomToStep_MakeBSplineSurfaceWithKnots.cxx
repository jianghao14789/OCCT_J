...
//=============================================================================
GeomToStep_MakeBSplineSurfaceWithKnots::GeomToStep_MakeBSplineSurfaceWithKnots(const Handle(Geom_BSplineSurface) & BS)

{
    ...
    BSWK->Init(name, aUDegree, aVDegree, aControlPointsList, aSurfaceForm, aUClosed, aVClosed, aSelfIntersect,
               aUMultiplicities, aVMultiplicities, aUKnots, aVKnots, KnotSpec);
...
const Handle(StepGeom_BSplineSurfaceWithKnots) & GeomToStep_MakeBSplineSurfaceWithKnots::Value() const {
