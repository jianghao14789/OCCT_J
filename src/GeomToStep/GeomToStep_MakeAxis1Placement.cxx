...
GeomToStep_MakeAxis1Placement::GeomToStep_MakeAxis1Placement(const Handle(Geom_Axis1Placement) & Axis1) {
    gp_Ax1 A;
    A = Axis1->Ax1();
#include "GeomToStep_MakeAxis1Placement_gen.pxx"
}
...
GeomToStep_MakeAxis1Placement::GeomToStep_MakeAxis1Placement(const Handle(Geom2d_AxisPlacement) & Axis1) {
    gp_Ax2d A;
    A = Axis1->Ax2d();
#include "GeomToStep_MakeAxis1Placement_gen.pxx"
}
