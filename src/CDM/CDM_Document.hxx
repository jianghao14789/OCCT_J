...
public:
    ...
    Standard_EXPORT virtual Standard_Boolean GetAlternativeDocument(const TCollection_ExtendedString& aFormat,
    ...
    Standard_EXPORT virtual Standard_Boolean CanCloseReference(const Handle(CDM_Document) & aDocument,
