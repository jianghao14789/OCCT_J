...
public:
    ...
    //! Creates the builder.
    Standard_EXPORT DBRep_IsoBuilder(const TopoDS_Face& TopologicalFace, const Standard_Real Infinite,
...
protected:
    typedef NCollection_IndexedDataMap<TopoDS_Shape, Handle(Geom2d_Curve), TopTools_OrientedShapeMapHasher>
        DataMapOfEdgePCurve;
