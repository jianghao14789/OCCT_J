...
public:
    ...
    Standard_EXPORT void Set(const Standard_Integer ViewId, const gp_Trsf& TProj, const Standard_Real Focal,
    ...
    Standard_EXPORT void DrawOn(Draw_Display& D, const Standard_Boolean withRg1, const Standard_Boolean withRgN,
