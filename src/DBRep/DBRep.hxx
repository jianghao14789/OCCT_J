...
public:
    ...
    //! @param theName [in] [out] variable name, or "." to pick up shape interactively (the picked name will be returned
    //! then)
    ...
    static TopoDS_Shape Get(Standard_CString& theName, TopAbs_ShapeEnum theType = TopAbs_SHAPE,
    ...
    //! @param theType [in]       shape type filter; function will return NULL if shape has different type
    //! @param theToComplain [in] when TRUE, prints a message on cout if the variable is not set
    static TopoDS_Shape Get(TCollection_AsciiString& theName, TopAbs_ShapeEnum theType = TopAbs_SHAPE,
                            Standard_Boolean theToComplain = Standard_False) {
    ...
    //! @param theType [in] shape type filter; function will return NULL if shape has different type
    //! @param theToComplain [in] when TRUE, prints a message on cout if the variable is not set
    static TopoDS_Shape GetExisting(const TCollection_AsciiString& theName, TopAbs_ShapeEnum theType = TopAbs_SHAPE,
                                    Standard_Boolean theToComplain = Standard_False) {
...
protected:
    ...
    //! @param theType [in]       shape type filter; function will return NULL if shape has different type
    //! @param theToComplain [in] when TRUE, prints a message on cout if the variable is not set
    Standard_EXPORT static TopoDS_Shape getShape(Standard_CString& theName, TopAbs_ShapeEnum theType,
