...
public:
    ...
    //! Raised if the length of Pnts and the length of Density
    //! is not the same.
    Standard_EXPORT static void Barycentre(const TColgp_Array1OfPnt& Pnts, const TColStd_Array1OfReal& Density,
                                           Standard_Real& Mass, gp_Pnt& G);
    ...
    //! Raised if the length of Pnts and the length of Density
    //! is not the same.
    Standard_EXPORT static void Barycentre(const TColgp_Array2OfPnt& Pnts, const TColStd_Array2OfReal& Density,
                                           Standard_Real& Mass, gp_Pnt& G);
