...
GProp_PrincipalProps::GProp_PrincipalProps(const Standard_Real Ixx, const Standard_Real Iyy, const Standard_Real Izz,
    ...
    : i1(Ixx), i2(Iyy), i3(Izz), r1(Rxx), r2(Ryy), r3(Rzz), v1(Vxx), v2(Vyy), v3(Vzz), g(G) {}
...
void GProp_PrincipalProps::RadiusOfGyration(Standard_Real& Rxx, Standard_Real& Ryy, Standard_Real& Rzz) const {
