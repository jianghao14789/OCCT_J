...
public:
    ...
    Standard_EXPORT IGESToBRep_TopoSurface(const Standard_Real eps, const Standard_Real epsGeom,
    ...
    Standard_EXPORT TopoDS_Shape ParamSurface(const Handle(IGESData_IGESEntity) & start, gp_Trsf2d& trans,
                                              Standard_Real& uFact);

protected:
private:
    Standard_EXPORT TopoDS_Shape TransferPlaneParts(const Handle(IGESGeom_Plane) & start, gp_Pln& gplan, gp_Trsf& locat,
