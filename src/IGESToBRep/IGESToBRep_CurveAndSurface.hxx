...
public:
    ...
    Standard_EXPORT IGESToBRep_CurveAndSurface(const Standard_Real eps, const Standard_Real epsGeom,
    ...
    Standard_EXPORT TopoDS_Shape TransferCurveAndSurface(
        const Handle(IGESData_IGESEntity) & start, const Message_ProgressRange& theProgress = Message_ProgressRange());
