...
public:
    ...
    Standard_EXPORT IGESToBRep_BasicCurve(const Standard_Real eps, const Standard_Real epsGeom,
    ...
    Standard_EXPORT Handle(Geom_Transformation)
        TransferTransformation(const Handle(IGESGeom_TransformationMatrix) & start);
