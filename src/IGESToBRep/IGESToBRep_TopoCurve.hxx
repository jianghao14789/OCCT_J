...
public:
    ...
    Standard_EXPORT IGESToBRep_TopoCurve(const Standard_Real eps, const Standard_Real epsGeom,
                                         const Standard_Real epsCoeff, const Standard_Boolean mode,
    ...
    Standard_EXPORT TopoDS_Shape Transfer2dTopoCurve(const Handle(IGESData_IGESEntity) & start, const TopoDS_Face& face,
    ...
    Standard_EXPORT TopoDS_Shape Transfer2dCompositeCurve(const Handle(IGESGeom_CompositeCurve) & start,
                                                          const TopoDS_Face& face, const gp_Trsf2d& trans,
                                                          const Standard_Real uFact);
    ...
    Standard_EXPORT TopoDS_Shape TransferCurveOnFace(TopoDS_Face& face, const Handle(IGESGeom_CurveOnSurface) & start,
                                                     const gp_Trsf2d& trans, const Standard_Real uFact,
    ...
    Standard_EXPORT TopoDS_Shape TransferBoundaryOnFace(TopoDS_Face& face, const Handle(IGESGeom_Boundary) & start,
                                                        const gp_Trsf2d& trans, const Standard_Real uFact);
...
protected:
private:
    Standard_EXPORT TopoDS_Shape TransferCompositeCurveGeneral(const Handle(IGESGeom_CompositeCurve) & start,
