...
public:
    ...
    Standard_EXPORT IGESToBRep_BRepEntity(const Standard_Real eps, const Standard_Real epsGeom,
    ...
    Standard_EXPORT TopoDS_Shape TransferLoop(const Handle(IGESSolid_Loop) & start, const TopoDS_Face& Face,
