...
Standard_Boolean TPrsStd_DriverTable::AddDriver(const Standard_GUID& guid, const Handle(TPrsStd_Driver) & driver) {
...
Standard_Boolean TPrsStd_DriverTable::FindDriver(const Standard_GUID& guid, Handle(TPrsStd_Driver) & driver) const {
