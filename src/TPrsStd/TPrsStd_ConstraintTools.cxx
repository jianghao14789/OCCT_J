...
// purpose  :
//=======================================================================
void TPrsStd_ConstraintTools::ComputeTextAndValue(const Handle(TDataXtd_Constraint) & aConst, Standard_Real& val,
                                                  TCollection_ExtendedString& txt, const Standard_Boolean anIsAngle) {
...
#ifdef OCCT_DEBUG
            std::cout << "Compute angle : Geom type = " << shape1.ShapeType() << " non traite" << std::endl;
#endif
            NullifyAIS(anAIS);
            return;
        }
...
#ifdef OCCT_DEBUG
            std::cout << "Compute angle : Geom type = " << shape2.ShapeType() << " non traite" << std::endl;
#endif
            NullifyAIS(anAIS);
            return;
        }
...
#ifdef OCCT_DEBUG
        std::cout << "TPrsStd_ConstraintTools::ComputeConcentric: concentric between two vertexes : NOT DISPLAYED"
                  << std::endl;
#endif
        NullifyAIS(anAIS);
        return;
...
void TPrsStd_ConstraintTools::ComputeRadius(const Handle(TDataXtd_Constraint) & aConst,
    ...
    if (IsFace(shape1)) shape1 = GetFace(shape1);
...
#ifdef OCCT_DEBUG
        std::cout << "TPrsStd_ConstraintTools::ComputeEqualDistance : at least one pair of shapes is incorrect"
                  << std::endl;
#endif
        NullifyAIS(anAIS);
        return;
...
static Standard_Boolean CheckShapesPair(const TopoDS_Shape& aShape1, const TopoDS_Shape& aShape2) {
    ...
    if (aShape1.ShapeType() == TopAbs_EDGE && aShape2.ShapeType() == TopAbs_EDGE) {
        ...
        if (aCurve1.GetType() == GeomAbs_Line && aCurve2.GetType() == GeomAbs_Line) { // Are lines parallel ?
...
// purpose  :
//=======================================================================
void TPrsStd_ConstraintTools::GetOneShape(const Handle(TDataXtd_Constraint) & aConst, TopoDS_Shape& aShape) {
...
// purpose  :
//=======================================================================
void TPrsStd_ConstraintTools::GetTwoShapes(const Handle(TDataXtd_Constraint) & aConst, TopoDS_Shape& aShape1,
...
// purpose  :
//=======================================================================
void TPrsStd_ConstraintTools::GetShapesAndGeom(const Handle(TDataXtd_Constraint) & aConst, TopoDS_Shape& aShape1,
                                               TopoDS_Shape& aShape2, Handle(Geom_Geometry) & aGeom) {
...
//=======================================================================
void TPrsStd_ConstraintTools::GetShapesAndGeom(const Handle(TDataXtd_Constraint) & aConst, TopoDS_Shape& aShape1,
                                               TopoDS_Shape& aShape2, TopoDS_Shape& aShape3,
                                               Handle(Geom_Geometry) & aGeom) {
    GetTwoShapes(aConst, aShape1, aShape2);
...
//=======================================================================
void TPrsStd_ConstraintTools::GetShapesAndGeom(const Handle(TDataXtd_Constraint) & aConst, TopoDS_Shape& aShape1,
                                               TopoDS_Shape& aShape2, TopoDS_Shape& aShape3, TopoDS_Shape& aShape4,
                                               Handle(Geom_Geometry) & aGeom) {
    GetTwoShapes(aConst, aShape1, aShape2);
...
// purpose  :
//=======================================================================
void TPrsStd_ConstraintTools::GetGeom(const Handle(TDataXtd_Constraint) & aConst, Handle(Geom_Geometry) & aGeom) {
