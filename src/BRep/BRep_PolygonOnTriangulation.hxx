...
public:
    ...
    //! location <L>.
    Standard_EXPORT virtual Standard_Boolean IsPolygonOnTriangulation(const Handle(Poly_Triangulation) & T,
                                                                      const TopLoc_Location& L) const Standard_OVERRIDE;

    //! returns True.
    Standard_EXPORT virtual void PolygonOnTriangulation(const Handle(Poly_PolygonOnTriangulation) &
                                                        P) Standard_OVERRIDE;

    Standard_EXPORT virtual const Handle(Poly_Triangulation) & Triangulation() const Standard_OVERRIDE;

    Standard_EXPORT virtual const Handle(Poly_PolygonOnTriangulation) &
        PolygonOnTriangulation() const Standard_OVERRIDE;
