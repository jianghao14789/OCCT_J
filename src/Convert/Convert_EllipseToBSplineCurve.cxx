...
Convert_EllipseToBSplineCurve::Convert_EllipseToBSplineCurve(const gp_Elips2d& E,
    ...
    if (Parameterisation != Convert_TgtThetaOver2 && Parameterisation != Convert_RationalC1) {
        ...
        Convert_ConicToBSplineCurve::BuildCosAndSin(Parameterisation, 0, 2 * M_PI, CosNumeratorPtr, SinNumeratorPtr,
                                                    weights, degree, knots, mults);
    } else {
        isperiodic = Standard_True;
        Convert_ConicToBSplineCurve::BuildCosAndSin(Parameterisation, CosNumeratorPtr, SinNumeratorPtr, weights, degree,
                                                    knots, mults);
    }
...
Convert_EllipseToBSplineCurve::Convert_EllipseToBSplineCurve(const gp_Elips2d& E, const Standard_Real UFirst,
...
#endif
    Standard_DomainError_Raise_if((delta > (2 * M_PI + Tol)) || (delta <= 0.0e0), "Convert_EllipseToBSplineCurve");
    Standard_Integer ii;
    Standard_Real R, r, value;
    Handle(TColStd_HArray1OfReal) CosNumeratorPtr, SinNumeratorPtr;
