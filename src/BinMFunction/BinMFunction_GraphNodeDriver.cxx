...
Standard_Boolean BinMFunction_GraphNodeDriver::Paste(const BinObjMgt_Persistent& theSource,
    ...
    if (!(theSource >> intStatus >> nb_previous >> nb_next)) return Standard_False;
...
void BinMFunction_GraphNodeDriver::Paste(const Handle(TDF_Attribute) & theSource, BinObjMgt_Persistent& theTarget,
