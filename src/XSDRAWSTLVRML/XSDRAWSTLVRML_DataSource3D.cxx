...
// Purpose  :
//================================================================
Standard_Boolean XSDRAWSTLVRML_DataSource3D::GetGeom(const Standard_Integer theID, const Standard_Boolean theIsElement,
...
// Purpose  :
//================================================================
Standard_Boolean XSDRAWSTLVRML_DataSource3D::Get3DGeom(const Standard_Integer theID, Standard_Integer& theNbNodes,
...
// Purpose  :
//================================================================
Standard_Boolean XSDRAWSTLVRML_DataSource3D::GetGeomType(const Standard_Integer theID,
...
// Purpose  :
//================================================================
Standard_Address XSDRAWSTLVRML_DataSource3D::GetAddr(const Standard_Integer, const Standard_Boolean) const {
    return NULL;
}
...
// Purpose  :
//================================================================
Standard_Boolean XSDRAWSTLVRML_DataSource3D::GetNodesByElement(const Standard_Integer theID,
...
// Purpose  :
//================================================================
Standard_Boolean XSDRAWSTLVRML_DataSource3D::GetNormal(const Standard_Integer /*theID*/,
                                                       const Standard_Integer /*theMax*/, Standard_Real& /*theNx*/,
                                                       Standard_Real& /*theNy*/, Standard_Real& /*theNz*/) const {
    return Standard_False;
}
