...
FairCurve_DistributionOfJerk::FairCurve_DistributionOfJerk(const Standard_Integer BSplOrder,
    ...
    : FairCurve_DistributionOfEnergy(BSplOrder, FlatKnots, Poles, DerivativeOrder, NbValAux), MyLaw(Law) {}
...
Standard_Boolean FairCurve_DistributionOfJerk::Value(const math_Vector& TParam, math_Vector& Jerk) {
    ...
    ier = BSplCLib::EvalBsplineBasis(3, MyBSplOrder, MyFlatKnots->Array1(), TParam(TParam.Lower()), FirstNonZero, Base);
    ...
    if (MyDerivativeOrder >= 1) {
        ...
        math_Vector WGrad(1, 2 * MyBSplOrder + MyNbValAux), NumGrad(1, 2 * MyBSplOrder), NGrad1(1, 2 * MyBSplOrder),
            NGrad2(1, 2 * MyBSplOrder), GradNormeCPrim(1, 2 * MyBSplOrder), NGDNCPrim(1, 2 * MyBSplOrder),
            GradDeriveNormeCPrim(1, 2 * MyBSplOrder), GradNumRho(1, 2 * MyBSplOrder), NumduGrad(1, 2 * MyBSplOrder);
        ...
        if (MyDerivativeOrder >= 2) {
            ...
            Standard_Real Produit, Produit2, ProduitV, HNumRho, DSeconde, NSeconde, HDeriveNormeCPrim, Aux1,
                DeriveAuxBis;
            ...
            for (ii = 2; ii <= 2 * MyBSplOrder; ii += 2) {
                ...
                for (jj = 2; jj < ii; jj += 2) {
                    ...
                    NSeconde = -3 * (GradNumRho(ii - 1) * GradDeriveNormeCPrim(jj - 1) + NumRho * HDeriveNormeCPrim +
                    ...
                    HDeriveNormeCPrim = (-DeriveAuxBis * GradNormeCPrim(ii - 1) + AuxBis * XPrim * Base(2, II) * Aux1) *
                                            InvNormeCPrim2 -
                                        2 * NGDNCPrim(ii - 1) * Aux1 * InvNormeCPrim;
                    NSeconde =
                        ProduitV - 3 * (GradNumRho(ii - 1) * GradDeriveNormeCPrim(jj) + NumRho * HDeriveNormeCPrim +
                    ...
                    DeriveAuxBis =
                        2 * ((XPrim * Base(3, JJ) + XSecn * Base(2, JJ)) * InvNormeCPrim - ProduitC1C2 * Aux1);
                    HDeriveNormeCPrim =
                        (-DeriveAuxBis * GradNormeCPrim(ii) + AuxBis * YPrim * Base(2, II) * Aux1) * InvNormeCPrim2 -
                        2 * NGDNCPrim(ii) * Aux1 * InvNormeCPrim;
                    NSeconde =
                        -ProduitV - 3 * (GradNumRho(ii) * GradDeriveNormeCPrim(jj - 1) + NumRho * HDeriveNormeCPrim +
                    ...
                    HDeriveNormeCPrim = (Produit2 - DeriveAuxBis * GradNormeCPrim(ii) -
                                         AuxBis * (Produit * InvNormeCPrim - YPrim * Base(2, II) * Aux1)) *
                                            InvNormeCPrim2 -
                                        2 * NGDNCPrim(ii) * Aux1 * InvNormeCPrim;
                    NSeconde = -3 * (GradNumRho(ii) * GradDeriveNormeCPrim(jj) + NumRho * HDeriveNormeCPrim +
                ...
                DeriveAuxBis = 2 * ((XPrim * Base(3, II) + XSecn * Base(2, II)) * InvNormeCPrim - ProduitC1C2 * Aux1);
                HDeriveNormeCPrim = (Produit2 - DeriveAuxBis * GradNormeCPrim(ii - 1) -
                                     AuxBis * (Produit * InvNormeCPrim - XPrim * Base(2, II) * Aux1)) *
                                        InvNormeCPrim2 -
                                    2 * NGDNCPrim(ii - 1) * Aux1 * InvNormeCPrim;
                NSeconde = -3 * (2 * GradNumRho(ii - 1) * GradDeriveNormeCPrim(ii - 1) + NumRho * HDeriveNormeCPrim);
                DSeconde = FacteurX * Produit;
                ...
                DeriveAuxBis = 2 * ((YPrim * Base(3, II) + YSecn * Base(2, II)) * InvNormeCPrim - ProduitC1C2 * Aux1);
                HDeriveNormeCPrim =
                    (-DeriveAuxBis * GradNormeCPrim(ii - 1) + AuxBis * XPrim * Base(2, II) * Aux1) * InvNormeCPrim2 -
                    2 * NGDNCPrim(ii - 1) * Aux1 * InvNormeCPrim;
                NSeconde = -3 * (GradNumRho(ii - 1) * GradDeriveNormeCPrim(ii) + NumRho * HDeriveNormeCPrim +
                ...
                HDeriveNormeCPrim = (Produit2 - DeriveAuxBis * GradNormeCPrim(ii) -
                                     AuxBis * (Produit * InvNormeCPrim - YPrim * Base(2, II) * Aux1)) *
                                        InvNormeCPrim2 -
                                    2 * NGDNCPrim(ii) * Aux1 * InvNormeCPrim;
                NSeconde = -3 * (2 * GradNumRho(ii) * GradDeriveNormeCPrim(ii) + NumRho * HDeriveNormeCPrim);
                DSeconde = FacteurY * Produit;
                Aux = NSeconde * NormeCPrim - 1.5 * NumGrad(ii) * GradNormeCPrim(ii) - 2.5 * DSeconde * Numerateur;
