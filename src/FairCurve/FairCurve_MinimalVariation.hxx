...
public:
    ...
    Standard_EXPORT FairCurve_MinimalVariation(const gp_Pnt2d& P1, const gp_Pnt2d& P2, const Standard_Real Heigth,
                                               const Standard_Real Slope = 0, const Standard_Real PhysicalRatio = 0);
    ...
    Standard_EXPORT virtual Standard_Boolean Compute(FairCurve_AnalysisCode& ACode,
                                                     ...
                                                     const Standard_Real Tolerance = 1.0e-3) Standard_OVERRIDE;
...
private:
    ...
    Standard_EXPORT Standard_Boolean Compute(const gp_Vec2d& DeltaP1, const gp_Vec2d& DeltaP2,
                                             const Standard_Real DeltaAngle1, const Standard_Real DeltaAngle2,
                                             const Standard_Real DeltaCurvature1, const Standard_Real DeltaCurvature2,
