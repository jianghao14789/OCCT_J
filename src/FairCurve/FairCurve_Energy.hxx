...
public:
    ...
    //! Returns True if the computation was done successfully,
    //! False otherwise.
    Standard_EXPORT virtual Standard_Boolean Values(const math_Vector& X, Standard_Real& E,
...
protected:
    ...
    Standard_EXPORT FairCurve_Energy(const Handle(TColgp_HArray1OfPnt2d) & Poles, const Standard_Integer ConstrOrder1,
                                     const Standard_Integer ConstrOrder2,
                                     const Standard_Boolean WithAuxValue = Standard_False,
                                     const Standard_Real Angle1 = 0, const Standard_Real Angle2 = 0,
                                     const Standard_Integer Degree = 2, const Standard_Real Curvature1 = 0,
    ...
    Standard_EXPORT void ComputePolesG1(const Standard_Integer Side, const Standard_Real Lambda, const gp_Pnt2d& P1,
                                        gp_Pnt2d& P2) const;

    //! compute  the  pole which depend of variables and G2 constraint
    Standard_EXPORT void ComputePolesG2(const Standard_Integer Side, const Standard_Real Lambda,
                                        const Standard_Real Rho, const gp_Pnt2d& P1, gp_Pnt2d& P2) const;
