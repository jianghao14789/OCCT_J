...
public:
    ...
    Standard_EXPORT FairCurve_Batten(const gp_Pnt2d& P1, const gp_Pnt2d& P2, const Standard_Real Height,
...
protected:
    Standard_EXPORT Standard_Real SlidingOfReference(const Standard_Real D, const Standard_Real A1,
