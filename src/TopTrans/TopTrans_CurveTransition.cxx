...
TopTrans_CurveTransition::TopTrans_CurveTransition()
    : myCurv(0.0), Init(Standard_False), CurvFirst(0.0), CurvLast(0.0) {}
...
void TopTrans_CurveTransition::Reset(const gp_Dir& Tgt, const gp_Dir& Norm, const Standard_Real Curv) {
    myTgt = Tgt;
    myNorm = Norm;
    myCurv = Curv;
    Init = Standard_True;
...
void TopTrans_CurveTransition::Compare(const Standard_Real Tole, const gp_Dir& T, const gp_Dir& N,
                                       const Standard_Real C, const TopAbs_Orientation St,
...
Standard_Boolean TopTrans_CurveTransition::IsBefore(const Standard_Real Tole, const Standard_Real CosAngl,
                                                    const gp_Dir& N1, const Standard_Real C1, const gp_Dir& N2,
...
Standard_Integer TopTrans_CurveTransition::Compare(const Standard_Real Ang1, const Standard_Real Ang2,
