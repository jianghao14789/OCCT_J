...
public:
    ...
    Standard_EXPORT Xw_Window(const Handle(Aspect_DisplayConnection) & theXDisplay, const Standard_CString theTitle,
    ...
    Standard_EXPORT Xw_Window(const Handle(Aspect_DisplayConnection) & theXDisplay, const Aspect_Drawable theXWin,
    ...
    Standard_EXPORT virtual bool ProcessMessage(Aspect_WindowInputListener& theListener, XEvent& theMsg);
