...
ShapeFix_WireSegment::ShapeFix_WireSegment(const Handle(ShapeExtend_WireData) & wire, const TopAbs_Orientation ori) {
    Load(wire);
    myOrient = ori;
}
...
void ShapeFix_WireSegment::AddEdge(const Standard_Integer i, const TopoDS_Edge& edge, const Standard_Integer iumin,
                                   const Standard_Integer iumax, const Standard_Integer ivmin,
...
void ShapeFix_WireSegment::SetPatchIndex(const Standard_Integer i, const Standard_Integer iumin,
                                         const Standard_Integer iumax, const Standard_Integer ivmin,
                                         const Standard_Integer ivmax) {
...
void ShapeFix_WireSegment::DefineIUMax(const Standard_Integer i, const Standard_Integer iumax) {
    ...
    if (iun > iux) std::cout << "Warning: ShapeFix_WireSegment::DefineIUMax: indexation error" << std::endl;
#endif
}
...
void ShapeFix_WireSegment::DefineIVMin(const Standard_Integer i, const Standard_Integer ivmin) {
    ...
    if (ivn > ivx) std::cout << "Warning: ShapeFix_WireSegment::DefineIVMin: indexation error" << std::endl;
#endif
}
...
#ifdef OCCT_DEBUG
    Standard_Integer ivn = myIVMin->Value(i), ivx = myIVMax->Value(i);
    if (ivn > ivx) std::cout << "Warning: ShapeFix_WireSegment::DefineIVMax: indexation error" << std::endl;
#endif
}
...
void ShapeFix_WireSegment::GetPatchIndex(const Standard_Integer i, Standard_Integer& iumin, Standard_Integer& iumax,
                                         Standard_Integer& ivmin, Standard_Integer& ivmax) const {
...
#ifdef OCCT_DEBUG
    if (!ok) std::cout << "Warning: ShapeFix_WireSegment::CheckPatchIndex: incomplete indexation" << std::endl;
#endif
    return ok;
}
