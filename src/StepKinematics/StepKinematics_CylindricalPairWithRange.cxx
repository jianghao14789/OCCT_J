...
void StepKinematics_CylindricalPairWithRange::Init(
    ...
    const Standard_Boolean hasLowerLimitActualTranslation, const Standard_Real theLowerLimitActualTranslation,
    const Standard_Boolean hasUpperLimitActualTranslation, const Standard_Real theUpperLimitActualTranslation,
    ...
    StepKinematics_CylindricalPair::Init(
