...
void StepKinematics_RackAndPinionPairWithRange::Init(
    ...
    const Standard_Real theRackAndPinionPair_PinionRadius, const Standard_Boolean hasLowerLimitRackDisplacement,
    const Standard_Real theLowerLimitRackDisplacement, const Standard_Boolean hasUpperLimitRackDisplacement,
    ...
    StepKinematics_RackAndPinionPair::Init(
        ...
        theItemDefinedTransformation_TransformItem2, theKinematicPair_Joint, theRackAndPinionPair_PinionRadius);
