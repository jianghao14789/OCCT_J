...
void StepKinematics_PointOnSurfacePairWithRange::Init(
    ...
    const Handle(StepGeom_RectangularTrimmedSurface) & theRangeOnPairSurface, const Standard_Boolean hasLowerLimitYaw,
    ...
    StepKinematics_PointOnSurfacePair::Init(
        ...
        theItemDefinedTransformation_TransformItem2, theKinematicPair_Joint, thePointOnSurfacePair_PairSurface);
