...
void StepKinematics_PairRepresentationRelationship::Init(
    ...
    myRepresentationRelationshipWithTransformation->Init(
        ...
        theRepresentationRelationship_Description, theRepresentationRelationship_Rep1.Representation(),
...
Handle(StepRepr_RepresentationRelationshipWithTransformation)
    StepKinematics_PairRepresentationRelationship::RepresentationRelationshipWithTransformation() const {
