...
void StepKinematics_SurfacePairWithRange::Init(
    ...
    const Handle(StepGeom_Surface) & theSurfacePair_Surface1, const Handle(StepGeom_Surface) & theSurfacePair_Surface2,
    ...
    StepKinematics_SurfacePair::Init(theRepresentationItem_Name, theItemDefinedTransformation_Name,
                                     hasItemDefinedTransformation_Description, theItemDefinedTransformation_Description,
                                     theItemDefinedTransformation_TransformItem1,
                                     theItemDefinedTransformation_TransformItem2, theKinematicPair_Joint,
                                     theSurfacePair_Surface1, theSurfacePair_Surface2, theSurfacePair_Orientation);
...
// purpose  :
//=======================================================================
void StepKinematics_SurfacePairWithRange::SetRangeOnSurface1(const Handle(StepGeom_RectangularTrimmedSurface) &
                                                             theRangeOnSurface1) {
    myRangeOnSurface1 = theRangeOnSurface1;
}
...
// purpose  :
//=======================================================================
void StepKinematics_SurfacePairWithRange::SetRangeOnSurface2(const Handle(StepGeom_RectangularTrimmedSurface) &
                                                             theRangeOnSurface2) {
    myRangeOnSurface2 = theRangeOnSurface2;
}
