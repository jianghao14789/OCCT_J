...
public:
    ...
    Init(const Handle(StepKinematics_KinematicLinkRepresentationAssociation) & theRepresentationRelation,
    ...
    Standard_EXPORT void SetRepresentationRelation(const Handle(StepKinematics_KinematicLinkRepresentationAssociation) &
