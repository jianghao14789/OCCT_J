...
void StepKinematics_PointOnPlanarCurvePairWithRange::Init(
    ...
    const Handle(StepGeom_TrimmedCurve) & theRangeOnPairCurve, const Standard_Boolean hasLowerLimitYaw,
    const Standard_Real theLowerLimitYaw, const Standard_Boolean hasUpperLimitYaw, const Standard_Real theUpperLimitYaw,
    ...
    StepKinematics_PointOnPlanarCurvePair::Init(
        ...
        theItemDefinedTransformation_TransformItem2, theKinematicPair_Joint, thePointOnPlanarCurvePair_PairCurve,
...
// purpose  :
//=======================================================================
void StepKinematics_PointOnPlanarCurvePairWithRange::SetRangeOnPairCurve(const Handle(StepGeom_TrimmedCurve) &
                                                                         theRangeOnPairCurve) {
    myRangeOnPairCurve = theRangeOnPairCurve;
}
