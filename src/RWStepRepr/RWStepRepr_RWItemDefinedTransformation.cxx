...
void RWStepRepr_RWItemDefinedTransformation::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepRepr_RWItemDefinedTransformation::WriteStep(StepData_StepWriter& SW,
                                                       const Handle(StepRepr_ItemDefinedTransformation) & ent) const {
...
void RWStepRepr_RWItemDefinedTransformation::Share(const Handle(StepRepr_ItemDefinedTransformation) & ent,
