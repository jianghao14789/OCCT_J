...
void RWStepRepr_RWFunctionallyDefinedTransformation::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                              const Standard_Integer num, Handle(Interface_Check) & ach,
                                                              const Handle(StepRepr_FunctionallyDefinedTransformation) &
                                                                  ent) const {
...
void RWStepRepr_RWFunctionallyDefinedTransformation::WriteStep(
    StepData_StepWriter& SW, const Handle(StepRepr_FunctionallyDefinedTransformation) & ent) const {
