...
void RWStepRepr_RWRepresentationRelationship::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepRepr_RWRepresentationRelationship::WriteStep(StepData_StepWriter& SW,
                                                        const Handle(StepRepr_RepresentationRelationship) & ent) const {
...
void RWStepRepr_RWRepresentationRelationship::Share(const Handle(StepRepr_RepresentationRelationship) & ent,
