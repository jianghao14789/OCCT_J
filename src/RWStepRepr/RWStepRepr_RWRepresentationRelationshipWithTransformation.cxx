...
void RWStepRepr_RWRepresentationRelationshipWithTransformation::WriteStep(
    StepData_StepWriter& SW, const Handle(StepRepr_RepresentationRelationshipWithTransformation) & ent) const {
...
void RWStepRepr_RWRepresentationRelationshipWithTransformation::Share(
    const Handle(StepRepr_RepresentationRelationshipWithTransformation) & ent, Interface_EntityIterator& iter) const {
