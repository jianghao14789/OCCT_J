...
void RWStepRepr_RWConstructiveGeometryRepresentation::WriteStep(
    StepData_StepWriter& SW, const Handle(StepRepr_ConstructiveGeometryRepresentation) & ent) const {
    // Inherited field : name
    SW.Send(ent->Name());
...
// purpose  :
//=======================================================================
void RWStepRepr_RWConstructiveGeometryRepresentation::Share(const Handle(StepRepr_ConstructiveGeometryRepresentation) &
                                                                ent,
