...
void RWStepRepr_RWSpecifiedHigherUsageOccurrence::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                           ...
                                                           const Handle(StepRepr_SpecifiedHigherUsageOccurrence) &
                                                               ent) const {
    ...
    if (data->IsParamDefined(num, 6)) {
        data->ReadString(num, 6, "assembly_component_usage.reference_designator", ach,
    ...
    ent->Init(aProductDefinitionRelationship_Id, aProductDefinitionRelationship_Name,
              ...
              aAssemblyComponentUsage_ReferenceDesignator, aUpperUsage, aNextUsage);
}
