...
void RWStepRepr_RWMaterialDesignation::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepRepr_RWMaterialDesignation::WriteStep(StepData_StepWriter& SW,
                                                 const Handle(StepRepr_MaterialDesignation) & ent) const {
