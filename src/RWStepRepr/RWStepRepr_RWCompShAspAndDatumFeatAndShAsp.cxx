...
void RWStepRepr_RWCompShAspAndDatumFeatAndShAsp::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                          const Standard_Integer num0, Handle(Interface_Check) & ach,
                                                          const Handle(StepRepr_CompShAspAndDatumFeatAndShAsp) &
                                                              ent) const {
...
void RWStepRepr_RWCompShAspAndDatumFeatAndShAsp::WriteStep(StepData_StepWriter& SW,
                                                           const Handle(StepRepr_CompShAspAndDatumFeatAndShAsp) &
                                                               ent) const {
...
void RWStepRepr_RWCompShAspAndDatumFeatAndShAsp::Share(const Handle(StepRepr_CompShAspAndDatumFeatAndShAsp) & ent,
