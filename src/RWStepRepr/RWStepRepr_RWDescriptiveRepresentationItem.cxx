...
void RWStepRepr_RWDescriptiveRepresentationItem::ReadStep(const Handle(StepData_StepReaderData) & data,
    ...
    if (data->NbParams(num) != 2 && data->NbParams(num) != 1) {
        Handle(TCollection_HAsciiString) errmess =
            new TCollection_HAsciiString("Count of Parameters is not 1 or 2 for descriptive_representation_item");
...
void RWStepRepr_RWDescriptiveRepresentationItem::WriteStep(StepData_StepWriter& SW,
                                                           const Handle(StepRepr_DescriptiveRepresentationItem) &
                                                               ent) const {
