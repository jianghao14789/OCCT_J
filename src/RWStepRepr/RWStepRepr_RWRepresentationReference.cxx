...
void RWStepRepr_RWRepresentationReference::ReadStep(const Handle(StepData_StepReaderData) & theData,
                                                    const Standard_Integer theNum, Handle(Interface_Check) & theAch,
    ...
    theData->ReadEntity(theNum, 2, "context_of_items", theAch, STANDARD_TYPE(StepRepr_RepresentationContextReference),
                        aContextOfItems);
