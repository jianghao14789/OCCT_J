...
void RWStepRepr_RWDefinitionalRepresentation::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepRepr_RWDefinitionalRepresentation::WriteStep(StepData_StepWriter& SW,
                                                        const Handle(StepRepr_DefinitionalRepresentation) & ent) const {
...
void RWStepRepr_RWDefinitionalRepresentation::Share(const Handle(StepRepr_DefinitionalRepresentation) & ent,
