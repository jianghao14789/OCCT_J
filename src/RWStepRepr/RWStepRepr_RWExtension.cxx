...
void RWStepRepr_RWExtension::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepRepr_RWExtension::WriteStep(StepData_StepWriter& SW, const Handle(StepRepr_Extension) & ent) const {
...
void RWStepRepr_RWExtension::Share(const Handle(StepRepr_Extension) & ent, Interface_EntityIterator& iter) const {
