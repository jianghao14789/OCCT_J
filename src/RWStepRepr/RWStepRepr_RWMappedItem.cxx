...
void RWStepRepr_RWMappedItem::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                       Handle(Interface_Check) & ach, const Handle(StepRepr_MappedItem) & ent) const {
...
void RWStepRepr_RWMappedItem::WriteStep(StepData_StepWriter& SW, const Handle(StepRepr_MappedItem) & ent) const {
