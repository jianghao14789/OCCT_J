...
void RWStepRepr_RWPropertyDefinitionRelationship::ReadStep(const Handle(StepData_StepReaderData) & data,
    ...
    data->ReadEntity(num, 3, "relating_property_definition", ach, STANDARD_TYPE(StepRepr_PropertyDefinition),
                     aRelatingPropertyDefinition);

    Handle(StepRepr_PropertyDefinition) aRelatedPropertyDefinition;
    data->ReadEntity(num, 4, "related_property_definition", ach, STANDARD_TYPE(StepRepr_PropertyDefinition),
