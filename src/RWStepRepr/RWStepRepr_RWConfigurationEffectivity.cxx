...
void RWStepRepr_RWConfigurationEffectivity::ReadStep(const Handle(StepData_StepReaderData) & data,
    ...
    data->ReadEntity(num, 2, "product_definition_effectivity.usage", ach,
                     STANDARD_TYPE(StepBasic_ProductDefinitionRelationship), aProductDefinitionEffectivity_Usage);
