...
void RWStepRepr_RWParametricRepresentationContext::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepRepr_RWParametricRepresentationContext::WriteStep(StepData_StepWriter& SW,
                                                             const Handle(StepRepr_ParametricRepresentationContext) &
                                                                 ent) const {
