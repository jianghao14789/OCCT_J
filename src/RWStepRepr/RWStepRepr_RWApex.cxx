...
void RWStepRepr_RWApex::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepRepr_RWApex::Share(const Handle(StepRepr_Apex) & ent, Interface_EntityIterator& iter) const {
