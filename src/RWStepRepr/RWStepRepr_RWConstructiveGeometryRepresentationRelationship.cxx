...
void RWStepRepr_RWConstructiveGeometryRepresentationRelationship::WriteStep(
    StepData_StepWriter& SW, const Handle(StepRepr_ConstructiveGeometryRepresentationRelationship) & ent) const {
    // Inherited field : name
    SW.Send(ent->Name());
...
void RWStepRepr_RWConstructiveGeometryRepresentationRelationship::Share(
    const Handle(StepRepr_ConstructiveGeometryRepresentationRelationship) & ent, Interface_EntityIterator& iter) const {
