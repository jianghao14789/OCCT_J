...
void RWStepRepr_RWGlobalUncertaintyAssignedContext::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepRepr_RWGlobalUncertaintyAssignedContext::WriteStep(StepData_StepWriter& SW,
                                                              const Handle(StepRepr_GlobalUncertaintyAssignedContext) &
                                                                  ent) const {
...
void RWStepRepr_RWGlobalUncertaintyAssignedContext::Share(const Handle(StepRepr_GlobalUncertaintyAssignedContext) & ent,
