...
void RWStepRepr_RWAssemblyComponentUsageSubstitute::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                             const Standard_Integer num, Handle(Interface_Check) & ach,
                                                             const Handle(StepRepr_AssemblyComponentUsageSubstitute) &
                                                                 ent) const {
...
void RWStepRepr_RWAssemblyComponentUsageSubstitute::WriteStep(StepData_StepWriter& SW,
                                                              const Handle(StepRepr_AssemblyComponentUsageSubstitute) &
                                                                  ent) const {
...
void RWStepRepr_RWAssemblyComponentUsageSubstitute::Share(const Handle(StepRepr_AssemblyComponentUsageSubstitute) & ent,
