...
public:
    ...
    Standard_EXPORT AdvApp2Var_Iso(const GeomAbs_IsoType type, const Standard_Real cte, const Standard_Real Ufirst,
    ...
    Standard_EXPORT void MakeApprox(const AdvApp2Var_Context& Conditions, const Standard_Real a, const Standard_Real b,
