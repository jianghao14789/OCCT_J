...
public:
    ...
    Standard_EXPORT AdvApp2Var_Patch(const Standard_Real U0, const Standard_Real U1, const Standard_Real V0,
    ...
    Standard_EXPORT void Discretise(const AdvApp2Var_Context& Conditions, const AdvApp2Var_Framework& Constraints,
    ...
    Standard_EXPORT void MakeApprox(const AdvApp2Var_Context& Conditions, const AdvApp2Var_Framework& Constraints,
    ...
    Standard_EXPORT void ChangeDomain(const Standard_Real a, const Standard_Real b, const Standard_Real c,
    ...
    Standard_EXPORT Handle(TColgp_HArray2OfPnt)
        Poles(const Standard_Integer SSPIndex, const AdvApp2Var_Context& Conditions) const;

    Standard_EXPORT Handle(TColStd_HArray1OfReal)
        Coefficients(const Standard_Integer SSPIndex, const AdvApp2Var_Context& Conditions) const;
