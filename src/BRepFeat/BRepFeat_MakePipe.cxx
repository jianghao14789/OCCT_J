...
void BRepFeat_MakePipe::Init(const TopoDS_Shape& Sbase, const TopoDS_Shape& Pbase, const TopoDS_Face& Skface,
                             const TopoDS_Wire& Spine, const Standard_Integer Mode, const Standard_Boolean Modify) {
#ifdef OCCT_DEBUG
...
static void MajMap(const TopoDS_Shape& theB, LocOpe_Pipe& theP,
