...
public:
    ...
    //! trigonometric  sense.
    Standard_EXPORT void Perform(const MAT2d_SequenceOfSequenceOfGeometry& Figure, const Standard_Integer IndStart,
...
private:
    ...
    Standard_EXPORT Handle(MAT2d_Connexion) MinimumL1L2(const MAT2d_SequenceOfSequenceOfGeometry& Figure,
                                                        const Standard_Integer L1, const Standard_Integer L2) const;
