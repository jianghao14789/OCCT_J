...
public:
    Geom2dConvert_ApproxCurve_Eval(const Handle(Adaptor2d_Curve2d) & theFunc, Standard_Real First, Standard_Real Last)
        : fonct(theFunc) {
        StartEndSav[0] = First;
        StartEndSav[1] = Last;
    }
...
void Geom2dConvert_ApproxCurve_Eval::Evaluate(Standard_Integer* Dimension, Standard_Real StartEnd[2],
...
Geom2dConvert_ApproxCurve::Geom2dConvert_ApproxCurve(const Handle(Geom2d_Curve) & Curve, const Standard_Real Tol2d,
...
Geom2dConvert_ApproxCurve::Geom2dConvert_ApproxCurve(const Handle(Adaptor2d_Curve2d) & Curve, const Standard_Real Tol2d,
                                                     const GeomAbs_Shape Order, const Standard_Integer MaxSegments,
                                                     const Standard_Integer MaxDegree) {
    Approximate(Curve, Tol2d, Order, MaxSegments, MaxDegree);
}

void Geom2dConvert_ApproxCurve::Approximate(const Handle(Adaptor2d_Curve2d) & theCurve, const Standard_Real theTol2d,
                                            const GeomAbs_Shape theOrder, const Standard_Integer theMaxSegments,
    ...
    AdvApprox_ApproxAFunction aApprox(Num1DSS, Num2DSS, Num3DSS, OneDTolNul, TwoDTol, ThreeDTolNul, First, Last,
                                      theOrder, theMaxDegree, theMaxSegments, ev, CutTool);
