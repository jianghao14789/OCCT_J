...
public:
    ...
    Standard_EXPORT void Perform(const BRepAdaptor_Surface& Surf1, const BRepAdaptor_Surface& Surf2,
    ...
    Standard_EXPORT static void Parameters(const BRepApprox_TheMultiLineOfApprox& Line, const Standard_Integer firstP,
                                           const Standard_Integer lastP, const Approx_ParametrizationType Par,
                                           math_Vector& TheParameters);

protected:
private:
    Standard_EXPORT void Perform(const IntSurf_Quadric& Surf1, const BRepAdaptor_Surface& Surf2,
                                 const Handle(BRepApprox_ApproxLine) & aLine, const Standard_Boolean ApproxXYZ,
    ...
    //! Build knot sequence.
    Standard_EXPORT void buildKnots(const Handle(BRepApprox_ApproxLine) & theline, const Standard_Address thePtrSVSurf);

    //! Build curve.
    Standard_EXPORT void buildCurve(const Handle(BRepApprox_ApproxLine) & theline, const Standard_Address thePtrSVSurf);
