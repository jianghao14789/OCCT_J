...
public:
    ...
    //! parameter, only the vector B changes).
    Standard_EXPORT BRepApprox_ParLeastSquareOfMyGradientOfTheComputeLineBezierOfApprox(
        const BRepApprox_TheMultiLineOfApprox& SSP, const TColStd_Array1OfReal& Knots,
...
protected:
    ...
    Standard_EXPORT void Init(const BRepApprox_TheMultiLineOfApprox& SSP, const Standard_Integer FirstPoint,
    ...
    Standard_EXPORT void Affect(const BRepApprox_TheMultiLineOfApprox& SSP, const Standard_Integer Index,
