...
BRepBlend_AppFuncRoot::BRepBlend_AppFuncRoot(Handle(BRepBlend_Line) & Line, Blend_AppFunction& Func,
                                             const Standard_Real Tol3d, const Standard_Real Tol2d)
    : myLine(Line), myFunc(&Func), myTolerance(1, Func.NbVariables()), X1(1, Func.NbVariables()),
      X2(1, Func.NbVariables()), XInit(1, Func.NbVariables()), Sol(1, Func.NbVariables()) {
    ...
    if (Func.IsRational()) {
        Standard_Real Xmax = -1.e100, Xmin = 1.e100, Ymax = -1.e100, Ymin = 1.e100, Zmax = -1.e100, Zmin = 1.e100;
        Blend_Point P;
...
//================================================================================
Standard_Boolean BRepBlend_AppFuncRoot::D0(const Standard_Real Param, const Standard_Real /*First*/,
    ...
    if (Ok) (*Func).Section(myPnt, Poles, Poles2d, Weigths);
    return Ok;
}
...
//================================================================================
Standard_Boolean BRepBlend_AppFuncRoot::D1(const Standard_Real Param, const Standard_Real /*First*/,
                                           const Standard_Real /*Last*/, TColgp_Array1OfPnt& Poles,
...
//           For v = Param, if the calculation fails Standard_False is raised.
//===========================================================================
Standard_Boolean BRepBlend_AppFuncRoot::D2(const Standard_Real Param, const Standard_Real /*First*/,
                                           const Standard_Real /*Last*/, TColgp_Array1OfPnt& Poles,
    ...
    Ok = SearchPoint(*Func, Param, myPnt);
    if (Ok) {
        Ok = (*Func).Section(myPnt, Poles, DPoles, D2Poles, Poles2d, DPoles2d, D2Poles2d, Weigths, DWeigths, D2Weigths);
    }
    return Ok;
}
...
void BRepBlend_AppFuncRoot::SectionShape(Standard_Integer& NbPoles, Standard_Integer& NbKnots,
...
void BRepBlend_AppFuncRoot::Resolution(const Standard_Integer Index, const Standard_Real Tol, Standard_Real& TolU,
                                       Standard_Real& TolV) const {
    Blend_AppFunction* Func = (Blend_AppFunction*)myFunc;
    Func->Resolution(Index, Tol, TolU, TolV);
}

void BRepBlend_AppFuncRoot::GetTolerance(const Standard_Real BoundTol, const Standard_Real SurfTol,
...
Standard_Boolean BRepBlend_AppFuncRoot::SearchPoint(Blend_AppFunction& Func, const Standard_Real Param,
                                                    Blend_Point& Pnt) {
...
//================================================================================
Standard_Boolean BRepBlend_AppFuncRoot::SearchLocation(const Standard_Real Param, const Standard_Integer FirstIndex,
