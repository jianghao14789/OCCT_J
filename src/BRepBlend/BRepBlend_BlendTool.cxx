...
//=======================================================================
Standard_Boolean BRepBlend_BlendTool::Project(const gp_Pnt2d& P, const Handle(Adaptor3d_Surface) &,
    ...
    if (!extrema.IsDone()) return Standard_True;
...
//=======================================================================
Standard_Boolean BRepBlend_BlendTool::Inters(const gp_Pnt2d& P1, const gp_Pnt2d& P2, const Handle(Adaptor3d_Surface) &,
    ...
    if (Nbint == 0) return Standard_False;
...
Standard_Integer BRepBlend_BlendTool::NbSamplesV(const Handle(Adaptor3d_Surface) &, const Standard_Real,
                                                 const Standard_Real) {
    return 10;
}

Standard_Integer BRepBlend_BlendTool::NbSamplesU(const Handle(Adaptor3d_Surface) &, const Standard_Real,
                                                 const Standard_Real) {
    return 10;
}

void BRepBlend_BlendTool::Bounds(const Handle(Adaptor2d_Curve2d) & A, Standard_Real& Ufirst, Standard_Real& Ulast) {
