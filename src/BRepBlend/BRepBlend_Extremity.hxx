...
public:
    ...
    Standard_EXPORT BRepBlend_Extremity(const gp_Pnt& P, const Standard_Real U, const Standard_Real V,
    ...
    Standard_EXPORT BRepBlend_Extremity(const gp_Pnt& P, const Standard_Real W, const Standard_Real Param,
    ...
    Standard_EXPORT void SetValue(const gp_Pnt& P, const Standard_Real W, const Standard_Real Param,
                                  const Standard_Real Tol);
    ...
    Standard_EXPORT void AddArc(const Handle(Adaptor2d_Curve2d) & A, const Standard_Real Param,
