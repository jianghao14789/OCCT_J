...
BRepBlend_RstRstEvolRad::BRepBlend_RstRstEvolRad(const Handle(Adaptor3d_Surface) & Surf1,
    ...
    : surf1(Surf1), surf2(Surf2), rst1(Rst1), rst2(Rst2), cons1(Rst1, Surf1), cons2(Rst2, Surf2), guide(CGuide),
      tguide(CGuide), istangent(Standard_True), maxang(RealFirst()), minang(RealLast()), distmin(RealLast()),
...
void BRepBlend_RstRstEvolRad::Set(const Handle(Adaptor3d_Surface) & SurfRef1, const Handle(Adaptor2d_Curve2d) & RstRef1,
...
Blend_DecrochStatus BRepBlend_RstRstEvolRad::Decroch(const math_Vector& Sol, gp_Vec& NRst1, gp_Vec& TgRst1,
...
//=======================================================================
Standard_Boolean BRepBlend_RstRstEvolRad::CenterCircleRst1Rst2(const gp_Pnt& PtRst1, const gp_Pnt& PtRst2,
...
void BRepBlend_RstRstEvolRad::Section(const Standard_Real Param, const Standard_Real U, const Standard_Real V,
...
void BRepBlend_RstRstEvolRad::GetShape(Standard_Integer& NbPoles, Standard_Integer& NbKnots, Standard_Integer& Degree,
...
void BRepBlend_RstRstEvolRad::GetTolerance(const Standard_Real BoundTol, const Standard_Real SurfTol,
...
void BRepBlend_RstRstEvolRad::Section(const Blend_Point& P, TColgp_Array1OfPnt& Poles, TColgp_Array1OfPnt2d& Poles2d,
...
Standard_Boolean BRepBlend_RstRstEvolRad::Section(const Blend_Point& P, TColgp_Array1OfPnt& Poles,
    ...
    if (!istgt) {
        return GeomFill::GetCircle(myTConv, n1, n2, d1n1, d1n2, nplan, dnplan, ptrst1, ptrst2, tgrst1, tgrst2, Abs(ray),
                                   dray, Center, tgct, Poles, DPoles, Weights, DWeights);
    } else {
        GeomFill::GetCircle(myTConv, n1, n2, nplan, ptrst1, ptrst2, Abs(ray), Center, Poles, Weights);
        return Standard_False;
    }
...
Standard_Boolean BRepBlend_RstRstEvolRad::Section(const Blend_Point&, TColgp_Array1OfPnt&, TColgp_Array1OfVec&,
...
void BRepBlend_RstRstEvolRad::Resolution(const Standard_Integer IC2d, const Standard_Real Tol, Standard_Real& TolU,
