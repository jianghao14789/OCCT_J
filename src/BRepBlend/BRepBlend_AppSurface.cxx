...
BRepBlend_AppSurface::BRepBlend_AppSurface(const Handle(Approx_SweepFunction) & Func, const Standard_Real First,
                                           const Standard_Real Last, const Standard_Real Tol3d,
                                           const Standard_Real Tol2d, const Standard_Real TolAngular,
...
void BRepBlend_AppSurface::SurfShape(Standard_Integer& UDegree, Standard_Integer& VDegree, Standard_Integer& NbUPoles,
...
void BRepBlend_AppSurface::Surface(TColgp_Array2OfPnt& TPoles, TColStd_Array2OfReal& TWeights,
...
void BRepBlend_AppSurface::Curves2dShape(Standard_Integer& Degree, Standard_Integer& NbPoles,
                                         Standard_Integer& NbKnots) const {
    approx.Curves2dShape(Degree, NbPoles, NbKnots);
}

void BRepBlend_AppSurface::Curve2d(const Standard_Integer Index, TColgp_Array1OfPnt2d& TPoles,
