...
public:
    ...
    Standard_EXPORT BRepBlend_AppSurf(const Standard_Integer Degmin, const Standard_Integer Degmax,
    ...
    Standard_EXPORT void Perform(const Handle(BRepBlend_Line) & Lin, Blend_AppFunction& SecGen,
...
protected:
private:
    Standard_EXPORT void InternalPerform(const Handle(BRepBlend_Line) & Lin, Blend_AppFunction& SecGen,
