...
BRepBlend_RstRstConstRad::BRepBlend_RstRstConstRad(const Handle(Adaptor3d_Surface) & Surf1,
    ...
    : surf1(Surf1), surf2(Surf2), rst1(Rst1), rst2(Rst2), cons1(Rst1, Surf1), cons2(Rst2, Surf2), guide(CGuide),
      tguide(CGuide), prmrst1(0.0), prmrst2(0.0), istangent(Standard_True), ray(0.0), choix(0), normtg(0.0), theD(0.0),
...
Standard_Boolean BRepBlend_RstRstConstRad::Values(const math_Vector& X, math_Vector& F, math_Matrix& D) {
    Value(X, F);
    Derivatives(X, D);
...
Standard_Boolean BRepBlend_RstRstConstRad::IsSolution(const math_Vector& Sol, const Standard_Real Tol)
...
Blend_DecrochStatus BRepBlend_RstRstConstRad::Decroch(const math_Vector& Sol, gp_Vec& NRst1, gp_Vec& TgRst1,
                                                      gp_Vec& NRst2, gp_Vec& TgRst2) const {
...
//=======================================================================
Standard_Boolean BRepBlend_RstRstConstRad::CenterCircleRst1Rst2(const gp_Pnt& PtRst1, const gp_Pnt& PtRst2,
                                                                const gp_Vec& np, gp_Pnt& Center, gp_Vec& VdMed) const {
...
void BRepBlend_RstRstConstRad::Section(const Standard_Real Param, const Standard_Real U, const Standard_Real V,
                                       Standard_Real& Pdeb, Standard_Real& Pfin, gp_Circ& C) {
...
void BRepBlend_RstRstConstRad::GetShape(Standard_Integer& NbPoles, Standard_Integer& NbKnots, Standard_Integer& Degree,
...
void BRepBlend_RstRstConstRad::GetTolerance(const Standard_Real BoundTol, const Standard_Real SurfTol,
...
void BRepBlend_RstRstConstRad::Section(const Blend_Point& P, TColgp_Array1OfPnt& Poles, TColgp_Array1OfPnt2d& Poles2d,
...
Standard_Boolean BRepBlend_RstRstConstRad::Section(const Blend_Point& P, TColgp_Array1OfPnt& Poles,
    ...
    if (!istgt) {
        return GeomFill::GetCircle(myTConv, n1, n2, d1n1, d1n2, nplan, dnplan, ptrst1, ptrst2, tgrst1, tgrst2, Abs(ray),
                                   0, Center, tgct, Poles, DPoles, Weights, DWeights);
    } else {
...
Standard_Boolean BRepBlend_RstRstConstRad::Section(const Blend_Point&, TColgp_Array1OfPnt&, TColgp_Array1OfVec&,
...
void BRepBlend_RstRstConstRad::Resolution(const Standard_Integer IC2d, const Standard_Real Tol, Standard_Real& TolU,
