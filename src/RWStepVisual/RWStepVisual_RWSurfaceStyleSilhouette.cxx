...
void RWStepVisual_RWSurfaceStyleSilhouette::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepVisual_RWSurfaceStyleSilhouette::WriteStep(StepData_StepWriter& SW,
                                                      const Handle(StepVisual_SurfaceStyleSilhouette) & ent) const {
...
void RWStepVisual_RWSurfaceStyleSilhouette::Share(const Handle(StepVisual_SurfaceStyleSilhouette) & ent,
