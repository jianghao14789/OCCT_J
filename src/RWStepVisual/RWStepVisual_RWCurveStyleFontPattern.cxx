...
void RWStepVisual_RWCurveStyleFontPattern::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepVisual_RWCurveStyleFontPattern::WriteStep(StepData_StepWriter& SW,
                                                     const Handle(StepVisual_CurveStyleFontPattern) & ent) const {
