...
void RWStepVisual_RWPresentationLayerAssignment::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepVisual_RWPresentationLayerAssignment::WriteStep(StepData_StepWriter& SW,
                                                           const Handle(StepVisual_PresentationLayerAssignment) &
                                                               ent) const {
...
void RWStepVisual_RWPresentationLayerAssignment::Share(const Handle(StepVisual_PresentationLayerAssignment) & ent,
