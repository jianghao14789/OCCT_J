...
void RWStepVisual_RWSurfaceStyleUsage::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepVisual_RWSurfaceStyleUsage::WriteStep(StepData_StepWriter& SW,
                                                 const Handle(StepVisual_SurfaceStyleUsage) & ent) const {
