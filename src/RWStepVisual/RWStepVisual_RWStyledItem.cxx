...
void RWStepVisual_RWStyledItem::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepVisual_RWStyledItem::WriteStep(StepData_StepWriter& SW, const Handle(StepVisual_StyledItem) & ent) const {
