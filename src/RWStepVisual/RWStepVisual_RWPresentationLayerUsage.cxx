...
void RWStepVisual_RWPresentationLayerUsage::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepVisual_RWPresentationLayerUsage::WriteStep(StepData_StepWriter& SW,
                                                      const Handle(StepVisual_PresentationLayerUsage) & ent) const {
...
void RWStepVisual_RWPresentationLayerUsage::Share(const Handle(StepVisual_PresentationLayerUsage) & ent,
