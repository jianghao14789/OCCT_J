...
// purpose  :
//=======================================================================
void RWStepVisual_RWCameraModelD3MultiClippingUnion::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                              const Standard_Integer num, Handle(Interface_Check) & ach,
                                                              const Handle(StepVisual_CameraModelD3MultiClippingUnion) &
                                                                  ent) const {
    // Number of Parameter Control
    if (!data->CheckNbParams(num, 2, ach, "camera_model_d3_multi_clipping_union")) return;
...
void RWStepVisual_RWCameraModelD3MultiClippingUnion::WriteStep(
    StepData_StepWriter& SW, const Handle(StepVisual_CameraModelD3MultiClippingUnion) & ent) const {
    // Inherited field name
    SW.Send(ent->Name());
...
// purpose  :
//=======================================================================
void RWStepVisual_RWCameraModelD3MultiClippingUnion::Share(const Handle(StepVisual_CameraModelD3MultiClippingUnion) &
                                                               ent,
