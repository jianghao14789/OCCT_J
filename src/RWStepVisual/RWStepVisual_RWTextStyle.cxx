...
void RWStepVisual_RWTextStyle::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                        Handle(Interface_Check) & ach, const Handle(StepVisual_TextStyle) & ent) const {
...
void RWStepVisual_RWTextStyle::WriteStep(StepData_StepWriter& SW, const Handle(StepVisual_TextStyle) & ent) const {
