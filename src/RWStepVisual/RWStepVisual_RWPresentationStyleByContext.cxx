...
void RWStepVisual_RWPresentationStyleByContext::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                         const Standard_Integer num, Handle(Interface_Check) & ach,
                                                         const Handle(StepVisual_PresentationStyleByContext) &
                                                             ent) const {
...
void RWStepVisual_RWPresentationStyleByContext::WriteStep(StepData_StepWriter& SW,
                                                          const Handle(StepVisual_PresentationStyleByContext) &
                                                              ent) const {
...
void RWStepVisual_RWPresentationStyleByContext::Share(const Handle(StepVisual_PresentationStyleByContext) & ent,
