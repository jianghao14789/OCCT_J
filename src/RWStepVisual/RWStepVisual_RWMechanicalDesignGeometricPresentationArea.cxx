...
void RWStepVisual_RWMechanicalDesignGeometricPresentationArea::WriteStep(
    StepData_StepWriter& SW, const Handle(StepVisual_MechanicalDesignGeometricPresentationArea) & ent) const {
...
void RWStepVisual_RWMechanicalDesignGeometricPresentationArea::Share(
    const Handle(StepVisual_MechanicalDesignGeometricPresentationArea) & ent, Interface_EntityIterator& iter) const {
