...
void RWStepVisual_RWSurfaceStyleRenderingWithProperties::ReadStep(
    ...
    data->ReadEntity(num, 2, "surface_style_rendering.surface_colour", ach, STANDARD_TYPE(StepVisual_Colour),
    ...
    // Initialize entity
    ent->Init(aSurfaceStyleRendering_RenderingMethod, aSurfaceStyleRendering_SurfaceColour, aProperties);
}
...
void RWStepVisual_RWSurfaceStyleRenderingWithProperties::WriteStep(
    StepData_StepWriter& SW, const Handle(StepVisual_SurfaceStyleRenderingWithProperties) & ent) const {
...
void RWStepVisual_RWSurfaceStyleRenderingWithProperties::Share(
    const Handle(StepVisual_SurfaceStyleRenderingWithProperties) & ent, Interface_EntityIterator& iter) const {
