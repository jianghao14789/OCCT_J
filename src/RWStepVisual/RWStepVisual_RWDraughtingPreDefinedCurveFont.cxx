...
void RWStepVisual_RWDraughtingPreDefinedCurveFont::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                            const Standard_Integer num, Handle(Interface_Check) & ach,
                                                            const Handle(StepVisual_DraughtingPreDefinedCurveFont) &
                                                                ent) const {
...
void RWStepVisual_RWDraughtingPreDefinedCurveFont::WriteStep(StepData_StepWriter& SW,
                                                             const Handle(StepVisual_DraughtingPreDefinedCurveFont) &
                                                                 ent) const {
