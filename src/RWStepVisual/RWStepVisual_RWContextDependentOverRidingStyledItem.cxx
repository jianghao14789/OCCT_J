...
void RWStepVisual_RWContextDependentOverRidingStyledItem::WriteStep(
    StepData_StepWriter& SW, const Handle(StepVisual_ContextDependentOverRidingStyledItem) & ent) const {
...
void RWStepVisual_RWContextDependentOverRidingStyledItem::Share(
    const Handle(StepVisual_ContextDependentOverRidingStyledItem) & ent, Interface_EntityIterator& iter) const {
