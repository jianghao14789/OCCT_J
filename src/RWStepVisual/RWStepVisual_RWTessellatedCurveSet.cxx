...
// purpose  :
//=======================================================================
void RWStepVisual_RWTessellatedCurveSet::ReadStep(const Handle(StepData_StepReaderData) & data,
        ...
        for (Standard_Integer i = 1; i <= nb2; i++) {
            ...
            if (data->ReadSubList(nsub2, i, "number_coordinates", ach, nsub3)) {
                ...
                for (Standard_Integer j = 1; j <= nb3; j++) {
                    ...
                    if (data->ReadInteger(nsub3, j, "coordinates", ach, aVal)) aCurve->Append(aVal);
                }
...
// purpose  :
//=======================================================================
void RWStepVisual_RWTessellatedCurveSet::WriteStep(StepData_StepWriter& SW,
                                                   const Handle(StepVisual_TessellatedCurveSet) & ent) const {
    // Inherited field : name
    SW.Send(ent->Name());
