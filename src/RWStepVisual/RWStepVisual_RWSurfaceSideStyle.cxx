...
void RWStepVisual_RWSurfaceSideStyle::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
    ...
    if (data->ReadSubList(num, 2, "styles", ach, nsub2)) {
        ...
        for (Standard_Integer i2 = 1; i2 <= nb2; i2++) {
            ...
            if (data->ReadEntity(nsub2, i2, "styles", ach, aStylesItem)) aStyles->SetValue(i2, aStylesItem);
        }
    }
...
void RWStepVisual_RWSurfaceSideStyle::WriteStep(StepData_StepWriter& SW,
                                                const Handle(StepVisual_SurfaceSideStyle) & ent) const {
