...
void RWStepVisual_RWPreDefinedColour::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepVisual_RWPreDefinedColour::WriteStep(StepData_StepWriter& SW,
                                                const Handle(StepVisual_PreDefinedColour) & ent) const {
