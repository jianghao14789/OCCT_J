...
void RWStepVisual_RWTemplateInstance::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepVisual_RWTemplateInstance::WriteStep(StepData_StepWriter& SW,
                                                const Handle(StepVisual_TemplateInstance) & ent) const {
...
void RWStepVisual_RWTemplateInstance::Share(const Handle(StepVisual_TemplateInstance) & ent,
