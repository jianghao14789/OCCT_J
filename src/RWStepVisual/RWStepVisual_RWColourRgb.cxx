...
void RWStepVisual_RWColourRgb::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepVisual_RWColourRgb::WriteStep(StepData_StepWriter& SW, const Handle(StepVisual_ColourRgb) & ent) const {
