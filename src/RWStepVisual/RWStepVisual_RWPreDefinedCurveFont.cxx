...
void RWStepVisual_RWPreDefinedCurveFont::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepVisual_RWPreDefinedCurveFont::WriteStep(StepData_StepWriter& SW,
                                                   const Handle(StepVisual_PreDefinedCurveFont) & ent) const {
