...
void RWStepVisual_RWTextStyleForDefinedFont::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepVisual_RWTextStyleForDefinedFont::WriteStep(StepData_StepWriter& SW,
                                                       const Handle(StepVisual_TextStyleForDefinedFont) & ent) const {
...
void RWStepVisual_RWTextStyleForDefinedFont::Share(const Handle(StepVisual_TextStyleForDefinedFont) & ent,
