...
void RWStepVisual_RWCameraImage::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepVisual_RWCameraImage::WriteStep(StepData_StepWriter& SW, const Handle(StepVisual_CameraImage) & ent) const {
