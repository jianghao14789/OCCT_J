...
void RWStepVisual_RWOverRidingStyledItem::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepVisual_RWOverRidingStyledItem::WriteStep(StepData_StepWriter& SW,
                                                    const Handle(StepVisual_OverRidingStyledItem) & ent) const {
