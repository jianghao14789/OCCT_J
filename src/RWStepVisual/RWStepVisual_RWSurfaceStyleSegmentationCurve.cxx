...
void RWStepVisual_RWSurfaceStyleSegmentationCurve::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                            const Standard_Integer num, Handle(Interface_Check) & ach,
                                                            const Handle(StepVisual_SurfaceStyleSegmentationCurve) &
                                                                ent) const {
    ...
    data->ReadEntity(num, 1, "style_of_segmentation_curve", ach, STANDARD_TYPE(StepVisual_CurveStyle),
...
void RWStepVisual_RWSurfaceStyleSegmentationCurve::WriteStep(StepData_StepWriter& SW,
                                                             const Handle(StepVisual_SurfaceStyleSegmentationCurve) &
                                                                 ent) const {
...
void RWStepVisual_RWSurfaceStyleSegmentationCurve::Share(const Handle(StepVisual_SurfaceStyleSegmentationCurve) & ent,
