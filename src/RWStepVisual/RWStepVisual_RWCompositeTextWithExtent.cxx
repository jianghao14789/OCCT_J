...
void RWStepVisual_RWCompositeTextWithExtent::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepVisual_RWCompositeTextWithExtent::WriteStep(StepData_StepWriter& SW,
                                                       const Handle(StepVisual_CompositeTextWithExtent) & ent) const {
...
void RWStepVisual_RWCompositeTextWithExtent::Share(const Handle(StepVisual_CompositeTextWithExtent) & ent,
