...
void RWStepVisual_RWColourSpecification::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepVisual_RWColourSpecification::WriteStep(StepData_StepWriter& SW,
                                                   const Handle(StepVisual_ColourSpecification) & ent) const {
