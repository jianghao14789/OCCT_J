...
void RWStepVisual_RWPresentationView::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepVisual_RWPresentationView::WriteStep(StepData_StepWriter& SW,
                                                const Handle(StepVisual_PresentationView) & ent) const {
