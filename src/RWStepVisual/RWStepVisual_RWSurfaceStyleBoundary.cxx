...
void RWStepVisual_RWSurfaceStyleBoundary::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepVisual_RWSurfaceStyleBoundary::WriteStep(StepData_StepWriter& SW,
                                                    const Handle(StepVisual_SurfaceStyleBoundary) & ent) const {
