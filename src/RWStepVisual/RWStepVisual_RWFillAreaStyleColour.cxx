...
void RWStepVisual_RWFillAreaStyleColour::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepVisual_RWFillAreaStyleColour::WriteStep(StepData_StepWriter& SW,
                                                   const Handle(StepVisual_FillAreaStyleColour) & ent) const {
