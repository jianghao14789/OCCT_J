...
void RWStepVisual_RWSurfaceStyleControlGrid::ReadStep(const Handle(StepData_StepReaderData) & data,
...
void RWStepVisual_RWSurfaceStyleControlGrid::WriteStep(StepData_StepWriter& SW,
                                                       const Handle(StepVisual_SurfaceStyleControlGrid) & ent) const {
...
void RWStepVisual_RWSurfaceStyleControlGrid::Share(const Handle(StepVisual_SurfaceStyleControlGrid) & ent,
