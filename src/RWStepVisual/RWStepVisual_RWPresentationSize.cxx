...
void RWStepVisual_RWPresentationSize::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepVisual_RWPresentationSize::WriteStep(StepData_StepWriter& SW,
                                                const Handle(StepVisual_PresentationSize) & ent) const {
