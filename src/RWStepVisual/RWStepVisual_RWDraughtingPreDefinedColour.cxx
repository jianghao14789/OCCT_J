...
void RWStepVisual_RWDraughtingPreDefinedColour::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                         const Standard_Integer num, Handle(Interface_Check) & ach,
                                                         const Handle(StepVisual_DraughtingPreDefinedColour) &
                                                             ent) const {
...
void RWStepVisual_RWDraughtingPreDefinedColour::WriteStep(StepData_StepWriter& SW,
                                                          const Handle(StepVisual_DraughtingPreDefinedColour) &
                                                              ent) const {
