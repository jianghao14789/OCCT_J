...
void RWStepVisual_RWPlanarBox::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                        Handle(Interface_Check) & ach, const Handle(StepVisual_PlanarBox) & ent) const {
...
void RWStepVisual_RWPlanarBox::WriteStep(StepData_StepWriter& SW, const Handle(StepVisual_PlanarBox) & ent) const {
