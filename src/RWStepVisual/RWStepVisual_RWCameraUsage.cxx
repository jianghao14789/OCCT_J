...
void RWStepVisual_RWCameraUsage::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
    ...
    data->ReadEntity(num, 2, "mapped_representation", ach, STANDARD_TYPE(StepRepr_Representation),
...
void RWStepVisual_RWCameraUsage::WriteStep(StepData_StepWriter& SW, const Handle(StepVisual_CameraUsage) & ent) const {
