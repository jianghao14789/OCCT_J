...
void RWStepVisual_RWDraughtingModel::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
    ...
    if (data->ReadSubList(num, 2, "representation.items", ach, sub2)) {
        ...
        if (nb0 > 0) {
            ...
            for (Standard_Integer i0 = 1; i0 <= nb0; i0++) {
                ...
                data->ReadEntity(num2, i0, "representation.items", ach, STANDARD_TYPE(StepRepr_RepresentationItem),
                                 anIt0);
