...
void RWStepVisual_RWContextDependentInvisibility::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                           const Standard_Integer num, Handle(Interface_Check) & ach,
                                                           const Handle(StepVisual_ContextDependentInvisibility) &
                                                               ent) const {
...
void RWStepVisual_RWContextDependentInvisibility::WriteStep(StepData_StepWriter& SW,
                                                            const Handle(StepVisual_ContextDependentInvisibility) &
                                                                ent) const {
...
void RWStepVisual_RWContextDependentInvisibility::Share(const Handle(StepVisual_ContextDependentInvisibility) & ent,
