...
void RWStepVisual_RWCameraModelD3MultiClippingIntersection::ReadStep(
    ...
    if (!data->CheckNbParams(num, 2, ach, "camera_model_d3_multi_clipping_intersection")) return;
...
void RWStepVisual_RWCameraModelD3MultiClippingIntersection::WriteStep(
    StepData_StepWriter& SW, const Handle(StepVisual_CameraModelD3MultiClippingIntersection) & ent) const {
    // Inherited field name
    SW.Send(ent->Name());
...
void RWStepVisual_RWCameraModelD3MultiClippingIntersection::Share(
    const Handle(StepVisual_CameraModelD3MultiClippingIntersection) & ent, Interface_EntityIterator& iter) const {
    // Own field: shape_clipping
