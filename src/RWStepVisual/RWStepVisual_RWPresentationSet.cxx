...
void RWStepVisual_RWPresentationSet::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepVisual_RWPresentationSet::WriteStep(StepData_StepWriter& /*SW*/,
                                               const Handle(StepVisual_PresentationSet) & /*ent*/) const {}
