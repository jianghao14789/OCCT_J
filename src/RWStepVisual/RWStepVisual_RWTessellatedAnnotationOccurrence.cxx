...
// purpose  :
//=======================================================================
void RWStepVisual_RWTessellatedAnnotationOccurrence::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                              const Standard_Integer num, Handle(Interface_Check) & ach,
                                                              const Handle(StepVisual_TessellatedAnnotationOccurrence) &
                                                                  ent) const {
...
void RWStepVisual_RWTessellatedAnnotationOccurrence::WriteStep(
    StepData_StepWriter& SW, const Handle(StepVisual_TessellatedAnnotationOccurrence) & ent) const {
    // Inherited field : name
    SW.Send(ent->Name());
...
// purpose  :
//=======================================================================
void RWStepVisual_RWTessellatedAnnotationOccurrence::Share(const Handle(StepVisual_TessellatedAnnotationOccurrence) &
                                                               ent,
