...
void RWStepVisual_RWCurveStyle::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepVisual_RWCurveStyle::WriteStep(StepData_StepWriter& SW, const Handle(StepVisual_CurveStyle) & ent) const {
...
void RWStepVisual_RWCurveStyle::Share(const Handle(StepVisual_CurveStyle) & ent, Interface_EntityIterator& iter) const {
