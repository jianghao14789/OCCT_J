...
void RWStepVisual_RWCameraModel::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
...
void RWStepVisual_RWCameraModel::WriteStep(StepData_StepWriter& SW, const Handle(StepVisual_CameraModel) & ent) const {
