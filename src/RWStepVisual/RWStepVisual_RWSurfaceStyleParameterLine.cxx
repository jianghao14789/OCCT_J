...
void RWStepVisual_RWSurfaceStyleParameterLine::ReadStep(const Handle(StepData_StepReaderData) & data,
                                                        const Standard_Integer num, Handle(Interface_Check) & ach,
                                                        const Handle(StepVisual_SurfaceStyleParameterLine) &
                                                            ent) const {
    ...
    data->ReadEntity(num, 1, "style_of_parameter_lines", ach, STANDARD_TYPE(StepVisual_CurveStyle),
...
void RWStepVisual_RWSurfaceStyleParameterLine::WriteStep(StepData_StepWriter& SW,
                                                         const Handle(StepVisual_SurfaceStyleParameterLine) &
                                                             ent) const {
...
void RWStepVisual_RWSurfaceStyleParameterLine::Share(const Handle(StepVisual_SurfaceStyleParameterLine) & ent,
