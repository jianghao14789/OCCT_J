...
// purpose  :
//=======================================================================
void RWStepVisual_RWAnnotationPlane::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
    ...
    if (data->ReadSubList(num, 4, "elements", ach, nbSub)) {
        ...
        for (Standard_Integer i = 1; i <= nbElements; i++) {
            if (data->ReadEntity(nbSub, i, "content", ach, anEnt)) anElements->SetValue(i, anEnt);
        }
    }
