...
void RWStepVisual_RWAreaInSet::ReadStep(const Handle(StepData_StepReaderData) & data, const Standard_Integer num,
                                        Handle(Interface_Check) & ach, const Handle(StepVisual_AreaInSet) & ent) const {
...
void RWStepVisual_RWAreaInSet::WriteStep(StepData_StepWriter& SW, const Handle(StepVisual_AreaInSet) & ent) const {
