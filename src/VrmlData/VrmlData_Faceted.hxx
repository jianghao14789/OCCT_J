...
public:
    ...
    inline VrmlData_Faceted()
        : myCreaseAngle(0.), myIsCCW(Standard_True), myIsSolid(Standard_True), myIsConvex(Standard_True) {}

    /**
     * Empty constructor
     */
    inline VrmlData_Faceted(const VrmlData_Scene& theScene, const char* theName, const Standard_Boolean isCCW,
                            const Standard_Boolean isSolid, const Standard_Boolean isConvex,
                            const Standard_Real theCreaseAngle)
        : VrmlData_Geometry(theScene, theName), myCreaseAngle(theCreaseAngle), myIsCCW(isCCW), myIsSolid(isSolid),
          myIsConvex(isConvex) {}

    /**
     * Query "Is Counter-Clockwise" attribute
     */
    inline Standard_Boolean IsCCW() const {
        return myIsCCW;
    }
     ...
     */
    inline Standard_Boolean IsSolid() const {
        return myIsSolid;
    }
     ...
     */
    inline Standard_Boolean IsConvex() const {
        return myIsConvex;
    }
     ...
     */
    inline Standard_Real CreaseAngle() const {
        return myCreaseAngle;
    }
