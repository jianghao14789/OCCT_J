...
public:
     ...
     * Constructor
     */
    inline VrmlData_ShapeNode(const VrmlData_Scene& theScene, const char* theName) : VrmlData_Node(theScene, theName) {}

    /**
     * Query the Appearance.
     */
    inline const Handle(VrmlData_Appearance) & Appearance() const {
        return myAppearance;
    }
     ...
     * Query the Geometry.
     */
    inline const Handle(VrmlData_Geometry) & Geometry() const {
        return myGeometry;
    }
