...
public:
    ...
    inline VrmlData_IndexedFaceSet()
        : myArrPolygons(0L), myArrNormalInd(0L), myArrColorInd(0L), myArrTextureInd(0L), myNbPolygons(0),
          myNbNormals(0), myNbColors(0), myNbTextures(0), myNormalPerVertex(Standard_True),
          myColorPerVertex(Standard_True) {}

    /**
     * Constructor
     */
    inline VrmlData_IndexedFaceSet(const VrmlData_Scene& theScene, const char* theName,
        ...
        : VrmlData_Faceted(theScene, theName, isCCW, isSolid, isConvex, theCreaseAngle), myArrPolygons(0L),
          myArrNormalInd(0L), myArrColorInd(0L), myArrTextureInd(0L), myNbPolygons(0), myNbNormals(0), myNbColors(0),
          myNbTextures(0), myNormalPerVertex(Standard_True), myColorPerVertex(Standard_True) {}

    /**
     * Query the Normals.
     */
    inline const Handle(VrmlData_Normal) & Normals() const {
        return myNormals;
    }
     ...
     * Query the Colors.
     */
    inline const Handle(VrmlData_Color) & Colors() const {
        return myColors;
    }
     ...
     */
    inline const Handle(VrmlData_TextureCoordinate) & TextureCoords() const {
        return myTxCoords;
    }
     ...
     */
    inline const Handle(VrmlData_Coordinate) & Coordinates() const {
        return myCoords;
    }
     ...
     */
    Standard_EXPORT virtual Handle(VrmlData_Node) Clone(const Handle(VrmlData_Node) & theOther) const Standard_OVERRIDE;
