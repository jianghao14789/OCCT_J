...
public:
     ...
     * Constructor
     */
    Standard_EXPORT VrmlData_ImageTexture(const VrmlData_Scene& theScene, const char* theName, const char* theURL = 0L,
     ...
     */
    inline const NCollection_List<TCollection_AsciiString>& URL() const {
        return myURL;
    }
