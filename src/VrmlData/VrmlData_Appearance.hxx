...
public:
     ...
     * Query the Material
     */
    inline const Handle(VrmlData_Material) & Material() const {
        return myMaterial;
    }
     ...
     * Query the Texture
     */
    inline const Handle(VrmlData_Texture) & Texture() const {
        return myTexture;
    }
     ...
     */
    inline const Handle(VrmlData_TextureTransform) & TextureTransform() const {
        return myTTransform;
    }
     ...
     */
    Standard_EXPORT virtual Handle(VrmlData_Node) Clone(const Handle(VrmlData_Node) &) const Standard_OVERRIDE;
    /**
