...
public:
     ...
     */
    VrmlData_Group(const Standard_Boolean isTransform = Standard_False) : myIsTransform(isTransform) {}
     ...
     *   Allocator used for the list of children
     */
    Standard_EXPORT VrmlData_Group(const VrmlData_Scene& theScene, const char* theName,
     ...
     */
    inline Iterator NodeIterator() const {
        return Iterator(myNodes);
    }

    /**
     * Query the bounding box.
     */
    inline const Bnd_B3f& Box() const {
        return myBox;
    }
     ...
     */
    inline const gp_Trsf& GetTransform() const {
        return myTrsf;
    }
     ...
     */
    inline Standard_Boolean IsTransform() const {
        return myIsTransform;
    }
