...
public:
     ...
     * Constructor
     */
    Standard_EXPORT VrmlData_Material(const VrmlData_Scene& theScene, const char* theName,
     ...
     */
    inline Standard_Real AmbientIntensity() const {
        return myAmbientIntensity;
    }

    /**
     * Query the Shininess value
     */
    inline Standard_Real Shininess() const {
        return myShininess;
    }
     ...
     */
    inline const Quantity_Color& DiffuseColor() const {
     ...
     */
    inline const Quantity_Color& EmissiveColor() const {
     ...
     */
    inline const Quantity_Color& SpecularColor() const {
