...
public:
    ...
    inline VrmlData_Cylinder()
        : myRadius(1.), myHeight(2.), myHasBottom(Standard_True), myHasSide(Standard_True), myHasTop(Standard_True) {}
    /**
     * Constructor
     */
    inline VrmlData_Cylinder(const VrmlData_Scene& theScene, const char* theName, const Standard_Real theRadius = 1.,
                             const Standard_Real theHeight = 2.)
        : VrmlData_Geometry(theScene, theName), myRadius(theRadius), myHeight(theHeight), myHasBottom(Standard_True),
          myHasSide(Standard_True), myHasTop(Standard_True) {}

    /**
     * Query the Radius
     */
    inline Standard_Real Radius() const {
        return myRadius;
    }
     ...
     * Query the Height
     */
    inline Standard_Real Height() const {
        return myHeight;
    }
     ...
     */
    inline Standard_Boolean HasBottom() const {
        return myHasBottom;
    }
     ...
     */
    inline Standard_Boolean HasSide() const {
        return myHasSide;
    }
     ...
     */
    inline Standard_Boolean HasTop() const {
        return myHasTop;
    }
