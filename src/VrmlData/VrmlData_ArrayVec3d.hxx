...
public:
     ...
     * Empty constructor
     */
    inline VrmlData_ArrayVec3d() : myArray(0L), myLength(0) {}

    /**
     * Constructor
     */
    inline VrmlData_ArrayVec3d(const VrmlData_Scene& theScene, const char* theName, const Standard_Size nVec,
                               const gp_XYZ* arrVec)
        : VrmlData_Node(theScene, theName), myArray(arrVec), myLength(nVec) {}

    /**
     * Query the number of vectors
     */
    inline Standard_Size Length() const {
        return myLength;
    }
     ...
     * Query the array
     */
    inline const gp_XYZ* Values() const {
        return myArray;
    }
     ...
     */
    Standard_EXPORT VrmlData_ErrorStatus ReadArray(VrmlData_InBuffer& theBuffer, const char* theName,
