...
Standard_DEPRECATED("PrsMgr_TOP_ProjectorDependent should be used instead") const PrsMgr_TypeOfPresentation3d
    PrsMgr_TOP_ProjectorDependant = PrsMgr_TOP_ProjectorDependent;
