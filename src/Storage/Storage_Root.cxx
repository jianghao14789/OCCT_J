...
Storage_Root::Storage_Root(const TCollection_AsciiString& theName, const Handle(Standard_Persistent) & theObject)
    : myName(theName), myObject(theObject), myRef(0) {}

Storage_Root::Storage_Root(const TCollection_AsciiString& theName, const Standard_Integer theRef,
