...
void IGESAppli_ToolPinNumber::WriteOwnParams(const Handle(IGESAppli_PinNumber) & ent, IGESData_IGESWriter& IW) const {
...
void IGESAppli_ToolPinNumber::OwnCopy(const Handle(IGESAppli_PinNumber) & another,
    ...
    Handle(TCollection_HAsciiString) aPinNumber = new TCollection_HAsciiString(another->PinNumberVal());
...
IGESData_DirChecker IGESAppli_ToolPinNumber::DirChecker(const Handle(IGESAppli_PinNumber) & /* ent */) const {
...
void IGESAppli_ToolPinNumber::OwnCheck(const Handle(IGESAppli_PinNumber) & ent, const Interface_ShareTool&,
...
void IGESAppli_ToolPinNumber::OwnDump(const Handle(IGESAppli_PinNumber) & ent, const IGESData_IGESDumper& /* dumper */,
