...
void BSplSLib::RationalDerivative(const Standard_Integer UDeg, const Standard_Integer VDeg, const Standard_Integer N,
                                  const Standard_Integer M, Standard_Real& HDerivatives, Standard_Real& RDerivatives,
...
static Standard_Boolean PrepareEval(const Standard_Real U, const Standard_Real V, const Standard_Integer Uindex,
...
void BSplSLib::D0(const Standard_Real U, const Standard_Real V, const Standard_Integer UIndex,
                  const Standard_Integer VIndex, const TColgp_Array2OfPnt& Poles, const TColStd_Array2OfReal* Weights,
                  ...
                  const Standard_Integer UDegree, const Standard_Integer VDegree, const Standard_Boolean URat,
                  const Standard_Boolean VRat, const Standard_Boolean UPer, const Standard_Boolean VPer, gp_Pnt& P) {
    //  Standard_Integer k ;
    Standard_Real W;
    HomogeneousD0(U, V, UIndex, VIndex, Poles, Weights, UKnots, VKnots, UMults, VMults, UDegree, VDegree, URat, VRat,
                  UPer, VPer, W, P);
    P.SetX(P.X() / W);
    P.SetY(P.Y() / W);
    P.SetZ(P.Z() / W);
...
void BSplSLib::HomogeneousD0(const Standard_Real U, const Standard_Real V, const Standard_Integer UIndex,
                             const Standard_Integer VIndex, const TColgp_Array2OfPnt& Poles,
                             const TColStd_Array2OfReal* Weights, const TColStd_Array1OfReal& UKnots,
                             const TColStd_Array1OfReal& VKnots, const TColStd_Array1OfInteger* UMults,
                             const TColStd_Array1OfInteger* VMults, const Standard_Integer UDegree,
                             const Standard_Integer VDegree, const Standard_Boolean URat, const Standard_Boolean VRat,
    ...
    PrepareEval(U, V, UIndex, VIndex, UDegree, VDegree, URat, VRat, UPer, VPer, Poles, Weights, UKnots, VKnots, UMults,
                VMults, u1, u2, d1, d2, rational, dc);
    if (rational) {
        dim = 4;
...
void BSplSLib::D1(const Standard_Real U, const Standard_Real V, const Standard_Integer UIndex,
                  const Standard_Integer VIndex, const TColgp_Array2OfPnt& Poles, const TColStd_Array2OfReal* Weights,
                  const TColStd_Array1OfReal& UKnots, const TColStd_Array1OfReal& VKnots,
                  const TColStd_Array1OfInteger* UMults, const TColStd_Array1OfInteger* VMults,
                  const Standard_Integer UDegree, const Standard_Integer VDegree, const Standard_Boolean URat,
    ...
    BSplSLib_DataContainer dc(UDegree, VDegree);
    if (PrepareEval(U, V, UIndex, VIndex, UDegree, VDegree, URat, VRat, UPer, VPer, Poles, Weights, UKnots, VKnots,
                    UMults, VMults, u1, u2, d1, d2, rational, dc)) {
        if (rational) {
            dim = 4;
            dim2 = (d2 + 1) << 2;
...
void BSplSLib::HomogeneousD1(const Standard_Real U, const Standard_Real V, const Standard_Integer UIndex,
                             const Standard_Integer VIndex, const TColgp_Array2OfPnt& Poles,
                             const TColStd_Array2OfReal* Weights, const TColStd_Array1OfReal& UKnots,
                             const TColStd_Array1OfReal& VKnots, const TColStd_Array1OfInteger* UMults,
                             const TColStd_Array1OfInteger* VMults, const Standard_Integer UDegree,
                             const Standard_Integer VDegree, const Standard_Boolean URat, const Standard_Boolean VRat,
                             const Standard_Boolean UPer, const Standard_Boolean VPer, gp_Pnt& N, gp_Vec& Nu,
                             gp_Vec& Nv, Standard_Real& D, Standard_Real& Du, Standard_Real& Dv) {
    Standard_Boolean rational;
    //  Standard_Integer k,dim;
    Standard_Integer dim;
    Standard_Real u1, u2;
    ...
    Dv = 0.0e0;
    BSplSLib_DataContainer dc(UDegree, VDegree);
    Standard_Boolean ufirst = PrepareEval(U, V, UIndex, VIndex, UDegree, VDegree, URat, VRat, UPer, VPer, Poles,
                                          Weights, UKnots, VKnots, UMults, VMults, u1, u2, d1, d2, rational, dc);
    dim = rational ? 4 : 3;
...
void BSplSLib::D2(const Standard_Real U, const Standard_Real V, const Standard_Integer UIndex,
                  const Standard_Integer VIndex, const TColgp_Array2OfPnt& Poles, const TColStd_Array2OfReal* Weights,
                  const TColStd_Array1OfReal& UKnots, const TColStd_Array1OfReal& VKnots,
                  const TColStd_Array1OfInteger* UMults, const TColStd_Array1OfInteger* VMults,
                  const Standard_Integer UDegree, const Standard_Integer VDegree, const Standard_Boolean URat,
                  const Standard_Boolean VRat, const Standard_Boolean UPer, const Standard_Boolean VPer, gp_Pnt& P,
                  gp_Vec& Vu, gp_Vec& Vv, gp_Vec& Vuu, gp_Vec& Vvv, gp_Vec& Vuv) {
    Standard_Boolean rational;
    //  Standard_Integer k,dim,dim2;
    Standard_Integer dim, dim2;
    Standard_Real u1, u2;
    ...
    if (PrepareEval(U, V, UIndex, VIndex, UDegree, VDegree, URat, VRat, UPer, VPer, Poles, Weights, UKnots, VKnots,
        ...
        if (rational) {
            ...
            if (d1 > 1) BSplCLib::Eval(u2, d2, *dc.knots2, dim, *(dc.poles + (dim2 << 1)));
...
void BSplSLib::D3(const Standard_Real U, const Standard_Real V, const Standard_Integer UIndex,
                  const Standard_Integer VIndex, const TColgp_Array2OfPnt& Poles, const TColStd_Array2OfReal* Weights,
                  const TColStd_Array1OfReal& UKnots, const TColStd_Array1OfReal& VKnots,
                  const TColStd_Array1OfInteger* UMults, const TColStd_Array1OfInteger* VMults,
                  const Standard_Integer UDegree, const Standard_Integer VDegree, const Standard_Boolean URat,
                  const Standard_Boolean VRat, const Standard_Boolean UPer, const Standard_Boolean VPer, gp_Pnt& P,
                  gp_Vec& Vu, gp_Vec& Vv, gp_Vec& Vuu, gp_Vec& Vvv, gp_Vec& Vuv, gp_Vec& Vuuu, gp_Vec& Vvvv,
    ...
    Standard_Real u1, u2;
    Standard_Integer d1, d2;
    Standard_Real *result, *resVu, *resVv, *resVuu, *resVvv, *resVuv, *resVuuu, *resVvvv, *resVuuv, *resVuvv;
    BSplSLib_DataContainer dc(UDegree, VDegree);
    if (PrepareEval(U, V, UIndex, VIndex, UDegree, VDegree, URat, VRat, UPer, VPer, Poles, Weights, UKnots, VKnots,
                    UMults, VMults, u1, u2, d1, d2, rational, dc)) {
        if (rational) {
            ...
            if (d1 > 1) BSplCLib::Bohm(u2, d2, 1, *dc.knots2, dim, *(dc.poles + (dim2 << 1)));
            if (d1 > 2) BSplCLib::Eval(u2, d2, *dc.knots2, dim, *(dc.poles + (dim2 << 1) + dim2));
...
void BSplSLib::DN(const Standard_Real U, const Standard_Real V, const Standard_Integer Nu, const Standard_Integer Nv,
                  const Standard_Integer UIndex, const Standard_Integer VIndex, const TColgp_Array2OfPnt& Poles,
                  const TColStd_Array2OfReal* Weights, const TColStd_Array1OfReal& UKnots,
                  const TColStd_Array1OfReal& VKnots, const TColStd_Array1OfInteger* UMults,
                  const TColStd_Array1OfInteger* VMults, const Standard_Integer UDegree, const Standard_Integer VDegree,
                  const Standard_Boolean URat, const Standard_Boolean VRat, const Standard_Boolean UPer,
                  const Standard_Boolean VPer, gp_Vec& Vn) {
    Standard_Boolean rational;
    Standard_Integer k, dim;
    Standard_Real u1, u2;
    Standard_Integer d1, d2;
...
void BSplSLib::Iso(const Standard_Real Param, const Standard_Boolean IsU, const TColgp_Array2OfPnt& Poles,
                   const TColStd_Array2OfReal* Weights, const TColStd_Array1OfReal& Knots,
                   const TColStd_Array1OfInteger* Mults, const Standard_Integer Degree, const Standard_Boolean Periodic,
...
void BSplSLib::Reverse(TColgp_Array2OfPnt& Poles, const Standard_Integer Last, const Standard_Boolean UDirection) {
...
void BSplSLib::Reverse(TColStd_Array2OfReal& Weights, const Standard_Integer Last, const Standard_Boolean UDirection) {
    Standard_Integer i, j, l = Last;
    if (UDirection) {
...
Standard_Boolean BSplSLib::IsRational(const TColStd_Array2OfReal& Weights, const Standard_Integer I1,
                                      const Standard_Integer I2, const Standard_Integer J1, const Standard_Integer J2,
...
void BSplSLib::SetPoles(const TColgp_Array2OfPnt& Poles, TColStd_Array1OfReal& FP, const Standard_Boolean UDirection) {
...
void BSplSLib::SetPoles(const TColgp_Array2OfPnt& Poles, const TColStd_Array2OfReal& Weights, TColStd_Array1OfReal& FP,
...
void BSplSLib::GetPoles(const TColStd_Array1OfReal& FP, TColgp_Array2OfPnt& Poles, const Standard_Boolean UDirection) {
    Standard_Integer i, j, l = FP.Lower();
    Standard_Integer PLowerRow = Poles.LowerRow();
    Standard_Integer PUpperRow = Poles.UpperRow();
    Standard_Integer PLowerCol = Poles.LowerCol();
...
void BSplSLib::GetPoles(const TColStd_Array1OfReal& FP, TColgp_Array2OfPnt& Poles, TColStd_Array2OfReal& Weights,
                        const Standard_Boolean UDirection) {
    Standard_Integer i, j, l = FP.Lower();
    Standard_Integer PLowerRow = Poles.LowerRow();
    Standard_Integer PUpperRow = Poles.UpperRow();
...
void BSplSLib::InsertKnots(const Standard_Boolean UDirection, const Standard_Integer Degree,
                           const Standard_Boolean Periodic, const TColgp_Array2OfPnt& Poles,
                           const TColStd_Array2OfReal* Weights, const TColStd_Array1OfReal& Knots,
                           const TColStd_Array1OfInteger& Mults, const TColStd_Array1OfReal& AddKnots,
                           const TColStd_Array1OfInteger* AddMults, TColgp_Array2OfPnt& NewPoles,
                           TColStd_Array2OfReal* NewWeights, TColStd_Array1OfReal& NewKnots,
                           TColStd_Array1OfInteger& NewMults, const Standard_Real Epsilon, const Standard_Boolean Add) {
    Standard_Boolean rational = Weights != NULL;
    ...
    BSplCLib::InsertKnots(Degree, Periodic, dim, poles, Knots, Mults, AddKnots, AddMults, newpoles, NewKnots, NewMults,
                          Epsilon, Add);
...
Standard_Boolean BSplSLib::RemoveKnot(const Standard_Boolean UDirection, const Standard_Integer Index,
                                      const Standard_Integer Mult, const Standard_Integer Degree,
                                      const Standard_Boolean Periodic, const TColgp_Array2OfPnt& Poles,
                                      const TColStd_Array2OfReal* Weights, const TColStd_Array1OfReal& Knots,
                                      const TColStd_Array1OfInteger& Mults, TColgp_Array2OfPnt& NewPoles,
                                      TColStd_Array2OfReal* NewWeights, TColStd_Array1OfReal& NewKnots,
    ...
    if (!BSplCLib::RemoveKnot(Index, Mult, Degree, Periodic, dim, poles, Knots, Mults, newpoles, NewKnots, NewMults,
                              Tolerance))
        return Standard_False;
...
void BSplSLib::IncreaseDegree(const Standard_Boolean UDirection, const Standard_Integer Degree,
                              const Standard_Integer NewDegree, const Standard_Boolean Periodic,
                              ...
                              TColgp_Array2OfPnt& NewPoles, TColStd_Array2OfReal* NewWeights,
    ...
    BSplCLib::IncreaseDegree(Degree, NewDegree, Periodic, dim, poles, Knots, Mults, newpoles, NewKnots, NewMults);
...
void BSplSLib::Unperiodize(const Standard_Boolean UDirection, const Standard_Integer Degree,
                           const TColStd_Array1OfInteger& Mults, const TColStd_Array1OfReal& Knots,
                           const TColgp_Array2OfPnt& Poles, const TColStd_Array2OfReal* Weights,
                           TColStd_Array1OfInteger& NewMults, TColStd_Array1OfReal& NewKnots,
                           TColgp_Array2OfPnt& NewPoles, TColStd_Array2OfReal* NewWeights) {
    Standard_Boolean rational = Weights != NULL;
    Standard_Integer dim = 3;
    if (rational) dim++;
...
void BSplSLib::BuildCache(const Standard_Real U, const Standard_Real V, const Standard_Real USpanDomain,
                          const Standard_Real VSpanDomain, const Standard_Boolean UPeriodic,
                          const Standard_Boolean VPeriodic, const Standard_Integer UDegree,
                          const Standard_Integer VDegree, const Standard_Integer UIndex, const Standard_Integer VIndex,
                          const TColStd_Array1OfReal& UFlatKnots, const TColStd_Array1OfReal& VFlatKnots,
                          const TColgp_Array2OfPnt& Poles, const TColStd_Array2OfReal* Weights,
    ...
    BSplSLib_DataContainer dc(UDegree, VDegree);
    flag_u_or_v = PrepareEval(U, V, UIndex, VIndex, UDegree, VDegree, rational_u, rational_v, UPeriodic, VPeriodic,
                              Poles, Weights, UFlatKnots, VFlatKnots, (BSplCLib::NoMults()), (BSplCLib::NoMults()), u1,
                              u2, d1, d2, rational, dc);
    d1p1 = d1 + 1;
    d2p1 = d2 + 1;
    if (rational) {
...
void BSplSLib::BuildCache(const Standard_Real theU, const Standard_Real theV, const Standard_Real theUSpanDomain,
                          const Standard_Real theVSpanDomain, const Standard_Boolean theUPeriodicFlag,
                          const Standard_Boolean theVPeriodicFlag, const Standard_Integer theUDegree,
                          const Standard_Integer theVDegree, const Standard_Integer theUIndex,
                          const Standard_Integer theVIndex, const TColStd_Array1OfReal& theUFlatKnots,
                          const TColStd_Array1OfReal& theVFlatKnots, const TColgp_Array2OfPnt& thePoles,
                          const TColStd_Array2OfReal* theWeights, TColStd_Array2OfReal& theCacheArray) {
    ...
    flag_u_or_v =
        PrepareEval(theU, theV, theUIndex, theVIndex, theUDegree, theVDegree, isRationalOnParam, isRationalOnParam,
                    theUPeriodicFlag, theVPeriodicFlag, thePoles, theWeights, theUFlatKnots, theVFlatKnots,
                    (BSplCLib::NoMults()), (BSplCLib::NoMults()), u1, u2, d1, d2, isRational, dc);

    Standard_Integer d2p1 = d2 + 1;
    Standard_Integer aDimension = isRational ? 4 : 3;
    Standard_Integer
        aCacheShift = // helps to store weights when PrepareEval did not found that the surface is locally polynomial
...
void BSplSLib::CacheD0(const Standard_Real UParameter, const Standard_Real VParameter, const Standard_Integer UDegree,
                       const Standard_Integer VDegree, const Standard_Real UCacheParameter,
                       const Standard_Real VCacheParameter, const Standard_Real USpanLenght,
                       const Standard_Real VSpanLenght, const TColgp_Array2OfPnt& PolesArray,
                       const TColStd_Array2OfReal* WeightsArray, gp_Pnt& aPoint) {
    //
    ...
    Standard_Real* PArray = (Standard_Real*)&(PolesArray(PolesArray.LowerCol(), PolesArray.LowerRow()));
    ...
    PLib::NoDerivativeEvalPolynomial(new_parameter[0], max_degree, dimension, max_degree * dimension, PArray[0],
                                     locpoles[0]);

    PLib::NoDerivativeEvalPolynomial(new_parameter[1], min_degree, 3, (min_degree << 1) + min_degree, locpoles[0],
                                     myPoint[0]);
    if (WeightsArray != NULL) {
        dimension = min_degree + 1;
        const TColStd_Array2OfReal& refWeights = *WeightsArray;
        Standard_Real* WArray = (Standard_Real*)&refWeights(refWeights.LowerCol(), refWeights.LowerRow());
        PLib::NoDerivativeEvalPolynomial(new_parameter[0], max_degree, dimension, max_degree * dimension, WArray[0],
                                         locpoles[0]);

        PLib::NoDerivativeEvalPolynomial(new_parameter[1], min_degree, 1, min_degree, locpoles[0], inverse);
...
void BSplSLib::CacheD1(const Standard_Real UParameter, const Standard_Real VParameter, const Standard_Integer UDegree,
                       const Standard_Integer VDegree, const Standard_Real UCacheParameter,
                       const Standard_Real VCacheParameter, const Standard_Real USpanLenght,
                       const Standard_Real VSpanLenght, const TColgp_Array2OfPnt& PolesArray,
                       const TColStd_Array2OfReal* WeightsArray, gp_Pnt& aPoint, gp_Vec& aVecU, gp_Vec& aVecV) {
    //
    // the CacheParameter is where the cache polynomial was evaluated in homogeneous
    // form
    // the SpanLenght     is the normalizing factor so that the polynomial is between
    ...
    Standard_Real* PArray = (Standard_Real*)&(PolesArray(PolesArray.LowerCol(), PolesArray.LowerRow()));
    Standard_Real local_poles_array[2][2][3], local_poles_and_weights_array[2][2][4], local_weights_array[2][2];
    ...
    PLib::NoDerivativeEvalPolynomial(new_parameter[1], min_degree, 3, (min_degree << 1) + min_degree,
                                     locpoles[dimension], local_poles_array[1][0][0]);
    ...
    if (WeightsArray != NULL) {
        ...
        PLib::EvalPolynomial(new_parameter[1], 1, min_degree, 1, locpoles[0], local_weights_array[0][0]);
        PLib::NoDerivativeEvalPolynomial(new_parameter[1], min_degree, 1, min_degree, locpoles[dimension],
        ...
        BSplSLib::RationalDerivative(1, 1, 1, 1, local_poles_and_weights_array[0][0][0], local_poles_array[0][0][0]);
    }
...
void BSplSLib::CacheD2(const Standard_Real UParameter, const Standard_Real VParameter, const Standard_Integer UDegree,
                       const Standard_Integer VDegree, const Standard_Real UCacheParameter,
                       const Standard_Real VCacheParameter, const Standard_Real USpanLenght,
                       const Standard_Real VSpanLenght, const TColgp_Array2OfPnt& PolesArray,
                       const TColStd_Array2OfReal* WeightsArray, gp_Pnt& aPoint, gp_Vec& aVecU, gp_Vec& aVecV,
                       gp_Vec& aVecUU, gp_Vec& aVecUV, gp_Vec& aVecVV) {
    //
    // the CacheParameter is where the cache polynomial was evaluated in homogeneous
    // form
    // the SpanLenght     is the normalizing factor so that the polynomial is between
    ...
    Standard_Real* PArray = (Standard_Real*)&(PolesArray(PolesArray.LowerCol(), PolesArray.LowerRow()));
    Standard_Real local_poles_array[3][3][3], local_poles_and_weights_array[3][3][4], local_weights_array[3][3];
    ...
    PLib::EvalPolynomial(new_parameter[1], MinIndMin, min_degree, 3, locpoles[0], local_poles_array[0][0][0]);
    PLib::EvalPolynomial(new_parameter[1], 1, min_degree, 3, locpoles[dimension], local_poles_array[1][0][0]);

    PLib::NoDerivativeEvalPolynomial(new_parameter[1], min_degree, 3, (min_degree << 1) + min_degree,
                                     locpoles[dimension + dimension], local_poles_array[2][0][0]);

    if (WeightsArray != NULL) {
        dimension = min_degree + 1;
        const TColStd_Array2OfReal& refWeights = *WeightsArray;
        Standard_Real* WArray = (Standard_Real*)&refWeights(refWeights.LowerCol(), refWeights.LowerRow());
        PLib::EvalPolynomial(new_parameter[0], MinIndMax, max_degree, dimension, WArray[0], locpoles[0]);

        PLib::EvalPolynomial(new_parameter[1], MinIndMin, min_degree, 1, locpoles[0], local_weights_array[0][0]);
        PLib::EvalPolynomial(new_parameter[1], 1, min_degree, 1, locpoles[dimension], local_weights_array[1][0]);
        PLib::NoDerivativeEvalPolynomial(new_parameter[1], min_degree, 1, min_degree, locpoles[dimension + dimension],
        ...
        BSplSLib::RationalDerivative(2, 2, 2, 2, local_poles_and_weights_array[0][0][0], local_poles_array[0][0][0]);
    }
...
void BSplSLib::MovePoint(const Standard_Real U, const Standard_Real V, const gp_Vec& Displ,
                         const Standard_Integer UIndex1, const Standard_Integer UIndex2, const Standard_Integer VIndex1,
                         const Standard_Integer VIndex2, const Standard_Integer UDegree, const Standard_Integer VDegree,
                         const Standard_Boolean Rational, const TColgp_Array2OfPnt& Poles,
                         const TColStd_Array2OfReal& Weights, const TColStd_Array1OfReal& UFlatKnots,
                         const TColStd_Array1OfReal& VFlatKnots, Standard_Integer& UFirstIndex,
                         Standard_Integer& ULastIndex, Standard_Integer& VFirstIndex, Standard_Integer& VLastIndex,
    ...
    Standard_Integer ErrorCod1 =
        BSplCLib::EvalBsplineBasis(0, UDegree + 1, UFlatKnots, U, UFirstNonZeroBsplineIndex, UBSplineBasis);
    ...
    Standard_Integer ErrorCod2 =
        BSplCLib::EvalBsplineBasis(0, VDegree + 1, VFlatKnots, V, VFirstNonZeroBsplineIndex, VBSplineBasis);
...
void BSplSLib::Resolution(const TColgp_Array2OfPnt& Poles, const TColStd_Array2OfReal* Weights,
                          const TColStd_Array1OfReal& UKnots, const TColStd_Array1OfReal& VKnots,
                          const TColStd_Array1OfInteger& UMults, const TColStd_Array1OfInteger& VMults,
                          const Standard_Integer UDegree, const Standard_Integer VDegree,
                          const Standard_Boolean URational, const Standard_Boolean VRational,
                          const Standard_Boolean UPeriodic, const Standard_Boolean VPeriodic,
                          const Standard_Real Tolerance3D, Standard_Real& UTolerance, Standard_Real& VTolerance) {
...
void BSplSLib::Interpolate(const Standard_Integer UDegree, const Standard_Integer VDegree,
                           const TColStd_Array1OfReal& UFlatKnots, const TColStd_Array1OfReal& VFlatKnots,
                           const TColStd_Array1OfReal& UParameters, const TColStd_Array1OfReal& VParameters,
                           TColgp_Array2OfPnt& Poles, TColStd_Array2OfReal& Weights,
    ...
    BSplCLib::Interpolate(VDegree, VFlatKnots, VParameters, ContactOrder->Array1(), dimension, poles_array[0],
                          InversionProblem);
    ...
    BSplCLib::Interpolate(UDegree, UFlatKnots, UParameters, ContactOrder->Array1(), dimension, poles_array[0],
                          InversionProblem);
...
void BSplSLib::FunctionMultiply(const BSplSLib_EvaluatorFunction& Function, const Standard_Integer UBSplineDegree,
                                const Standard_Integer VBSplineDegree, const TColStd_Array1OfReal& UBSplineKnots,
                                const TColStd_Array1OfReal& VBSplineKnots, const TColStd_Array1OfInteger* UMults,
                                const TColStd_Array1OfInteger* VMults, const TColgp_Array2OfPnt& Poles,
                                const TColStd_Array2OfReal* Weights, const TColStd_Array1OfReal& UFlatKnots,
                                const TColStd_Array1OfReal& VFlatKnots, const Standard_Integer UNewDegree,
                                const Standard_Integer VNewDegree, TColgp_Array2OfPnt& NewNumerator,
                                TColStd_Array2OfReal& NewDenominator, Standard_Integer& theStatus) {
    ...
    if ((NewNumerator.ColLength() == num_uparameters) && (NewNumerator.RowLength() == num_vparameters) &&
        (NewDenominator.ColLength() == num_uparameters) && (NewDenominator.RowLength() == num_vparameters)) {
        ...
        for (ii = 1; ii <= num_uparameters; ii++) {
            ...
            for (jj = 1; jj <= num_vparameters; jj++) {
                HomogeneousD0(UParameters(ii), VParameters(jj), 0, 0, Poles, Weights, UBSplineKnots, VBSplineKnots,
                              UMults, VMults, UBSplineDegree, VBSplineDegree, Standard_True, Standard_True,
                              Standard_False, Standard_False, NewDenominator(ii, jj), NewNumerator(ii, jj));
        ...
        Interpolate(UNewDegree, VNewDegree, UFlatKnots, VFlatKnots, UParameters, VParameters, NewNumerator,
                    NewDenominator, theStatus);
    } else {
        throw Standard_ConstructionError();
    }
}
