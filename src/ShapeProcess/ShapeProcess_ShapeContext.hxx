...
public:
    ...
    //! to be processed
    Standard_EXPORT ShapeProcess_ShapeContext(const TopoDS_Shape& S, const Standard_CString file,
    ...
    Standard_EXPORT void AddMessage(const TopoDS_Shape& S, const Message_Msg& msg,
