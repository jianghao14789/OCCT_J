...
protected:
    BOPDS_Interf()
        : myIndex1(-1), myIndex2(-1), myIndexNew(-1), myAllocator(NCollection_BaseAllocator::CommonBaseAllocator()) {}
    //
    BOPDS_Interf(const Handle(NCollection_BaseAllocator) & theAllocator)
        : myIndex1(-1), myIndex2(-1), myIndexNew(-1), myAllocator(theAllocator) {}
    //
...
public:
     ...
     */
    BOPDS_InterfVV(const Handle(NCollection_BaseAllocator) & theAllocator) : BOPDS_Interf(theAllocator) {}
    //
    /**
     *  Destructor
     */
...
public:
     ...
     *  Constructor
     */
    BOPDS_InterfVE() : BOPDS_Interf(), myParameter(0.) {}
    //
    /**
     *  Constructor
     * @param theAllocator
    ...
    BOPDS_InterfVE(const Handle(NCollection_BaseAllocator) & theAllocator)
        : BOPDS_Interf(theAllocator), myParameter(0.) {}
    //
    /**
     *  Destructor
     */
...
public:
     ...
     *  Constructor
     */
    BOPDS_InterfVF() : BOPDS_Interf(), myU(0.), myV(0.) {}
    //
    /**
     *  Constructor
     * @param theAllocator
    ...
    BOPDS_InterfVF(const Handle(NCollection_BaseAllocator) & theAllocator)
        : BOPDS_Interf(theAllocator), myU(0.), myV(0.) {}
    //
    /**
     *  Destructor
     */
...
public:
     ...
     *   allocator to manage the memory
     */
    BOPDS_InterfEE(const Handle(NCollection_BaseAllocator) & theAllocator) : BOPDS_Interf(theAllocator) {}
    //
    /**
     *  Destructor
     */
...
public:
     ...
     *   allocator to manage the memory
     */
    BOPDS_InterfEF(const Handle(NCollection_BaseAllocator) & theAllocator) : BOPDS_Interf(theAllocator) {}
    //
    /**
     *  Destructor
     */
...
public:
     ...
     */
    BOPDS_InterfFF()
        : BOPDS_Interf(), myTangentFaces(Standard_False), myCurves(0, myAllocator), myPoints(0, myAllocator) {}
    //
    /**
     *  Destructor
     */
...
public:
     ...
     *   allocator to manage the memory
     */
    BOPDS_InterfVZ(const Handle(NCollection_BaseAllocator) & theAllocator) : BOPDS_Interf(theAllocator) {};
    //
    /**
     *  Destructor
     */
...
public:
     ...
     *   allocator to manage the memory
     */
    BOPDS_InterfEZ(const Handle(NCollection_BaseAllocator) & theAllocator) : BOPDS_Interf(theAllocator) {};
    //
    /**
     *  Destructor
     */
...
public:
     ...
     *   allocator to manage the memory
     */
    BOPDS_InterfFZ(const Handle(NCollection_BaseAllocator) & theAllocator) : BOPDS_Interf(theAllocator) {};
    //
    /**
     *  Destructor
     */
...
public:
     ...
     *   allocator to manage the memory
     */
    BOPDS_InterfZZ(const Handle(NCollection_BaseAllocator) & theAllocator) : BOPDS_Interf(theAllocator) {};
    //
    /**
     *  Destructor
     */
