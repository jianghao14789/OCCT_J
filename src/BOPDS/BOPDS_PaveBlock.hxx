...
public:
    ...
    Standard_EXPORT Standard_Boolean ContainsParameter(const Standard_Real thePrm, const Standard_Real theTol,
    ...
    //! <theBox> - the bounding box
    //! <theIsSplittable> - defines whether the edge can be split
    Standard_EXPORT void ShrunkData(Standard_Real& theTS1, Standard_Real& theTS2, Bnd_Box& theBox,
